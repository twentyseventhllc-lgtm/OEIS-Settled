...
\title{A proof of the conjectured linear recurrence for OEIS A243606}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A243606}{A243606} as

\begin{quote}\itshape Number of length n+2 0..9 arrays with no three elements in a row with pattern aba (with a!=b) and new values 0..9 introduced in 0..9 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 38*a(n-1) -603*a(n-2) +5165*a(n-3) -25592*a(n-4) +71533*a(n-5) -92714*a(n-6) -10048*a(n-7) +134330*a(n-8) -29886*a(n-9) -94396*a(n-10) -8366*a(n-11) +29547*a(n-12) +16394*a(n-13) +4033*a(n-14) +529*a(n-15) +36*a(n-16) +a(n-17)\end{quote}
...
\begin{multline*} a(n) = 38\,a(n-1) - 603\,a(n-2) + 5165\,a(n-3) - 25592\,a(n-4) + 71533\,a(n-5) - 92714\,a(n-6) - \\ 10048\,a(n-7) + 134330\,a(n-8) - 29886\,a(n-9) - 94396\,a(n-10) - 8366\,a(n-11) + 29547\,a(n-12) + \\ 16394\,a(n-13) + 4033\,a(n-14) + 529\,a(n-15) + 36\,a(n-16) + a(n-17). \end{multline*}
...
\begin{theorem} For A243606, the recurrence $a(n) = 38\,a(n-1) - 603\,a(n-2) + 5165\,a(n-3) - 25592\,a(n-4) + 71533\,a(n-5) - 92714\,a(n-6) - 10048\,a(n-7) + 134330\,a(n-8) - 29886\,a(n-9) - 94396\,a(n-10) - 8366\,a(n-11) + 29547\,a(n-12) + 16394\,a(n-13) + 4033\,a(n-14) + 529\,a(n-15) + 36\,a(n-16) + a(n-17)$ holds for every $n \ge 18$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 10, 29, 97, 366, 1534, 7050, 35167,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A243606}{A243606}, revision 6, last modified Jul 23 2025.
