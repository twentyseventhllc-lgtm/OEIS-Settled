...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A223962}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223962}{A223962} as

\begin{quote}\itshape Number of 2 X n 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/144)*n\textasciicircum{}6 + (7/48)*n\textasciicircum{}5 + (157/144)*n\textasciicircum{}4 + (59/16)*n\textasciicircum{}3 + (425/72)*n\textasciicircum{}2 + (25/6)*n + 1.\end{quote}

\begin{quote}\ttfamily G.f.: x*(16 - 27*x + 36*x\textasciicircum{}2 - 35*x\textasciicircum{}3 + 21*x\textasciicircum{}4 - 7*x\textasciicircum{}5 + x\textasciicircum{}6) / (1 - x)\textasciicircum{}7.\end{quote}
...
\[a(n) = 1 + \frac{25}{6}n + \frac{425}{72}n^{2} + \frac{59}{16}n^{3} + \frac{157}{144}n^{4} + \frac{7}{48}n^{5} + \frac{1}{144}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{16x - 27x^{2} + 36x^{3} - 35x^{4} + 21x^{5} - 7x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A223962, $a(n)$ is the polynomial $1 + \frac{25}{6}n + \frac{425}{72}n^{2} + \frac{59}{16}n^{3} + \frac{157}{144}n^{4} + \frac{7}{48}n^{5} + \frac{1}{144}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A223962, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{16x - 27x^{2} + 36x^{3} - 35x^{4} + 21x^{5} - 7x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A223962, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 85, 295, 805, 1876, 3906, 7470, 13365,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223962}{A223962}, revision 7, last modified Aug 24 2018.
