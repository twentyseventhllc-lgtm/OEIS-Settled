...
\title{A proof of the conjectured linear recurrence for OEIS A295843}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295843}{A295843} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 adjacent to 1 or 2 king-move neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +6*a(n-2) +47*a(n-3) -138*a(n-4) +33*a(n-5) +55*a(n-6) -397*a(n-7) -225*a(n-8) +305*a(n-9) -243*a(n-10) -191*a(n-11) +206*a(n-12) -56*a(n-13) -26*a(n-14) +21*a(n-15) +2*a(n-16)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 6\,a(n-2) + 47\,a(n-3) - 138\,a(n-4) + 33\,a(n-5) + 55\,a(n-6) - \\ 397\,a(n-7) - 225\,a(n-8) + 305\,a(n-9) - 243\,a(n-10) - 191\,a(n-11) + 206\,a(n-12) - \\ 56\,a(n-13) - 26\,a(n-14) + 21\,a(n-15) + 2\,a(n-16). \end{multline*}
...
That refinement leaves $23$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 18$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A295843, the recurrence $a(n) = 6\,a(n-1) + 6\,a(n-2) + 47\,a(n-3) - 138\,a(n-4) + 33\,a(n-5) + 55\,a(n-6) - 397\,a(n-7) - 225\,a(n-8) + 305\,a(n-9) - 243\,a(n-10) - 191\,a(n-11) + 206\,a(n-12) - 56\,a(n-13) - 26\,a(n-14) + 21\,a(n-15) + 2\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 80, 467, 3472, 26544, 190943, 1406191, 10368395,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295843}{A295843}, revision 4, last modified Nov 29 2017.
