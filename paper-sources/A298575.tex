...
k=1: a(n) = a(n-1)\\k=2: a(n) = a(n-1) +8*a(n-3) -4*a(n-4)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 22 2018). As of revision 6, last modified Jan 29 2018, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
