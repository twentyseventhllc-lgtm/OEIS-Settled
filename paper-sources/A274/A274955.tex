...
\title{A proof of the conjectured linear recurrence for OEIS A274955}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A274955}{A274955} as

\begin{quote}\itshape Number of nX4 0..2 arrays with no element equal to any value at offset (-1,-1) (-2,0) or (0,-2) and new values introduced in order 0..2\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +4*a(n-3) +13*a(n-4) -74*a(n-5) -8*a(n-6) -4*a(n-8) +8*a(n-9) for n>11\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 4\,a(n-3) + 13\,a(n-4) - 74\,a(n-5) - 8\,a(n-6) - 4\,a(n-8) + \\ 8\,a(n-9). \end{multline*}
...
The reachable part of the digraph has $443$ states, $443$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 14$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of the resulting $14\times14$ matrix. That bound is computed, not assumed.
...
\begin{theorem} For A274955, the recurrence $a(n) = 6\,a(n-1) + 4\,a(n-3) + 13\,a(n-4) - 74\,a(n-5) - 8\,a(n-6) - 4\,a(n-8) + 8\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 72, 384, 2376, 14406, 87780, 536406, 3278016,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A274955}{A274955}, revision 4, last modified Jul 12 2016.
