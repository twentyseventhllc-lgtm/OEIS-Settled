...
\title{Proofs of the conjectured column and row recurrences for OEIS A224676}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224676}{A224676} as

\begin{quote}\itshape T(n,k)=Number of (n+1)X(k+1) 0..2 matrices with each 2X2 subblock idempotent\end{quote}
...
k=1: a(n) = 2*a(n-1) -a(n-3)\\k=2: a(n) = 4*a(n-1) -5*a(n-2) +a(n-3) +2*a(n-4) -a(n-5)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Apr 14 2013). As of revision 8, last modified Oct 03 2025, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A224676, the recurrence $a(n) = 2\,a(n-1) - a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A224676, the recurrence $a(n) = 4\,a(n-1) - 5\,a(n-2) + a(n-3) + 2\,a(n-4) - a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224676}{A224676}, revision 8, last modified Oct 03 2025.
