...
k=1: a(n) = 5*a(n-2) -4*a(n-4).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 01 2014). As of revision 7, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
