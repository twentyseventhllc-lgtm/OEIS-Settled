...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 5$, that is at $n = 21$. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
