...
\title{A proof of the conjectured linear recurrence for OEIS A302417}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302417}{A302417} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +6*a(n-3) -6*a(n-4) +3*a(n-5) -6*a(n-6) +a(n-7) -14*a(n-8) +9*a(n-9) +4*a(n-10) +2*a(n-11) -4*a(n-12) +2*a(n-13) +8*a(n-15) -4*a(n-16) for n>21\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + 6\,a(n-3) - 6\,a(n-4) + 3\,a(n-5) - 6\,a(n-6) + \\ a(n-7) - 14\,a(n-8) + 9\,a(n-9) + 4\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) + \\ 2\,a(n-13) + 8\,a(n-15) - 4\,a(n-16). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $172$; neither removal changes any count.
...
\begin{theorem} For A302417, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + 6\,a(n-3) - 6\,a(n-4) + 3\,a(n-5) - 6\,a(n-6) + a(n-7) - 14\,a(n-8) + 9\,a(n-9) + 4\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) + 2\,a(n-13) + 8\,a(n-15) - 4\,a(n-16)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,82$. The last nonvanishing one is at $m = 5$, that is at $n = 21$. After it, more than $S = 33$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 81, 120, 259, 698, 1650, 3655, 8544,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302417}{A302417}, revision 4, last modified Apr 07 2018.
