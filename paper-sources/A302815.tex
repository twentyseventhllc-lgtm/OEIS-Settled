...
\title{A proof of the conjectured linear recurrence for OEIS A302815}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302815}{A302815} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +5*a(n-2) +36*a(n-3) -62*a(n-4) -116*a(n-5) -142*a(n-6) -78*a(n-7) +150*a(n-8) -100*a(n-9) +176*a(n-10) +272*a(n-11) +320*a(n-12) -256*a(n-14).\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 5\,a(n-2) + 36\,a(n-3) - 62\,a(n-4) - 116\,a(n-5) - 142\,a(n-6) - \\ 78\,a(n-7) + 150\,a(n-8) - 100\,a(n-9) + 176\,a(n-10) + 272\,a(n-11) + 320\,a(n-12) - \\ 256\,a(n-14). \end{multline*}
...
\begin{theorem} For A302815, the recurrence $a(n) = 3\,a(n-1) + 5\,a(n-2) + 36\,a(n-3) - 62\,a(n-4) - 116\,a(n-5) - 142\,a(n-6) - 78\,a(n-7) + 150\,a(n-8) - 100\,a(n-9) + 176\,a(n-10) + 272\,a(n-11) + 320\,a(n-12) - 256\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 75, 389, 1852, 8485, 41247, 196946,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302815}{A302815}, revision 6, last modified May 26 2024.
