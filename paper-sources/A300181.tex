...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,110$. Every one of them vanished. After it, more than $S = 56$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
