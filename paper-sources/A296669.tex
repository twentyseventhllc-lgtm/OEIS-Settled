...
\title{A proof of the conjectured linear recurrence for OEIS A296669}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296669}{A296669} as

\begin{quote}\itshape Number of nX3 0..1 arrays with each 1 adjacent to 0, 2 or 3 king-move neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -a(n-2) +5*a(n-3) -55*a(n-4) -22*a(n-5) +42*a(n-6) +48*a(n-7) +37*a(n-8) -16*a(n-9) +30*a(n-10) -22*a(n-11) +4*a(n-12)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - a(n-2) + 5\,a(n-3) - 55\,a(n-4) - 22\,a(n-5) + 42\,a(n-6) + \\ 48\,a(n-7) + 37\,a(n-8) - 16\,a(n-9) + 30\,a(n-10) - 22\,a(n-11) + 4\,a(n-12). \end{multline*}
...
\begin{theorem} For A296669, the recurrence $a(n) = 5\,a(n-1) - a(n-2) + 5\,a(n-3) - 55\,a(n-4) - 22\,a(n-5) + 42\,a(n-6) + 48\,a(n-7) + 37\,a(n-8) - 16\,a(n-9) + 30\,a(n-10) - 22\,a(n-11) + 4\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,53$. Every one of them vanished. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 25, 82, 334, 1451, 5938, 25144, 108174,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296669}{A296669}, revision 4, last modified Dec 18 2017.
