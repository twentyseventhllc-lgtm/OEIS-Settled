...
\title{A proof of the conjectured linear recurrence for OEIS A300337}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300337}{A300337} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +6*a(n-2) -40*a(n-3) -59*a(n-4) +79*a(n-5) +97*a(n-6) -40*a(n-7) +20*a(n-8) +8*a(n-9) -44*a(n-10) -6*a(n-11) for n>13\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 6\,a(n-2) - 40\,a(n-3) - 59\,a(n-4) + 79\,a(n-5) + 97\,a(n-6) - \\ 40\,a(n-7) + 20\,a(n-8) + 8\,a(n-9) - 44\,a(n-10) - 6\,a(n-11). \end{multline*}
...
\begin{theorem} For A300337, the recurrence $a(n) = 6\,a(n-1) + 6\,a(n-2) - 40\,a(n-3) - 59\,a(n-4) + 79\,a(n-5) + 97\,a(n-6) - 40\,a(n-7) + 20\,a(n-8) + 8\,a(n-9) - 44\,a(n-10) - 6\,a(n-11)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,52$. The last nonvanishing one is at $m = 2$, that is at $n = 13$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 13, 47, 255, 1272, 6780, 36498, 198531,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300337}{A300337}, revision 4, last modified Mar 03 2018.
