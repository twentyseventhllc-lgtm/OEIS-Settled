...
\title{A proof of the conjectured linear recurrence for OEIS A207341}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207341}{A207341} as

\begin{quote}\itshape Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-2) +16*a(n-3) +13*a(n-4) -10*a(n-5) -17*a(n-6) -8*a(n-7) +2*a(n-8) -2*a(n-9) -a(n-10) for n>13\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-2) + 16\,a(n-3) + 13\,a(n-4) - 10\,a(n-5) - 17\,a(n-6) - 8\,a(n-7) + \\ 2\,a(n-8) - 2\,a(n-9) - a(n-10). \end{multline*}
...
\begin{theorem} For A207341, the recurrence $a(n) = 4\,a(n-2) + 16\,a(n-3) + 13\,a(n-4) - 10\,a(n-5) - 17\,a(n-6) - 8\,a(n-7) + 2\,a(n-8) - 2\,a(n-9) - a(n-10)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,55$. The last nonvanishing one is at $m = 3$, that is at $n = 13$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 84, 292, 912, 2812, 8928, 28152,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207341}{A207341}, revision 9, last modified Oct 03 2025.
