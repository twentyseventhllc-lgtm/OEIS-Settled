...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,125$. The last nonvanishing one is at $m = 7$, that is at $n = 41$. After it, more than $S = 62$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
