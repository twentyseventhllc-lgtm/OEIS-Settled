...
\title{A proof of the conjectured linear recurrence for OEIS A316278}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316278}{A316278} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +52*a(n-2) -19*a(n-3) -854*a(n-4) -2603*a(n-5) -3429*a(n-6) +1157*a(n-7) +8303*a(n-8) +14076*a(n-9) +9383*a(n-10) +1417*a(n-11) -8498*a(n-12) -5299*a(n-13) -7573*a(n-14) -7142*a(n-15) -9163*a(n-16) -1007*a(n-17) +3161*a(n-18) +384*a(n-19) +3327*a(n-20) +172*a(n-21) +2940*a(n-22) -289*a(n-23) -28*a(n-24) -324*a(n-25) +42*a(n-26) +28*a(n-27) for n>28\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 52\,a(n-2) - 19\,a(n-3) - 854\,a(n-4) - 2603\,a(n-5) - 3429\,a(n-6) + \\ 1157\,a(n-7) + 8303\,a(n-8) + 14076\,a(n-9) + 9383\,a(n-10) + 1417\,a(n-11) - 8498\,a(n-12) - \\ 5299\,a(n-13) - 7573\,a(n-14) - 7142\,a(n-15) - 9163\,a(n-16) - 1007\,a(n-17) + 3161\,a(n-18) + \\ 384\,a(n-19) + 3327\,a(n-20) + 172\,a(n-21) + 2940\,a(n-22) - 289\,a(n-23) - 28\,a(n-24) - \\ 324\,a(n-25) + 42\,a(n-26) + 28\,a(n-27). \end{multline*}
...
That refinement leaves $42$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 32$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A316278, the recurrence of order $27$ displayed in Section 1 holds for every $n > 28$, and fails at $n = 28$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,82$. The last nonvanishing one is at $m = 1$, that is at $n = 28$. After it, more than $S = 32$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 98, 846, 9540, 102072, 1099200, 11834419, 127394654,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316278}{A316278}, revision 4, last modified Jun 28 2018.
