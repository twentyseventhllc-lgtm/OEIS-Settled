...
\title{A proof of the conjectured linear recurrence for OEIS A298083}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298083}{A298083} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -4*a(n-2) -28*a(n-4) +10*a(n-5) +35*a(n-6) +103*a(n-7) -31*a(n-8) +31*a(n-9) -383*a(n-10) +291*a(n-11) -598*a(n-12) -88*a(n-13) +16*a(n-14) -165*a(n-15) +1777*a(n-16) +1139*a(n-17) +1984*a(n-18) -2265*a(n-19) +1513*a(n-20) -2214*a(n-21) +6466*a(n-22) -9351*a(n-23) -128*a(n-24) -14148*a(n-25) -9460*a(n-26) -16824*a(n-27) +19925*a(n-28) +22443*a(n-29) +20906*a(n-30) +7763*a(n-31) +5741*a(n-32) -10077*a(n-33) +2720*a(n-34) +13550*a(n-35) -7017*a(n-36) -31393*a(n-37) -21978*a(n-38) +5034*a(n-39) +16547*a(n-40) +7238*a(n-41) -404*a(n-42) -6332*a(n-43) -2417*a(n-44) -5112*a(n-45) -816*a(n-46) -1724*a(n-47) +1953*a(n-48) +1176*a(n-49) +1643*a(n-50) -112*a(n-51) -110*a(n-52) -388*a(n-53) +15*a(n-54) -40*a(n-55) +26*a(n-56) +6*a(n-57) for n>58\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 4\,a(n-2) - 28\,a(n-4) + 10\,a(n-5) + 35\,a(n-6) + 103\,a(n-7) - \\ 31\,a(n-8) + 31\,a(n-9) - 383\,a(n-10) + 291\,a(n-11) - 598\,a(n-12) - 88\,a(n-13) + \\ 16\,a(n-14) - 165\,a(n-15) + 1777\,a(n-16) + 1139\,a(n-17) + 1984\,a(n-18) - 2265\,a(n-19) + \\ 1513\,a(n-20) - 2214\,a(n-21) + 6466\,a(n-22) - 9351\,a(n-23) - 128\,a(n-24) - 14148\,a(n-25) - \\ 9460\,a(n-26) - 16824\,a(n-27) + 19925\,a(n-28) + 22443\,a(n-29) + 20906\,a(n-30) + 7763\,a(n-31) + \\ 5741\,a(n-32) - 10077\,a(n-33) + 2720\,a(n-34) + 13550\,a(n-35) - 7017\,a(n-36) - 31393\,a(n-37) - \\ 21978\,a(n-38) + 5034\,a(n-39) + 16547\,a(n-40) + 7238\,a(n-41) - 404\,a(n-42) - 6332\,a(n-43) - \\ 2417\,a(n-44) - 5112\,a(n-45) - 816\,a(n-46) - 1724\,a(n-47) + 1953\,a(n-48) + 1176\,a(n-49) + \\ 1643\,a(n-50) - 112\,a(n-51) - 110\,a(n-52) - 388\,a(n-53) + 15\,a(n-54) - 40\,a(n-55) + \\ 26\,a(n-56) + 6\,a(n-57). \end{multline*}
...
That refinement leaves $59$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 58$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A298083, the recurrence of order $57$ displayed in Section 1 holds for every $n > 58$, and fails at $n = 58$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,148$. The last nonvanishing one is at $m = 1$, that is at $n = 58$. After it, more than $S = 58$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 2, 3, 10, 28, 76, 213, 645,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298083}{A298083}, revision 4, last modified Jan 12 2018.
