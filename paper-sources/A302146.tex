...
\title{A proof of the conjectured linear recurrence for OEIS A302146}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302146}{A302146} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
The construction gives $72$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $18$; neither removal changes any count.
...
\begin{theorem} For A302146, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) - 2\,a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 2, 4, 10, 28, 84, 260, 816,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302146}{A302146}, revision 4, last modified Apr 02 2018.
