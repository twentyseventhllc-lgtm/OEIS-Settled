...
\title{A proof of the conjectured linear recurrence for OEIS A189198}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189198}{A189198} as

\begin{quote}\itshape Number of 5Xn binary arrays without the pattern 0 0 1 vertically or antidiagonally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 20*a(n-1) -60*a(n-2) -208*a(n-3) +844*a(n-4) +344*a(n-5) -3476*a(n-6) +3544*a(n-7) -1056*a(n-8)\end{quote}
...
\begin{multline*} a(n) = 20\,a(n-1) - 60\,a(n-2) - 208\,a(n-3) + 844\,a(n-4) + 344\,a(n-5) - 3476\,a(n-6) + \\ 3544\,a(n-7) - 1056\,a(n-8). \end{multline*}
...
The reachable part of the digraph has $421$ states, $421$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 12$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $12\times12$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189198, the recurrence $a(n) = 20\,a(n-1) - 60\,a(n-2) - 208\,a(n-3) + 844\,a(n-4) + 344\,a(n-5) - 3476\,a(n-6) + 3544\,a(n-7) - 1056\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 6446, 101628, 1579664, 24496092, 379515360, 5878642448,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189198}{A189198}, revision 9, last modified Oct 03 2025.
