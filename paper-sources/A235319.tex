...
\title{Proofs of the conjectured column and row recurrences for OEIS A235319}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A235319}{A235319} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings)\end{quote}
...
\begin{quote}\ttfamily Empirical for column k (the k=2..6 recurrence also works for k=1; apparently all rows and columns satisfy the same order 18 recurrence):\\
k=1: a(n) = 28*a(n-2) - 252*a(n-4) + 720*a(n-6).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 05 2014). As of revision 9, last modified Jun 18 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A235319, the recurrence $a(n) = 28\,a(n-2) - 252\,a(n-4) + 720\,a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A235319}{A235319}, revision 9, last modified Jun 18 2022.
