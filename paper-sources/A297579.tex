...
\title{A proof of the conjectured linear recurrence for OEIS A297579}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297579}{A297579} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 4 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +8*a(n-2) +65*a(n-3) +24*a(n-4) -109*a(n-5) -708*a(n-6) -460*a(n-7) +1188*a(n-8) +1178*a(n-9) +1813*a(n-10) -509*a(n-11) -2484*a(n-12) -3623*a(n-13) -998*a(n-14) +974*a(n-15) +4136*a(n-16) +3611*a(n-17) +746*a(n-18) -1268*a(n-19) -2677*a(n-20) -2205*a(n-21) -330*a(n-22) +30*a(n-23) +347*a(n-24) +205*a(n-25) -45*a(n-26) +46*a(n-27) +66*a(n-28) +8*a(n-29) -8*a(n-30)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 8\,a(n-2) + 65\,a(n-3) + 24\,a(n-4) - 109\,a(n-5) - 708\,a(n-6) - \\ 460\,a(n-7) + 1188\,a(n-8) + 1178\,a(n-9) + 1813\,a(n-10) - 509\,a(n-11) - 2484\,a(n-12) - \\ 3623\,a(n-13) - 998\,a(n-14) + 974\,a(n-15) + 4136\,a(n-16) + 3611\,a(n-17) + 746\,a(n-18) - \\ 1268\,a(n-19) - 2677\,a(n-20) - 2205\,a(n-21) - 330\,a(n-22) + 30\,a(n-23) + 347\,a(n-24) + \\ 205\,a(n-25) - 45\,a(n-26) + 46\,a(n-27) + 66\,a(n-28) + 8\,a(n-29) - 8\,a(n-30). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $326$; neither removal changes any count.
...
\begin{theorem} For A297579, the recurrence of order $30$ displayed in Section 1 holds for every $n \ge 31$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 39, 188, 1017, 5800, 31171, 171543, 945046,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297579}{A297579}, revision 4, last modified Jan 01 2018.
