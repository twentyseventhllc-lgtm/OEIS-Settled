...
\title{Proofs of the conjectured column and row recurrences for OEIS A269109}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269109}{A269109} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three no more than once\end{quote}
...
k=1: a(n) = 6*a(n-1) -9*a(n-2)\\k=2: a(n) = 14*a(n-1) -49*a(n-2) for n>3\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 19 2016). As of revision 4, last modified Feb 19 2016, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A269109, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269109, the recurrence $a(n) = 14\,a(n-1) - 49\,a(n-2)$ holds for every $n > 3$, and fails at $n = 3$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269109}{A269109}, revision 4, last modified Feb 19 2016.
