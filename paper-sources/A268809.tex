...
\title{Proofs of the conjectured column and row recurrences for OEIS A268809}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268809}{A268809} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once\end{quote}
...
\begin{theorem} For column $k = 1$ of A268809, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A268809, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - 2\,a(n-3) - 6\,a(n-4) - 4\,a(n-5) - a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A268809, the recurrence $a(n) = 0$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A268809, the recurrence $a(n) = 0$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268809}{A268809}, revision 4, last modified Feb 13 2016.
