...
\title{A proof of the conjectured linear recurrence for OEIS A300969}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300969}{A300969} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) -52*a(n-2) +28*a(n-3) +56*a(n-4) +123*a(n-5) -596*a(n-6) +202*a(n-7) +1114*a(n-8) +244*a(n-9) -3131*a(n-10) -352*a(n-11) +4162*a(n-12) +2026*a(n-13) -4839*a(n-14) -3744*a(n-15) +7609*a(n-16) +18297*a(n-17) -1782*a(n-18) -28845*a(n-19) -7069*a(n-20) +33095*a(n-21) +2775*a(n-22) -27095*a(n-23) -2505*a(n-24) +18334*a(n-25) +1817*a(n-26) -8564*a(n-27) -484*a(n-28) +3474*a(n-29) -1170*a(n-30) -1450*a(n-31) +1068*a(n-32) +757*a(n-33) -464*a(n-34) -280*a(n-35) +95*a(n-36) +80*a(n-37) -13*a(n-38) -12*a(n-39) +a(n-41) for n>42\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Mar 17 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 4, last modified Mar 17 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 16\,a(n-1) - 52\,a(n-2) + 28\,a(n-3) + 56\,a(n-4) + 123\,a(n-5) - 596\,a(n-6) + \\ 202\,a(n-7) + 1114\,a(n-8) + 244\,a(n-9) - 3131\,a(n-10) - 352\,a(n-11) + 4162\,a(n-12) + \\ 2026\,a(n-13) - 4839\,a(n-14) - 3744\,a(n-15) + 7609\,a(n-16) + 18297\,a(n-17) - 1782\,a(n-18) - \\ 28845\,a(n-19) - 7069\,a(n-20) + 33095\,a(n-21) + 2775\,a(n-22) - 27095\,a(n-23) - 2505\,a(n-24) + \\ 18334\,a(n-25) + 1817\,a(n-26) - 8564\,a(n-27) - 484\,a(n-28) + 3474\,a(n-29) - 1170\,a(n-30) - \\ 1450\,a(n-31) + 1068\,a(n-32) + 757\,a(n-33) - 464\,a(n-34) - 280\,a(n-35) + 95\,a(n-36) + \\ 80\,a(n-37) - 13\,a(n-38) - 12\,a(n-39) + a(n-41). \end{multline*}
...
That refinement leaves $55$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 47$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A300969, the recurrence of order $41$ displayed in Section 1 holds for every $n > 42$, and fails at $n = 42$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,111$. The last nonvanishing one is at $m = 1$, that is at $n = 42$. After it, more than $S = 47$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 37, 459, 5362, 63565, 753471, 8926774, 105763972,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300969}{A300969}, revision 4, last modified Mar 17 2018.
