...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,139$. The last nonvanishing one is at $m = 10$, that is at $n = 45$. After it, more than $S = 70$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
