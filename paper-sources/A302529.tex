...
\title{A proof of the conjectured linear recurrence for OEIS A302529}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302529}{A302529} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays with every element equal to 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -4*a(n-2) +6*a(n-3) -10*a(n-4) -24*a(n-5) +37*a(n-6) -22*a(n-7) +72*a(n-8) +18*a(n-9) -108*a(n-10) +24*a(n-11) -24*a(n-12) +24*a(n-13) +8*a(n-14) -8*a(n-15) for n>17.\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 4\,a(n-2) + 6\,a(n-3) - 10\,a(n-4) - 24\,a(n-5) + 37\,a(n-6) - \\ 22\,a(n-7) + 72\,a(n-8) + 18\,a(n-9) - 108\,a(n-10) + 24\,a(n-11) - 24\,a(n-12) + \\ 24\,a(n-13) + 8\,a(n-14) - 8\,a(n-15). \end{multline*}
...
\begin{theorem} For A302529, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2) + 6\,a(n-3) - 10\,a(n-4) - 24\,a(n-5) + 37\,a(n-6) - 22\,a(n-7) + 72\,a(n-8) + 18\,a(n-9) - 108\,a(n-10) + 24\,a(n-11) - 24\,a(n-12) + 24\,a(n-13) + 8\,a(n-14) - 8\,a(n-15)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,67$. The last nonvanishing one is at $m = 2$, that is at $n = 17$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 10, 28, 42, 100, 290, 730, 1700,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302529}{A302529}, revision 6, last modified Feb 14 2026.
