...
\title{A proof of the conjectured linear recurrence for OEIS A300204}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300204}{A300204} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 15*a(n-1) +4*a(n-2) +22*a(n-3) -200*a(n-4) -372*a(n-5) +49*a(n-6) +405*a(n-7) +898*a(n-8) +427*a(n-9) -28*a(n-10) -359*a(n-11) -196*a(n-12) -30*a(n-13) +64*a(n-14) +24*a(n-15).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 28 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Jan 18 2026, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 15\,a(n-1) + 4\,a(n-2) + 22\,a(n-3) - 200\,a(n-4) - 372\,a(n-5) + 49\,a(n-6) + \\ 405\,a(n-7) + 898\,a(n-8) + 427\,a(n-9) - 28\,a(n-10) - 359\,a(n-11) - 196\,a(n-12) - \\ 30\,a(n-13) + 64\,a(n-14) + 24\,a(n-15). \end{multline*}
...
\begin{theorem} For A300204, the recurrence $a(n) = 15\,a(n-1) + 4\,a(n-2) + 22\,a(n-3) - 200\,a(n-4) - 372\,a(n-5) + 49\,a(n-6) + 405\,a(n-7) + 898\,a(n-8) + 427\,a(n-9) - 28\,a(n-10) - 359\,a(n-11) - 196\,a(n-12) - 30\,a(n-13) + 64\,a(n-14) + 24\,a(n-15)$ holds for every $n \ge 16$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1933, 29561, 451996, 6912249, 105708560, 1616600364,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300204}{A300204}, revision 8, last modified Jan 18 2026.
