...
\title{A proof of the conjectured linear recurrence for OEIS A260837}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260837}{A260837} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +6*a(n-3) -a(n-4) -12*a(n-5) -15*a(n-6) +2*a(n-7) +18*a(n-8) +28*a(n-9) -3*a(n-10) -28*a(n-11) -a(n-12) +9*a(n-13) +12*a(n-14) +10*a(n-15) -19*a(n-16) -36*a(n-17) +4*a(n-18) +10*a(n-19) -4*a(n-20) +23*a(n-21) +a(n-22) -20*a(n-23) +9*a(n-24) +10*a(n-25) -4*a(n-26) +6*a(n-27) +8*a(n-28) -14*a(n-29) +2*a(n-31) -5*a(n-32) +3*a(n-33) for n>34\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 6\,a(n-3) - a(n-4) - 12\,a(n-5) - 15\,a(n-6) + \\ 2\,a(n-7) + 18\,a(n-8) + 28\,a(n-9) - 3\,a(n-10) - 28\,a(n-11) - a(n-12) + \\ 9\,a(n-13) + 12\,a(n-14) + 10\,a(n-15) - 19\,a(n-16) - 36\,a(n-17) + 4\,a(n-18) + \\ 10\,a(n-19) - 4\,a(n-20) + 23\,a(n-21) + a(n-22) - 20\,a(n-23) + 9\,a(n-24) + \\ 10\,a(n-25) - 4\,a(n-26) + 6\,a(n-27) + 8\,a(n-28) - 14\,a(n-29) + 2\,a(n-31) - \\ 5\,a(n-32) + 3\,a(n-33). \end{multline*}
...
\begin{theorem} For A260837, the recurrence of order $33$ displayed in Section 1 holds for every $n > 34$, and fails at $n = 34$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,115$. The last nonvanishing one is at $m = 1$, that is at $n = 34$. After it, more than $S = 49$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 364, 496, 1224, 2235, 2590, 6232, 13170, 17731,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260837}{A260837}, revision 6, last modified Jun 02 2025.
