...
\title{A proof of the conjectured linear recurrence for OEIS A316955}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316955}{A316955} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +9*a(n-2) -14*a(n-3) -52*a(n-4) -33*a(n-5) for n>6\end{quote}
...
\[a(n) = 6\,a(n-1) + 9\,a(n-2) - 14\,a(n-3) - 52\,a(n-4) - 33\,a(n-5).\]
...
\begin{theorem} For A316955, the recurrence $a(n) = 6\,a(n-1) + 9\,a(n-2) - 14\,a(n-3) - 52\,a(n-4) - 33\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,38$. The last nonvanishing one is at $m = 1$, that is at $n = 6$. After it, more than $S = 7$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 220, 1498, 10243, 70037, 478941, 3275421,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316955}{A316955}, revision 4, last modified Jul 17 2018.
