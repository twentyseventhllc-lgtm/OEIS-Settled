...
\title{A proof of the conjectured closed form for OEIS A223860}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223860}{A223860} as

\begin{quote}\itshape Number of n X 4 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (3551/47900160)*n\textasciicircum{}12 + (3551/1995840)*n\textasciicircum{}11 + (100307/4354560)*n\textasciicircum{}10 + (28081/145152)*n\textasciicircum{}9 + (1559477/1451520)*n\textasciicircum{}8 + (14951/3456)*n\textasciicircum{}7 + (54414629/4354560)*n\textasciicircum{}6 + (18845069/725760)*n\textasciicircum{}5 + (41975947/1088640)*n\textasciicircum{}4 + (7155619/181440)*n\textasciicircum{}3 + (694249/83160)*n\textasciicircum{}2 - (7351/990)*n - 11 for n>1.\end{quote}
...
\[a(n) = -11 - \frac{7351}{990}n + \frac{694249}{83160}n^{2} + \frac{7155619}{181440}n^{3} + \frac{41975947}{1088640}n^{4} + \frac{18845069}{725760}n^{5} + \frac{54414629}{4354560}n^{6} + \frac{14951}{3456}n^{7} + \frac{1559477}{1451520}n^{8} + \frac{28081}{145152}n^{9} + \frac{100307}{4354560}n^{10} + \frac{3551}{1995840}n^{11} + \frac{3551}{47900160}n^{12}.\]
...
\begin{theorem} For A223860, $a(n)$ is the polynomial $-11 - \frac{7351}{990}n + \frac{694249}{83160}n^{2} + \frac{7155619}{181440}n^{3} + \frac{41975947}{1088640}n^{4} + \frac{18845069}{725760}n^{5} + \frac{54414629}{4354560}n^{6} + \frac{14951}{3456}n^{7} + \frac{1559477}{1451520}n^{8} + \frac{28081}{145152}n^{9} + \frac{100307}{4354560}n^{10} + \frac{3551}{1995840}n^{11} + \frac{3551}{47900160}n^{12}$ for every $n > 1$, and not at $n = 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $12$ is annihilated by the difference operator $(E-1)^{13}$, whose characteristic polynomial is $(t-1)^{13}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 13 = 135$. Its values were computed exactly; the last nonvanishing one is at $n = 1$, and more than $135$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 130, 3526, 41682, 315124, 1771012, 8008548, 30627033, 102479569,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223860}{A223860}, revision 6, last modified Sep 07 2022.
