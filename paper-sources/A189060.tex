...
\title{A proof of the conjectured linear recurrence for OEIS A189060}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189060}{A189060} as

\begin{quote}\itshape Number of nX5 binary arrays without the pattern 0 1 0 antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 21*a(n-1) -80*a(n-2) -240*a(n-3) +1115*a(n-4) +2917*a(n-5) -15840*a(n-6) +21676*a(n-7) -10784*a(n-8) +1216*a(n-9) for n>10\end{quote}
...
\begin{multline*} a(n) = 21\,a(n-1) - 80\,a(n-2) - 240\,a(n-3) + 1115\,a(n-4) + 2917\,a(n-5) - 15840\,a(n-6) + \\ 21676\,a(n-7) - 10784\,a(n-8) + 1216\,a(n-9). \end{multline*}
...
The reachable part of the digraph has $463$ states, $463$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 15$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $15\times15$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189060, the recurrence $a(n) = 21\,a(n-1) - 80\,a(n-2) - 240\,a(n-3) + 1115\,a(n-4) + 2917\,a(n-5) - 15840\,a(n-6) + 21676\,a(n-7) - 10784\,a(n-8) + 1216\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,46$. The last nonvanishing one is at $m = 1$, that is at $n = 10$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 21, 441, 6768, 99721, 1492864, 22289912, 333124565, 4978704008,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189060}{A189060}, revision 9, last modified Oct 03 2025.
