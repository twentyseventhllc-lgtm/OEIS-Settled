...
\title{A proof of the conjectured linear recurrence for OEIS A297810}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297810}{A297810} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 2 or 3 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +3*a(n-4) +2*a(n-5) -4*a(n-6) -11*a(n-7) -11*a(n-8) -6*a(n-9) +a(n-10) +6*a(n-11) +5*a(n-12) -a(n-14) for n>21\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 3\,a(n-4) + 2\,a(n-5) - 4\,a(n-6) - 11\,a(n-7) - \\ 11\,a(n-8) - 6\,a(n-9) + a(n-10) + 6\,a(n-11) + 5\,a(n-12) - a(n-14). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $76$; neither removal changes any count.
...
\begin{theorem} For A297810, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 3\,a(n-4) + 2\,a(n-5) - 4\,a(n-6) - 11\,a(n-7) - 11\,a(n-8) - 6\,a(n-9) + a(n-10) + 6\,a(n-11) + 5\,a(n-12) - a(n-14)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 7$, that is at $n = 21$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 1, 2, 8, 13, 27, 41, 100,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297810}{A297810}, revision 4, last modified Jan 06 2018.
