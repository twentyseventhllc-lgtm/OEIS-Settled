...
\title{A proof of the conjectured linear recurrence for OEIS A297609}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297609}{A297609} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +7*a(n-2) +13*a(n-3) +52*a(n-4) +19*a(n-5) -36*a(n-6) +2*a(n-7) -98*a(n-8) -31*a(n-9) +32*a(n-10) +22*a(n-11) +6*a(n-12) +a(n-13)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 7\,a(n-2) + 13\,a(n-3) + 52\,a(n-4) + 19\,a(n-5) - 36\,a(n-6) + \\ 2\,a(n-7) - 98\,a(n-8) - 31\,a(n-9) + 32\,a(n-10) + 22\,a(n-11) + 6\,a(n-12) + \\ a(n-13). \end{multline*}
...
\begin{theorem} For A297609, the recurrence $a(n) = 2\,a(n-1) + 7\,a(n-2) + 13\,a(n-3) + 52\,a(n-4) + 19\,a(n-5) - 36\,a(n-6) + 2\,a(n-7) - 98\,a(n-8) - 31\,a(n-9) + 32\,a(n-10) + 22\,a(n-11) + 6\,a(n-12) + a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 35, 181, 787, 3691, 17186, 80140, 371557,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297609}{A297609}, revision 4, last modified Jan 01 2018.
