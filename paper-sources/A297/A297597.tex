...
\title{A proof of the conjectured linear recurrence for OEIS A297597}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297597}{A297597} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 5 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +24*a(n-3) +23*a(n-4) -17*a(n-5) -95*a(n-6) -73*a(n-7) -45*a(n-8) -36*a(n-9) +4*a(n-10) -4*a(n-11) +2*a(n-12)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 23\,a(n-4) - 17\,a(n-5) - 95\,a(n-6) - \\ 73\,a(n-7) - 45\,a(n-8) - 36\,a(n-9) + 4\,a(n-10) - 4\,a(n-11) + 2\,a(n-12). \end{multline*}
...
\begin{theorem} For A297597, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 23\,a(n-4) - 17\,a(n-5) - 95\,a(n-6) - 73\,a(n-7) - 45\,a(n-8) - 36\,a(n-9) + 4\,a(n-10) - 4\,a(n-11) + 2\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 20, 69, 154, 752, 3145, 10131, 37929,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297597}{A297597}, revision 4, last modified Jan 01 2018.
