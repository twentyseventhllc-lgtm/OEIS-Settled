...
\title{A proof of the conjectured linear recurrence for OEIS A297983}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297983}{A297983} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) -a(n-3) +6*a(n-4) -9*a(n-5) -15*a(n-6) +2*a(n-7) -9*a(n-8) +6*a(n-9) +34*a(n-10) +45*a(n-11) +6*a(n-12) -21*a(n-13) -39*a(n-14) +2*a(n-15) -8*a(n-16) -38*a(n-17) -7*a(n-18) +26*a(n-19) -24*a(n-20) -48*a(n-21) +28*a(n-22) +23*a(n-23) -37*a(n-24) -4*a(n-25) +88*a(n-26) +34*a(n-27) -14*a(n-28) +7*a(n-29) +24*a(n-30) -2*a(n-31) -23*a(n-32) -6*a(n-33) -4*a(n-34) -3*a(n-35) -2*a(n-36) -2*a(n-37) for n>43\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) - a(n-3) + 6\,a(n-4) - 9\,a(n-5) - 15\,a(n-6) + \\ 2\,a(n-7) - 9\,a(n-8) + 6\,a(n-9) + 34\,a(n-10) + 45\,a(n-11) + 6\,a(n-12) - \\ 21\,a(n-13) - 39\,a(n-14) + 2\,a(n-15) - 8\,a(n-16) - 38\,a(n-17) - 7\,a(n-18) + \\ 26\,a(n-19) - 24\,a(n-20) - 48\,a(n-21) + 28\,a(n-22) + 23\,a(n-23) - 37\,a(n-24) - \\ 4\,a(n-25) + 88\,a(n-26) + 34\,a(n-27) - 14\,a(n-28) + 7\,a(n-29) + 24\,a(n-30) - \\ 2\,a(n-31) - 23\,a(n-32) - 6\,a(n-33) - 4\,a(n-34) - 3\,a(n-35) - 2\,a(n-36) - \\ 2\,a(n-37). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $244$; neither removal changes any count.
...
That refinement leaves $61$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 53$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A297983, the recurrence of order $37$ displayed in Section 1 holds for every $n > 43$, and fails at $n = 43$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,127$. The last nonvanishing one is at $m = 6$, that is at $n = 43$. After it, more than $S = 53$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 24, 7, 23, 34, 61, 105, 222,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297983}{A297983}, revision 4, last modified Jan 10 2018.
