...
\title{A proof of the conjectured linear recurrence for OEIS A297818}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297818}{A297818} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2 or 3 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) -a(n-3) +7*a(n-4) -a(n-5) +2*a(n-6) +2*a(n-7) +2*a(n-9) for n>11\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) - a(n-3) + 7\,a(n-4) - a(n-5) + 2\,a(n-6) + \\ 2\,a(n-7) + 2\,a(n-9). \end{multline*}
...
\begin{theorem} For A297818, the recurrence $a(n) = 3\,a(n-1) - a(n-2) - a(n-3) + 7\,a(n-4) - a(n-5) + 2\,a(n-6) + 2\,a(n-7) + 2\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,53$. The last nonvanishing one is at $m = 2$, that is at $n = 11$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 17, 48, 146, 399, 1114, 3124, 8861,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297818}{A297818}, revision 4, last modified Jan 06 2018.
