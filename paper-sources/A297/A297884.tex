...
\title{A proof of the conjectured linear recurrence for OEIS A297884}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297884}{A297884} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -2*a(n-2) +2*a(n-3) -6*a(n-4) +2*a(n-5) +5*a(n-7) -a(n-8) -2*a(n-10) for n>11\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) - 6\,a(n-4) + 2\,a(n-5) + 5\,a(n-7) - \\ a(n-8) - 2\,a(n-10). \end{multline*}
...
\begin{theorem} For A297884, the recurrence $a(n) = 3\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) - 6\,a(n-4) + 2\,a(n-5) + 5\,a(n-7) - a(n-8) - 2\,a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,63$. The last nonvanishing one is at $m = 1$, that is at $n = 11$. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 35 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 13, 20, 26, 41, 67, 99, 156,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297884}{A297884}, revision 4, last modified Jan 07 2018.
