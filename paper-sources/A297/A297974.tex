...
\title{A proof of the conjectured linear recurrence for OEIS A297974}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297974}{A297974} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +32*a(n-2) -140*a(n-3) -598*a(n-4) +1159*a(n-5) +5304*a(n-6) -4333*a(n-7) -25781*a(n-8) +7663*a(n-9) +77338*a(n-10) -9186*a(n-11) -146950*a(n-12) +40670*a(n-13) +162366*a(n-14) -251269*a(n-15) -5153*a(n-16) +716034*a(n-17) -170543*a(n-18) -1303137*a(n-19) +206096*a(n-20) +1281221*a(n-21) +682644*a(n-22) -1324101*a(n-23) -1132741*a(n-24) +1131408*a(n-25) +172656*a(n-26) +40049*a(n-27) -568390*a(n-28) -239758*a(n-29) +645066*a(n-30) -100658*a(n-31) -51639*a(n-32) +38776*a(n-33) +33836*a(n-34) +41437*a(n-35) -48047*a(n-36) -59151*a(n-37) +9515*a(n-38) +46874*a(n-39) -834*a(n-40) -25695*a(n-41) +1922*a(n-42) +7078*a(n-43) -1180*a(n-44) -1468*a(n-45) +204*a(n-46) for n>49.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jan 10 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Feb 21 2026, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 7\,a(n-1) + 32\,a(n-2) - 140\,a(n-3) - 598\,a(n-4) + 1159\,a(n-5) + 5304\,a(n-6) - \\ 4333\,a(n-7) - 25781\,a(n-8) + 7663\,a(n-9) + 77338\,a(n-10) - 9186\,a(n-11) - 146950\,a(n-12) + \\ 40670\,a(n-13) + 162366\,a(n-14) - 251269\,a(n-15) - 5153\,a(n-16) + 716034\,a(n-17) - 170543\,a(n-18) - \\ 1303137\,a(n-19) + 206096\,a(n-20) + 1281221\,a(n-21) + 682644\,a(n-22) - 1324101\,a(n-23) - 1132741\,a(n-24) + \\ 1131408\,a(n-25) + 172656\,a(n-26) + 40049\,a(n-27) - 568390\,a(n-28) - 239758\,a(n-29) + 645066\,a(n-30) - \\ 100658\,a(n-31) - 51639\,a(n-32) + 38776\,a(n-33) + 33836\,a(n-34) + 41437\,a(n-35) - 48047\,a(n-36) - \\ 59151\,a(n-37) + 9515\,a(n-38) + 46874\,a(n-39) - 834\,a(n-40) - 25695\,a(n-41) + 1922\,a(n-42) + \\ 7078\,a(n-43) - 1180\,a(n-44) - 1468\,a(n-45) + 204\,a(n-46). \end{multline*}
...
\begin{theorem} For A297974, the recurrence of order $46$ displayed in Section 1 holds for every $n > 49$, and fails at $n = 49$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,128$. The last nonvanishing one is at $m = 3$, that is at $n = 49$. After it, more than $S = 55$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 6, 20, 109, 1042, 7302, 60427, 481401,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297974}{A297974}, revision 6, last modified Feb 21 2026.
