...
\title{A proof of the conjectured linear recurrence for OEIS A297603}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297603}{A297603} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -15*a(n-2) +23*a(n-3) -194*a(n-4) +70*a(n-5) +255*a(n-6) +963*a(n-7) +726*a(n-8) -4023*a(n-9) -2056*a(n-10) +3928*a(n-11) +5067*a(n-12) -6036*a(n-13) -3432*a(n-14) +6721*a(n-15) +3158*a(n-16) -5982*a(n-17) -1559*a(n-18) +1385*a(n-19) +3525*a(n-20) -2268*a(n-21) -1131*a(n-22) +957*a(n-23) +179*a(n-24) -244*a(n-25) -33*a(n-26) +33*a(n-27) +6*a(n-28) -2*a(n-29) +2*a(n-30) +a(n-31) -a(n-32)\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 15\,a(n-2) + 23\,a(n-3) - 194\,a(n-4) + 70\,a(n-5) + 255\,a(n-6) + \\ 963\,a(n-7) + 726\,a(n-8) - 4023\,a(n-9) - 2056\,a(n-10) + 3928\,a(n-11) + 5067\,a(n-12) - \\ 6036\,a(n-13) - 3432\,a(n-14) + 6721\,a(n-15) + 3158\,a(n-16) - 5982\,a(n-17) - 1559\,a(n-18) + \\ 1385\,a(n-19) + 3525\,a(n-20) - 2268\,a(n-21) - 1131\,a(n-22) + 957\,a(n-23) + 179\,a(n-24) - \\ 244\,a(n-25) - 33\,a(n-26) + 33\,a(n-27) + 6\,a(n-28) - 2\,a(n-29) + 2\,a(n-30) + \\ a(n-31) - a(n-32). \end{multline*}
...
\begin{theorem} For A297603, the recurrence of order $32$ displayed in Section 1 holds for every $n \ge 33$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,89$. Every one of them vanished. After it, more than $S = 32$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 96, 787, 6413, 52512, 429491, 3514058, 28752016,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297603}{A297603}, revision 4, last modified Jan 01 2018.
