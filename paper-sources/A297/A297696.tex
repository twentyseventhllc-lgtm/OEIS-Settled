...
\title{A proof of the conjectured linear recurrence for OEIS A297696}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297696}{A297696} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +10*a(n-2) -24*a(n-3) -24*a(n-4) +43*a(n-5) +22*a(n-6) -17*a(n-7) -4*a(n-8) +2*a(n-9)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 10\,a(n-2) - 24\,a(n-3) - 24\,a(n-4) + 43\,a(n-5) + 22\,a(n-6) - \\ 17\,a(n-7) - 4\,a(n-8) + 2\,a(n-9). \end{multline*}
...
\begin{theorem} For A297696, the recurrence $a(n) = 3\,a(n-1) + 10\,a(n-2) - 24\,a(n-3) - 24\,a(n-4) + 43\,a(n-5) + 22\,a(n-6) - 17\,a(n-7) - 4\,a(n-8) + 2\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 19, 95, 293, 1244, 4277, 16931, 61040,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297696}{A297696}, revision 4, last modified Jan 03 2018.
