...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A297221}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297221}{A297221} as

\begin{quote}\itshape Number of n X 5 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 16*a(n-2) + 45*a(n-3) + 39*a(n-4) - 3*a(n-5) - 21*a(n-6) + 8*a(n-7) - 4*a(n-8) + a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(6 + 27*x + 53*x\textasciicircum{}2 + 17*x\textasciicircum{}3 - 58*x\textasciicircum{}4 - 35*x\textasciicircum{}5 + 47*x\textasciicircum{}6 - 13*x\textasciicircum{}7 + x\textasciicircum{}8) / ((1 + 2*x + x\textasciicircum{}2 - x\textasciicircum{}3)*(1 - 3*x - 11*x\textasciicircum{}2 - 19*x\textasciicircum{}3 + 7*x\textasciicircum{}4 - 3*x\textasciicircum{}5 + x\textasciicircum{}6)). - Colin Barker, Feb 26 2019\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 16\,a(n-2) + 45\,a(n-3) + 39\,a(n-4) - 3\,a(n-5) - 21\,a(n-6) + \\ 8\,a(n-7) - 4\,a(n-8) + a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 27x^{2} + 53x^{3} + 17x^{4} - 58x^{5} - 35x^{6} + 47x^{7} - 13x^{8} + x^{9}}{1 - x - 16x^{2} - 45x^{3} - 39x^{4} + 3x^{5} + 21x^{6} - 8x^{7} + 4x^{8} - x^{9}}.\]
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $213$; neither removal changes any count.
...
\begin{theorem} For A297221, the recurrence $a(n) = a(n-1) + 16\,a(n-2) + 45\,a(n-3) + 39\,a(n-4) - 3\,a(n-5) - 21\,a(n-6) + 8\,a(n-7) - 4\,a(n-8) + a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A297221, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 27x^{2} + 53x^{3} + 17x^{4} - 58x^{5} - 35x^{6} + 47x^{7} - 13x^{8} + x^{9}}{1 - x - 16x^{2} - 45x^{3} - 39x^{4} + 3x^{5} + 21x^{6} - 8x^{7} + 4x^{8} - x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 33, 182, 997, 5570, 30946, 171851, 955316,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297221}{A297221}, revision 8, last modified Feb 26 2019.
