...
\title{Proofs of the conjectured column and row recurrences for OEIS A295097}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295097}{A295097} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 3 1s\end{quote}
...
k=1: a(n) = a(n-1) +a(n-3)\\k=2: a(n) = a(n-1) +2*a(n-2) +2*a(n-3) -a(n-5)\\k=3: [order 16]\\k=4: [order 45]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Nov 14 2017). As of revision 4, last modified Nov 14 2017, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A295097, the recurrence $a(n) = a(n-1) + a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A295097, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 2\,a(n-3) - a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A295097, the recurrence $a(n) = 0$ holds for every $n \ge 17$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A295097, the recurrence $a(n) = 0$ holds for every $n \ge 46$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295097}{A295097}, revision 4, last modified Nov 14 2017.
