...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A255021}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255021}{A255021} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(54 + 80*x + 163*x\textasciicircum{}2 + 124*x\textasciicircum{}3 + 10*x\textasciicircum{}4 - 73*x\textasciicircum{}5 - 68*x\textasciicircum{}6 - 31*x\textasciicircum{}7 - 2*x\textasciicircum{}8) / (1 - x - 2*x\textasciicircum{}2 - 6*x\textasciicircum{}3 - 5*x\textasciicircum{}4 - x\textasciicircum{}5 + 2*x\textasciicircum{}6 + 2*x\textasciicircum{}7 + x\textasciicircum{}8). - Colin Barker, Dec 18 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{54x + 80x^{2} + 163x^{3} + 124x^{4} + 10x^{5} - 73x^{6} - 68x^{7} - 31x^{8} - 2x^{9}}{1 - x - 2x^{2} - 6x^{3} - 5x^{4} - x^{5} + 2x^{6} + 2x^{7} + x^{8}}.\]
...
\begin{theorem} For A255021, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 6\,a(n-3) + 5\,a(n-4) + a(n-5) - 2\,a(n-6) - 2\,a(n-7) - a(n-8)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}
...
\begin{theorem} For A255021, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{54x + 80x^{2} + 163x^{3} + 124x^{4} + 10x^{5} - 73x^{6} - 68x^{7} - 31x^{8} - 2x^{9}}{1 - x - 2x^{2} - 6x^{3} - 5x^{4} - x^{5} + 2x^{6} + 2x^{7} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 54, 134, 405, 1121, 3015, 8338, 23077, 63446,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255021}{A255021}, revision 8, last modified Dec 18 2018.
