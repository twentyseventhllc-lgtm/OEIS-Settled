...
\title{A proof of the conjectured linear recurrence for OEIS A317233}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317233}{A317233} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +11*a(n-3) +a(n-4) -18*a(n-5) -48*a(n-6) -31*a(n-7) +19*a(n-8) +50*a(n-9) +34*a(n-10) +2*a(n-11) -4*a(n-12) -3*a(n-13) for n>14\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 11\,a(n-3) + a(n-4) - 18\,a(n-5) - 48\,a(n-6) - \\ 31\,a(n-7) + 19\,a(n-8) + 50\,a(n-9) + 34\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) - \\ 3\,a(n-13). \end{multline*}
...
\begin{theorem} For A317233, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 11\,a(n-3) + a(n-4) - 18\,a(n-5) - 48\,a(n-6) - 31\,a(n-7) + 19\,a(n-8) + 50\,a(n-9) + 34\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) - 3\,a(n-13)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,60$. The last nonvanishing one is at $m = 1$, that is at $n = 14$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 28, 60, 211, 597, 1619, 4792,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317233}{A317233}, revision 4, last modified Jul 24 2018.
