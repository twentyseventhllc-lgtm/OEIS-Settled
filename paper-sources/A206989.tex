...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A206989}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A206989}{A206989} as

\begin{quote}\itshape Number of n X 3 0..1 arrays avoiding 0 0 0 horizontally and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) + 5*a(n-2) + 11*a(n-3) - 5*a(n-4) + a(n-5) - 3*a(n-6) + a(n-7) for n>9.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(1 - x)*(7 + 35*x + 27*x\textasciicircum{}2 + 23*x\textasciicircum{}3 - 13*x\textasciicircum{}4 - 3*x\textasciicircum{}5 - x\textasciicircum{}6 + x\textasciicircum{}7) / (1 - 3*x - 5*x\textasciicircum{}2 - 11*x\textasciicircum{}3 + 5*x\textasciicircum{}4 - x\textasciicircum{}5 + 3*x\textasciicircum{}6 - x\textasciicircum{}7). - Colin Barker, Jun 17 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 14 2012).

The line quoted ending in that signature is contributed by Colin Barker on Jun 17 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 11, last modified Jun 17 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 3\,a(n-1) + 5\,a(n-2) + 11\,a(n-3) - 5\,a(n-4) + a(n-5) - 3\,a(n-6) + \\ a(n-7). \end{multline*}

stated for $n > 9$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x + 28x^{2} - 8x^{3} - 4x^{4} - 36x^{5} + 10x^{6} + 2x^{7} + 2x^{8} - x^{9}}{1 - 3x - 5x^{2} - 11x^{3} + 5x^{4} - x^{5} + 3x^{6} - x^{7}}.\]
...
\begin{theorem} For A206989, the recurrence $a(n) = 3\,a(n-1) + 5\,a(n-2) + 11\,a(n-3) - 5\,a(n-4) + a(n-5) - 3\,a(n-6) + a(n-7)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,44$. The last nonvanishing one is at $m = 2$, that is at $n = 9$. After it, more than $S = 9$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 9$. The theorem is at least as strong.

\begin{theorem} For A206989, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x + 28x^{2} - 8x^{3} - 4x^{4} - 36x^{5} + 10x^{6} + 2x^{7} + 2x^{8} - x^{9}}{1 - 3x - 5x^{2} - 11x^{3} + 5x^{4} - x^{5} + 3x^{6} - x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 174, 840, 3858, 17460, 80070, 365784,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A206989}{A206989}, revision 11, last modified Jun 17 2018.
