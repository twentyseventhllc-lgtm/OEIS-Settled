...
\title{A proof of the conjectured linear recurrence for OEIS A299656}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299656}{A299656} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +3*a(n-2) -6*a(n-3) -18*a(n-4) -15*a(n-5) -17*a(n-6) -32*a(n-7) -12*a(n-8)\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 3\,a(n-2) - 6\,a(n-3) - 18\,a(n-4) - 15\,a(n-5) - 17\,a(n-6) - \\ 32\,a(n-7) - 12\,a(n-8). \end{multline*}
...
\begin{theorem} For A299656, the recurrence $a(n) = 7\,a(n-1) + 3\,a(n-2) - 6\,a(n-3) - 18\,a(n-4) - 15\,a(n-5) - 17\,a(n-6) - 32\,a(n-7) - 12\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 227, 1642, 11888, 86123, 624007, 4521433,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299656}{A299656}, revision 4, last modified Feb 15 2018.
