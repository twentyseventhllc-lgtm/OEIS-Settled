...
\title{A proof of the conjectured linear recurrence for OEIS A240770}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A240770}{A240770} as

\begin{quote}\itshape Number of nX2 0..3 arrays with no element equal to exactly one horizontal or vertical neighbor, with new values 0..3 introduced in row major order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) -36*a(n-2) +4*a(n-3) +51*a(n-4) +74*a(n-5) -105*a(n-6) -60*a(n-7) +22*a(n-8) +66*a(n-9) -27*a(n-10) for n>11\end{quote}
...
\begin{multline*} a(n) = 12\,a(n-1) - 36\,a(n-2) + 4\,a(n-3) + 51\,a(n-4) + 74\,a(n-5) - 105\,a(n-6) - \\ 60\,a(n-7) + 22\,a(n-8) + 66\,a(n-9) - 27\,a(n-10). \end{multline*}
...
The reachable part of the digraph has $690$ states, $337$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 13$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of that $13\times13$ matrix; the bound is computed, not assumed.
...
\begin{theorem} For A240770, the recurrence $a(n) = 12\,a(n-1) - 36\,a(n-2) + 4\,a(n-3) + 51\,a(n-4) + 74\,a(n-5) - 105\,a(n-6) - 60\,a(n-7) + 22\,a(n-8) + 66\,a(n-9) - 27\,a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 5, 28, 196, 1418, 10314, 75138, 547557,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A240770}{A240770}, revision 7, last modified Jul 23 2025.
