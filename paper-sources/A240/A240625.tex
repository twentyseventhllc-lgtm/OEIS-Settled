...
\title{A proof of the conjectured linear recurrence for OEIS A240625}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A240625}{A240625} as

\begin{quote}\itshape Number of nX2 0..3 arrays with no element equal to exactly two horizontal and vertical neighbors, with new values 0..3 introduced in row major order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) -14*a(n-2) -60*a(n-3) +29*a(n-4) +150*a(n-5) -47*a(n-6) -124*a(n-7) -4*a(n-8) +84*a(n-9) -27*a(n-10) for n>11\end{quote}
...
\begin{multline*} a(n) = 14\,a(n-1) - 14\,a(n-2) - 60\,a(n-3) + 29\,a(n-4) + 150\,a(n-5) - 47\,a(n-6) - \\ 124\,a(n-7) - 4\,a(n-8) + 84\,a(n-9) - 27\,a(n-10). \end{multline*}
...
The reachable part of the digraph has $700$ states, $347$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 12$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of that $12\times12$ matrix; the bound is computed, not assumed.
...
\begin{theorem} For A240625, the recurrence $a(n) = 14\,a(n-1) - 14\,a(n-2) - 60\,a(n-3) + 29\,a(n-4) + 150\,a(n-5) - 47\,a(n-6) - 124\,a(n-7) - 4\,a(n-8) + 84\,a(n-9) - 27\,a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,45$. The last nonvanishing one is at $m = 1$, that is at $n = 11$. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 10, 109, 1332, 16624, 208015, 2604059, 32601488,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A240625}{A240625}, revision 7, last modified Jul 23 2025.
