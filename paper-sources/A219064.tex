...
\title{A proof of the conjectured linear recurrence for OEIS A219064}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A219064}{A219064} as

\begin{quote}\itshape Hilltop maps: number of 3Xn binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, diagonal or antidiagonal neighbor in a random 0..2 3Xn array\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +6*a(n-2) +14*a(n-3) +10*a(n-4) +38*a(n-5) +23*a(n-6) -29*a(n-7) -52*a(n-8) -28*a(n-9) for n>10\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 6\,a(n-2) + 14\,a(n-3) + 10\,a(n-4) + 38\,a(n-5) + 23\,a(n-6) - \\ 29\,a(n-7) - 52\,a(n-8) - 28\,a(n-9). \end{multline*}
...
The reachable part of the subset automaton has $221$ states, $221$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 11$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $11\times11$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A219064, the recurrence $a(n) = 7\,a(n-1) + 6\,a(n-2) + 14\,a(n-3) + 10\,a(n-4) + 38\,a(n-5) + 23\,a(n-6) - 29\,a(n-7) - 52\,a(n-8) - 28\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,45$. The last nonvanishing one is at $m = 1$, that is at $n = 10$. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 59, 503, 4049, 32313, 258353, 2066359, 16527691,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A219064}{A219064}, revision 8, last modified Oct 03 2025.
