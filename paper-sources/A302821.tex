...
\title{A proof of the conjectured linear recurrence for OEIS A302821}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302821}{A302821} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -9*a(n-2) +2*a(n-4) -18*a(n-5) +37*a(n-6) +34*a(n-7) +5*a(n-8) -52*a(n-9) -118*a(n-10) -24*a(n-11) +190*a(n-12) +10*a(n-13) -68*a(n-14) +12*a(n-15) for n>16\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 9\,a(n-2) + 2\,a(n-4) - 18\,a(n-5) + 37\,a(n-6) + 34\,a(n-7) + \\ 5\,a(n-8) - 52\,a(n-9) - 118\,a(n-10) - 24\,a(n-11) + 190\,a(n-12) + 10\,a(n-13) - \\ 68\,a(n-14) + 12\,a(n-15). \end{multline*}
...
\begin{theorem} For A302821, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2) + 2\,a(n-4) - 18\,a(n-5) + 37\,a(n-6) + 34\,a(n-7) + 5\,a(n-8) - 52\,a(n-9) - 118\,a(n-10) - 24\,a(n-11) + 190\,a(n-12) + 10\,a(n-13) - 68\,a(n-14) + 12\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 25, 75, 220, 731, 2419, 7900, 25645,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302821}{A302821}, revision 4, last modified Apr 13 2018.
