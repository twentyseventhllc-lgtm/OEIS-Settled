...
\title{A proof of the conjectured linear recurrence for OEIS A297638}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297638}{A297638} as

\begin{quote}\itshape Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 3 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +a(n-2) -a(n-3) +6*a(n-4) -28*a(n-5) -24*a(n-6)\end{quote}
...
\begin{theorem} For A297638, the recurrence $a(n) = 3\,a(n-1) + a(n-2) - a(n-3) + 6\,a(n-4) - 28\,a(n-5) - 24\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 8, 29, 69, 200, 552, 1641, 4685,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297638}{A297638}, revision 4, last modified Jan 02 2018.
