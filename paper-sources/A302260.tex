...
\title{A proof of the conjectured linear recurrence for OEIS A302260}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302260}{A302260} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -2*a(n-2) +2*a(n-3) -54*a(n-4) +16*a(n-5) for n>6.\end{quote}
...
\[a(n) = 6\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) - 54\,a(n-4) + 16\,a(n-5).\]
...
\begin{theorem} For A302260, the recurrence $a(n) = 6\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) - 54\,a(n-4) + 16\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 29, 153, 818, 4386, 23516, 126162, 676988,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302260}{A302260}, revision 6, last modified Jan 16 2024.
