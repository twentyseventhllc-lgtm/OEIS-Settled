...
\title{A proof of the conjectured generating function for OEIS A225012}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A225012}{A225012} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays with rows unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: G.f.: -x*(x\textasciicircum{}2 - 3*x + 3) *(x\textasciicircum{}2 - 2*x + 2) *(x\textasciicircum{}2 - x + 1) *(x\textasciicircum{}4 - 4*x\textasciicircum{}3 + 5*x\textasciicircum{}2 - 2*x + 1) / (x-1)\textasciicircum{}11. - R. J. Mathar, May 17 2014\end{quote}

The line quoted above is contributed by R. J. Mathar on May 17 2014.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 10, last modified May 19 2014, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x - 30x^{2} + 95x^{3} - 200x^{4} + 296x^{5} - 314x^{6} + 239x^{7} - 128x^{8} + 46x^{9} - 10x^{10} + x^{11}}{1 - 11x + 55x^{2} - 165x^{3} + 330x^{4} - 462x^{5} + 462x^{6} - 330x^{7} + 165x^{8} - 55x^{9} + 11x^{10} - x^{11}}.\]
...
\begin{theorem} For A225012, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x - 30x^{2} + 95x^{3} - 200x^{4} + 296x^{5} - 314x^{6} + 239x^{7} - 128x^{8} + 46x^{9} - 10x^{10} + x^{11}}{1 - 11x + 55x^{2} - 165x^{3} + 330x^{4} - 462x^{5} + 462x^{6} - 330x^{7} + 165x^{8} - 55x^{9} + 11x^{10} - x^{11}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 161, 581, 1792, 4900, 12174, 27966,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A225012}{A225012}, revision 10, last modified May 19 2014.
