...
\title{A proof of the conjectured linear recurrence for OEIS A268795}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268795}{A268795} as

\begin{quote}\itshape Number of nX5 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} For A268795, the recurrence of order $26$ displayed in Section 1 holds for every $n > 29$, and fails at $n = 29$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 96, 652, 3384, 23994, 168740, 1158904, 7801688, 51781418,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268795}{A268795}, revision 4, last modified Feb 13 2016.
