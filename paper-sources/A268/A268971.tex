...
\title{Proofs of the conjectured column and row recurrences for OEIS A268971}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268971}{A268971} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once\end{quote}
...
k=1: a(n) = 3*a(n-1)\\k=2: a(n) = 8*a(n-1) -16*a(n-2)\\k=3: a(n) = 12*a(n-1) -36*a(n-2)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 16 2016). As of revision 4, last modified Feb 16 2016, the entry records no proof of any of them and links to none. This note proves the 3 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A268971, the recurrence $a(n) = 3\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A268971, the recurrence $a(n) = 8\,a(n-1) - 16\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A268971, the recurrence $a(n) = 12\,a(n-1) - 36\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268971}{A268971}, revision 4, last modified Feb 16 2016.
