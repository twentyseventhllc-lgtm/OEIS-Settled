...
\title{A proof of the conjectured linear recurrence for OEIS A268806}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268806}{A268806} as

\begin{quote}\itshape Number of nX5 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +41*a(n-2) +54*a(n-3) -509*a(n-4) -2182*a(n-5) -2830*a(n-6) +1766*a(n-7) +7914*a(n-8) +2584*a(n-9) -10583*a(n-10) -6092*a(n-11) +11506*a(n-12) +5348*a(n-13) -11688*a(n-14) -620*a(n-15) +9251*a(n-16) -4462*a(n-17) -3137*a(n-18) +4774*a(n-19) -2365*a(n-20) +338*a(n-21) +198*a(n-22) -106*a(n-23) +12*a(n-24) +4*a(n-25) -a(n-26) for n>29\end{quote}
...
\begin{theorem} For A268806, the recurrence of order $26$ displayed in Section 1 holds for every $n > 29$, and fails at $n = 29$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,86$. The last nonvanishing one is at $m = 3$, that is at $n = 29$. After it, more than $S = 35$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 144, 772, 4158, 28452, 195384, 1316226, 8734264, 57302798,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268806}{A268806}, revision 4, last modified Feb 13 2016.
