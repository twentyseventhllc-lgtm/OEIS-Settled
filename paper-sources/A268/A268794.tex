...
\title{A proof of the conjectured linear recurrence for OEIS A268794}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268794}{A268794} as

\begin{quote}\itshape Number of nX4 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} For A268794, the recurrence $a(n) = 2\,a(n-1) + 19\,a(n-2) + 10\,a(n-3) - 122\,a(n-4) - 320\,a(n-5) - 295\,a(n-6) + 8\,a(n-7) + 176\,a(n-8) + 20\,a(n-9) - 98\,a(n-10) - 6\,a(n-11) + 43\,a(n-12) - 6\,a(n-13) - 11\,a(n-14) + 6\,a(n-15) - a(n-16)$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 36, 234, 950, 4800, 23994, 117062, 561116, 2652936,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268794}{A268794}, revision 4, last modified Feb 13 2016.
