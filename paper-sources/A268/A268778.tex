...
\title{A proof of the conjectured linear recurrence for OEIS A268778}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268778}{A268778} as

\begin{quote}\itshape Number of nX5 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +28*a(n-2) -62*a(n-3) -314*a(n-4) +78*a(n-5) +867*a(n-6) +6*a(n-7) -859*a(n-8) +46*a(n-9) +215*a(n-10) -8*a(n-11) -16*a(n-12)\end{quote}
...
\begin{theorem} For A268778, the recurrence $a(n) = 4\,a(n-1) + 28\,a(n-2) - 62\,a(n-3) - 314\,a(n-4) + 78\,a(n-5) + 867\,a(n-6) + 6\,a(n-7) - 859\,a(n-8) + 46\,a(n-9) + 215\,a(n-10) - 8\,a(n-11) - 16\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 23, 148, 1031, 6383, 38483, 224960, 1288693, 7271509,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268778}{A268778}, revision 4, last modified Feb 13 2016.
