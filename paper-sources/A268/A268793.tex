...
\title{A proof of the conjectured linear recurrence for OEIS A268793}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268793}{A268793} as

\begin{quote}\itshape Number of nX3 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} For A268793, the recurrence $a(n) = 2\,a(n-1) + 9\,a(n-2) - 2\,a(n-3) - 33\,a(n-4) - 42\,a(n-5) - 14\,a(n-6) + 10\,a(n-7) + 8\,a(n-8) - a(n-10)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 78, 248, 950, 3384, 11948, 41248, 140698,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268793}{A268793}, revision 4, last modified Feb 13 2016.
