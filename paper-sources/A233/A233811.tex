...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A233811}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A233811}{A233811} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 30*a(n-2) - 220*a(n-4) + 240*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(24 + 107*x - 264*x\textasciicircum{}2 - 1176*x\textasciicircum{}3 + 312*x\textasciicircum{}4 + 1392*x\textasciicircum{}5) / (1 - 30*x\textasciicircum{}2 + 220*x\textasciicircum{}4 - 240*x\textasciicircum{}6). - Colin Barker, Oct 11 2018\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Oct 11 2018, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{96x + 428x^{2} - 1056x^{3} - 4704x^{4} + 1248x^{5} + 5568x^{6}}{1 - 30x^{2} + 220x^{4} - 240x^{6}}.\]

\section{The object}

The name is read as follows. The reading is not a guess: it is pinned against the entry's own published terms, and against an independent enumeration, before anything is proved (Section 7).

Let $A$ be an $n' \times 2$ array over $\{0,\dots,5\}$ with $n' = n + 1$ rows.
...
\begin{theorem} For A233811, the recurrence $a(n) = 30\,a(n-2) - 220\,a(n-4) + 240\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A233811, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{96x + 428x^{2} - 1056x^{3} - 4704x^{4} + 1248x^{5} + 5568x^{6}}{1 - 30x^{2} + 220x^{4} - 240x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 96, 428, 1824, 8136, 34848, 155488, 667200, 2977440,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A233811}{A233811}, revision 8, last modified Oct 11 2018.
