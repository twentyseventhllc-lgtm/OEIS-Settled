...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A223952}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223952}{A223952} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (2/15)*n\textasciicircum{}5 + (1/6)*n\textasciicircum{}4 + (23/6)*n\textasciicircum{}3 + (89/6)*n\textasciicircum{}2 + (1501/30)*n + 200 for n>3.\end{quote}

\begin{quote}\ttfamily G.f.: x*(32 + 51*x - 382*x\textasciicircum{}2 + 491*x\textasciicircum{}3 + 9*x\textasciicircum{}4 - 348*x\textasciicircum{}5 + 132*x\textasciicircum{}6 + 68*x\textasciicircum{}7 - 37*x\textasciicircum{}8) / (1 - x)\textasciicircum{}6.\end{quote}
...
\[a(n) = 200 + \frac{1501}{30}n + \frac{89}{6}n^{2} + \frac{23}{6}n^{3} + \frac{1}{6}n^{4} + \frac{2}{15}n^{5}.\]

stated for $n > 3$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{32x + 51x^{2} - 382x^{3} + 491x^{4} + 9x^{5} - 348x^{6} + 132x^{7} + 68x^{8} - 37x^{9}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}.\]
...
The refinement, applied first forwards and then in the mirror direction on the edges coming in, leaves $S = 24$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of the $24 \times 24$ quotient matrix. That degree bound is computed here, not assumed, and it is the only one the decision procedure below uses.
...
\begin{theorem} For A223952, $a(n)$ is the polynomial $200 + \frac{1501}{30}n + \frac{89}{6}n^{2} + \frac{23}{6}n^{3} + \frac{1}{6}n^{4} + \frac{2}{15}n^{5}$ for every $n > 3$, and not at $n = 3$.\end{theorem}

{\itshape Proof.} A polynomial of degree $5$ is annihilated by the difference operator $(E-1)^{6}$, whose characteristic polynomial is $(t-1)^{6}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 6 = 30$. Its values were computed exactly; the last nonvanishing one is at $n = 3$, and more than $30$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A223952, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{32x + 51x^{2} - 382x^{3} + 491x^{4} + 9x^{5} - 348x^{6} + 132x^{7} + 68x^{8} - 37x^{9}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}$.\end{theorem}
...
\begin{theorem} For A223952, the recurrence $a(n) = 6\,a(n-1) - 15\,a(n-2) + 20\,a(n-3) - 15\,a(n-4) + 6\,a(n-5) - a(n-6)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 3$, that is at $n = 9$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 33 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 243, 596, 1062, 1821, 3115, 5233, 8564,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223952}{A223952}, revision 7, last modified Aug 24 2018.
