...
\title{A proof of the conjectured closed form for OEIS A223826}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223826}{A223826} as

\begin{quote}\itshape Number of nX3 0..2 arrays with rows and columns unimodal\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (5051/239500800)*n\textasciicircum{}12 + (17911/39916800)*n\textasciicircum{}11 + (113633/21772800)*n\textasciicircum{}10 + (27157/725760)*n\textasciicircum{}9 + (1331621/7257600)*n\textasciicircum{}8 + (36461/57600)*n\textasciicircum{}7 + (35192219/21772800)*n\textasciicircum{}6 + (2190431/725760)*n\textasciicircum{}5 + (24210049/5443200)*n\textasciicircum{}4 + (4187689/907200)*n\textasciicircum{}3 + (882989/207900)*n\textasciicircum{}2 + (2173/990)*n + 1\end{quote}
...
\[a(n) = 1 + \frac{2173}{990}n + \frac{882989}{207900}n^{2} + \frac{4187689}{907200}n^{3} + \frac{24210049}{5443200}n^{4} + \frac{2190431}{725760}n^{5} + \frac{35192219}{21772800}n^{6} + \frac{36461}{57600}n^{7} + \frac{1331621}{7257600}n^{8} + \frac{27157}{725760}n^{9} + \frac{113633}{21772800}n^{10} + \frac{17911}{39916800}n^{11} + \frac{5051}{239500800}n^{12}.\]
...
The refinement, applied first forwards and then in the mirror direction on the edges coming in, leaves $S = 52$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of the $52 \times 52$ quotient matrix. That degree bound is computed here, not assumed, and it is the only one the decision procedure below uses.
...
\begin{theorem} For A223826, $a(n)$ is the polynomial $1 + \frac{2173}{990}n + \frac{882989}{207900}n^{2} + \frac{4187689}{907200}n^{3} + \frac{24210049}{5443200}n^{4} + \frac{2190431}{725760}n^{5} + \frac{35192219}{21772800}n^{6} + \frac{36461}{57600}n^{7} + \frac{1331621}{7257600}n^{8} + \frac{27157}{725760}n^{9} + \frac{113633}{21772800}n^{10} + \frac{17911}{39916800}n^{11} + \frac{5051}{239500800}n^{12}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $12$ is annihilated by the difference operator $(E-1)^{13}$, whose characteristic polynomial is $(t-1)^{13}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 13 = 65$. Its values were computed exactly; all of them vanish, and more than $65$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 22, 484, 6166, 51136, 310396, 1492552, 5995781, 20879061,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223826}{A223826}, revision 8, last modified Oct 03 2025.
