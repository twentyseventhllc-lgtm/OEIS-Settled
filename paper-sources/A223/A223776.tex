...
\title{A proof of the conjectured closed form for OEIS A223776}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223776}{A223776} as

\begin{quote}\itshape Number of nX7 0..1 arrays with rows and columns unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (1/87178291200)*n\textasciicircum{}14 + (1/4151347200)*n\textasciicircum{}13 + (1/106444800)*n\textasciicircum{}12 + (53/319334400)*n\textasciicircum{}11 + (409/87091200)*n\textasciicircum{}10 + (1681/29030400)*n\textasciicircum{}9 + (862999/609638400)*n\textasciicircum{}8 - (56411/29030400)*n\textasciicircum{}7 + (3673639/14515200)*n\textasciicircum{}6 - (4250857/7257600)*n\textasciicircum{}5 + (1960444733/119750400)*n\textasciicircum{}4 - (326164913/4989600)*n\textasciicircum{}3 + (89807927381/151351200)*n\textasciicircum{}2 - (113103797/51480)*n + 3030 for n>4\end{quote}
...
\[a(n) = 3030 - \frac{113103797}{51480}n + \frac{89807927381}{151351200}n^{2} - \frac{326164913}{4989600}n^{3} + \frac{1960444733}{119750400}n^{4} - \frac{4250857}{7257600}n^{5} + \frac{3673639}{14515200}n^{6} - \frac{56411}{29030400}n^{7} + \frac{862999}{609638400}n^{8} + \frac{1681}{29030400}n^{9} + \frac{409}{87091200}n^{10} + \frac{53}{319334400}n^{11} + \frac{1}{106444800}n^{12} + \frac{1}{4151347200}n^{13} + \frac{1}{87178291200}n^{14}.\]
...
\begin{theorem} For A223776, $a(n)$ is the polynomial $3030 - \frac{113103797}{51480}n + \frac{89807927381}{151351200}n^{2} - \frac{326164913}{4989600}n^{3} + \frac{1960444733}{119750400}n^{4} - \frac{4250857}{7257600}n^{5} + \frac{3673639}{14515200}n^{6} - \frac{56411}{29030400}n^{7} + \frac{862999}{609638400}n^{8} + \frac{1681}{29030400}n^{9} + \frac{409}{87091200}n^{10} + \frac{53}{319334400}n^{11} + \frac{1}{106444800}n^{12} + \frac{1}{4151347200}n^{13} + \frac{1}{87178291200}n^{14}$ for every $n > 4$, and not at $n = 4$.\end{theorem}

{\itshape Proof.} A polynomial of degree $14$ is annihilated by the difference operator $(E-1)^{15}$, whose characteristic polynomial is $(t-1)^{15}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 15 = 74$. Its values were computed exactly; the last nonvanishing one is at $n = 4$, and more than $74$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 29, 267, 1269, 4246, 11635, 28346, 64256, 138913,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223776}{A223776}, revision 8, last modified Oct 03 2025.
