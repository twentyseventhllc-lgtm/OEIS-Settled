...
\title{A proof of the conjectured closed form for OEIS A223865}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223865}{A223865} as

\begin{quote}\itshape Number of 2Xn 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (1/19160064)*n\textasciicircum{}12 + (1/456192)*n\textasciicircum{}11 + (2287/43545600)*n\textasciicircum{}10 + (215/290304)*n\textasciicircum{}9 + (3991/580608)*n\textasciicircum{}8 + (2369/53760)*n\textasciicircum{}7 + (8836141/43545600)*n\textasciicircum{}6 + (136571/207360)*n\textasciicircum{}5 + (654599/435456)*n\textasciicircum{}4 + (865283/362880)*n\textasciicircum{}3 + (289699/103950)*n\textasciicircum{}2 + (39143/27720)*n + 1\end{quote}
...
\[a(n) = 1 + \frac{39143}{27720}n + \frac{289699}{103950}n^{2} + \frac{865283}{362880}n^{3} + \frac{654599}{435456}n^{4} + \frac{136571}{207360}n^{5} + \frac{8836141}{43545600}n^{6} + \frac{2369}{53760}n^{7} + \frac{3991}{580608}n^{8} + \frac{215}{290304}n^{9} + \frac{2287}{43545600}n^{10} + \frac{1}{456192}n^{11} + \frac{1}{19160064}n^{12}.\]
...
\begin{theorem} For A223865, $a(n)$ is the polynomial $1 + \frac{39143}{27720}n + \frac{289699}{103950}n^{2} + \frac{865283}{362880}n^{3} + \frac{654599}{435456}n^{4} + \frac{136571}{207360}n^{5} + \frac{8836141}{43545600}n^{6} + \frac{2369}{53760}n^{7} + \frac{3991}{580608}n^{8} + \frac{215}{290304}n^{9} + \frac{2287}{43545600}n^{10} + \frac{1}{456192}n^{11} + \frac{1}{19160064}n^{12}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $12$ is annihilated by the difference operator $(E-1)^{13}$, whose characteristic polynomial is $(t-1)^{13}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 13 = 37$. Its values were computed exactly; all of them vanish, and more than $37$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 684, 3526, 14751, 52591, 165212, 468292,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223865}{A223865}, revision 8, last modified Oct 03 2025.
