...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A223950}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223950}{A223950} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (2/3)*n\textasciicircum{}3 + (3/2)*n\textasciicircum{}2 + (41/6)*n + 2 for n>1.\end{quote}

\begin{quote}\ttfamily G.f.: x*(8 - 5*x - 6*x\textasciicircum{}2 + 10*x\textasciicircum{}3 - 3*x\textasciicircum{}4) / (1 - x)\textasciicircum{}4.\end{quote}
...
\[a(n) = 2 + \frac{41}{6}n + \frac{3}{2}n^{2} + \frac{2}{3}n^{3}.\]

stated for $n > 1$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{8x - 5x^{2} - 6x^{3} + 10x^{4} - 3x^{5}}{1 - 4x + 6x^{2} - 4x^{3} + x^{4}}.\]
...
\begin{theorem} For A223950, $a(n)$ is the polynomial $2 + \frac{41}{6}n + \frac{3}{2}n^{2} + \frac{2}{3}n^{3}$ for every $n > 1$, and not at $n = 1$.\end{theorem}
...
\begin{theorem} For A223950, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{8x - 5x^{2} - 6x^{3} + 10x^{4} - 3x^{5}}{1 - 4x + 6x^{2} - 4x^{3} + x^{4}}$.\end{theorem}
...
\begin{theorem} For A223950, the recurrence $a(n) = 4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) - a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,60$. The last nonvanishing one is at $m = 1$, that is at $n = 5$. After it, more than $S = 8$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 42 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 27, 54, 96, 157, 241, 352, 494,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223950}{A223950}, revision 7, last modified Aug 24 2018.
