...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A223970}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223970}{A223970} as

\begin{quote}\itshape Number of n X 3 0..2 arrays with rows and antidiagonals unimodal\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 22*a(n-1) - 43*a(n-2) - 125*a(n-3) + 283*a(n-4) - 70*a(n-5) - 111*a(n-6) + 45*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(22 - 187*x\textasciicircum{}2 + 236*x\textasciicircum{}3 + 27*x\textasciicircum{}4 - 141*x\textasciicircum{}5 + 45*x\textasciicircum{}6) / ((1 - x)*(1 - 3*x)*(1 - 18*x - 32*x\textasciicircum{}2 + 51*x\textasciicircum{}3 + 17*x\textasciicircum{}4 - 15*x\textasciicircum{}5)). - Colin Barker, Aug 25 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Mar 30 2013).

The line quoted ending in that signature is contributed by Colin Barker on Aug 25 2018.
...
\begin{multline*} a(n) = 22\,a(n-1) - 43\,a(n-2) - 125\,a(n-3) + 283\,a(n-4) - 70\,a(n-5) - 111\,a(n-6) + \\ 45\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{22x - 187x^{3} + 236x^{4} + 27x^{5} - 141x^{6} + 45x^{7}}{1 - 22x + 43x^{2} + 125x^{3} - 283x^{4} + 70x^{5} + 111x^{6} - 45x^{7}}.\]
...
\begin{theorem} For A223970, the recurrence $a(n) = 22\,a(n-1) - 43\,a(n-2) - 125\,a(n-3) + 283\,a(n-4) - 70\,a(n-5) - 111\,a(n-6) + 45\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A223970, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{22x - 187x^{3} + 236x^{4} + 27x^{5} - 141x^{6} + 45x^{7}}{1 - 22x + 43x^{2} + 125x^{3} - 283x^{4} + 70x^{5} + 111x^{6} - 45x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 22, 484, 9515, 186004, 3628696, 70779056, 1380511272, 26926081924,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223970}{A223970}, revision 8, last modified Aug 25 2018.
