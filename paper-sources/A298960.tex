...
\title{A proof of the conjectured linear recurrence for OEIS A298960}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298960}{A298960} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) +5*a(n-4) -9*a(n-5) -a(n-6) -8*a(n-7) +8*a(n-9) -6*a(n-10) +2*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) + 5\,a(n-4) - 9\,a(n-5) - a(n-6) - 8\,a(n-7) + \\ 8\,a(n-9) - 6\,a(n-10) + 2\,a(n-11). \end{multline*}
...
\begin{theorem} For A298960, the recurrence $a(n) = 3\,a(n-1) - a(n-2) + 5\,a(n-4) - 9\,a(n-5) - a(n-6) - 8\,a(n-7) + 8\,a(n-9) - 6\,a(n-10) + 2\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. Every one of them vanished. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 3, 3, 14, 31, 91, 230, 633,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298960}{A298960}, revision 4, last modified Jan 30 2018.
