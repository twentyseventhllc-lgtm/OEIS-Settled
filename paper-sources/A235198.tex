...
k=1: a(n) = 30*a(n-2) -257*a(n-4) +468*a(n-6).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 04 2014). As of revision 8, last modified Jun 19 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
