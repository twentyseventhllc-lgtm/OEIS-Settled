...
\title{A proof of the conjectured linear recurrence for OEIS A207501}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207501}{A207501} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -a(n-2) -10*a(n-3) -3*a(n-4) +28*a(n-5) +4*a(n-6) -32*a(n-7) -15*a(n-8) +26*a(n-9) +8*a(n-10) -6*a(n-11) +8*a(n-12) -4*a(n-13) -13*a(n-14) -2*a(n-15) +11*a(n-16) -2*a(n-17) +a(n-18) -2*a(n-21) +a(n-22)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - a(n-2) - 10\,a(n-3) - 3\,a(n-4) + 28\,a(n-5) + 4\,a(n-6) - \\ 32\,a(n-7) - 15\,a(n-8) + 26\,a(n-9) + 8\,a(n-10) - 6\,a(n-11) + 8\,a(n-12) - \\ 4\,a(n-13) - 13\,a(n-14) - 2\,a(n-15) + 11\,a(n-16) - 2\,a(n-17) + a(n-18) - \\ 2\,a(n-21) + a(n-22). \end{multline*}
...
That refinement leaves $43$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 35$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207501, the recurrence $a(n) = 4\,a(n-1) - a(n-2) - 10\,a(n-3) - 3\,a(n-4) + 28\,a(n-5) + 4\,a(n-6) - 32\,a(n-7) - 15\,a(n-8) + 26\,a(n-9) + 8\,a(n-10) - 6\,a(n-11) + 8\,a(n-12) - 4\,a(n-13) - 13\,a(n-14) - 2\,a(n-15) + 11\,a(n-16) - 2\,a(n-17) + a(n-18) - 2\,a(n-21) + a(n-22)$ holds for every $n \ge 23$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 297, 1004, 2942, 7305, 17911, 40262,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207501}{A207501}, revision 9, last modified Oct 03 2025.
