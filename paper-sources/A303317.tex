...
\title{A proof of the conjectured linear recurrence for OEIS A303317}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303317}{A303317} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) -a(n-2) +11*a(n-3) +21*a(n-4) -13*a(n-5) +5*a(n-6) -37*a(n-7) -34*a(n-8) +4*a(n-9) -20*a(n-10) +18*a(n-11) -7*a(n-12) for n>16.\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) - a(n-2) + 11\,a(n-3) + 21\,a(n-4) - 13\,a(n-5) + 5\,a(n-6) - \\ 37\,a(n-7) - 34\,a(n-8) + 4\,a(n-9) - 20\,a(n-10) + 18\,a(n-11) - 7\,a(n-12). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $136$; neither removal changes any count.
...
\begin{theorem} For A303317, the recurrence $a(n) = 2\,a(n-1) - a(n-2) + 11\,a(n-3) + 21\,a(n-4) - 13\,a(n-5) + 5\,a(n-6) - 37\,a(n-7) - 34\,a(n-8) + 4\,a(n-9) - 20\,a(n-10) + 18\,a(n-11) - 7\,a(n-12)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. The last nonvanishing one is at $m = 4$, that is at $n = 16$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 9, 19, 74, 139, 410, 1799, 5907,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303317}{A303317}, revision 6, last modified Jan 06 2026.
