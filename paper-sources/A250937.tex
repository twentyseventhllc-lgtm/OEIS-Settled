...
\title{A proof of the conjectured linear recurrence for OEIS A250937}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250937}{A250937} as
...
\begin{quote}\ttfamily Empirical: a(n) = 24*a(n-1) -266*a(n-2) +1806*a(n-3) -8400*a(n-4) +28350*a(n-5) -71722*a(n-6) +138498*a(n-7) -205823*a(n-8) +235410*a(n-9) -205548*a(n-10) +134568*a(n-11) -63952*a(n-12) +20832*a(n-13) -4160*a(n-14) +384*a(n-15) for n>21\end{quote}
...
\begin{multline*} a(n) = 24\,a(n-1) - 266\,a(n-2) + 1806\,a(n-3) - 8400\,a(n-4) + 28350\,a(n-5) - 71722\,a(n-6) + \\ 138498\,a(n-7) - 205823\,a(n-8) + 235410\,a(n-9) - 205548\,a(n-10) + 134568\,a(n-11) - 63952\,a(n-12) + \\ 20832\,a(n-13) - 4160\,a(n-14) + 384\,a(n-15). \end{multline*}
...
That refinement leaves $69$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 57$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $3^{32}$ arrays, about $10^{15}$, against $57$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A250937, the recurrence $a(n) = 24\,a(n-1) - 266\,a(n-2) + 1806\,a(n-3) - 8400\,a(n-4) + 28350\,a(n-5) - 71722\,a(n-6) + 138498\,a(n-7) - 205823\,a(n-8) + 235410\,a(n-9) - 205548\,a(n-10) + 134568\,a(n-11) - 63952\,a(n-12) + 20832\,a(n-13) - 4160\,a(n-14) + 384\,a(n-15)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,99$. The last nonvanishing one is at $m = 6$, that is at $n = 21$. After it, more than $S = 57$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 599, 3355, 16208, 71014, 289407, 1115035, 4106983, 14585505,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250937}{A250937}, revision 6, last modified Jul 23 2025.
