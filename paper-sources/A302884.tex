...
\title{A proof of the conjectured linear recurrence for OEIS A302884}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302884}{A302884} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -a(n-2) +5*a(n-3) -3*a(n-4) -9*a(n-5) -3*a(n-6) -8*a(n-7) +4*a(n-8) +8*a(n-9) +4*a(n-10)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - a(n-2) + 5\,a(n-3) - 3\,a(n-4) - 9\,a(n-5) - 3\,a(n-6) - \\ 8\,a(n-7) + 4\,a(n-8) + 8\,a(n-9) + 4\,a(n-10). \end{multline*}
...
\begin{theorem} For A302884, the recurrence $a(n) = 4\,a(n-1) - a(n-2) + 5\,a(n-3) - 3\,a(n-4) - 9\,a(n-5) - 3\,a(n-6) - 8\,a(n-7) + 4\,a(n-8) + 8\,a(n-9) + 4\,a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 12, 37, 141, 569, 2262, 8968, 35667,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302884}{A302884}, revision 4, last modified Apr 15 2018.
