...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207174}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207174}{A207174} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 21*a(n-3) + 5*a(n-4) + 5*a(n-5) - 75*a(n-6) - 50*a(n-7) + 125*a(n-9) for n>11.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(12 + 132*x + 252*x\textasciicircum{}2 + 1341*x\textasciicircum{}3 + 1440*x\textasciicircum{}4 + 180*x\textasciicircum{}5 - 5150*x\textasciicircum{}6 - 9425*x\textasciicircum{}7 - 3500*x\textasciicircum{}8 + 10125*x\textasciicircum{}9 + 10000*x\textasciicircum{}10) / (1 - x - 21*x\textasciicircum{}3 - 5*x\textasciicircum{}4 - 5*x\textasciicircum{}5 + 75*x\textasciicircum{}6 + 50*x\textasciicircum{}7 - 125*x\textasciicircum{}9). - Colin Barker, Jun 21 2018\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 21\,a(n-3) + 5\,a(n-4) + 5\,a(n-5) - 75\,a(n-6) - 50\,a(n-7) + \\ 125\,a(n-9). \end{multline*}

stated for $n > 11$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{12x + 132x^{2} + 252x^{3} + 1341x^{4} + 1440x^{5} + 180x^{6} - 5150x^{7} - 9425x^{8} - 3500x^{9} + 10125x^{10} + 10000x^{11}}{1 - x - 21x^{3} - 5x^{4} - 5x^{5} + 75x^{6} + 50x^{7} - 125x^{9}}.\]
...
That refinement leaves $33$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 11$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207174, the recurrence $a(n) = a(n-1) + 21\,a(n-3) + 5\,a(n-4) + 5\,a(n-5) - 75\,a(n-6) - 50\,a(n-7) + 125\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,49$. The last nonvanishing one is at $m = 2$, that is at $n = 11$. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 11$. The theorem is at least as strong.

\begin{theorem} For A207174, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{12x + 132x^{2} + 252x^{3} + 1341x^{4} + 1440x^{5} + 180x^{6} - 5150x^{7} - 9425x^{8} - 3500x^{9} + 10125x^{10} + 10000x^{11}}{1 - x - 21x^{3} - 5x^{4} - 5x^{5} + 75x^{6} + 50x^{7} - 125x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 396, 1989, 6513, 15789, 54208, 182081,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207174}{A207174}, revision 8, last modified Jun 21 2018.
