...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $62$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,109$. The last nonvanishing one is at $m = 8$, that is at $n = 18$. After it, more than $S = 62$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
