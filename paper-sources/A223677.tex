...
\title{A proof of the conjectured linear recurrence for OEIS A223677}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223677}{A223677} as

\begin{quote}\itshape Number of nX5 0..1 arrays with rows and antidiagonals unimodal\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) -65*a(n-2) +116*a(n-3) -387*a(n-4) -316*a(n-5) +5502*a(n-6) -6052*a(n-7) -5304*a(n-8) +10256*a(n-9) -13182*a(n-10) +1596*a(n-11) +36430*a(n-12) -48912*a(n-13) +27205*a(n-14) -2186*a(n-15) -10400*a(n-16) +7800*a(n-17) -2128*a(n-18) +192*a(n-19)\end{quote}
...
\begin{multline*} a(n) = 16\,a(n-1) - 65\,a(n-2) + 116\,a(n-3) - 387\,a(n-4) - 316\,a(n-5) + 5502\,a(n-6) - \\ 6052\,a(n-7) - 5304\,a(n-8) + 10256\,a(n-9) - 13182\,a(n-10) + 1596\,a(n-11) + 36430\,a(n-12) - \\ 48912\,a(n-13) + 27205\,a(n-14) - 2186\,a(n-15) - 10400\,a(n-16) + 7800\,a(n-17) - 2128\,a(n-18) + \\ 192\,a(n-19). \end{multline*}
...
\begin{theorem} For A223677, the recurrence of order $19$ displayed in Section 1 holds for every $n \ge 20$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 3177, 35509, 384009, 4106403, 43632367, 462307835,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223677}{A223677}, revision 8, last modified Oct 03 2025.
