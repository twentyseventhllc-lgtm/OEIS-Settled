...
\title{A proof of the conjectured linear recurrence for OEIS A258726}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A258726}{A258726} as

\begin{quote}\itshape Number of length n+4 0..3 arrays with at most one downstep in every 4 consecutive neighbor pairs\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -6*a(n-2) +4*a(n-3) +30*a(n-4) -72*a(n-5) +58*a(n-6) -16*a(n-7) -31*a(n-8) +36*a(n-9) -10*a(n-10) +a(n-12)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) + 30\,a(n-4) - 72\,a(n-5) + 58\,a(n-6) - \\ 16\,a(n-7) - 31\,a(n-8) + 36\,a(n-9) - 10\,a(n-10) + a(n-12). \end{multline*}
...
The reachable part of that digraph has $341$ states, $341$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 25$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $25\times25$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A258726, the recurrence $a(n) = 4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) + 30\,a(n-4) - 72\,a(n-5) + 58\,a(n-6) - 16\,a(n-7) - 31\,a(n-8) + 36\,a(n-9) - 10\,a(n-10) + a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 512, 1408, 4184, 12549, 35540, 98676, 281136, 819453,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A258726}{A258726}, revision 6, last modified Jul 23 2025.
