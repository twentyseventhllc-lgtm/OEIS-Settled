...
\title{A proof of the conjectured linear recurrence for OEIS A299517}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299517}{A299517} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A299517, the recurrence of order $34$ displayed in Section 1 holds for every $n > 36$, and fails at $n = 36$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 2, 5, 8, 41, 117, 476, 1743,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299517}{A299517}, revision 4, last modified Feb 11 2018.
