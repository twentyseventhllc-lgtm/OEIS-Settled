...
\title{A proof of the conjectured linear recurrence for OEIS A305584}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305584}{A305584} as

\begin{quote}\itshape Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +5*a(n-2) +33*a(n-3) -14*a(n-4) -54*a(n-5) -238*a(n-6) +86*a(n-7) +54*a(n-8) +467*a(n-9) -144*a(n-10) -48*a(n-11) -378*a(n-12) +144*a(n-13) +324*a(n-15) for n>20\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 5\,a(n-2) + 33\,a(n-3) - 14\,a(n-4) - 54\,a(n-5) - 238\,a(n-6) + \\ 86\,a(n-7) + 54\,a(n-8) + 467\,a(n-9) - 144\,a(n-10) - 48\,a(n-11) - 378\,a(n-12) + \\ 144\,a(n-13) + 324\,a(n-15). \end{multline*}
...
\begin{theorem} For A305584, the recurrence $a(n) = 2\,a(n-1) + 5\,a(n-2) + 33\,a(n-3) - 14\,a(n-4) - 54\,a(n-5) - 238\,a(n-6) + 86\,a(n-7) + 54\,a(n-8) + 467\,a(n-9) - 144\,a(n-10) - 48\,a(n-11) - 378\,a(n-12) + 144\,a(n-13) + 324\,a(n-15)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,71$. The last nonvanishing one is at $m = 5$, that is at $n = 20$. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 13, 33, 102, 327, 1897, 8182, 33142,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305584}{A305584}, revision 4, last modified Jun 05 2018.
