...
\title{Proofs of the conjectured column and row recurrences for OEIS A234738}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234738}{A234738} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 8 (constant-stress 1 X 1 tilings)\end{quote}
...
\begin{quote}\ttfamily Empirical for column k (the k=2 recurrence also works for column 1; apparently every row and column satisfies the same order 23 recurrence):\\
k=1: a(n) = 4*a(n-1) +34*a(n-2) -136*a(n-3) -369*a(n-4) +1476*a(n-5) +1260*a(n-6) -5040*a(n-7).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 30 2013). As of revision 7, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A234738, the recurrence $a(n) = 4\,a(n-1) + 34\,a(n-2) - 136\,a(n-3) - 369\,a(n-4) + 1476\,a(n-5) + 1260\,a(n-6) - 5040\,a(n-7)$ holds for every $n \ge 8$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234738}{A234738}, revision 7, last modified Jun 20 2022.
