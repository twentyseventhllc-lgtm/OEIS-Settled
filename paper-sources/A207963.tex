...
\title{A proof of the conjectured linear recurrence for OEIS A207963}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207963}{A207963} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 27\,a(n-3) + 52\,a(n-4) + 69\,a(n-5) - 35\,a(n-6) - \\ 285\,a(n-7) - 495\,a(n-8) - 186\,a(n-9) + 721\,a(n-10) + 1173\,a(n-11) + 105\,a(n-12) - \\ 1194\,a(n-13) - 703\,a(n-14) + 560\,a(n-15) + 572\,a(n-16) - 197\,a(n-17) - 382\,a(n-18) - \\ 68\,a(n-19) + 154\,a(n-20) + 117\,a(n-21) - a(n-22) - 18\,a(n-23) + 6\,a(n-24) + \\ 3\,a(n-25) + 3\,a(n-27) - a(n-29) - a(n-30) - a(n-31). \end{multline*}
...
\begin{theorem} For A207963, the recurrence of order $31$ displayed in Section 1 holds for every $n > 33$, and fails at $n = 33$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,92$. The last nonvanishing one is at $m = 2$, that is at $n = 33$. After it, more than $S = 34$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 932, 3923, 15839, 66089, 274310, 1137227,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207963}{A207963}, revision 9, last modified Sep 05 2025.
