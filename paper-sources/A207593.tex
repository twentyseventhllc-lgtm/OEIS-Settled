...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207593}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207593}{A207593} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = -a(n-1) + 16*a(n-2) + 18*a(n-3) - 61*a(n-4) - 61*a(n-5) + 66*a(n-6) + 58*a(n-7) - 8*a(n-8) - 8*a(n-9) for n>11.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 18*x*(1 + 19*x + 36*x\textasciicircum{}2 - 148*x\textasciicircum{}3 - 279*x\textasciicircum{}4 + 399*x\textasciicircum{}5 + 594*x\textasciicircum{}6 - 368*x\textasciicircum{}7 - 410*x\textasciicircum{}8 + 44*x\textasciicircum{}9 + 52*x\textasciicircum{}10) / (1 + x - 16*x\textasciicircum{}2 - 18*x\textasciicircum{}3 + 61*x\textasciicircum{}4 + 61*x\textasciicircum{}5 - 66*x\textasciicircum{}6 - 58*x\textasciicircum{}7 + 8*x\textasciicircum{}8 + 8*x\textasciicircum{}9). - Colin Barker, Jun 24 2018\end{quote}
...
\begin{multline*} a(n) = -a(n-1) + 16\,a(n-2) + 18\,a(n-3) - 61\,a(n-4) - 61\,a(n-5) + 66\,a(n-6) + \\ 58\,a(n-7) - 8\,a(n-8) - 8\,a(n-9). \end{multline*}

stated for $n > 11$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{18x + 342x^{2} + 648x^{3} - 2664x^{4} - 5022x^{5} + 7182x^{6} + 10692x^{7} - 6624x^{8} - 7380x^{9} + 792x^{10} + 936x^{11}}{1 + x - 16x^{2} - 18x^{3} + 61x^{4} + 61x^{5} - 66x^{6} - 58x^{7} + 8x^{8} + 8x^{9}}.\]
...
\begin{theorem} For A207593, the recurrence $a(n) = -a(n-1) + 16\,a(n-2) + 18\,a(n-3) - 61\,a(n-4) - 61\,a(n-5) + 66\,a(n-6) + 58\,a(n-7) - 8\,a(n-8) - 8\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,51$. The last nonvanishing one is at $m = 2$, that is at $n = 11$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 11$. The theorem is at least as strong.

\begin{theorem} For A207593, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{18x + 342x^{2} + 648x^{3} - 2664x^{4} - 5022x^{5} + 7182x^{6} + 10692x^{7} - 6624x^{8} - 7380x^{9} + 792x^{10} + 936x^{11}}{1 + x - 16x^{2} - 18x^{3} + 61x^{4} + 61x^{5} - 66x^{6} - 58x^{7} + 8x^{8} + 8x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 18, 324, 612, 2232, 7272, 25776, 85536, 300096,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207593}{A207593}, revision 12, last modified Jun 25 2018.
