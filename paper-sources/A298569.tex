...
\title{A proof of the conjectured linear recurrence for OEIS A298569}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298569}{A298569} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element equal to 0, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +8*a(n-3) -4*a(n-4)\end{quote}
...
\begin{theorem} For A298569, the recurrence $a(n) = a(n-1) + 8\,a(n-3) - 4\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 4, 4, 8, 36, 52, 100, 356,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298569}{A298569}, revision 4, last modified Jan 22 2018.
