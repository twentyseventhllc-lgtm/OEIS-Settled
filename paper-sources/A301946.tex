...
\title{A proof of the conjectured linear recurrence for OEIS A301946}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301946}{A301946} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A301946, the recurrence $a(n) = 4\,a(n-1) + a(n-2) - 2\,a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 5, 20, 83, 342, 1411, 5820, 24007,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301946}{A301946}, revision 4, last modified Mar 29 2018.
