...
\title{A proof of the conjectured linear recurrence for OEIS A207342}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207342}{A207342} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-2) +64*a(n-3) +19*a(n-4) -30*a(n-5) -1264*a(n-6) -412*a(n-7) +509*a(n-8) +11226*a(n-9) +4125*a(n-10) -7984*a(n-11) -48526*a(n-12) -21168*a(n-13) +56453*a(n-14) +90870*a(n-15) +44166*a(n-16) -165266*a(n-17) -604*a(n-18) +11976*a(n-19) +127602*a(n-20) -222084*a(n-21) -139349*a(n-22) +215646*a(n-23) +160783*a(n-24) +133104*a(n-25) -315422*a(n-26) +178506*a(n-27) -76744*a(n-28) +16220*a(n-29) -172129*a(n-30) +47480*a(n-31) +60151*a(n-32) -4410*a(n-33) +6681*a(n-34) +13948*a(n-35) +10141*a(n-36) -9158*a(n-37) -9200*a(n-38) +5102*a(n-39) -3391*a(n-40) -714*a(n-41) +245*a(n-42) +394*a(n-43) +36*a(n-44) +72*a(n-45) +73*a(n-46) +6*a(n-47) -a(n-48) for n>51\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-2) + 64\,a(n-3) + 19\,a(n-4) - 30\,a(n-5) - 1264\,a(n-6) - 412\,a(n-7) + \\ 509\,a(n-8) + 11226\,a(n-9) + 4125\,a(n-10) - 7984\,a(n-11) - 48526\,a(n-12) - 21168\,a(n-13) + \\ 56453\,a(n-14) + 90870\,a(n-15) + 44166\,a(n-16) - 165266\,a(n-17) - 604\,a(n-18) + 11976\,a(n-19) + \\ 127602\,a(n-20) - 222084\,a(n-21) - 139349\,a(n-22) + 215646\,a(n-23) + 160783\,a(n-24) + 133104\,a(n-25) - \\ 315422\,a(n-26) + 178506\,a(n-27) - 76744\,a(n-28) + 16220\,a(n-29) - 172129\,a(n-30) + 47480\,a(n-31) + \\ 60151\,a(n-32) - 4410\,a(n-33) + 6681\,a(n-34) + 13948\,a(n-35) + 10141\,a(n-36) - 9158\,a(n-37) - \\ 9200\,a(n-38) + 5102\,a(n-39) - 3391\,a(n-40) - 714\,a(n-41) + 245\,a(n-42) + 394\,a(n-43) + \\ 36\,a(n-44) + 72\,a(n-45) + 73\,a(n-46) + 6\,a(n-47) - a(n-48). \end{multline*}
...
\begin{theorem} For A207342, the recurrence of order $48$ displayed in Section 1 holds for every $n > 51$, and fails at $n = 51$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,130$. The last nonvanishing one is at $m = 3$, that is at $n = 51$. After it, more than $S = 53$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 192, 828, 3130, 11230, 43260, 163710,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207342}{A207342}, revision 9, last modified Oct 03 2025.
