...
\title{A proof of the conjectured linear recurrence for OEIS A224305}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224305}{A224305} as

\begin{quote}\itshape Number of n X 3 0..2 arrays with diagonals and rows unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -16*a(n-2) -24*a(n-3) -44*a(n-4) +728*a(n-5) -678*a(n-6) -722*a(n-7) -860*a(n-8) +9336*a(n-9) -3916*a(n-10) +792*a(n-11) +320*a(n-12) -11936*a(n-13) +2848*a(n-14) +128*a(n-15) +384*a(n-16) +3840*a(n-17).\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 16\,a(n-2) - 24\,a(n-3) - 44\,a(n-4) + 728\,a(n-5) - 678\,a(n-6) - \\ 722\,a(n-7) - 860\,a(n-8) + 9336\,a(n-9) - 3916\,a(n-10) + 792\,a(n-11) + 320\,a(n-12) - \\ 11936\,a(n-13) + 2848\,a(n-14) + 128\,a(n-15) + 384\,a(n-16) + 3840\,a(n-17). \end{multline*}
...
\begin{theorem} For A224305, the recurrence $a(n) = 10\,a(n-1) - 16\,a(n-2) - 24\,a(n-3) - 44\,a(n-4) + 728\,a(n-5) - 678\,a(n-6) - 722\,a(n-7) - 860\,a(n-8) + 9336\,a(n-9) - 3916\,a(n-10) + 792\,a(n-11) + 320\,a(n-12) - 11936\,a(n-13) + 2848\,a(n-14) + 128\,a(n-15) + 384\,a(n-16) + 3840\,a(n-17)$ holds for every $n \ge 18$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 22, 218, 1586, 11361, 82700, 615481, 4634768, 35003328,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224305}{A224305}, revision 8, last modified Oct 03 2025.
