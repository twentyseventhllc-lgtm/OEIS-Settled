...
\title{A proof of the conjectured linear recurrence for OEIS A197608}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197608}{A197608} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,2,1,1,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +6*a(n-2) +26*a(n-3) +53*a(n-4) +232*a(n-5) +501*a(n-6) +551*a(n-7) -245*a(n-8) -2023*a(n-9) -3810*a(n-10) -8322*a(n-11) -13685*a(n-12) -22140*a(n-13) -25568*a(n-14) -31943*a(n-15) -6603*a(n-16) +38551*a(n-17) +60843*a(n-18) +53444*a(n-19) +38044*a(n-20) +14221*a(n-21) +7417*a(n-22) +70469*a(n-23) +71386*a(n-24) +16860*a(n-25) +14396*a(n-26) +8246*a(n-27) +5868*a(n-28) +2756*a(n-29) +716*a(n-30) +240*a(n-31) +48*a(n-32)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 6\,a(n-2) + 26\,a(n-3) + 53\,a(n-4) + 232\,a(n-5) + 501\,a(n-6) + \\ 551\,a(n-7) - 245\,a(n-8) - 2023\,a(n-9) - 3810\,a(n-10) - 8322\,a(n-11) - 13685\,a(n-12) - \\ 22140\,a(n-13) - 25568\,a(n-14) - 31943\,a(n-15) - 6603\,a(n-16) + 38551\,a(n-17) + 60843\,a(n-18) + \\ 53444\,a(n-19) + 38044\,a(n-20) + 14221\,a(n-21) + 7417\,a(n-22) + 70469\,a(n-23) + 71386\,a(n-24) + \\ 16860\,a(n-25) + 14396\,a(n-26) + 8246\,a(n-27) + 5868\,a(n-28) + 2756\,a(n-29) + 716\,a(n-30) + \\ 240\,a(n-31) + 48\,a(n-32). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $480$; neither removal changes any count.
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $41$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A197608, the recurrence of order $32$ displayed in Section 1 holds for every $n \ge 33$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,100$. Every one of them vanished. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 14, 67, 366, 1840, 9361, 47610, 242254,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197608}{A197608}, revision 9, last modified Oct 03 2025.
