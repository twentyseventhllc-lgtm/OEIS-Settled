...
\title{A proof of the conjectured generating function for OEIS A250750}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250750}{A250750} as
...
\begin{quote}\ttfamily Empirical g.f.: 3*x*(43 - 117*x + 78*x\textasciicircum{}2) / ((1 - x)*(1 - 2*x)*(1 - 3*x)). - Colin Barker, Nov 17 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{129x - 351x^{2} + 234x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}.\]
...
For scale: at $n = 8$ there are $3^{32}$ arrays, about $10^{15}$, against $4$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A250750, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{129x - 351x^{2} + 234x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 129, 423, 1353, 4239, 13089, 40023, 121593, 367839,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250750}{A250750}, revision 8, last modified Nov 17 2018.
