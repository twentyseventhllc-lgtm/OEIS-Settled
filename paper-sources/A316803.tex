...
\title{A proof of the conjectured linear recurrence for OEIS A316803}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316803}{A316803} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -3*a(n-2) +7*a(n-3) -3*a(n-4)\end{quote}
...
\[a(n) = 8\,a(n-1) - 3\,a(n-2) + 7\,a(n-3) - 3\,a(n-4).\]
...
\begin{theorem} For A316803, the recurrence $a(n) = 8\,a(n-1) - 3\,a(n-2) + 7\,a(n-3) - 3\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 247, 1905, 14711, 113606, 877309, 6774916,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316803}{A316803}, revision 4, last modified Jul 14 2018.
