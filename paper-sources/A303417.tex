...
\title{A proof of the conjectured linear recurrence for OEIS A303417}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303417}{A303417} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) +21*a(n-2) +54*a(n-3) -23*a(n-4) -18*a(n-5) -20*a(n-6)\end{quote}
...
\[a(n) = 14\,a(n-1) + 21\,a(n-2) + 54\,a(n-3) - 23\,a(n-4) - 18\,a(n-5) - 20\,a(n-6).\]
...
\begin{theorem} For A303417, the recurrence $a(n) = 14\,a(n-1) + 21\,a(n-2) + 54\,a(n-3) - 23\,a(n-4) - 18\,a(n-5) - 20\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1985, 30897, 480960, 7486369, 116529645, 1813851698,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303417}{A303417}, revision 4, last modified Apr 23 2018.
