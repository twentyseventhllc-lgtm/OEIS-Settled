...
\title{A proof of the conjectured linear recurrence for OEIS A301879}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301879}{A301879} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +6*a(n-2) +2*a(n-3)\end{quote}
...
\begin{theorem} For A301879, the recurrence $a(n) = a(n-1) + 6\,a(n-2) + 2\,a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 10, 29, 95, 289, 917, 2841, 8921,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301879}{A301879}, revision 4, last modified Mar 28 2018.
