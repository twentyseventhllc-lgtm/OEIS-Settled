...
\title{A proof of the conjectured linear recurrence for OEIS A302207}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302207}{A302207} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -2*a(n-2) +9*a(n-3) -13*a(n-4) +2*a(n-5) -12*a(n-6) +12*a(n-7) -16*a(n-9)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 13\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) + \\ 12\,a(n-7) - 16\,a(n-9). \end{multline*}
...
\begin{theorem} For A302207, the recurrence $a(n) = 3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 13\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) + 12\,a(n-7) - 16\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 11, 16, 47, 147, 386, 1065, 3063,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302207}{A302207}, revision 4, last modified Apr 03 2018.
