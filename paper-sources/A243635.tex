...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A243635}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A243635}{A243635} as

\begin{quote}\itshape Number of length n+2 0..4 arrays with no three unequal elements in a row and new values 0..4 introduced in 0..4 order\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(4 - 19*x + 14*x\textasciicircum{}2 + 30*x\textasciicircum{}3 - 20*x\textasciicircum{}4 - 12*x\textasciicircum{}5) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 - 3*x)*(1 - 2*x - x\textasciicircum{}2)). - Colin Barker, Nov 02 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{4x - 19x^{2} + 14x^{3} + 30x^{4} - 20x^{5} - 12x^{6}}{1 - 7x + 14x^{2} - 21x^{4} + 7x^{5} + 6x^{6}}.\]
...
\begin{theorem} For A243635, the recurrence $a(n) = 7\,a(n-1) - 14\,a(n-2) + 21\,a(n-4) - 7\,a(n-5) - 6\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A243635, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{4x - 19x^{2} + 14x^{3} + 30x^{4} - 20x^{5} - 12x^{6}}{1 - 7x + 14x^{2} - 21x^{4} + 7x^{5} + 6x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 9, 21, 51, 127, 324, 844, 2242,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A243635}{A243635}, revision 8, last modified Nov 02 2018.
