...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A253019}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A253019}{A253019} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..3 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-3) -10*a(n-6) +3*a(n-9) for n>11.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(37 + 50*x + 83*x\textasciicircum{}2 - 131*x\textasciicircum{}3 - 167*x\textasciicircum{}4 - 275*x\textasciicircum{}5 + 67*x\textasciicircum{}6 + 59*x\textasciicircum{}7 + 87*x\textasciicircum{}8 - 6*x\textasciicircum{}9 - 3*x\textasciicircum{}10) / ((1 - 3*x\textasciicircum{}3)*(1 - 3*x\textasciicircum{}3 + x\textasciicircum{}6)). - Colin Barker, Dec 08 2018\end{quote}
...
\[a(n) = 6\,a(n-3) - 10\,a(n-6) + 3\,a(n-9).\]

stated for $n > 11$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{37x + 50x^{2} + 83x^{3} - 131x^{4} - 167x^{5} - 275x^{6} + 67x^{7} + 59x^{8} + 87x^{9} - 6x^{10} - 3x^{11}}{1 - 6x^{3} + 10x^{6} - 3x^{9}}.\]
...
\begin{theorem} For A253019, the recurrence $a(n) = 6\,a(n-3) - 10\,a(n-6) + 3\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. The last nonvanishing one is at $m = 2$, that is at $n = 11$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 11$. The theorem is at least as strong.

\begin{theorem} For A253019, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{37x + 50x^{2} + 83x^{3} - 131x^{4} - 167x^{5} - 275x^{6} + 67x^{7} + 59x^{8} + 87x^{9} - 6x^{10} - 3x^{11}}{1 - 6x^{3} + 10x^{6} - 3x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 37 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 37, 50, 83, 91, 133, 223, 243, 357,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A253019}{A253019}, revision 8, last modified Dec 08 2018.
