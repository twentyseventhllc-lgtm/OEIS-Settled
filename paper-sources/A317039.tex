...
\title{A proof of the conjectured linear recurrence for OEIS A317039}
...
\begin{multline*} a(n) = 12\,a(n-1) - 53\,a(n-2) + 212\,a(n-3) - 1067\,a(n-4) + 3283\,a(n-5) - 7149\,a(n-6) + \\ 22550\,a(n-7) - 60499\,a(n-8) + 111428\,a(n-9) - 255645\,a(n-10) + 566156\,a(n-11) - 963436\,a(n-12) + \\ 1783859\,a(n-13) - 2972693\,a(n-14) + 4666054\,a(n-15) - 7467897\,a(n-16) + 8654259\,a(n-17) - 12205787\,a(n-18) + \\ 15382900\,a(n-19) - 8013589\,a(n-20) + 9971092\,a(n-21) + 4366120\,a(n-22) - 38850043\,a(n-23) + 48297824\,a(n-24) - \\ 95813499\,a(n-25) + 154140740\,a(n-26) - 222888798\,a(n-27) + 265742479\,a(n-28) - 255691820\,a(n-29) + 399479858\,a(n-30) - \\ 401654404\,a(n-31) + 385831534\,a(n-32) - 397757831\,a(n-33) + 67971892\,a(n-34) - 270794607\,a(n-35) + 350468437\,a(n-36) + \\ 255979054\,a(n-37) - 209173625\,a(n-38) + 190177950\,a(n-39) - 222665052\,a(n-40) - 131151071\,a(n-41) - 55961197\,a(n-42) - \\ 133828132\,a(n-43) + 99648586\,a(n-44) + 97475736\,a(n-45) + 30041612\,a(n-46) + 11310024\,a(n-47) + 1563480\,a(n-48) - \\ 480320\,a(n-49) - 244512\,a(n-50) + 74432\,a(n-51) + 12032\,a(n-52). \end{multline*}
...
That refinement leaves $68$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 59$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A317039, the recurrence of order $52$ displayed in Section 1 holds for every $n > 55$, and fails at $n = 55$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,138$. The last nonvanishing one is at $m = 3$, that is at $n = 55$. After it, more than $S = 59$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 21, 33, 141, 610, 2516, 14294, 88030,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317039}{A317039}, revision 4, last modified Jul 19 2018.
