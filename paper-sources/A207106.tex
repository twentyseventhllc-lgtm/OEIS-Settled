...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207106}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207106}{A207106} as

\begin{quote}\itshape Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (4/3)*n\textasciicircum{}3 + 8*n\textasciicircum{}2 - (10/3)*n.\end{quote}

\begin{quote}\ttfamily G.f.: 2*x*(3 + 6*x - 5*x\textasciicircum{}2) / (1 - x)\textasciicircum{}4.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 11, last modified Feb 22 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = -\frac{10}{3}n + 8n^{2} + \frac{4}{3}n^{3}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 12x^{2} - 10x^{3}}{1 - 4x + 6x^{2} - 4x^{3} + x^{4}}.\]
...
\begin{theorem} For A207106, $a(n)$ is the polynomial $-\frac{10}{3}n + 8n^{2} + \frac{4}{3}n^{3}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A207106, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 12x^{2} - 10x^{3}}{1 - 4x + 6x^{2} - 4x^{3} + x^{4}}$.\end{theorem}
...
\begin{theorem} For A207106, the recurrence $a(n) = 4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) - a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. Every one of them vanished. After it, more than $S = 6$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 40 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 98, 200, 350, 556, 826, 1168,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207106}{A207106}, revision 11, last modified Feb 22 2018.
