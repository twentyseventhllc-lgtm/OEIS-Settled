...
\title{A proof of the conjectured linear recurrence for OEIS A299076}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299076}{A299076} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +4*a(n-2) +7*a(n-3) -26*a(n-4) -28*a(n-5) -18*a(n-6) -16*a(n-7) +12*a(n-8) +8*a(n-9) +16*a(n-10) for n>11\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 4\,a(n-2) + 7\,a(n-3) - 26\,a(n-4) - 28\,a(n-5) - 18\,a(n-6) - \\ 16\,a(n-7) + 12\,a(n-8) + 8\,a(n-9) + 16\,a(n-10). \end{multline*}
...
\begin{theorem} For A299076, the recurrence $a(n) = 5\,a(n-1) + 4\,a(n-2) + 7\,a(n-3) - 26\,a(n-4) - 28\,a(n-5) - 18\,a(n-6) - 16\,a(n-7) + 12\,a(n-8) + 8\,a(n-9) + 16\,a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 31, 163, 927, 5331, 30535, 175286, 1006611,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299076}{A299076}, revision 4, last modified Feb 02 2018.
