...
\title{A proof of the conjectured linear recurrence for OEIS A234915}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234915}{A234915} as

\begin{quote}\itshape Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings)\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +20*a(n-2) -60*a(n-3) -110*a(n-4) +376*a(n-5) +70*a(n-6) -758*a(n-7) +309*a(n-8) +455*a(n-9) -336*a(n-10) -16*a(n-11) +60*a(n-12) -12*a(n-13).\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 20\,a(n-2) - 60\,a(n-3) - 110\,a(n-4) + 376\,a(n-5) + 70\,a(n-6) - \\ 758\,a(n-7) + 309\,a(n-8) + 455\,a(n-9) - 336\,a(n-10) - 16\,a(n-11) + 60\,a(n-12) - \\ 12\,a(n-13). \end{multline*}
...
\begin{theorem} For A234915, the recurrence $a(n) = 3\,a(n-1) + 20\,a(n-2) - 60\,a(n-3) - 110\,a(n-4) + 376\,a(n-5) + 70\,a(n-6) - 758\,a(n-7) + 309\,a(n-8) + 455\,a(n-9) - 336\,a(n-10) - 16\,a(n-11) + 60\,a(n-12) - 12\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 120, 360, 1128, 3912, 13368, 47980, 169128, 615344,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234915}{A234915}, revision 7, last modified Jun 20 2022.
