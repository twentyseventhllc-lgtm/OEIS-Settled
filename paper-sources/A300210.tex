...
\title{A proof of the conjectured linear recurrence for OEIS A300210}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300210}{A300210} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -4*a(n-2) -8*a(n-3) -15*a(n-4) -4*a(n-5) -25*a(n-6) -44*a(n-7) -12*a(n-8).\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 4\,a(n-2) - 8\,a(n-3) - 15\,a(n-4) - 4\,a(n-5) - 25\,a(n-6) - \\ 44\,a(n-7) - 12\,a(n-8). \end{multline*}
...
\begin{theorem} For A300210, the recurrence $a(n) = 8\,a(n-1) - 4\,a(n-2) - 8\,a(n-3) - 15\,a(n-4) - 4\,a(n-5) - 25\,a(n-6) - 44\,a(n-7) - 12\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 228, 1651, 11965, 86775, 629440, 4566023,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300210}{A300210}, revision 6, last modified Jun 26 2025.
