...
\title{A proof of the conjectured linear recurrence for OEIS A188690}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188690}{A188690} as

\begin{quote}\itshape Number of nX4 binary arrays without the pattern 0 1 0 diagonally, vertically, antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -20*a(n-2) +38*a(n-3) +44*a(n-4) -252*a(n-5) -94*a(n-6) -173*a(n-7) +417*a(n-8) +2548*a(n-9) -384*a(n-10) +1193*a(n-11) -4772*a(n-12) -6984*a(n-13) +6677*a(n-14) -10923*a(n-15) +16477*a(n-16) +4376*a(n-17) -6808*a(n-18) +1546*a(n-19) -4577*a(n-20) +1179*a(n-21) +3261*a(n-22) -1466*a(n-23) -63*a(n-24) +121*a(n-25) -246*a(n-26) +361*a(n-27) -334*a(n-28) -3*a(n-29) +149*a(n-30) -66*a(n-31) +4*a(n-32) +2*a(n-33)\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 20\,a(n-2) + 38\,a(n-3) + 44\,a(n-4) - 252\,a(n-5) - 94\,a(n-6) - \\ 173\,a(n-7) + 417\,a(n-8) + 2548\,a(n-9) - 384\,a(n-10) + 1193\,a(n-11) - 4772\,a(n-12) - \\ 6984\,a(n-13) + 6677\,a(n-14) - 10923\,a(n-15) + 16477\,a(n-16) + 4376\,a(n-17) - 6808\,a(n-18) + \\ 1546\,a(n-19) - 4577\,a(n-20) + 1179\,a(n-21) + 3261\,a(n-22) - 1466\,a(n-23) - 63\,a(n-24) + \\ 121\,a(n-25) - 246\,a(n-26) + 361\,a(n-27) - 334\,a(n-28) - 3\,a(n-29) + 149\,a(n-30) - \\ 66\,a(n-31) + 4\,a(n-32) + 2\,a(n-33). \end{multline*}
...
\begin{theorem} For A188690, the recurrence of order $33$ displayed in Section 1 holds for every $n \ge 34$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 857, 4008, 20662, 120839, 708519, 3984317,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188690}{A188690}, revision 9, last modified Oct 03 2025.
