...
\title{A proof of the conjectured linear recurrence for OEIS A206780}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A206780}{A206780} as

\begin{quote}\itshape Number of nX3 0..1 arrays avoiding 0 0 1 horizontally and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) -10*a(n-2) -23*a(n-3) +57*a(n-4) +6*a(n-5) -75*a(n-6) +21*a(n-7) +34*a(n-8) -13*a(n-9) -5*a(n-10) +2*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) - 10\,a(n-2) - 23\,a(n-3) + 57\,a(n-4) + 6\,a(n-5) - 75\,a(n-6) + \\ 21\,a(n-7) + 34\,a(n-8) - 13\,a(n-9) - 5\,a(n-10) + 2\,a(n-11). \end{multline*}
...
\begin{theorem} For A206780, the recurrence $a(n) = 7\,a(n-1) - 10\,a(n-2) - 23\,a(n-3) + 57\,a(n-4) + 6\,a(n-5) - 75\,a(n-6) + 21\,a(n-7) + 34\,a(n-8) - 13\,a(n-9) - 5\,a(n-10) + 2\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 230, 1020, 4120, 16109, 61003, 227197,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A206780}{A206780}, revision 9, last modified Oct 03 2025.
