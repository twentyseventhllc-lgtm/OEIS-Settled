...
\title{Proofs of the conjectured column and row recurrences for OEIS A275401}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A275401}{A275401} as
...
k=1: a(n) = 2*a(n-1) for n>3\\k=2: [order 9] for n>10\\k=3: [order 24] for n>28\\k=4: [order 65] for n>69\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 26 2016). As of revision 4, last modified Jul 26 2016, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A275401, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n > 3$, and fails at $n = 3$.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A275401, the recurrence $a(n) = 0$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The width is $2$; the digraph has $62$ states, $62$ after trimming, and $S = 11$ blocks after refinement. The model reproduces every published value of column $k = 2$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 10$; after that point more than $S = 11$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$

The entry states this line for $n > 10$; the proved threshold is $n > 10$.

\begin{theorem} For column $k = 3$ of A275401, the recurrence $a(n) = 0$ holds for every $n > 28$, and fails at $n = 28$.\end{theorem}

{\itshape Proof.} The width is $3$; the digraph has $229$ states, $229$ after trimming, and $S = 34$ blocks after refinement. The model reproduces every published value of column $k = 3$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 28$; after that point more than $S = 34$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$

The entry states this line for $n > 28$; the proved threshold is $n > 28$.

\begin{theorem} For column $k = 4$ of A275401, the recurrence $a(n) = 0$ holds for every $n > 69$, and fails at $n = 69$.\end{theorem}

{\itshape Proof.} The width is $4$; the digraph has $985$ states, $985$ after trimming, and $S = 92$ blocks after refinement. The model reproduces every published value of column $k = 4$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 69$; after that point more than $S = 92$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A275401}{A275401}, revision 4, last modified Jul 26 2016.
