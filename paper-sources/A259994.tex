...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A259994}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259994}{A259994} as

\begin{quote}\itshape Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 5*a(n-3) + 7*a(n-4) - 7*a(n-5) - 5*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(48 + 51*x + 185*x\textasciicircum{}2 + 117*x\textasciicircum{}3 - 244*x\textasciicircum{}4 - 62*x\textasciicircum{}5 - 159*x\textasciicircum{}6) / ((1 - x)*(1 - 5*x\textasciicircum{}3 - 12*x\textasciicircum{}4 - 5*x\textasciicircum{}5 - 5*x\textasciicircum{}6)). - Colin Barker, Dec 27 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{48x + 51x^{2} + 185x^{3} + 117x^{4} - 244x^{5} - 62x^{6} - 159x^{7}}{1 - x - 5x^{3} - 7x^{4} + 7x^{5} + 5x^{7}}.\]
...
\begin{theorem} For A259994, the recurrence $a(n) = a(n-1) + 5\,a(n-3) + 7\,a(n-4) - 7\,a(n-5) - 5\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A259994, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{48x + 51x^{2} + 185x^{3} + 117x^{4} - 244x^{5} - 62x^{6} - 159x^{7}}{1 - x - 5x^{3} - 7x^{4} + 7x^{5} + 5x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 48, 99, 284, 641, 1228, 2943, 7284, 15683,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259994}{A259994}, revision 8, last modified Dec 27 2018.
