...
\title{A proof of the conjectured linear recurrence for OEIS A250136}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250136}{A250136} as

\begin{quote}\itshape Number of length n+2 0..4 arrays with the medians of every three consecutive terms nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -10*a(n-2) +50*a(n-3) -155*a(n-4) +211*a(n-5) -786*a(n-6) +1706*a(n-7) -1383*a(n-8) +6007*a(n-9) -8058*a(n-10) +2038*a(n-11) -26882*a(n-12) +10262*a(n-13) +7248*a(n-14) +73688*a(n-15) +44407*a(n-16) -5079*a(n-17) -105040*a(n-18) -155452*a(n-19) -62796*a(n-20) +55668*a(n-21) +163440*a(n-22) +121104*a(n-23) +15552*a(n-24) -53568*a(n-25) -62208*a(n-26) -20736*a(n-27)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 10\,a(n-2) + 50\,a(n-3) - 155\,a(n-4) + 211\,a(n-5) - 786\,a(n-6) + \\ 1706\,a(n-7) - 1383\,a(n-8) + 6007\,a(n-9) - 8058\,a(n-10) + 2038\,a(n-11) - 26882\,a(n-12) + \\ 10262\,a(n-13) + 7248\,a(n-14) + 73688\,a(n-15) + 44407\,a(n-16) - 5079\,a(n-17) - 105040\,a(n-18) - \\ 155452\,a(n-19) - 62796\,a(n-20) + 55668\,a(n-21) + 163440\,a(n-22) + 121104\,a(n-23) + 15552\,a(n-24) - \\ 53568\,a(n-25) - 62208\,a(n-26) - 20736\,a(n-27). \end{multline*}
...
The reachable part of that digraph has $156$ states, $156$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 27$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $27\times27$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A250136, the recurrence of order $27$ displayed in Section 1 holds for every $n \ge 28$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 125, 485, 1827, 6902, 24125, 81664, 274901, 899306,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250136}{A250136}, revision 6, last modified Jul 23 2025.
