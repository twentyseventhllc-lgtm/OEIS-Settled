...
\title{A proof of the conjectured linear recurrence for OEIS A299317}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299317}{A299317} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +15*a(n-2) -12*a(n-3) -117*a(n-4) -82*a(n-5) +220*a(n-6) +455*a(n-7) +187*a(n-8) -278*a(n-9) -592*a(n-10) -695*a(n-11) -353*a(n-12) +604*a(n-13) +404*a(n-14) -92*a(n-15) +874*a(n-16) +845*a(n-17) -523*a(n-18) -728*a(n-19) -234*a(n-20) -26*a(n-21) +90*a(n-22) +42*a(n-23) -39*a(n-24) +15*a(n-25) +40*a(n-26) +4*a(n-27) -8*a(n-28) -2*a(n-29) for n>30\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 15\,a(n-2) - 12\,a(n-3) - 117\,a(n-4) - 82\,a(n-5) + 220\,a(n-6) + \\ 455\,a(n-7) + 187\,a(n-8) - 278\,a(n-9) - 592\,a(n-10) - 695\,a(n-11) - 353\,a(n-12) + \\ 604\,a(n-13) + 404\,a(n-14) - 92\,a(n-15) + 874\,a(n-16) + 845\,a(n-17) - 523\,a(n-18) - \\ 728\,a(n-19) - 234\,a(n-20) - 26\,a(n-21) + 90\,a(n-22) + 42\,a(n-23) - 39\,a(n-24) + \\ 15\,a(n-25) + 40\,a(n-26) + 4\,a(n-27) - 8\,a(n-28) - 2\,a(n-29). \end{multline*}
...
\begin{theorem} For A299317, the recurrence of order $29$ displayed in Section 1 holds for every $n > 30$, and fails at $n = 30$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,92$. The last nonvanishing one is at $m = 1$, that is at $n = 30$. After it, more than $S = 33$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 2, 10, 12, 130, 284, 1557, 5838,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299317}{A299317}, revision 4, last modified Feb 06 2018.
