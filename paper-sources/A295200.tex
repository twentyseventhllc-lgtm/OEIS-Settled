...
\title{A proof of the conjectured linear recurrence for OEIS A295200}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295200}{A295200} as

\begin{quote}\itshape Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 2 or 4 1s\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 13, last modified Aug 27 2022, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\begin{theorem} For A295200, the recurrence $a(n) = 2\,a(n-1) - a(n-2) + 2\,a(n-3) + a(n-4) - 2\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 8, 14, 25, 53, 111, 217,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295200}{A295200}, revision 13, last modified Aug 27 2022.
