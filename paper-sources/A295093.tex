...
\title{A proof of the conjectured linear recurrence for OEIS A295093}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295093}{A295093} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 3 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +2*a(n-2) +12*a(n-3) +24*a(n-4) -12*a(n-5) -192*a(n-6) -183*a(n-7) +99*a(n-8) +13*a(n-9) +377*a(n-10) +690*a(n-11) -19*a(n-12) +305*a(n-13) +358*a(n-14) -841*a(n-15) +269*a(n-16) -2630*a(n-17) -190*a(n-18) -818*a(n-19) -1094*a(n-20) +2834*a(n-21) -1033*a(n-22) +1681*a(n-23) +597*a(n-24) +96*a(n-25) +1650*a(n-26) -332*a(n-27) +101*a(n-28) +59*a(n-29) -804*a(n-30) -338*a(n-31) -291*a(n-32) -285*a(n-33) +50*a(n-34) +18*a(n-35) +29*a(n-36) +26*a(n-37) -30*a(n-38) -20*a(n-39) -10*a(n-40) -5*a(n-41) +9*a(n-42) +7*a(n-43) -a(n-44) -a(n-45)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 24\,a(n-4) - 12\,a(n-5) - 192\,a(n-6) - \\ 183\,a(n-7) + 99\,a(n-8) + 13\,a(n-9) + 377\,a(n-10) + 690\,a(n-11) - 19\,a(n-12) + \\ 305\,a(n-13) + 358\,a(n-14) - 841\,a(n-15) + 269\,a(n-16) - 2630\,a(n-17) - 190\,a(n-18) - \\ 818\,a(n-19) - 1094\,a(n-20) + 2834\,a(n-21) - 1033\,a(n-22) + 1681\,a(n-23) + 597\,a(n-24) + \\ 96\,a(n-25) + 1650\,a(n-26) - 332\,a(n-27) + 101\,a(n-28) + 59\,a(n-29) - 804\,a(n-30) - \\ 338\,a(n-31) - 291\,a(n-32) - 285\,a(n-33) + 50\,a(n-34) + 18\,a(n-35) + 29\,a(n-36) + \\ 26\,a(n-37) - 30\,a(n-38) - 20\,a(n-39) - 10\,a(n-40) - 5\,a(n-41) + 9\,a(n-42) + \\ 7\,a(n-43) - a(n-44) - a(n-45). \end{multline*}
...
\begin{theorem} For A295093, the recurrence of order $45$ displayed in Section 1 holds for every $n \ge 46$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 24, 114, 578, 2859, 14187, 70982, 353880,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295093}{A295093}, revision 4, last modified Nov 14 2017.
