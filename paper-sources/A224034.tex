...
\title{A proof of the conjectured linear recurrence for OEIS A224034}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224034}{A224034} as

\begin{quote}\itshape Number of nX4 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -6*a(n-2) -a(n-3) +2*a(n-4) +2*a(n-5) -2*a(n-6) +4*a(n-7)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 6\,a(n-2) - a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 2\,a(n-6) + \\ 4\,a(n-7). \end{multline*}
...
\begin{theorem} For A224034, the recurrence $a(n) = 5\,a(n-1) - 6\,a(n-2) - a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 2\,a(n-6) + 4\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 19, 58, 168, 488, 1422, 4160, 12214,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224034}{A224034}, revision 8, last modified Oct 03 2025.
