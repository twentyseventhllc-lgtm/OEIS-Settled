...
\title{Proofs of the conjectured column and row recurrences for OEIS A295551}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295551}{A295551} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 3 or 4 1s\end{quote}
...
k=1: a(n) = a(n-1) +a(n-3)\\k=2: a(n) = a(n-1) +2*a(n-2) +2*a(n-3) -a(n-5)\\k=3: [order 17]\\k=4: [order 45]\end{quote}
...
\begin{theorem} For column $k = 1$ of A295551, the recurrence $a(n) = a(n-1) + a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A295551, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 2\,a(n-3) - a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A295551, the recurrence $a(n) = 0$ holds for every $n \ge 18$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A295551, the recurrence $a(n) = 0$ holds for every $n \ge 46$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295551}{A295551}, revision 4, last modified Nov 23 2017.
