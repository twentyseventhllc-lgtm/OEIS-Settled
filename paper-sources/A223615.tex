...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A223615}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223615}{A223615} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with rows and columns unimodal\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (23/360)*n\textasciicircum{}6 + (31/120)*n\textasciicircum{}5 + (8/9)*n\textasciicircum{}4 + (31/24)*n\textasciicircum{}3 + (737/360)*n\textasciicircum{}2 + (29/20)*n + 1.\end{quote}

\begin{quote}\ttfamily G.f.: x*(7 + 44*x\textasciicircum{}2 - 20*x\textasciicircum{}3 + 20*x\textasciicircum{}4 - 6*x\textasciicircum{}5 + x\textasciicircum{}6) / (1 - x)\textasciicircum{}7.\end{quote}
...
\[a(n) = 1 + \frac{29}{20}n + \frac{737}{360}n^{2} + \frac{31}{24}n^{3} + \frac{8}{9}n^{4} + \frac{31}{120}n^{5} + \frac{23}{360}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x + 44x^{3} - 20x^{4} + 20x^{5} - 6x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A223615, $a(n)$ is the polynomial $1 + \frac{29}{20}n + \frac{737}{360}n^{2} + \frac{31}{24}n^{3} + \frac{8}{9}n^{4} + \frac{31}{120}n^{5} + \frac{23}{360}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A223615, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x + 44x^{3} - 20x^{4} + 20x^{5} - 6x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A223615, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. Every one of them vanished. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 240, 876, 2582, 6504, 14547, 29659,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223615}{A223615}, revision 8, last modified Aug 21 2018.
