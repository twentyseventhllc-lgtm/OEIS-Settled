...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A297981}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297981}{A297981} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 2*a(n-2) + a(n-3) - a(n-4) - 4*a(n-6) - 8*a(n-7) - 2*a(n-8) + 4*a(n-9) + 6*a(n-10) + 2*a(n-11) for n>13.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(1 + 5*x - 6*x\textasciicircum{}2 - 10*x\textasciicircum{}3 - 7*x\textasciicircum{}4 + x\textasciicircum{}5 - 6*x\textasciicircum{}6 + 22*x\textasciicircum{}7 + 38*x\textasciicircum{}8 + 14*x\textasciicircum{}9 - 14*x\textasciicircum{}10 - 16*x\textasciicircum{}11 - 4*x\textasciicircum{}12) / ((1 - x)*(1 + x)*(1 - x - x\textasciicircum{}2 - 2*x\textasciicircum{}3 - 2*x\textasciicircum{}5 + 4*x\textasciicircum{}6 + 6*x\textasciicircum{}7 + 6*x\textasciicircum{}8 + 2*x\textasciicircum{}9)). - Colin Barker, Mar 22 2018\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + a(n-3) - a(n-4) - 4\,a(n-6) - 8\,a(n-7) - \\ 2\,a(n-8) + 4\,a(n-9) + 6\,a(n-10) + 2\,a(n-11). \end{multline*}

stated for $n > 13$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{x + 5x^{2} - 6x^{3} - 10x^{4} - 7x^{5} + x^{6} - 6x^{7} + 22x^{8} + 38x^{9} + 14x^{10} - 14x^{11} - 16x^{12} - 4x^{13}}{1 - x - 2x^{2} - x^{3} + x^{4} + 4x^{6} + 8x^{7} + 2x^{8} - 4x^{9} - 6x^{10} - 2x^{11}}.\]
...
The construction gives $72$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $36$; neither removal changes any count.
...
\begin{theorem} For A297981, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + a(n-3) - a(n-4) - 4\,a(n-6) - 8\,a(n-7) - 2\,a(n-8) + 4\,a(n-9) + 6\,a(n-10) + 2\,a(n-11)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,65$. The last nonvanishing one is at $m = 2$, that is at $n = 13$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 13$. The theorem is at least as strong.

\begin{theorem} For A297981, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{x + 5x^{2} - 6x^{3} - 10x^{4} - 7x^{5} + x^{6} - 6x^{7} + 22x^{8} + 38x^{9} + 14x^{10} - 14x^{11} - 16x^{12} - 4x^{13}}{1 - x - 2x^{2} - x^{3} + x^{4} + 4x^{6} + 8x^{7} + 2x^{8} - 4x^{9} - 6x^{10} - 2x^{11}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 35 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 6, 2, 5, 7, 14, 21, 41,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297981}{A297981}, revision 8, last modified Mar 22 2018.
