...
\title{Proofs of the conjectured column and row recurrences for OEIS A252260}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252260}{A252260} as

\begin{quote}\itshape T(n,k)=Number of (n+2)X(k+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 3 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 3 6 or 7\end{quote}
...
k=1: a(n) = 5*a(n-3) +a(n-5) -8*a(n-6) -4*a(n-8) +4*a(n-9) +5*a(n-11) -2*a(n-14) for n>27\end{quote}
...
\begin{theorem} For column $k = 1$ of A252260, the recurrence $a(n) = 5\,a(n-3) + a(n-5) - 8\,a(n-6) - 4\,a(n-8) + 4\,a(n-9) + 5\,a(n-11) - 2\,a(n-14)$ holds for every $n > 27$, and fails at $n = 27$.\end{theorem}

{\itshape Proof.} The width is $3$; the digraph has $4160$ states, $4160$ after trimming, and $S = 73$ blocks after refinement. The model reproduces every published value of column $k = 1$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 27$; after that point more than $S = 73$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252260}{A252260}, revision 6, last modified Jun 02 2025.
