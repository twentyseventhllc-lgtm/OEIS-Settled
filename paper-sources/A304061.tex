...
\title{A proof of the conjectured linear recurrence for OEIS A304061}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304061}{A304061} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +37*a(n-2) -38*a(n-3) -707*a(n-4) -616*a(n-5) +4092*a(n-6) +8653*a(n-7) -5001*a(n-8) -30067*a(n-9) -22368*a(n-10) +31730*a(n-11) +68640*a(n-12) +22165*a(n-13) -61965*a(n-14) -109903*a(n-15) -78019*a(n-16) +97476*a(n-17) +294883*a(n-18) +190465*a(n-19) -201904*a(n-20) -445993*a(n-21) -244956*a(n-22) +202931*a(n-23) +428079*a(n-24) +228808*a(n-25) -144476*a(n-26) -278161*a(n-27) -113821*a(n-28) +63344*a(n-29) +93553*a(n-30) +34356*a(n-31) -17292*a(n-32) -24767*a(n-33) -6317*a(n-34) +5347*a(n-35) +2607*a(n-36) -166*a(n-37) -70*a(n-38) -46*a(n-39) -42*a(n-40) +2*a(n-42) for n>43\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 37\,a(n-2) - 38\,a(n-3) - 707\,a(n-4) - 616\,a(n-5) + 4092\,a(n-6) + \\ 8653\,a(n-7) - 5001\,a(n-8) - 30067\,a(n-9) - 22368\,a(n-10) + 31730\,a(n-11) + 68640\,a(n-12) + \\ 22165\,a(n-13) - 61965\,a(n-14) - 109903\,a(n-15) - 78019\,a(n-16) + 97476\,a(n-17) + 294883\,a(n-18) + \\ 190465\,a(n-19) - 201904\,a(n-20) - 445993\,a(n-21) - 244956\,a(n-22) + 202931\,a(n-23) + 428079\,a(n-24) + \\ 228808\,a(n-25) - 144476\,a(n-26) - 278161\,a(n-27) - 113821\,a(n-28) + 63344\,a(n-29) + 93553\,a(n-30) + \\ 34356\,a(n-31) - 17292\,a(n-32) - 24767\,a(n-33) - 6317\,a(n-34) + 5347\,a(n-35) + 2607\,a(n-36) - \\ 166\,a(n-37) - 70\,a(n-38) - 46\,a(n-39) - 42\,a(n-40) + 2\,a(n-42). \end{multline*}
...
\begin{theorem} For A304061, the recurrence of order $42$ displayed in Section 1 holds for every $n > 43$, and fails at $n = 43$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,121$. The last nonvanishing one is at $m = 1$, that is at $n = 43$. After it, more than $S = 53$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 18, 69, 661, 5580, 48148, 418382, 3621421,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304061}{A304061}, revision 4, last modified May 05 2018.
