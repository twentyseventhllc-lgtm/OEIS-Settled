...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207592}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207592}{A207592} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = -a(n-1) + 11*a(n-2) + 13*a(n-3) - 18*a(n-4) - 18*a(n-5) + 6*a(n-6) + 4*a(n-7) for n>9.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 13*x*(1 + 14*x + 26*x\textasciicircum{}2 - 54*x\textasciicircum{}3 - 99*x\textasciicircum{}4 + 66*x\textasciicircum{}5 + 86*x\textasciicircum{}6 - 20*x\textasciicircum{}7 - 16*x\textasciicircum{}8) / ((1 + x)*(1 - 11*x\textasciicircum{}2 - 2*x\textasciicircum{}3 + 20*x\textasciicircum{}4 - 2*x\textasciicircum{}5 - 4*x\textasciicircum{}6)). - Colin Barker, Jun 24 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 19 2012).

The line quoted ending in that signature is contributed by Colin Barker on Jun 24 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 12, last modified Jun 24 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = -a(n-1) + 11\,a(n-2) + 13\,a(n-3) - 18\,a(n-4) - 18\,a(n-5) + 6\,a(n-6) + \\ 4\,a(n-7). \end{multline*}

stated for $n > 9$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{13x + 182x^{2} + 338x^{3} - 702x^{4} - 1287x^{5} + 858x^{6} + 1118x^{7} - 260x^{8} - 208x^{9}}{1 + x - 11x^{2} - 13x^{3} + 18x^{4} + 18x^{5} - 6x^{6} - 4x^{7}}.\]
...
\begin{theorem} For A207592, the recurrence $a(n) = -a(n-1) + 11\,a(n-2) + 13\,a(n-3) - 18\,a(n-4) - 18\,a(n-5) + 6\,a(n-6) + 4\,a(n-7)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,48$. The last nonvanishing one is at $m = 2$, that is at $n = 9$. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 9$. The theorem is at least as strong.

\begin{theorem} For A207592, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{13x + 182x^{2} + 338x^{3} - 702x^{4} - 1287x^{5} + 858x^{6} + 1118x^{7} - 260x^{8} - 208x^{9}}{1 + x - 11x^{2} - 13x^{3} + 18x^{4} + 18x^{5} - 6x^{6} - 4x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 312, 1014, 3094, 9698, 30056, 93782,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207592}{A207592}, revision 12, last modified Jun 24 2018.
