...
\title{A proof of the conjectured linear recurrence for OEIS A297677}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297677}{A297677} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 4 neighboring 1's\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -a(n-2) +8*a(n-3) -5*a(n-4) -30*a(n-5) +17*a(n-6).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jan 03 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Apr 20 2021, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = 5\,a(n-1) - a(n-2) + 8\,a(n-3) - 5\,a(n-4) - 30\,a(n-5) + 17\,a(n-6).\]
...
\begin{theorem} For A297677, the recurrence $a(n) = 5\,a(n-1) - a(n-2) + 8\,a(n-3) - 5\,a(n-4) - 30\,a(n-5) + 17\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 29, 150, 742, 3744, 18840, 94891, 477850,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297677}{A297677}, revision 6, last modified Apr 20 2021.
