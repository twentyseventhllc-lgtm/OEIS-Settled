...
k=1: a(n) = 2*a(n-1) -a(n-2) +a(n-3).\\k=2: a(n) = 3*a(n-1) -a(n-2) +8*a(n-3) -12*a(n-4) +2*a(n-5) -12*a(n-6).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 19 2017). As of revision 6, last modified Sep 04 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
