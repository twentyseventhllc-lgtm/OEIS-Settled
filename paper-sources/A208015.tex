...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208015}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208015}{A208015} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 23*a(n-3) + 6*a(n-4) + 6*a(n-5) - 108*a(n-6) - 72*a(n-7) + 216*a(n-9) for n>11.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(12 + 132*x + 276*x\textasciicircum{}2 + 1247*x\textasciicircum{}3 + 625*x\textasciicircum{}4 - 324*x\textasciicircum{}5 - 7377*x\textasciicircum{}6 - 9090*x\textasciicircum{}7 - 846*x\textasciicircum{}8 + 17064*x\textasciicircum{}9 + 7884*x\textasciicircum{}10) / (1 - x - 23*x\textasciicircum{}3 - 6*x\textasciicircum{}4 - 6*x\textasciicircum{}5 + 108*x\textasciicircum{}6 + 72*x\textasciicircum{}7 - 216*x\textasciicircum{}9). - Colin Barker, Jun 26 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 22 2012).

The line quoted ending in that signature is contributed by Colin Barker on Jun 26 2018.
...
\begin{multline*} a(n) = a(n-1) + 23\,a(n-3) + 6\,a(n-4) + 6\,a(n-5) - 108\,a(n-6) - 72\,a(n-7) + \\ 216\,a(n-9). \end{multline*}

stated for $n > 11$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{12x + 132x^{2} + 276x^{3} + 1247x^{4} + 625x^{5} - 324x^{6} - 7377x^{7} - 9090x^{8} - 846x^{9} + 17064x^{10} + 7884x^{11}}{1 - x - 23x^{3} - 6x^{4} - 6x^{5} + 108x^{6} + 72x^{7} - 216x^{9}}.\]
...
That refinement leaves $31$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 12$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A208015, the recurrence $a(n) = a(n-1) + 23\,a(n-3) + 6\,a(n-4) + 6\,a(n-5) - 108\,a(n-6) - 72\,a(n-7) + 216\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\begin{theorem} For A208015, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{12x + 132x^{2} + 276x^{3} + 1247x^{4} + 625x^{5} - 324x^{6} - 7377x^{7} - 9090x^{8} - 846x^{9} + 17064x^{10} + 7884x^{11}}{1 - x - 23x^{3} - 6x^{4} - 6x^{5} + 108x^{6} + 72x^{7} - 216x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 420, 1943, 5952, 16224, 55624, 181192,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208015}{A208015}, revision 8, last modified Jun 26 2018.
