...
\title{A proof of the conjectured linear recurrence for OEIS A295777}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295777}{A295777} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 adjacent to 0 or 2 king-move neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +6*a(n-2) +6*a(n-3) -58*a(n-4) -20*a(n-5) +29*a(n-6) -92*a(n-7) +7*a(n-8) +2*a(n-9) -2*a(n-10)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 6\,a(n-2) + 6\,a(n-3) - 58\,a(n-4) - 20\,a(n-5) + 29\,a(n-6) - \\ 92\,a(n-7) + 7\,a(n-8) + 2\,a(n-9) - 2\,a(n-10). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $89$; neither removal changes any count.
...
\begin{theorem} For A295777, the recurrence $a(n) = 4\,a(n-1) + 6\,a(n-2) + 6\,a(n-3) - 58\,a(n-4) - 20\,a(n-5) + 29\,a(n-6) - 92\,a(n-7) + 7\,a(n-8) + 2\,a(n-9) - 2\,a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 49, 198, 1059, 5263, 25529, 127731, 630988,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295777}{A295777}, revision 4, last modified Nov 27 2017.
