...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234228}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234228}{A234228} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 182*a(n-2) - 9024*a(n-4) + 66960*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(142 + 1315*x - 13696*x\textasciicircum{}2 - 126860*x\textasciicircum{}3 + 110640*x\textasciicircum{}4 + 1033800*x\textasciicircum{}5) / ((1 - 90*x\textasciicircum{}2)*(1 - 92*x\textasciicircum{}2 + 744*x\textasciicircum{}4)). - Colin Barker, Oct 14 2018\end{quote}
...
\[a(n) = 182\,a(n-2) - 9024\,a(n-4) + 66960\,a(n-6).\]
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{568x + 5260x^{2} - 54784x^{3} - 507440x^{4} + 442560x^{5} + 4135200x^{6}}{1 - 182x^{2} + 9024x^{4} - 66960x^{6}}.\]
...
\begin{theorem} For A234228, the recurrence $a(n) = 182\,a(n-2) - 9024\,a(n-4) + 66960\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234228, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{568x + 5260x^{2} - 54784x^{3} - 507440x^{4} + 442560x^{5} + 4135200x^{6}}{1 - 182x^{2} + 9024x^{4} - 66960x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 568, 5260, 48592, 449880, 4160672, 38547120, 356781376, 3308068320,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234228}{A234228}, revision 13, last modified Jun 20 2022.
