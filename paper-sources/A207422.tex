...
\title{A proof of the conjectured linear recurrence for OEIS A207422}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207422}{A207422} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +a(n-2) +8*a(n-3) -21*a(n-4) -46*a(n-5) -6*a(n-6) +35*a(n-7) +49*a(n-8) +19*a(n-9) -16*a(n-10) -21*a(n-11) -4*a(n-13) -2*a(n-14) +a(n-15)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + a(n-2) + 8\,a(n-3) - 21\,a(n-4) - 46\,a(n-5) - 6\,a(n-6) + \\ 35\,a(n-7) + 49\,a(n-8) + 19\,a(n-9) - 16\,a(n-10) - 21\,a(n-11) - 4\,a(n-13) - \\ 2\,a(n-14) + a(n-15). \end{multline*}
...
\begin{theorem} For A207422, the recurrence $a(n) = 4\,a(n-1) + a(n-2) + 8\,a(n-3) - 21\,a(n-4) - 46\,a(n-5) - 6\,a(n-6) + 35\,a(n-7) + 49\,a(n-8) + 19\,a(n-9) - 16\,a(n-10) - 21\,a(n-11) - 4\,a(n-13) - 2\,a(n-14) + a(n-15)$ holds for every $n \ge 16$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 361, 1521, 6889, 29929, 127449, 546121,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207422}{A207422}, revision 9, last modified Oct 03 2025.
