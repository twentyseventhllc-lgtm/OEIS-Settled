...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $45$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,94$. The last nonvanishing one is at $m = 3$, that is at $n = 23$. After it, more than $S = 45$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
