...
\title{A proof of the conjectured linear recurrence for OEIS A242470}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A242470}{A242470} as

\begin{quote}\itshape Number of length n+2 0..7 arrays with no three equal elements in a row and new values 0..7 introduced in 0..7 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 22*a(n-1) -168*a(n-2) +440*a(n-3) +421*a(n-4) -2898*a(n-5) -924*a(n-6) +7944*a(n-7) +5931*a(n-8) -6610*a(n-9) -10562*a(n-10) -5040*a(n-11) -840*a(n-12)\end{quote}
...
\begin{multline*} a(n) = 22\,a(n-1) - 168\,a(n-2) + 440\,a(n-3) + 421\,a(n-4) - 2898\,a(n-5) - 924\,a(n-6) + \\ 7944\,a(n-7) + 5931\,a(n-8) - 6610\,a(n-9) - 10562\,a(n-10) - 5040\,a(n-11) - 840\,a(n-12). \end{multline*}
...
\begin{theorem} For A242470, the recurrence $a(n) = 22\,a(n-1) - 168\,a(n-2) + 440\,a(n-3) + 421\,a(n-4) - 2898\,a(n-5) - 924\,a(n-6) + 7944\,a(n-7) + 5931\,a(n-8) - 6610\,a(n-9) - 10562\,a(n-10) - 5040\,a(n-11) - 840\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 41, 159, 685, 3233, 16533, 90817,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A242470}{A242470}, revision 6, last modified Jul 23 2025.
