...
\title{A proof of the conjectured linear recurrence for OEIS A299092}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299092}{A299092} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -3*a(n-2) +4*a(n-3) -23*a(n-4) +18*a(n-5) -8*a(n-6) +47*a(n-7) -29*a(n-8) +26*a(n-9) -66*a(n-10) +17*a(n-11) -29*a(n-12) +46*a(n-13) -3*a(n-14) +18*a(n-15) -18*a(n-16) for n>17\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 3\,a(n-2) + 4\,a(n-3) - 23\,a(n-4) + 18\,a(n-5) - 8\,a(n-6) + \\ 47\,a(n-7) - 29\,a(n-8) + 26\,a(n-9) - 66\,a(n-10) + 17\,a(n-11) - 29\,a(n-12) + \\ 46\,a(n-13) - 3\,a(n-14) + 18\,a(n-15) - 18\,a(n-16). \end{multline*}
...
\begin{theorem} For A299092, the recurrence $a(n) = 4\,a(n-1) - 3\,a(n-2) + 4\,a(n-3) - 23\,a(n-4) + 18\,a(n-5) - 8\,a(n-6) + 47\,a(n-7) - 29\,a(n-8) + 26\,a(n-9) - 66\,a(n-10) + 17\,a(n-11) - 29\,a(n-12) + 46\,a(n-13) - 3\,a(n-14) + 18\,a(n-15) - 18\,a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 13, 20, 41, 101, 242, 578, 1385,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299092}{A299092}, revision 4, last modified Feb 02 2018.
