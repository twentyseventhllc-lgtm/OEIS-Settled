...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234674}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234674}{A234674} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 22*a(n-2) - 120*a(n-4).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(28 + 101*x - 300*x\textasciicircum{}2 - 1080*x\textasciicircum{}3) / ((1 - 10*x\textasciicircum{}2)*(1 - 12*x\textasciicircum{}2)). - Colin Barker, Oct 16 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{112x + 404x^{2} - 1200x^{3} - 4320x^{4}}{1 - 22x^{2} + 120x^{4}}.\]
...
\begin{theorem} For A234674, the recurrence $a(n) = 22\,a(n-2) - 120\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234674, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{112x + 404x^{2} - 1200x^{3} - 4320x^{4}}{1 - 22x^{2} + 120x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 112, 404, 1264, 4568, 14368, 52016, 164416, 596192,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234674}{A234674}, revision 9, last modified Jun 19 2022.
