...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234491}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234491}{A234491} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) + 74*a(n-2) - 295*a(n-3) - 1008*a(n-4) + 840*a(n-5).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(125 + 292*x - 7103*x\textasciicircum{}2 - 15072*x\textasciicircum{}3 + 14760*x\textasciicircum{}4) / ((1 - 56*x\textasciicircum{}2)*(1 - 5*x - 18*x\textasciicircum{}2 + 15*x\textasciicircum{}3)). - Colin Barker, Oct 15 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{250x + 584x^{2} - 14206x^{3} - 30144x^{4} + 29520x^{5}}{1 - 5x - 74x^{2} + 295x^{3} + 1008x^{4} - 840x^{5}}.\]
...
\begin{theorem} For A234491, the recurrence $a(n) = 5\,a(n-1) + 74\,a(n-2) - 295\,a(n-3) - 1008\,a(n-4) + 840\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234491, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{250x + 584x^{2} - 14206x^{3} - 30144x^{4} + 29520x^{5}}{1 - 5x - 74x^{2} + 295x^{3} + 1008x^{4} - 840x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 250, 1834, 13464, 99142, 728536, 5368636, 39476802, 291119578,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234491}{A234491}, revision 13, last modified Jun 20 2022.
