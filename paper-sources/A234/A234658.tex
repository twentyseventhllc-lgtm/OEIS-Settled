...
\title{Proofs of the conjectured column and row recurrences for OEIS A234658}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234658}{A234658} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings)\end{quote}
...
k=1: a(n) = 4*a(n-1) +44*a(n-2) -176*a(n-3) -480*a(n-4) +1920*a(n-5).\\k=2: [order 15].\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 29 2013). As of revision 7, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A234658, the recurrence $a(n) = 4\,a(n-1) + 44\,a(n-2) - 176\,a(n-3) - 480\,a(n-4) + 1920\,a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A234658, the recurrence $a(n) = 0$ holds for every $n \ge 16$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234658}{A234658}, revision 7, last modified Jun 20 2022.
