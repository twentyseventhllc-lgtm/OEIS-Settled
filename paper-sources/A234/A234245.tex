...
\title{Proofs of the conjectured column and row recurrences for OEIS A234245}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234245}{A234245} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings)\end{quote}
...
k=1: [linear recurrence of order 8].\end{quote}
...
\begin{theorem} For column $k = 1$ of A234245, the recurrence $a(n) = 0$ holds for every $n \ge 9$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234245}{A234245}, revision 6, last modified Jun 20 2022.
