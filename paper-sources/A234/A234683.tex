...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234683}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234683}{A234683} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 72*a(n-2) - 1712*a(n-4) + 13440*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(58 + 287*x - 2808*x\textasciicircum{}2 - 13828*x\textasciicircum{}3 + 33600*x\textasciicircum{}4 + 164640*x\textasciicircum{}5) / ((1 - 20*x\textasciicircum{}2)*(1 - 24*x\textasciicircum{}2)*(1 - 28*x\textasciicircum{}2)). - Colin Barker, Oct 16 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{232x + 1148x^{2} - 11232x^{3} - 55312x^{4} + 134400x^{5} + 658560x^{6}}{1 - 72x^{2} + 1712x^{4} - 13440x^{6}}.\]
...
For scale: at $n = 8$ there are $7^{16}$ arrays, about $10^{14}$, against $6$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A234683, the recurrence $a(n) = 72\,a(n-2) - 1712\,a(n-4) + 13440\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234683, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{232x + 1148x^{2} - 11232x^{3} - 55312x^{4} + 134400x^{5} + 658560x^{6}}{1 - 72x^{2} + 1712x^{4} - 13440x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 232, 1148, 5472, 27344, 131200, 661952, 3196416, 16276736,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234683}{A234683}, revision 9, last modified Jun 19 2022.
