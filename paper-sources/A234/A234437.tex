...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234437}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234437}{A234437} as

\begin{quote}\itshape Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) + 24*a(n-2) - 130*a(n-3) + 36*a(n-4) + 80*a(n-5) - 32*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(60 - 9*x - 1493*x\textasciicircum{}2 + 644*x\textasciicircum{}3 + 946*x\textasciicircum{}4 - 420*x\textasciicircum{}5) / ((1 - 5*x + 2*x\textasciicircum{}2)*(1 - 26*x\textasciicircum{}2 + 16*x\textasciicircum{}4)). - Colin Barker, Oct 15 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{120x - 18x^{2} - 2986x^{3} + 1288x^{4} + 1892x^{5} - 840x^{6}}{1 - 5x - 24x^{2} + 130x^{3} - 36x^{4} - 80x^{5} + 32x^{6}}.\]

\section{The object}

The name is read as follows. The reading is not a guess: it is pinned against the entry's own published terms, and against an independent enumeration, before anything is proved (Section 7).

Let $q = 3$ and let $A$ be an $n' \times 3$ array with entries in $\{0,1,\dots,2\}$, where the entry writes the number of rows as $n' = n + 1$.
...
\begin{theorem} For A234437, the recurrence $a(n) = 5\,a(n-1) + 24\,a(n-2) - 130\,a(n-3) + 36\,a(n-4) + 80\,a(n-5) - 32\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234437, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{120x - 18x^{2} - 2986x^{3} + 1288x^{4} + 1892x^{5} - 840x^{6}}{1 - 5x - 24x^{2} + 130x^{3} - 36x^{4} - 80x^{5} + 32x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 120, 582, 2804, 13676, 66228, 324556, 1578036, 7767916,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234437}{A234437}, revision 12, last modified Jun 20 2022.
