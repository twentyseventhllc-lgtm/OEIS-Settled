...
\title{Proofs of the conjectured column and row recurrences for OEIS A234450}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234450}{A234450} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings)\end{quote}
...
k=1: a(n) = 60*a(n-2) -344*a(n-4).\\k=2: [order 17].\end{quote}
...
\begin{theorem} For column $k = 1$ of A234450, the recurrence $a(n) = 60\,a(n-2) - 344\,a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A234450, the recurrence $a(n) = 0$ holds for every $n \ge 18$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234450}{A234450}, revision 6, last modified Jun 20 2022.
