...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A250660}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250660}{A250660} as

\begin{quote}\itshape Number of (6+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 32*n\textasciicircum{}2 + 159*n + 128.\end{quote}

\begin{quote}\ttfamily G.f.: x*(319 - 383*x + 128*x\textasciicircum{}2) / (1 - x)\textasciicircum{}3.\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{319x - 383x^{2} + 128x^{3}}{1 - 3x + 3x^{2} - x^{3}}.\]
...
\begin{theorem} For A250660, $a(n)$ is the polynomial $128 + 159n + 32n^{2}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A250660, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{319x - 383x^{2} + 128x^{3}}{1 - 3x + 3x^{2} - x^{3}}$.\end{theorem}
...
\begin{theorem} For A250660, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 39 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 319, 574, 893, 1276, 1723, 2234, 2809, 3448,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250660}{A250660}, revision 7, last modified Nov 15 2018.
