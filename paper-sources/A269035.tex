...
\title{Proofs of the conjectured column and row recurrences for OEIS A269035}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269035}{A269035} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} In A269035, column $k = 1$ is identically zero, and the claimed recurrence therefore holds at every index.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269035, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2)$ holds for every $n > 3$, and fails at $n = 3$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269035, the recurrence $a(n) = 10\,a(n-1) - 29\,a(n-2) + 20\,a(n-3) - 4\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A269035, the recurrence $a(n) = 14\,a(n-1) - 57\,a(n-2) + 56\,a(n-3) - 16\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269035}{A269035}, revision 4, last modified Feb 18 2016.
