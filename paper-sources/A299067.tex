...
\title{Proofs of the conjectured column and row recurrences for OEIS A299067}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299067}{A299067} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}
...
k=2: a(n) = 4*a(n-1) -2*a(n-2) +4*a(n-3) for n>4;\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 01 2018). As of revision 6, last modified Jul 23 2025, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 2$ of A299067, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) + 4\,a(n-3)$ holds for every $n > 4$, and fails at $n = 4$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299067}{A299067}, revision 6, last modified Jul 23 2025.
