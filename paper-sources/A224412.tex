...
\title{A proof of the conjectured closed form for OEIS A224412}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224412}{A224412} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays with rows unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (1/3628800)*n\textasciicircum{}10 + (1/80640)*n\textasciicircum{}9 + (1/3456)*n\textasciicircum{}8 + (23/5760)*n\textasciicircum{}7 + (7213/172800)*n\textasciicircum{}6 + (683/2304)*n\textasciicircum{}5 + (138869/36288)*n\textasciicircum{}4 + (32143/2240)*n\textasciicircum{}3 + (32909/450)*n\textasciicircum{}2 - (753/20)*n - 44 for n>3\end{quote}
...
\[a(n) = -44 - \frac{753}{20}n + \frac{32909}{450}n^{2} + \frac{32143}{2240}n^{3} + \frac{138869}{36288}n^{4} + \frac{683}{2304}n^{5} + \frac{7213}{172800}n^{6} + \frac{23}{5760}n^{7} + \frac{1}{3456}n^{8} + \frac{1}{80640}n^{9} + \frac{1}{3628800}n^{10}.\]
...
\begin{theorem} For A224412, $a(n)$ is the polynomial $-44 - \frac{753}{20}n + \frac{32909}{450}n^{2} + \frac{32143}{2240}n^{3} + \frac{138869}{36288}n^{4} + \frac{683}{2304}n^{5} + \frac{7213}{172800}n^{6} + \frac{23}{5760}n^{7} + \frac{1}{3456}n^{8} + \frac{1}{80640}n^{9} + \frac{1}{3628800}n^{10}$ for every $n > 3$, and not at $n = 3$.\end{theorem}

{\itshape Proof.} A polynomial of degree $10$ is annihilated by the difference operator $(E-1)^{11}$, whose characteristic polynomial is $(t-1)^{11}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 11 = 49$. Its values were computed exactly; the last nonvanishing one is at $n = 3$, and more than $49$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 324, 1288, 3436, 7812, 16420, 32814, 63202,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224412}{A224412}, revision 8, last modified Oct 03 2025.
