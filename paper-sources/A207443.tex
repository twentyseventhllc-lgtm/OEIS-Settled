...
\title{A proof of the conjectured linear recurrence for OEIS A207443}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207443}{A207443} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}
...
\begin{theorem} For A207443, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 108, 323, 1058, 3223, 9515, 28426,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207443}{A207443}, revision 9, last modified Oct 03 2025.
