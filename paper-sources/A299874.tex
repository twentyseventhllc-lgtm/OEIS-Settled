...
\title{A proof of the conjectured linear recurrence for OEIS A299874}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299874}{A299874} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -7*a(n-2) +7*a(n-3) -24*a(n-4) +31*a(n-5) -21*a(n-6) +51*a(n-7) -50*a(n-8) +44*a(n-9) -78*a(n-10) +34*a(n-11) -37*a(n-12) +60*a(n-13) -10*a(n-14) +20*a(n-15) -24*a(n-16) for n>17.\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 7\,a(n-2) + 7\,a(n-3) - 24\,a(n-4) + 31\,a(n-5) - 21\,a(n-6) + \\ 51\,a(n-7) - 50\,a(n-8) + 44\,a(n-9) - 78\,a(n-10) + 34\,a(n-11) - 37\,a(n-12) + \\ 60\,a(n-13) - 10\,a(n-14) + 20\,a(n-15) - 24\,a(n-16). \end{multline*}
...
\begin{theorem} For A299874, the recurrence $a(n) = 5\,a(n-1) - 7\,a(n-2) + 7\,a(n-3) - 24\,a(n-4) + 31\,a(n-5) - 21\,a(n-6) + 51\,a(n-7) - 50\,a(n-8) + 44\,a(n-9) - 78\,a(n-10) + 34\,a(n-11) - 37\,a(n-12) + 60\,a(n-13) - 10\,a(n-14) + 20\,a(n-15) - 24\,a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,68$. The last nonvanishing one is at $m = 1$, that is at $n = 17$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 13, 20, 41, 102, 253, 632, 1563,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299874}{A299874}, revision 6, last modified Apr 25 2023.
