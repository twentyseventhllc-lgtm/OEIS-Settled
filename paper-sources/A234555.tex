...
\title{Proofs of the conjectured column and row recurrences for OEIS A234555}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234555}{A234555} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings)\end{quote}
...
k=1: a(n) = 118*a(n-2) -3660*a(n-4) +10800*a(n-6).\end{quote}
...
\begin{theorem} For column $k = 1$ of A234555, the recurrence $a(n) = 118\,a(n-2) - 3660\,a(n-4) + 10800\,a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234555}{A234555}, revision 6, last modified Jun 20 2022.
