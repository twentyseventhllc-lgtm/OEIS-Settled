...
\title{A proof of the conjectured linear recurrence for OEIS A318071}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A318071}{A318071} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) +2*a(n-3) -3*a(n-4) -5*a(n-5) -2*a(n-7) +7*a(n-8) -a(n-9) -2*a(n-10) +8*a(n-11) -3*a(n-12) -a(n-13) -3*a(n-14) -3*a(n-15) +4*a(n-16) +a(n-17) -a(n-18) for n>21\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) + 2\,a(n-3) - 3\,a(n-4) - 5\,a(n-5) - 2\,a(n-7) + \\ 7\,a(n-8) - a(n-9) - 2\,a(n-10) + 8\,a(n-11) - 3\,a(n-12) - a(n-13) - \\ 3\,a(n-14) - 3\,a(n-15) + 4\,a(n-16) + a(n-17) - a(n-18). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $109$; neither removal changes any count.
...
\begin{theorem} For A318071, the recurrence $a(n) = 2\,a(n-1) + a(n-2) + 2\,a(n-3) - 3\,a(n-4) - 5\,a(n-5) - 2\,a(n-7) + 7\,a(n-8) - a(n-9) - 2\,a(n-10) + 8\,a(n-11) - 3\,a(n-12) - a(n-13) - 3\,a(n-14) - 3\,a(n-15) + 4\,a(n-16) + a(n-17) - a(n-18)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,77$. The last nonvanishing one is at $m = 3$, that is at $n = 21$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 20, 41, 73, 149, 372, 861, 2016,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A318071}{A318071}, revision 4, last modified Aug 15 2018.
