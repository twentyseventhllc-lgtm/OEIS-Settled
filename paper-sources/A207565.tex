...
\title{A proof of the conjectured linear recurrence for OEIS A207565}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207565}{A207565} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -4*a(n-2) +10*a(n-3) -30*a(n-4) +10*a(n-5) -4*a(n-6) +54*a(n-7) +10*a(n-8) -22*a(n-9) -62*a(n-10) -10*a(n-11) +18*a(n-12) +32*a(n-13) +7*a(n-14) -6*a(n-15) -6*a(n-16)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 4\,a(n-2) + 10\,a(n-3) - 30\,a(n-4) + 10\,a(n-5) - 4\,a(n-6) + \\ 54\,a(n-7) + 10\,a(n-8) - 22\,a(n-9) - 62\,a(n-10) - 10\,a(n-11) + 18\,a(n-12) + \\ 32\,a(n-13) + 7\,a(n-14) - 6\,a(n-15) - 6\,a(n-16). \end{multline*}
...
\begin{theorem} For A207565, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2) + 10\,a(n-3) - 30\,a(n-4) + 10\,a(n-5) - 4\,a(n-6) + 54\,a(n-7) + 10\,a(n-8) - 22\,a(n-9) - 62\,a(n-10) - 10\,a(n-11) + 18\,a(n-12) + 32\,a(n-13) + 7\,a(n-14) - 6\,a(n-15) - 6\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 221, 636, 2234, 6315, 16812, 47596,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207565}{A207565}, revision 9, last modified Oct 03 2025.
