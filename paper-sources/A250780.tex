...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250780}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250780}{A250780} as

\begin{quote}\itshape Number of (n+1) X (5+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) - 27*a(n-2) + 50*a(n-3) - 55*a(n-4) + 36*a(n-5) - 13*a(n-6) + 2*a(n-7).\end{quote}

\begin{quote}\ttfamily G.f.: x*(209 - 1154*x + 2693*x\textasciicircum{}2 - 3376*x\textasciicircum{}3 + 2401*x\textasciicircum{}4 - 922*x\textasciicircum{}5 + 153*x\textasciicircum{}6) / ((1 - x)\textasciicircum{}6*(1 - 2*x)).\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 27\,a(n-2) + 50\,a(n-3) - 55\,a(n-4) + 36\,a(n-5) - 13\,a(n-6) + \\ 2\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{209x - 1154x^{2} + 2693x^{3} - 3376x^{4} + 2401x^{5} - 922x^{6} + 153x^{7}}{1 - 8x + 27x^{2} - 50x^{3} + 55x^{4} - 36x^{5} + 13x^{6} - 2x^{7}}.\]
...
For scale: at $n = 8$ there are $2^{48}$ arrays, about $10^{14}$, against $15$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A250780, the recurrence $a(n) = 8\,a(n-1) - 27\,a(n-2) + 50\,a(n-3) - 55\,a(n-4) + 36\,a(n-5) - 13\,a(n-6) + 2\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250780, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{209x - 1154x^{2} + 2693x^{3} - 3376x^{4} + 2401x^{5} - 922x^{6} + 153x^{7}}{1 - 8x + 27x^{2} - 50x^{3} + 55x^{4} - 36x^{5} + 13x^{6} - 2x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 209, 518, 1194, 2640, 5688, 12036, 25126, 51904,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250780}{A250780}, revision 8, last modified Nov 19 2018.
