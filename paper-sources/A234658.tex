...
k=1: a(n) = 4*a(n-1) +44*a(n-2) -176*a(n-3) -480*a(n-4) +1920*a(n-5).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 29 2013). As of revision 7, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
