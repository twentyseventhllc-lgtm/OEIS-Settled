...
\title{A proof of the conjectured generating function for OEIS A225011}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A225011}{A225011} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays with rows unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: G.f.: -x*(x\textasciicircum{}4 - 5*x\textasciicircum{}3 + 10*x\textasciicircum{}2 - 10*x + 5) *(x\textasciicircum{}4 - 3*x\textasciicircum{}3 + 4*x\textasciicircum{}2 - 2*x + 1) / (x-1)\textasciicircum{}9. - R. J. Mathar, May 17 2014\end{quote}

The line quoted above is contributed by R. J. Mathar on May 17 2014.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 14, last modified Mar 09 2023, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{5x - 20x^{2} + 50x^{3} - 80x^{4} + 86x^{5} - 62x^{6} + 29x^{7} - 8x^{8} + x^{9}}{1 - 9x + 36x^{2} - 84x^{3} + 126x^{4} - 126x^{5} + 84x^{6} - 36x^{7} + 9x^{8} - x^{9}}.\]
...
\begin{theorem} For A225011, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{5x - 20x^{2} + 50x^{3} - 80x^{4} + 86x^{5} - 62x^{6} + 29x^{7} - 8x^{8} + x^{9}}{1 - 9x + 36x^{2} - 84x^{3} + 126x^{4} - 126x^{5} + 84x^{6} - 36x^{7} + 9x^{8} - x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 25, 95, 295, 791, 1897, 4166, 8518,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A225011}{A225011}, revision 14, last modified Mar 09 2023.
