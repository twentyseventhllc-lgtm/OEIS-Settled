...
\title{A proof of the conjectured linear recurrence for OEIS A299650}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299650}{A299650} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) +31*a(n-2) +61*a(n-3) -43*a(n-4) -428*a(n-5) -273*a(n-6) +69*a(n-7) +545*a(n-8) +212*a(n-9) -84*a(n-10) -204*a(n-11) -32*a(n-12) +16*a(n-13) +24*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 13\,a(n-1) + 31\,a(n-2) + 61\,a(n-3) - 43\,a(n-4) - 428\,a(n-5) - 273\,a(n-6) + \\ 69\,a(n-7) + 545\,a(n-8) + 212\,a(n-9) - 84\,a(n-10) - 204\,a(n-11) - 32\,a(n-12) + \\ 16\,a(n-13) + 24\,a(n-14). \end{multline*}
...
\begin{theorem} For A299650, the recurrence $a(n) = 13\,a(n-1) + 31\,a(n-2) + 61\,a(n-3) - 43\,a(n-4) - 428\,a(n-5) - 273\,a(n-6) + 69\,a(n-7) + 545\,a(n-8) + 212\,a(n-9) - 84\,a(n-10) - 204\,a(n-11) - 32\,a(n-12) + 16\,a(n-13) + 24\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1924, 29408, 448993, 6856789, 104711327, 1599074414,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299650}{A299650}, revision 4, last modified Feb 15 2018.
