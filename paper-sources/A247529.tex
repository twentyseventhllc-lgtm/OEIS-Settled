...
\title{A proof of the conjectured linear recurrence for OEIS A247529}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A247529}{A247529} as

\begin{quote}\itshape Number of length n+3 0..4 arrays with some disjoint pairs in every consecutive four terms having the same sum\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-2) -4*a(n-3) +18*a(n-4) -18*a(n-5) -78*a(n-6) +78*a(n-7) -67*a(n-8) +67*a(n-9) +386*a(n-10) -386*a(n-11) +22*a(n-12) -22*a(n-13) -686*a(n-14) +686*a(n-15) +125*a(n-16) -125*a(n-17) +616*a(n-18) -616*a(n-19) -178*a(n-20) +178*a(n-21) -340*a(n-22) +340*a(n-23) +130*a(n-24) -130*a(n-25) +80*a(n-26) -80*a(n-27) -40*a(n-28) +40*a(n-29) for n>30\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 4\,a(n-2) - 4\,a(n-3) + 18\,a(n-4) - 18\,a(n-5) - 78\,a(n-6) + \\ 78\,a(n-7) - 67\,a(n-8) + 67\,a(n-9) + 386\,a(n-10) - 386\,a(n-11) + 22\,a(n-12) - \\ 22\,a(n-13) - 686\,a(n-14) + 686\,a(n-15) + 125\,a(n-16) - 125\,a(n-17) + 616\,a(n-18) - \\ 616\,a(n-19) - 178\,a(n-20) + 178\,a(n-21) - 340\,a(n-22) + 340\,a(n-23) + 130\,a(n-24) - \\ 130\,a(n-25) + 80\,a(n-26) - 80\,a(n-27) - 40\,a(n-28) + 40\,a(n-29). \end{multline*}
...
The reachable part of that digraph has $156$ states, $156$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 41$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $41\times41$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A247529, the recurrence of order $29$ displayed in Section 1 holds for every $n > 30$, and fails at $n = 30$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,104$. The last nonvanishing one is at $m = 1$, that is at $n = 30$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 185, 317, 561, 1007, 1823, 3455, 6495, 12105,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A247529}{A247529}, revision 6, last modified Jul 23 2025.
