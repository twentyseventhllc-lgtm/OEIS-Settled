...
\title{A proof of the conjectured linear recurrence for OEIS A188905}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188905}{A188905} as

\begin{quote}\itshape Number of nX4 binary arrays without the pattern 0 1 0 diagonally or antidiagonally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) -36*a(n-2) -132*a(n-3) +1048*a(n-4) -3876*a(n-5) -1424*a(n-6) +41744*a(n-7) -47040*a(n-8) -45216*a(n-9) +146704*a(n-10) -537440*a(n-11) +34944*a(n-12) +1290816*a(n-13) -172032*a(n-14) +3609664*a(n-15) -1049344*a(n-16) -18017792*a(n-17) +9017344*a(n-18) +5099520*a(n-19) -9596928*a(n-20) +41336832*a(n-21) -16777216*a(n-22) -12320768*a(n-23) +7340032*a(n-24) -49545216*a(n-25) +31457280*a(n-26) +25165824*a(n-27) -16777216*a(n-28)\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 13 2011).
...
\begin{multline*} a(n) = 14\,a(n-1) - 36\,a(n-2) - 132\,a(n-3) + 1048\,a(n-4) - 3876\,a(n-5) - 1424\,a(n-6) + \\ 41744\,a(n-7) - 47040\,a(n-8) - 45216\,a(n-9) + 146704\,a(n-10) - 537440\,a(n-11) + 34944\,a(n-12) + \\ 1290816\,a(n-13) - 172032\,a(n-14) + 3609664\,a(n-15) - 1049344\,a(n-16) - 18017792\,a(n-17) + 9017344\,a(n-18) + \\ 5099520\,a(n-19) - 9596928\,a(n-20) + 41336832\,a(n-21) - 16777216\,a(n-22) - 12320768\,a(n-23) + 7340032\,a(n-24) - \\ 49545216\,a(n-25) + 31457280\,a(n-26) + 25165824\,a(n-27) - 16777216\,a(n-28). \end{multline*}
...
\[\mathcal{D} = \{(1,-1)\mapsto(0,1,0), (1,1)\mapsto(0,1,0)\},\]
...
\begin{theorem} For A188905, the recurrence of order $28$ displayed in Section 1 holds for every $n \ge 29$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 2500, 21904, 204304, 1971216, 18939904, 180741136,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188905}{A188905}, revision 9, last modified Oct 03 2025.
