...
\title{A proof of the conjectured linear recurrence for OEIS A303177}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303177}{A303177} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +12*a(n-3) +4*a(n-4) -14*a(n-5) -17*a(n-6) -26*a(n-7) +52*a(n-8) -8*a(n-10) +8*a(n-12) -32*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 12\,a(n-3) + 4\,a(n-4) - 14\,a(n-5) - 17\,a(n-6) - \\ 26\,a(n-7) + 52\,a(n-8) - 8\,a(n-10) + 8\,a(n-12) - 32\,a(n-13). \end{multline*}
...
\begin{theorem} For A303177, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) + 12\,a(n-3) + 4\,a(n-4) - 14\,a(n-5) - 17\,a(n-6) - 26\,a(n-7) + 52\,a(n-8) - 8\,a(n-10) + 8\,a(n-12) - 32\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 17, 31, 135, 547, 1938, 6965, 25953,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303177}{A303177}, revision 4, last modified Apr 19 2018.
