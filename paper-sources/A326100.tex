...
\title{A proof of the conjectured linear recurrence for OEIS A326100}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A326100}{A326100} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +5*a(n-2) -2*a(n-3) -3*a(n-6) -2*a(n-7) -a(n-8) -a(n-9)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 5\,a(n-2) - 2\,a(n-3) - 3\,a(n-6) - 2\,a(n-7) - a(n-8) - \\ a(n-9). \end{multline*}
...
\begin{theorem} For A326100, the recurrence $a(n) = 5\,a(n-1) + 5\,a(n-2) - 2\,a(n-3) - 3\,a(n-6) - 2\,a(n-7) - a(n-8) - a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 29, 161, 929, 5383, 31236, 181227, 1051456,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A326100}{A326100}, revision 4, last modified Jun 06 2019.
