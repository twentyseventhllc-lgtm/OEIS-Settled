...
k=1: a(n) = 14*a(n-2).\\k=2: a(n) = 5*a(n-1) +24*a(n-2) -130*a(n-3) +36*a(n-4) +80*a(n-5) -32*a(n-6).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 26 2013). As of revision 8, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
