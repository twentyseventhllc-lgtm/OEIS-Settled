...
\title{A proof of the conjectured linear recurrence for OEIS A302411}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302411}{A302411} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 4\,a(n-2) + a(n-3) - 17\,a(n-4) - 39\,a(n-5) - 18\,a(n-6) + \\ 96\,a(n-7) + 133\,a(n-8) - a(n-9) - 37\,a(n-10) - 239\,a(n-11) - 212\,a(n-12) - \\ 10\,a(n-13) + 191\,a(n-14) + 299\,a(n-15) - 38\,a(n-16) + 62\,a(n-17) + 145\,a(n-18) - \\ 218\,a(n-19) - 77\,a(n-20) + 21\,a(n-21) - 202\,a(n-22) + 25\,a(n-23) + 144\,a(n-24) + \\ 19\,a(n-25) - 53\,a(n-26) + 2\,a(n-27) + 22\,a(n-28) - 5\,a(n-29) + 4\,a(n-30) - \\ 4\,a(n-31). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $195$; neither removal changes any count.
...
\begin{theorem} For A302411, the recurrence of order $31$ displayed in Section 1 holds for every $n > 33$, and fails at $n = 33$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,97$. The last nonvanishing one is at $m = 2$, that is at $n = 33$. After it, more than $S = 36$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 37, 66, 259, 994, 3548, 12442, 46066,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302411}{A302411}, revision 6, last modified Mar 01 2023.
