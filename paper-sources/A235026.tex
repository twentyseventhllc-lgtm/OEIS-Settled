...
k=1: a(n) = 18*a(n-2) -56*a(n-4) +32*a(n-6).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 02 2014). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
