...
\title{A proof of the conjectured linear recurrence for OEIS A302166}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302166}{A302166} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +8*a(n-4) -4*a(n-5) -4*a(n-6) -a(n-7) -22*a(n-8) +a(n-9) +5*a(n-10) +2*a(n-11) +28*a(n-12) +6*a(n-13) -3*a(n-14) -3*a(n-15) -17*a(n-16) -4*a(n-17) +2*a(n-18) +2*a(n-19) +4*a(n-20) -a(n-22) for n>23\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 8\,a(n-4) - 4\,a(n-5) - 4\,a(n-6) - a(n-7) - \\ 22\,a(n-8) + a(n-9) + 5\,a(n-10) + 2\,a(n-11) + 28\,a(n-12) + 6\,a(n-13) - \\ 3\,a(n-14) - 3\,a(n-15) - 17\,a(n-16) - 4\,a(n-17) + 2\,a(n-18) + 2\,a(n-19) + \\ 4\,a(n-20) - a(n-22). \end{multline*}
...
\begin{theorem} For A302166, the recurrence $a(n) = a(n-1) + a(n-2) + 8\,a(n-4) - 4\,a(n-5) - 4\,a(n-6) - a(n-7) - 22\,a(n-8) + a(n-9) + 5\,a(n-10) + 2\,a(n-11) + 28\,a(n-12) + 6\,a(n-13) - 3\,a(n-14) - 3\,a(n-15) - 17\,a(n-16) - 4\,a(n-17) + 2\,a(n-18) + 2\,a(n-19) + 4\,a(n-20) - a(n-22)$ holds for every $n > 23$, and fails at $n = 23$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,89$. The last nonvanishing one is at $m = 1$, that is at $n = 23$. After it, more than $S = 29$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 10, 17, 29, 51, 109, 206, 407,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302166}{A302166}, revision 4, last modified Apr 02 2018.
