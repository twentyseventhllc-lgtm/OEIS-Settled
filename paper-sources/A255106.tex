...
\title{A proof of the conjectured linear recurrence for OEIS A255106}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255106}{A255106} as

\begin{quote}\itshape Number of length n+7 0..2 arrays with at most one downstep in every 7 consecutive neighbor pairs\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +a(n-3) +33*a(n-7) -57*a(n-8) +25*a(n-9) -15*a(n-14) +10*a(n-15)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + a(n-3) + 33\,a(n-7) - 57\,a(n-8) + 25\,a(n-9) - \\ 15\,a(n-14) + 10\,a(n-15). \end{multline*}
...
The reachable part of that digraph has $3280$ states, $3280$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 62$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $62\times62$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A255106, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + a(n-3) + 33\,a(n-7) - 57\,a(n-8) + 25\,a(n-9) - 15\,a(n-14) + 10\,a(n-15)$ holds for every $n \ge 16$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 927, 1616, 3042, 6141, 12662, 25578, 49611, 91887,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255106}{A255106}, revision 6, last modified Jul 23 2025.
