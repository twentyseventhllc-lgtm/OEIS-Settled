...
\title{A proof of the conjectured linear recurrence for OEIS A189613}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189613}{A189613} as

\begin{quote}\itshape Number of nX5 binary arrays without the pattern 0 1 0 diagonally, antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) -47*a(n-2) -126*a(n-3) +2471*a(n-4) -25560*a(n-5) +55367*a(n-6) -83579*a(n-7) -124019*a(n-8) +7300122*a(n-9) -7365184*a(n-10) -599459*a(n-11) -31727197*a(n-12) -754040572*a(n-13) +142951670*a(n-14) +953676928*a(n-15) +1891140440*a(n-16) +29553742000*a(n-17) +9452004592*a(n-18) -65219737520*a(n-19) -36827703408*a(n-20) -187343367808*a(n-21) -114093863744*a(n-22) +354967210752*a(n-23) +176354022912*a(n-24) +450092691456*a(n-25) +319703132160*a(n-26) -570350149632*a(n-27) -92906913792*a(n-28) +66527690752*a(n-29)\end{quote}
...
\begin{multline*} a(n) = 16\,a(n-1) - 47\,a(n-2) - 126\,a(n-3) + 2471\,a(n-4) - 25560\,a(n-5) + 55367\,a(n-6) - \\ 83579\,a(n-7) - 124019\,a(n-8) + 7300122\,a(n-9) - 7365184\,a(n-10) - 599459\,a(n-11) - 31727197\,a(n-12) - \\ 754040572\,a(n-13) + 142951670\,a(n-14) + 953676928\,a(n-15) + 1891140440\,a(n-16) + 29553742000\,a(n-17) + 9452004592\,a(n-18) - \\ 65219737520\,a(n-19) - 36827703408\,a(n-20) - 187343367808\,a(n-21) - 114093863744\,a(n-22) + 354967210752\,a(n-23) + 176354022912\,a(n-24) + \\ 450092691456\,a(n-25) + 319703132160\,a(n-26) - 570350149632\,a(n-27) - 92906913792\,a(n-28) + 66527690752\,a(n-29). \end{multline*}
...
The reachable part of the digraph has $463$ states, $463$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 53$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $53\times53$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189613, the recurrence of order $29$ displayed in Section 1 holds for every $n \ge 30$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,104$. Every one of them vanished. After it, more than $S = 53$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 21, 441, 5238, 50024, 532565, 6110500, 69943253, 783072552,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189613}{A189613}, revision 9, last modified Oct 03 2025.
