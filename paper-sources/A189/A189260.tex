...
\title{A proof of the conjectured linear recurrence for OEIS A189260}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189260}{A189260} as

\begin{quote}\itshape Number of nX5 binary arrays without the pattern 0 0 1 diagonally, antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) -30*a(n-2) -99*a(n-3) +356*a(n-4) -2856*a(n-5) +8692*a(n-6) +17040*a(n-7) -65040*a(n-8) +142172*a(n-9) -523592*a(n-10) -577136*a(n-11) +4758096*a(n-12) -3418384*a(n-13) -5978816*a(n-14) +8825824*a(n-15) -10155968*a(n-16) +18636928*a(n-17) -17683840*a(n-18) +1152*a(n-19) +18846208*a(n-20) -16343040*a(n-21) +1361920*a(n-22) +2150400*a(n-23) for n>24\end{quote}
...
\begin{multline*} a(n) = 14\,a(n-1) - 30\,a(n-2) - 99\,a(n-3) + 356\,a(n-4) - 2856\,a(n-5) + 8692\,a(n-6) + \\ 17040\,a(n-7) - 65040\,a(n-8) + 142172\,a(n-9) - 523592\,a(n-10) - 577136\,a(n-11) + 4758096\,a(n-12) - \\ 3418384\,a(n-13) - 5978816\,a(n-14) + 8825824\,a(n-15) - 10155968\,a(n-16) + 18636928\,a(n-17) - 17683840\,a(n-18) + \\ 1152\,a(n-19) + 18846208\,a(n-20) - 16343040\,a(n-21) + 1361920\,a(n-22) + 2150400\,a(n-23). \end{multline*}
...
The reachable part of the digraph has $421$ states, $421$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 51$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $51\times51$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189260, the recurrence of order $23$ displayed in Section 1 holds for every $n > 24$, and fails at $n = 24$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,97$. The last nonvanishing one is at $m = 1$, that is at $n = 24$. After it, more than $S = 51$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 4720, 52748, 552752, 5746968, 59399960, 613358776,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189260}{A189260}, revision 9, last modified Oct 03 2025.
