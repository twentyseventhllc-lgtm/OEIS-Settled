...
\title{A proof of the conjectured linear recurrence for OEIS A189199}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189199}{A189199} as

\begin{quote}\itshape Number of 6Xn binary arrays without the pattern 0 0 1 vertically or antidiagonally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 33*a(n-1) -206*a(n-2) -738*a(n-3) +8753*a(n-4) -13693*a(n-5) -33068*a(n-6) +87427*a(n-7) -52757*a(n-8) +67082*a(n-9) -70312*a(n-10) -61118*a(n-11) +47608*a(n-12) -908*a(n-13) -1404*a(n-14) +568*a(n-15) -192*a(n-16)\end{quote}
...
\begin{multline*} a(n) = 33\,a(n-1) - 206\,a(n-2) - 738\,a(n-3) + 8753\,a(n-4) - 13693\,a(n-5) - 33068\,a(n-6) + \\ 87427\,a(n-7) - 52757\,a(n-8) + 67082\,a(n-9) - 70312\,a(n-10) - 61118\,a(n-11) + 47608\,a(n-12) - \\ 908\,a(n-13) - 1404\,a(n-14) + 568\,a(n-15) - 192\,a(n-16). \end{multline*}
...
The reachable part of the digraph has $1123$ states, $1123$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 27$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $27\times27$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189199, the recurrence $a(n) = 33\,a(n-1) - 206\,a(n-2) - 738\,a(n-3) + 8753\,a(n-4) - 13693\,a(n-5) - 33068\,a(n-6) + 87427\,a(n-7) - 52757\,a(n-8) + 67082\,a(n-9) - 70312\,a(n-10) - 61118\,a(n-11) + 47608\,a(n-12) - 908\,a(n-13) - 1404\,a(n-14) + 568\,a(n-15) - 192\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. Every one of them vanished. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 33, 1089, 27170, 657028, 15564047, 367115337, 8646366042, 203562575017,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189199}{A189199}, revision 9, last modified Oct 03 2025.
