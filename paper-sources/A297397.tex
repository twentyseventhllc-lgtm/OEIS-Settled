...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A297397}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297397}{A297397} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 3*a(n-2) + 24*a(n-3) + 11*a(n-4) - 21*a(n-5) - 67*a(n-6) - 9*a(n-7) - 45*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(1 + 19*x + 34*x\textasciicircum{}2 - 15*x\textasciicircum{}3 - 88*x\textasciicircum{}4 - 76*x\textasciicircum{}5 - 54*x\textasciicircum{}6 - 45*x\textasciicircum{}7) / (1 - x - 3*x\textasciicircum{}2 - 24*x\textasciicircum{}3 - 11*x\textasciicircum{}4 + 21*x\textasciicircum{}5 + 67*x\textasciicircum{}6 + 9*x\textasciicircum{}7 + 45*x\textasciicircum{}8). - Colin Barker, Feb 28 2019\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 7, last modified Feb 28 2019, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 11\,a(n-4) - 21\,a(n-5) - 67\,a(n-6) - \\ 9\,a(n-7) - 45\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{x + 19x^{2} + 34x^{3} - 15x^{4} - 88x^{5} - 76x^{6} - 54x^{7} - 45x^{8}}{1 - x - 3x^{2} - 24x^{3} - 11x^{4} + 21x^{5} + 67x^{6} + 9x^{7} + 45x^{8}}.\]
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $75$; neither removal changes any count.
...
\begin{theorem} For A297397, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 11\,a(n-4) - 21\,a(n-5) - 67\,a(n-6) - 9\,a(n-7) - 45\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A297397, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{x + 19x^{2} + 34x^{3} - 15x^{4} - 88x^{5} - 76x^{6} - 54x^{7} - 45x^{8}}{1 - x - 3x^{2} - 24x^{3} - 11x^{4} + 21x^{5} + 67x^{6} + 9x^{7} + 45x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 20, 57, 126, 700, 2569, 7779, 31081,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297397}{A297397}, revision 7, last modified Feb 28 2019.
