...
\title{A proof of the conjectured linear recurrence for OEIS A196691}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196691}{A196691} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,1,3,0,4 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +8*a(n-2) +32*a(n-3) +54*a(n-4) +88*a(n-5) +28*a(n-6) -a(n-7) -10*a(n-8) -18*a(n-9) -a(n-11) -a(n-12) for n>13\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 8\,a(n-2) + 32\,a(n-3) + 54\,a(n-4) + 88\,a(n-5) + 28\,a(n-6) - \\ a(n-7) - 10\,a(n-8) - 18\,a(n-9) - a(n-11) - a(n-12). \end{multline*}
...
\begin{theorem} For A196691, the recurrence $a(n) = 2\,a(n-1) + 8\,a(n-2) + 32\,a(n-3) + 54\,a(n-4) + 88\,a(n-5) + 28\,a(n-6) - a(n-7) - 10\,a(n-8) - 18\,a(n-9) - a(n-11) - a(n-12)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,54$. The last nonvanishing one is at $m = 1$, that is at $n = 13$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 11, 76, 408, 2025, 10548, 55431, 289038,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196691}{A196691}, revision 9, last modified Oct 03 2025.
