...
\title{A proof of the conjectured linear recurrence for OEIS A207392}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207392}{A207392} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -2*a(n-2) +9*a(n-3) -15*a(n-4) -21*a(n-6) +16*a(n-7) +11*a(n-8) +27*a(n-9) +2*a(n-10) -12*a(n-12) -a(n-13) -2*a(n-14) +2*a(n-15)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 15\,a(n-4) - 21\,a(n-6) + 16\,a(n-7) + \\ 11\,a(n-8) + 27\,a(n-9) + 2\,a(n-10) - 12\,a(n-12) - a(n-13) - 2\,a(n-14) + \\ 2\,a(n-15). \end{multline*}
...
\begin{theorem} For A207392, the recurrence $a(n) = 3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 15\,a(n-4) - 21\,a(n-6) + 16\,a(n-7) + 11\,a(n-8) + 27\,a(n-9) + 2\,a(n-10) - 12\,a(n-12) - a(n-13) - 2\,a(n-14) + 2\,a(n-15)$ holds for every $n \ge 16$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 98, 271, 834, 2307, 6115, 16544,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207392}{A207392}, revision 9, last modified Oct 03 2025.
