...
\title{A proof of the conjectured linear recurrence for OEIS A207462}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207462}{A207462} as

\begin{quote}\itshape Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +a(n-2) -4*a(n-3) +11*a(n-4) +15*a(n-5) +4*a(n-6) -23*a(n-7) -17*a(n-8) +4*a(n-9) -7*a(n-10) +a(n-11) +a(n-12).\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + a(n-2) - 4\,a(n-3) + 11\,a(n-4) + 15\,a(n-5) + 4\,a(n-6) - \\ 23\,a(n-7) - 17\,a(n-8) + 4\,a(n-9) - 7\,a(n-10) + a(n-11) + a(n-12). \end{multline*}
...
\begin{theorem} For A207462, the recurrence $a(n) = 3\,a(n-1) + a(n-2) - 4\,a(n-3) + 11\,a(n-4) + 15\,a(n-5) + 4\,a(n-6) - 23\,a(n-7) - 17\,a(n-8) + 4\,a(n-9) - 7\,a(n-10) + a(n-11) + a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 98, 358, 1152, 3910, 12994, 43596,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207462}{A207462}, revision 7, last modified Jun 18 2022.
