...
\title{A proof of the conjectured linear recurrence for OEIS A207957}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207957}{A207957} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-1) -14*a(n-2) -203*a(n-3) +563*a(n-4) +1329*a(n-5) -5460*a(n-6) -3116*a(n-7) +25220*a(n-8) -3605*a(n-9) -62985*a(n-10) +33885*a(n-11) +86009*a(n-12) -71075*a(n-13) -59522*a(n-14) +69044*a(n-15) +15374*a(n-16) -32682*a(n-17) +2168*a(n-18) +6860*a(n-19) -1480*a(n-20) -448*a(n-21) +128*a(n-22) for n>23\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-1) - 14\,a(n-2) - 203\,a(n-3) + 563\,a(n-4) + 1329\,a(n-5) - 5460\,a(n-6) - \\ 3116\,a(n-7) + 25220\,a(n-8) - 3605\,a(n-9) - 62985\,a(n-10) + 33885\,a(n-11) + 86009\,a(n-12) - \\ 71075\,a(n-13) - 59522\,a(n-14) + 69044\,a(n-15) + 15374\,a(n-16) - 32682\,a(n-17) + 2168\,a(n-18) + \\ 6860\,a(n-19) - 1480\,a(n-20) - 448\,a(n-21) + 128\,a(n-22). \end{multline*}
...
\begin{theorem} For A207957, the recurrence of order $22$ displayed in Section 1 holds for every $n > 23$, and fails at $n = 23$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,78$. The last nonvanishing one is at $m = 1$, that is at $n = 23$. After it, more than $S = 30$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 699, 3080, 15839, 84013, 463482, 2593815,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207957}{A207957}, revision 9, last modified Oct 03 2025.
