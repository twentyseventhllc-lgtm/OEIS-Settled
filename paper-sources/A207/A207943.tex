...
\title{A proof of the conjectured linear recurrence for OEIS A207943}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207943}{A207943} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-1) -12*a(n-2) -210*a(n-3) +495*a(n-4) +1675*a(n-5) -4933*a(n-6) -7524*a(n-7) +24432*a(n-8) +22034*a(n-9) -69076*a(n-10) -45806*a(n-11) +114911*a(n-12) +67305*a(n-13) -109800*a(n-14) -63536*a(n-15) +56149*a(n-16) +33715*a(n-17) -13209*a(n-18) -8384*a(n-19) +1044*a(n-20) +720*a(n-21) for n>22\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-1) - 12\,a(n-2) - 210\,a(n-3) + 495\,a(n-4) + 1675\,a(n-5) - 4933\,a(n-6) - \\ 7524\,a(n-7) + 24432\,a(n-8) + 22034\,a(n-9) - 69076\,a(n-10) - 45806\,a(n-11) + 114911\,a(n-12) + \\ 67305\,a(n-13) - 109800\,a(n-14) - 63536\,a(n-15) + 56149\,a(n-16) + 33715\,a(n-17) - 13209\,a(n-18) - \\ 8384\,a(n-19) + 1044\,a(n-20) + 720\,a(n-21). \end{multline*}
...
\begin{theorem} For A207943, the recurrence of order $21$ displayed in Section 1 holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 1$, that is at $n = 22$. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 826, 3641, 20568, 120276, 737575, 4570122,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207943}{A207943}, revision 9, last modified Oct 03 2025.
