...
\title{A proof of the conjectured linear recurrence for OEIS A207679}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207679}{A207679} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = -a(n-1) +3*a(n-2) +11*a(n-3) +6*a(n-4) -16*a(n-5) -43*a(n-6) -28*a(n-7) +30*a(n-8) +89*a(n-9) +66*a(n-10) -28*a(n-11) -109*a(n-12) -93*a(n-13) +17*a(n-14) +89*a(n-15) +82*a(n-16) -5*a(n-17) -55*a(n-18) -44*a(n-19) -2*a(n-20) +26*a(n-21) +14*a(n-22) +a(n-23) -8*a(n-24) -2*a(n-25) +a(n-27) for n>32\end{quote}
...
\begin{multline*} a(n) = -a(n-1) + 3\,a(n-2) + 11\,a(n-3) + 6\,a(n-4) - 16\,a(n-5) - 43\,a(n-6) - \\ 28\,a(n-7) + 30\,a(n-8) + 89\,a(n-9) + 66\,a(n-10) - 28\,a(n-11) - 109\,a(n-12) - \\ 93\,a(n-13) + 17\,a(n-14) + 89\,a(n-15) + 82\,a(n-16) - 5\,a(n-17) - 55\,a(n-18) - \\ 44\,a(n-19) - 2\,a(n-20) + 26\,a(n-21) + 14\,a(n-22) + a(n-23) - 8\,a(n-24) - \\ 2\,a(n-25) + a(n-27). \end{multline*}
...
\begin{theorem} For A207679, the recurrence of order $27$ displayed in Section 1 holds for every $n > 32$, and fails at $n = 32$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,104$. The last nonvanishing one is at $m = 5$, that is at $n = 32$. After it, more than $S = 44$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 336, 964, 2310, 4728, 9450, 18940,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207679}{A207679}, revision 9, last modified Oct 03 2025.
