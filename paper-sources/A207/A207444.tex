...
\title{A proof of the conjectured linear recurrence for OEIS A207444}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207444}{A207444} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -4*a(n-2) +21*a(n-3) -78*a(n-4) -31*a(n-5) -41*a(n-6) +475*a(n-7) +568*a(n-8) -94*a(n-9) -2370*a(n-10) -2473*a(n-11) +670*a(n-12) +6654*a(n-13) +6859*a(n-14) -1652*a(n-15) -11383*a(n-16) -11186*a(n-17) +818*a(n-18) +11923*a(n-19) +11553*a(n-20) +1019*a(n-21) -6760*a(n-22) -7392*a(n-23) -1944*a(n-24) +1915*a(n-25) +2670*a(n-26) +1090*a(n-27) -64*a(n-28) -529*a(n-29) -259*a(n-30) -53*a(n-31) +46*a(n-32) +24*a(n-33) +8*a(n-34) -4*a(n-35)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 4\,a(n-2) + 21\,a(n-3) - 78\,a(n-4) - 31\,a(n-5) - 41\,a(n-6) + \\ 475\,a(n-7) + 568\,a(n-8) - 94\,a(n-9) - 2370\,a(n-10) - 2473\,a(n-11) + 670\,a(n-12) + \\ 6654\,a(n-13) + 6859\,a(n-14) - 1652\,a(n-15) - 11383\,a(n-16) - 11186\,a(n-17) + 818\,a(n-18) + \\ 11923\,a(n-19) + 11553\,a(n-20) + 1019\,a(n-21) - 6760\,a(n-22) - 7392\,a(n-23) - 1944\,a(n-24) + \\ 1915\,a(n-25) + 2670\,a(n-26) + 1090\,a(n-27) - 64\,a(n-28) - 529\,a(n-29) - 259\,a(n-30) - \\ 53\,a(n-31) + 46\,a(n-32) + 24\,a(n-33) + 8\,a(n-34) - 4\,a(n-35). \end{multline*}
...
\begin{theorem} For A207444, the recurrence of order $35$ displayed in Section 1 holds for every $n \ge 36$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,100$. Every one of them vanished. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 333, 1360, 6092, 25689, 105690, 439332,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207444}{A207444}, revision 9, last modified Oct 03 2025.
