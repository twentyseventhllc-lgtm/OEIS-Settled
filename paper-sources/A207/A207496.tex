...
\title{A proof of the conjectured linear recurrence for OEIS A207496}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207496}{A207496} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -11*a(n-2) -92*a(n-3) +184*a(n-4) +391*a(n-5) -806*a(n-6) -893*a(n-7) +1570*a(n-8) +1170*a(n-9) -1486*a(n-10) -867*a(n-11) +679*a(n-12) +340*a(n-13) -139*a(n-14) -62*a(n-15) +10*a(n-16) +4*a(n-17) for n>18\end{quote}
...
\begin{multline*} a(n) = 9\,a(n-1) - 11\,a(n-2) - 92\,a(n-3) + 184\,a(n-4) + 391\,a(n-5) - 806\,a(n-6) - \\ 893\,a(n-7) + 1570\,a(n-8) + 1170\,a(n-9) - 1486\,a(n-10) - 867\,a(n-11) + 679\,a(n-12) + \\ 340\,a(n-13) - 139\,a(n-14) - 62\,a(n-15) + 10\,a(n-16) + 4\,a(n-17). \end{multline*}
...
That refinement leaves $25$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 18$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207496, the recurrence $a(n) = 9\,a(n-1) - 11\,a(n-2) - 92\,a(n-3) + 184\,a(n-4) + 391\,a(n-5) - 806\,a(n-6) - 893\,a(n-7) + 1570\,a(n-8) + 1170\,a(n-9) - 1486\,a(n-10) - 867\,a(n-11) + 679\,a(n-12) + 340\,a(n-13) - 139\,a(n-14) - 62\,a(n-15) + 10\,a(n-16) + 4\,a(n-17)$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,63$. The last nonvanishing one is at $m = 1$, that is at $n = 18$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 283, 1004, 3939, 15495, 62530, 253747,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207496}{A207496}, revision 9, last modified Oct 03 2025.
