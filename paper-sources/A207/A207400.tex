...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207400}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207400}{A207400} as

\begin{quote}\itshape Number of n X 5 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/3)*n\textasciicircum{}5 + 3*n\textasciicircum{}4 + (28/3)*n\textasciicircum{}3 + 7*n\textasciicircum{}2 - (29/3)*n + 2.\end{quote}

\begin{quote}\ttfamily G.f.: 2*x*(6 + 36*x - 36*x\textasciicircum{}2 + 15*x\textasciicircum{}3 - x\textasciicircum{}5) / (1 - x)\textasciicircum{}6.\end{quote}
...
\[a(n) = 2 - \frac{29}{3}n + 7n^{2} + \frac{28}{3}n^{3} + 3n^{4} + \frac{1}{3}n^{5}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{12x + 72x^{2} - 72x^{3} + 30x^{4} - 2x^{6}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}.\]
...
\begin{theorem} For A207400, $a(n)$ is the polynomial $2 - \frac{29}{3}n + 7n^{2} + \frac{28}{3}n^{3} + 3n^{4} + \frac{1}{3}n^{5}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $5$ is annihilated by the difference operator $(E-1)^{6}$, whose characteristic polynomial is $(t-1)^{6}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 6 = 17$. Its values were computed exactly; all of them vanish, and more than $17$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A207400, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{12x + 72x^{2} - 72x^{3} + 30x^{4} - 2x^{6}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}$.\end{theorem}
...
\begin{theorem} For A207400, the recurrence $a(n) = 6\,a(n-1) - 15\,a(n-2) + 20\,a(n-3) - 15\,a(n-4) + 6\,a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 612, 1782, 4212, 8692, 16284, 28362,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207400}{A207400}, revision 8, last modified Jun 22 2018.
