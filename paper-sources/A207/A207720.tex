...
\title{A proof of the conjectured linear recurrence for OEIS A207720}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207720}{A207720} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +37*a(n-2) -3*a(n-3) -132*a(n-4) +26*a(n-5) +132*a(n-6) -59*a(n-7) -15*a(n-8) +6*a(n-9) +a(n-10)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 37\,a(n-2) - 3\,a(n-3) - 132\,a(n-4) + 26\,a(n-5) + 132\,a(n-6) - \\ 59\,a(n-7) - 15\,a(n-8) + 6\,a(n-9) + a(n-10). \end{multline*}
...
\begin{theorem} For A207720, the recurrence $a(n) = 4\,a(n-1) + 37\,a(n-2) - 3\,a(n-3) - 132\,a(n-4) + 26\,a(n-5) + 132\,a(n-6) - 59\,a(n-7) - 15\,a(n-8) + 6\,a(n-9) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 1414, 11970, 97580, 805154, 6614706, 54438356,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207720}{A207720}, revision 9, last modified Oct 03 2025.
