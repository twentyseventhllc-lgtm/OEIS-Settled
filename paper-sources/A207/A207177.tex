...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207177}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207177}{A207177} as

\begin{quote}\itshape Number of n X 3 0..1 arrays avoiding 0 0 0 horizontally and 0 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) + 2*a(n-2) + 12*a(n-3) + 23*a(n-4) + 6*a(n-5) - a(n-6) - 2*a(n-7) - a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(7 + 21*x + 31*x\textasciicircum{}2 + 25*x\textasciicircum{}3 + 2*x\textasciicircum{}4 - 4*x\textasciicircum{}5 - 3*x\textasciicircum{}6 - x\textasciicircum{}7) / (1 - 4*x - 2*x\textasciicircum{}2 - 12*x\textasciicircum{}3 - 23*x\textasciicircum{}4 - 6*x\textasciicircum{}5 + x\textasciicircum{}6 + 2*x\textasciicircum{}7 + x\textasciicircum{}8). - Colin Barker, Jun 21 2018\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 23\,a(n-4) + 6\,a(n-5) - a(n-6) - \\ 2\,a(n-7) - a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x + 21x^{2} + 31x^{3} + 25x^{4} + 2x^{5} - 4x^{6} - 3x^{7} - x^{8}}{1 - 4x - 2x^{2} - 12x^{3} - 23x^{4} - 6x^{5} + x^{6} + 2x^{7} + x^{8}}.\]
...
\begin{theorem} For A207177, the recurrence $a(n) = 4\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 23\,a(n-4) + 6\,a(n-5) - a(n-6) - 2\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,43$. Every one of them vanished. After it, more than $S = 8$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A207177, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x + 21x^{2} + 31x^{3} + 25x^{4} + 2x^{5} - 4x^{6} - 3x^{7} - x^{8}}{1 - 4x - 2x^{2} - 12x^{3} - 23x^{4} - 6x^{5} + x^{6} + 2x^{7} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 241, 1171, 5917, 30067, 151981, 767377,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207177}{A207177}, revision 8, last modified Jun 21 2018.
