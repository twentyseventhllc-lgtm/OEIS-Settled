...
\title{A proof of the conjectured linear recurrence for OEIS A207070}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207070}{A207070} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -9*a(n-2) +21*a(n-3) -56*a(n-4) +64*a(n-5) -89*a(n-6) +192*a(n-7) -119*a(n-8) +117*a(n-9) -305*a(n-10) +46*a(n-11) -64*a(n-12) +323*a(n-13) +39*a(n-14) +36*a(n-15) -228*a(n-16) -56*a(n-17) -4*a(n-18) +80*a(n-19) +24*a(n-20) -16*a(n-22)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 9\,a(n-2) + 21\,a(n-3) - 56\,a(n-4) + 64\,a(n-5) - 89\,a(n-6) + \\ 192\,a(n-7) - 119\,a(n-8) + 117\,a(n-9) - 305\,a(n-10) + 46\,a(n-11) - 64\,a(n-12) + \\ 323\,a(n-13) + 39\,a(n-14) + 36\,a(n-15) - 228\,a(n-16) - 56\,a(n-17) - 4\,a(n-18) + \\ 80\,a(n-19) + 24\,a(n-20) - 16\,a(n-22). \end{multline*}
...
\begin{theorem} For A207070, the recurrence of order $22$ displayed in Section 1 holds for every $n \ge 23$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. Every one of them vanished. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 102, 288, 896, 2499, 6634, 17848,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207070}{A207070}, revision 9, last modified Oct 03 2025.
