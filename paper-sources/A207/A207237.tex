...
\title{A proof of the conjectured linear recurrence for OEIS A207237}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207237}{A207237} as

\begin{quote}\itshape Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) +6*a(n-3) -12*a(n-4) -8*a(n-5) -10*a(n-6) +8*a(n-7) +13*a(n-8) +11*a(n-9) -2*a(n-10) -4*a(n-11) -4*a(n-12) +a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) + 6\,a(n-3) - 12\,a(n-4) - 8\,a(n-5) - 10\,a(n-6) + \\ 8\,a(n-7) + 13\,a(n-8) + 11\,a(n-9) - 2\,a(n-10) - 4\,a(n-11) - 4\,a(n-12) + \\ a(n-14). \end{multline*}
...
\begin{theorem} For A207237, the recurrence $a(n) = 3\,a(n-1) - a(n-2) + 6\,a(n-3) - 12\,a(n-4) - 8\,a(n-5) - 10\,a(n-6) + 8\,a(n-7) + 13\,a(n-8) + 11\,a(n-9) - 2\,a(n-10) - 4\,a(n-11) - 4\,a(n-12) + a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 102, 287, 882, 2491, 6759, 18528,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207237}{A207237}, revision 9, last modified Oct 03 2025.
