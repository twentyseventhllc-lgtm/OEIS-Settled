...
\title{A proof of the conjectured linear recurrence for OEIS A207705}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207705}{A207705} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +14*a(n-3) +48*a(n-4) -65*a(n-5) -41*a(n-6) -103*a(n-7) -351*a(n-8) +353*a(n-9) +286*a(n-10) +103*a(n-11) +629*a(n-12) -480*a(n-13) -280*a(n-14) -16*a(n-15) -367*a(n-16) +216*a(n-17) +46*a(n-18) +2*a(n-19) +53*a(n-20) -28*a(n-21) -2*a(n-22) -2*a(n-24) +a(n-25)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 14\,a(n-3) + 48\,a(n-4) - 65\,a(n-5) - 41\,a(n-6) - 103\,a(n-7) - \\ 351\,a(n-8) + 353\,a(n-9) + 286\,a(n-10) + 103\,a(n-11) + 629\,a(n-12) - 480\,a(n-13) - \\ 280\,a(n-14) - 16\,a(n-15) - 367\,a(n-16) + 216\,a(n-17) + 46\,a(n-18) + 2\,a(n-19) + \\ 53\,a(n-20) - 28\,a(n-21) - 2\,a(n-22) - 2\,a(n-24) + a(n-25). \end{multline*}
...
\begin{theorem} For A207705, the recurrence of order $25$ displayed in Section 1 holds for every $n \ge 26$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 64, 216, 729, 3321, 15129, 61254, 248004,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207705}{A207705}, revision 9, last modified Oct 03 2025.
