...
\title{A proof of the conjectured linear recurrence for OEIS A207948}
...
\begin{multline*} a(n) = 6\,a(n-1) + 3\,a(n-2) + 8\,a(n-3) + 303\,a(n-4) + 385\,a(n-5) + 871\,a(n-6) + \\ 4356\,a(n-7) + 5282\,a(n-8) + 3375\,a(n-9) + 4096\,a(n-10) - 4422\,a(n-11) - 32005\,a(n-12) - \\ 63696\,a(n-13) - 35314\,a(n-14) + 48358\,a(n-15) + 111187\,a(n-16) + 82219\,a(n-17) - 21414\,a(n-18) - \\ 76099\,a(n-19) - 68521\,a(n-20) - 1500\,a(n-21) + 23855\,a(n-22) + 27908\,a(n-23) + 3257\,a(n-24) - \\ 2887\,a(n-25) - 6127\,a(n-26) - 714\,a(n-27) - 94\,a(n-28) + 735\,a(n-29) + 43\,a(n-30) + \\ 42\,a(n-31) - 45\,a(n-32) - 2\,a(n-34) + a(n-35). \end{multline*}
...
\begin{theorem} For A207948, the recurrence of order $35$ displayed in Section 1 holds for every $n \ge 36$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 2340, 18330, 133812, 1007146, 7513176, 56114310,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207948}{A207948}, revision 9, last modified Oct 03 2025.
