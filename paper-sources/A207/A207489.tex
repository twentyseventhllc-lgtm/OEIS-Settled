...
\title{A proof of the conjectured linear recurrence for OEIS A207489}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207489}{A207489} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +2*a(n-2) +a(n-3) -11*a(n-4) -5*a(n-5) +a(n-6) +23*a(n-7) +14*a(n-8) +4*a(n-9) -37*a(n-10) -31*a(n-11) -6*a(n-12) +43*a(n-13) +31*a(n-14) +2*a(n-15) -28*a(n-16) -15*a(n-17) +9*a(n-19) +3*a(n-20) -a(n-22)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 2\,a(n-2) + a(n-3) - 11\,a(n-4) - 5\,a(n-5) + a(n-6) + \\ 23\,a(n-7) + 14\,a(n-8) + 4\,a(n-9) - 37\,a(n-10) - 31\,a(n-11) - 6\,a(n-12) + \\ 43\,a(n-13) + 31\,a(n-14) + 2\,a(n-15) - 28\,a(n-16) - 15\,a(n-17) + 9\,a(n-19) + \\ 3\,a(n-20) - a(n-22). \end{multline*}
...
\begin{theorem} For A207489, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-2) + a(n-3) - 11\,a(n-4) - 5\,a(n-5) + a(n-6) + 23\,a(n-7) + 14\,a(n-8) + 4\,a(n-9) - 37\,a(n-10) - 31\,a(n-11) - 6\,a(n-12) + 43\,a(n-13) + 31\,a(n-14) + 2\,a(n-15) - 28\,a(n-16) - 15\,a(n-17) + 9\,a(n-19) + 3\,a(n-20) - a(n-22)$ holds for every $n \ge 23$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 177, 530, 1322, 2749, 6217, 12712,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207489}{A207489}, revision 9, last modified Oct 03 2025.
