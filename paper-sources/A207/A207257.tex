...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207257}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207257}{A207257} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (13/180)*n\textasciicircum{}6 + (143/20)*n\textasciicircum{}5 + (1235/36)*n\textasciicircum{}4 - (39/4)*n\textasciicircum{}3 - (377/45)*n\textasciicircum{}2 + (13/5)*n.\end{quote}

\begin{quote}\ttfamily G.f.: 26*x*(1 + 19*x + 2*x\textasciicircum{}2 - 28*x\textasciicircum{}3 + 7*x\textasciicircum{}4 + x\textasciicircum{}5) / (1 - x)\textasciicircum{}7.\end{quote}
...
\[a(n) = \frac{13}{5}n - \frac{377}{45}n^{2} - \frac{39}{4}n^{3} + \frac{1235}{36}n^{4} + \frac{143}{20}n^{5} + \frac{13}{180}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{26x + 494x^{2} + 52x^{3} - 728x^{4} + 182x^{5} + 26x^{6}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A207257, $a(n)$ is the polynomial $\frac{13}{5}n - \frac{377}{45}n^{2} - \frac{39}{4}n^{3} + \frac{1235}{36}n^{4} + \frac{143}{20}n^{5} + \frac{13}{180}n^{6}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $6$ is annihilated by the difference operator $(E-1)^{7}$, whose characteristic polynomial is $(t-1)^{7}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 7 = 18$. Its values were computed exactly; all of them vanish, and more than $18$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A207257, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{26x + 494x^{2} + 52x^{3} - 728x^{4} + 182x^{5} + 26x^{6}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A207257, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,50$. Every one of them vanished. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 26, 676, 4238, 15652, 43498, 101036, 207298, 388232,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207257}{A207257}, revision 8, last modified Jun 21 2018.
