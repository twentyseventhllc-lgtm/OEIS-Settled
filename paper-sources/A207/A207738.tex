...
\title{A proof of the conjectured linear recurrence for OEIS A207738}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207738}{A207738} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) -2*a(n-2) -307*a(n-3) +431*a(n-4) +2588*a(n-5) -3497*a(n-6) -10961*a(n-7) +10555*a(n-8) +24977*a(n-9) -14239*a(n-10) -30241*a(n-11) +8813*a(n-12) +19175*a(n-13) -2139*a(n-14) -6107*a(n-15) +82*a(n-16) +903*a(n-17) +13*a(n-18) -56*a(n-19) +a(n-21) for n>22\end{quote}
...
\begin{multline*} a(n) = 12\,a(n-1) - 2\,a(n-2) - 307\,a(n-3) + 431\,a(n-4) + 2588\,a(n-5) - 3497\,a(n-6) - \\ 10961\,a(n-7) + 10555\,a(n-8) + 24977\,a(n-9) - 14239\,a(n-10) - 30241\,a(n-11) + 8813\,a(n-12) + \\ 19175\,a(n-13) - 2139\,a(n-14) - 6107\,a(n-15) + 82\,a(n-16) + 903\,a(n-17) + 13\,a(n-18) - \\ 56\,a(n-19) + a(n-21). \end{multline*}
...
\begin{theorem} For A207738, the recurrence of order $21$ displayed in Section 1 holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 1$, that is at $n = 22$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 15, 225, 1425, 10535, 86355, 733363, 6349893, 55343835,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207738}{A207738}, revision 9, last modified Oct 03 2025.
