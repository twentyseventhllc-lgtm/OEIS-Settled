...
\title{A proof of the conjectured linear recurrence for OEIS A207842}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207842}{A207842} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-2) +48*a(n-3) +76*a(n-4) +109*a(n-5) -87*a(n-6) -231*a(n-7) -212*a(n-8) -604*a(n-9) -224*a(n-10) -993*a(n-11) +224*a(n-12) -604*a(n-13) +212*a(n-14) -231*a(n-15) +87*a(n-16) +109*a(n-17) -76*a(n-18) +48*a(n-19) -3*a(n-20) +a(n-22) for n>24\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-2) + 48\,a(n-3) + 76\,a(n-4) + 109\,a(n-5) - 87\,a(n-6) - 231\,a(n-7) - \\ 212\,a(n-8) - 604\,a(n-9) - 224\,a(n-10) - 993\,a(n-11) + 224\,a(n-12) - 604\,a(n-13) + \\ 212\,a(n-14) - 231\,a(n-15) + 87\,a(n-16) + 109\,a(n-17) - 76\,a(n-18) + 48\,a(n-19) - \\ 3\,a(n-20) + a(n-22). \end{multline*}
...
\begin{theorem} For A207842, the recurrence of order $22$ displayed in Section 1 holds for every $n > 24$, and fails at $n = 24$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 2$, that is at $n = 24$. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 432, 2320, 10144, 41444, 185136, 813824,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207842}{A207842}, revision 9, last modified Oct 03 2025.
