...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207065}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207065}{A207065} as

\begin{quote}\itshape Number of n X 5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (7/30)*n\textasciicircum{}5 + 7*n\textasciicircum{}4 + (21/2)*n\textasciicircum{}3 - (56/15)*n.\end{quote}

\begin{quote}\ttfamily G.f.: 14*x*(1 + 8*x - 5*x\textasciicircum{}2 - 2*x\textasciicircum{}3) / (1 - x)\textasciicircum{}6.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Jun 18 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = -\frac{56}{15}n + \frac{21}{2}n^{3} + 7n^{4} + \frac{7}{30}n^{5}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{14x + 112x^{2} - 70x^{3} - 28x^{4}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}.\]
...
\begin{theorem} For A207065, $a(n)$ is the polynomial $-\frac{56}{15}n + \frac{21}{2}n^{3} + 7n^{4} + \frac{7}{30}n^{5}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A207065, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{14x + 112x^{2} - 70x^{3} - 28x^{4}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}$.\end{theorem}
...
\begin{theorem} For A207065, the recurrence $a(n) = 6\,a(n-1) - 15\,a(n-2) + 20\,a(n-3) - 15\,a(n-4) + 6\,a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 896, 2688, 6398, 13132, 24304, 41664,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207065}{A207065}, revision 8, last modified Jun 18 2018.
