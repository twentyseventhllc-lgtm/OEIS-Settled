...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207067}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207067}{A207067} as

\begin{quote}\itshape Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (31/2520)*n\textasciicircum{}7 + (62/45)*n\textasciicircum{}6 + (4867/360)*n\textasciicircum{}5 + (2015/72)*n\textasciicircum{}4 + (1271/180)*n\textasciicircum{}3 - (4991/360)*n\textasciicircum{}2 - (713/140)*n.\end{quote}

\begin{quote}\ttfamily G.f.: 31*x*(1 + 23*x - 6*x\textasciicircum{}2 - 27*x\textasciicircum{}3 + 11*x\textasciicircum{}4) / (1 - x)\textasciicircum{}8.\end{quote}
...
\[a(n) = -\frac{713}{140}n - \frac{4991}{360}n^{2} + \frac{1271}{180}n^{3} + \frac{2015}{72}n^{4} + \frac{4867}{360}n^{5} + \frac{62}{45}n^{6} + \frac{31}{2520}n^{7}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{31x + 713x^{2} - 186x^{3} - 837x^{4} + 341x^{5}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}.\]
...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $10$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A207067, $a(n)$ is the polynomial $-\frac{713}{140}n - \frac{4991}{360}n^{2} + \frac{1271}{180}n^{3} + \frac{2015}{72}n^{4} + \frac{4867}{360}n^{5} + \frac{62}{45}n^{6} + \frac{31}{2520}n^{7}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $7$ is annihilated by the difference operator $(E-1)^{8}$, whose characteristic polynomial is $(t-1)^{8}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 8 = 18$. Its values were computed exactly; all of them vanish, and more than $18$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A207067, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{31x + 713x^{2} - 186x^{3} - 837x^{4} + 341x^{5}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}$.\end{theorem}
...
\begin{theorem} For A207067, the recurrence $a(n) = 8\,a(n-1) - 28\,a(n-2) + 56\,a(n-3) - 70\,a(n-4) + 56\,a(n-5) - 28\,a(n-6) + 8\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 31, 961, 6634, 27063, 82739, 210118, 468348, 947298,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207067}{A207067}, revision 8, last modified Jun 18 2018.
