...
\title{A proof of the conjectured linear recurrence for OEIS A316578}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316578}{A316578} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +13*a(n-2) +12*a(n-3) -18*a(n-4) -27*a(n-5) +4*a(n-6) +19*a(n-7) +31*a(n-8) -3*a(n-10) -3*a(n-11) -14*a(n-12) -6*a(n-14) +4*a(n-15) for n>16\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jul 07 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 4, last modified Jul 07 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = a(n-1) + 13\,a(n-2) + 12\,a(n-3) - 18\,a(n-4) - 27\,a(n-5) + 4\,a(n-6) + \\ 19\,a(n-7) + 31\,a(n-8) - 3\,a(n-10) - 3\,a(n-11) - 14\,a(n-12) - 6\,a(n-14) + \\ 4\,a(n-15). \end{multline*}
...
\begin{theorem} For A316578, the recurrence $a(n) = a(n-1) + 13\,a(n-2) + 12\,a(n-3) - 18\,a(n-4) - 27\,a(n-5) + 4\,a(n-6) + 19\,a(n-7) + 31\,a(n-8) - 3\,a(n-10) - 3\,a(n-11) - 14\,a(n-12) - 6\,a(n-14) + 4\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 23, 63, 338, 1312, 5936, 25271, 110555,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316578}{A316578}, revision 4, last modified Jul 07 2018.
