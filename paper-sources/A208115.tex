...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208115}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208115}{A208115} as

\begin{quote}\itshape Number of n X 5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(15 + 195*x + 315*x\textasciicircum{}2 + 625*x\textasciicircum{}3 + 290*x\textasciicircum{}4 + 34*x\textasciicircum{}5 - 50*x\textasciicircum{}6 + 14*x\textasciicircum{}7 + 7*x\textasciicircum{}8 - 5*x\textasciicircum{}9 - x\textasciicircum{}10 + x\textasciicircum{}11) / ((1 - x)\textasciicircum{}7*(1 + x)\textasciicircum{}5). - Colin Barker, Jun 28 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 23 2012).

The line quoted ending in that signature is contributed by Colin Barker on Jun 28 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Jun 28 2018, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{15x + 195x^{2} + 315x^{3} + 625x^{4} + 290x^{5} + 34x^{6} - 50x^{7} + 14x^{8} + 7x^{9} - 5x^{10} - x^{11} + x^{12}}{1 - 2x - 4x^{2} + 10x^{3} + 5x^{4} - 20x^{5} + 20x^{7} - 5x^{8} - 10x^{9} + 4x^{10} + 2x^{11} - x^{12}}.\]
...
That refinement leaves $36$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 25$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $2^{40}$ arrays, about $10^{12}$, against $25$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A208115, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) - 10\,a(n-3) - 5\,a(n-4) + 20\,a(n-5) - 20\,a(n-7) + 5\,a(n-8) + 10\,a(n-9) - 4\,a(n-10) - 2\,a(n-11) + a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,72$. Every one of them vanished. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A208115, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{15x + 195x^{2} + 315x^{3} + 625x^{4} + 290x^{5} + 34x^{6} - 50x^{7} + 14x^{8} + 7x^{9} - 5x^{10} - x^{11} + x^{12}}{1 - 2x - 4x^{2} + 10x^{3} + 5x^{4} - 20x^{5} + 20x^{7} - 5x^{8} - 10x^{9} + 4x^{10} + 2x^{11} - x^{12}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 15, 225, 825, 3025, 7315, 17689, 34713, 68121,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208115}{A208115}, revision 8, last modified Jun 28 2018.
