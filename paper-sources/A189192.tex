...
\title{A proof of the conjectured linear recurrence for OEIS A189192}
...
The reachable part of the digraph has $1057$ states, $1057$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 141$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $141\times141$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189192, the recurrence of order $57$ displayed in Section 1 holds for every $n \ge 58$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,221$. Every one of them vanished. After it, more than $S = 141$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 1024, 13045, 156564, 1579664, 15564047, 146936454, 1372985912,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189192}{A189192}, revision 9, last modified Oct 03 2025.
