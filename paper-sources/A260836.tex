...
\title{A proof of the conjectured linear recurrence for OEIS A260836}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260836}{A260836} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-3) +6*a(n-4) -9*a(n-6) -16*a(n-7) -10*a(n-8) +4*a(n-9) +7*a(n-10) +6*a(n-12) +8*a(n-14) +10*a(n-15) +2*a(n-16) +4*a(n-17) +4*a(n-19) +3*a(n-20) +2*a(n-22) for n>24\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-3) + 6\,a(n-4) - 9\,a(n-6) - 16\,a(n-7) - 10\,a(n-8) + 4\,a(n-9) + \\ 7\,a(n-10) + 6\,a(n-12) + 8\,a(n-14) + 10\,a(n-15) + 2\,a(n-16) + 4\,a(n-17) + \\ 4\,a(n-19) + 3\,a(n-20) + 2\,a(n-22). \end{multline*}
...
\begin{theorem} For A260836, the recurrence $a(n) = 6\,a(n-3) + 6\,a(n-4) - 9\,a(n-6) - 16\,a(n-7) - 10\,a(n-8) + 4\,a(n-9) + 7\,a(n-10) + 6\,a(n-12) + 8\,a(n-14) + 10\,a(n-15) + 2\,a(n-16) + 4\,a(n-17) + 4\,a(n-19) + 3\,a(n-20) + 2\,a(n-22)$ holds for every $n > 24$, and fails at $n = 24$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,87$. The last nonvanishing one is at $m = 2$, that is at $n = 24$. After it, more than $S = 31$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 188, 288, 700, 1224, 1560, 3470, 6908, 10070,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260836}{A260836}, revision 6, last modified Jun 02 2025.
