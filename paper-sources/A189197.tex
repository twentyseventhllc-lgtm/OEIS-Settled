...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A189197}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189197}{A189197} as

\begin{quote}\itshape Number of 4 X n binary arrays without the pattern 0 0 1 vertically or antidiagonally\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) -14*a(n-2) -52*a(n-3) +82*a(n-4) +16*a(n-5) -56*a(n-6) +16*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(1 - x)*(2 + 2*x - x\textasciicircum{}2)*(3 - 12*x\textasciicircum{}2 + 8*x\textasciicircum{}3) / (1 - 12*x + 14*x\textasciicircum{}2 + 52*x\textasciicircum{}3 - 82*x\textasciicircum{}4 - 16*x\textasciicircum{}5 + 56*x\textasciicircum{}6 - 16*x\textasciicircum{}7). - Colin Barker, May 01 2018\end{quote}
...
\begin{multline*} a(n) = 12\,a(n-1) - 14\,a(n-2) - 52\,a(n-3) + 82\,a(n-4) + 16\,a(n-5) - 56\,a(n-6) + \\ 16\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{12x - 66x^{3} + 38x^{4} + 72x^{5} - 72x^{6} + 16x^{7}}{1 - 12x + 14x^{2} + 52x^{3} - 82x^{4} - 16x^{5} + 56x^{6} - 16x^{7}}.\]
...
\begin{theorem} For A189197, the recurrence $a(n) = 12\,a(n-1) - 14\,a(n-2) - 52\,a(n-3) + 82\,a(n-4) + 16\,a(n-5) - 56\,a(n-6) + 16\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A189197, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{12x - 66x^{3} + 38x^{4} + 72x^{5} - 72x^{6} + 16x^{7}}{1 - 12x + 14x^{2} + 52x^{3} - 82x^{4} - 16x^{5} + 56x^{6} - 16x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 1494, 15326, 156564, 1598444, 16316636, 166552852,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189197}{A189197}, revision 8, last modified May 01 2018.
