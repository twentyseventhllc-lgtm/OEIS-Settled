...
\title{A proof of the conjectured linear recurrence for OEIS A207084}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207084}{A207084} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 horizontally and 0 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-1) -11*a(n-2) -195*a(n-3) +361*a(n-4) +1387*a(n-5) -2443*a(n-6) -5105*a(n-7) +6602*a(n-8) +9836*a(n-9) -7666*a(n-10) -9322*a(n-11) +3553*a(n-12) +4167*a(n-13) -507*a(n-14) -741*a(n-15) +25*a(n-16) +51*a(n-17) -a(n-18) -a(n-19).\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-1) - 11\,a(n-2) - 195\,a(n-3) + 361\,a(n-4) + 1387\,a(n-5) - 2443\,a(n-6) - \\ 5105\,a(n-7) + 6602\,a(n-8) + 9836\,a(n-9) - 7666\,a(n-10) - 9322\,a(n-11) + 3553\,a(n-12) + \\ 4167\,a(n-13) - 507\,a(n-14) - 741\,a(n-15) + 25\,a(n-16) + 51\,a(n-17) - a(n-18) - \\ a(n-19). \end{multline*}
...
\begin{theorem} For A207084, the recurrence of order $19$ displayed in Section 1 holds for every $n \ge 20$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 1393, 10621, 75221, 518001, 3500117, 23428181,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207084}{A207084}, revision 12, last modified Oct 03 2025.
