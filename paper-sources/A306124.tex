...
\title{A proof of the conjectured linear recurrence for OEIS A306124}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A306124}{A306124} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-3) -7*a(n-4) +4*a(n-5) -4*a(n-6) -7*a(n-8) +9*a(n-9) +14*a(n-10) +11*a(n-11) -7*a(n-12) -6*a(n-13).\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-3) - 7\,a(n-4) + 4\,a(n-5) - 4\,a(n-6) - 7\,a(n-8) + \\ 9\,a(n-9) + 14\,a(n-10) + 11\,a(n-11) - 7\,a(n-12) - 6\,a(n-13). \end{multline*}
...
\begin{theorem} For A306124, the recurrence $a(n) = 3\,a(n-1) - a(n-3) - 7\,a(n-4) + 4\,a(n-5) - 4\,a(n-6) - 7\,a(n-8) + 9\,a(n-9) + 14\,a(n-10) + 11\,a(n-11) - 7\,a(n-12) - 6\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 7, 9, 19, 39, 73, 147, 319,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A306124}{A306124}, revision 6, last modified Oct 13 2021.
