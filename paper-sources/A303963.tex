...
\title{A proof of the conjectured linear recurrence for OEIS A303963}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303963}{A303963} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 0, 1, 3 or 5 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A303963, the recurrence $a(n) = a(n-1) + 8\,a(n-3) - 4\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 5, 9, 21, 53, 105, 237, 577,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303963}{A303963}, revision 4, last modified May 03 2018.
