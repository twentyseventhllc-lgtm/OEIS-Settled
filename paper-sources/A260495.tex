...
\title{A proof of the conjectured linear recurrence for OEIS A260495}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260495}{A260495} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001011\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-3) +6*a(n-4) -7*a(n-6) -18*a(n-7) -10*a(n-8) +5*a(n-9) +7*a(n-10) +16*a(n-11) +6*a(n-12) -4*a(n-13) -3*a(n-15) -2*a(n-16) +a(n-17) for n>19\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-3) + 6\,a(n-4) - 7\,a(n-6) - 18\,a(n-7) - 10\,a(n-8) + 5\,a(n-9) + \\ 7\,a(n-10) + 16\,a(n-11) + 6\,a(n-12) - 4\,a(n-13) - 3\,a(n-15) - 2\,a(n-16) + \\ a(n-17). \end{multline*}
...
That refinement leaves $42$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 24$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A260495, the recurrence $a(n) = 6\,a(n-3) + 6\,a(n-4) - 7\,a(n-6) - 18\,a(n-7) - 10\,a(n-8) + 5\,a(n-9) + 7\,a(n-10) + 16\,a(n-11) + 6\,a(n-12) - 4\,a(n-13) - 3\,a(n-15) - 2\,a(n-16) + a(n-17)$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 2$, that is at $n = 19$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 83, 136, 347, 683, 942, 2115, 4393, 6800,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260495}{A260495}, revision 6, last modified Jun 02 2025.
