...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207306}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207306}{A207306} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + a(n-2) + 6*a(n-3) + 4*a(n-4) + a(n-5) - 2*a(n-6) - 2*a(n-7) for n>9.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(6 + 30*x + 56*x\textasciicircum{}2 + 101*x\textasciicircum{}3 + 56*x\textasciicircum{}4 + x\textasciicircum{}5 - 38*x\textasciicircum{}6 - 26*x\textasciicircum{}7 - 2*x\textasciicircum{}8) / (1 - x - x\textasciicircum{}2 - 6*x\textasciicircum{}3 - 4*x\textasciicircum{}4 - x\textasciicircum{}5 + 2*x\textasciicircum{}6 + 2*x\textasciicircum{}7). - Colin Barker, Mar 05 2018\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 6\,a(n-3) + 4\,a(n-4) + a(n-5) - 2\,a(n-6) - \\ 2\,a(n-7). \end{multline*}

stated for $n > 9$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 30x^{2} + 56x^{3} + 101x^{4} + 56x^{5} + x^{6} - 38x^{7} - 26x^{8} - 2x^{9}}{1 - x - x^{2} - 6x^{3} - 4x^{4} - x^{5} + 2x^{6} + 2x^{7}}.\]
...
\begin{theorem} For A207306, the recurrence $a(n) = a(n-1) + a(n-2) + 6\,a(n-3) + 4\,a(n-4) + a(n-5) - 2\,a(n-6) - 2\,a(n-7)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,50$. The last nonvanishing one is at $m = 2$, that is at $n = 9$. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 9$. The theorem is at least as strong.

\begin{theorem} For A207306, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 30x^{2} + 56x^{3} + 101x^{4} + 56x^{5} + x^{6} - 38x^{7} - 26x^{8} - 2x^{9}}{1 - x - x^{2} - 6x^{3} - 4x^{4} - x^{5} + 2x^{6} + 2x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 98, 271, 665, 1675, 4344, 11081,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207306}{A207306}, revision 8, last modified Mar 05 2018.
