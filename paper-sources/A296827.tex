...
k=1: a(n) = a(n-1)\\k=2: a(n) = 3*a(n-1) +5*a(n-3) -2*a(n-4) -10*a(n-5) -8*a(n-6)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 21 2017). As of revision 4, last modified Dec 21 2017, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
