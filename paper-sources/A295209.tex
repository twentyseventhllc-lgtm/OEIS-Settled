...
\title{A proof of the conjectured linear recurrence for OEIS A295209}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295209}{A295209} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with each 1 horizontally or vertically adjacent to 2 or 3 1's\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -17*a(n-2) +27*a(n-3) -66*a(n-4) +182*a(n-5) -188*a(n-6) -199*a(n-7) -22*a(n-8) +185*a(n-9) +385*a(n-10) +169*a(n-11) +49*a(n-12) +408*a(n-13) +516*a(n-14) -492*a(n-15) -1779*a(n-16) -408*a(n-17) +326*a(n-18) -331*a(n-19) +505*a(n-20) -310*a(n-21) +217*a(n-22) -111*a(n-23) +4*a(n-24) -16*a(n-25) +4*a(n-26) +4*a(n-27) -a(n-28).\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 17\,a(n-2) + 27\,a(n-3) - 66\,a(n-4) + 182\,a(n-5) - 188\,a(n-6) - \\ 199\,a(n-7) - 22\,a(n-8) + 185\,a(n-9) + 385\,a(n-10) + 169\,a(n-11) + 49\,a(n-12) + \\ 408\,a(n-13) + 516\,a(n-14) - 492\,a(n-15) - 1779\,a(n-16) - 408\,a(n-17) + 326\,a(n-18) - \\ 331\,a(n-19) + 505\,a(n-20) - 310\,a(n-21) + 217\,a(n-22) - 111\,a(n-23) + 4\,a(n-24) - \\ 16\,a(n-25) + 4\,a(n-26) + 4\,a(n-27) - a(n-28). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $133$; neither removal changes any count.
...
\begin{theorem} For A295209, the recurrence of order $28$ displayed in Section 1 holds for every $n \ge 29$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,84$. Every one of them vanished. After it, more than $S = 29$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 7, 27, 147, 916, 4938, 27208, 152236,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295209}{A295209}, revision 6, last modified Jun 22 2022.
