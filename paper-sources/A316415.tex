...
\title{A proof of the conjectured linear recurrence for OEIS A316415}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316415}{A316415} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +4*a(n-3) +2*a(n-4) -3*a(n-5) -9*a(n-6) -6*a(n-7) for n>10\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 9\,a(n-6) - \\ 6\,a(n-7). \end{multline*}
...
\begin{theorem} For A316415, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 9\,a(n-6) - 6\,a(n-7)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,54$. The last nonvanishing one is at $m = 3$, that is at $n = 10$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 5, 14, 27, 66, 180, 484, 1261,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316415}{A316415}, revision 4, last modified Jul 02 2018.
