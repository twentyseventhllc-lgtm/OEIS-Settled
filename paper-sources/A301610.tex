...
\title{A proof of the conjectured linear recurrence for OEIS A301610}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301610}{A301610} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2 or 3 horizontally or vertically adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +12*a(n-2) -5*a(n-3) -14*a(n-4) +14*a(n-6) +4*a(n-7) -3*a(n-8) -5*a(n-9) +a(n-10)\end{quote}
...
\begin{theorem} For A301610, the recurrence $a(n) = 4\,a(n-1) + 12\,a(n-2) - 5\,a(n-3) - 14\,a(n-4) + 14\,a(n-6) + 4\,a(n-7) - 3\,a(n-8) - 5\,a(n-9) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 11, 62, 367, 2131, 12467, 72758, 425003,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301610}{A301610}, revision 4, last modified Mar 24 2018.
