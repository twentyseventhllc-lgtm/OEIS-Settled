...
\title{A proof of the conjectured linear recurrence for OEIS A296537}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296537}{A296537} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 2 or 4 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -13*a(n-2) +21*a(n-3) -22*a(n-4) +7*a(n-5) +18*a(n-6) -37*a(n-7) -34*a(n-8) +111*a(n-9) -210*a(n-10) +91*a(n-11) +161*a(n-12) -194*a(n-13) +84*a(n-14) +464*a(n-15) -73*a(n-16) +283*a(n-17) +265*a(n-18) -165*a(n-19) -208*a(n-20) -363*a(n-21) -705*a(n-22) -701*a(n-23) -687*a(n-24) -589*a(n-25) -418*a(n-26) -171*a(n-27) -30*a(n-28) +142*a(n-29) +214*a(n-30) +244*a(n-31) +218*a(n-32) +175*a(n-33) +114*a(n-34) +69*a(n-35) +34*a(n-36) +14*a(n-37) +4*a(n-38) +a(n-39)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 13\,a(n-2) + 21\,a(n-3) - 22\,a(n-4) + 7\,a(n-5) + 18\,a(n-6) - \\ 37\,a(n-7) - 34\,a(n-8) + 111\,a(n-9) - 210\,a(n-10) + 91\,a(n-11) + 161\,a(n-12) - \\ 194\,a(n-13) + 84\,a(n-14) + 464\,a(n-15) - 73\,a(n-16) + 283\,a(n-17) + 265\,a(n-18) - \\ 165\,a(n-19) - 208\,a(n-20) - 363\,a(n-21) - 705\,a(n-22) - 701\,a(n-23) - 687\,a(n-24) - \\ 589\,a(n-25) - 418\,a(n-26) - 171\,a(n-27) - 30\,a(n-28) + 142\,a(n-29) + 214\,a(n-30) + \\ 244\,a(n-31) + 218\,a(n-32) + 175\,a(n-33) + 114\,a(n-34) + 69\,a(n-35) + 34\,a(n-36) + \\ 14\,a(n-37) + 4\,a(n-38) + a(n-39). \end{multline*}
...
\begin{theorem} For A296537, the recurrence of order $39$ displayed in Section 1 holds for every $n \ge 40$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,108$. Every one of them vanished. After it, more than $S = 39$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 8, 37, 126, 431, 1554, 5601, 20036,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296537}{A296537}, revision 4, last modified Dec 15 2017.
