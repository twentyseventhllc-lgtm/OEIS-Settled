...
\title{A proof of the conjectured linear recurrence for OEIS A296986}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296986}{A296986} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 adjacent to 3, 4 or 5 king-move neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +6*a(n-2) +51*a(n-3) -133*a(n-4) -268*a(n-5) -850*a(n-6) +1602*a(n-7) +3436*a(n-8) +6403*a(n-9) -7204*a(n-10) -17827*a(n-11) -31595*a(n-12) +9383*a(n-13) +38828*a(n-14) +93044*a(n-15) +30469*a(n-16) -2987*a(n-17) -173072*a(n-18) -125340*a(n-19) -22415*a(n-20) +291219*a(n-21) +110702*a(n-22) -99668*a(n-23) -406185*a(n-24) -72261*a(n-25) +146112*a(n-26) +278271*a(n-27) +31593*a(n-28) -175355*a(n-29) -108038*a(n-30) -29331*a(n-31) +80234*a(n-32) +31726*a(n-33) -2190*a(n-34) -20309*a(n-35) -7046*a(n-36) +1820*a(n-37) +2688*a(n-38) +739*a(n-39) -55*a(n-40) -103*a(n-41) -24*a(n-42) -3*a(n-43)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 6\,a(n-2) + 51\,a(n-3) - 133\,a(n-4) - 268\,a(n-5) - 850\,a(n-6) + \\ 1602\,a(n-7) + 3436\,a(n-8) + 6403\,a(n-9) - 7204\,a(n-10) - 17827\,a(n-11) - 31595\,a(n-12) + \\ 9383\,a(n-13) + 38828\,a(n-14) + 93044\,a(n-15) + 30469\,a(n-16) - 2987\,a(n-17) - 173072\,a(n-18) - \\ 125340\,a(n-19) - 22415\,a(n-20) + 291219\,a(n-21) + 110702\,a(n-22) - 99668\,a(n-23) - 406185\,a(n-24) - \\ 72261\,a(n-25) + 146112\,a(n-26) + 278271\,a(n-27) + 31593\,a(n-28) - 175355\,a(n-29) - 108038\,a(n-30) - \\ 29331\,a(n-31) + 80234\,a(n-32) + 31726\,a(n-33) - 2190\,a(n-34) - 20309\,a(n-35) - 7046\,a(n-36) + \\ 1820\,a(n-37) + 2688\,a(n-38) + 739\,a(n-39) - 55\,a(n-40) - 103\,a(n-41) - 24\,a(n-42) - \\ 3\,a(n-43). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $205$; neither removal changes any count.
...
\begin{theorem} For A296986, the recurrence of order $43$ displayed in Section 1 holds for every $n \ge 44$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,123$. Every one of them vanished. After it, more than $S = 52$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 7, 28, 74, 440, 2514, 12601, 71009,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296986}{A296986}, revision 4, last modified Dec 22 2017.
