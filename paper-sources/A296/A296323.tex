...
\title{A proof of the conjectured linear recurrence for OEIS A296323}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296323}{A296323} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 2 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -6*a(n-2) +13*a(n-3) -17*a(n-4) +22*a(n-5) -30*a(n-6) +33*a(n-7) -42*a(n-8) +37*a(n-9) -34*a(n-10) +21*a(n-11) -12*a(n-12) +4*a(n-13) -a(n-14)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 6\,a(n-2) + 13\,a(n-3) - 17\,a(n-4) + 22\,a(n-5) - 30\,a(n-6) + \\ 33\,a(n-7) - 42\,a(n-8) + 37\,a(n-9) - 34\,a(n-10) + 21\,a(n-11) - 12\,a(n-12) + \\ 4\,a(n-13) - a(n-14). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $78$; neither removal changes any count.
...
\begin{theorem} For A296323, the recurrence $a(n) = 4\,a(n-1) - 6\,a(n-2) + 13\,a(n-3) - 17\,a(n-4) + 22\,a(n-5) - 30\,a(n-6) + 33\,a(n-7) - 42\,a(n-8) + 37\,a(n-9) - 34\,a(n-10) + 21\,a(n-11) - 12\,a(n-12) + 4\,a(n-13) - a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,60$. Every one of them vanished. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 8, 23, 61, 185, 562, 1677, 4998,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296323}{A296323}, revision 4, last modified Dec 10 2017.
