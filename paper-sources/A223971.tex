...
\title{A proof of the conjectured linear recurrence for OEIS A223971}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223971}{A223971} as

\begin{quote}\itshape Number of nX4 0..2 arrays with rows and antidiagonals unimodal\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 46*a(n-1) -475*a(n-2) +1981*a(n-3) -20047*a(n-4) +170659*a(n-5) -619313*a(n-6) +1472430*a(n-7) -5125985*a(n-8) +14966969*a(n-9) -26289219*a(n-10) +49504177*a(n-11) -100448013*a(n-12) +127366991*a(n-13) -120709682*a(n-14) +121925145*a(n-15) -83316868*a(n-16) +21878656*a(n-17) -230400*a(n-18)\end{quote}
...
\begin{multline*} a(n) = 46\,a(n-1) - 475\,a(n-2) + 1981\,a(n-3) - 20047\,a(n-4) + 170659\,a(n-5) - 619313\,a(n-6) + \\ 1472430\,a(n-7) - 5125985\,a(n-8) + 14966969\,a(n-9) - 26289219\,a(n-10) + 49504177\,a(n-11) - 100448013\,a(n-12) + \\ 127366991\,a(n-13) - 120709682\,a(n-14) + 121925145\,a(n-15) - 83316868\,a(n-16) + 21878656\,a(n-17) - 230400\,a(n-18). \end{multline*}
...
\begin{theorem} For A223971, the recurrence of order $18$ displayed in Section 1 holds for every $n \ge 19$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 46, 2116, 76092, 2558848, 84988435, 2809740785, 92756321858, 3060966419662,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223971}{A223971}, revision 8, last modified Oct 03 2025.
