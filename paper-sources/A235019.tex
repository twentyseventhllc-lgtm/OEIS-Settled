...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A235019}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A235019}{A235019} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 18*a(n-2) - 56*a(n-4) + 32*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(22 + 83*x - 84*x\textasciicircum{}2 - 318*x\textasciicircum{}3 + 48*x\textasciicircum{}4 + 192*x\textasciicircum{}5) / (1 - 18*x\textasciicircum{}2 + 56*x\textasciicircum{}4 - 32*x\textasciicircum{}6). - Colin Barker, Oct 17 2018\end{quote}
...
\[a(n) = 18\,a(n-2) - 56\,a(n-4) + 32\,a(n-6).\]
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{88x + 332x^{2} - 336x^{3} - 1272x^{4} + 192x^{5} + 768x^{6}}{1 - 18x^{2} + 56x^{4} - 32x^{6}}.\]
...
\begin{theorem} For A235019, the recurrence $a(n) = 18\,a(n-2) - 56\,a(n-4) + 32\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A235019, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{88x + 332x^{2} - 336x^{3} - 1272x^{4} + 192x^{5} + 768x^{6}}{1 - 18x^{2} + 56x^{4} - 32x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 88, 332, 1248, 4704, 17728, 66848, 252032, 950464,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A235019}{A235019}, revision 9, last modified Jun 19 2022.
