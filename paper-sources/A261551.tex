...
\title{A proof of the conjectured linear recurrence for OEIS A261551}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A261551}{A261551} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001011\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-7) +4*a(n-10) +2*a(n-13) -3*a(n-14) -2*a(n-17) +a(n-20) -4*a(n-21) -4*a(n-23) -8*a(n-24) -a(n-26) -6*a(n-27) +3*a(n-28) +3*a(n-34) +2*a(n-35) +2*a(n-38) for n>44\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-7) + 4\,a(n-10) + 2\,a(n-13) - 3\,a(n-14) - 2\,a(n-17) + a(n-20) - \\ 4\,a(n-21) - 4\,a(n-23) - 8\,a(n-24) - a(n-26) - 6\,a(n-27) + 3\,a(n-28) + \\ 3\,a(n-34) + 2\,a(n-35) + 2\,a(n-38). \end{multline*}
...
That refinement leaves $116$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 69$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $2^{48}$ arrays, about $10^{14}$, against $69$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A261551, the recurrence $a(n) = 4\,a(n-7) + 4\,a(n-10) + 2\,a(n-13) - 3\,a(n-14) - 2\,a(n-17) + a(n-20) - 4\,a(n-21) - 4\,a(n-23) - 8\,a(n-24) - a(n-26) - 6\,a(n-27) + 3\,a(n-28) + 3\,a(n-34) + 2\,a(n-35) + 2\,a(n-38)$ holds for every $n > 44$, and fails at $n = 44$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,149$. The last nonvanishing one is at $m = 6$, that is at $n = 44$. After it, more than $S = 69$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 36 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 336, 484, 754, 769, 816, 1286, 1510, 1615,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A261551}{A261551}, revision 4, last modified Aug 24 2015.
