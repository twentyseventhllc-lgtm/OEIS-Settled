...
\title{A proof of the conjectured linear recurrence for OEIS A304467}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304467}{A304467} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +8*a(n-3) -21*a(n-4) -26*a(n-5) +10*a(n-6) +31*a(n-7) +20*a(n-8) -20*a(n-9) -10*a(n-10) for n>12\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 8\,a(n-3) - 21\,a(n-4) - 26\,a(n-5) + 10\,a(n-6) + 31\,a(n-7) + \\ 20\,a(n-8) - 20\,a(n-9) - 10\,a(n-10). \end{multline*}
...
\begin{theorem} For A304467, the recurrence $a(n) = 3\,a(n-1) + 8\,a(n-3) - 21\,a(n-4) - 26\,a(n-5) + 10\,a(n-6) + 31\,a(n-7) + 20\,a(n-8) - 20\,a(n-9) - 10\,a(n-10)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 21, 41, 117, 316, 810, 2208, 6012,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304467}{A304467}, revision 4, last modified May 13 2018.
