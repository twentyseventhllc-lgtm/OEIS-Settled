...
\title{A proof of the conjectured linear recurrence for OEIS A316178}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316178}{A316178} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +8*a(n-2) -4*a(n-3) -11*a(n-4) -a(n-5) -13*a(n-7) +2*a(n-8) -a(n-9) -a(n-10) -a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 8\,a(n-2) - 4\,a(n-3) - 11\,a(n-4) - a(n-5) - 13\,a(n-7) + \\ 2\,a(n-8) - a(n-9) - a(n-10) - a(n-11). \end{multline*}
...
\begin{theorem} For A316178, the recurrence $a(n) = 3\,a(n-1) + 8\,a(n-2) - 4\,a(n-3) - 11\,a(n-4) - a(n-5) - 13\,a(n-7) + 2\,a(n-8) - a(n-9) - a(n-10) - a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,54$. The last nonvanishing one is at $m = 1$, that is at $n = 12$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 30, 134, 601, 2665, 11915, 53134, 237241,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316178}{A316178}, revision 4, last modified Jun 25 2018.
