...
\title{A proof of the conjectured linear recurrence for OEIS A208551}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208551}{A208551} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}
...
\begin{theorem} For A208551, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) - 10\,a(n-3) - 5\,a(n-4) + 20\,a(n-5) - 20\,a(n-7) + 5\,a(n-8) + 10\,a(n-9) - 4\,a(n-10) - 2\,a(n-11) + a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 330, 1089, 2508, 5776, 11020, 21025,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208551}{A208551}, revision 8, last modified Jul 03 2018.
