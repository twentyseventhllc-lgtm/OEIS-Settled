...
\title{A proof of the conjectured linear recurrence for OEIS A260171}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260171}{A260171} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00010001\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +5*a(n-3) +5*a(n-4) -3*a(n-5) +5*a(n-6) +9*a(n-7) -5*a(n-8) -5*a(n-9) +4*a(n-10) -17*a(n-11) -14*a(n-12) +4*a(n-13) -4*a(n-14) -4*a(n-15) for n>16\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 5\,a(n-3) + 5\,a(n-4) - 3\,a(n-5) + 5\,a(n-6) + \\ 9\,a(n-7) - 5\,a(n-8) - 5\,a(n-9) + 4\,a(n-10) - 17\,a(n-11) - 14\,a(n-12) + \\ 4\,a(n-13) - 4\,a(n-14) - 4\,a(n-15). \end{multline*}
...
\begin{theorem} For A260171, the recurrence $a(n) = a(n-1) + a(n-2) + 5\,a(n-3) + 5\,a(n-4) - 3\,a(n-5) + 5\,a(n-6) + 9\,a(n-7) - 5\,a(n-8) - 5\,a(n-9) + 4\,a(n-10) - 17\,a(n-11) - 14\,a(n-12) + 4\,a(n-13) - 4\,a(n-14) - 4\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,67$. The last nonvanishing one is at $m = 1$, that is at $n = 16$. After it, more than $S = 21$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 74, 167, 419, 1001, 2500, 6344, 15847, 39584,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260171}{A260171}, revision 6, last modified Jun 02 2025.
