...
\title{A proof of the conjectured linear recurrence for OEIS A298549}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298549}{A298549} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -a(n-2) -7*a(n-3) -5*a(n-4) +13*a(n-5) +19*a(n-6) -27*a(n-7) +a(n-8) +3*a(n-9) -55*a(n-10) +37*a(n-11) +55*a(n-12) -23*a(n-13) -a(n-14) +9*a(n-15) -16*a(n-16) -11*a(n-17) +4*a(n-18) +2*a(n-19) for n>20\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jan 21 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 5, last modified Jan 21 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 4\,a(n-1) - a(n-2) - 7\,a(n-3) - 5\,a(n-4) + 13\,a(n-5) + 19\,a(n-6) - \\ 27\,a(n-7) + a(n-8) + 3\,a(n-9) - 55\,a(n-10) + 37\,a(n-11) + 55\,a(n-12) - \\ 23\,a(n-13) - a(n-14) + 9\,a(n-15) - 16\,a(n-16) - 11\,a(n-17) + 4\,a(n-18) + \\ 2\,a(n-19). \end{multline*}
...
\begin{theorem} For A298549, the recurrence $a(n) = 4\,a(n-1) - a(n-2) - 7\,a(n-3) - 5\,a(n-4) + 13\,a(n-5) + 19\,a(n-6) - 27\,a(n-7) + a(n-8) + 3\,a(n-9) - 55\,a(n-10) + 37\,a(n-11) + 55\,a(n-12) - 23\,a(n-13) - a(n-14) + 9\,a(n-15) - 16\,a(n-16) - 11\,a(n-17) + 4\,a(n-18) + 2\,a(n-19)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 7, 4, 14, 16, 51, 104, 262,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298549}{A298549}, revision 5, last modified Jan 21 2018.
