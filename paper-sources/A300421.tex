...
\title{A proof of the conjectured recurrence and generating function for OEIS A300421}
...
Here the refinement leaves $S = 7$ blocks. Writing $L$ for the $S\times S$ quotient matrix, $\tilde w$ for the start weights summed over each block and $\tilde f$ for the acceptance indicator,
