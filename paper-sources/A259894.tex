...
k=1: a(n) = a(n-1) +5*a(n-3) +3*a(n-4)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 07 2015). As of revision 6, last modified Jun 02 2025, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
