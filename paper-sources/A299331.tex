...
\title{A proof of the conjectured order of the recurrence for OEIS A299331}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299331}{A299331} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 17, 173, 2537, 46286, 816886, 14783424, 267652693,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299331}{A299331}, revision 4, last modified Feb 07 2018.
