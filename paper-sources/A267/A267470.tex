...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A267470}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A267470}{A267470} as

\begin{quote}\itshape Number of length-n 0..7 arrays with no following elements larger than the first repeated value\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 43*a(n-1) -798*a(n-2) +8358*a(n-3) -54201*a(n-4) +224427*a(n-5) -589112*a(n-6) +936452*a(n-7) -807408*a(n-8) +282240*a(n-9).\end{quote}

\begin{quote}\ttfamily G.f.: 4*x*(2 - 70*x + 1029*x\textasciicircum{}2 - 8253*x\textasciicircum{}3 + 39228*x\textasciicircum{}4 - 112119*x\textasciicircum{}5 + 185785*x\textasciicircum{}6 - 160106*x\textasciicircum{}7 + 53244*x\textasciicircum{}8) / ((1 - x)*(1 - 2*x)*(1 - 3*x)*(1 - 4*x)*(1 - 5*x)*(1 - 6*x)*(1 - 7*x)\textasciicircum{}2*(1 - 8*x)).\end{quote}
...
\begin{multline*} a(n) = 43\,a(n-1) - 798\,a(n-2) + 8358\,a(n-3) - 54201\,a(n-4) + 224427\,a(n-5) - 589112\,a(n-6) + \\ 936452\,a(n-7) - 807408\,a(n-8) + 282240\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{8x - 280x^{2} + 4116x^{3} - 33012x^{4} + 156912x^{5} - 448476x^{6} + 743140x^{7} - 640424x^{8} + 212976x^{9}}{1 - 43x + 798x^{2} - 8358x^{3} + 54201x^{4} - 224427x^{5} + 589112x^{6} - 936452x^{7} + 807408x^{8} - 282240x^{9}}.\]
...
\begin{theorem} For A267470, the recurrence $a(n) = 43\,a(n-1) - 798\,a(n-2) + 8358\,a(n-3) - 54201\,a(n-4) + 224427\,a(n-5) - 589112\,a(n-6) + 936452\,a(n-7) - 807408\,a(n-8) + 282240\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A267470, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{8x - 280x^{2} + 4116x^{3} - 33012x^{4} + 156912x^{5} - 448476x^{6} + 743140x^{7} - 640424x^{8} + 212976x^{9}}{1 - 43x + 798x^{2} - 8358x^{3} + 54201x^{4} - 224427x^{5} + 589112x^{6} - 936452x^{7} + 807408x^{8} - 282240x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 64, 484, 3592, 26440, 193852, 1418740, 10378144,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A267470}{A267470}, revision 7, last modified Feb 05 2018.
