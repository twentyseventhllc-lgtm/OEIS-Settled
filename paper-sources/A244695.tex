...
\title{A proof of the conjectured linear recurrence for OEIS A244695}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A244695}{A244695} as

\begin{quote}\itshape Number of length n+4 0..3 arrays with no five consecutive elements with pattern ababa or abbba (with a!=b) and new values 0..3 introduced in 0..3 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -3*a(n-2) -5*a(n-3) +a(n-4) -3*a(n-5) +4*a(n-6) -4*a(n-7) +a(n-8) +3*a(n-9) +2*a(n-11) -a(n-12) +a(n-13)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 3\,a(n-2) - 5\,a(n-3) + a(n-4) - 3\,a(n-5) + 4\,a(n-6) - \\ 4\,a(n-7) + a(n-8) + 3\,a(n-9) + 2\,a(n-11) - a(n-12) + a(n-13). \end{multline*}
...
The reachable part of that digraph has $363$ states, $363$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 14$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $14\times14$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A244695, the recurrence $a(n) = 5\,a(n-1) - 3\,a(n-2) - 5\,a(n-3) + a(n-4) - 3\,a(n-5) + 4\,a(n-6) - 4\,a(n-7) + a(n-8) + 3\,a(n-9) + 2\,a(n-11) - a(n-12) + a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 49, 176, 661, 2540, 9858, 38440, 150208, 587527,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A244695}{A244695}, revision 6, last modified Jul 23 2025.
