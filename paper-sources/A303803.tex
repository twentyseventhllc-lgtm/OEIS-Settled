...
\title{A proof of the conjectured linear recurrence for OEIS A303803}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303803}{A303803} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) -3*a(n-3) +6*a(n-4) -5*a(n-5) -2*a(n-6) -a(n-7) -6*a(n-8) +4*a(n-9) +2*a(n-10)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) - 3\,a(n-3) + 6\,a(n-4) - 5\,a(n-5) - 2\,a(n-6) - \\ a(n-7) - 6\,a(n-8) + 4\,a(n-9) + 2\,a(n-10). \end{multline*}
...
The construction gives $72$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $39$; neither removal changes any count.
...
\begin{theorem} For A303803, the recurrence $a(n) = 3\,a(n-1) - a(n-2) - 3\,a(n-3) + 6\,a(n-4) - 5\,a(n-5) - 2\,a(n-6) - a(n-7) - 6\,a(n-8) + 4\,a(n-9) + 2\,a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 7, 9, 15, 27, 47, 83, 161,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303803}{A303803}, revision 4, last modified Apr 30 2018.
