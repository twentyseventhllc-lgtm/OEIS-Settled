...
\title{A proof of the conjectured linear recurrence for OEIS A251038}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A251038}{A251038} as

\begin{quote}\itshape Number of (1+1)X(n+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -25*a(n-2) -30*a(n-3) +146*a(n-4) +31*a(n-5) -287*a(n-6) -50*a(n-7) +239*a(n-8) +59*a(n-9) -86*a(n-10) -27*a(n-11) +11*a(n-12) +4*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 25\,a(n-2) - 30\,a(n-3) + 146\,a(n-4) + 31\,a(n-5) - 287\,a(n-6) - \\ 50\,a(n-7) + 239\,a(n-8) + 59\,a(n-9) - 86\,a(n-10) - 27\,a(n-11) + 11\,a(n-12) + \\ 4\,a(n-13). \end{multline*}
...
\begin{theorem} For A251038, the recurrence $a(n) = 10\,a(n-1) - 25\,a(n-2) - 30\,a(n-3) + 146\,a(n-4) + 31\,a(n-5) - 287\,a(n-6) - 50\,a(n-7) + 239\,a(n-8) + 59\,a(n-9) - 86\,a(n-10) - 27\,a(n-11) + 11\,a(n-12) + 4\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 110, 711, 4050, 21720, 110852, 546600, 2624313, 12343573,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A251038}{A251038}, revision 6, last modified Jul 23 2025.
