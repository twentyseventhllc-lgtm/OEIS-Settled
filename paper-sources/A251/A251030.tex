...
\title{A proof of the conjectured linear recurrence for OEIS A251030}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A251030}{A251030} as

\begin{quote}\itshape Number of (n+1)X(1+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) -46*a(n-2) +40*a(n-3) +111*a(n-4) -168*a(n-5) -110*a(n-6) +172*a(n-7) +95*a(n-8) -52*a(n-9) -48*a(n-10) -12*a(n-11) -a(n-12)\end{quote}
...
\begin{multline*} a(n) = 12\,a(n-1) - 46\,a(n-2) + 40\,a(n-3) + 111\,a(n-4) - 168\,a(n-5) - 110\,a(n-6) + \\ 172\,a(n-7) + 95\,a(n-8) - 52\,a(n-9) - 48\,a(n-10) - 12\,a(n-11) - a(n-12). \end{multline*}
...
\begin{theorem} For A251030, the recurrence $a(n) = 12\,a(n-1) - 46\,a(n-2) + 40\,a(n-3) + 111\,a(n-4) - 168\,a(n-5) - 110\,a(n-6) + 172\,a(n-7) + 95\,a(n-8) - 52\,a(n-9) - 48\,a(n-10) - 12\,a(n-11) - a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,51$. Every one of them vanished. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 110, 636, 3550, 19112, 100633, 521227, 2668193, 13542602,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A251030}{A251030}, revision 6, last modified Jul 23 2025.
