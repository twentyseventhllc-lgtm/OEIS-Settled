...
\title{A proof of the conjectured order of the recurrence for OEIS A300608}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300608}{A300608} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A300608, the least order of a linear recurrence that $a$ eventually satisfies is exactly $72$, and that recurrence holds for every $n > 73$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 30, 277, 2347, 19532, 164619, 1387896, 11697909,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300608}{A300608}, revision 6, last modified May 25 2024.
