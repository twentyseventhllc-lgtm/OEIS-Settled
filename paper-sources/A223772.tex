...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A223772}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223772}{A223772} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with rows and columns unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/720)*n\textasciicircum{}6 + (1/80)*n\textasciicircum{}5 + (29/144)*n\textasciicircum{}4 + (25/48)*n\textasciicircum{}3 + (1727/360)*n\textasciicircum{}2 - (8/15)*n + 2.\end{quote}

\begin{quote}\ttfamily G.f.: x*(7 - 21*x + 29*x\textasciicircum{}2 - 23*x\textasciicircum{}3 + 14*x\textasciicircum{}4 - 7*x\textasciicircum{}5 + 2*x\textasciicircum{}6) / (1 - x)\textasciicircum{}7.\end{quote}
...
\[a(n) = 2 - \frac{8}{15}n + \frac{1727}{360}n^{2} + \frac{25}{48}n^{3} + \frac{29}{144}n^{4} + \frac{1}{80}n^{5} + \frac{1}{720}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x - 21x^{2} + 29x^{3} - 23x^{4} + 14x^{5} - 7x^{6} + 2x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A223772, $a(n)$ is the polynomial $2 - \frac{8}{15}n + \frac{1727}{360}n^{2} + \frac{25}{48}n^{3} + \frac{29}{144}n^{4} + \frac{1}{80}n^{5} + \frac{1}{720}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A223772, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x - 21x^{2} + 29x^{3} - 23x^{4} + 14x^{5} - 7x^{6} + 2x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A223772, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 34 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 28, 78, 180, 371, 707, 1269, 2170,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223772}{A223772}, revision 7, last modified Aug 23 2018.
