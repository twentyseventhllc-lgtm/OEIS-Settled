...
\title{A proof of the conjectured linear recurrence for OEIS A303965}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303965}{A303965} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 3 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +2*a(n-3) -a(n-4) -2*a(n-5) +7*a(n-6) -8*a(n-7) -2*a(n-8) -11*a(n-9) +a(n-10) +6*a(n-11) -12*a(n-12) +4*a(n-13) +4*a(n-14) +18*a(n-15) +7*a(n-16) -3*a(n-17) +6*a(n-18) +8*a(n-19) +2*a(n-20) -6*a(n-21) -10*a(n-22) -5*a(n-23) +a(n-24) -6*a(n-25) -6*a(n-26) -7*a(n-27) +a(n-28) +5*a(n-29) +2*a(n-32) +4*a(n-33) +2*a(n-34) -a(n-35) -a(n-36) for n>37\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 2\,a(n-3) - a(n-4) - 2\,a(n-5) + 7\,a(n-6) - 8\,a(n-7) - \\ 2\,a(n-8) - 11\,a(n-9) + a(n-10) + 6\,a(n-11) - 12\,a(n-12) + 4\,a(n-13) + \\ 4\,a(n-14) + 18\,a(n-15) + 7\,a(n-16) - 3\,a(n-17) + 6\,a(n-18) + 8\,a(n-19) + \\ 2\,a(n-20) - 6\,a(n-21) - 10\,a(n-22) - 5\,a(n-23) + a(n-24) - 6\,a(n-25) - \\ 6\,a(n-26) - 7\,a(n-27) + a(n-28) + 5\,a(n-29) + 2\,a(n-32) + 4\,a(n-33) + \\ 2\,a(n-34) - a(n-35) - a(n-36). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $134$; neither removal changes any count.
...
\begin{theorem} For A303965, the recurrence of order $36$ displayed in Section 1 holds for every $n > 37$, and fails at $n = 37$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,109$. The last nonvanishing one is at $m = 1$, that is at $n = 37$. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 21, 26, 73, 173, 374, 842, 1923,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303965}{A303965}, revision 4, last modified May 03 2018.
