...
\title{A proof of the conjectured linear recurrence for OEIS A298315}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298315}{A298315} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-2) +12*a(n-3) -15*a(n-4) -40*a(n-5) -53*a(n-6) +62*a(n-7) +133*a(n-8) +92*a(n-9) -92*a(n-10) -146*a(n-11) -11*a(n-12) +102*a(n-13) +49*a(n-14) -49*a(n-15) -64*a(n-16) -48*a(n-17) for n>18\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 4\,a(n-2) + 12\,a(n-3) - 15\,a(n-4) - 40\,a(n-5) - 53\,a(n-6) + \\ 62\,a(n-7) + 133\,a(n-8) + 92\,a(n-9) - 92\,a(n-10) - 146\,a(n-11) - 11\,a(n-12) + \\ 102\,a(n-13) + 49\,a(n-14) - 49\,a(n-15) - 64\,a(n-16) - 48\,a(n-17). \end{multline*}
...
\begin{theorem} For A298315, the recurrence $a(n) = a(n-1) + 4\,a(n-2) + 12\,a(n-3) - 15\,a(n-4) - 40\,a(n-5) - 53\,a(n-6) + 62\,a(n-7) + 133\,a(n-8) + 92\,a(n-9) - 92\,a(n-10) - 146\,a(n-11) - 11\,a(n-12) + 102\,a(n-13) + 49\,a(n-14) - 49\,a(n-15) - 64\,a(n-16) - 48\,a(n-17)$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,71$. The last nonvanishing one is at $m = 1$, that is at $n = 18$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 3, 3, 9, 17, 48, 94, 234,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298315}{A298315}, revision 4, last modified Jan 17 2018.
