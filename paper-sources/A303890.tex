...
\title{A proof of the conjectured linear recurrence for OEIS A303890}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303890}{A303890} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 1, 2, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A303890, the recurrence $a(n) = 3\,a(n-1) + a(n-2) + 4\,a(n-3) + 4\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 7, 23, 86, 313, 1145, 4184, 15293,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303890}{A303890}, revision 4, last modified May 02 2018.
