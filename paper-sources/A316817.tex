...
\title{A proof of the conjectured linear recurrence for OEIS A316817}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316817}{A316817} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +4*a(n-2) +9*a(n-3) -34*a(n-4) +20*a(n-5) -5*a(n-6) +4*a(n-7) -24*a(n-8) -34*a(n-9) -16*a(n-10) -8*a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 4\,a(n-2) + 9\,a(n-3) - 34\,a(n-4) + 20\,a(n-5) - 5\,a(n-6) + \\ 4\,a(n-7) - 24\,a(n-8) - 34\,a(n-9) - 16\,a(n-10) - 8\,a(n-11). \end{multline*}
...
\begin{theorem} For A316817, the recurrence $a(n) = 5\,a(n-1) + 4\,a(n-2) + 9\,a(n-3) - 34\,a(n-4) + 20\,a(n-5) - 5\,a(n-6) + 4\,a(n-7) - 24\,a(n-8) - 34\,a(n-9) - 16\,a(n-10) - 8\,a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 30, 169, 983, 5701, 33046, 191692, 1111756,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316817}{A316817}, revision 4, last modified Jul 14 2018.
