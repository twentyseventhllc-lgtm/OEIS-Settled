...
\title{A proof of the conjectured linear recurrence for OEIS A223946}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223946}{A223946} as

\begin{quote}\itshape Number of nX5 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -9*a(n-2) -a(n-3) +11*a(n-4) -7*a(n-5) +12*a(n-6) -51*a(n-7) -91*a(n-8) -171*a(n-9) +353*a(n-10) +89*a(n-11) +73*a(n-12) +177*a(n-13) +22*a(n-14) -64*a(n-15) -24*a(n-16)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 9\,a(n-2) - a(n-3) + 11\,a(n-4) - 7\,a(n-5) + 12\,a(n-6) - \\ 51\,a(n-7) - 91\,a(n-8) - 171\,a(n-9) + 353\,a(n-10) + 89\,a(n-11) + 73\,a(n-12) + \\ 177\,a(n-13) + 22\,a(n-14) - 64\,a(n-15) - 24\,a(n-16). \end{multline*}
...
\begin{theorem} For A223946, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2) - a(n-3) + 11\,a(n-4) - 7\,a(n-5) + 12\,a(n-6) - 51\,a(n-7) - 91\,a(n-8) - 171\,a(n-9) + 353\,a(n-10) + 89\,a(n-11) + 73\,a(n-12) + 177\,a(n-13) + 22\,a(n-14) - 64\,a(n-15) - 24\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,70$. Every one of them vanished. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 157, 558, 1821, 5951, 20275, 71653,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223946}{A223946}, revision 8, last modified Oct 03 2025.
