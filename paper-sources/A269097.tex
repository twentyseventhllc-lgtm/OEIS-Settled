...
\title{Proofs of the conjectured column and row recurrences for OEIS A269097}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269097}{A269097} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once\end{quote}
...
k=2: a(n) = 14*a(n-1) -49*a(n-2) for n>3;\\k=3: a(n) = 36*a(n-1) -378*a(n-2) +972*a(n-3) -729*a(n-4) for n>5;\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 19 2016). As of revision 6, last modified Jun 23 2026, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 2$ of A269097, the recurrence $a(n) = 14\,a(n-1) - 49\,a(n-2)$ holds for every $n > 3$, and fails at $n = 3$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269097, the recurrence $a(n) = 36\,a(n-1) - 378\,a(n-2) + 972\,a(n-3) - 729\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269097}{A269097}, revision 6, last modified Jun 23 2026.
