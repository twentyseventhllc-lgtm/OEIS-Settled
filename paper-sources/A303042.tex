...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,164$. The last nonvanishing one is at $m = 1$, that is at $n = 62$. After it, more than $S = 72$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
