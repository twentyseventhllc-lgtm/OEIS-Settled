...
\title{A proof of the conjectured linear recurrence for OEIS A303326}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303326}{A303326} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays with every element equal to 0, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +9*a(n-2) -16*a(n-3) -25*a(n-4) +34*a(n-5) +15*a(n-6) +4*a(n-7) +34*a(n-8) -64*a(n-9) -42*a(n-10) +20*a(n-11) -7*a(n-12) +34*a(n-13) +21*a(n-14) -8*a(n-15) -a(n-16) -6*a(n-17) -3*a(n-18) for n > 19.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 21 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified May 03 2021, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 9\,a(n-2) - 16\,a(n-3) - 25\,a(n-4) + 34\,a(n-5) + 15\,a(n-6) + \\ 4\,a(n-7) + 34\,a(n-8) - 64\,a(n-9) - 42\,a(n-10) + 20\,a(n-11) - 7\,a(n-12) + \\ 34\,a(n-13) + 21\,a(n-14) - 8\,a(n-15) - a(n-16) - 6\,a(n-17) - 3\,a(n-18). \end{multline*}
...
\begin{theorem} For A303326, the recurrence $a(n) = 2\,a(n-1) + 9\,a(n-2) - 16\,a(n-3) - 25\,a(n-4) + 34\,a(n-5) + 15\,a(n-6) + 4\,a(n-7) + 34\,a(n-8) - 64\,a(n-9) - 42\,a(n-10) + 20\,a(n-11) - 7\,a(n-12) + 34\,a(n-13) + 21\,a(n-14) - 8\,a(n-15) - a(n-16) - 6\,a(n-17) - 3\,a(n-18)$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,77$. The last nonvanishing one is at $m = 1$, that is at $n = 19$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 2, 8, 2, 12, 10, 46, 50,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303326}{A303326}, revision 6, last modified May 03 2021.
