...
\title{A proof of the conjectured linear recurrence for OEIS A300918}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300918}{A300918} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +11*a(n-2) +a(n-3) -17*a(n-4) -46*a(n-5) -68*a(n-6) -42*a(n-7) +4*a(n-8) +43*a(n-9) +28*a(n-10) -34*a(n-11) -12*a(n-12) +8*a(n-13) +46*a(n-14) +22*a(n-15) +15*a(n-16) -2*a(n-17) -2*a(n-18) -3*a(n-19) -a(n-21) for n>22\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 11\,a(n-2) + a(n-3) - 17\,a(n-4) - 46\,a(n-5) - 68\,a(n-6) - \\ 42\,a(n-7) + 4\,a(n-8) + 43\,a(n-9) + 28\,a(n-10) - 34\,a(n-11) - 12\,a(n-12) + \\ 8\,a(n-13) + 46\,a(n-14) + 22\,a(n-15) + 15\,a(n-16) - 2\,a(n-17) - 2\,a(n-18) - \\ 3\,a(n-19) - a(n-21). \end{multline*}
...
\begin{theorem} For A300918, the recurrence $a(n) = 2\,a(n-1) + 11\,a(n-2) + a(n-3) - 17\,a(n-4) - 46\,a(n-5) - 68\,a(n-6) - 42\,a(n-7) + 4\,a(n-8) + 43\,a(n-9) + 28\,a(n-10) - 34\,a(n-11) - 12\,a(n-12) + 8\,a(n-13) + 46\,a(n-14) + 22\,a(n-15) + 15\,a(n-16) - 2\,a(n-17) - 2\,a(n-18) - 3\,a(n-19) - a(n-21)$ holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,75$. The last nonvanishing one is at $m = 1$, that is at $n = 22$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 5, 20, 76, 290, 1245, 5160, 21819,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300918}{A300918}, revision 4, last modified Mar 15 2018.
