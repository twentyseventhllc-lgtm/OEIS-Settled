...
\title{A proof of the conjectured linear recurrence for OEIS A302742}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302742}{A302742} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +4*a(n-2) -17*a(n-3) -3*a(n-4) -9*a(n-6) +14*a(n-7) for n>8\end{quote}
...
\begin{theorem} For A302742, the recurrence $a(n) = 7\,a(n-1) + 4\,a(n-2) - 17\,a(n-3) - 3\,a(n-4) - 9\,a(n-6) + 14\,a(n-7)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 228, 1637, 11814, 85268, 615589, 4444226,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302742}{A302742}, revision 4, last modified Apr 12 2018.
