...
\title{A proof of the conjectured linear recurrence for OEIS A318010}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A318010}{A318010} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -2*a(n-2) +a(n-3) -a(n-4)\end{quote}
...
\begin{theorem} For A318010, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) + a(n-3) - a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 8, 28, 97, 338, 1178, 4105, 14305,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A318010}{A318010}, revision 4, last modified Aug 12 2018.
