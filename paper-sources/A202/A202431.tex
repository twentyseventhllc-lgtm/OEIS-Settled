...
\title{A proof of the conjectured linear recurrence for OEIS A202431}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202431}{A202431} as

\begin{quote}\itshape Number of (n+2)X6 binary arrays avoiding patterns 000 and 001 in rows, columns and nw-to-se diagonals\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +64*a(n-2) +213*a(n-3) -199*a(n-4) -1711*a(n-5) +255*a(n-6) +8022*a(n-7) -2711*a(n-8) -25993*a(n-9) +26163*a(n-10) +41611*a(n-11) -104189*a(n-12) +72169*a(n-13) +11753*a(n-14) -44090*a(n-15) +15201*a(n-16) +10399*a(n-17) -6613*a(n-18) -2087*a(n-19) +1405*a(n-20) +609*a(n-21) -113*a(n-22) -132*a(n-23) -28*a(n-24) +2*a(n-25) +a(n-26)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 64\,a(n-2) + 213\,a(n-3) - 199\,a(n-4) - 1711\,a(n-5) + 255\,a(n-6) + \\ 8022\,a(n-7) - 2711\,a(n-8) - 25993\,a(n-9) + 26163\,a(n-10) + 41611\,a(n-11) - 104189\,a(n-12) + \\ 72169\,a(n-13) + 11753\,a(n-14) - 44090\,a(n-15) + 15201\,a(n-16) + 10399\,a(n-17) - 6613\,a(n-18) - \\ 2087\,a(n-19) + 1405\,a(n-20) + 609\,a(n-21) - 113\,a(n-22) - 132\,a(n-23) - 28\,a(n-24) + \\ 2\,a(n-25) + a(n-26). \end{multline*}
...
\begin{theorem} For A202431, the recurrence of order $26$ displayed in Section 1 holds for every $n \ge 27$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4680, 50310, 463632, 4502836, 42948906, 412198592, 3947786700, 37835503602,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202431}{A202431}, revision 9, last modified Oct 03 2025.
