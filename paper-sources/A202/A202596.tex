...
\title{A proof of the conjectured linear recurrence for OEIS A202596}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202596}{A202596} as

\begin{quote}\itshape Number of (n+2)X5 binary arrays avoiding patterns 001 and 000 in rows and columns\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +43*a(n-2) +16*a(n-3) -169*a(n-4) -8*a(n-5) +161*a(n-6) -16*a(n-7) -31*a(n-8) +4*a(n-9) +a(n-10)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 43\,a(n-2) + 16\,a(n-3) - 169\,a(n-4) - 8\,a(n-5) + 161\,a(n-6) - \\ 16\,a(n-7) - 31\,a(n-8) + 4\,a(n-9) + a(n-10). \end{multline*}
...
\begin{theorem} For A202596, the recurrence $a(n) = 4\,a(n-1) + 43\,a(n-2) + 16\,a(n-3) - 169\,a(n-4) - 8\,a(n-5) + 161\,a(n-6) - 16\,a(n-7) - 31\,a(n-8) + 4\,a(n-9) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1968, 18160, 157952, 1402544, 12360432, 109234112, 964348880, 8516820112,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202596}{A202596}, revision 9, last modified Oct 03 2025.
