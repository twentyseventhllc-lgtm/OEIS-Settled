...
\title{A proof of the conjectured linear recurrence for OEIS A202598}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202598}{A202598} as

\begin{quote}\itshape Number of (n+2)X7 binary arrays avoiding patterns 001 and 000 in rows and columns\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) +250*a(n-2) +184*a(n-3) -8341*a(n-4) -3864*a(n-5) +101382*a(n-6) -13547*a(n-7) -478599*a(n-8) +220430*a(n-9) +899746*a(n-10) -500871*a(n-11) -729610*a(n-12) +374846*a(n-13) +291331*a(n-14) -107013*a(n-15) -59556*a(n-16) +9986*a(n-17) +5219*a(n-18) -224*a(n-19) -160*a(n-20) -2*a(n-21) +a(n-22)\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) + 250\,a(n-2) + 184\,a(n-3) - 8341\,a(n-4) - 3864\,a(n-5) + 101382\,a(n-6) - \\ 13547\,a(n-7) - 478599\,a(n-8) + 220430\,a(n-9) + 899746\,a(n-10) - 500871\,a(n-11) - 729610\,a(n-12) + \\ 374846\,a(n-13) + 291331\,a(n-14) - 107013\,a(n-15) - 59556\,a(n-16) + 9986\,a(n-17) + 5219\,a(n-18) - \\ 224\,a(n-19) - 160\,a(n-20) - 2\,a(n-21) + a(n-22). \end{multline*}
...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $25$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A202598, the recurrence of order $22$ displayed in Section 1 holds for every $n \ge 23$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 14 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 30114, 629790, 12360432, 248094210, 4938195402, 98603761284, 1966507686990, 39237140832414,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202598}{A202598}, revision 9, last modified Oct 03 2025.
