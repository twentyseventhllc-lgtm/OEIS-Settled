...
\title{A proof of the conjectured linear recurrence for OEIS A202891}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202891}{A202891} as

\begin{quote}\itshape Number of (n+2)X3 binary arrays avoiding patterns 001 and 010 in rows, columns and nw-to-se diagonals\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +14*a(n-3) -20*a(n-4) +9*a(n-5) -47*a(n-6) +24*a(n-7) +14*a(n-8) +62*a(n-9) +24*a(n-10) -33*a(n-11) -52*a(n-12) -43*a(n-13) +4*a(n-14) +25*a(n-15) +20*a(n-16) +5*a(n-17) -2*a(n-18) -3*a(n-19).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Dec 25 2011).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Jul 19 2023, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + 14\,a(n-3) - 20\,a(n-4) + 9\,a(n-5) - 47\,a(n-6) + \\ 24\,a(n-7) + 14\,a(n-8) + 62\,a(n-9) + 24\,a(n-10) - 33\,a(n-11) - 52\,a(n-12) - \\ 43\,a(n-13) + 4\,a(n-14) + 25\,a(n-15) + 20\,a(n-16) + 5\,a(n-17) - 2\,a(n-18) - \\ 3\,a(n-19). \end{multline*}
...
\begin{theorem} For A202891, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + 14\,a(n-3) - 20\,a(n-4) + 9\,a(n-5) - 47\,a(n-6) + 24\,a(n-7) + 14\,a(n-8) + 62\,a(n-9) + 24\,a(n-10) - 33\,a(n-11) - 52\,a(n-12) - 43\,a(n-13) + 4\,a(n-14) + 25\,a(n-15) + 20\,a(n-16) + 5\,a(n-17) - 2\,a(n-18) - 3\,a(n-19)$ holds for every $n \ge 20$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 96, 258, 776, 2201, 6037, 16722, 46270, 127161,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202891}{A202891}, revision 9, last modified Jul 19 2023.
