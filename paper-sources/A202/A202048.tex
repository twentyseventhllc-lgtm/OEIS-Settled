...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A202048}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202048}{A202048} as

\begin{quote}\itshape Number of (n+2) X 6 binary arrays avoiding patterns 001 and 110 in rows and columns\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/30)*n\textasciicircum{}6 + (9/10)*n\textasciicircum{}5 + (59/6)*n\textasciicircum{}4 + (111/2)*n\textasciicircum{}3 + (2552/15)*n\textasciicircum{}2 + (1278/5)*n + 144.\end{quote}

\begin{quote}\ttfamily G.f.: 12*x*(53 - 207*x + 380*x\textasciicircum{}2 - 398*x\textasciicircum{}3 + 245*x\textasciicircum{}4 - 83*x\textasciicircum{}5 + 12*x\textasciicircum{}6) / (1 - x)\textasciicircum{}7.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 10, last modified May 25 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = 144 + \frac{1278}{5}n + \frac{2552}{15}n^{2} + \frac{111}{2}n^{3} + \frac{59}{6}n^{4} + \frac{9}{10}n^{5} + \frac{1}{30}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{636x - 2484x^{2} + 4560x^{3} - 4776x^{4} + 2940x^{5} - 996x^{6} + 144x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A202048, $a(n)$ is the polynomial $144 + \frac{1278}{5}n + \frac{2552}{15}n^{2} + \frac{111}{2}n^{3} + \frac{59}{6}n^{4} + \frac{9}{10}n^{5} + \frac{1}{30}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A202048, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{636x - 2484x^{2} + 4560x^{3} - 4776x^{4} + 2940x^{5} - 996x^{6} + 144x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A202048, the recurrence $a(n) = 8\,a(n-1) - 28\,a(n-2) + 56\,a(n-3) - 70\,a(n-4) + 56\,a(n-5) - 28\,a(n-6) + 8\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,49$. Every one of them vanished. After it, more than $S = 7$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 636, 1968, 4980, 11016, 22092, 41088, 71964, 120000,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202048}{A202048}, revision 10, last modified May 25 2018.
