...
\title{A proof of the conjectured linear recurrence for OEIS A318077}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A318077}{A318077} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +8*a(n-4) -2*a(n-5) -24*a(n-8) -3*a(n-9) +34*a(n-12) +4*a(n-13) -24*a(n-16) -a(n-17) +8*a(n-20) -a(n-24)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 8\,a(n-4) - 2\,a(n-5) - 24\,a(n-8) - 3\,a(n-9) + 34\,a(n-12) + \\ 4\,a(n-13) - 24\,a(n-16) - a(n-17) + 8\,a(n-20) - a(n-24). \end{multline*}
...
\begin{theorem} For A318077, the recurrence $a(n) = a(n-1) + 8\,a(n-4) - 2\,a(n-5) - 24\,a(n-8) - 3\,a(n-9) + 34\,a(n-12) + 4\,a(n-13) - 24\,a(n-16) - a(n-17) + 8\,a(n-20) - a(n-24)$ holds for every $n \ge 25$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,88$. Every one of them vanished. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 34 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 4, 5, 11, 18, 32, 54, 98,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A318077}{A318077}, revision 4, last modified Aug 15 2018.
