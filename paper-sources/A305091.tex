...
\title{A proof of the conjectured linear recurrence for OEIS A305091}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305091}{A305091} as

\begin{quote}\itshape Number of n X 2 0..1 arrays with every element unequal to 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +8*a(n-3) -16*a(n-5) for n>6.\end{quote}
...
\begin{theorem} For A305091, the recurrence $a(n) = a(n-1) + a(n-2) + 8\,a(n-3) - 16\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 9, 10, 27, 109, 168, 349,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305091}{A305091}, revision 6, last modified May 25 2024.
