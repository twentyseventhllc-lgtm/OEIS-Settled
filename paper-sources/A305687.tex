...
\title{A proof of the conjectured linear recurrence for OEIS A305687}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305687}{A305687} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +8*a(n-2) +12*a(n-3) +11*a(n-4) -a(n-5) +a(n-6) +a(n-7) -a(n-8)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 8\,a(n-2) + 12\,a(n-3) + 11\,a(n-4) - a(n-5) + a(n-6) + \\ a(n-7) - a(n-8). \end{multline*}
...
\begin{theorem} For A305687, the recurrence $a(n) = 6\,a(n-1) + 8\,a(n-2) + 12\,a(n-3) + 11\,a(n-4) - a(n-5) + a(n-6) + a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 25, 152, 1151, 8415, 61796, 453553, 3329201,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305687}{A305687}, revision 4, last modified Jun 08 2018.
