...
\title{A proof of the conjectured linear recurrence for OEIS A304130}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304130}{A304130} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element unequal to 0, 1, 3 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +8*a(n-3) -3*a(n-4) -23*a(n-6) -4*a(n-7) -4*a(n-8) +26*a(n-9) +19*a(n-10) +8*a(n-11) -10*a(n-12) -19*a(n-13) -4*a(n-14) +6*a(n-16) for n>22\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 8\,a(n-3) - 3\,a(n-4) - 23\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + \\ 26\,a(n-9) + 19\,a(n-10) + 8\,a(n-11) - 10\,a(n-12) - 19\,a(n-13) - 4\,a(n-14) + \\ 6\,a(n-16). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $112$; neither removal changes any count.
...
\begin{theorem} For A304130, the recurrence $a(n) = a(n-1) + 8\,a(n-3) - 3\,a(n-4) - 23\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + 26\,a(n-9) + 19\,a(n-10) + 8\,a(n-11) - 10\,a(n-12) - 19\,a(n-13) - 4\,a(n-14) + 6\,a(n-16)$ holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,82$. The last nonvanishing one is at $m = 6$, that is at $n = 22$. After it, more than $S = 29$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 31, 33, 80, 176, 320, 582, 1112,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304130}{A304130}, revision 4, last modified May 07 2018.
