...
\title{A proof of the conjectured linear recurrence for OEIS A202609}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202609}{A202609} as

\begin{quote}\itshape Number of (n+2) X 3 binary arrays avoiding patterns 001 and 010 in rows and columns\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -5*a(n-2) +16*a(n-3) -35*a(n-4) +19*a(n-5) -48*a(n-6) +80*a(n-7) +12*a(n-8) +52*a(n-9) -92*a(n-10) -54*a(n-11) -52*a(n-12) +76*a(n-13) +43*a(n-14) +32*a(n-15) -27*a(n-16) -16*a(n-17) -11*a(n-18) +5*a(n-19) +2*a(n-21).\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 5\,a(n-2) + 16\,a(n-3) - 35\,a(n-4) + 19\,a(n-5) - 48\,a(n-6) + \\ 80\,a(n-7) + 12\,a(n-8) + 52\,a(n-9) - 92\,a(n-10) - 54\,a(n-11) - 52\,a(n-12) + \\ 76\,a(n-13) + 43\,a(n-14) + 32\,a(n-15) - 27\,a(n-16) - 16\,a(n-17) - 11\,a(n-18) + \\ 5\,a(n-19) + 2\,a(n-21). \end{multline*}
...
No three consecutive cells of a row, read left to right, and no three consecutive cells of a column, read top to bottom, may spell \texttt{001}, \texttt{010}.
...
\begin{theorem} For A202609, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 108, 323, 1058, 3223, 9515, 28426, 84486, 249106,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202609}{A202609}, revision 7, last modified Jan 01 2024.
