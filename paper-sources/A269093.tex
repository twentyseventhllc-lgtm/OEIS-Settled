...
\title{A proof of the conjectured linear recurrence for OEIS A269093}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269093}{A269093} as

\begin{quote}\itshape Number of nX4 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once\end{quote}
...
\begin{theorem} For A269093, the recurrence $a(n) = 90\,a(n-1) - 2559\,a(n-2) + 24556\,a(n-3) - 94959\,a(n-4) + 140442\,a(n-5) - 69169\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 13 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 108, 11424, 715320, 37963968, 1856325000, 86415197088, 3892946216856, 171307237216320,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269093}{A269093}, revision 4, last modified Feb 19 2016.
