...
\title{A proof of the conjectured linear recurrence for OEIS A297902}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297902}{A297902} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +5*a(n-3) -4*a(n-4) -7*a(n-5) -6*a(n-6) +5*a(n-7) +4*a(n-8) +a(n-9) -2*a(n-10) +a(n-11) +a(n-12) for n>13\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 5\,a(n-3) - 4\,a(n-4) - 7\,a(n-5) - 6\,a(n-6) + \\ 5\,a(n-7) + 4\,a(n-8) + a(n-9) - 2\,a(n-10) + a(n-11) + a(n-12). \end{multline*}
...
\begin{theorem} For A297902, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 5\,a(n-3) - 4\,a(n-4) - 7\,a(n-5) - 6\,a(n-6) + 5\,a(n-7) + 4\,a(n-8) + a(n-9) - 2\,a(n-10) + a(n-11) + a(n-12)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 3, 1, 4, 5, 5, 20, 29,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297902}{A297902}, revision 4, last modified Jan 08 2018.
