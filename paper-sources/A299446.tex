...
\title{A proof of the conjectured linear recurrence for OEIS A299446}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299446}{A299446} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 1, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +5*a(n-3) -5*a(n-4) +a(n-5) -2*a(n-6) +2*a(n-7) -2*a(n-8) -8*a(n-9) +5*a(n-10) -10*a(n-11) +10*a(n-12) +a(n-13) +2*a(n-14) +7*a(n-15) +a(n-17) +a(n-18) for n>19.\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 5\,a(n-3) - 5\,a(n-4) + a(n-5) - 2\,a(n-6) + 2\,a(n-7) - \\ 2\,a(n-8) - 8\,a(n-9) + 5\,a(n-10) - 10\,a(n-11) + 10\,a(n-12) + a(n-13) + \\ 2\,a(n-14) + 7\,a(n-15) + a(n-17) + a(n-18). \end{multline*}
...
\begin{theorem} For A299446, the recurrence $a(n) = a(n-1) + 5\,a(n-3) - 5\,a(n-4) + a(n-5) - 2\,a(n-6) + 2\,a(n-7) - 2\,a(n-8) - 8\,a(n-9) + 5\,a(n-10) - 10\,a(n-11) + 10\,a(n-12) + a(n-13) + 2\,a(n-14) + 7\,a(n-15) + a(n-17) + a(n-18)$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,85$. The last nonvanishing one is at $m = 1$, that is at $n = 19$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 39 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 4, 1, 4, 10, 6, 11, 41,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299446}{A299446}, revision 6, last modified Apr 11 2022.
