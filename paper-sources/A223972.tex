...
\title{A proof of the conjectured order of the recurrence for OEIS A223972}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223972}{A223972} as

\begin{quote}\itshape Number of nX5 0..2 arrays with rows and antidiagonals unimodal\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical recurrence of order 43 (see link above)\end{quote}
...
\begin{theorem} For A223972, the least order of a linear recurrence that $a$ eventually satisfies is exactly $43$, and that recurrence holds for every $n > 43$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 13 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 86, 7396, 440628, 22935921, 1140963027, 55803232969, 2708281019793, 131014406127439,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223972}{A223972}, revision 10, last modified Oct 03 2025.
