...
\title{A proof of the conjectured linear recurrence for OEIS A303423}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303423}{A303423} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) +12*a(n-2) +175*a(n-3) +283*a(n-4) -235*a(n-5) -144*a(n-6) +67*a(n-7) -135*a(n-8) +50*a(n-9)\end{quote}
...
\begin{multline*} a(n) = 14\,a(n-1) + 12\,a(n-2) + 175\,a(n-3) + 283\,a(n-4) - 235\,a(n-5) - 144\,a(n-6) + \\ 67\,a(n-7) - 135\,a(n-8) + 50\,a(n-9). \end{multline*}
...
\begin{theorem} For A303423, the recurrence $a(n) = 14\,a(n-1) + 12\,a(n-2) + 175\,a(n-3) + 283\,a(n-4) - 235\,a(n-5) - 144\,a(n-6) + 67\,a(n-7) - 135\,a(n-8) + 50\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1988, 30897, 480953, 7486281, 116517744, 1813509273,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303423}{A303423}, revision 4, last modified Apr 23 2018.
