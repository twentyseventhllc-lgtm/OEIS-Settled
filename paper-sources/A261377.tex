...
\title{A proof of the conjectured linear recurrence for OEIS A261377}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A261377}{A261377} as

\begin{quote}\itshape Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00001011 00010101 or 01010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 31*a(n-4) +97*a(n-6) +39*a(n-8) -144*a(n-10) -29*a(n-12) +189*a(n-14) -125*a(n-16) -14*a(n-18) +40*a(n-20) -13*a(n-22) -a(n-24) +a(n-26) for n>29\end{quote}
...
\begin{multline*} a(n) = 31\,a(n-4) + 97\,a(n-6) + 39\,a(n-8) - 144\,a(n-10) - 29\,a(n-12) + 189\,a(n-14) - \\ 125\,a(n-16) - 14\,a(n-18) + 40\,a(n-20) - 13\,a(n-22) - a(n-24) + a(n-26). \end{multline*}
...
That refinement leaves $66$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 41$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $41$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A261377, the recurrence $a(n) = 31\,a(n-4) + 97\,a(n-6) + 39\,a(n-8) - 144\,a(n-10) - 29\,a(n-12) + 189\,a(n-14) - 125\,a(n-16) - 14\,a(n-18) + 40\,a(n-20) - 13\,a(n-22) - a(n-24) + a(n-26)$ holds for every $n > 29$, and fails at $n = 29$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,97$. The last nonvanishing one is at $m = 3$, that is at $n = 29$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 154, 266, 869, 2282, 5633, 14312, 39494, 99168,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A261377}{A261377}, revision 4, last modified Aug 17 2015.
