...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,83$. The last nonvanishing one is at $m = 1$, that is at $n = 29$. After it, more than $S = 31$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
