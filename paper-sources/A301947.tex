...
\title{A proof of the conjectured linear recurrence for OEIS A301947}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301947}{A301947} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -8*a(n-2) -14*a(n-3) +4*a(n-4) +4*a(n-5) -a(n-6)\end{quote}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $148$; neither removal changes any count.
...
\begin{theorem} For A301947, the recurrence $a(n) = 9\,a(n-1) - 8\,a(n-2) - 14\,a(n-3) + 4\,a(n-4) + 4\,a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 16, 123, 947, 7326, 56710, 439078, 3399722,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301947}{A301947}, revision 4, last modified Mar 29 2018.
