...
\title{A proof of the conjectured generating function for OEIS A250807}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250807}{A250807} as
...
\begin{quote}\ttfamily Empirical g.f.: 3*x*(75 - 159*x + 106*x\textasciicircum{}2) / ((1 - x)*(1 - 2*x)*(1 - 3*x)). - Colin Barker, Nov 20 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{225x - 477x^{2} + 318x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}.\]
...
For scale: at $n = 8$ there are $3^{32}$ arrays, about $10^{15}$, against $8$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A250807, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{225x - 477x^{2} + 318x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 225, 873, 3081, 10233, 32745, 102393, 315561, 963513,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250807}{A250807}, revision 8, last modified Nov 20 2018.
