...
\title{A proof of the conjectured closed form for OEIS A223915}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223915}{A223915} as

\begin{quote}\itshape Number of nX5 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (1009/907200)*n\textasciicircum{}10 + (1009/60480)*n\textasciicircum{}9 + (4919/30240)*n\textasciicircum{}8 + (293/288)*n\textasciicircum{}7 + (196597/43200)*n\textasciicircum{}6 + (35317/2880)*n\textasciicircum{}5 + (1341229/45360)*n\textasciicircum{}4 + (115123/3024)*n\textasciicircum{}3 + (38483/3150)*n\textasciicircum{}2 - (868/15)*n + 4 for n>2\end{quote}
...
\[a(n) = 4 - \frac{868}{15}n + \frac{38483}{3150}n^{2} + \frac{115123}{3024}n^{3} + \frac{1341229}{45360}n^{4} + \frac{35317}{2880}n^{5} + \frac{196597}{43200}n^{6} + \frac{293}{288}n^{7} + \frac{4919}{30240}n^{8} + \frac{1009}{60480}n^{9} + \frac{1009}{907200}n^{10}.\]
...
The reachable part of that digraph has $247$ states, $247$ after discarding states from which no accepting state is reachable. States from which the same number of arrays can be completed, for every remaining number of rows, are then identified by partition refinement --- start from the partition by acceptance and separate two states as soon as they send different numbers of edges into some block. On the blocks the number of completions of each length is constant, so the quotient counts exactly what the original does.

The refinement, applied first forwards and then in the mirror direction on the edges coming in, leaves $S = 87$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of the $87 \times 87$ quotient matrix. That degree bound is computed here, not assumed, and it is the only one the decision procedure below uses.
...
\begin{theorem} For A223915, $a(n)$ is the polynomial $4 - \frac{868}{15}n + \frac{38483}{3150}n^{2} + \frac{115123}{3024}n^{3} + \frac{1341229}{45360}n^{4} + \frac{35317}{2880}n^{5} + \frac{196597}{43200}n^{6} + \frac{293}{288}n^{7} + \frac{4919}{30240}n^{8} + \frac{1009}{60480}n^{9} + \frac{1009}{907200}n^{10}$ for every $n > 2$, and not at $n = 2$.\end{theorem}

{\itshape Proof.} A polynomial of degree $10$ is annihilated by the difference operator $(E-1)^{11}$, whose characteristic polynomial is $(t-1)^{11}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 11 = 98$. Its values were computed exactly; the last nonvanishing one is at $n = 2$, and more than $98$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 86, 1600, 13347, 74040, 319156, 1147712, 3588729, 10031780,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223915}{A223915}, revision 8, last modified Oct 03 2025.
