...
\title{A proof of the conjectured linear recurrence for OEIS A207854}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207854}{A207854} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +a(n-2) +18*a(n-4) +4*a(n-5) -2*a(n-6) -8*a(n-7) -a(n-8) +a(n-10)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + a(n-2) + 18\,a(n-4) + 4\,a(n-5) - 2\,a(n-6) - 8\,a(n-7) - \\ a(n-8) + a(n-10). \end{multline*}
...
\begin{theorem} For A207854, the recurrence $a(n) = 4\,a(n-1) + a(n-2) + 18\,a(n-4) + 4\,a(n-5) - 2\,a(n-6) - 8\,a(n-7) - a(n-8) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 289, 1369, 5929, 26569, 117649, 522729,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207854}{A207854}, revision 9, last modified Oct 03 2025.
