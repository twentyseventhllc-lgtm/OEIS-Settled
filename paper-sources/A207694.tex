...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207694}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207694}{A207694} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 3*a(n-3) + 9*a(n-4) for n>7.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(3 + 15*x + 12*x\textasciicircum{}2 + 11*x\textasciicircum{}3 - 11*x\textasciicircum{}4 - 84*x\textasciicircum{}5 - 60*x\textasciicircum{}6) / ((1 + 3*x\textasciicircum{}2)*(1 - x - 3*x\textasciicircum{}2)). - Colin Barker, Mar 05 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 30x^{2} + 24x^{3} + 22x^{4} - 22x^{5} - 168x^{6} - 120x^{7}}{1 - x - 3x^{3} - 9x^{4}}.\]
...
\begin{theorem} For A207694, the recurrence $a(n) = a(n-1) + 3\,a(n-3) + 9\,a(n-4)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,52$. The last nonvanishing one is at $m = 3$, that is at $n = 7$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 7$. The theorem is at least as strong.

\begin{theorem} For A207694, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 30x^{2} + 24x^{3} + 22x^{4} - 22x^{5} - 168x^{6} - 120x^{7}}{1 - x - 3x^{3} - 9x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 60, 100, 240, 576, 1296, 2916,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207694}{A207694}, revision 8, last modified Mar 05 2018.
