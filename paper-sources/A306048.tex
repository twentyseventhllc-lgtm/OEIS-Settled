...
\title{A proof of the conjectured linear recurrence for OEIS A306048}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A306048}{A306048} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +9*a(n-3) -20*a(n-4) -27*a(n-5) +11*a(n-6) +33*a(n-7) +18*a(n-8) -22*a(n-9) -10*a(n-10) for n>12\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 9\,a(n-3) - 20\,a(n-4) - 27\,a(n-5) + 11\,a(n-6) + 33\,a(n-7) + \\ 18\,a(n-8) - 22\,a(n-9) - 10\,a(n-10). \end{multline*}
...
\begin{theorem} For A306048, the recurrence $a(n) = 3\,a(n-1) + 9\,a(n-3) - 20\,a(n-4) - 27\,a(n-5) + 11\,a(n-6) + 33\,a(n-7) + 18\,a(n-8) - 22\,a(n-9) - 10\,a(n-10)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 21, 45, 142, 439, 1261, 3826, 11770,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A306048}{A306048}, revision 4, last modified Jun 18 2018.
