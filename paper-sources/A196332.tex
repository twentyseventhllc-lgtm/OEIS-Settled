...
\title{A proof of the conjectured linear recurrence for OEIS A196332}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196332}{A196332} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,0,3,1,2 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-3) -5*a(n-4) +6*a(n-5) +6*a(n-6) -22*a(n-7) -71*a(n-8) +6*a(n-9) +95*a(n-10) +3*a(n-11) +139*a(n-12) -20*a(n-13) -45*a(n-14) +44*a(n-15) -6*a(n-16) -14*a(n-17)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-3) - 5\,a(n-4) + 6\,a(n-5) + 6\,a(n-6) - 22\,a(n-7) - \\ 71\,a(n-8) + 6\,a(n-9) + 95\,a(n-10) + 3\,a(n-11) + 139\,a(n-12) - 20\,a(n-13) - \\ 45\,a(n-14) + 44\,a(n-15) - 6\,a(n-16) - 14\,a(n-17). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 4, \tau(1) = 0, \tau(2) = 3, \tau(3) = 1, \tau(4) = 2. The condition is that for every cell,
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $100$; neither removal changes any count.
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $18$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A196332, the recurrence $a(n) = 3\,a(n-1) - a(n-3) - 5\,a(n-4) + 6\,a(n-5) + 6\,a(n-6) - 22\,a(n-7) - 71\,a(n-8) + 6\,a(n-9) + 95\,a(n-10) + 3\,a(n-11) + 139\,a(n-12) - 20\,a(n-13) - 45\,a(n-14) + 44\,a(n-15) - 6\,a(n-16) - 14\,a(n-17)$ holds for every $n \ge 18$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. Every one of them vanished. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 8, 7, 50, 111, 259, 744, 1840,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196332}{A196332}, revision 9, last modified Oct 03 2025.
