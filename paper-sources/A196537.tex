...
\title{A proof of the conjectured linear recurrence for OEIS A196537}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196537}{A196537} as

\begin{quote}\itshape Number of nX1 0..4 arrays with each element equal to the number its horizontal and vertical neighbors less than or equal to itself\end{quote}
...
\begin{theorem} For A196537, the recurrence $a(n) = a(n-1) + a(n-2) + 3\,a(n-3) + a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 2, 7, 19, 35, 77, 176,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196537}{A196537}, revision 11, last modified Oct 03 2025.
