...
k=1: a(n) = 2*a(n-1) -2*a(n-2) +9*a(n-3) -4*a(n-4) +9*a(n-5) -9*a(n-6) for n>7\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 20 2015). As of revision 6, last modified Jun 02 2025, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
