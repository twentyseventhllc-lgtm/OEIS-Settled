...
\title{A proof of the conjectured linear recurrence for OEIS A301403}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301403}{A301403} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) +40*a(n-2) +9*a(n-3) -29*a(n-4) +4*a(n-5)\end{quote}
...
\begin{theorem} For A301403, the recurrence $a(n) = 13\,a(n-1) + 40\,a(n-2) + 9\,a(n-3) - 29\,a(n-4) + 4\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1988, 31012, 483600, 7541492, 117605364, 1833990416,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301403}{A301403}, revision 4, last modified Mar 20 2018.
