...
\title{A proof of the conjectured linear recurrence for OEIS A302619}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302619}{A302619} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +6*a(n-3) -a(n-4) -8*a(n-5) -7*a(n-6) +2*a(n-7) +5*a(n-8) for n>10\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 6\,a(n-3) - a(n-4) - 8\,a(n-5) - 7\,a(n-6) + \\ 2\,a(n-7) + 5\,a(n-8). \end{multline*}
...
\begin{theorem} For A302619, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 6\,a(n-3) - a(n-4) - 8\,a(n-5) - 7\,a(n-6) + 2\,a(n-7) + 5\,a(n-8)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. The last nonvanishing one is at $m = 2$, that is at $n = 10$. After it, more than $S = 17$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 37, 45, 130, 367, 917, 2533, 6871,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302619}{A302619}, revision 4, last modified Apr 10 2018.
