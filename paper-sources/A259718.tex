...
\title{A proof of the conjectured linear recurrence for OEIS A259718}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259718}{A259718} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000011\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-3) +6*a(n-4) -9*a(n-6) -16*a(n-7) -12*a(n-8) +4*a(n-9) +7*a(n-10) +10*a(n-11) +14*a(n-12) -3*a(n-16)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-3) + 6\,a(n-4) - 9\,a(n-6) - 16\,a(n-7) - 12\,a(n-8) + 4\,a(n-9) + \\ 7\,a(n-10) + 10\,a(n-11) + 14\,a(n-12) - 3\,a(n-16). \end{multline*}
...
\begin{theorem} For A259718, the recurrence $a(n) = 6\,a(n-3) + 6\,a(n-4) - 9\,a(n-6) - 16\,a(n-7) - 12\,a(n-8) + 4\,a(n-9) + 7\,a(n-10) + 10\,a(n-11) + 14\,a(n-12) - 3\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 140, 228, 568, 1064, 1244, 2858, 6092, 8638,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259718}{A259718}, revision 6, last modified Jun 02 2025.
