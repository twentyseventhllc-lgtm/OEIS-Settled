...
\title{A proof of the conjectured linear recurrence for OEIS A297679}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297679}{A297679} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 4 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) -13*a(n-2) +103*a(n-3) -631*a(n-4) -2904*a(n-5) +4228*a(n-6) -9174*a(n-7) +33373*a(n-8) -11504*a(n-9) +48969*a(n-10) -94831*a(n-11) +2069*a(n-12) -31085*a(n-13) -9102*a(n-14) +78809*a(n-15) -13808*a(n-16) +49758*a(n-17) -54323*a(n-18) +6349*a(n-19) +12263*a(n-20) -9120*a(n-21) +1613*a(n-22) -13130*a(n-23) +13637*a(n-24) -72*a(n-25) -8310*a(n-26) +1120*a(n-27) +2320*a(n-28) +128*a(n-29) -192*a(n-30)\end{quote}
...
\begin{multline*} a(n) = 13\,a(n-1) - 13\,a(n-2) + 103\,a(n-3) - 631\,a(n-4) - 2904\,a(n-5) + 4228\,a(n-6) - \\ 9174\,a(n-7) + 33373\,a(n-8) - 11504\,a(n-9) + 48969\,a(n-10) - 94831\,a(n-11) + 2069\,a(n-12) - \\ 31085\,a(n-13) - 9102\,a(n-14) + 78809\,a(n-15) - 13808\,a(n-16) + 49758\,a(n-17) - 54323\,a(n-18) + \\ 6349\,a(n-19) + 12263\,a(n-20) - 9120\,a(n-21) + 1613\,a(n-22) - 13130\,a(n-23) + 13637\,a(n-24) - \\ 72\,a(n-25) - 8310\,a(n-26) + 1120\,a(n-27) + 2320\,a(n-28) + 128\,a(n-29) - 192\,a(n-30). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $474$; neither removal changes any count.
...
That refinement leaves $36$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 32$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A297679, the recurrence of order $30$ displayed in Section 1 holds for every $n \ge 31$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,84$. Every one of them vanished. After it, more than $S = 32$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 24, 219, 2790, 32911, 401678, 4870764, 59210634, 719647644,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297679}{A297679}, revision 4, last modified Jan 03 2018.
