...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207166}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207166}{A207166} as

\begin{quote}\itshape Number of n X 5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (13/4)*n\textasciicircum{}4 + (13/2)*n\textasciicircum{}3 + (117/4)*n\textasciicircum{}2 - 26*n.\end{quote}

\begin{quote}\ttfamily G.f.: 13*x*(1 + 8*x - 7*x\textasciicircum{}2 + 4*x\textasciicircum{}3) / (1 - x)\textasciicircum{}5.\end{quote}
...
\[a(n) = -26n + \frac{117}{4}n^{2} + \frac{13}{2}n^{3} + \frac{13}{4}n^{4}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{13x + 104x^{2} - 91x^{3} + 52x^{4}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}.\]
...
\begin{theorem} For A207166, $a(n)$ is the polynomial $-26n + \frac{117}{4}n^{2} + \frac{13}{2}n^{3} + \frac{13}{4}n^{4}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A207166, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{13x + 104x^{2} - 91x^{3} + 52x^{4}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}$.\end{theorem}
...
\begin{theorem} For A207166, the recurrence $a(n) = 5\,a(n-1) - 10\,a(n-2) + 10\,a(n-3) - 5\,a(n-4) + a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 624, 1612, 3445, 6513, 11284, 18304,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207166}{A207166}, revision 8, last modified Jun 19 2018.
