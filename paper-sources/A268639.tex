...
\title{Proofs of the conjectured column and row recurrences for OEIS A268639}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A268639}{A268639} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} For column $k = 1$ of A268639, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A268639, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2)$ holds for every $n > 3$, and fails at $n = 3$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A268639, the recurrence $a(n) = 10\,a(n-1) - 29\,a(n-2) + 20\,a(n-3) - 4\,a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A268639, the recurrence $a(n) = 0$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A268639}{A268639}, revision 4, last modified Feb 09 2016.
