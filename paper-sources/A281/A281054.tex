...
\title{A proof of the conjectured linear recurrence for OEIS A281054}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A281054}{A281054} as

\begin{quote}\itshape Number of nX6 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +3*a(n-2) -11*a(n-3) -9*a(n-4) +15*a(n-5) +20*a(n-6) +3*a(n-7) -18*a(n-8) -27*a(n-9) -9*a(n-10) +15*a(n-11) +20*a(n-12) +12*a(n-13) -7*a(n-15) -6*a(n-16) -3*a(n-17) -a(n-18) for n>21\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) - 9\,a(n-4) + 15\,a(n-5) + 20\,a(n-6) + \\ 3\,a(n-7) - 18\,a(n-8) - 27\,a(n-9) - 9\,a(n-10) + 15\,a(n-11) + 20\,a(n-12) + \\ 12\,a(n-13) - 7\,a(n-15) - 6\,a(n-16) - 3\,a(n-17) - a(n-18). \end{multline*}
...
The reachable part of the digraph has $7365$ states, $1040$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 51$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of that $51\times51$ matrix; the bound is computed, not assumed.
...
\begin{theorem} For A281054, the recurrence $a(n) = 3\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) - 9\,a(n-4) + 15\,a(n-5) + 20\,a(n-6) + 3\,a(n-7) - 18\,a(n-8) - 27\,a(n-9) - 9\,a(n-10) + 15\,a(n-11) + 20\,a(n-12) + 12\,a(n-13) - 7\,a(n-15) - 6\,a(n-16) - 3\,a(n-17) - a(n-18)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,99$. The last nonvanishing one is at $m = 3$, that is at $n = 21$. After it, more than $S = 51$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 251, 1403, 5400, 16875, 46610, 119205, 288527,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A281054}{A281054}, revision 4, last modified Jan 13 2017.
