...
\title{A proof of the conjectured linear recurrence for OEIS A261706}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A261706}{A261706} as

\begin{quote}\itshape Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00000111\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-3) +3*a(n-6) +4*a(n-7) -2*a(n-9) +4*a(n-11) -8*a(n-13) +10*a(n-14) for n>20.\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-3) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-9) + 4\,a(n-11) - 8\,a(n-13) + \\ 10\,a(n-14). \end{multline*}
...
That refinement leaves $43$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 31$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A261706, the recurrence $a(n) = 4\,a(n-3) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-9) + 4\,a(n-11) - 8\,a(n-13) + 10\,a(n-14)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,80$. The last nonvanishing one is at $m = 6$, that is at $n = 20$. After it, more than $S = 31$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 172, 270, 468, 662, 1168, 2372, 3700, 6158,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A261706}{A261706}, revision 6, last modified Apr 18 2023.
