...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234326}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234326}{A234326} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 32*a(n-2) - 48*a(n-4).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 16*x*(5 + 27*x - 12*x\textasciicircum{}2 - 48*x\textasciicircum{}3) / (1 - 32*x\textasciicircum{}2 + 48*x\textasciicircum{}4). - Colin Barker, Oct 14 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Dec 23 2013).
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{80x + 432x^{2} - 192x^{3} - 768x^{4}}{1 - 32x^{2} + 48x^{4}}.\]
...
\begin{theorem} For A234326, the recurrence $a(n) = 32\,a(n-2) - 48\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234326, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{80x + 432x^{2} - 192x^{3} - 768x^{4}}{1 - 32x^{2} + 48x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 80, 432, 2368, 13056, 71936, 397056, 2188288, 12079104,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234326}{A234326}, revision 13, last modified Jun 20 2022.
