...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A235312}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A235312}{A235312} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 28*a(n-2) -252*a(n-4) +720*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 8*x*(2 + 7*x)*(7 - 126*x\textasciicircum{}2 + 540*x\textasciicircum{}4) / ((1 - 6*x\textasciicircum{}2)*(1 - 10*x\textasciicircum{}2)*(1 - 12*x\textasciicircum{}2)). - Colin Barker, Oct 18 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{112x + 392x^{2} - 2016x^{3} - 7056x^{4} + 8640x^{5} + 30240x^{6}}{1 - 28x^{2} + 252x^{4} - 720x^{6}}.\]
...
\begin{theorem} For A235312, the recurrence $a(n) = 28\,a(n-2) - 252\,a(n-4) + 720\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A235312, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{112x + 392x^{2} - 2016x^{3} - 7056x^{4} + 8640x^{5} + 30240x^{6}}{1 - 28x^{2} + 252x^{4} - 720x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 112, 392, 1120, 3920, 11776, 41216, 128128, 448448,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A235312}{A235312}, revision 10, last modified Jun 18 2022.
