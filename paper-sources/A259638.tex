...
\title{A proof of the conjectured linear recurrence for OEIS A259638}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259638}{A259638} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001\end{quote}
...
\begin{theorem} For A259638, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 16\,a(n-3) + 7\,a(n-4) - 14\,a(n-5) - 45\,a(n-6) - 14\,a(n-7) + 5\,a(n-8) + 38\,a(n-9) + 13\,a(n-10) - 6\,a(n-11) - 6\,a(n-12)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 133, 365, 1483, 4146, 12348, 42524, 133078, 406770,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259638}{A259638}, revision 6, last modified Jun 02 2025.
