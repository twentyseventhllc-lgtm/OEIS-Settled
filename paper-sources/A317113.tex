...
\title{A proof of the conjectured linear recurrence for OEIS A317113}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317113}{A317113} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +10*a(n-2) -a(n-3) -12*a(n-4) +7*a(n-5) -a(n-6) -20*a(n-7) +15*a(n-8) -3*a(n-9) -3*a(n-10) for n>12\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 10\,a(n-2) - a(n-3) - 12\,a(n-4) + 7\,a(n-5) - a(n-6) - \\ 20\,a(n-7) + 15\,a(n-8) - 3\,a(n-9) - 3\,a(n-10). \end{multline*}
...
\begin{theorem} For A317113, the recurrence $a(n) = 3\,a(n-1) + 10\,a(n-2) - a(n-3) - 12\,a(n-4) + 7\,a(n-5) - a(n-6) - 20\,a(n-7) + 15\,a(n-8) - 3\,a(n-9) - 3\,a(n-10)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,51$. The last nonvanishing one is at $m = 2$, that is at $n = 12$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 30, 142, 698, 3398, 16686, 81809, 401415,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317113}{A317113}, revision 4, last modified Jul 21 2018.
