...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207747}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207747}{A207747} as

\begin{quote}\itshape Number of n X 3 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) - 9*a(n-2) - 32*a(n-3) + 72*a(n-4) + 36*a(n-5) - 147*a(n-6) + 9*a(n-7) + 109*a(n-8) - 28*a(n-9) - 24*a(n-10) + 8*a(n-11) for n>12. Corrected by Colin Barker, Mar 06 2018\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(3 - 3*x - 48*x\textasciicircum{}2 + 36*x\textasciicircum{}3 + 273*x\textasciicircum{}4 - 173*x\textasciicircum{}5 - 602*x\textasciicircum{}6 + 305*x\textasciicircum{}7 + 502*x\textasciicircum{}8 - 216*x\textasciicircum{}9 - 120*x\textasciicircum{}10 + 48*x\textasciicircum{}11) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 - 3*x + x\textasciicircum{}2)*(1 + x - x\textasciicircum{}2)*(1 - x - x\textasciicircum{}2)*(1 - 2*x - 4*x\textasciicircum{}2)). - Colin Barker, Mar 06 2018\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) - 9\,a(n-2) - 32\,a(n-3) + 72\,a(n-4) + 36\,a(n-5) - 147\,a(n-6) + \\ 9\,a(n-7) + 109\,a(n-8) - 28\,a(n-9) - 24\,a(n-10) + 8\,a(n-11). \end{multline*}

stated for $n > 12$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x - 6x^{2} - 96x^{3} + 72x^{4} + 546x^{5} - 346x^{6} - 1204x^{7} + 610x^{8} + 1004x^{9} - 432x^{10} - 240x^{11} + 96x^{12}}{1 - 7x + 9x^{2} + 32x^{3} - 72x^{4} - 36x^{5} + 147x^{6} - 9x^{7} - 109x^{8} + 28x^{9} + 24x^{10} - 8x^{11}}.\]
...
\begin{theorem} For A207747, the recurrence $a(n) = 7\,a(n-1) - 9\,a(n-2) - 32\,a(n-3) + 72\,a(n-4) + 36\,a(n-5) - 147\,a(n-6) + 9\,a(n-7) + 109\,a(n-8) - 28\,a(n-9) - 24\,a(n-10) + 8\,a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,55$. The last nonvanishing one is at $m = 1$, that is at $n = 12$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 12$. The theorem is at least as strong.

\begin{theorem} For A207747, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x - 6x^{2} - 96x^{3} + 72x^{4} + 546x^{5} - 346x^{6} - 1204x^{7} + 610x^{8} + 1004x^{9} - 432x^{10} - 240x^{11} + 96x^{12}}{1 - 7x + 9x^{2} + 32x^{3} - 72x^{4} - 36x^{5} + 147x^{6} - 9x^{7} - 109x^{8} + 28x^{9} + 24x^{10} - 8x^{11}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 102, 270, 798, 2354, 7210, 22232,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207747}{A207747}, revision 8, last modified Mar 06 2018.
