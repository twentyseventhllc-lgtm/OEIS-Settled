...
\title{A proof of the conjectured linear recurrence for OEIS A317735}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317735}{A317735} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A317735, the recurrence $a(n) = 2\,a(n-1) + a(n-2) + a(n-3) - a(n-4) - a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 1, 1, 2, 4, 9, 22, 53,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317735}{A317735}, revision 4, last modified Aug 05 2018.
