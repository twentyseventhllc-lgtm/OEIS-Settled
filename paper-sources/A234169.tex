...
\title{Proofs of the conjectured column and row recurrences for OEIS A234169}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234169}{A234169} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings)\end{quote}
...
k=1: a(n) = 4*a(n-1) +41*a(n-2) -132*a(n-3) -264*a(n-4).\\k=2: [order 17].\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 20 2013). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A234169, the recurrence $a(n) = 4\,a(n-1) + 41\,a(n-2) - 132\,a(n-3) - 264\,a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A234169, the recurrence $a(n) = 0$ holds for every $n \ge 18$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234169}{A234169}, revision 6, last modified Jun 20 2022.
