...
\title{A proof of the conjectured linear recurrence for OEIS A316612}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316612}{A316612} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element unequal to 0, 1, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +10*a(n-3) -6*a(n-4) -4*a(n-5) -13*a(n-6) -14*a(n-7) -27*a(n-8) -13*a(n-9) +38*a(n-10) +45*a(n-11) +16*a(n-12) +69*a(n-13) +95*a(n-14) +29*a(n-15) -73*a(n-16) -2*a(n-17) +66*a(n-18) -94*a(n-19) -279*a(n-20) -62*a(n-21) -179*a(n-22) -288*a(n-23) -214*a(n-24) +234*a(n-25) +437*a(n-26) +118*a(n-27) -213*a(n-28) +249*a(n-29) +355*a(n-30) +133*a(n-31) -60*a(n-32) -227*a(n-33) -5*a(n-34) +52*a(n-35) +16*a(n-36) +8*a(n-37) -8*a(n-38) -4*a(n-39) -4*a(n-40) for n>51\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jul 08 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 4, last modified Jul 08 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 10\,a(n-3) - 6\,a(n-4) - 4\,a(n-5) - 13\,a(n-6) - 14\,a(n-7) - \\ 27\,a(n-8) - 13\,a(n-9) + 38\,a(n-10) + 45\,a(n-11) + 16\,a(n-12) + 69\,a(n-13) + \\ 95\,a(n-14) + 29\,a(n-15) - 73\,a(n-16) - 2\,a(n-17) + 66\,a(n-18) - 94\,a(n-19) - \\ 279\,a(n-20) - 62\,a(n-21) - 179\,a(n-22) - 288\,a(n-23) - 214\,a(n-24) + 234\,a(n-25) + \\ 437\,a(n-26) + 118\,a(n-27) - 213\,a(n-28) + 249\,a(n-29) + 355\,a(n-30) + 133\,a(n-31) - \\ 60\,a(n-32) - 227\,a(n-33) - 5\,a(n-34) + 52\,a(n-35) + 16\,a(n-36) + 8\,a(n-37) - \\ 8\,a(n-38) - 4\,a(n-39) - 4\,a(n-40). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $304$; neither removal changes any count.
...
\begin{theorem} For A316612, the recurrence of order $40$ displayed in Section 1 holds for every $n > 51$, and fails at $n = 51$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,128$. The last nonvanishing one is at $m = 11$, that is at $n = 51$. After it, more than $S = 57$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 53, 63, 199, 649, 1749, 4719, 13770,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316612}{A316612}, revision 4, last modified Jul 08 2018.
