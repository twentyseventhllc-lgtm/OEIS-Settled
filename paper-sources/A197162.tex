...
\title{A proof of the conjectured linear recurrence for OEIS A197162}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197162}{A197162} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,2,1,4,0 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +5*a(n-2) +21*a(n-3) +48*a(n-4) +168*a(n-5) +194*a(n-6) +40*a(n-7) -492*a(n-8) -713*a(n-9) -516*a(n-10) +152*a(n-11) +700*a(n-12) +538*a(n-13) +265*a(n-14) -160*a(n-15) -176*a(n-16) -53*a(n-17) -4*a(n-18) +26*a(n-19) +3*a(n-20) -10*a(n-21) -3*a(n-22)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 5\,a(n-2) + 21\,a(n-3) + 48\,a(n-4) + 168\,a(n-5) + 194\,a(n-6) + \\ 40\,a(n-7) - 492\,a(n-8) - 713\,a(n-9) - 516\,a(n-10) + 152\,a(n-11) + 700\,a(n-12) + \\ 538\,a(n-13) + 265\,a(n-14) - 160\,a(n-15) - 176\,a(n-16) - 53\,a(n-17) - 4\,a(n-18) + \\ 26\,a(n-19) + 3\,a(n-20) - 10\,a(n-21) - 3\,a(n-22). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 3, \tau(1) = 2, \tau(2) = 1, \tau(3) = 4, \tau(4) = 0. The condition is that for every cell,
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $296$; neither removal changes any count.
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $25$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A197162, the recurrence of order $22$ displayed in Section 1 holds for every $n \ge 23$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,75$. Every one of them vanished. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 14, 66, 306, 1489, 7106, 34021, 162800,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197162}{A197162}, revision 9, last modified Oct 03 2025.
