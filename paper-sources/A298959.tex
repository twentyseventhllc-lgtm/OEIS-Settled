...
\title{A proof of the conjectured linear recurrence for OEIS A298959}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298959}{A298959} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-3) +2*a(n-4) -2*a(n-5)\end{quote}
...
\begin{theorem} For A298959, the recurrence $a(n) = 2\,a(n-1) + a(n-3) + 2\,a(n-4) - 2\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 2, 2, 7, 14, 34, 75, 174,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298959}{A298959}, revision 4, last modified Jan 30 2018.
