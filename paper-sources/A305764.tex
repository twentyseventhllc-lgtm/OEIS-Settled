...
\title{A proof of the conjectured linear recurrence for OEIS A305764}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305764}{A305764} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +9*a(n-2) -6*a(n-4) +12*a(n-5) -3*a(n-6) -27*a(n-7) +17*a(n-8) -4*a(n-9) -7*a(n-10) +a(n-11)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 9\,a(n-2) - 6\,a(n-4) + 12\,a(n-5) - 3\,a(n-6) - 27\,a(n-7) + \\ 17\,a(n-8) - 4\,a(n-9) - 7\,a(n-10) + a(n-11). \end{multline*}
...
\begin{theorem} For A305764, the recurrence $a(n) = 3\,a(n-1) + 9\,a(n-2) - 6\,a(n-4) + 12\,a(n-5) - 3\,a(n-6) - 27\,a(n-7) + 17\,a(n-8) - 4\,a(n-9) - 7\,a(n-10) + a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,52$. Every one of them vanished. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 30, 141, 684, 3282, 15874, 76613, 370087,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305764}{A305764}, revision 4, last modified Jun 10 2018.
