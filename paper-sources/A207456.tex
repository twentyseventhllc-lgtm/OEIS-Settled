...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207456}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207456}{A207456} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 13*a(n-2) + 4*a(n-3) - 16*a(n-4).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 10*x*(1 + 9*x + 4*x\textasciicircum{}2 - 16*x\textasciicircum{}3) / (1 - x - 13*x\textasciicircum{}2 - 4*x\textasciicircum{}3 + 16*x\textasciicircum{}4). - Colin Barker, Jun 23 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{10x + 90x^{2} + 40x^{3} - 160x^{4}}{1 - x - 13x^{2} - 4x^{3} + 16x^{4}}.\]
...
\begin{theorem} For A207456, the recurrence $a(n) = a(n-1) + 13\,a(n-2) + 4\,a(n-3) - 16\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A207456, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{10x + 90x^{2} + 40x^{3} - 160x^{4}}{1 - x - 13x^{2} - 4x^{3} + 16x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 270, 1450, 5200, 23530, 92610, 396100,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207456}{A207456}, revision 11, last modified Jun 23 2018.
