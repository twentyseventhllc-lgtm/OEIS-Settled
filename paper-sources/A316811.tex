...
\title{A proof of the conjectured linear recurrence for OEIS A316811}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316811}{A316811} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-1) +33*a(n-2) -111*a(n-3) -963*a(n-4) -704*a(n-5) +2343*a(n-6) +3981*a(n-7) +490*a(n-8) -3271*a(n-9) -2446*a(n-10) -1376*a(n-11) -902*a(n-12) +600*a(n-13) +1658*a(n-14) -484*a(n-15) -668*a(n-16) -26*a(n-17) for n>18\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-1) + 33\,a(n-2) - 111\,a(n-3) - 963\,a(n-4) - 704\,a(n-5) + 2343\,a(n-6) + \\ 3981\,a(n-7) + 490\,a(n-8) - 3271\,a(n-9) - 2446\,a(n-10) - 1376\,a(n-11) - 902\,a(n-12) + \\ 600\,a(n-13) + 1658\,a(n-14) - 484\,a(n-15) - 668\,a(n-16) - 26\,a(n-17). \end{multline*}
...
\begin{theorem} For A316811, the recurrence $a(n) = 11\,a(n-1) + 33\,a(n-2) - 111\,a(n-3) - 963\,a(n-4) - 704\,a(n-5) + 2343\,a(n-6) + 3981\,a(n-7) + 490\,a(n-8) - 3271\,a(n-9) - 2446\,a(n-10) - 1376\,a(n-11) - 902\,a(n-12) + 600\,a(n-13) + 1658\,a(n-14) - 484\,a(n-15) - 668\,a(n-16) - 26\,a(n-17)$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. The last nonvanishing one is at $m = 1$, that is at $n = 18$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1603, 19816, 246196, 3056047, 37935501, 470942175,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316811}{A316811}, revision 4, last modified Jul 14 2018.
