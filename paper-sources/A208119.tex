...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208119}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208119}{A208119} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) - 10*a(n-2) + 30*a(n-3) - 120*a(n-5) + 160*a(n-6) - 320*a(n-7) + 256*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(9 + 36*x - 90*x\textasciicircum{}2 + 40*x\textasciicircum{}3 - 280*x\textasciicircum{}4 + 96*x\textasciicircum{}5 - 64*x\textasciicircum{}6 + 256*x\textasciicircum{}7) / ((1 - x)*(1 - 2*x)*(1 + 2*x)*(1 - 4*x)*(1 + 2*x\textasciicircum{}2)*(1 + 8*x\textasciicircum{}2)). - Colin Barker, Jun 28 2018\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 10\,a(n-2) + 30\,a(n-3) - 120\,a(n-5) + 160\,a(n-6) - 320\,a(n-7) + \\ 256\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 36x^{2} - 90x^{3} + 40x^{4} - 280x^{5} + 96x^{6} - 64x^{7} + 256x^{8}}{1 - 5x + 10x^{2} - 30x^{3} + 120x^{5} - 160x^{6} + 320x^{7} - 256x^{8}}.\]
...
\begin{theorem} For A208119, the recurrence $a(n) = 5\,a(n-1) - 10\,a(n-2) + 30\,a(n-3) - 120\,a(n-5) + 160\,a(n-6) - 320\,a(n-7) + 256\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208119, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 36x^{2} - 90x^{3} + 40x^{4} - 280x^{5} + 96x^{6} - 64x^{7} + 256x^{8}}{1 - 5x + 10x^{2} - 30x^{3} + 120x^{5} - 160x^{6} + 320x^{7} - 256x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 225, 625, 3025, 14641, 53361, 194481,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208119}{A208119}, revision 8, last modified Jun 28 2018.
