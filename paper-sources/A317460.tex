...
\title{A proof of the conjectured linear recurrence for OEIS A317460}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317460}{A317460} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +8*a(n-2) +2*a(n-3) -48*a(n-4) -62*a(n-5) +35*a(n-6) +62*a(n-7) +5*a(n-8) -25*a(n-9) +2*a(n-10) +14*a(n-11) +4*a(n-12) for n>14\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 8\,a(n-2) + 2\,a(n-3) - 48\,a(n-4) - 62\,a(n-5) + 35\,a(n-6) + \\ 62\,a(n-7) + 5\,a(n-8) - 25\,a(n-9) + 2\,a(n-10) + 14\,a(n-11) + 4\,a(n-12). \end{multline*}
...
\begin{theorem} For A317460, the recurrence $a(n) = 5\,a(n-1) + 8\,a(n-2) + 2\,a(n-3) - 48\,a(n-4) - 62\,a(n-5) + 35\,a(n-6) + 62\,a(n-7) + 5\,a(n-8) - 25\,a(n-9) + 2\,a(n-10) + 14\,a(n-11) + 4\,a(n-12)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,53$. The last nonvanishing one is at $m = 2$, that is at $n = 14$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 5, 16, 107, 636, 3893, 23769, 145280,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317460}{A317460}, revision 4, last modified Jul 28 2018.
