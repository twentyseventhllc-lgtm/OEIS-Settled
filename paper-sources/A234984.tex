...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234984}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234984}{A234984} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) + 6*a(n-2) - 33*a(n-3) - 24*a(n-4) + 56*a(n-5) + 34*a(n-6) - 20*a(n-7) - 4*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(45 - 40*x - 375*x\textasciicircum{}2 + 52*x\textasciicircum{}3 + 916*x\textasciicircum{}4 + 346*x\textasciicircum{}5 - 324*x\textasciicircum{}6 - 60*x\textasciicircum{}7) / ((1 - 2*x\textasciicircum{}2)*(1 - 5*x - 4*x\textasciicircum{}2 + 23*x\textasciicircum{}3 + 16*x\textasciicircum{}4 - 10*x\textasciicircum{}5 - 2*x\textasciicircum{}6)). - Colin Barker, Oct 16 2018\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 6\,a(n-2) - 33\,a(n-3) - 24\,a(n-4) + 56\,a(n-5) + 34\,a(n-6) - \\ 20\,a(n-7) - 4\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{90x - 80x^{2} - 750x^{3} + 104x^{4} + 1832x^{5} + 692x^{6} - 648x^{7} - 120x^{8}}{1 - 5x - 6x^{2} + 33x^{3} + 24x^{4} - 56x^{5} - 34x^{6} + 20x^{7} + 4x^{8}}.\]
...
For scale: at $n = 8$ there are $6^{16}$ arrays, about $10^{12}$, against $8$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A234984, the recurrence $a(n) = 5\,a(n-1) + 6\,a(n-2) - 33\,a(n-3) - 24\,a(n-4) + 56\,a(n-5) + 34\,a(n-6) - 20\,a(n-7) - 4\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234984, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{90x - 80x^{2} - 750x^{3} + 104x^{4} + 1832x^{5} + 692x^{6} - 648x^{7} - 120x^{8}}{1 - 5x - 6x^{2} + 33x^{3} + 24x^{4} - 56x^{5} - 34x^{6} + 20x^{7} + 4x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 90, 370, 1640, 7554, 35072, 163416, 762002, 3554334,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234984}{A234984}, revision 9, last modified Jun 19 2022.
