...
\title{A proof of the conjectured linear recurrence for OEIS A297225}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297225}{A297225} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +8*a(n-3) +6*a(n-4) +4*a(n-5) -6*a(n-6) -8*a(n-7) -8*a(n-8) +10*a(n-9) +4*a(n-10) -2*a(n-11) -3*a(n-12) +a(n-13)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 6\,a(n-4) + 4\,a(n-5) - 6\,a(n-6) - \\ 8\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) + 4\,a(n-10) - 2\,a(n-11) - 3\,a(n-12) + \\ a(n-13). \end{multline*}
...
\begin{theorem} For A297225, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 6\,a(n-4) + 4\,a(n-5) - 6\,a(n-6) - 8\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) + 4\,a(n-10) - 2\,a(n-11) - 3\,a(n-12) + a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 9, 24, 57, 182, 535, 1513, 4415,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297225}{A297225}, revision 4, last modified Dec 27 2017.
