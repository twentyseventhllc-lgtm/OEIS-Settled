...
k=2: a(n) = 2*a(n-1) -a(n-2) +4*a(n-3) -4*a(n-4) for n > 5;\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (May 19 2018). As of revision 6, last modified Apr 26 2021, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
