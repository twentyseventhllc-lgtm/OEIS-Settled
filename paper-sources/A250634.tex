...
\title{A proof of the conjectured linear recurrence for OEIS A250634}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250634}{A250634} as
...
\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -21*a(n-2) -32*a(n-3) +195*a(n-4) -160*a(n-5) -371*a(n-6) +679*a(n-7) +5*a(n-8) -716*a(n-9) +413*a(n-10) +152*a(n-11) -200*a(n-12) +48*a(n-13) for n>16\end{quote}
...
\begin{theorem} For A250634, the recurrence $a(n) = 9\,a(n-1) - 21\,a(n-2) - 32\,a(n-3) + 195\,a(n-4) - 160\,a(n-5) - 371\,a(n-6) + 679\,a(n-7) + 5\,a(n-8) - 716\,a(n-9) + 413\,a(n-10) + 152\,a(n-11) - 200\,a(n-12) + 48\,a(n-13)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,62$. The last nonvanishing one is at $m = 3$, that is at $n = 16$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 125, 654, 2969, 12360, 49310, 190213, 720347, 2690076,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250634}{A250634}, revision 6, last modified Jul 23 2025.
