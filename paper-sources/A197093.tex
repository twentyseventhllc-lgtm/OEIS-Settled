...
\title{A proof of the conjectured linear recurrence for OEIS A197093}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197093}{A197093} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,0,0,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +5*a(n-2) +16*a(n-3) +26*a(n-4) +32*a(n-5) -2*a(n-6) +2*a(n-7) -30*a(n-8) +7*a(n-9) -3*a(n-10) +a(n-11) +a(n-12) -a(n-13)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 5\,a(n-2) + 16\,a(n-3) + 26\,a(n-4) + 32\,a(n-5) - 2\,a(n-6) + \\ 2\,a(n-7) - 30\,a(n-8) + 7\,a(n-9) - 3\,a(n-10) + a(n-11) + a(n-12) - \\ a(n-13). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $130$; neither removal changes any count.
...
\begin{theorem} For A197093, the recurrence $a(n) = 3\,a(n-1) + 5\,a(n-2) + 16\,a(n-3) + 26\,a(n-4) + 32\,a(n-5) - 2\,a(n-6) + 2\,a(n-7) - 30\,a(n-8) + 7\,a(n-9) - 3\,a(n-10) + a(n-11) + a(n-12) - a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,54$. Every one of them vanished. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 18, 74, 384, 1880, 9274, 45843, 226260,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197093}{A197093}, revision 9, last modified Oct 03 2025.
