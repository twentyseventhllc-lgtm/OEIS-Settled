...
\title{A proof of the conjectured linear recurrence for OEIS A303184}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303184}{A303184} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -4*a(n-2) +4*a(n-3) -9*a(n-4) +6*a(n-5) -5*a(n-6) +4*a(n-7) -4*a(n-8) +14*a(n-9) -9*a(n-10) -2*a(n-12) +8*a(n-13) +2*a(n-14) -8*a(n-15) -4*a(n-16) +4*a(n-17) for n>22\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 4\,a(n-2) + 4\,a(n-3) - 9\,a(n-4) + 6\,a(n-5) - 5\,a(n-6) + \\ 4\,a(n-7) - 4\,a(n-8) + 14\,a(n-9) - 9\,a(n-10) - 2\,a(n-12) + 8\,a(n-13) + \\ 2\,a(n-14) - 8\,a(n-15) - 4\,a(n-16) + 4\,a(n-17). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $174$; neither removal changes any count.
...
\begin{theorem} For A303184, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2) + 4\,a(n-3) - 9\,a(n-4) + 6\,a(n-5) - 5\,a(n-6) + 4\,a(n-7) - 4\,a(n-8) + 14\,a(n-9) - 9\,a(n-10) - 2\,a(n-12) + 8\,a(n-13) + 2\,a(n-14) - 8\,a(n-15) - 4\,a(n-16) + 4\,a(n-17)$ holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,81$. The last nonvanishing one is at $m = 5$, that is at $n = 22$. After it, more than $S = 33$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 81, 135, 297, 931, 2569, 6668, 17934,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303184}{A303184}, revision 4, last modified Apr 19 2018.
