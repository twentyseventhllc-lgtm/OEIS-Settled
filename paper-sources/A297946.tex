...
\title{A proof of the conjectured linear recurrence for OEIS A297946}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297946}{A297946} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -2*a(n-3) -2*a(n-4) -12*a(n-5) +24*a(n-6) +3*a(n-7) -4*a(n-8) -80*a(n-9) -67*a(n-10) +37*a(n-11) +140*a(n-12) +100*a(n-13) -32*a(n-14) -67*a(n-15) -12*a(n-16) +24*a(n-17) +2*a(n-18) -12*a(n-19) -4*a(n-20) for n>21\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 2\,a(n-3) - 2\,a(n-4) - 12\,a(n-5) + 24\,a(n-6) + 3\,a(n-7) - \\ 4\,a(n-8) - 80\,a(n-9) - 67\,a(n-10) + 37\,a(n-11) + 140\,a(n-12) + 100\,a(n-13) - \\ 32\,a(n-14) - 67\,a(n-15) - 12\,a(n-16) + 24\,a(n-17) + 2\,a(n-18) - 12\,a(n-19) - \\ 4\,a(n-20). \end{multline*}
...
\begin{theorem} For A297946, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-3) - 2\,a(n-4) - 12\,a(n-5) + 24\,a(n-6) + 3\,a(n-7) - 4\,a(n-8) - 80\,a(n-9) - 67\,a(n-10) + 37\,a(n-11) + 140\,a(n-12) + 100\,a(n-13) - 32\,a(n-14) - 67\,a(n-15) - 12\,a(n-16) + 24\,a(n-17) + 2\,a(n-18) - 12\,a(n-19) - 4\,a(n-20)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,72$. The last nonvanishing one is at $m = 1$, that is at $n = 21$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 56, 219, 796, 3079, 11614, 44076,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297946}{A297946}, revision 4, last modified Jan 09 2018.
