...
\title{A proof of the conjectured linear recurrence for OEIS A302213}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302213}{A302213} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +4*a(n-2) -29*a(n-3) -3*a(n-4) +96*a(n-5) -14*a(n-6) -187*a(n-7) +39*a(n-8) +246*a(n-9) -52*a(n-10) -230*a(n-11) +48*a(n-12) +146*a(n-13) -29*a(n-14) -57*a(n-15) +9*a(n-16) +12*a(n-17) -a(n-18) -a(n-19) for n>20\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 4\,a(n-2) - 29\,a(n-3) - 3\,a(n-4) + 96\,a(n-5) - 14\,a(n-6) - \\ 187\,a(n-7) + 39\,a(n-8) + 246\,a(n-9) - 52\,a(n-10) - 230\,a(n-11) + 48\,a(n-12) + \\ 146\,a(n-13) - 29\,a(n-14) - 57\,a(n-15) + 9\,a(n-16) + 12\,a(n-17) - a(n-18) - \\ a(n-19). \end{multline*}
...
\begin{theorem} For A302213, the recurrence $a(n) = 4\,a(n-1) + 4\,a(n-2) - 29\,a(n-3) - 3\,a(n-4) + 96\,a(n-5) - 14\,a(n-6) - 187\,a(n-7) + 39\,a(n-8) + 246\,a(n-9) - 52\,a(n-10) - 230\,a(n-11) + 48\,a(n-12) + 146\,a(n-13) - 29\,a(n-14) - 57\,a(n-15) + 9\,a(n-16) + 12\,a(n-17) - a(n-18) - a(n-19)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,78$. The last nonvanishing one is at $m = 1$, that is at $n = 20$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 2, 16, 5, 32, 22, 72, 101,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302213}{A302213}, revision 4, last modified Apr 03 2018.
