...
\title{A proof of the conjectured linear recurrence for OEIS A256804}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A256804}{A256804} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 0 or 1 and no column sum 0 or 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-2) +17*a(n-3) +18*a(n-4) -7*a(n-5) -37*a(n-6) -47*a(n-7) +2*a(n-8) +40*a(n-9) +21*a(n-10) -7*a(n-11) -3*a(n-12) -2*a(n-13) -a(n-14)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 4\,a(n-2) + 17\,a(n-3) + 18\,a(n-4) - 7\,a(n-5) - 37\,a(n-6) - \\ 47\,a(n-7) + 2\,a(n-8) + 40\,a(n-9) + 21\,a(n-10) - 7\,a(n-11) - 3\,a(n-12) - \\ 2\,a(n-13) - a(n-14). \end{multline*}
...
\begin{theorem} For A256804, the recurrence $a(n) = a(n-1) + 4\,a(n-2) + 17\,a(n-3) + 18\,a(n-4) - 7\,a(n-5) - 37\,a(n-6) - 47\,a(n-7) + 2\,a(n-8) + 40\,a(n-9) + 21\,a(n-10) - 7\,a(n-11) - 3\,a(n-12) - 2\,a(n-13) - a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 86, 312, 1167, 4219, 15291, 55798, 203129, 738760,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A256804}{A256804}, revision 6, last modified Jun 02 2025.
