...
\title{A proof of the conjectured linear recurrence for OEIS A197302}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197302}{A197302} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,0,2,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +3*a(n-3) +4*a(n-4) +2*a(n-5) +10*a(n-6) +6*a(n-7) -7*a(n-8) -23*a(n-9) -27*a(n-10) -23*a(n-11) +5*a(n-12) +29*a(n-13) +15*a(n-14) +2*a(n-15)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 4\,a(n-4) + 2\,a(n-5) + 10\,a(n-6) + \\ 6\,a(n-7) - 7\,a(n-8) - 23\,a(n-9) - 27\,a(n-10) - 23\,a(n-11) + 5\,a(n-12) + \\ 29\,a(n-13) + 15\,a(n-14) + 2\,a(n-15). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 4, \tau(1) = 4, \tau(2) = 0, \tau(3) = 2, \tau(4) = 1. The condition is that for every cell,
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $76$; neither removal changes any count.
...
\begin{theorem} For A197302, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 4\,a(n-4) + 2\,a(n-5) + 10\,a(n-6) + 6\,a(n-7) - 7\,a(n-8) - 23\,a(n-9) - 27\,a(n-10) - 23\,a(n-11) + 5\,a(n-12) + 29\,a(n-13) + 15\,a(n-14) + 2\,a(n-15)$ holds for every $n \ge 16$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,61$. Every one of them vanished. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 10, 31, 98, 344, 1139, 3750, 12470,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197302}{A197302}, revision 9, last modified Oct 03 2025.
