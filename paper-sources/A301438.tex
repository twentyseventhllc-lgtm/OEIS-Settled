...
\title{A proof of the conjectured linear recurrence for OEIS A301438}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301438}{A301438} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -4*a(n-2) -5*a(n-3)\end{quote}
...
\begin{theorem} For A301438, the recurrence $a(n) = 8\,a(n-1) - 4\,a(n-2) - 5\,a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 232, 1708, 12576, 92616, 682084, 5023328,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301438}{A301438}, revision 4, last modified Mar 21 2018.
