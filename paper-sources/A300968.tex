...
\title{A proof of the conjectured linear recurrence for OEIS A300968}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300968}{A300968} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) -2*a(n-2) -11*a(n-3) -a(n-4) +10*a(n-5) +6*a(n-6) -4*a(n-7) -4*a(n-8) -2*a(n-9) for n>11.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Mar 17 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Jan 25 2022, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 7\,a(n-1) - 2\,a(n-2) - 11\,a(n-3) - a(n-4) + 10\,a(n-5) + 6\,a(n-6) - \\ 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9). \end{multline*}
...
\begin{theorem} For A300968, the recurrence $a(n) = 7\,a(n-1) - 2\,a(n-2) - 11\,a(n-3) - a(n-4) + 10\,a(n-5) + 6\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,49$. The last nonvanishing one is at $m = 2$, that is at $n = 11$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 11, 72, 459, 2956, 18996, 122043, 784108,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300968}{A300968}, revision 6, last modified Jan 25 2022.
