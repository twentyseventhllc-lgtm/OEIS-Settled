...
\title{A proof of the conjectured linear recurrence for OEIS A207903}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207903}{A207903} as

\begin{quote}\itshape Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -4*a(n-3) -5*a(n-4) +9*a(n-5) +3*a(n-6) -2*a(n-7) -5*a(n-8) +2*a(n-9) -2*a(n-10) +a(n-11) +a(n-12) +a(n-13) -a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 4\,a(n-3) - 5\,a(n-4) + 9\,a(n-5) + 3\,a(n-6) - 2\,a(n-7) - \\ 5\,a(n-8) + 2\,a(n-9) - 2\,a(n-10) + a(n-11) + a(n-12) + a(n-13) - \\ a(n-14). \end{multline*}
...
\begin{theorem} For A207903, the recurrence $a(n) = 3\,a(n-1) - 4\,a(n-3) - 5\,a(n-4) + 9\,a(n-5) + 3\,a(n-6) - 2\,a(n-7) - 5\,a(n-8) + 2\,a(n-9) - 2\,a(n-10) + a(n-11) + a(n-12) + a(n-13) - a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 102, 261, 611, 1278, 2625, 5134,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207903}{A207903}, revision 9, last modified Oct 03 2025.
