...
\title{A proof of the conjectured linear recurrence for OEIS A303686}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303686}{A303686} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 2, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +16*a(n-2) -80*a(n-4) -37*a(n-5) +195*a(n-6) +139*a(n-7) -235*a(n-8) -254*a(n-9) +22*a(n-10) +175*a(n-11) +412*a(n-12) +300*a(n-13) -564*a(n-14) -853*a(n-15) +201*a(n-16) +822*a(n-17) +70*a(n-18) -251*a(n-19) +26*a(n-20) -139*a(n-21) -266*a(n-22) +225*a(n-23) +290*a(n-24) -140*a(n-25) -150*a(n-26) +24*a(n-27) +78*a(n-28) -16*a(n-29) -14*a(n-30) +4*a(n-31) for n>35\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 16\,a(n-2) - 80\,a(n-4) - 37\,a(n-5) + 195\,a(n-6) + 139\,a(n-7) - \\ 235\,a(n-8) - 254\,a(n-9) + 22\,a(n-10) + 175\,a(n-11) + 412\,a(n-12) + 300\,a(n-13) - \\ 564\,a(n-14) - 853\,a(n-15) + 201\,a(n-16) + 822\,a(n-17) + 70\,a(n-18) - 251\,a(n-19) + \\ 26\,a(n-20) - 139\,a(n-21) - 266\,a(n-22) + 225\,a(n-23) + 290\,a(n-24) - 140\,a(n-25) - \\ 150\,a(n-26) + 24\,a(n-27) + 78\,a(n-28) - 16\,a(n-29) - 14\,a(n-30) + 4\,a(n-31). \end{multline*}
...
\begin{theorem} For A303686, the recurrence of order $31$ displayed in Section 1 holds for every $n > 35$, and fails at $n = 35$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,100$. The last nonvanishing one is at $m = 4$, that is at $n = 35$. After it, more than $S = 39$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 18, 20, 138, 343, 1744, 5563, 23963,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303686}{A303686}, revision 4, last modified Apr 28 2018.
