...
\title{A proof of the conjectured linear recurrence for OEIS A302164}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302164}{A302164} as

\begin{quote}\itshape Number of 2Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +16*a(n-4) -8*a(n-5) for n>6\end{quote}
...
\begin{theorem} For A302164, the recurrence $a(n) = a(n-1) + 16\,a(n-4) - 8\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 3, 9, 17, 25, 65, 185, 385,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302164}{A302164}, revision 4, last modified Apr 02 2018.
