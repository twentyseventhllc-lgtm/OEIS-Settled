...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A260364}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260364}{A260364} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001111\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) + 5*a(n-3) + 5*a(n-4) - 4*a(n-5) - 6*a(n-6) - 10*a(n-7) - 7*a(n-8) + 4*a(n-9) + 5*a(n-10) + 5*a(n-11) + 3*a(n-12).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(78 + 127*x + 264*x\textasciicircum{}2 + 183*x\textasciicircum{}3 - 471*x\textasciicircum{}4 - 686*x\textasciicircum{}5 - 692*x\textasciicircum{}6 - 443*x\textasciicircum{}7 + 393*x\textasciicircum{}8 + 559*x\textasciicircum{}9 + 428*x\textasciicircum{}10 + 268*x\textasciicircum{}11) / ((1 - x)*(1 + x)\textasciicircum{}2*(1 + x\textasciicircum{}2)*(1 - x - 5*x\textasciicircum{}3 + x\textasciicircum{}4 + 3*x\textasciicircum{}5 + 2*x\textasciicircum{}6 + 3*x\textasciicircum{}7)). - Colin Barker, Dec 29 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jul 23 2015).
...
\begin{multline*} a(n) = a(n-2) + 5\,a(n-3) + 5\,a(n-4) - 4\,a(n-5) - 6\,a(n-6) - 10\,a(n-7) - \\ 7\,a(n-8) + 4\,a(n-9) + 5\,a(n-10) + 5\,a(n-11) + 3\,a(n-12). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{78x + 127x^{2} + 264x^{3} + 183x^{4} - 471x^{5} - 686x^{6} - 692x^{7} - 443x^{8} + 393x^{9} + 559x^{10} + 428x^{11} + 268x^{12}}{1 - x^{2} - 5x^{3} - 5x^{4} + 4x^{5} + 6x^{6} + 10x^{7} + 7x^{8} - 4x^{9} - 5x^{10} - 5x^{11} - 3x^{12}}.\]
...
That refinement leaves $26$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 18$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A260364, the recurrence $a(n) = a(n-2) + 5\,a(n-3) + 5\,a(n-4) - 4\,a(n-5) - 6\,a(n-6) - 10\,a(n-7) - 7\,a(n-8) + 4\,a(n-9) + 5\,a(n-10) + 5\,a(n-11) + 3\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A260364, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{78x + 127x^{2} + 264x^{3} + 183x^{4} - 471x^{5} - 686x^{6} - 692x^{7} - 443x^{8} + 393x^{9} + 559x^{10} + 428x^{11} + 268x^{12}}{1 - x^{2} - 5x^{3} - 5x^{4} + 4x^{5} + 6x^{6} + 10x^{7} + 7x^{8} - 4x^{9} - 5x^{10} - 5x^{11} - 3x^{12}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 78, 127, 342, 700, 896, 2047, 4438, 6674,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260364}{A260364}, revision 8, last modified Dec 29 2018.
