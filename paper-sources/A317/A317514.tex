...
\title{A proof of the conjectured linear recurrence for OEIS A317514}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317514}{A317514} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 31*a(n-1) -3*a(n-2) +708*a(n-3) +474*a(n-4) +2957*a(n-5) +2350*a(n-6) -1836*a(n-7) -1440*a(n-8)\end{quote}
...
\begin{multline*} a(n) = 31\,a(n-1) - 3\,a(n-2) + 708\,a(n-3) + 474\,a(n-4) + 2957\,a(n-5) + 2350\,a(n-6) - \\ 1836\,a(n-7) - 1440\,a(n-8). \end{multline*}
...
\begin{theorem} For A317514, the recurrence $a(n) = 31\,a(n-1) - 3\,a(n-2) + 708\,a(n-3) + 474\,a(n-4) + 2957\,a(n-5) + 2350\,a(n-6) - 1836\,a(n-7) - 1440\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 512, 16193, 512096, 16198017, 512358002, 16206294085, 512618027974,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317514}{A317514}, revision 4, last modified Jul 30 2018.
