...
\title{A proof of the conjectured linear recurrence for OEIS A317513}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317513}{A317513} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) -6*a(n-2) +64*a(n-3)\end{quote}
...
\begin{theorem} For A317513, the recurrence $a(n) = 16\,a(n-1) - 6\,a(n-2) + 64\,a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,29$. Every one of them vanished. After it, more than $S = 4$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 2032, 32256, 512096, 8130048, 129072576, 2049155072,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317513}{A317513}, revision 4, last modified Jul 30 2018.
