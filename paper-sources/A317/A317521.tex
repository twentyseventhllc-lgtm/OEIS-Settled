...
\title{A proof of the conjectured linear recurrence for OEIS A317521}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317521}{A317521} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 15*a(n-1) +a(n-2) -8*a(n-3) -84*a(n-4) -63*a(n-5) +24*a(n-6) +20*a(n-7)\end{quote}
...
\begin{multline*} a(n) = 15\,a(n-1) + a(n-2) - 8\,a(n-3) - 84\,a(n-4) - 63\,a(n-5) + 24\,a(n-6) + \\ 20\,a(n-7). \end{multline*}
...
\begin{theorem} For A317521, the recurrence $a(n) = 15\,a(n-1) + a(n-2) - 8\,a(n-3) - 84\,a(n-4) - 63\,a(n-5) + 24\,a(n-6) + 20\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1921, 28760, 431529, 6475106, 97158833, 1457871738,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317521}{A317521}, revision 4, last modified Jul 30 2018.
