...
\title{A proof of the conjectured linear recurrence for OEIS A305956}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305956}{A305956} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +17*a(n-2) +14*a(n-3) -54*a(n-4) -135*a(n-5) -107*a(n-6) -58*a(n-7) -39*a(n-8) -11*a(n-9) for n>10\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 17\,a(n-2) + 14\,a(n-3) - 54\,a(n-4) - 135\,a(n-5) - 107\,a(n-6) - \\ 58\,a(n-7) - 39\,a(n-8) - 11\,a(n-9). \end{multline*}
...
\begin{theorem} For A305956, the recurrence $a(n) = 4\,a(n-1) + 17\,a(n-2) + 14\,a(n-3) - 54\,a(n-4) - 135\,a(n-5) - 107\,a(n-6) - 58\,a(n-7) - 39\,a(n-8) - 11\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 25, 132, 919, 6030, 39985, 264680, 1752681,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305956}{A305956}, revision 4, last modified Jun 15 2018.
