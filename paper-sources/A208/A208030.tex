...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208030}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208030}{A208030} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) + 19*a(n-2) - 9*a(n-3) - 42*a(n-4) + 31*a(n-5) + 3*a(n-6) - 4*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 13*x*(1 + 10*x - x\textasciicircum{}2 - 38*x\textasciicircum{}3 + 28*x\textasciicircum{}4 + 3*x\textasciicircum{}5 - 4*x\textasciicircum{}6) / ((1 - x)*(1 - 2*x - 21*x\textasciicircum{}2 - 12*x\textasciicircum{}3 + 30*x\textasciicircum{}4 - x\textasciicircum{}5 - 4*x\textasciicircum{}6)). - Colin Barker, Jun 26 2018\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 19\,a(n-2) - 9\,a(n-3) - 42\,a(n-4) + 31\,a(n-5) + 3\,a(n-6) - \\ 4\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{13x + 130x^{2} - 13x^{3} - 494x^{4} + 364x^{5} + 39x^{6} - 52x^{7}}{1 - 3x - 19x^{2} + 9x^{3} + 42x^{4} - 31x^{5} - 3x^{6} + 4x^{7}}.\]
...
\begin{theorem} For A208030, the recurrence $a(n) = 3\,a(n-1) + 19\,a(n-2) - 9\,a(n-3) - 42\,a(n-4) + 31\,a(n-5) + 3\,a(n-6) - 4\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208030, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{13x + 130x^{2} - 13x^{3} - 494x^{4} + 364x^{5} + 39x^{6} - 52x^{7}}{1 - 3x - 19x^{2} + 9x^{3} + 42x^{4} - 31x^{5} - 3x^{6} + 4x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 741, 4823, 26845, 158847, 917293, 5349227,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208030}{A208030}, revision 8, last modified Jun 26 2018.
