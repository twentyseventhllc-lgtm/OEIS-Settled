...
\title{A proof of the conjectured linear recurrence for OEIS A208122}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208122}{A208122} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) -12*a(n-2) +55*a(n-3) +805*a(n-4) +900*a(n-5) +10320*a(n-6) -123840*a(n-8) -129600*a(n-9) -1391040*a(n-10) -1140480*a(n-11) +2985984*a(n-12) -2985984*a(n-13) +35831808*a(n-14)\end{quote}
...
\begin{multline*} a(n) = a(n-1) - 12\,a(n-2) + 55\,a(n-3) + 805\,a(n-4) + 900\,a(n-5) + 10320\,a(n-6) - \\ 123840\,a(n-8) - 129600\,a(n-9) - 1391040\,a(n-10) - 1140480\,a(n-11) + 2985984\,a(n-12) - 2985984\,a(n-13) + \\ 35831808\,a(n-14). \end{multline*}
...
\begin{theorem} For A208122, the recurrence $a(n) = a(n-1) - 12\,a(n-2) + 55\,a(n-3) + 805\,a(n-4) + 900\,a(n-5) + 10320\,a(n-6) - 123840\,a(n-8) - 129600\,a(n-9) - 1391040\,a(n-10) - 1140480\,a(n-11) + 2985984\,a(n-12) - 2985984\,a(n-13) + 35831808\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 1260, 3969, 34713, 303601, 1432600, 6760000,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208122}{A208122}, revision 9, last modified Oct 03 2025.
