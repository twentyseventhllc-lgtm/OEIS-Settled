...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208014}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208014}{A208014} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 2*a(n-2) + 10*a(n-3) + 4*a(n-4) - 8*a(n-5) - 16*a(n-6) for n>8.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(9 + 72*x + 126*x\textasciicircum{}2 + 364*x\textasciicircum{}3 + 167*x\textasciicircum{}4 - 404*x\textasciicircum{}5 - 714*x\textasciicircum{}6 - 148*x\textasciicircum{}7) / ((1 + 2*x\textasciicircum{}2 - 4*x\textasciicircum{}3)*(1 - x - 4*x\textasciicircum{}2 - 4*x\textasciicircum{}3)). - Colin Barker, Jun 26 2018\end{quote}
...
\[a(n) = a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 8\,a(n-5) - 16\,a(n-6).\]

stated for $n > 8$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 72x^{2} + 126x^{3} + 364x^{4} + 167x^{5} - 404x^{6} - 714x^{7} - 148x^{8}}{1 - x - 2x^{2} - 10x^{3} - 4x^{4} + 8x^{5} + 16x^{6}}.\]
...
\begin{theorem} For A208014, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 8\,a(n-5) - 16\,a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,46$. The last nonvanishing one is at $m = 2$, that is at $n = 8$. After it, more than $S = 10$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 8$. The theorem is at least as strong.

\begin{theorem} For A208014, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 72x^{2} + 126x^{3} + 364x^{4} + 167x^{5} - 404x^{6} - 714x^{7} - 148x^{8}}{1 - x - 2x^{2} - 10x^{3} - 4x^{4} + 8x^{5} + 16x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 225, 841, 2304, 6084, 18496, 53824,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208014}{A208014}, revision 8, last modified Jun 26 2018.
