...
\title{A proof of the conjectured generating function and closed form for OEIS A208138}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208138}{A208138} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (9/4)*n\textasciicircum{}4 + (9/2)*n\textasciicircum{}3 + (9/4)*n\textasciicircum{}2.\end{quote}

\begin{quote}\ttfamily G.f.: 9*x*(1 + 4*x + x\textasciicircum{}2) / (1 - x)\textasciicircum{}5.\end{quote}
...
\[a(n) = \frac{9}{4}n^{2} + \frac{9}{2}n^{3} + \frac{9}{4}n^{4}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 36x^{2} + 9x^{3}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}.\]
...
\begin{theorem} For A208138, $a(n)$ is the polynomial $\frac{9}{4}n^{2} + \frac{9}{2}n^{3} + \frac{9}{4}n^{4}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A208138, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 36x^{2} + 9x^{3}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 33 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 324, 900, 2025, 3969, 7056, 11664,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208138}{A208138}, revision 8, last modified Jun 28 2018.
