...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208111}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208111}{A208111} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 21*a(n-3) + 438*a(n-4) - 456*a(n-5) - 399*a(n-6) - 7220*a(n-8) + 6859*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(22 + 440*x + 22*x\textasciicircum{}2 - 417*x\textasciicircum{}3 - 855*x\textasciicircum{}4 - 7619*x\textasciicircum{}5 - 361*x\textasciicircum{}6 - 361*x\textasciicircum{}7 + 6859*x\textasciicircum{}8) / ((1 - 2*x - 20*x\textasciicircum{}2 + 19*x\textasciicircum{}3)*(1 + 20*x\textasciicircum{}2 - 38*x\textasciicircum{}4 - 361*x\textasciicircum{}6)). - Colin Barker, Jun 28 2018\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 21\,a(n-3) + 438\,a(n-4) - 456\,a(n-5) - 399\,a(n-6) - 7220\,a(n-8) + \\ 6859\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{22x + 440x^{2} + 22x^{3} - 417x^{4} - 855x^{5} - 7619x^{6} - 361x^{7} - 361x^{8} + 6859x^{9}}{1 - 2x - 21x^{3} - 438x^{4} + 456x^{5} + 399x^{6} + 7220x^{8} - 6859x^{9}}.\]
...
\begin{theorem} For A208111, the recurrence $a(n) = 2\,a(n-1) + 21\,a(n-3) + 438\,a(n-4) - 456\,a(n-5) - 399\,a(n-6) - 7220\,a(n-8) + 6859\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208111, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{22x + 440x^{2} + 22x^{3} - 417x^{4} - 855x^{5} - 7619x^{6} - 361x^{7} - 361x^{8} + 6859x^{9}}{1 - 2x - 21x^{3} - 438x^{4} + 456x^{5} + 399x^{6} + 7220x^{8} - 6859x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 22, 484, 990, 2025, 22995, 261121, 768544, 2262016,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208111}{A208111}, revision 8, last modified Jun 28 2018.
