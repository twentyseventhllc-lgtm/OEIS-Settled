...
\title{A proof of the conjectured linear recurrence for OEIS A208017}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208017}{A208017} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +43*a(n-3) +12*a(n-4) +12*a(n-5) -432*a(n-6) -288*a(n-7) +1728*a(n-9) for n>11\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 43\,a(n-3) + 12\,a(n-4) + 12\,a(n-5) - 432\,a(n-6) - 288\,a(n-7) + \\ 1728\,a(n-9). \end{multline*}
...
That refinement leaves $46$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 12$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A208017, the recurrence $a(n) = a(n-1) + 43\,a(n-3) + 12\,a(n-4) + 12\,a(n-5) - 432\,a(n-6) - 288\,a(n-7) + 1728\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 1260, 8643, 32860, 92560, 393049, 1578401,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208017}{A208017}, revision 9, last modified Oct 03 2025.
