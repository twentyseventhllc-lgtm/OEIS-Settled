...
\title{A proof of the conjectured linear recurrence for OEIS A208165}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208165}{A208165} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +16*a(n-3) +13*a(n-4) +21*a(n-5) -24*a(n-6) -56*a(n-7) -65*a(n-8) +3*a(n-9) +93*a(n-10) +114*a(n-11) +a(n-12) -99*a(n-13) -107*a(n-14) +14*a(n-15) +86*a(n-16) +39*a(n-17) -34*a(n-18) -19*a(n-19) +6*a(n-21) for n>23\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 16\,a(n-3) + 13\,a(n-4) + 21\,a(n-5) - 24\,a(n-6) - 56\,a(n-7) - \\ 65\,a(n-8) + 3\,a(n-9) + 93\,a(n-10) + 114\,a(n-11) + a(n-12) - 99\,a(n-13) - \\ 107\,a(n-14) + 14\,a(n-15) + 86\,a(n-16) + 39\,a(n-17) - 34\,a(n-18) - 19\,a(n-19) + \\ 6\,a(n-21). \end{multline*}
...
\begin{theorem} For A208165, the recurrence $a(n) = a(n-1) + 16\,a(n-3) + 13\,a(n-4) + 21\,a(n-5) - 24\,a(n-6) - 56\,a(n-7) - 65\,a(n-8) + 3\,a(n-9) + 93\,a(n-10) + 114\,a(n-11) + a(n-12) - 99\,a(n-13) - 107\,a(n-14) + 14\,a(n-15) + 86\,a(n-16) + 39\,a(n-17) - 34\,a(n-18) - 19\,a(n-19) + 6\,a(n-21)$ holds for every $n > 23$, and fails at $n = 23$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 2$, that is at $n = 23$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 287, 981, 2920, 9039, 28681, 89623,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208165}{A208165}, revision 9, last modified Oct 03 2025.
