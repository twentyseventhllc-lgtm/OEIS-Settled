...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208779}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208779}{A208779} as

\begin{quote}\itshape Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + a(n-2) for n>4.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 42*x*(1 + 41*x - 37*x\textasciicircum{}2 - 38*x\textasciicircum{}3) / (1 - x - x\textasciicircum{}2). - Colin Barker, Jul 06 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{42x + 1722x^{2} - 1554x^{3} - 1596x^{4}}{1 - x - x^{2}}.\]
...
\begin{theorem} For A208779, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n > 4$, and fails at $n = 4$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,42$. The last nonvanishing one is at $m = 2$, that is at $n = 4$. After it, more than $S = 4$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 4$. The theorem is at least as strong.

\begin{theorem} For A208779, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{42x + 1722x^{2} - 1554x^{3} - 1596x^{4}}{1 - x - x^{2}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 42, 1764, 252, 420, 672, 1092, 1764, 2856,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208779}{A208779}, revision 8, last modified Jul 06 2018.
