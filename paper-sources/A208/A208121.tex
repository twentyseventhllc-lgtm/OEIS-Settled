...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208121}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208121}{A208121} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) - 21*a(n-2) + 84*a(n-3) - 756*a(n-5) + 1701*a(n-6) - 5103*a(n-7) + 6561*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(16 + 144*x - 672*x\textasciicircum{}2 + 945*x\textasciicircum{}3 - 4158*x\textasciicircum{}4 + 3159*x\textasciicircum{}5 + 1458*x\textasciicircum{}6 + 6561*x\textasciicircum{}7) / ((1 - 3*x)*(1 + 3*x)*(1 - 7*x + 9*x\textasciicircum{}2)*(1 + 21*x\textasciicircum{}2 + 81*x\textasciicircum{}4)). - Colin Barker, Jun 28 2018\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) - 21\,a(n-2) + 84\,a(n-3) - 756\,a(n-5) + 1701\,a(n-6) - 5103\,a(n-7) + \\ 6561\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{16x + 144x^{2} - 672x^{3} + 945x^{4} - 4158x^{5} + 3159x^{6} + 1458x^{7} + 6561x^{8}}{1 - 7x + 21x^{2} - 84x^{3} + 756x^{5} - 1701x^{6} + 5103x^{7} - 6561x^{8}}.\]
...
\begin{theorem} For A208121, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 84\,a(n-3) - 756\,a(n-5) + 1701\,a(n-6) - 5103\,a(n-7) + 6561\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,43$. Every one of them vanished. After it, more than $S = 9$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A208121, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{16x + 144x^{2} - 672x^{3} + 945x^{4} - 4158x^{5} + 3159x^{6} + 1458x^{7} + 6561x^{8}}{1 - 7x + 21x^{2} - 84x^{3} + 756x^{5} - 1701x^{6} + 5103x^{7} - 6561x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 784, 2401, 17689, 130321, 577600, 2560000,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208121}{A208121}, revision 8, last modified Jun 28 2018.
