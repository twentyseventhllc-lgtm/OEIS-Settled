...
\title{A proof of the conjectured linear recurrence for OEIS A208498}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208498}{A208498} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) +16*a(n-3) +2*a(n-4) +2*a(n-5) -107*a(n-6) +10*a(n-7) -75*a(n-8) +416*a(n-9) -102*a(n-10) +335*a(n-11) -965*a(n-12) +313*a(n-13) -613*a(n-14) +1499*a(n-15) -398*a(n-16) +552*a(n-17) -1629*a(n-18) +183*a(n-19) -217*a(n-20) +1234*a(n-21) +93*a(n-22) -46*a(n-23) -623*a(n-24) -161*a(n-25) +86*a(n-26) +235*a(n-27) +71*a(n-28) -35*a(n-29) -72*a(n-30) -8*a(n-31) +6*a(n-32) +13*a(n-33) -a(n-34) -a(n-36) for n>38\end{quote}
...
\begin{multline*} a(n) = a(n-2) + 16\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 107\,a(n-6) + 10\,a(n-7) - \\ 75\,a(n-8) + 416\,a(n-9) - 102\,a(n-10) + 335\,a(n-11) - 965\,a(n-12) + 313\,a(n-13) - \\ 613\,a(n-14) + 1499\,a(n-15) - 398\,a(n-16) + 552\,a(n-17) - 1629\,a(n-18) + 183\,a(n-19) - \\ 217\,a(n-20) + 1234\,a(n-21) + 93\,a(n-22) - 46\,a(n-23) - 623\,a(n-24) - 161\,a(n-25) + \\ 86\,a(n-26) + 235\,a(n-27) + 71\,a(n-28) - 35\,a(n-29) - 72\,a(n-30) - 8\,a(n-31) + \\ 6\,a(n-32) + 13\,a(n-33) - a(n-34) - a(n-36). \end{multline*}
...
That refinement leaves $47$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 39$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A208498, the recurrence of order $36$ displayed in Section 1 holds for every $n > 38$, and fails at $n = 38$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,107$. The last nonvanishing one is at $m = 2$, that is at $n = 38$. After it, more than $S = 39$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 324, 828, 1794, 4104, 9912, 21976,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208498}{A208498}, revision 9, last modified Oct 03 2025.
