...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208383}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208383}{A208383} as

\begin{quote}\itshape Number of 7 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 4*a(n-2) + 21*a(n-3) + 14*a(n-4) - 5*a(n-5) + 25*a(n-6) for n>8.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(7 + 91*x - 18*x\textasciicircum{}2 - 47*x\textasciicircum{}3 - 980*x\textasciicircum{}4 - 725*x\textasciicircum{}5 + 375*x\textasciicircum{}6 - 1250*x\textasciicircum{}7) / (1 - x - 4*x\textasciicircum{}2 - 21*x\textasciicircum{}3 - 14*x\textasciicircum{}4 + 5*x\textasciicircum{}5 - 25*x\textasciicircum{}6). - Colin Barker, Jul 02 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{14x + 182x^{2} - 36x^{3} - 94x^{4} - 1960x^{5} - 1450x^{6} + 750x^{7} - 2500x^{8}}{1 - x - 4x^{2} - 21x^{3} - 14x^{4} + 5x^{5} - 25x^{6}}.\]
...
\begin{theorem} For A208383, the recurrence $a(n) = a(n-1) + 4\,a(n-2) + 21\,a(n-3) + 14\,a(n-4) - 5\,a(n-5) + 25\,a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,42$. The last nonvanishing one is at $m = 2$, that is at $n = 8$. After it, more than $S = 8$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 8$. The theorem is at least as strong.

\begin{theorem} For A208383, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{14x + 182x^{2} - 36x^{3} - 94x^{4} - 1960x^{5} - 1450x^{6} + 750x^{7} - 2500x^{8}}{1 - x - 4x^{2} - 21x^{3} - 14x^{4} + 5x^{5} - 25x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 216, 1200, 4416, 14976, 60984, 231744,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208383}{A208383}, revision 8, last modified Jul 02 2018.
