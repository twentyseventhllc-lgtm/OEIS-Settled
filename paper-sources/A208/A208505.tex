...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208505}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208505}{A208505} as

\begin{quote}\itshape Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 8*a(n-2) - 10*a(n-3) - 8*a(n-4) + 8*a(n-5) for n>7.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 28*x*(1 + 26*x - 32*x\textasciicircum{}2 - 170*x\textasciicircum{}3 + 170*x\textasciicircum{}4 + 160*x\textasciicircum{}5 - 136*x\textasciicircum{}6) / (1 - 2*x - 8*x\textasciicircum{}2 + 10*x\textasciicircum{}3 + 8*x\textasciicircum{}4 - 8*x\textasciicircum{}5). - Colin Barker, Jul 03 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 27 2012).

The line quoted ending in that signature is contributed by Colin Barker on Jul 03 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Jul 03 2018, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{28x + 728x^{2} - 896x^{3} - 4760x^{4} + 4760x^{5} + 4480x^{6} - 3808x^{7}}{1 - 2x - 8x^{2} + 10x^{3} + 8x^{4} - 8x^{5}}.\]
...
\begin{theorem} For A208505, the recurrence $a(n) = 2\,a(n-1) + 8\,a(n-2) - 10\,a(n-3) - 8\,a(n-4) + 8\,a(n-5)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,41$. The last nonvanishing one is at $m = 2$, that is at $n = 7$. After it, more than $S = 8$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 7$. The theorem is at least as strong.

\begin{theorem} For A208505, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{28x + 728x^{2} - 896x^{3} - 4760x^{4} + 4760x^{5} + 4480x^{6} - 3808x^{7}}{1 - 2x - 8x^{2} + 10x^{3} + 8x^{4} - 8x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 28, 784, 896, 3024, 9912, 33488, 111328, 374416,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208505}{A208505}, revision 8, last modified Jul 03 2018.
