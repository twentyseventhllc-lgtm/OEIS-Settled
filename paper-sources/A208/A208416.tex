...
\title{A proof of the conjectured linear recurrence for OEIS A208416}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208416}{A208416} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -10*a(n-3) -15*a(n-4) +40*a(n-5) +19*a(n-6) -25*a(n-7) -60*a(n-8) +32*a(n-9) -10*a(n-10) +29*a(n-11) +28*a(n-12) +43*a(n-13) -83*a(n-14) -24*a(n-15) +4*a(n-16) +30*a(n-17) -13*a(n-18) +20*a(n-19) +a(n-20) -3*a(n-21) -8*a(n-22) +4*a(n-23) -2*a(n-24) -a(n-25) +a(n-27).\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 10\,a(n-3) - 15\,a(n-4) + 40\,a(n-5) + 19\,a(n-6) - 25\,a(n-7) - \\ 60\,a(n-8) + 32\,a(n-9) - 10\,a(n-10) + 29\,a(n-11) + 28\,a(n-12) + 43\,a(n-13) - \\ 83\,a(n-14) - 24\,a(n-15) + 4\,a(n-16) + 30\,a(n-17) - 13\,a(n-18) + 20\,a(n-19) + \\ a(n-20) - 3\,a(n-21) - 8\,a(n-22) + 4\,a(n-23) - 2\,a(n-24) - a(n-25) + \\ a(n-27). \end{multline*}
...
That refinement leaves $64$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 58$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A208416, the recurrence of order $27$ displayed in Section 1 holds for every $n \ge 28$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,116$. Every one of them vanished. After it, more than $S = 58$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 378, 1269, 3835, 10098, 26375, 65178,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208416}{A208416}, revision 7, last modified Jun 09 2023.
