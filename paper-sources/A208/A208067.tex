...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208067}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208067}{A208067} as

\begin{quote}\itshape Number of n X 6 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: 2*x*(13 + 312*x + 338*x\textasciicircum{}2 + 522*x\textasciicircum{}3 + 28*x\textasciicircum{}4 - 76*x\textasciicircum{}5 + 26*x\textasciicircum{}6 + 26*x\textasciicircum{}7 - 13*x\textasciicircum{}8) / ((1 - x)\textasciicircum{}5*(1 + x)\textasciicircum{}3). - Colin Barker, Jun 27 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{26x + 624x^{2} + 676x^{3} + 1044x^{4} + 56x^{5} - 152x^{6} + 52x^{7} + 52x^{8} - 26x^{9}}{1 - 2x - 2x^{2} + 6x^{3} - 6x^{5} + 2x^{6} + 2x^{7} - x^{8}}.\]
...
For scale: at $n = 8$ there are $2^{48}$ arrays, about $10^{14}$, against $41$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A208067, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-2) - 6\,a(n-3) + 6\,a(n-5) - 2\,a(n-6) - 2\,a(n-7) + a(n-8)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,84$. The last nonvanishing one is at $m = 1$, that is at $n = 9$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 9$. The theorem is at least as strong.

\begin{theorem} For A208067, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{26x + 624x^{2} + 676x^{3} + 1044x^{4} + 56x^{5} - 152x^{6} + 52x^{7} + 52x^{8} - 26x^{9}}{1 - 2x - 2x^{2} + 6x^{3} - 6x^{5} + 2x^{6} + 2x^{7} - x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 26, 676, 2080, 6400, 12960, 26244, 44064, 73984,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208067}{A208067}, revision 8, last modified Jun 27 2018.
