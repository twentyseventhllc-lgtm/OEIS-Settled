...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208009}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208009}{A208009} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(9 + 63*x + 63*x\textasciicircum{}2 + 85*x\textasciicircum{}3 + 72*x\textasciicircum{}4 + 74*x\textasciicircum{}5 - 12*x\textasciicircum{}6 - 6*x\textasciicircum{}7 + 15*x\textasciicircum{}8 - x\textasciicircum{}9 - 3*x\textasciicircum{}10 + x\textasciicircum{}11) / ((1 - x)\textasciicircum{}7*(1 + x)\textasciicircum{}5). - Colin Barker, Jun 26 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 63x^{2} + 63x^{3} + 85x^{4} + 72x^{5} + 74x^{6} - 12x^{7} - 6x^{8} + 15x^{9} - x^{10} - 3x^{11} + x^{12}}{1 - 2x - 4x^{2} + 10x^{3} + 5x^{4} - 20x^{5} + 20x^{7} - 5x^{8} - 10x^{9} + 4x^{10} + 2x^{11} - x^{12}}.\]
...
\begin{theorem} For A208009, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) - 10\,a(n-3) - 5\,a(n-4) + 20\,a(n-5) - 20\,a(n-7) + 5\,a(n-8) + 10\,a(n-9) - 4\,a(n-10) - 2\,a(n-11) + a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,73$. Every one of them vanished. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A208009, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 63x^{2} + 63x^{3} + 85x^{4} + 72x^{5} + 74x^{6} - 12x^{7} - 6x^{8} + 15x^{9} - x^{10} - 3x^{11} + x^{12}}{1 - 2x - 4x^{2} + 10x^{3} + 5x^{4} - 20x^{5} + 20x^{7} - 5x^{8} - 10x^{9} + 4x^{10} + 2x^{11} - x^{12}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 261, 841, 1943, 4489, 8643, 16641,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208009}{A208009}, revision 8, last modified Jun 26 2018.
