...
\title{A proof of the conjectured linear recurrence for OEIS A208082}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208082}{A208082} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) +240*a(n-2) +212*a(n-3) -6470*a(n-4) -2816*a(n-5) +58646*a(n-6) +3528*a(n-7) -215345*a(n-8) +36778*a(n-9) +305644*a(n-10) -78492*a(n-11) -174713*a(n-12) +38956*a(n-13) +42650*a(n-14) -5016*a(n-15) -4246*a(n-16) +194*a(n-17) +156*a(n-18) -a(n-20)\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) + 240\,a(n-2) + 212\,a(n-3) - 6470\,a(n-4) - 2816\,a(n-5) + 58646\,a(n-6) + \\ 3528\,a(n-7) - 215345\,a(n-8) + 36778\,a(n-9) + 305644\,a(n-10) - 78492\,a(n-11) - 174713\,a(n-12) + \\ 38956\,a(n-13) + 42650\,a(n-14) - 5016\,a(n-15) - 4246\,a(n-16) + 194\,a(n-17) + 156\,a(n-18) - \\ a(n-20). \end{multline*}
...
\begin{theorem} For A208082, the recurrence of order $20$ displayed in Section 1 holds for every $n \ge 21$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 40, 1600, 27880, 572040, 11204720, 223058440, 4412968520, 87523832240,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208082}{A208082}, revision 9, last modified Oct 03 2025.
