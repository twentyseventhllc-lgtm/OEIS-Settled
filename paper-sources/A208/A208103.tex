...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208103}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208103}{A208103} as

\begin{quote}\itshape Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(6 + 12*x - 54*x\textasciicircum{}2 - 33*x\textasciicircum{}3 + 70*x\textasciicircum{}4 + 20*x\textasciicircum{}5 - 15*x\textasciicircum{}6) / ((1 - x)*(1 + x)*(1 - 3*x + x\textasciicircum{}2)*(1 - x - x\textasciicircum{}2)). - Colin Barker, Mar 06 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 12x^{2} - 54x^{3} - 33x^{4} + 70x^{5} + 20x^{6} - 15x^{7}}{1 - 4x + 2x^{2} + 6x^{3} - 4x^{4} - 2x^{5} + x^{6}}.\]
...
\begin{theorem} For A208103, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) - 6\,a(n-3) + 4\,a(n-4) + 2\,a(n-5) - a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,46$. The last nonvanishing one is at $m = 1$, that is at $n = 7$. After it, more than $S = 8$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 7$. The theorem is at least as strong.

\begin{theorem} For A208103, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 12x^{2} - 54x^{3} - 33x^{4} + 70x^{5} + 20x^{6} - 15x^{7}}{1 - 4x + 2x^{2} + 6x^{3} - 4x^{4} - 2x^{5} + x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 78, 171, 406, 990, 2485, 6328,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208103}{A208103}, revision 8, last modified Mar 06 2018.
