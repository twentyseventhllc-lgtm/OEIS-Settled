...
\title{A proof of the conjectured linear recurrence for OEIS A208424}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208424}{A208424} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 52*a(n-2) +80*a(n-3) -477*a(n-4) -656*a(n-5) +1489*a(n-6) +1910*a(n-7) -1775*a(n-8) -2192*a(n-9) +812*a(n-10) +984*a(n-11) -120*a(n-12) -144*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 52\,a(n-2) + 80\,a(n-3) - 477\,a(n-4) - 656\,a(n-5) + 1489\,a(n-6) + 1910\,a(n-7) - \\ 1775\,a(n-8) - 2192\,a(n-9) + 812\,a(n-10) + 984\,a(n-11) - 120\,a(n-12) - 144\,a(n-13). \end{multline*}
...
\begin{theorem} For A208424, the recurrence $a(n) = 52\,a(n-2) + 80\,a(n-3) - 477\,a(n-4) - 656\,a(n-5) + 1489\,a(n-6) + 1910\,a(n-7) - 1775\,a(n-8) - 2192\,a(n-9) + 812\,a(n-10) + 984\,a(n-11) - 120\,a(n-12) - 144\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 25, 625, 2625, 26375, 161975, 1297475, 8948825, 67061525,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208424}{A208424}, revision 9, last modified Oct 03 2025.
