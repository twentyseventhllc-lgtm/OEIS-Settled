...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A208141}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208141}{A208141} as

\begin{quote}\itshape Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (5/36)*n\textasciicircum{}7 + (5/4)*n\textasciicircum{}6 + (155/36)*n\textasciicircum{}5 + (85/12)*n\textasciicircum{}4 + (50/9)*n\textasciicircum{}3 + (5/3)*n\textasciicircum{}2.\end{quote}

\begin{quote}\ttfamily G.f.: 20*x*(1 + 12*x + 18*x\textasciicircum{}2 + 4*x\textasciicircum{}3) / (1 - x)\textasciicircum{}8.\end{quote}
...
\[a(n) = \frac{5}{3}n^{2} + \frac{50}{9}n^{3} + \frac{85}{12}n^{4} + \frac{155}{36}n^{5} + \frac{5}{4}n^{6} + \frac{5}{36}n^{7}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{20x + 240x^{2} + 360x^{3} + 80x^{4}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}.\]
...
\begin{theorem} For A208141, $a(n)$ is the polynomial $\frac{5}{3}n^{2} + \frac{50}{9}n^{3} + \frac{85}{12}n^{4} + \frac{155}{36}n^{5} + \frac{5}{4}n^{6} + \frac{5}{36}n^{7}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A208141, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{20x + 240x^{2} + 360x^{3} + 80x^{4}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}$.\end{theorem}
...
\begin{theorem} For A208141, the recurrence $a(n) = 8\,a(n-1) - 28\,a(n-2) + 56\,a(n-3) - 70\,a(n-4) + 56\,a(n-5) - 28\,a(n-6) + 8\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 3000, 14000, 49000, 141120, 352800, 792000,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208141}{A208141}, revision 8, last modified Jun 28 2018.
