...
\title{A proof of the conjectured linear recurrence for OEIS A259767}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259767}{A259767} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-3) +3*a(n-6) +4*a(n-7) -2*a(n-9) +2*a(n-11) -8*a(n-13) +6*a(n-14) for n>17\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-3) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-9) + 2\,a(n-11) - 8\,a(n-13) + \\ 6\,a(n-14). \end{multline*}
...
\begin{theorem} For A259767, the recurrence $a(n) = 3\,a(n-3) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-9) + 2\,a(n-11) - 8\,a(n-13) + 6\,a(n-14)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,78$. The last nonvanishing one is at $m = 3$, that is at $n = 17$. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 104, 167, 256, 385, 612, 1108, 1708, 2700,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259767}{A259767}, revision 6, last modified Jun 02 2025.
