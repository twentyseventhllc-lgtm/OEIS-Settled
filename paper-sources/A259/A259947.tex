...
\title{A proof of the conjectured linear recurrence for OEIS A259947}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259947}{A259947} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +2*a(n-2) +12*a(n-3) +27*a(n-4) -31*a(n-5) -10*a(n-6) -62*a(n-7) -30*a(n-8) +42*a(n-9) +13*a(n-10) +47*a(n-11) -3*a(n-12) -14*a(n-13) -4*a(n-15) +2*a(n-16) for n>17\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 27\,a(n-4) - 31\,a(n-5) - 10\,a(n-6) - \\ 62\,a(n-7) - 30\,a(n-8) + 42\,a(n-9) + 13\,a(n-10) + 47\,a(n-11) - 3\,a(n-12) - \\ 14\,a(n-13) - 4\,a(n-15) + 2\,a(n-16). \end{multline*}
...
\begin{theorem} For A259947, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 27\,a(n-4) - 31\,a(n-5) - 10\,a(n-6) - 62\,a(n-7) - 30\,a(n-8) + 42\,a(n-9) + 13\,a(n-10) + 47\,a(n-11) - 3\,a(n-12) - 14\,a(n-13) - 4\,a(n-15) + 2\,a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,67$. The last nonvanishing one is at $m = 1$, that is at $n = 17$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 156, 549, 2438, 8699, 30351, 115410, 438353, 1615572,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259947}{A259947}, revision 6, last modified Jun 02 2025.
