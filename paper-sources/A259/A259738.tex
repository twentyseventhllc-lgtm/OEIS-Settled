...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A259738}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259738}{A259738} as

\begin{quote}\itshape Number of (n+2) X (4+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 or 01010101\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 4*a(n-3) + 5*a(n-4) + 3*a(n-5) + 5*a(n-6) + a(n-7) - 4*a(n-8) - a(n-9) + a(n-10) for n>11.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(31 + 37*x + 119*x\textasciicircum{}2 + 123*x\textasciicircum{}3 + 80*x\textasciicircum{}4 + 106*x\textasciicircum{}5 + 27*x\textasciicircum{}6 - 76*x\textasciicircum{}7 - 30*x\textasciicircum{}8 + 16*x\textasciicircum{}9 + 3*x\textasciicircum{}10) / (1 - x - 4*x\textasciicircum{}3 - 5*x\textasciicircum{}4 - 3*x\textasciicircum{}5 - 5*x\textasciicircum{}6 - x\textasciicircum{}7 + 4*x\textasciicircum{}8 + x\textasciicircum{}9 - x\textasciicircum{}10). - Colin Barker, Dec 26 2018\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 4\,a(n-3) + 5\,a(n-4) + 3\,a(n-5) + 5\,a(n-6) + a(n-7) - \\ 4\,a(n-8) - a(n-9) + a(n-10). \end{multline*}

stated for $n > 11$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{62x + 74x^{2} + 238x^{3} + 246x^{4} + 160x^{5} + 212x^{6} + 54x^{7} - 152x^{8} - 60x^{9} + 32x^{10} + 6x^{11}}{1 - x - 4x^{3} - 5x^{4} - 3x^{5} - 5x^{6} - x^{7} + 4x^{8} + x^{9} - x^{10}}.\]
...
For scale: at $n = 8$ there are $2^{48}$ arrays, about $10^{14}$, against $14$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A259738, the recurrence $a(n) = a(n-1) + 4\,a(n-3) + 5\,a(n-4) + 3\,a(n-5) + 5\,a(n-6) + a(n-7) - 4\,a(n-8) - a(n-9) + a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. The last nonvanishing one is at $m = 1$, that is at $n = 11$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 11$. The theorem is at least as strong.

\begin{theorem} For A259738, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{62x + 74x^{2} + 238x^{3} + 246x^{4} + 160x^{5} + 212x^{6} + 54x^{7} - 152x^{8} - 60x^{9} + 32x^{10} + 6x^{11}}{1 - x - 4x^{3} - 5x^{4} - 3x^{5} - 5x^{6} - x^{7} + 4x^{8} + x^{9} - x^{10}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 62, 136, 374, 868, 1882, 4456, 10570, 24150,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259738}{A259738}, revision 8, last modified Dec 26 2018.
