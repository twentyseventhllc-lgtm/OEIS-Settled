...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A259765}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259765}{A259765} as

\begin{quote}\itshape Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 or 00000101\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) + 2*a(n-3) + 6*a(n-4) + 2*a(n-5) - a(n-6) + 2*a(n-7) - a(n-8) for n>9.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(32 + 49*x + 72*x\textasciicircum{}2 + 88*x\textasciicircum{}3 - 18*x\textasciicircum{}4 - 22*x\textasciicircum{}5 + 26*x\textasciicircum{}6 - 29*x\textasciicircum{}7 + 6*x\textasciicircum{}8) / (1 - x\textasciicircum{}2 - 2*x\textasciicircum{}3 - 6*x\textasciicircum{}4 - 2*x\textasciicircum{}5 + x\textasciicircum{}6 - 2*x\textasciicircum{}7 + x\textasciicircum{}8). - Colin Barker, Dec 26 2018\end{quote}
...
\begin{multline*} a(n) = a(n-2) + 2\,a(n-3) + 6\,a(n-4) + 2\,a(n-5) - a(n-6) + 2\,a(n-7) - \\ a(n-8). \end{multline*}

stated for $n > 9$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{32x + 49x^{2} + 72x^{3} + 88x^{4} - 18x^{5} - 22x^{6} + 26x^{7} - 29x^{8} + 6x^{9}}{1 - x^{2} - 2x^{3} - 6x^{4} - 2x^{5} + x^{6} - 2x^{7} + x^{8}}.\]
...
\begin{theorem} For A259765, the recurrence $a(n) = a(n-2) + 2\,a(n-3) + 6\,a(n-4) + 2\,a(n-5) - a(n-6) + 2\,a(n-7) - a(n-8)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. The last nonvanishing one is at $m = 1$, that is at $n = 9$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 9$. The theorem is at least as strong.

\begin{theorem} For A259765, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{32x + 49x^{2} + 72x^{3} + 88x^{4} - 18x^{5} - 22x^{6} + 26x^{7} - 29x^{8} + 6x^{9}}{1 - x^{2} - 2x^{3} - 6x^{4} - 2x^{5} + x^{6} - 2x^{7} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 49, 104, 201, 376, 745, 1494, 2897,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259765}{A259765}, revision 11, last modified Dec 26 2018.
