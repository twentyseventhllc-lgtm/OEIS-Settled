...
\title{A proof of the conjectured linear recurrence for OEIS A303684}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303684}{A303684} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 2, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A303684, the recurrence $a(n) = 3\,a(n-1) + a(n-2) + 2\,a(n-3) - 2\,a(n-4) - 4\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 3, 5, 18, 61, 209, 702, 2381,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303684}{A303684}, revision 4, last modified Apr 28 2018.
