...
\title{A proof of the conjectured linear recurrence for OEIS A297297}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297297}{A297297} as

\begin{quote}\itshape Number of nX6 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 2 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -8*a(n-3) -2*a(n-4) +4*a(n-5) +4*a(n-6) +a(n-7) -a(n-8)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 8\,a(n-3) - 2\,a(n-4) + 4\,a(n-5) + 4\,a(n-6) + a(n-7) - \\ a(n-8). \end{multline*}
...
The construction gives $4160$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $133$; neither removal changes any count.
...
\begin{theorem} For A297297, the recurrence $a(n) = 4\,a(n-1) - 8\,a(n-3) - 2\,a(n-4) + 4\,a(n-5) + 4\,a(n-6) + a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 6, 17, 50, 157, 495, 1574, 5031,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297297}{A297297}, revision 4, last modified Dec 27 2017.
