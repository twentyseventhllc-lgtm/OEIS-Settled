...
\title{A proof of the conjectured linear recurrence for OEIS A296015}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296015}{A296015} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with each 1 adjacent to 1 or 4 king-move neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 6*a(n-2) + 36*a(n-3) + 8*a(n-4) - 71*a(n-5) - 345*a(n-6) - 221*a(n-7) + 167*a(n-8) + 1167*a(n-9) + 930*a(n-10) + 200*a(n-11) - 1607*a(n-12) - 1327*a(n-13) - 670*a(n-14) + 1036*a(n-15) + 741*a(n-16) + 514*a(n-17) - 306*a(n-18) - 128*a(n-19) - 114*a(n-20) + 40*a(n-21).\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 6\,a(n-2) + 36\,a(n-3) + 8\,a(n-4) - 71\,a(n-5) - 345\,a(n-6) - \\ 221\,a(n-7) + 167\,a(n-8) + 1167\,a(n-9) + 930\,a(n-10) + 200\,a(n-11) - 1607\,a(n-12) - \\ 1327\,a(n-13) - 670\,a(n-14) + 1036\,a(n-15) + 741\,a(n-16) + 514\,a(n-17) - 306\,a(n-18) - \\ 128\,a(n-19) - 114\,a(n-20) + 40\,a(n-21). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $146$; neither removal changes any count.
...
That refinement leaves $24$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 23$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A296015, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,72$. Every one of them vanished. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 28, 91, 366, 1644, 6545, 26865, 112345,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296015}{A296015}, revision 9, last modified Dec 04 2017.
