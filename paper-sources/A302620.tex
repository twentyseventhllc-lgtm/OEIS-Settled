...
\title{A proof of the conjectured linear recurrence for OEIS A302620}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302620}{A302620} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +6*a(n-3) -12*a(n-4) -6*a(n-5) -7*a(n-6) -4*a(n-7) +20*a(n-9) +30*a(n-10) +4*a(n-11) -19*a(n-12) -36*a(n-13) +4*a(n-14) +16*a(n-15) for n>20\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 12\,a(n-4) - 6\,a(n-5) - 7\,a(n-6) - \\ 4\,a(n-7) + 20\,a(n-9) + 30\,a(n-10) + 4\,a(n-11) - 19\,a(n-12) - 36\,a(n-13) + \\ 4\,a(n-14) + 16\,a(n-15). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $178$; neither removal changes any count.
...
That refinement leaves $32$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 25$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A302620, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 12\,a(n-4) - 6\,a(n-5) - 7\,a(n-6) - 4\,a(n-7) + 20\,a(n-9) + 30\,a(n-10) + 4\,a(n-11) - 19\,a(n-12) - 36\,a(n-13) + 4\,a(n-14) + 16\,a(n-15)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,71$. The last nonvanishing one is at $m = 5$, that is at $n = 20$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 78, 79, 251, 896, 2669, 8283, 25770,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302620}{A302620}, revision 4, last modified Apr 10 2018.
