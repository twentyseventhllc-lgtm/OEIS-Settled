...
\title{A proof of the conjectured linear recurrence for OEIS A304592}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304592}{A304592} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +9*a(n-2) +13*a(n-3) -38*a(n-4) -46*a(n-5) +28*a(n-6) -45*a(n-7) -54*a(n-8) -34*a(n-9) +8*a(n-10) +26*a(n-11) -37*a(n-12) -7*a(n-13) -3*a(n-14) +2*a(n-15) for n>16\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 9\,a(n-2) + 13\,a(n-3) - 38\,a(n-4) - 46\,a(n-5) + 28\,a(n-6) - \\ 45\,a(n-7) - 54\,a(n-8) - 34\,a(n-9) + 8\,a(n-10) + 26\,a(n-11) - 37\,a(n-12) - \\ 7\,a(n-13) - 3\,a(n-14) + 2\,a(n-15). \end{multline*}
...
\begin{theorem} For A304592, the recurrence $a(n) = 3\,a(n-1) + 9\,a(n-2) + 13\,a(n-3) - 38\,a(n-4) - 46\,a(n-5) + 28\,a(n-6) - 45\,a(n-7) - 54\,a(n-8) - 34\,a(n-9) + 8\,a(n-10) + 26\,a(n-11) - 37\,a(n-12) - 7\,a(n-13) - 3\,a(n-14) + 2\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,61$. The last nonvanishing one is at $m = 1$, that is at $n = 16$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 23, 82, 456, 2207, 10949, 54357, 269732,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304592}{A304592}, revision 4, last modified May 15 2018.
