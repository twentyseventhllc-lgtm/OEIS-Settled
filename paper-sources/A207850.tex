...
\title{A proof of the conjectured linear recurrence for OEIS A207850}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207850}{A207850} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +40*a(n-2) -50*a(n-3) -511*a(n-4) +376*a(n-5) +2736*a(n-6) -1247*a(n-7) -7118*a(n-8) +2183*a(n-9) +9712*a(n-10) -2183*a(n-11) -7118*a(n-12) +1247*a(n-13) +2736*a(n-14) -376*a(n-15) -511*a(n-16) +50*a(n-17) +40*a(n-18) -2*a(n-19) -a(n-20) for n>21\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 40\,a(n-2) - 50\,a(n-3) - 511\,a(n-4) + 376\,a(n-5) + 2736\,a(n-6) - \\ 1247\,a(n-7) - 7118\,a(n-8) + 2183\,a(n-9) + 9712\,a(n-10) - 2183\,a(n-11) - 7118\,a(n-12) + \\ 1247\,a(n-13) + 2736\,a(n-14) - 376\,a(n-15) - 511\,a(n-16) + 50\,a(n-17) + 40\,a(n-18) - \\ 2\,a(n-19) - a(n-20). \end{multline*}
...
\begin{theorem} For A207850, the recurrence of order $20$ displayed in Section 1 holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,70$. The last nonvanishing one is at $m = 1$, that is at $n = 21$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 42, 1764, 6216, 35952, 185136, 1006572, 5346600, 28935984,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207850}{A207850}, revision 9, last modified Oct 03 2025.
