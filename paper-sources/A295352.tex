...
\title{Proofs of the conjectured column and row recurrences for OEIS A295352}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295352}{A295352} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 2 or 3 1s\end{quote}
...
k=1: a(n) = a(n-1) +a(n-2)\\k=2: a(n) = 4*a(n-1) -3*a(n-2) -4*a(n-4) -a(n-5) +a(n-6)\\k=3: [order 18]\\k=4: [order 45]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Nov 20 2017). As of revision 4, last modified Nov 20 2017, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A295352, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A295352, the recurrence $a(n) = 4\,a(n-1) - 3\,a(n-2) - 4\,a(n-4) - a(n-5) + a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A295352, the recurrence $a(n) = 0$ holds for every $n \ge 19$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A295352, the recurrence $a(n) = 0$ holds for every $n \ge 46$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295352}{A295352}, revision 4, last modified Nov 20 2017.
