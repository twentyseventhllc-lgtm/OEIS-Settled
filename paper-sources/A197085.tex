...
\title{A proof of the conjectured linear recurrence for OEIS A197085}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197085}{A197085} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,3,2,0,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +3*a(n-2) +10*a(n-3) -3*a(n-4) +2*a(n-5) +11*a(n-6) -15*a(n-7) -15*a(n-8) -2*a(n-9) +a(n-10) -2*a(n-11) +4*a(n-12) +2*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 3\,a(n-2) + 10\,a(n-3) - 3\,a(n-4) + 2\,a(n-5) + 11\,a(n-6) - \\ 15\,a(n-7) - 15\,a(n-8) - 2\,a(n-9) + a(n-10) - 2\,a(n-11) + 4\,a(n-12) + \\ 2\,a(n-13). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 4, \tau(1) = 3, \tau(2) = 2, \tau(3) = 0, \tau(4) = 1. The condition is that for every cell,
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $70$; neither removal changes any count.
...
\begin{theorem} For A197085, the recurrence $a(n) = 3\,a(n-1) + 3\,a(n-2) + 10\,a(n-3) - 3\,a(n-4) + 2\,a(n-5) + 11\,a(n-6) - 15\,a(n-7) - 15\,a(n-8) - 2\,a(n-9) + a(n-10) - 2\,a(n-11) + 4\,a(n-12) + 2\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 5, 25, 96, 422, 1780, 7537, 31911,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197085}{A197085}, revision 9, last modified Oct 03 2025.
