...
\title{A proof of the conjectured linear recurrence for OEIS A223797}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223797}{A223797} as

\begin{quote}\itshape Number of nX4 0..3 arrays with rows and antidiagonals unimodal\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 130*a(n-1) -4151*a(n-2) +55367*a(n-3) -1103289*a(n-4) +25676564*a(n-5) -311713584*a(n-6) +2153547070*a(n-7) -14084700670*a(n-8) +111538734736*a(n-9) -678666743150*a(n-10) +3151156493032*a(n-11) -15705615808280*a(n-12) +74227237529348*a(n-13) -265525650225285*a(n-14) +858145104057893*a(n-15) -2835818034237058*a(n-16) +7784228337705693*a(n-17) -17375928755819704*a(n-18) +37062908059029592*a(n-19) -69764230981154356*a(n-20) +99762651233668576*a(n-21) -119132184363098064*a(n-22) +127177566453563712*a(n-23) -90807087696380928*a(n-24) +28396177139635200*a(n-25) -1473691515457536*a(n-26) +18962192793600*a(n-27)\end{quote}
...
\begin{multline*} a(n) = 130\,a(n-1) - 4151\,a(n-2) + 55367\,a(n-3) - 1103289\,a(n-4) + 25676564\,a(n-5) - 311713584\,a(n-6) + \\ 2153547070\,a(n-7) - 14084700670\,a(n-8) + 111538734736\,a(n-9) - 678666743150\,a(n-10) + 3151156493032\,a(n-11) - 15705615808280\,a(n-12) + \\ 74227237529348\,a(n-13) - 265525650225285\,a(n-14) + 858145104057893\,a(n-15) - 2835818034237058\,a(n-16) + 7784228337705693\,a(n-17) - 17375928755819704\,a(n-18) + \\ 37062908059029592\,a(n-19) - 69764230981154356\,a(n-20) + 99762651233668576\,a(n-21) - 119132184363098064\,a(n-22) + 127177566453563712\,a(n-23) - 90807087696380928\,a(n-24) + \\ 28396177139635200\,a(n-25) - 1473691515457536\,a(n-26) + 18962192793600\,a(n-27). \end{multline*}
...
\begin{theorem} For A223797, the recurrence of order $27$ displayed in Section 1 holds for every $n \ge 28$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,86$. Every one of them vanished. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 12 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 130, 16900, 1658703, 151310069, 13602542576, 1216562667529, 108631485025292, 9695922803812530,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223797}{A223797}, revision 8, last modified Oct 03 2025.
