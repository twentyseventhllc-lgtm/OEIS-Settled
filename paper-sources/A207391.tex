...
\title{Proofs of the conjectured column and row recurrences for OEIS A207391}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207391}{A207391} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}
...
k=1: a(n) = 2*n\\k=2: a(n) = 4*n\textasciicircum{}2\\k=3: a(n) = (4/3)*n\textasciicircum{}3 + 8*n\textasciicircum{}2 - (10/3)*n\\k=4: a(n) = (5/12)*n\textasciicircum{}4 + (13/2)*n\textasciicircum{}3 + (115/12)*n\textasciicircum{}2 - (17/2)*n + 1\\k=5: a(n) = (2/15)*n\textasciicircum{}5 + (55/12)*n\textasciicircum{}4 + (101/6)*n\textasciicircum{}3 + (5/12)*n\textasciicircum{}2 - (299/30)*n + 2\end{quote}
...
\begin{theorem} For column $k = 1$ of A207391, the recurrence $a(n) = 0$ holds for every $n \ge 1$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A207391, the recurrence $a(n) = 0$ holds for every $n \ge 1$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A207391, the recurrence $a(n) = 0$ holds for every $n \ge 1$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A207391, the recurrence $a(n) = 0$ holds for every $n \ge 1$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 5$ of A207391, the recurrence $a(n) = 0$ holds for every $n \ge 1$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The width is $5$; the digraph has $1056$ states, $210$ after trimming, and $S = 21$ blocks after refinement. The model reproduces every published value of column $k = 5$ --- and of the rest of the triangle. The residuals were computed exactly and all of them vanish; after that point more than $S = 21$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207391}{A207391}, revision 9, last modified Oct 03 2025.
