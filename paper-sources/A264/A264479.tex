...
\title{A proof of the conjectured order of the recurrence for OEIS A264479}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A264479}{A264479} as

\begin{quote}\itshape Number of (5+1)X(n+1) arrays of permutations of 0..n*6+5 with each element having directed index change 0,1 1,0 2,1 or -1,-1\end{quote}
...
\begin{theorem} For A264479, the least order of a linear recurrence that $a$ eventually satisfies is exactly $84$, and that recurrence holds for every $n > 84$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 16, 49, 456, 3540, 28489, 215607, 1711113,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A264479}{A264479}, revision 4, last modified Nov 14 2015.
