...
\title{A proof of the conjectured linear recurrence for OEIS A264315}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A264315}{A264315} as

\begin{quote}\itshape Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,1 1,0 -1,-2 or 0,2\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +10*a(n-2) +18*a(n-3) +72*a(n-4) +40*a(n-5) -152*a(n-6) -728*a(n-7) -400*a(n-8) +1008*a(n-9) +704*a(n-10) +192*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 10\,a(n-2) + 18\,a(n-3) + 72\,a(n-4) + 40\,a(n-5) - 152\,a(n-6) - \\ 728\,a(n-7) - 400\,a(n-8) + 1008\,a(n-9) + 704\,a(n-10) + 192\,a(n-11). \end{multline*}
...
\begin{theorem} For A264315, the recurrence $a(n) = 3\,a(n-1) + 10\,a(n-2) + 18\,a(n-3) + 72\,a(n-4) + 40\,a(n-5) - 152\,a(n-6) - 728\,a(n-7) - 400\,a(n-8) + 1008\,a(n-9) + 704\,a(n-10) + 192\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,75$. Every one of them vanished. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 20, 139, 735, 4103, 24153, 137703, 781453,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A264315}{A264315}, revision 4, last modified Nov 11 2015.
