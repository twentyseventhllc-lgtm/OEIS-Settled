...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208381}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208381}{A208381} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 4*a(n-2) + 13*a(n-3) + 8*a(n-4) - 3*a(n-5) + 9*a(n-6) for n>8.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(5 + 45*x + 2*x\textasciicircum{}2 - 17*x\textasciicircum{}3 - 210*x\textasciicircum{}4 - 153*x\textasciicircum{}5 + 81*x\textasciicircum{}6 - 162*x\textasciicircum{}7) / (1 - x - 4*x\textasciicircum{}2 - 13*x\textasciicircum{}3 - 8*x\textasciicircum{}4 + 3*x\textasciicircum{}5 - 9*x\textasciicircum{}6). - Colin Barker, Jul 02 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{10x + 90x^{2} + 4x^{3} - 34x^{4} - 420x^{5} - 306x^{6} + 162x^{7} - 324x^{8}}{1 - x - 4x^{2} - 13x^{3} - 8x^{4} + 3x^{5} - 9x^{6}}.\]
...
\begin{theorem} For A208381, the recurrence $a(n) = a(n-1) + 4\,a(n-2) + 13\,a(n-3) + 8\,a(n-4) - 3\,a(n-5) + 9\,a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}
...
\begin{theorem} For A208381, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{10x + 90x^{2} + 4x^{3} - 34x^{4} - 420x^{5} - 306x^{6} + 162x^{7} - 324x^{8}}{1 - x - 4x^{2} - 13x^{3} - 8x^{4} + 3x^{5} - 9x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 144, 640, 2176, 7072, 25200, 87040,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208381}{A208381}, revision 8, last modified Jul 02 2018.
