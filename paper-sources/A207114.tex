...
\title{A proof of the conjectured linear recurrence for OEIS A207114}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207114}{A207114} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +9*a(n-2) +2*a(n-3) -45*a(n-4) -38*a(n-5) +103*a(n-6) +166*a(n-7) -90*a(n-8) -319*a(n-9) -86*a(n-10) +254*a(n-11) +207*a(n-12) +52*a(n-13) +50*a(n-14) -151*a(n-15) -425*a(n-16) -170*a(n-17) +375*a(n-18) +403*a(n-19) -9*a(n-20) -227*a(n-21) -147*a(n-22) -27*a(n-23) +50*a(n-24) +79*a(n-25) +29*a(n-26) -28*a(n-27) -26*a(n-28) +2*a(n-29) +7*a(n-30) +a(n-31) -a(n-32)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 9\,a(n-2) + 2\,a(n-3) - 45\,a(n-4) - 38\,a(n-5) + 103\,a(n-6) + \\ 166\,a(n-7) - 90\,a(n-8) - 319\,a(n-9) - 86\,a(n-10) + 254\,a(n-11) + 207\,a(n-12) + \\ 52\,a(n-13) + 50\,a(n-14) - 151\,a(n-15) - 425\,a(n-16) - 170\,a(n-17) + 375\,a(n-18) + \\ 403\,a(n-19) - 9\,a(n-20) - 227\,a(n-21) - 147\,a(n-22) - 27\,a(n-23) + 50\,a(n-24) + \\ 79\,a(n-25) + 29\,a(n-26) - 28\,a(n-27) - 26\,a(n-28) + 2\,a(n-29) + 7\,a(n-30) + \\ a(n-31) - a(n-32). \end{multline*}
...
\begin{theorem} For A207114, the recurrence of order $32$ displayed in Section 1 holds for every $n \ge 33$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,97$. Every one of them vanished. After it, more than $S = 34$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 350, 1271, 4047, 10898, 30415, 77326,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207114}{A207114}, revision 9, last modified Oct 03 2025.
