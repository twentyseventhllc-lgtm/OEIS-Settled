...
\title{A proof of the conjectured linear recurrence for OEIS A224155}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224155}{A224155} as

\begin{quote}\itshape Number of nX5 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -9*a(n-2) -a(n-3) +a(n-4) +23*a(n-5) -38*a(n-6) +42*a(n-7) -41*a(n-8) +89*a(n-9) -67*a(n-10) -9*a(n-11) +5*a(n-12) -32*a(n-13) -50*a(n-14) -12*a(n-15) -58*a(n-16) -28*a(n-17) +12*a(n-18) +4*a(n-20) for n>22\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 9\,a(n-2) - a(n-3) + a(n-4) + 23\,a(n-5) - 38\,a(n-6) + \\ 42\,a(n-7) - 41\,a(n-8) + 89\,a(n-9) - 67\,a(n-10) - 9\,a(n-11) + 5\,a(n-12) - \\ 32\,a(n-13) - 50\,a(n-14) - 12\,a(n-15) - 58\,a(n-16) - 28\,a(n-17) + 12\,a(n-18) + \\ 4\,a(n-20). \end{multline*}
...
\begin{theorem} For A224155, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2) - a(n-3) + a(n-4) + 23\,a(n-5) - 38\,a(n-6) + 42\,a(n-7) - 41\,a(n-8) + 89\,a(n-9) - 67\,a(n-10) - 9\,a(n-11) + 5\,a(n-12) - 32\,a(n-13) - 50\,a(n-14) - 12\,a(n-15) - 58\,a(n-16) - 28\,a(n-17) + 12\,a(n-18) + 4\,a(n-20)$ holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,81$. The last nonvanishing one is at $m = 2$, that is at $n = 22$. After it, more than $S = 32$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 101, 373, 1156, 3469, 10562, 32910, 105020,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224155}{A224155}, revision 8, last modified Oct 03 2025.
