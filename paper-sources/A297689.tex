...
\title{A proof of the conjectured linear recurrence for OEIS A297689}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297689}{A297689} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -2*a(n-2) +6*a(n-3) -52*a(n-4) +23*a(n-5) -3*a(n-6) +21*a(n-7) -9*a(n-8)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 2\,a(n-2) + 6\,a(n-3) - 52\,a(n-4) + 23\,a(n-5) - 3\,a(n-6) + \\ 21\,a(n-7) - 9\,a(n-8). \end{multline*}
...
The construction gives $72$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $48$; neither removal changes any count.
...
\begin{theorem} For A297689, the recurrence $a(n) = 5\,a(n-1) - 2\,a(n-2) + 6\,a(n-3) - 52\,a(n-4) + 23\,a(n-5) - 3\,a(n-6) + 21\,a(n-7) - 9\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 26, 95, 415, 1801, 7526, 32173, 137242,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297689}{A297689}, revision 4, last modified Jan 03 2018.
