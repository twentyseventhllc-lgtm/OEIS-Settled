...
\title{A proof of the conjectured linear recurrence for OEIS A300467}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300467}{A300467} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -a(n-2) -a(n-3) +a(n-4) -4*a(n-5) +a(n-6) -a(n-7).\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - a(n-2) - a(n-3) + a(n-4) - 4\,a(n-5) + a(n-6) - \\ a(n-7). \end{multline*}
...
\begin{theorem} For A300467, the recurrence $a(n) = 6\,a(n-1) - a(n-2) - a(n-3) + a(n-4) - 4\,a(n-5) + a(n-6) - a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 29, 160, 925, 5363, 31106, 180397, 1046223,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300467}{A300467}, revision 6, last modified Dec 27 2023.
