...
\title{Proofs of the conjectured column and row recurrences for OEIS A300804}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300804}{A300804} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = 2*a(n-1)\\k=2: a(n) = 4*a(n-1)\\k=3: a(n) = 7*a(n-1) +3*a(n-2) -5*a(n-3)\\k=4: [order 11]\end{quote}
...
\begin{theorem} For column $k = 1$ of A300804, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A300804, the recurrence $a(n) = 4\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A300804, the recurrence $a(n) = 7\,a(n-1) + 3\,a(n-2) - 5\,a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A300804, the recurrence $a(n) = 0$ holds for every $n \ge 12$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300804}{A300804}, revision 4, last modified Mar 13 2018.
