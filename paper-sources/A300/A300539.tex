...
\title{Proofs of the conjectured column and row recurrences for OEIS A300539}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300539}{A300539} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
The lines carry no separate signature; the entry itself is by R. H. Hardin (Mar 08 2018). As of revision 4, last modified Mar 08 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A300539, the recurrence $a(n) = a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A300539, the recurrence $a(n) = a(n-1) + 4\,a(n-2) + 2\,a(n-3) - a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A300539, the recurrence $a(n) = 0$ holds for every $n > 24$, and fails at $n = 24$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A300539, the recurrence $a(n) = 0$ holds for every $n > 78$, and fails at $n = 78$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300539}{A300539}, revision 4, last modified Mar 08 2018.
