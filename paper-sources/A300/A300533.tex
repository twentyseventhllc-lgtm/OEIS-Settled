...
\title{A proof of the conjectured linear recurrence for OEIS A300533}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300533}{A300533} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-2) +2*a(n-3) -a(n-6)\end{quote}
...
\begin{theorem} For A300533, the recurrence $a(n) = a(n-1) + 4\,a(n-2) + 2\,a(n-3) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 5, 16, 40, 113, 304, 833,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300533}{A300533}, revision 4, last modified Mar 08 2018.
