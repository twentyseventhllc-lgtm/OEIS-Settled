...
\title{A proof of the conjectured linear recurrence for OEIS A300925}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300925}{A300925} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +6*a(n-2) -3*a(n-3) -9*a(n-4) -6*a(n-5) +3*a(n-6) +6*a(n-7) +2*a(n-8) for n>10\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 6\,a(n-2) - 3\,a(n-3) - 9\,a(n-4) - 6\,a(n-5) + 3\,a(n-6) + \\ 6\,a(n-7) + 2\,a(n-8). \end{multline*}
...
\begin{theorem} For A300925, the recurrence $a(n) = 6\,a(n-1) + 6\,a(n-2) - 3\,a(n-3) - 9\,a(n-4) - 6\,a(n-5) + 3\,a(n-6) + 6\,a(n-7) + 2\,a(n-8)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,46$. The last nonvanishing one is at $m = 2$, that is at $n = 10$. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 11, 75, 508, 3447, 23404, 158855, 1078231,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300925}{A300925}, revision 4, last modified Mar 15 2018.
