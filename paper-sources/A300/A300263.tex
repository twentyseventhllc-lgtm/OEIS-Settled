...
\title{A proof of the conjectured order of the recurrence for OEIS A300263}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300263}{A300263} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1, 2, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Jul 07 2025, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\begin{theorem} For A300263, the least order of a linear recurrence that $a$ eventually satisfies is exactly $64$, and that recurrence holds for every $n > 66$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 88, 375, 2030, 12324, 71529, 412094, 2398145,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300263}{A300263}, revision 8, last modified Jul 07 2025.
