...
\title{A proof of the conjectured linear recurrence for OEIS A300179}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300179}{A300179} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 26*a(n-1) +158*a(n-2) +696*a(n-3) +756*a(n-4) +236*a(n-5) -3520*a(n-6) -640*a(n-7) -1792*a(n-8) +4096*a(n-9)\end{quote}
...
\begin{multline*} a(n) = 26\,a(n-1) + 158\,a(n-2) + 696\,a(n-3) + 756\,a(n-4) + 236\,a(n-5) - 3520\,a(n-6) - \\ 640\,a(n-7) - 1792\,a(n-8) + 4096\,a(n-9). \end{multline*}
...
\begin{theorem} For A300179, the recurrence $a(n) = 26\,a(n-1) + 158\,a(n-2) + 696\,a(n-3) + 756\,a(n-4) + 236\,a(n-5) - 3520\,a(n-6) - 640\,a(n-7) - 1792\,a(n-8) + 4096\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,43$. Every one of them vanished. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 512, 16208, 513832, 16288960, 516368256, 16369174784, 518912313824,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300179}{A300179}, revision 4, last modified Feb 27 2018.
