...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208559}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208559}{A208559} as

\begin{quote}\itshape Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 31*a(n-2) + 12*a(n-3) - 144*a(n-4).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 20*x*(1 + 19*x + 12*x\textasciicircum{}2 - 144*x\textasciicircum{}3) / (1 - x - 31*x\textasciicircum{}2 - 12*x\textasciicircum{}3 + 144*x\textasciicircum{}4). - Colin Barker, Jul 05 2018\end{quote}
...
\[a(n) = a(n-1) + 31\,a(n-2) + 12\,a(n-3) - 144\,a(n-4).\]
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{20x + 380x^{2} + 240x^{3} - 2880x^{4}}{1 - x - 31x^{2} - 12x^{3} + 144x^{4}}.\]
...
\begin{theorem} For A208559, the recurrence $a(n) = a(n-1) + 31\,a(n-2) + 12\,a(n-3) - 144\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208559, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{20x + 380x^{2} + 240x^{3} - 2880x^{4}}{1 - x - 31x^{2} - 12x^{3} + 144x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 1260, 11020, 52000, 351140, 1913940, 11836400,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208559}{A208559}, revision 9, last modified Jul 05 2018.
