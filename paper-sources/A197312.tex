...
\title{A proof of the conjectured linear recurrence for OEIS A197312}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197312}{A197312} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,1,1,0,0 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-2) +3*a(n-3) +17*a(n-4) +a(n-5) +32*a(n-6) -13*a(n-7) -61*a(n-8) -41*a(n-9) -115*a(n-10) -83*a(n-11) -315*a(n-12) -280*a(n-13) -12*a(n-14) +214*a(n-15) -659*a(n-16) +358*a(n-17) +319*a(n-18) +247*a(n-19) -121*a(n-20) -109*a(n-21) -12*a(n-22) +50*a(n-23) +46*a(n-24) +a(n-25) -a(n-26) -3*a(n-27) for n>28\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-2) + 3\,a(n-3) + 17\,a(n-4) + a(n-5) + 32\,a(n-6) - 13\,a(n-7) - \\ 61\,a(n-8) - 41\,a(n-9) - 115\,a(n-10) - 83\,a(n-11) - 315\,a(n-12) - 280\,a(n-13) - \\ 12\,a(n-14) + 214\,a(n-15) - 659\,a(n-16) + 358\,a(n-17) + 319\,a(n-18) + 247\,a(n-19) - \\ 121\,a(n-20) - 109\,a(n-21) - 12\,a(n-22) + 50\,a(n-23) + 46\,a(n-24) + a(n-25) - \\ a(n-26) - 3\,a(n-27). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $146$; neither removal changes any count.
...
\begin{theorem} For A197312, the recurrence of order $27$ displayed in Section 1 holds for every $n > 28$, and fails at $n = 28$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,91$. The last nonvanishing one is at $m = 1$, that is at $n = 28$. After it, more than $S = 29$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 3, 5, 10, 128, 79, 249, 662,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197312}{A197312}, revision 9, last modified Oct 03 2025.
