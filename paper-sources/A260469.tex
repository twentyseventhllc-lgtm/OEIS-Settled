...
\title{A proof of the conjectured linear recurrence for OEIS A260469}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260469}{A260469} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +5*a(n-3) +a(n-4) -3*a(n-5) -3*a(n-6) +a(n-7) +2*a(n-8) -a(n-9) -5*a(n-10) -5*a(n-11) -2*a(n-15) -2*a(n-16) for n>17\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 5\,a(n-3) + a(n-4) - 3\,a(n-5) - 3\,a(n-6) + \\ a(n-7) + 2\,a(n-8) - a(n-9) - 5\,a(n-10) - 5\,a(n-11) - 2\,a(n-15) - \\ 2\,a(n-16). \end{multline*}
...
\begin{theorem} For A260469, the recurrence $a(n) = a(n-1) + a(n-2) + 5\,a(n-3) + a(n-4) - 3\,a(n-5) - 3\,a(n-6) + a(n-7) + 2\,a(n-8) - a(n-9) - 5\,a(n-10) - 5\,a(n-11) - 2\,a(n-15) - 2\,a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 1$, that is at $n = 17$. After it, more than $S = 21$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 49, 92, 213, 471, 1085, 2562, 5891, 13530,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260469}{A260469}, revision 6, last modified Jun 02 2025.
