...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A202595}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202595}{A202595} as

\begin{quote}\itshape Number of (n+2) X 4 binary arrays avoiding patterns 001 and 000 in rows and columns\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +22*a(n-2) +12*a(n-3) -43*a(n-4) -8*a(n-5) +18*a(n-6) -a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 10*x*(51 + 213*x + 64*x\textasciicircum{}2 - 423*x\textasciicircum{}3 - 62*x\textasciicircum{}4 + 179*x\textasciicircum{}5 - x\textasciicircum{}6 - 10*x\textasciicircum{}7) / (1 - 2*x - 22*x\textasciicircum{}2 - 12*x\textasciicircum{}3 + 43*x\textasciicircum{}4 + 8*x\textasciicircum{}5 - 18*x\textasciicircum{}6 + x\textasciicircum{}8). - Colin Barker, Jun 01 2018\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 12, last modified Jun 01 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 22\,a(n-2) + 12\,a(n-3) - 43\,a(n-4) - 8\,a(n-5) + 18\,a(n-6) - \\ a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{510x + 2130x^{2} + 640x^{3} - 4230x^{4} - 620x^{5} + 1790x^{6} - 10x^{7} - 100x^{8}}{1 - 2x - 22x^{2} - 12x^{3} + 43x^{4} + 8x^{5} - 18x^{6} + x^{8}}.\]
...
\begin{theorem} For A202595, the recurrence $a(n) = 2\,a(n-1) + 22\,a(n-2) + 12\,a(n-3) - 43\,a(n-4) - 8\,a(n-5) + 18\,a(n-6) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A202595, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{510x + 2130x^{2} + 640x^{3} - 4230x^{4} - 620x^{5} + 1790x^{6} - 10x^{7} - 100x^{8}}{1 - 2x - 22x^{2} - 12x^{3} + 43x^{4} + 8x^{5} - 18x^{6} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 510, 3150, 18160, 107510, 629790, 3704980, 21758550, 127872530,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202595}{A202595}, revision 12, last modified Jun 01 2018.
