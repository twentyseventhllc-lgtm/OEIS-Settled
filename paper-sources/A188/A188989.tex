...
\title{A proof of the conjectured linear recurrence for OEIS A188989}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188989}{A188989} as

\begin{quote}\itshape Number of nX6 binary arrays without the pattern 0 0 1 antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 22*a(n-1) -47*a(n-2) -420*a(n-3) +1353*a(n-4) +490*a(n-5) -5593*a(n-6) +15840*a(n-7) -27360*a(n-8) +19496*a(n-9) -1828*a(n-10) -1376*a(n-11) -576*a(n-12) for n>14\end{quote}
...
\begin{multline*} a(n) = 22\,a(n-1) - 47\,a(n-2) - 420\,a(n-3) + 1353\,a(n-4) + 490\,a(n-5) - 5593\,a(n-6) + \\ 15840\,a(n-7) - 27360\,a(n-8) + 19496\,a(n-9) - 1828\,a(n-10) - 1376\,a(n-11) - 576\,a(n-12). \end{multline*}
...
The reachable part of the digraph has $1123$ states, $1123$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 31$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $31\times31$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188989, the recurrence $a(n) = 22\,a(n-1) - 47\,a(n-2) - 420\,a(n-3) + 1353\,a(n-4) + 490\,a(n-5) - 5593\,a(n-6) + 15840\,a(n-7) - 27360\,a(n-8) + 19496\,a(n-9) - 1828\,a(n-10) - 1376\,a(n-11) - 576\,a(n-12)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. The last nonvanishing one is at $m = 2$, that is at $n = 14$. After it, more than $S = 31$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 33, 1089, 21952, 423606, 7844188, 144733702, 2668260348, 49183191266,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188989}{A188989}, revision 9, last modified Oct 03 2025.
