...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A188558}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188558}{A188558} as

\begin{quote}\itshape Number of 7 X n binary arrays without the pattern 0 1 diagonally, vertically, antidiagonally or horizontally\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/5040)*n\textasciicircum{}7 - (1/360)*n\textasciicircum{}6 + (11/360)*n\textasciicircum{}5 - (1/9)*n\textasciicircum{}4 + (427/720)*n\textasciicircum{}3 + (41/360)*n\textasciicircum{}2 + (709/210)*n + 4.\end{quote}

\begin{quote}\ttfamily G.f.: x*(8 - 49*x + 132*x\textasciicircum{}2 - 200*x\textasciicircum{}3 + 184*x\textasciicircum{}4 - 102*x\textasciicircum{}5 + 32*x\textasciicircum{}6 - 4*x\textasciicircum{}7) / (1 - x)\textasciicircum{}8.\end{quote}
...
\[a(n) = 4 + \frac{709}{210}n + \frac{41}{360}n^{2} + \frac{427}{720}n^{3} - \frac{1}{9}n^{4} + \frac{11}{360}n^{5} - \frac{1}{360}n^{6} + \frac{1}{5040}n^{7}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{8x - 49x^{2} + 132x^{3} - 200x^{4} + 184x^{5} - 102x^{6} + 32x^{7} - 4x^{8}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}.\]
...
The reachable part of the digraph has $9$ states, $9$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 9$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $9\times9$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188558, $a(n)$ is the polynomial $4 + \frac{709}{210}n + \frac{41}{360}n^{2} + \frac{427}{720}n^{3} - \frac{1}{9}n^{4} + \frac{11}{360}n^{5} - \frac{1}{360}n^{6} + \frac{1}{5040}n^{7}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $7$ is annihilated by the difference operator $(E-1)^{8}$, whose characteristic polynomial is $(t-1)^{8}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 8 = 17$. Its values were computed exactly; all of them vanish, and more than $17$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A188558, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{8x - 49x^{2} + 132x^{3} - 200x^{4} + 184x^{5} - 102x^{6} + 32x^{7} - 4x^{8}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}$.\end{theorem}
...
\begin{theorem} For A188558, the recurrence $a(n) = 8\,a(n-1) - 28\,a(n-2) + 56\,a(n-3) - 70\,a(n-4) + 56\,a(n-5) - 28\,a(n-6) + 8\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,58$. Every one of them vanished. After it, more than $S = 9$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 35 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 15, 28, 52, 96, 176, 320, 576,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188558}{A188558}, revision 9, last modified Apr 28 2018.
