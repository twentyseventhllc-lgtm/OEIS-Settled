...
\title{A proof of the conjectured linear recurrence for OEIS A188768}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188768}{A188768} as

\begin{quote}\itshape Number of nX3 binary arrays without the pattern 0 1 0 vertically or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -6*a(n-2) +23*a(n-3) +18*a(n-4) +5*a(n-5) +49*a(n-6) -30*a(n-7) -87*a(n-8) -6*a(n-9) +19*a(n-10) +8*a(n-11) +5*a(n-12) -a(n-13) -a(n-14)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 6\,a(n-2) + 23\,a(n-3) + 18\,a(n-4) + 5\,a(n-5) + 49\,a(n-6) - \\ 30\,a(n-7) - 87\,a(n-8) - 6\,a(n-9) + 19\,a(n-10) + 8\,a(n-11) + 5\,a(n-12) - \\ a(n-13) - a(n-14). \end{multline*}
...
The reachable part of the digraph has $57$ states, $57$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 14$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $14\times14$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188768, the recurrence $a(n) = 5\,a(n-1) - 6\,a(n-2) + 23\,a(n-3) + 18\,a(n-4) + 5\,a(n-5) + 49\,a(n-6) - 30\,a(n-7) - 87\,a(n-8) - 6\,a(n-9) + 19\,a(n-10) + 8\,a(n-11) + 5\,a(n-12) - a(n-13) - a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 240, 1103, 5357, 26564, 130828, 641137,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188768}{A188768}, revision 9, last modified Oct 03 2025.
