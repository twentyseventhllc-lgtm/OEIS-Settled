...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A188987}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188987}{A188987} as

\begin{quote}\itshape Number of n X 4 binary arrays without the pattern 0 0 1 antidiagonally or horizontally\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -36*a(n-3) +24*a(n-4) +36*a(n-5) -48*a(n-6) +16*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(1 + x - 2*x\textasciicircum{}2 + x\textasciicircum{}3)*(3 + 6*x - 10*x\textasciicircum{}2 + 4*x\textasciicircum{}3) / ((1 - x)*(1 - 8*x - 8*x\textasciicircum{}2 + 28*x\textasciicircum{}3 + 4*x\textasciicircum{}4 - 32*x\textasciicircum{}5 + 16*x\textasciicircum{}6)). - Colin Barker, May 01 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{12x + 36x^{2} - 40x^{3} - 60x^{4} + 120x^{5} - 72x^{6} + 16x^{7}}{1 - 9x + 36x^{3} - 24x^{4} - 36x^{5} + 48x^{6} - 16x^{7}}.\]
...
The reachable part of the digraph has $157$ states, $157$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 9$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $9\times9$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188987, the recurrence $a(n) = 9\,a(n-1) - 36\,a(n-3) + 24\,a(n-4) + 36\,a(n-5) - 48\,a(n-6) + 16\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A188987, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{12x + 36x^{2} - 40x^{3} - 60x^{4} + 120x^{5} - 72x^{6} + 16x^{7}}{1 - 9x + 36x^{3} - 24x^{4} - 36x^{5} + 48x^{6} - 16x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 1256, 10812, 92532, 791388, 6768028, 57879084,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188987}{A188987}, revision 8, last modified May 01 2018.
