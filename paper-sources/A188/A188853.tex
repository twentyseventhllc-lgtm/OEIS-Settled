...
\title{A proof of the conjectured linear recurrence for OEIS A188853}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188853}{A188853} as

\begin{quote}\itshape Number of 4Xn binary arrays without the pattern 0 0 1 vertically, antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) +15*a(n-2) -217*a(n-3) -65*a(n-4) +2637*a(n-5) +75*a(n-6) -18789*a(n-7) -1526*a(n-8) +86316*a(n-9) +19704*a(n-10) -266659*a(n-11) -102052*a(n-12) +565680*a(n-13) +288503*a(n-14) -834249*a(n-15) -499808*a(n-16) +863607*a(n-17) +561084*a(n-18) -631388*a(n-19) -421898*a(n-20) +323752*a(n-21) +217120*a(n-22) -111753*a(n-23) -77769*a(n-24) +22421*a(n-25) +19774*a(n-26) -747*a(n-27) -3667*a(n-28) -883*a(n-29) +501*a(n-30) +234*a(n-31) -46*a(n-32) -25*a(n-33) +2*a(n-34) +a(n-35) for n>38\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) + 15\,a(n-2) - 217\,a(n-3) - 65\,a(n-4) + 2637\,a(n-5) + 75\,a(n-6) - \\ 18789\,a(n-7) - 1526\,a(n-8) + 86316\,a(n-9) + 19704\,a(n-10) - 266659\,a(n-11) - 102052\,a(n-12) + \\ 565680\,a(n-13) + 288503\,a(n-14) - 834249\,a(n-15) - 499808\,a(n-16) + 863607\,a(n-17) + 561084\,a(n-18) - \\ 631388\,a(n-19) - 421898\,a(n-20) + 323752\,a(n-21) + 217120\,a(n-22) - 111753\,a(n-23) - 77769\,a(n-24) + \\ 22421\,a(n-25) + 19774\,a(n-26) - 747\,a(n-27) - 3667\,a(n-28) - 883\,a(n-29) + 501\,a(n-30) + \\ 234\,a(n-31) - 46\,a(n-32) - 25\,a(n-33) + 2\,a(n-34) + a(n-35). \end{multline*}
...
The reachable part of the digraph has $157$ states, $157$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 47$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $47\times47$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188853, the recurrence of order $35$ displayed in Section 1 holds for every $n > 38$, and fails at $n = 38$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,107$. The last nonvanishing one is at $m = 3$, that is at $n = 38$. After it, more than $S = 47$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 958, 5711, 33037, 185351, 1020454, 5541360,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188853}{A188853}, revision 9, last modified Oct 03 2025.
