...
\title{A proof of the conjectured linear recurrence for OEIS A188990}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188990}{A188990} as

\begin{quote}\itshape Number of nX7 binary arrays without the pattern 0 0 1 antidiagonally or horizontally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 35*a(n-1) -175*a(n-2) -1169*a(n-3) +8904*a(n-4) -5838*a(n-5) -78636*a(n-6) +390264*a(n-7) -535812*a(n-8) -1472012*a(n-9) +4073408*a(n-10) -2206456*a(n-11) +439232*a(n-12) -2614848*a(n-13) +1784672*a(n-14) +415680*a(n-15) +176768*a(n-16) -281856*a(n-17) -92160*a(n-18) for n>22\end{quote}
...
\begin{multline*} a(n) = 35\,a(n-1) - 175\,a(n-2) - 1169\,a(n-3) + 8904\,a(n-4) - 5838\,a(n-5) - 78636\,a(n-6) + \\ 390264\,a(n-7) - 535812\,a(n-8) - 1472012\,a(n-9) + 4073408\,a(n-10) - 2206456\,a(n-11) + 439232\,a(n-12) - \\ 2614848\,a(n-13) + 1784672\,a(n-14) + 415680\,a(n-15) + 176768\,a(n-16) - 281856\,a(n-17) - 92160\,a(n-18). \end{multline*}
...
The reachable part of the digraph has $2971$ states, $2971$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 63$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $63\times63$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188990, the recurrence of order $18$ displayed in Section 1 holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,102$. The last nonvanishing one is at $m = 4$, that is at $n = 22$. After it, more than $S = 63$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 54, 2916, 89744, 2613530, 72609144, 2002277608, 55080396536, 1515192856324,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188990}{A188990}, revision 9, last modified Oct 03 2025.
