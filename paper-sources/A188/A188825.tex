...
\title{A proof of the conjectured linear recurrence for OEIS A188825}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188825}{A188825} as

\begin{quote}\itshape Number of 3Xn binary arrays without the pattern 0 1 diagonally or antidiagonally\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) for n>2\end{quote}
...
\begin{theorem} For A188825, the recurrence $a(n) = 3\,a(n-1)$ holds for every $n > 2$, and fails at $n = 2$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,36$. The last nonvanishing one is at $m = 1$, that is at $n = 2$. After it, more than $S = 4$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 16, 48, 144, 432, 1296, 3888, 11664,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188825}{A188825}, revision 8, last modified Oct 03 2025.
