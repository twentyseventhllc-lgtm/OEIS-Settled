...
\title{A proof of the conjectured linear recurrence for OEIS A246887}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A246887}{A246887} as

\begin{quote}\itshape Number of length n+4 0..3 arrays with some pair in every consecutive five terms totalling exactly 3\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +4*a(n-2) +6*a(n-3) +12*a(n-4) -4*a(n-5) -6*a(n-6) -2*a(n-8) +a(n-10)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 4\,a(n-2) + 6\,a(n-3) + 12\,a(n-4) - 4\,a(n-5) - 6\,a(n-6) - \\ 2\,a(n-8) + a(n-10). \end{multline*}
...
\item {\itshape some pair in every consecutive five terms totalling exactly 3}
...
The reachable part of that digraph has $341$ states, $341$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 11$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $11\times11$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A246887, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) + 6\,a(n-3) + 12\,a(n-4) - 4\,a(n-5) - 6\,a(n-6) - 2\,a(n-8) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 900, 3364, 12544, 46656, 173056, 643204, 2390116, 8880400,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A246887}{A246887}, revision 6, last modified Jun 02 2025.
