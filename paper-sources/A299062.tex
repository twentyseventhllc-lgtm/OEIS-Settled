...
\title{A proof of the conjectured linear recurrence for OEIS A299062}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299062}{A299062} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +8*a(n-2) +14*a(n-3) +11*a(n-4) -4*a(n-5) +3*a(n-6) +2*a(n-7) -5*a(n-8) -2*a(n-9) for n>10\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 8\,a(n-2) + 14\,a(n-3) + 11\,a(n-4) - 4\,a(n-5) + 3\,a(n-6) + \\ 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9). \end{multline*}
...
\begin{theorem} For A299062, the recurrence $a(n) = 6\,a(n-1) + 8\,a(n-2) + 14\,a(n-3) + 11\,a(n-4) - 4\,a(n-5) + 3\,a(n-6) + 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,45$. The last nonvanishing one is at $m = 1$, that is at $n = 10$. After it, more than $S = 10$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 141, 993, 7330, 54106, 398654, 2937795,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299062}{A299062}, revision 4, last modified Feb 01 2018.
