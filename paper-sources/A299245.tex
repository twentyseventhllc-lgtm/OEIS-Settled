...
\title{A proof of the conjectured order of the recurrence for OEIS A299245}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299245}{A299245} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A299245, the least order of a linear recurrence that $a$ eventually satisfies is exactly $72$, and that recurrence holds for every $n > 73$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 18, 55, 192, 652, 2002, 6741,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299245}{A299245}, revision 4, last modified Feb 05 2018.
