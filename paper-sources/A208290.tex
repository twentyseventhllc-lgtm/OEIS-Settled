...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208290}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208290}{A208290} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) + 11*a(n-2) - 10*a(n-3) - 10*a(n-4) + 6*a(n-5) + 2*a(n-6) - a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 12*x*(1 - x)*(1 + 9*x + 3*x\textasciicircum{}2 - 6*x\textasciicircum{}3 - x\textasciicircum{}4 + x\textasciicircum{}5) / (1 - 4*x - 11*x\textasciicircum{}2 + 10*x\textasciicircum{}3 + 10*x\textasciicircum{}4 - 6*x\textasciicircum{}5 - 2*x\textasciicircum{}6 + x\textasciicircum{}7). - Colin Barker, Jun 30 2018\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 11\,a(n-2) - 10\,a(n-3) - 10\,a(n-4) + 6\,a(n-5) + 2\,a(n-6) - \\ a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{12x + 96x^{2} - 72x^{3} - 108x^{4} + 60x^{5} + 24x^{6} - 12x^{7}}{1 - 4x - 11x^{2} + 10x^{3} + 10x^{4} - 6x^{5} - 2x^{6} + x^{7}}.\]
...
\begin{theorem} For A208290, the recurrence $a(n) = 4\,a(n-1) + 11\,a(n-2) - 10\,a(n-3) - 10\,a(n-4) + 6\,a(n-5) + 2\,a(n-6) - a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208290, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{12x + 96x^{2} - 72x^{3} - 108x^{4} + 60x^{5} + 24x^{6} - 12x^{7}}{1 - 4x - 11x^{2} + 10x^{3} + 10x^{4} - 6x^{5} - 2x^{6} + x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 636, 3900, 21096, 119580, 665892, 3733080,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208290}{A208290}, revision 8, last modified Jun 30 2018.
