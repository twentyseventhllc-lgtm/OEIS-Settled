...
\title{A proof of the conjectured generating function for OEIS A250806}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250806}{A250806} as
...
\begin{quote}\ttfamily Empirical g.f.: x*(100 - 221*x + 141*x\textasciicircum{}2) / ((1 - x)*(1 - 2*x)*(1 - 3*x)). - Colin Barker, Nov 20 2018\end{quote}

The line quoted above is contributed by Colin Barker on Nov 20 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Nov 20 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{100x - 221x^{2} + 141x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}.\]
...
\begin{theorem} For A250806, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{100x - 221x^{2} + 141x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 100, 379, 1315, 4321, 13735, 42769, 131455, 400681,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250806}{A250806}, revision 9, last modified Nov 20 2018.
