...
\title{A proof of the conjectured linear recurrence for OEIS A234684}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234684}{A234684} as

\begin{quote}\itshape Number of (n+1) X (2+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +136*a(n-2) -1036*a(n-3) -7837*a(n-4) +67291*a(n-5) +245614*a(n-6) -2526790*a(n-7) -4355332*a(n-8) +60808804*a(n-9) +36086728*a(n-10) -982312744*a(n-11) +135510432*a(n-12) +10839179904*a(n-13) -6945594624*a(n-14) -81450996480*a(n-15) +81465827328*a(n-16) +407151166464*a(n-17) -514409232384*a(n-18) -1284949370880*a(n-19) +1874710241280*a(n-20) +2296420761600*a(n-21) -3685898649600*a(n-22) -1755758592000*a(n-23) +3009871872000*a(n-24).\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 136\,a(n-2) - 1036\,a(n-3) - 7837\,a(n-4) + 67291\,a(n-5) + 245614\,a(n-6) - \\ 2526790\,a(n-7) - 4355332\,a(n-8) + 60808804\,a(n-9) + 36086728\,a(n-10) - 982312744\,a(n-11) + 135510432\,a(n-12) + \\ 10839179904\,a(n-13) - 6945594624\,a(n-14) - 81450996480\,a(n-15) + 81465827328\,a(n-16) + 407151166464\,a(n-17) - 514409232384\,a(n-18) - \\ 1284949370880\,a(n-19) + 1874710241280\,a(n-20) + 2296420761600\,a(n-21) - 3685898649600\,a(n-22) - 1755758592000\,a(n-23) + 3009871872000\,a(n-24). \end{multline*}
...
For scale: at $n = 8$ there are $7^{24}$ arrays, about $10^{20}$, against $25$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A234684, the recurrence of order $24$ displayed in Section 1 holds for every $n \ge 25$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1148, 4416, 16580, 69336, 281612, 1253088, 5385236, 25119456,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234684}{A234684}, revision 6, last modified Jun 20 2022.
