...
\title{Proofs of the conjectured column and row recurrences for OEIS A234497}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234497}{A234497} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings)\end{quote}
...
k=1: a(n) = 5*a(n-1) +74*a(n-2) -295*a(n-3) -1008*a(n-4) +840*a(n-5).\end{quote}
...
\begin{theorem} For column $k = 1$ of A234497, the recurrence $a(n) = 5\,a(n-1) + 74\,a(n-2) - 295\,a(n-3) - 1008\,a(n-4) + 840\,a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234497}{A234497}, revision 6, last modified Jun 20 2022.
