...
\title{A proof of the conjectured linear recurrence for OEIS A207604}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207604}{A207604} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) -6*a(n-2) +31*a(n-3) +319*a(n-4) +270*a(n-5) +2100*a(n-6) -12600*a(n-8) -9720*a(n-9) -68904*a(n-10) -40176*a(n-11) +46656*a(n-12) -46656*a(n-13) +279936*a(n-14)\end{quote}
...
\begin{multline*} a(n) = a(n-1) - 6\,a(n-2) + 31\,a(n-3) + 319\,a(n-4) + 270\,a(n-5) + 2100\,a(n-6) - \\ 12600\,a(n-8) - 9720\,a(n-9) - 68904\,a(n-10) - 40176\,a(n-11) + 46656\,a(n-12) - 46656\,a(n-13) + \\ 279936\,a(n-14). \end{multline*}
...
\begin{theorem} For A207604, the recurrence $a(n) = a(n-1) - 6\,a(n-2) + 31\,a(n-3) + 319\,a(n-4) + 270\,a(n-5) + 2100\,a(n-6) - 12600\,a(n-8) - 9720\,a(n-9) - 68904\,a(n-10) - 40176\,a(n-11) + 46656\,a(n-12) - 46656\,a(n-13) + 279936\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 546, 1521, 10725, 75625, 292600, 1132096,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207604}{A207604}, revision 9, last modified Oct 03 2025.
