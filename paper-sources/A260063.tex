...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A260063}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260063}{A260063} as

\begin{quote}\itshape Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 4*a(n-3) + 5*a(n-4) - 5*a(n-5) - 2*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(48 + 43*x + 165*x\textasciicircum{}2 + 109*x\textasciicircum{}3 - 205*x\textasciicircum{}4 - 64*x\textasciicircum{}5) / (1 - x - 4*x\textasciicircum{}3 - 5*x\textasciicircum{}4 + 5*x\textasciicircum{}5 + 2*x\textasciicircum{}6). - Colin Barker, Dec 28 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{48x + 43x^{2} + 165x^{3} + 109x^{4} - 205x^{5} - 64x^{6}}{1 - x - 4x^{3} - 5x^{4} + 5x^{5} + 2x^{6}}.\]
...
\begin{theorem} For A260063, the recurrence $a(n) = a(n-1) + 4\,a(n-3) + 5\,a(n-4) - 5\,a(n-5) - 2\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A260063, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{48x + 43x^{2} + 165x^{3} + 109x^{4} - 205x^{5} - 64x^{6}}{1 - x - 4x^{3} - 5x^{4} + 5x^{5} + 2x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 48, 91, 256, 557, 956, 2131, 5088, 10235,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260063}{A260063}, revision 8, last modified Dec 28 2018.
