...
\title{A proof of the conjectured linear recurrence for OEIS A316299}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316299}{A316299} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-2) +7*a(n-3) +8*a(n-4) +2*a(n-5) -12*a(n-6) -26*a(n-7) -23*a(n-8) -6*a(n-9) +9*a(n-10) +10*a(n-11) +3*a(n-12) for n>13\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-2) + 7\,a(n-3) + 8\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) - 26\,a(n-7) - \\ 23\,a(n-8) - 6\,a(n-9) + 9\,a(n-10) + 10\,a(n-11) + 3\,a(n-12). \end{multline*}
...
\begin{theorem} For A316299, the recurrence $a(n) = 2\,a(n-2) + 7\,a(n-3) + 8\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) - 26\,a(n-7) - 23\,a(n-8) - 6\,a(n-9) + 9\,a(n-10) + 10\,a(n-11) + 3\,a(n-12)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,62$. The last nonvanishing one is at $m = 1$, that is at $n = 13$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 20, 39, 110, 245, 572, 1384,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316299}{A316299}, revision 4, last modified Jun 29 2018.
