...
\title{A proof of the conjectured linear recurrence for OEIS A316417}
...
\begin{multline*} a(n) = 3\,a(n-1) + 9\,a(n-2) - 3\,a(n-3) - 20\,a(n-4) - 65\,a(n-5) - 96\,a(n-6) + \\ 179\,a(n-7) + 361\,a(n-8) + 34\,a(n-9) - 66\,a(n-10) - 476\,a(n-11) - 672\,a(n-12) + \\ 502\,a(n-13) + 451\,a(n-14) + 40\,a(n-15) + 604\,a(n-16) - 670\,a(n-17) - 930\,a(n-18) - \\ 95\,a(n-19) - 98\,a(n-20) + 1056\,a(n-21) + 1159\,a(n-22) - 399\,a(n-23) - 724\,a(n-24) - \\ 961\,a(n-25) - 326\,a(n-26) + 898\,a(n-27) + 701\,a(n-28) + 308\,a(n-29) - 177\,a(n-30) - \\ 601\,a(n-31) - 204\,a(n-32) + 60\,a(n-33) + 125\,a(n-34) + 146\,a(n-35) - 6\,a(n-36) - \\ 46\,a(n-37) - 26\,a(n-38) - 9\,a(n-39) + 13\,a(n-40) + 7\,a(n-41) - 2\,a(n-42) - \\ a(n-43). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $283$; neither removal changes any count.
...
\begin{theorem} For A316417, the recurrence of order $43$ displayed in Section 1 holds for every $n > 49$, and fails at $n = 49$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,130$. The last nonvanishing one is at $m = 6$, that is at $n = 49$. After it, more than $S = 59$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 22, 66, 287, 1265, 5695, 25312, 112499,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316417}{A316417}, revision 4, last modified Jul 02 2018.
