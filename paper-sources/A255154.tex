...
\title{A proof of the conjectured linear recurrence for OEIS A255154}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255154}{A255154} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 0 or 1 and no column sum 0 or 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +13*a(n-3) +31*a(n-4) +44*a(n-5) +33*a(n-6) -50*a(n-7) -84*a(n-8) +a(n-9) +76*a(n-10) -86*a(n-11) -274*a(n-12) -149*a(n-13) -14*a(n-14) +12*a(n-15) -2*a(n-16) -4*a(n-17) +4*a(n-18) for n>20\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 13\,a(n-3) + 31\,a(n-4) + 44\,a(n-5) + 33\,a(n-6) - \\ 50\,a(n-7) - 84\,a(n-8) + a(n-9) + 76\,a(n-10) - 86\,a(n-11) - 274\,a(n-12) - \\ 149\,a(n-13) - 14\,a(n-14) + 12\,a(n-15) - 2\,a(n-16) - 4\,a(n-17) + 4\,a(n-18). \end{multline*}
...
\begin{theorem} For A255154, the recurrence $a(n) = a(n-1) + a(n-2) + 13\,a(n-3) + 31\,a(n-4) + 44\,a(n-5) + 33\,a(n-6) - 50\,a(n-7) - 84\,a(n-8) + a(n-9) + 76\,a(n-10) - 86\,a(n-11) - 274\,a(n-12) - 149\,a(n-13) - 14\,a(n-14) + 12\,a(n-15) - 2\,a(n-16) - 4\,a(n-17) + 4\,a(n-18)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,71$. The last nonvanishing one is at $m = 2$, that is at $n = 20$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 141, 459, 1637, 5615, 19437, 67465, 232685, 804189,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255154}{A255154}, revision 6, last modified Jun 02 2025.
