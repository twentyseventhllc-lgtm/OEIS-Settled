...
\title{A proof of the conjectured linear recurrence for OEIS A304896}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304896}{A304896} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +12*a(n-2) +11*a(n-3) -12*a(n-4) -15*a(n-5) +14*a(n-6) +14*a(n-7) +26*a(n-8) +5*a(n-9) +a(n-10) -a(n-11) -17*a(n-12) +a(n-13) -5*a(n-14) +2*a(n-15) for n>16\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 12\,a(n-2) + 11\,a(n-3) - 12\,a(n-4) - 15\,a(n-5) + 14\,a(n-6) + \\ 14\,a(n-7) + 26\,a(n-8) + 5\,a(n-9) + a(n-10) - a(n-11) - 17\,a(n-12) + \\ a(n-13) - 5\,a(n-14) + 2\,a(n-15). \end{multline*}
...
\begin{theorem} For A304896, the recurrence $a(n) = a(n-1) + 12\,a(n-2) + 11\,a(n-3) - 12\,a(n-4) - 15\,a(n-5) + 14\,a(n-6) + 14\,a(n-7) + 26\,a(n-8) + 5\,a(n-9) + a(n-10) - a(n-11) - 17\,a(n-12) + a(n-13) - 5\,a(n-14) + 2\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 23, 62, 330, 1249, 5562, 23101, 99064,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304896}{A304896}, revision 4, last modified May 20 2018.
