...
\title{A proof of the conjectured linear recurrence for OEIS A208120}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208120}{A208120} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) -6*a(n-2) +29*a(n-3) +247*a(n-4) +246*a(n-5) +1656*a(n-6) -9936*a(n-8) -8856*a(n-9) -53352*a(n-10) -37584*a(n-11) +46656*a(n-12) -46656*a(n-13) +279936*a(n-14)\end{quote}
...
\begin{multline*} a(n) = a(n-1) - 6\,a(n-2) + 29\,a(n-3) + 247\,a(n-4) + 246\,a(n-5) + 1656\,a(n-6) - \\ 9936\,a(n-8) - 8856\,a(n-9) - 53352\,a(n-10) - 37584\,a(n-11) + 46656\,a(n-12) - 46656\,a(n-13) + \\ 279936\,a(n-14). \end{multline*}
...
\begin{theorem} For A208120, the recurrence $a(n) = a(n-1) - 6\,a(n-2) + 29\,a(n-3) + 247\,a(n-4) + 246\,a(n-5) + 1656\,a(n-6) - 9936\,a(n-8) - 8856\,a(n-9) - 53352\,a(n-10) - 37584\,a(n-11) + 46656\,a(n-12) - 46656\,a(n-13) + 279936\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 420, 1225, 7315, 43681, 175560, 705600,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208120}{A208120}, revision 9, last modified Oct 03 2025.
