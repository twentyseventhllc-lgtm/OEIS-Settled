...
\title{A proof of the conjectured linear recurrence for OEIS A302324}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302324}{A302324} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -4*a(n-2) -6*a(n-3) +a(n-4) -15*a(n-5) +25*a(n-6) +37*a(n-7) +8*a(n-8) -27*a(n-9) -57*a(n-10) -49*a(n-11) +51*a(n-12) +44*a(n-13) -12*a(n-14) for n>15.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 05 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 10, last modified Jan 27 2024, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 5\,a(n-1) - 4\,a(n-2) - 6\,a(n-3) + a(n-4) - 15\,a(n-5) + 25\,a(n-6) + \\ 37\,a(n-7) + 8\,a(n-8) - 27\,a(n-9) - 57\,a(n-10) - 49\,a(n-11) + 51\,a(n-12) + \\ 44\,a(n-13) - 12\,a(n-14). \end{multline*}
...
\begin{theorem} For A302324, the recurrence $a(n) = 5\,a(n-1) - 4\,a(n-2) - 6\,a(n-3) + a(n-4) - 15\,a(n-5) + 25\,a(n-6) + 37\,a(n-7) + 8\,a(n-8) - 27\,a(n-9) - 57\,a(n-10) - 49\,a(n-11) + 51\,a(n-12) + 44\,a(n-13) - 12\,a(n-14)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. The last nonvanishing one is at $m = 1$, that is at $n = 15$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 25, 65, 177, 519, 1528, 4509, 13329,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302324}{A302324}, revision 10, last modified Jan 27 2024.
