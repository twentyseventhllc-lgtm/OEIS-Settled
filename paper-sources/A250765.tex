...
\title{A proof of the conjectured generating function for OEIS A250765}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250765}{A250765} as
...
\begin{quote}\ttfamily Empirical g.f.: 2*x*(34 - 79*x + 40*x\textasciicircum{}2) / ((1 - x)\textasciicircum{}2*(1 - 2*x)). - Colin Barker, Nov 18 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{68x - 158x^{2} + 80x^{3}}{1 - 4x + 5x^{2} - 2x^{3}}.\]
...
\begin{theorem} For A250765, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{68x - 158x^{2} + 80x^{3}}{1 - 4x + 5x^{2} - 2x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 68, 114, 196, 350, 648, 1234, 2396, 4710,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250765}{A250765}, revision 8, last modified Nov 18 2018.
