...
\title{A proof of the conjectured linear recurrence for OEIS A297501}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297501}{A297501} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +5*a(n-2) +37*a(n-3) +63*a(n-4) +101*a(n-5) -45*a(n-6) -198*a(n-7) -254*a(n-8) -40*a(n-9) +88*a(n-10) +96*a(n-11)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 5\,a(n-2) + 37\,a(n-3) + 63\,a(n-4) + 101\,a(n-5) - 45\,a(n-6) - \\ 198\,a(n-7) - 254\,a(n-8) - 40\,a(n-9) + 88\,a(n-10) + 96\,a(n-11). \end{multline*}
...
\begin{theorem} For A297501, the recurrence $a(n) = a(n-1) + 5\,a(n-2) + 37\,a(n-3) + 63\,a(n-4) + 101\,a(n-5) - 45\,a(n-6) - 198\,a(n-7) - 254\,a(n-8) - 40\,a(n-9) + 88\,a(n-10) + 96\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 31, 110, 531, 2534, 11405, 53175, 246040,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297501}{A297501}, revision 4, last modified Dec 31 2017.
