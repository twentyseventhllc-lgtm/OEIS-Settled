...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,178$. The last nonvanishing one is at $m = 1$, that is at $n = 72$. After it, more than $S = 75$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
