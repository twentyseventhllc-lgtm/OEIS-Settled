...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208291}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208291}{A208291} as

\begin{quote}\itshape Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) + 16*a(n-2) - 7*a(n-3) - 23*a(n-4) + 2*a(n-5) + 9*a(n-6) - a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 14*x*(1 + x)*(1 + 9*x - 12*x\textasciicircum{}2 - 6*x\textasciicircum{}3 + 7*x\textasciicircum{}4 + x\textasciicircum{}5 - x\textasciicircum{}6) / (1 - 4*x - 16*x\textasciicircum{}2 + 7*x\textasciicircum{}3 + 23*x\textasciicircum{}4 - 2*x\textasciicircum{}5 - 9*x\textasciicircum{}6 + x\textasciicircum{}8). - Colin Barker, Jun 30 2018\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 16\,a(n-2) - 7\,a(n-3) - 23\,a(n-4) + 2\,a(n-5) + 9\,a(n-6) - \\ a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{14x + 140x^{2} - 42x^{3} - 252x^{4} + 14x^{5} + 112x^{6} - 14x^{8}}{1 - 4x - 16x^{2} + 7x^{3} + 23x^{4} - 2x^{5} - 9x^{6} + x^{8}}.\]
...
\begin{theorem} For A208291, the recurrence $a(n) = 4\,a(n-1) + 16\,a(n-2) - 7\,a(n-3) - 23\,a(n-4) + 2\,a(n-5) + 9\,a(n-6) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208291, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{14x + 140x^{2} - 42x^{3} - 252x^{4} + 14x^{5} + 112x^{6} - 14x^{8}}{1 - 4x - 16x^{2} + 7x^{3} + 23x^{4} - 2x^{5} - 9x^{6} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 966, 6650, 40376, 256774, 1604862, 10095932,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208291}{A208291}, revision 8, last modified Jun 30 2018.
