...
\title{A proof of the conjectured closed form for OEIS A207023}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207023}{A207023} as

\begin{quote}\itshape Number of nX7 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (55/24)*n\textasciicircum{}5 + (75/4)*n\textasciicircum{}4 + (275/8)*n\textasciicircum{}3 + (75/4)*n\textasciicircum{}2 - (295/6)*n.\end{quote}
...
\[a(n) = -\frac{295}{6}n + \frac{75}{4}n^{2} + \frac{275}{8}n^{3} + \frac{75}{4}n^{4} + \frac{55}{24}n^{5}.\]
...
\begin{theorem} For A207023, $a(n)$ is the polynomial $-\frac{295}{6}n + \frac{75}{4}n^{2} + \frac{275}{8}n^{3} + \frac{75}{4}n^{4} + \frac{55}{24}n^{5}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $5$ is annihilated by the difference operator $(E-1)^{6}$, whose characteristic polynomial is $(t-1)^{6}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 6 = 15$. Its values were computed exactly; all of them vanish, and more than $15$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 25, 625, 3025, 9450, 23400, 49925, 95900, 170300,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207023}{A207023}, revision 12, last modified Oct 03 2025.
