...
\title{A proof of the conjectured linear recurrence for OEIS A197445}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197445}{A197445} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,1,1,0,0 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +12*a(n-2) +45*a(n-3) +61*a(n-4) +20*a(n-5) -129*a(n-6) -324*a(n-7) -344*a(n-8) -166*a(n-9) +61*a(n-10) +268*a(n-11) +360*a(n-12) +307*a(n-13) +240*a(n-14) +92*a(n-15) -97*a(n-16) -142*a(n-17) -120*a(n-18) -92*a(n-19) -32*a(n-20) -4*a(n-22) for n>25\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 12\,a(n-2) + 45\,a(n-3) + 61\,a(n-4) + 20\,a(n-5) - 129\,a(n-6) - \\ 324\,a(n-7) - 344\,a(n-8) - 166\,a(n-9) + 61\,a(n-10) + 268\,a(n-11) + 360\,a(n-12) + \\ 307\,a(n-13) + 240\,a(n-14) + 92\,a(n-15) - 97\,a(n-16) - 142\,a(n-17) - 120\,a(n-18) - \\ 92\,a(n-19) - 32\,a(n-20) - 4\,a(n-22). \end{multline*}
...
\begin{theorem} For A197445, the recurrence of order $22$ displayed in Section 1 holds for every $n > 25$, and fails at $n = 25$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 3$, that is at $n = 25$. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 12, 81, 474, 2678, 15410, 88767, 510482,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197445}{A197445}, revision 9, last modified Oct 03 2025.
