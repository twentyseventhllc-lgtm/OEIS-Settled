...
\title{A proof of the conjectured linear recurrence for OEIS A231214}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231214}{A231214} as

\begin{quote}\itshape Number of (n+1)X(3+1) 0..2 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with values 0..2 introduced in row major order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -16*a(n-2) -11*a(n-3) +77*a(n-4) -147*a(n-5) +179*a(n-6) -109*a(n-7) +129*a(n-8) -231*a(n-9) +327*a(n-10) -280*a(n-11) -288*a(n-12) +548*a(n-13) -504*a(n-14) +486*a(n-15) -183*a(n-16) +48*a(n-17) -24*a(n-18) -8*a(n-19)\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 16\,a(n-2) - 11\,a(n-3) + 77\,a(n-4) - 147\,a(n-5) + 179\,a(n-6) - \\ 109\,a(n-7) + 129\,a(n-8) - 231\,a(n-9) + 327\,a(n-10) - 280\,a(n-11) - 288\,a(n-12) + \\ 548\,a(n-13) - 504\,a(n-14) + 486\,a(n-15) - 183\,a(n-16) + 48\,a(n-17) - 24\,a(n-18) - \\ 8\,a(n-19). \end{multline*}
...
The reachable part of the digraph has $5260$ states, $473$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 23$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $23\times23$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A231214, the recurrence of order $19$ displayed in Section 1 holds for every $n \ge 20$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 22, 93, 408, 1793, 7844, 34609, 152421,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231214}{A231214}, revision 6, last modified Jul 23 2025.
