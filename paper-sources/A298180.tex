...
\title{A proof of the conjectured linear recurrence for OEIS A298180}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298180}{A298180} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) +a(n-3) -2*a(n-4) -5*a(n-5) -6*a(n-6) -4*a(n-7) +14*a(n-8) +6*a(n-9) -2*a(n-10)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) + a(n-3) - 2\,a(n-4) - 5\,a(n-5) - 6\,a(n-6) - \\ 4\,a(n-7) + 14\,a(n-8) + 6\,a(n-9) - 2\,a(n-10). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $45$; neither removal changes any count.
...
\begin{theorem} For A298180, the recurrence $a(n) = 2\,a(n-1) + a(n-2) + a(n-3) - 2\,a(n-4) - 5\,a(n-5) - 6\,a(n-6) - 4\,a(n-7) + 14\,a(n-8) + 6\,a(n-9) - 2\,a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 3, 3, 6, 15, 27, 54, 117,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298180}{A298180}, revision 4, last modified Jan 14 2018.
