...
\title{A proof of the conjectured linear recurrence for OEIS A303327}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303327}{A303327} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays with every element equal to 0, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +12*a(n-2) -129*a(n-3) +69*a(n-4) +842*a(n-5) -1297*a(n-6) -839*a(n-7) +3412*a(n-8) -9036*a(n-9) +11871*a(n-10) +17108*a(n-11) -45954*a(n-12) +47570*a(n-13) -53012*a(n-14) -66076*a(n-15) +203444*a(n-16) -165552*a(n-17) +190584*a(n-18) +4296*a(n-19) -282112*a(n-20) +206832*a(n-21) -309856*a(n-22) +208160*a(n-23) -21344*a(n-24) +101312*a(n-25) -1024*a(n-26) +22336*a(n-27) -32256*a(n-28) +2560*a(n-29) -2816*a(n-30) +2816*a(n-31) +1536*a(n-32) +1024*a(n-33) -1024*a(n-34) for n>35\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 12\,a(n-2) - 129\,a(n-3) + 69\,a(n-4) + 842\,a(n-5) - 1297\,a(n-6) - \\ 839\,a(n-7) + 3412\,a(n-8) - 9036\,a(n-9) + 11871\,a(n-10) + 17108\,a(n-11) - 45954\,a(n-12) + \\ 47570\,a(n-13) - 53012\,a(n-14) - 66076\,a(n-15) + 203444\,a(n-16) - 165552\,a(n-17) + 190584\,a(n-18) + \\ 4296\,a(n-19) - 282112\,a(n-20) + 206832\,a(n-21) - 309856\,a(n-22) + 208160\,a(n-23) - 21344\,a(n-24) + \\ 101312\,a(n-25) - 1024\,a(n-26) + 22336\,a(n-27) - 32256\,a(n-28) + 2560\,a(n-29) - 2816\,a(n-30) + \\ 2816\,a(n-31) + 1536\,a(n-32) + 1024\,a(n-33) - 1024\,a(n-34). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $296$; neither removal changes any count.
...
For scale: at $n = 8$ there are $2^{40}$ arrays, about $10^{12}$, against $38$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A303327, the recurrence of order $34$ displayed in Section 1 holds for every $n > 35$, and fails at $n = 35$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,105$. The last nonvanishing one is at $m = 1$, that is at $n = 35$. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 1, 16, 4, 64, 25, 368, 201,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303327}{A303327}, revision 4, last modified Apr 21 2018.
