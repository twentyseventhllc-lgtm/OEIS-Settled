...
\title{A proof of the conjectured linear recurrence for OEIS A301439}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301439}{A301439} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) -28*a(n-2) -26*a(n-3) +40*a(n-4) -37*a(n-5) -61*a(n-6) +30*a(n-7) +36*a(n-8) +25*a(n-9) +5*a(n-10) +a(n-11)\end{quote}
...
\begin{multline*} a(n) = 16\,a(n-1) - 28\,a(n-2) - 26\,a(n-3) + 40\,a(n-4) - 37\,a(n-5) - 61\,a(n-6) + \\ 30\,a(n-7) + 36\,a(n-8) + 25\,a(n-9) + 5\,a(n-10) + a(n-11). \end{multline*}
...
\begin{theorem} For A301439, the recurrence $a(n) = 16\,a(n-1) - 28\,a(n-2) - 26\,a(n-3) + 40\,a(n-4) - 37\,a(n-5) - 61\,a(n-6) + 30\,a(n-7) + 36\,a(n-8) + 25\,a(n-9) + 5\,a(n-10) + a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,47$. Every one of them vanished. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1708, 23672, 327848, 4543028, 62956480, 872451104,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301439}{A301439}, revision 4, last modified Mar 21 2018.
