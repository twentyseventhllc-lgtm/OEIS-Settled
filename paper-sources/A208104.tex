...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208104}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208104}{A208104} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(9 + 45*x - 137*x\textasciicircum{}2 - 99*x\textasciicircum{}3 + 185*x\textasciicircum{}4 + 55*x\textasciicircum{}5 - 40*x\textasciicircum{}6) / ((1 - x)*(1 + x)*(1 - 3*x + x\textasciicircum{}2)*(1 - x - x\textasciicircum{}2)). - Colin Barker, Jun 28 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 45x^{2} - 137x^{3} - 99x^{4} + 185x^{5} + 55x^{6} - 40x^{7}}{1 - 4x + 2x^{2} + 6x^{3} - 4x^{4} - 2x^{5} + x^{6}}.\]
...
\begin{theorem} For A208104, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) - 6\,a(n-3) + 4\,a(n-4) + 2\,a(n-5) - a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\begin{theorem} For A208104, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 45x^{2} - 137x^{3} - 99x^{4} + 185x^{5} + 55x^{6} - 40x^{7}}{1 - 4x + 2x^{2} + 6x^{3} - 4x^{4} - 2x^{5} + x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 169, 361, 841, 2025, 5041, 12769,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208104}{A208104}, revision 9, last modified Jun 28 2018.
