...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207250}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207250}{A207250} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 2*a(n-3) + 13*a(n-4) + 27*a(n-5) + 8*a(n-6) - 4*a(n-7) - 4*a(n-8) - 2*a(n-9) + a(n-10).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(2 + 12*x + 8*x\textasciicircum{}2 + 11*x\textasciicircum{}3 + 38*x\textasciicircum{}4 + 10*x\textasciicircum{}5 - 10*x\textasciicircum{}6 - 6*x\textasciicircum{}7 - 4*x\textasciicircum{}8 + 2*x\textasciicircum{}9) / (1 - 2*x - 7*x\textasciicircum{}2 - 2*x\textasciicircum{}3 - 13*x\textasciicircum{}4 - 27*x\textasciicircum{}5 - 8*x\textasciicircum{}6 + 4*x\textasciicircum{}7 + 4*x\textasciicircum{}8 + 2*x\textasciicircum{}9 - x\textasciicircum{}10). - Colin Barker, Jun 21 2018\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 7\,a(n-2) + 2\,a(n-3) + 13\,a(n-4) + 27\,a(n-5) + 8\,a(n-6) - \\ 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9) + a(n-10). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{8x + 48x^{2} + 32x^{3} + 44x^{4} + 152x^{5} + 40x^{6} - 40x^{7} - 24x^{8} - 16x^{9} + 8x^{10}}{1 - 2x - 7x^{2} - 2x^{3} - 13x^{4} - 27x^{5} - 8x^{6} + 4x^{7} + 4x^{8} + 2x^{9} - x^{10}}.\]
...
\begin{theorem} For A207250, the recurrence $a(n) = 2\,a(n-1) + 7\,a(n-2) + 2\,a(n-3) + 13\,a(n-4) + 27\,a(n-5) + 8\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A207250, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{8x + 48x^{2} + 32x^{3} + 44x^{4} + 152x^{5} + 40x^{6} - 40x^{7} - 24x^{8} - 16x^{9} + 8x^{10}}{1 - 2x - 7x^{2} - 2x^{3} - 13x^{4} - 27x^{5} - 8x^{6} + 4x^{7} + 4x^{8} + 2x^{9} - x^{10}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 64, 216, 940, 3776, 15652, 64176, 263976,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207250}{A207250}, revision 9, last modified Jun 21 2018.
