...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,107$. The last nonvanishing one is at $m = 3$, that is at $n = 34$. After it, more than $S = 51$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
