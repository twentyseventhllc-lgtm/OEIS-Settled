...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A260132}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260132}{A260132} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 01010101 or 01010111\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + a(n-2) + 5*a(n-3) + a(n-4) - 3*a(n-5) - 3*a(n-6) for n>7.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(29 + 35*x + 78*x\textasciicircum{}2 - 15*x\textasciicircum{}3 - 72*x\textasciicircum{}4 - 46*x\textasciicircum{}5 + 5*x\textasciicircum{}6) / (1 - x - x\textasciicircum{}2 - 5*x\textasciicircum{}3 - x\textasciicircum{}4 + 3*x\textasciicircum{}5 + 3*x\textasciicircum{}6). - Colin Barker, Dec 28 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{58x + 70x^{2} + 156x^{3} - 30x^{4} - 144x^{5} - 92x^{6} + 10x^{7}}{1 - x - x^{2} - 5x^{3} - x^{4} + 3x^{5} + 3x^{6}}.\]
...
\begin{theorem} For A260132, the recurrence $a(n) = a(n-1) + a(n-2) + 5\,a(n-3) + a(n-4) - 3\,a(n-5) - 3\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,50$. The last nonvanishing one is at $m = 1$, that is at $n = 7$. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 7$. The theorem is at least as strong.

\begin{theorem} For A260132, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{58x + 70x^{2} + 156x^{3} - 30x^{4} - 144x^{5} - 92x^{6} + 10x^{7}}{1 - x - x^{2} - 5x^{3} - x^{4} + 3x^{5} + 3x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 58, 128, 342, 730, 1626, 3928, 8998, 20376,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260132}{A260132}, revision 7, last modified Dec 28 2018.
