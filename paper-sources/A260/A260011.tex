...
\title{A proof of the conjectured linear recurrence for OEIS A260011}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260011}{A260011} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010101 or 01010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +9*a(n-3) +27*a(n-4) -13*a(n-5) -a(n-6) -54*a(n-7) -129*a(n-8) +13*a(n-9) -2*a(n-10) +48*a(n-11) +108*a(n-12) -4*a(n-13) -8*a(n-15) -16*a(n-16) for n>17\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 9\,a(n-3) + 27\,a(n-4) - 13\,a(n-5) - a(n-6) - 54\,a(n-7) - \\ 129\,a(n-8) + 13\,a(n-9) - 2\,a(n-10) + 48\,a(n-11) + 108\,a(n-12) - 4\,a(n-13) - \\ 8\,a(n-15) - 16\,a(n-16). \end{multline*}
...
\begin{theorem} For A260011, the recurrence $a(n) = 2\,a(n-1) + 9\,a(n-3) + 27\,a(n-4) - 13\,a(n-5) - a(n-6) - 54\,a(n-7) - 129\,a(n-8) + 13\,a(n-9) - 2\,a(n-10) + 48\,a(n-11) + 108\,a(n-12) - 4\,a(n-13) - 8\,a(n-15) - 16\,a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,68$. The last nonvanishing one is at $m = 1$, that is at $n = 17$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 209, 578, 2492, 8450, 25600, 84050, 292422, 985608,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260011}{A260011}, revision 6, last modified Jun 02 2025.
