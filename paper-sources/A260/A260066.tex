...
\title{A proof of the conjectured linear recurrence for OEIS A260066}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260066}{A260066} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-2) +8*a(n-3) +21*a(n-4) -14*a(n-5) -60*a(n-6) -76*a(n-7) -98*a(n-8) +139*a(n-9) +324*a(n-10) +176*a(n-11) +138*a(n-12) -351*a(n-13) -596*a(n-14) -154*a(n-15) +90*a(n-16) +484*a(n-17) +424*a(n-18) +72*a(n-19) -160*a(n-20) -288*a(n-21) for n>25\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-2) + 8\,a(n-3) + 21\,a(n-4) - 14\,a(n-5) - 60\,a(n-6) - 76\,a(n-7) - \\ 98\,a(n-8) + 139\,a(n-9) + 324\,a(n-10) + 176\,a(n-11) + 138\,a(n-12) - 351\,a(n-13) - \\ 596\,a(n-14) - 154\,a(n-15) + 90\,a(n-16) + 484\,a(n-17) + 424\,a(n-18) + 72\,a(n-19) - \\ 160\,a(n-20) - 288\,a(n-21). \end{multline*}
...
That refinement leaves $70$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 43$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A260066, the recurrence of order $21$ displayed in Section 1 holds for every $n > 25$, and fails at $n = 25$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,94$. The last nonvanishing one is at $m = 4$, that is at $n = 25$. After it, more than $S = 43$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 557, 1214, 3825, 7725, 12664, 34917, 89948, 166473,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260066}{A260066}, revision 6, last modified Jun 02 2025.
