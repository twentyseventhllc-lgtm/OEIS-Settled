...
\title{A proof of the conjectured linear recurrence for OEIS A197404}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197404}{A197404} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,1,1,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +4*a(n-2) +8*a(n-3) -37*a(n-4) -13*a(n-5) -58*a(n-6) -814*a(n-7) -2710*a(n-8) -1095*a(n-9) +6385*a(n-10) +15988*a(n-11) +42018*a(n-12) +47855*a(n-13) +32250*a(n-14) -50035*a(n-15) -77306*a(n-16) -41809*a(n-17) -25413*a(n-18) -49387*a(n-19) -14658*a(n-20) +11927*a(n-21) +12328*a(n-22) +6216*a(n-23) +17403*a(n-24) +12464*a(n-25) -363*a(n-26) +6490*a(n-27) -2100*a(n-28) +61*a(n-29) -629*a(n-30) -131*a(n-31) +42*a(n-32) +a(n-33) +a(n-34)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 4\,a(n-2) + 8\,a(n-3) - 37\,a(n-4) - 13\,a(n-5) - 58\,a(n-6) - \\ 814\,a(n-7) - 2710\,a(n-8) - 1095\,a(n-9) + 6385\,a(n-10) + 15988\,a(n-11) + 42018\,a(n-12) + \\ 47855\,a(n-13) + 32250\,a(n-14) - 50035\,a(n-15) - 77306\,a(n-16) - 41809\,a(n-17) - 25413\,a(n-18) - \\ 49387\,a(n-19) - 14658\,a(n-20) + 11927\,a(n-21) + 12328\,a(n-22) + 6216\,a(n-23) + 17403\,a(n-24) + \\ 12464\,a(n-25) - 363\,a(n-26) + 6490\,a(n-27) - 2100\,a(n-28) + 61\,a(n-29) - 629\,a(n-30) - \\ 131\,a(n-31) + 42\,a(n-32) + a(n-33) + a(n-34). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $402$; neither removal changes any count.
...
That refinement leaves $40$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 39$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $39$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A197404, the recurrence of order $34$ displayed in Section 1 holds for every $n \ge 35$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 60, 358, 1626, 7232, 34717, 160988,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197404}{A197404}, revision 9, last modified Oct 03 2025.
