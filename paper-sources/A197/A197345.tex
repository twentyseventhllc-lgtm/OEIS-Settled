...
\title{A proof of the conjectured linear recurrence for OEIS A197345}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197345}{A197345} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,1,1,0 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +8*a(n-3) +52*a(n-4) +40*a(n-5) +33*a(n-6) -34*a(n-7) -471*a(n-8) -603*a(n-9) -944*a(n-10) -786*a(n-11) +1306*a(n-12) +1460*a(n-13) +1840*a(n-14) +2248*a(n-15) -1768*a(n-16) -1536*a(n-17) -192*a(n-18)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 52\,a(n-4) + 40\,a(n-5) + 33\,a(n-6) - \\ 34\,a(n-7) - 471\,a(n-8) - 603\,a(n-9) - 944\,a(n-10) - 786\,a(n-11) + 1306\,a(n-12) + \\ 1460\,a(n-13) + 1840\,a(n-14) + 2248\,a(n-15) - 1768\,a(n-16) - 1536\,a(n-17) - 192\,a(n-18). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $212$; neither removal changes any count.
...
\begin{theorem} For A197345, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 52\,a(n-4) + 40\,a(n-5) + 33\,a(n-6) - 34\,a(n-7) - 471\,a(n-8) - 603\,a(n-9) - 944\,a(n-10) - 786\,a(n-11) + 1306\,a(n-12) + 1460\,a(n-13) + 1840\,a(n-14) + 2248\,a(n-15) - 1768\,a(n-16) - 1536\,a(n-17) - 192\,a(n-18)$ holds for every $n \ge 19$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 9, 18, 83, 245, 914, 3155, 11287,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197345}{A197345}, revision 9, last modified Oct 03 2025.
