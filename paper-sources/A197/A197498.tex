...
\title{A proof of the conjectured linear recurrence for OEIS A197498}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197498}{A197498} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,3,1,1,0 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +7*a(n-3) +15*a(n-4) +15*a(n-5) +6*a(n-6) -9*a(n-7) -14*a(n-8) -46*a(n-9) -63*a(n-10) +3*a(n-11) +a(n-12) +39*a(n-13) -16*a(n-14) +39*a(n-15) +27*a(n-16) +32*a(n-17) -3*a(n-18) -11*a(n-19) -14*a(n-20) -8*a(n-21)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 7\,a(n-3) + 15\,a(n-4) + 15\,a(n-5) + 6\,a(n-6) - \\ 9\,a(n-7) - 14\,a(n-8) - 46\,a(n-9) - 63\,a(n-10) + 3\,a(n-11) + a(n-12) + \\ 39\,a(n-13) - 16\,a(n-14) + 39\,a(n-15) + 27\,a(n-16) + 32\,a(n-17) - 3\,a(n-18) - \\ 11\,a(n-19) - 14\,a(n-20) - 8\,a(n-21). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $128$; neither removal changes any count.
...
\begin{theorem} For A197498, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,77$. Every one of them vanished. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 9, 22, 53, 162, 526, 1605, 5011,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197498}{A197498}, revision 9, last modified Oct 03 2025.
