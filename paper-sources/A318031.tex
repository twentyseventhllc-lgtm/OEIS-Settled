...
\title{A proof of the conjectured linear recurrence for OEIS A318031}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A318031}{A318031} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 0, 1, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-3) +a(n-5) -a(n-6)\end{quote}
...
\begin{theorem} For A318031, the recurrence $a(n) = a(n-1) + 4\,a(n-3) + a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 3, 6, 11, 22, 46, 91, 182,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A318031}{A318031}, revision 4, last modified Aug 13 2018.
