...
\title{A proof of the conjectured linear recurrence for OEIS A297069}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297069}{A297069} as

\begin{quote}\itshape Number of nX4 0..1 arrays with no 1 adjacent to 1 king-move neighboring 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 15*a(n-1) -19*a(n-2) +9*a(n-3) -314*a(n-4) -2060*a(n-5) +2472*a(n-6) +13839*a(n-7) +10226*a(n-8) -11979*a(n-9) -23610*a(n-10) -6595*a(n-11) +10275*a(n-12) +14004*a(n-13) +13286*a(n-14) +2169*a(n-15) -5262*a(n-16) -4234*a(n-17) -6020*a(n-18) -2763*a(n-19) +1073*a(n-20) +538*a(n-21) +112*a(n-22) +96*a(n-23)\end{quote}
...
\begin{multline*} a(n) = 15\,a(n-1) - 19\,a(n-2) + 9\,a(n-3) - 314\,a(n-4) - 2060\,a(n-5) + 2472\,a(n-6) + \\ 13839\,a(n-7) + 10226\,a(n-8) - 11979\,a(n-9) - 23610\,a(n-10) - 6595\,a(n-11) + 10275\,a(n-12) + \\ 14004\,a(n-13) + 13286\,a(n-14) + 2169\,a(n-15) - 5262\,a(n-16) - 4234\,a(n-17) - 6020\,a(n-18) - \\ 2763\,a(n-19) + 1073\,a(n-20) + 538\,a(n-21) + 112\,a(n-22) + 96\,a(n-23). \end{multline*}
...
\begin{theorem} For A297069, the recurrence of order $23$ displayed in Section 1 holds for every $n \ge 24$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,74$. Every one of them vanished. After it, more than $S = 29$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 103, 1292, 16059, 214205, 2883705, 38753117, 521094462,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297069}{A297069}, revision 4, last modified Dec 24 2017.
