...
\title{A proof of the conjectured linear recurrence for OEIS A207764}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207764}{A207764} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +15*a(n-3) -28*a(n-4) +16*a(n-5) -51*a(n-6) +83*a(n-7) -21*a(n-8) +65*a(n-9) -150*a(n-10) +64*a(n-11) -54*a(n-12) +132*a(n-13) -76*a(n-14) +26*a(n-15) -40*a(n-16) +20*a(n-17) for n>19\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + 15\,a(n-3) - 28\,a(n-4) + 16\,a(n-5) - 51\,a(n-6) + \\ 83\,a(n-7) - 21\,a(n-8) + 65\,a(n-9) - 150\,a(n-10) + 64\,a(n-11) - 54\,a(n-12) + \\ 132\,a(n-13) - 76\,a(n-14) + 26\,a(n-15) - 40\,a(n-16) + 20\,a(n-17). \end{multline*}
...
That refinement leaves $33$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 20$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207764, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + 15\,a(n-3) - 28\,a(n-4) + 16\,a(n-5) - 51\,a(n-6) + 83\,a(n-7) - 21\,a(n-8) + 65\,a(n-9) - 150\,a(n-10) + 64\,a(n-11) - 54\,a(n-12) + 132\,a(n-13) - 76\,a(n-14) + 26\,a(n-15) - 40\,a(n-16) + 20\,a(n-17)$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,68$. The last nonvanishing one is at $m = 2$, that is at $n = 19$. After it, more than $S = 20$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 193, 663, 1664, 4018, 11509, 30943,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207764}{A207764}, revision 9, last modified Oct 03 2025.
