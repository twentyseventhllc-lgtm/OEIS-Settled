...
\title{A proof of the conjectured linear recurrence for OEIS A208839}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208839}{A208839} as

\begin{quote}\itshape Number of nX7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}
...
\begin{theorem} For A208839, the recurrence $a(n) = 11\,a(n-1) - 17\,a(n-2) - 124\,a(n-3) + 276\,a(n-4) + 396\,a(n-5) - 902\,a(n-6) - 462\,a(n-7) + 946\,a(n-8) + 220\,a(n-9) - 340\,a(n-10) - 44\,a(n-11) + 39\,a(n-12) + 3\,a(n-13) - a(n-14)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 42, 1764, 7086, 31419, 169974, 992574, 6206445, 40122936,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208839}{A208839}, revision 9, last modified Oct 03 2025.
