...
\title{Proofs of the conjectured column and row recurrences for OEIS A229934}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A229934}{A229934} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..2 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value 2-x(i,j)\end{quote}
...
k=3: [order 49] for n>50.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Oct 04 2013). As of revision 6, last modified Apr 30 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 3$ of A229934, the recurrence $a(n) = 0$ holds for every $n > 50$, and fails at $n = 50$.\end{theorem}

{\itshape Proof.} The width is $3$; the digraph has $757$ states, $757$ after trimming, and $S = 56$ blocks after refinement. The model reproduces every published value of column $k = 3$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 50$; after that point more than $S = 56$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A229934}{A229934}, revision 6, last modified Apr 30 2022.
