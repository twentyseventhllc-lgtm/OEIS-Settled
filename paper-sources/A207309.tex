...
\title{A proof of the conjectured linear recurrence for OEIS A207309}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207309}{A207309} as

\begin{quote}\itshape Number of 6Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +13*a(n-3) +18*a(n-4) -2*a(n-5) -30*a(n-6) -59*a(n-7) -25*a(n-8) +16*a(n-9) +68*a(n-10) +44*a(n-11) +3*a(n-12) -42*a(n-13) -23*a(n-14) -3*a(n-15) +17*a(n-16) +a(n-17) -2*a(n-18) -2*a(n-19) +3*a(n-20) -a(n-21) for n>22\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 13\,a(n-3) + 18\,a(n-4) - 2\,a(n-5) - 30\,a(n-6) - \\ 59\,a(n-7) - 25\,a(n-8) + 16\,a(n-9) + 68\,a(n-10) + 44\,a(n-11) + 3\,a(n-12) - \\ 42\,a(n-13) - 23\,a(n-14) - 3\,a(n-15) + 17\,a(n-16) + a(n-17) - 2\,a(n-18) - \\ 2\,a(n-19) + 3\,a(n-20) - a(n-21). \end{multline*}
...
\begin{theorem} For A207309, the recurrence of order $21$ displayed in Section 1 holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,72$. The last nonvanishing one is at $m = 1$, that is at $n = 22$. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 556, 2239, 7093, 23091, 79802, 271023,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207309}{A207309}, revision 9, last modified Oct 03 2025.
