...
\title{A proof of the conjectured linear recurrence for OEIS A229691}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A229691}{A229691} as

\begin{quote}\itshape Number of defective 3-colorings of an nX5 0..2 array connected horizontally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 45*a(n-1) -729*a(n-2) +4995*a(n-3) -13122*a(n-4) +14580*a(n-5) -5832*a(n-6) for n>7.\end{quote}
...
The reachable part of the digraph has $688$ states, $428$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 14$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $14\times14$ matrix.
...
\begin{theorem} For A229691, the recurrence $a(n) = 45\,a(n-1) - 729\,a(n-2) + 4995\,a(n-3) - 13122\,a(n-4) + 14580\,a(n-5) - 5832\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,41$. The last nonvanishing one is at $m = 1$, that is at $n = 7$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 1171, 35825, 848937, 17724789, 342532665, 6279934941, 110801828529,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A229691}{A229691}, revision 8, last modified Jul 23 2025.
