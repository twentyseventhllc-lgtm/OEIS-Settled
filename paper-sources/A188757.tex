...
\title{A proof of the conjectured linear recurrence for OEIS A188757}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188757}{A188757} as

\begin{quote}\itshape Number of nX3 binary arrays without the pattern 0 0 1 vertically or horizontally\end{quote}
...
The reachable part of the digraph has $57$ states, $57$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 13$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $13\times13$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188757, the recurrence $a(n) = 8\,a(n-1) - 14\,a(n-2) - 29\,a(n-3) + 90\,a(n-4) + 12\,a(n-5) - 159\,a(n-6) + 36\,a(n-7) + 106\,a(n-8) - 35\,a(n-9) - 22\,a(n-10) + 8\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 240, 1112, 4792, 20129, 82807, 337209,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188757}{A188757}, revision 9, last modified Oct 03 2025.
