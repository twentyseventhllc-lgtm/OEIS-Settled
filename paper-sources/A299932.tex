...
\title{A proof of the conjectured linear recurrence for OEIS A299932}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299932}{A299932} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +2*a(n-2) -19*a(n-3) +15*a(n-4) +3*a(n-5) -3*a(n-6) -2*a(n-7) -10*a(n-8) -3*a(n-9) +2*a(n-10) for n>11\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 2\,a(n-2) - 19\,a(n-3) + 15\,a(n-4) + 3\,a(n-5) - 3\,a(n-6) - \\ 2\,a(n-7) - 10\,a(n-8) - 3\,a(n-9) + 2\,a(n-10). \end{multline*}
...
\begin{theorem} For A299932, the recurrence $a(n) = 7\,a(n-1) + 2\,a(n-2) - 19\,a(n-3) + 15\,a(n-4) + 3\,a(n-5) - 3\,a(n-6) - 2\,a(n-7) - 10\,a(n-8) - 3\,a(n-9) + 2\,a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 130, 902, 6243, 43375, 300901, 2088188,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299932}{A299932}, revision 4, last modified Feb 22 2018.
