...
\title{A proof of the conjectured linear recurrence for OEIS A223956}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223956}{A223956} as

\begin{quote}\itshape Number of nX3 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 20*a(n-1) -105*a(n-2) +51*a(n-3) +589*a(n-4) +1340*a(n-5) -8833*a(n-6) -2855*a(n-7) +30423*a(n-8) +57774*a(n-9) -140760*a(n-10) -176184*a(n-11) +106272*a(n-12) +544320*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 20\,a(n-1) - 105\,a(n-2) + 51\,a(n-3) + 589\,a(n-4) + 1340\,a(n-5) - 8833\,a(n-6) - \\ 2855\,a(n-7) + 30423\,a(n-8) + 57774\,a(n-9) - 140760\,a(n-10) - 176184\,a(n-11) + 106272\,a(n-12) + \\ 544320\,a(n-13). \end{multline*}
...
\begin{theorem} For A223956, the recurrence $a(n) = 20\,a(n-1) - 105\,a(n-2) + 51\,a(n-3) + 589\,a(n-4) + 1340\,a(n-5) - 8833\,a(n-6) - 2855\,a(n-7) + 30423\,a(n-8) + 57774\,a(n-9) - 140760\,a(n-10) - 176184\,a(n-11) + 106272\,a(n-12) + 544320\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,62$. Every one of them vanished. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 295, 3471, 41006, 485714, 5777663, 68892600, 822141033,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223956}{A223956}, revision 8, last modified Oct 03 2025.
