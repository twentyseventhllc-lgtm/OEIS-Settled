...
\title{A proof of the conjectured linear recurrence for OEIS A207706}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207706}{A207706} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +28*a(n-3) +106*a(n-4) -59*a(n-5) +7*a(n-6) -592*a(n-7) -1897*a(n-8) +226*a(n-9) -290*a(n-10) +3421*a(n-11) +10592*a(n-12) -320*a(n-13) +453*a(n-14) -7096*a(n-15) -21514*a(n-16) +149*a(n-17) +669*a(n-18) +5807*a(n-19) +16981*a(n-20) +326*a(n-21) -438*a(n-22) -1964*a(n-23) -5582*a(n-24) -245*a(n-25) +68*a(n-26) +256*a(n-27) +802*a(n-28) +41*a(n-29) -4*a(n-30) -11*a(n-31) -49*a(n-32) -2*a(n-33) +a(n-36)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 28\,a(n-3) + 106\,a(n-4) - 59\,a(n-5) + 7\,a(n-6) - 592\,a(n-7) - \\ 1897\,a(n-8) + 226\,a(n-9) - 290\,a(n-10) + 3421\,a(n-11) + 10592\,a(n-12) - 320\,a(n-13) + \\ 453\,a(n-14) - 7096\,a(n-15) - 21514\,a(n-16) + 149\,a(n-17) + 669\,a(n-18) + 5807\,a(n-19) + \\ 16981\,a(n-20) + 326\,a(n-21) - 438\,a(n-22) - 1964\,a(n-23) - 5582\,a(n-24) - 245\,a(n-25) + \\ 68\,a(n-26) + 256\,a(n-27) + 802\,a(n-28) + 41\,a(n-29) - 4\,a(n-30) - 11\,a(n-31) - \\ 49\,a(n-32) - 2\,a(n-33) + a(n-36). \end{multline*}
...
\begin{theorem} For A207706, the recurrence of order $36$ displayed in Section 1 holds for every $n \ge 37$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,99$. Every one of them vanished. After it, more than $S = 36$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 390, 1521, 8151, 43681, 206910, 980100,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207706}{A207706}, revision 9, last modified Oct 03 2025.
