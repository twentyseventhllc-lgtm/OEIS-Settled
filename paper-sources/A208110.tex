...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208110}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208110}{A208110} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 13*a(n-3) + 166*a(n-4) - 176*a(n-5) - 143*a(n-6) - 1452*a(n-8) + 1331*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(14 + 168*x + 14*x\textasciicircum{}2 - 153*x\textasciicircum{}3 - 319*x\textasciicircum{}4 - 1595*x\textasciicircum{}5 - 121*x\textasciicircum{}6 - 121*x\textasciicircum{}7 + 1331*x\textasciicircum{}8) / ((1 - 2*x - 12*x\textasciicircum{}2 + 11*x\textasciicircum{}3)*(1 + 12*x\textasciicircum{}2 - 22*x\textasciicircum{}4 - 121*x\textasciicircum{}6)). - Colin Barker, Jun 28 2018\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 13\,a(n-3) + 166\,a(n-4) - 176\,a(n-5) - 143\,a(n-6) - 1452\,a(n-8) + \\ 1331\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{14x + 168x^{2} + 14x^{3} - 153x^{4} - 319x^{5} - 1595x^{6} - 121x^{7} - 121x^{8} + 1331x^{9}}{1 - 2x - 13x^{3} - 166x^{4} + 176x^{5} + 143x^{6} + 1452x^{8} - 1331x^{9}}.\]
...
\begin{theorem} For A208110, the recurrence $a(n) = 2\,a(n-1) + 13\,a(n-3) + 166\,a(n-4) - 176\,a(n-5) - 143\,a(n-6) - 1452\,a(n-8) + 1331\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208110, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{14x + 168x^{2} + 14x^{3} - 153x^{4} - 319x^{5} - 1595x^{6} - 121x^{7} - 121x^{8} + 1331x^{9}}{1 - 2x - 13x^{3} - 166x^{4} + 176x^{5} + 143x^{6} + 1452x^{8} - 1331x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 406, 841, 6235, 46225, 134160, 389376,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208110}{A208110}, revision 9, last modified Jun 28 2018.
