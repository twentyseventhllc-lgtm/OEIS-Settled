...
\title{A proof of the conjectured linear recurrence for OEIS A300375}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300375}{A300375} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-2) +9*a(n-3) +9*a(n-4) +3*a(n-5) -8*a(n-6) -a(n-7) -18*a(n-8) -24*a(n-9) -45*a(n-10) -10*a(n-11) -15*a(n-12) +39*a(n-13) -21*a(n-14) +9*a(n-15) -7*a(n-16) -13*a(n-17) +14*a(n-18) -5*a(n-19) +3*a(n-20) -2*a(n-22) +a(n-23) for n>25\end{quote}
...
\begin{theorem} For A300375, the recurrence of order $23$ displayed in Section 1 holds for every $n > 25$, and fails at $n = 25$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,83$. The last nonvanishing one is at $m = 2$, that is at $n = 25$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 2, 4, 11, 8, 58, 131, 306,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300375}{A300375}, revision 4, last modified Mar 04 2018.
