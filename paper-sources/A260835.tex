...
\title{A proof of the conjectured linear recurrence for OEIS A260835}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260835}{A260835} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +5*a(n-3) -a(n-4) -3*a(n-5) -5*a(n-6) +3*a(n-9) -2*a(n-10) -5*a(n-11) -2*a(n-12) -a(n-13) +5*a(n-14) -2*a(n-15) -2*a(n-17) +2*a(n-18) for n>19\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 5\,a(n-3) - a(n-4) - 3\,a(n-5) - 5\,a(n-6) + 3\,a(n-9) - \\ 2\,a(n-10) - 5\,a(n-11) - 2\,a(n-12) - a(n-13) + 5\,a(n-14) - 2\,a(n-15) - \\ 2\,a(n-17) + 2\,a(n-18). \end{multline*}
...
\begin{theorem} For A260835, the recurrence $a(n) = a(n-1) + 5\,a(n-3) - a(n-4) - 3\,a(n-5) - 5\,a(n-6) + 3\,a(n-9) - 2\,a(n-10) - 5\,a(n-11) - 2\,a(n-12) - a(n-13) + 5\,a(n-14) - 2\,a(n-15) - 2\,a(n-17) + 2\,a(n-18)$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,78$. The last nonvanishing one is at $m = 1$, that is at $n = 19$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 82, 131, 288, 496, 796, 1645, 2976, 4890,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260835}{A260835}, revision 6, last modified Jun 02 2025.
