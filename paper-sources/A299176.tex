...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,94$. The last nonvanishing one is at $m = 6$, that is at $n = 28$. After it, more than $S = 42$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
