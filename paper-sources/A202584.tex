...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A202584}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A202584}{A202584} as

\begin{quote}\itshape Number of (n+2) X 3 binary arrays avoiding patterns 001 and 100 in rows, columns and nw-to-se diagonals\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +5*a(n-2) -11*a(n-3) -10*a(n-4) +9*a(n-5) +12*a(n-6) -2*a(n-7) -6*a(n-8) +a(n-10).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(96 - 28*x - 456*x\textasciicircum{}2 - 102*x\textasciicircum{}3 + 510*x\textasciicircum{}4 + 343*x\textasciicircum{}5 - 192*x\textasciicircum{}6 - 210*x\textasciicircum{}7 + 23*x\textasciicircum{}8 + 36*x\textasciicircum{}9) / ((1 - x)*(1 + x - x\textasciicircum{}2)*(1 - x - x\textasciicircum{}2)*(1 - 2*x - 4*x\textasciicircum{}2 - 2*x\textasciicircum{}3 + x\textasciicircum{}4 + x\textasciicircum{}5)). - Colin Barker, Feb 14 2018\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Feb 14 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 3\,a(n-1) + 5\,a(n-2) - 11\,a(n-3) - 10\,a(n-4) + 9\,a(n-5) + 12\,a(n-6) - \\ 2\,a(n-7) - 6\,a(n-8) + a(n-10). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{96x - 28x^{2} - 456x^{3} - 102x^{4} + 510x^{5} + 343x^{6} - 192x^{7} - 210x^{8} + 23x^{9} + 36x^{10}}{1 - 3x - 5x^{2} + 11x^{3} + 10x^{4} - 9x^{5} - 12x^{6} + 2x^{7} + 6x^{8} - x^{10}}.\]
...
\begin{theorem} For A202584, the recurrence $a(n) = 3\,a(n-1) + 5\,a(n-2) - 11\,a(n-3) - 10\,a(n-4) + 9\,a(n-5) + 12\,a(n-6) - 2\,a(n-7) - 6\,a(n-8) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A202584, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{96x - 28x^{2} - 456x^{3} - 102x^{4} + 510x^{5} + 343x^{6} - 192x^{7} - 210x^{8} + 23x^{9} + 36x^{10}}{1 - 3x - 5x^{2} + 11x^{3} + 10x^{4} - 9x^{5} - 12x^{6} + 2x^{7} + 6x^{8} - x^{10}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 96, 260, 804, 2554, 8372, 27649, 91973, 306486,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A202584}{A202584}, revision 9, last modified Feb 14 2018.
