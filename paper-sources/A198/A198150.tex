...
\title{A proof of the conjectured linear recurrence for OEIS A198150}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A198150}{A198150} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,3,0,1,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +38*a(n-3) +40*a(n-4) +21*a(n-5) -127*a(n-6) -313*a(n-7) -143*a(n-8) +681*a(n-9) +1988*a(n-10) +1587*a(n-11) -1232*a(n-12) -4569*a(n-13) -5344*a(n-14) -992*a(n-15) +3626*a(n-16) +4576*a(n-17) +2900*a(n-18) +162*a(n-19) -844*a(n-20) -954*a(n-21) -250*a(n-22) +190*a(n-23) +34*a(n-24) -a(n-25)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 38\,a(n-3) + 40\,a(n-4) + 21\,a(n-5) - 127\,a(n-6) - \\ 313\,a(n-7) - 143\,a(n-8) + 681\,a(n-9) + 1988\,a(n-10) + 1587\,a(n-11) - 1232\,a(n-12) - \\ 4569\,a(n-13) - 5344\,a(n-14) - 992\,a(n-15) + 3626\,a(n-16) + 4576\,a(n-17) + 2900\,a(n-18) + \\ 162\,a(n-19) - 844\,a(n-20) - 954\,a(n-21) - 250\,a(n-22) + 190\,a(n-23) + 34\,a(n-24) - \\ a(n-25). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 4, \tau(1) = 3, \tau(2) = 0, \tau(3) = 1, \tau(4) = 1. The condition is that for every cell,
...
\begin{theorem} For A198150, the recurrence of order $25$ displayed in Section 1 holds for every $n \ge 26$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 12, 54, 240, 1170, 5330, 24689, 116890,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A198150}{A198150}, revision 9, last modified Oct 03 2025.
