...
\title{A proof of the conjectured linear recurrence for OEIS A316949}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316949}{A316949} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) +38*a(n-2) +130*a(n-3) +69*a(n-4) +144*a(n-5) -193*a(n-6) -26*a(n-7) -60*a(n-8) +166*a(n-9) -97*a(n-10) +44*a(n-11) -44*a(n-12) +16*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 12\,a(n-1) + 38\,a(n-2) + 130\,a(n-3) + 69\,a(n-4) + 144\,a(n-5) - 193\,a(n-6) - \\ 26\,a(n-7) - 60\,a(n-8) + 166\,a(n-9) - 97\,a(n-10) + 44\,a(n-11) - 44\,a(n-12) + \\ 16\,a(n-13). \end{multline*}
...
\begin{theorem} For A316949, the recurrence $a(n) = 12\,a(n-1) + 38\,a(n-2) + 130\,a(n-3) + 69\,a(n-4) + 144\,a(n-5) - 193\,a(n-6) - 26\,a(n-7) - 60\,a(n-8) + 166\,a(n-9) - 97\,a(n-10) + 44\,a(n-11) - 44\,a(n-12) + 16\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 98, 1240, 18956, 287292, 4335826, 65510494, 989703110,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316949}{A316949}, revision 4, last modified Jul 17 2018.
