...
\title{A proof of the conjectured linear recurrence for OEIS A197745}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197745}{A197745} as

\begin{quote}\itshape Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,0,1,0 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +26*a(n-3) +20*a(n-4) +24*a(n-5) -62*a(n-6) -166*a(n-7) -99*a(n-8) +128*a(n-9) +383*a(n-10) +75*a(n-11) -563*a(n-12) -540*a(n-13) +86*a(n-14) +624*a(n-15) +663*a(n-16) +220*a(n-17) -159*a(n-18) -266*a(n-19) -229*a(n-20) -125*a(n-21) -30*a(n-22) +12*a(n-23) +4*a(n-24).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Oct 17 2011).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 10, last modified Jan 16 2024, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 26\,a(n-3) + 20\,a(n-4) + 24\,a(n-5) - 62\,a(n-6) - \\ 166\,a(n-7) - 99\,a(n-8) + 128\,a(n-9) + 383\,a(n-10) + 75\,a(n-11) - 563\,a(n-12) - \\ 540\,a(n-13) + 86\,a(n-14) + 624\,a(n-15) + 663\,a(n-16) + 220\,a(n-17) - 159\,a(n-18) - \\ 266\,a(n-19) - 229\,a(n-20) - 125\,a(n-21) - 30\,a(n-22) + 12\,a(n-23) + 4\,a(n-24). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 3, \tau(1) = 3, \tau(2) = 0, \tau(3) = 1, \tau(4) = 0. The condition is that for every cell,
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $27$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A197745, the recurrence of order $24$ displayed in Section 1 holds for every $n \ge 25$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,82$. Every one of them vanished. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 12, 66, 212, 921, 4086, 17332, 75122,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197745}{A197745}, revision 10, last modified Jan 16 2024.
