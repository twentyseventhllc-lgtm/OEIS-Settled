...
k=1: a(n) = a(n-1)\\k=2: a(n) = a(n-1) +3*a(n-2) +2*a(n-3)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 27 2018). As of revision 4, last modified Feb 27 2018, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
