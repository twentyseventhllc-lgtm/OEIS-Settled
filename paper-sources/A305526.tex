...
\title{A proof of the conjectured linear recurrence for OEIS A305526}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305526}{A305526} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -4*a(n-2) +28*a(n-3) -411*a(n-4) +338*a(n-5) +857*a(n-6) -247*a(n-7) +155*a(n-8) -1915*a(n-9) +7665*a(n-10) -11746*a(n-11) +5851*a(n-12) -15110*a(n-13) -1432*a(n-14) +49754*a(n-15) -26190*a(n-16) +52001*a(n-17) -260844*a(n-18) +179368*a(n-19) -30268*a(n-20) -258974*a(n-21) +645731*a(n-22) -479209*a(n-23) -129902*a(n-24) -300495*a(n-25) -507419*a(n-26) +168476*a(n-27) -99617*a(n-28) +197668*a(n-29) +23175*a(n-30) +47733*a(n-31) +14282*a(n-32) +24379*a(n-33) +13120*a(n-34) +7194*a(n-35) +3784*a(n-36) -672*a(n-37) -234*a(n-38) for n>39\end{quote}
...
\begin{multline*} a(n) = 9\,a(n-1) - 4\,a(n-2) + 28\,a(n-3) - 411\,a(n-4) + 338\,a(n-5) + 857\,a(n-6) - \\ 247\,a(n-7) + 155\,a(n-8) - 1915\,a(n-9) + 7665\,a(n-10) - 11746\,a(n-11) + 5851\,a(n-12) - \\ 15110\,a(n-13) - 1432\,a(n-14) + 49754\,a(n-15) - 26190\,a(n-16) + 52001\,a(n-17) - 260844\,a(n-18) + \\ 179368\,a(n-19) - 30268\,a(n-20) - 258974\,a(n-21) + 645731\,a(n-22) - 479209\,a(n-23) - 129902\,a(n-24) - \\ 300495\,a(n-25) - 507419\,a(n-26) + 168476\,a(n-27) - 99617\,a(n-28) + 197668\,a(n-29) + 23175\,a(n-30) + \\ 47733\,a(n-31) + 14282\,a(n-32) + 24379\,a(n-33) + 13120\,a(n-34) + 7194\,a(n-35) + 3784\,a(n-36) - \\ 672\,a(n-37) - 234\,a(n-38). \end{multline*}
...
\begin{theorem} For A305526, the recurrence of order $38$ displayed in Section 1 holds for every $n > 39$, and fails at $n = 39$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 112, 880, 7385, 61139, 506359, 4205030, 34889423,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305526}{A305526}, revision 4, last modified Jun 04 2018.
