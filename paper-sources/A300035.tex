...
k=1: a(n) = a(n-1)\\k=2: a(n) = 5*a(n-2) +8*a(n-3) +4*a(n-4)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 23 2018). As of revision 4, last modified Feb 23 2018, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
