...
\title{A proof of the conjectured linear recurrence for OEIS A302363}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302363}{A302363} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -7*a(n-2) +10*a(n-3) -30*a(n-4) -21*a(n-5) -3*a(n-6) -68*a(n-7) +280*a(n-8) +414*a(n-9) +164*a(n-10) -423*a(n-11) -1527*a(n-12) +833*a(n-13) +1714*a(n-14) -2022*a(n-15) -1901*a(n-16) +367*a(n-17) +2024*a(n-18) +923*a(n-19) +66*a(n-20) -142*a(n-21) -5380*a(n-22) +4543*a(n-23) +13152*a(n-24) -11763*a(n-25) -12833*a(n-26) +16700*a(n-27) +4765*a(n-28) -15572*a(n-29) +1243*a(n-30) +9288*a(n-31) -3398*a(n-32) -4331*a(n-33) +2341*a(n-34) +1523*a(n-35) -1099*a(n-36) -619*a(n-37) +631*a(n-38) +476*a(n-39) -262*a(n-40) -191*a(n-41) +217*a(n-42) -15*a(n-43) -90*a(n-44) +18*a(n-45) +6*a(n-46) -14*a(n-47) +4*a(n-48) +6*a(n-49) -2*a(n-50) for n>53\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 7\,a(n-2) + 10\,a(n-3) - 30\,a(n-4) - 21\,a(n-5) - 3\,a(n-6) - \\ 68\,a(n-7) + 280\,a(n-8) + 414\,a(n-9) + 164\,a(n-10) - 423\,a(n-11) - 1527\,a(n-12) + \\ 833\,a(n-13) + 1714\,a(n-14) - 2022\,a(n-15) - 1901\,a(n-16) + 367\,a(n-17) + 2024\,a(n-18) + \\ 923\,a(n-19) + 66\,a(n-20) - 142\,a(n-21) - 5380\,a(n-22) + 4543\,a(n-23) + 13152\,a(n-24) - \\ 11763\,a(n-25) - 12833\,a(n-26) + 16700\,a(n-27) + 4765\,a(n-28) - 15572\,a(n-29) + 1243\,a(n-30) + \\ 9288\,a(n-31) - 3398\,a(n-32) - 4331\,a(n-33) + 2341\,a(n-34) + 1523\,a(n-35) - 1099\,a(n-36) - \\ 619\,a(n-37) + 631\,a(n-38) + 476\,a(n-39) - 262\,a(n-40) - 191\,a(n-41) + 217\,a(n-42) - \\ 15\,a(n-43) - 90\,a(n-44) + 18\,a(n-45) + 6\,a(n-46) - 14\,a(n-47) + 4\,a(n-48) + \\ 6\,a(n-49) - 2\,a(n-50). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $243$; neither removal changes any count.
...
\begin{theorem} For A302363, the recurrence of order $50$ displayed in Section 1 holds for every $n > 53$, and fails at $n = 53$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,133$. The last nonvanishing one is at $m = 3$, that is at $n = 53$. After it, more than $S = 54$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 20, 20, 77, 209, 774, 3143, 13556,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302363}{A302363}, revision 4, last modified Apr 06 2018.
