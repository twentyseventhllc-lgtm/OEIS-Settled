...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207591}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207591}{A207591} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-2) + 2*a(n-3) - 10*a(n-4) + 2*a(n-6) for n>8.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 9*x*(1 - x)*(1 + 10*x + 18*x\textasciicircum{}2 - 8*x\textasciicircum{}3 - 22*x\textasciicircum{}4 + 2*x\textasciicircum{}5 + 4*x\textasciicircum{}6) / (1 - 8*x\textasciicircum{}2 - 2*x\textasciicircum{}3 + 10*x\textasciicircum{}4 - 2*x\textasciicircum{}6). - Colin Barker, Jun 24 2018\end{quote}
...
\[a(n) = 8\,a(n-2) + 2\,a(n-3) - 10\,a(n-4) + 2\,a(n-6).\]

stated for $n > 8$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 81x^{2} + 72x^{3} - 234x^{4} - 126x^{5} + 216x^{6} + 18x^{7} - 36x^{8}}{1 - 8x^{2} - 2x^{3} + 10x^{4} - 2x^{6}}.\]
...
\begin{theorem} For A207591, the recurrence $a(n) = 8\,a(n-2) + 2\,a(n-3) - 10\,a(n-4) + 2\,a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}
...
\begin{theorem} For A207591, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 81x^{2} + 72x^{3} - 234x^{4} - 126x^{5} + 216x^{6} + 18x^{7} - 36x^{8}}{1 - 8x^{2} - 2x^{3} + 10x^{4} - 2x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 144, 432, 1098, 3150, 8244, 23202,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207591}{A207591}, revision 12, last modified Jun 24 2018.
