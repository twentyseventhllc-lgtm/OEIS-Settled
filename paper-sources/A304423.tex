...
\title{A proof of the conjectured linear recurrence for OEIS A304423}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304423}{A304423} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +48*a(n-2) -12*a(n-3) -721*a(n-4) -2134*a(n-5) -2589*a(n-6) +1722*a(n-7) +7674*a(n-8) +10350*a(n-9) +4698*a(n-10) -1865*a(n-11) -5462*a(n-12) -2001*a(n-13) -4274*a(n-14) -7320*a(n-15) -6688*a(n-16) -1106*a(n-17) +2603*a(n-18) +631*a(n-19) +1682*a(n-20) +357*a(n-21) +1545*a(n-22) -138*a(n-23) -106*a(n-24) -73*a(n-25) +61*a(n-26) +20*a(n-27) for n>28\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 48\,a(n-2) - 12\,a(n-3) - 721\,a(n-4) - 2134\,a(n-5) - 2589\,a(n-6) + \\ 1722\,a(n-7) + 7674\,a(n-8) + 10350\,a(n-9) + 4698\,a(n-10) - 1865\,a(n-11) - 5462\,a(n-12) - \\ 2001\,a(n-13) - 4274\,a(n-14) - 7320\,a(n-15) - 6688\,a(n-16) - 1106\,a(n-17) + 2603\,a(n-18) + \\ 631\,a(n-19) + 1682\,a(n-20) + 357\,a(n-21) + 1545\,a(n-22) - 138\,a(n-23) - 106\,a(n-24) - \\ 73\,a(n-25) + 61\,a(n-26) + 20\,a(n-27). \end{multline*}
...
\begin{theorem} For A304423, the recurrence of order $27$ displayed in Section 1 holds for every $n > 28$, and fails at $n = 28$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 98, 836, 9304, 98190, 1043316, 11085965, 117776344,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304423}{A304423}, revision 4, last modified May 12 2018.
