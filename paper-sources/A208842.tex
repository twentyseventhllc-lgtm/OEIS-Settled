...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208842}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208842}{A208842} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 12*a(n-2) - 11*a(n-3).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 14*x*(1 + 12*x - 11*x\textasciicircum{}2) / (1 - 2*x - 12*x\textasciicircum{}2 + 11*x\textasciicircum{}3). - Colin Barker, Jul 07 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{14x + 168x^{2} - 154x^{3}}{1 - 2x - 12x^{2} + 11x^{3}}.\]
...
For scale: at $n = 8$ there are $2^{40}$ arrays, about $10^{12}$, against $4$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A208842, the recurrence $a(n) = 2\,a(n-1) + 12\,a(n-2) - 11\,a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208842, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{14x + 168x^{2} - 154x^{3}}{1 - 2x - 12x^{2} + 11x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 406, 3010, 8736, 49126, 169974, 833364,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208842}{A208842}, revision 9, last modified Jul 07 2018.
