...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207597}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207597}{A207597} as

\begin{quote}\itshape Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 25*n\textasciicircum{}4 + 50*n\textasciicircum{}3 - 25*n\textasciicircum{}2 - 50*n + 25.\end{quote}

\begin{quote}\ttfamily G.f.: 25*x*(1 + 20*x + 6*x\textasciicircum{}2 - 4*x\textasciicircum{}3 + x\textasciicircum{}4) / (1 - x)\textasciicircum{}5.\end{quote}
...
\[a(n) = 25 - 50n - 25n^{2} + 50n^{3} + 25n^{4}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{25x + 500x^{2} + 150x^{3} - 100x^{4} + 25x^{5}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}.\]
...
\begin{theorem} For A207597, $a(n)$ is the polynomial $25 - 50n - 25n^{2} + 50n^{3} + 25n^{4}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A207597, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{25x + 500x^{2} + 150x^{3} - 100x^{4} + 25x^{5}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}$.\end{theorem}
...
\begin{theorem} For A207597, the recurrence $a(n) = 5\,a(n-1) - 10\,a(n-2) + 10\,a(n-3) - 5\,a(n-4) + a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 25, 625, 3025, 9025, 21025, 42025, 75625, 126025,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207597}{A207597}, revision 8, last modified Jun 25 2018.
