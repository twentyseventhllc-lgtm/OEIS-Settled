...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,159$. The last nonvanishing one is at $m = 2$, that is at $n = 61$. After it, more than $S = 66$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
