...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A223682}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A223682}{A223682} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays with rows and antidiagonals unimodal\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/112)*n\textasciicircum{}8 + (79/1260)*n\textasciicircum{}7 + (121/120)*n\textasciicircum{}6 + (71/36)*n\textasciicircum{}5 + (475/48)*n\textasciicircum{}4 - (1757/180)*n\textasciicircum{}3 + (8893/840)*n\textasciicircum{}2 - (569/84)*n + 9.\end{quote}

\begin{quote}\ttfamily G.f.: x*(16 + 112*x + 304*x\textasciicircum{}2 - 594*x\textasciicircum{}3 + 775*x\textasciicircum{}4 - 442*x\textasciicircum{}5 + 216*x\textasciicircum{}6 - 36*x\textasciicircum{}7 + 9*x\textasciicircum{}8) / (1 - x)\textasciicircum{}9.\end{quote}
...
\[a(n) = 9 - \frac{569}{84}n + \frac{8893}{840}n^{2} - \frac{1757}{180}n^{3} + \frac{475}{48}n^{4} + \frac{71}{36}n^{5} + \frac{121}{120}n^{6} + \frac{79}{1260}n^{7} + \frac{1}{112}n^{8}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{16x + 112x^{2} + 304x^{3} - 594x^{4} + 775x^{5} - 442x^{6} + 216x^{7} - 36x^{8} + 9x^{9}}{1 - 9x + 36x^{2} - 84x^{3} + 126x^{4} - 126x^{5} + 84x^{6} - 36x^{7} + 9x^{8} - x^{9}}.\]
...
\begin{theorem} For A223682, $a(n)$ is the polynomial $9 - \frac{569}{84}n + \frac{8893}{840}n^{2} - \frac{1757}{180}n^{3} + \frac{475}{48}n^{4} + \frac{71}{36}n^{5} + \frac{121}{120}n^{6} + \frac{79}{1260}n^{7} + \frac{1}{112}n^{8}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $8$ is annihilated by the difference operator $(E-1)^{9}$, whose characteristic polynomial is $(t-1)^{9}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 9 = 66$. Its values were computed exactly; all of them vanish, and more than $66$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A223682, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{16x + 112x^{2} + 304x^{3} - 594x^{4} + 775x^{5} - 442x^{6} + 216x^{7} - 36x^{8} + 9x^{9}}{1 - 9x + 36x^{2} - 84x^{3} + 126x^{4} - 126x^{5} + 84x^{6} - 36x^{7} + 9x^{8} - x^{9}}$.\end{theorem}
...
\begin{theorem} For A223682, the recurrence $a(n) = 9\,a(n-1) - 36\,a(n-2) + 84\,a(n-3) - 126\,a(n-4) + 126\,a(n-5) - 84\,a(n-6) + 36\,a(n-7) - 9\,a(n-8) + a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,96$. Every one of them vanished. After it, more than $S = 57$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 2032, 9822, 35509, 105995, 275775, 646407,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A223682}{A223682}, revision 8, last modified Aug 22 2018.
