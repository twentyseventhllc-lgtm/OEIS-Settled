...
\title{A proof of the conjectured linear recurrence for OEIS A304890}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304890}{A304890} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +11*a(n-2) -50*a(n-3) -107*a(n-4) +164*a(n-5) +708*a(n-6) +258*a(n-7) -2532*a(n-8) -3646*a(n-9) +2761*a(n-10) +13804*a(n-11) +8446*a(n-12) -21154*a(n-13) -47250*a(n-14) -10914*a(n-15) +107499*a(n-16) +142066*a(n-17) -105426*a(n-18) -363420*a(n-19) -154022*a(n-20) +480595*a(n-21) +608522*a(n-22) -60692*a(n-23) -841802*a(n-24) -653368*a(n-25) +308330*a(n-26) +953192*a(n-27) +471156*a(n-28) -518499*a(n-29) -662721*a(n-30) -5905*a(n-31) +315496*a(n-32) +93165*a(n-33) -26826*a(n-34) +40184*a(n-35) -12298*a(n-36) -84979*a(n-37) -21668*a(n-38) +49569*a(n-39) +20751*a(n-40) -16407*a(n-41) -7208*a(n-42) +3391*a(n-43) +1365*a(n-44) -413*a(n-45) -170*a(n-46) +30*a(n-47) +12*a(n-48) -2*a(n-49) for n>52\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 11\,a(n-2) - 50\,a(n-3) - 107\,a(n-4) + 164\,a(n-5) + 708\,a(n-6) + \\ 258\,a(n-7) - 2532\,a(n-8) - 3646\,a(n-9) + 2761\,a(n-10) + 13804\,a(n-11) + 8446\,a(n-12) - \\ 21154\,a(n-13) - 47250\,a(n-14) - 10914\,a(n-15) + 107499\,a(n-16) + 142066\,a(n-17) - 105426\,a(n-18) - \\ 363420\,a(n-19) - 154022\,a(n-20) + 480595\,a(n-21) + 608522\,a(n-22) - 60692\,a(n-23) - 841802\,a(n-24) - \\ 653368\,a(n-25) + 308330\,a(n-26) + 953192\,a(n-27) + 471156\,a(n-28) - 518499\,a(n-29) - 662721\,a(n-30) - \\ 5905\,a(n-31) + 315496\,a(n-32) + 93165\,a(n-33) - 26826\,a(n-34) + 40184\,a(n-35) - 12298\,a(n-36) - \\ 84979\,a(n-37) - 21668\,a(n-38) + 49569\,a(n-39) + 20751\,a(n-40) - 16407\,a(n-41) - 7208\,a(n-42) + \\ 3391\,a(n-43) + 1365\,a(n-44) - 413\,a(n-45) - 170\,a(n-46) + 30\,a(n-47) + 12\,a(n-48) - \\ 2\,a(n-49). \end{multline*}
...
\begin{theorem} For A304890, the recurrence of order $49$ displayed in Section 1 holds for every $n > 52$, and fails at $n = 52$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,134$. The last nonvanishing one is at $m = 3$, that is at $n = 52$. After it, more than $S = 57$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 24, 40, 246, 899, 4262, 18773, 86217,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304890}{A304890}, revision 4, last modified May 20 2018.
