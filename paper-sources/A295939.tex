...
\title{A proof of the conjectured linear recurrence for OEIS A295939}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295939}{A295939} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with each 1 adjacent to 1 or 3 king-move neighboring 1's\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 5*a(n-2) + 52*a(n-3) - 12*a(n-4) - 55*a(n-5) - 505*a(n-6) - 34*a(n-7) - 70*a(n-8) + 1673*a(n-9) + 259*a(n-10) + 938*a(n-11) - 1632*a(n-12) + 663*a(n-13) - 899*a(n-14) + 985*a(n-15) - 542*a(n-16) + 19*a(n-17) + 89*a(n-18) - 104*a(n-19) + 7*a(n-20) - 14*a(n-21).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Nov 30 2017).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 11, last modified Dec 01 2017, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 5\,a(n-2) + 52\,a(n-3) - 12\,a(n-4) - 55\,a(n-5) - 505\,a(n-6) - \\ 34\,a(n-7) - 70\,a(n-8) + 1673\,a(n-9) + 259\,a(n-10) + 938\,a(n-11) - 1632\,a(n-12) + \\ 663\,a(n-13) - 899\,a(n-14) + 985\,a(n-15) - 542\,a(n-16) + 19\,a(n-17) + 89\,a(n-18) - \\ 104\,a(n-19) + 7\,a(n-20) - 14\,a(n-21). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $164$; neither removal changes any count.
...
\begin{theorem} For A295939, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 33, 120, 534, 2976, 13759, 65009, 325008,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295939}{A295939}, revision 11, last modified Dec 01 2017.
