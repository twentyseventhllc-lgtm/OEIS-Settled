...
k=1: a(n) = 72*a(n-2) -1712*a(n-4) +13440*a(n-6).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 29 2013). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
