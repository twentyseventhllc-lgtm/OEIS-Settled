...
\title{A proof of the conjectured linear recurrence for OEIS A196133}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196133}{A196133} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,2,1,3,4 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +a(n-3) +3*a(n-4) +3*a(n-5) +6*a(n-6) -5*a(n-7) -14*a(n-8) -17*a(n-9) -32*a(n-10) -25*a(n-11) -38*a(n-12) -11*a(n-13) +19*a(n-14) +39*a(n-15) +42*a(n-16) +6*a(n-17) +18*a(n-18) +20*a(n-19) +32*a(n-20) +24*a(n-21)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 6\,a(n-6) - \\ 5\,a(n-7) - 14\,a(n-8) - 17\,a(n-9) - 32\,a(n-10) - 25\,a(n-11) - 38\,a(n-12) - \\ 11\,a(n-13) + 19\,a(n-14) + 39\,a(n-15) + 42\,a(n-16) + 6\,a(n-17) + 18\,a(n-18) + \\ 20\,a(n-19) + 32\,a(n-20) + 24\,a(n-21). \end{multline*}
...
\begin{theorem} For A196133, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,82$. Every one of them vanished. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 4, 19, 31, 70, 117, 253,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196133}{A196133}, revision 9, last modified Oct 03 2025.
