...
\title{Proofs of the conjectured column and row recurrences for OEIS A301407}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301407}{A301407} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = 2*a(n-1)\\k=2: a(n) = 4*a(n-1)\\k=3: a(n) = 7*a(n-1) +7*a(n-2)\\k=4: a(n) = 13*a(n-1) +40*a(n-2) +9*a(n-3) -29*a(n-4) +4*a(n-5)\end{quote}
...
\begin{theorem} For column $k = 1$ of A301407, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A301407, the recurrence $a(n) = 4\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A301407, the recurrence $a(n) = 7\,a(n-1) + 7\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A301407, the recurrence $a(n) = 13\,a(n-1) + 40\,a(n-2) + 9\,a(n-3) - 29\,a(n-4) + 4\,a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301407}{A301407}, revision 4, last modified Mar 20 2018.
