...
\title{A proof of the conjectured linear recurrence for OEIS A303715}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303715}{A303715} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6)\end{quote}
...
\begin{theorem} For A303715, the recurrence $a(n) = a(n-1) + a(n-2) + 3\,a(n-3) + a(n-4) - a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 5, 8, 17, 36, 76, 161, 349,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303715}{A303715}, revision 4, last modified Apr 29 2018.
