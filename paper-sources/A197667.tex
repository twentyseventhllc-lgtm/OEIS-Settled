...
\title{A proof of the conjectured linear recurrence for OEIS A197667}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197667}{A197667} as

\begin{quote}\itshape Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,0,1,0,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +7*a(n-2) -24*a(n-3) -44*a(n-4) +67*a(n-5) +50*a(n-6) -412*a(n-7) -2205*a(n-8) -7418*a(n-9) -6654*a(n-10) -2331*a(n-11) +42455*a(n-12) +97689*a(n-13) +188061*a(n-14) +169272*a(n-15) -162775*a(n-16) -268709*a(n-17) -801522*a(n-18) -429147*a(n-19) +162997*a(n-20) -228546*a(n-21) +1079921*a(n-22) +1138660*a(n-23) +160033*a(n-24) -1361447*a(n-25) -51481*a(n-26) +285711*a(n-27) +152964*a(n-28) -624541*a(n-29) +374389*a(n-30) +62069*a(n-31) -30580*a(n-32) +83333*a(n-33) -134862*a(n-34) +17843*a(n-35) +16897*a(n-36) +7673*a(n-37) -3585*a(n-38) -1901*a(n-39) +2034*a(n-40) -729*a(n-41) +137*a(n-42) -105*a(n-43).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Oct 17 2011).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 7, last modified Sep 09 2022, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 5\,a(n-1) + 7\,a(n-2) - 24\,a(n-3) - 44\,a(n-4) + 67\,a(n-5) + 50\,a(n-6) - \\ 412\,a(n-7) - 2205\,a(n-8) - 7418\,a(n-9) - 6654\,a(n-10) - 2331\,a(n-11) + 42455\,a(n-12) + \\ 97689\,a(n-13) + 188061\,a(n-14) + 169272\,a(n-15) - 162775\,a(n-16) - 268709\,a(n-17) - 801522\,a(n-18) - \\ 429147\,a(n-19) + 162997\,a(n-20) - 228546\,a(n-21) + 1079921\,a(n-22) + 1138660\,a(n-23) + 160033\,a(n-24) - \\ 1361447\,a(n-25) - 51481\,a(n-26) + 285711\,a(n-27) + 152964\,a(n-28) - 624541\,a(n-29) + 374389\,a(n-30) + \\ 62069\,a(n-31) - 30580\,a(n-32) + 83333\,a(n-33) - 134862\,a(n-34) + 17843\,a(n-35) + 16897\,a(n-36) + \\ 7673\,a(n-37) - 3585\,a(n-38) - 1901\,a(n-39) + 2034\,a(n-40) - 729\,a(n-41) + 137\,a(n-42) - \\ 105\,a(n-43). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $384$; neither removal changes any count.
...
That refinement leaves $49$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 47$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $47$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A197667, the recurrence of order $43$ displayed in Section 1 holds for every $n \ge 44$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,117$. Every one of them vanished. After it, more than $S = 47$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 22, 95, 546, 2765, 14503, 74812, 386556,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197667}{A197667}, revision 7, last modified Sep 09 2022.
