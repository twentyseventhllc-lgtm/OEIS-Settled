...
k=1: a(n) = a(n-1) +a(n-2)\\k=2: a(n) = 3*a(n-1) +5*a(n-3) -10*a(n-4) -12*a(n-5) -4*a(n-6)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 18 2017). As of revision 8, last modified Jun 19 2020, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
