...
\title{A proof of the conjectured linear recurrence for OEIS A250996}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250996}{A250996} as

\begin{quote}\itshape Number of (2+1)X(n+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -23*a(n-2) -12*a(n-3) +120*a(n-4) -72*a(n-5) -213*a(n-6) +197*a(n-7) +179*a(n-8) -186*a(n-9) -81*a(n-10) +75*a(n-11) +22*a(n-12) -11*a(n-13) -3*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 9\,a(n-1) - 23\,a(n-2) - 12\,a(n-3) + 120\,a(n-4) - 72\,a(n-5) - 213\,a(n-6) + \\ 197\,a(n-7) + 179\,a(n-8) - 186\,a(n-9) - 81\,a(n-10) + 75\,a(n-11) + 22\,a(n-12) - \\ 11\,a(n-13) - 3\,a(n-14). \end{multline*}
...
That refinement leaves $23$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 15$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A250996, the recurrence $a(n) = 9\,a(n-1) - 23\,a(n-2) - 12\,a(n-3) + 120\,a(n-4) - 72\,a(n-5) - 213\,a(n-6) + 197\,a(n-7) + 179\,a(n-8) - 186\,a(n-9) - 81\,a(n-10) + 75\,a(n-11) + 22\,a(n-12) - 11\,a(n-13) - 3\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 158, 872, 4007, 16993, 67409, 255502, 934786, 3328627,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250996}{A250996}, revision 6, last modified Jul 23 2025.
