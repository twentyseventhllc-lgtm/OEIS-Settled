...
\title{A proof of the conjectured linear recurrence for OEIS A234485}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234485}{A234485} as

\begin{quote}\itshape Number of (n+1) X (3+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) -43*a(n-2) -107*a(n-3) +865*a(n-4) -1033*a(n-5) -1916*a(n-6) +2822*a(n-7) +2712*a(n-8) -1332*a(n-9) -1512*a(n-10) -288*a(n-11).\end{quote}
...
\begin{multline*} a(n) = 13\,a(n-1) - 43\,a(n-2) - 107\,a(n-3) + 865\,a(n-4) - 1033\,a(n-5) - 1916\,a(n-6) + \\ 2822\,a(n-7) + 2712\,a(n-8) - 1332\,a(n-9) - 1512\,a(n-10) - 288\,a(n-11). \end{multline*}
...
\begin{theorem} For A234485, the recurrence $a(n) = 13\,a(n-1) - 43\,a(n-2) - 107\,a(n-3) + 865\,a(n-4) - 1033\,a(n-5) - 1916\,a(n-6) + 2822\,a(n-7) + 2712\,a(n-8) - 1332\,a(n-9) - 1512\,a(n-10) - 288\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 944, 3540, 13260, 49784, 187196, 705072, 2659824, 10049936,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234485}{A234485}, revision 6, last modified Jun 20 2022.
