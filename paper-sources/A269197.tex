...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A269197}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269197}{A269197} as

\begin{quote}\itshape Number of n X 4 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three no more than once\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: 12*x*(18 - 315*x + 2265*x\textasciicircum{}2 - 8158*x\textasciicircum{}3 + 10756*x\textasciicircum{}4 - 4951*x\textasciicircum{}5 + 897*x\textasciicircum{}6) / ((1 - x)\textasciicircum{}2*(1 - 30*x + 5*x\textasciicircum{}2)\textasciicircum{}2). - Colin Barker, Jan 20 2019\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{216x - 3780x^{2} + 27180x^{3} - 97896x^{4} + 129072x^{5} - 59412x^{6} + 10764x^{7}}{1 - 62x + 1031x^{2} - 2180x^{3} + 1535x^{4} - 350x^{5} + 25x^{6}}.\]
...
\begin{theorem} For A269197, the recurrence $a(n) = 62\,a(n-1) - 1031\,a(n-2) + 2180\,a(n-3) - 1535\,a(n-4) + 350\,a(n-5) - 25\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\begin{theorem} For A269197, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{216x - 3780x^{2} + 27180x^{3} - 97896x^{4} + 129072x^{5} - 59412x^{6} + 10764x^{7}}{1 - 62x + 1031x^{2} - 2180x^{3} + 1535x^{4} - 350x^{5} + 25x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 14 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 216, 9612, 400428, 15289548, 555862380, 19558138380, 672230393004, 22702294138188,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269197}{A269197}, revision 8, last modified Jan 20 2019.
