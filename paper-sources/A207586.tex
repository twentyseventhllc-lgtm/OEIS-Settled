...
\title{A proof of the conjectured linear recurrence for OEIS A207586}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 16\,a(n-3) - 8\,a(n-4) - a(n-5) - 125\,a(n-6) + \\ 12\,a(n-7) - 59\,a(n-8) + 561\,a(n-9) + 15\,a(n-10) + 394\,a(n-11) - 1588\,a(n-12) - \\ 30\,a(n-13) - 1252\,a(n-14) + 3110\,a(n-15) - 240\,a(n-16) + 2220\,a(n-17) - 4681\,a(n-18) + \\ 1113\,a(n-19) - 2172\,a(n-20) + 5890\,a(n-21) - 2305\,a(n-22) + 689\,a(n-23) - 6463\,a(n-24) + \\ 2868\,a(n-25) + 1071\,a(n-26) + 5999\,a(n-27) - 2424\,a(n-28) - 1723\,a(n-29) - 4358\,a(n-30) + \\ 1491\,a(n-31) + 1167\,a(n-32) + 2335\,a(n-33) - 642\,a(n-34) - 411\,a(n-35) - 928\,a(n-36) + \\ 157\,a(n-37) + 60\,a(n-38) + 289\,a(n-39) - 3\,a(n-40) + 6\,a(n-41) - 71\,a(n-42) - \\ 9\,a(n-43) - 3\,a(n-44) + 12\,a(n-45) + 2\,a(n-46) - a(n-48). \end{multline*}
...
That refinement leaves $57$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 51$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207586, the recurrence of order $48$ displayed in Section 1 holds for every $n > 50$, and fails at $n = 50$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,130$. The last nonvanishing one is at $m = 2$, that is at $n = 50$. After it, more than $S = 51$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 324, 1098, 3094, 7272, 18150, 46716,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207586}{A207586}, revision 9, last modified Oct 03 2025.
