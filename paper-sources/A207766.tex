...
\title{A proof of the conjectured linear recurrence for OEIS A207766}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207766}{A207766} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +47*a(n-3) -100*a(n-4) +68*a(n-5) -729*a(n-6) +1351*a(n-7) -599*a(n-8) +5751*a(n-9) -10798*a(n-10) +4250*a(n-11) -27354*a(n-12) +54520*a(n-13) -24176*a(n-14) +83574*a(n-15) -172480*a(n-16) +85820*a(n-17) -163088*a(n-18) +335152*a(n-19) -176096*a(n-20) +192808*a(n-21) -384288*a(n-22) +203280*a(n-23) -123648*a(n-24) +236544*a(n-25) -122496*a(n-26) +32640*a(n-27) -59904*a(n-28) +29952*a(n-29) for n>31.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 19 2012).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Nov 12 2014, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + 47\,a(n-3) - 100\,a(n-4) + 68\,a(n-5) - 729\,a(n-6) + \\ 1351\,a(n-7) - 599\,a(n-8) + 5751\,a(n-9) - 10798\,a(n-10) + 4250\,a(n-11) - 27354\,a(n-12) + \\ 54520\,a(n-13) - 24176\,a(n-14) + 83574\,a(n-15) - 172480\,a(n-16) + 85820\,a(n-17) - 163088\,a(n-18) + \\ 335152\,a(n-19) - 176096\,a(n-20) + 192808\,a(n-21) - 384288\,a(n-22) + 203280\,a(n-23) - 123648\,a(n-24) + \\ 236544\,a(n-25) - 122496\,a(n-26) + 32640\,a(n-27) - 59904\,a(n-28) + 29952\,a(n-29). \end{multline*}
...
That refinement leaves $71$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 38$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207766, the recurrence of order $29$ displayed in Section 1 holds for every $n > 31$, and fails at $n = 31$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,95$. The last nonvanishing one is at $m = 2$, that is at $n = 31$. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 21, 441, 1087, 6459, 21547, 56651, 235872, 862146,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207766}{A207766}, revision 9, last modified Nov 12 2014.
