...
\title{A proof of the conjectured linear recurrence for OEIS A316818}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316818}{A316818} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -5*a(n-2) +28*a(n-3) -408*a(n-4) +542*a(n-5) +787*a(n-6) -2049*a(n-7) +2057*a(n-8) -3719*a(n-9) +6885*a(n-10) +504*a(n-11) -4666*a(n-12) +11617*a(n-13) -34519*a(n-14) +4496*a(n-15) +34989*a(n-16) +91122*a(n-17) -389039*a(n-18) +423734*a(n-19) -331342*a(n-20) -433316*a(n-21) +1590108*a(n-22) -1631316*a(n-23) +776241*a(n-24) -264053*a(n-25) -482035*a(n-26) +535407*a(n-27) -517081*a(n-28) +141983*a(n-29) +140727*a(n-30) +56125*a(n-31) +56314*a(n-32) +4504*a(n-33) -47306*a(n-34) +7194*a(n-35) +2430*a(n-36) -3159*a(n-37) +1674*a(n-38) for n>39\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 5\,a(n-2) + 28\,a(n-3) - 408\,a(n-4) + 542\,a(n-5) + 787\,a(n-6) - \\ 2049\,a(n-7) + 2057\,a(n-8) - 3719\,a(n-9) + 6885\,a(n-10) + 504\,a(n-11) - 4666\,a(n-12) + \\ 11617\,a(n-13) - 34519\,a(n-14) + 4496\,a(n-15) + 34989\,a(n-16) + 91122\,a(n-17) - 389039\,a(n-18) + \\ 423734\,a(n-19) - 331342\,a(n-20) - 433316\,a(n-21) + 1590108\,a(n-22) - 1631316\,a(n-23) + 776241\,a(n-24) - \\ 264053\,a(n-25) - 482035\,a(n-26) + 535407\,a(n-27) - 517081\,a(n-28) + 141983\,a(n-29) + 140727\,a(n-30) + \\ 56125\,a(n-31) + 56314\,a(n-32) + 4504\,a(n-33) - 47306\,a(n-34) + 7194\,a(n-35) + 2430\,a(n-36) - \\ 3159\,a(n-37) + 1674\,a(n-38). \end{multline*}
...
\begin{theorem} For A316818, the recurrence of order $38$ displayed in Section 1 holds for every $n > 39$, and fails at $n = 39$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,106$. The last nonvanishing one is at $m = 1$, that is at $n = 39$. After it, more than $S = 44$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 112, 983, 9233, 87009, 811854, 7609680, 71307863,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316818}{A316818}, revision 4, last modified Jul 14 2018.
