...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A297514}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297514}{A297514} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 3 neighboring 1s\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 2*a(n-2) + 30*a(n-3) + 6*a(n-5) - 124*a(n-6) - 8*a(n-8) + 64*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(3 + 14*x + 26*x\textasciicircum{}2 + 4*x\textasciicircum{}3 - 58*x\textasciicircum{}4 - 124*x\textasciicircum{}5 - 8*x\textasciicircum{}6 + 24*x\textasciicircum{}7 + 64*x\textasciicircum{}8) / (1 - x - 2*x\textasciicircum{}2 - 30*x\textasciicircum{}3 - 6*x\textasciicircum{}5 + 124*x\textasciicircum{}6 + 8*x\textasciicircum{}8 - 64*x\textasciicircum{}9). - Colin Barker, Feb 28 2019\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 30\,a(n-3) + 6\,a(n-5) - 124\,a(n-6) - 8\,a(n-8) + \\ 64\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{3x + 14x^{2} + 26x^{3} + 4x^{4} - 58x^{5} - 124x^{6} - 8x^{7} + 24x^{8} + 64x^{9}}{1 - x - 2x^{2} - 30x^{3} - 6x^{5} + 124x^{6} + 8x^{8} - 64x^{9}}.\]
...
\begin{theorem} For A297514, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 30\,a(n-3) + 6\,a(n-5) - 124\,a(n-6) - 8\,a(n-8) + 64\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,52$. Every one of them vanished. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A297514, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{3x + 14x^{2} + 26x^{3} + 4x^{4} - 58x^{5} - 124x^{6} - 8x^{7} + 24x^{8} + 64x^{9}}{1 - x - 2x^{2} - 30x^{3} - 6x^{5} + 124x^{6} + 8x^{8} - 64x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 17, 49, 177, 727, 2445, 8931, 33841,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297514}{A297514}, revision 8, last modified Feb 28 2019.
