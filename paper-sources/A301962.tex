...
\title{A proof of the conjectured linear recurrence for OEIS A301962}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301962}{A301962} as

\begin{quote}\itshape Number of nX6 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +8*a(n-2) +4*a(n-3) -8*a(n-4) -7*a(n-5) -a(n-6) -3*a(n-7) +a(n-8) +5*a(n-9) -3*a(n-10) +a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 8\,a(n-2) + 4\,a(n-3) - 8\,a(n-4) - 7\,a(n-5) - a(n-6) - \\ 3\,a(n-7) + a(n-8) + 5\,a(n-9) - 3\,a(n-10) + a(n-11). \end{multline*}
...
The construction gives $4160$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $161$; neither removal changes any count.
...
\begin{theorem} For A301962, the recurrence $a(n) = a(n-1) + 8\,a(n-2) + 4\,a(n-3) - 8\,a(n-4) - 7\,a(n-5) - a(n-6) - 3\,a(n-7) + a(n-8) + 5\,a(n-9) - 3\,a(n-10) + a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,59$. The last nonvanishing one is at $m = 1$, that is at $n = 12$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 22, 74, 219, 749, 2544, 8705, 29750,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301962}{A301962}, revision 4, last modified Mar 29 2018.
