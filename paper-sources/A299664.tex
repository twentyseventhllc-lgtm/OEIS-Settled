...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,114$. The last nonvanishing one is at $m = 1$, that is at $n = 39$. After it, more than $S = 52$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
