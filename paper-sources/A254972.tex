...
\title{A proof of the conjectured linear recurrence for OEIS A254972}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A254972}{A254972} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 and no column sum 0\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +10*a(n-2) +16*a(n-3) -29*a(n-4) -158*a(n-5) -102*a(n-6) +260*a(n-7) +509*a(n-8) +114*a(n-9) -417*a(n-10) -430*a(n-11) -123*a(n-12) +59*a(n-13) +142*a(n-14) +131*a(n-15) -21*a(n-16) -10*a(n-17) +6*a(n-18) -2*a(n-20) for n>22\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 10\,a(n-2) + 16\,a(n-3) - 29\,a(n-4) - 158\,a(n-5) - 102\,a(n-6) + \\ 260\,a(n-7) + 509\,a(n-8) + 114\,a(n-9) - 417\,a(n-10) - 430\,a(n-11) - 123\,a(n-12) + \\ 59\,a(n-13) + 142\,a(n-14) + 131\,a(n-15) - 21\,a(n-16) - 10\,a(n-17) + 6\,a(n-18) - \\ 2\,a(n-20). \end{multline*}
...
That refinement leaves $46$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 35$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A254972, the recurrence of order $20$ displayed in Section 1 holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,81$. The last nonvanishing one is at $m = 2$, that is at $n = 22$. After it, more than $S = 35$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 310, 1282, 6915, 27211, 116534, 518534, 2243657, 9685030,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A254972}{A254972}, revision 6, last modified Jun 02 2025.
