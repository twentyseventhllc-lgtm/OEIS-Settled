...
\title{Proofs of the conjectured column and row recurrences for OEIS A316740}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316740}{A316740} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element unequal to 1, 2, 3, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
k=2: a(n) = 2*a(n-1) +3*a(n-2) -2*a(n-3) -6*a(n-4) -4*a(n-5) for n > 6;\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 11 2018). As of revision 6, last modified Apr 21 2021, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 2$ of A316740, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - 2\,a(n-3) - 6\,a(n-4) - 4\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316740}{A316740}, revision 6, last modified Apr 21 2021.
