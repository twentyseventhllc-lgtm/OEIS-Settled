...
\title{A proof of the conjectured generating function for OEIS A250870}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250870}{A250870} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical g.f.: 2*x*(45 - 140*x + 96*x\textasciicircum{}2) / ((1 - x)*(1 - 3*x)*(1 - 4*x)). - Colin Barker, Nov 22 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{90x - 280x^{2} + 192x^{3}}{1 - 8x + 19x^{2} - 12x^{3}}.\]
...
\begin{theorem} For A250870, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{90x - 280x^{2} + 192x^{3}}{1 - 8x + 19x^{2} - 12x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 90, 440, 2002, 8736, 37130, 155080, 640002, 2619056,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250870}{A250870}, revision 7, last modified Nov 22 2018.
