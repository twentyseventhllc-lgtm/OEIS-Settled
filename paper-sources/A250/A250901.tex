...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250901}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250901}{A250901} as

\begin{quote}\itshape Number of (3+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(413 - 4332*x + 19193*x\textasciicircum{}2 - 47217*x\textasciicircum{}3 + 70990*x\textasciicircum{}4 - 67269*x\textasciicircum{}5 + 39526*x\textasciicircum{}6 - 13236*x\textasciicircum{}7 + 1944*x\textasciicircum{}8) / ((1 - x)\textasciicircum{}5*(1 - 2*x)\textasciicircum{}3*(1 - 3*x)). - Colin Barker, Nov 23 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{413x - 4332x^{2} + 19193x^{3} - 47217x^{4} + 70990x^{5} - 67269x^{6} + 39526x^{7} - 13236x^{8} + 1944x^{9}}{1 - 14x + 85x^{2} - 294x^{3} + 639x^{4} - 906x^{5} + 839x^{6} - 490x^{7} + 164x^{8} - 24x^{9}}.\]
...
\begin{theorem} For A250901, the recurrence $a(n) = 14\,a(n-1) - 85\,a(n-2) + 294\,a(n-3) - 639\,a(n-4) + 906\,a(n-5) - 839\,a(n-6) + 490\,a(n-7) - 164\,a(n-8) + 24\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,52$. Every one of them vanished. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A250901, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{413x - 4332x^{2} + 19193x^{3} - 47217x^{4} + 70990x^{5} - 67269x^{6} + 39526x^{7} - 13236x^{8} + 1944x^{9}}{1 - 14x + 85x^{2} - 294x^{3} + 639x^{4} - 906x^{5} + 839x^{6} - 490x^{7} + 164x^{8} - 24x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 413, 1450, 4388, 12387, 33821, 91030, 244200, 657443,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250901}{A250901}, revision 8, last modified Nov 23 2018.
