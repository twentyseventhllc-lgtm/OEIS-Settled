...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250792}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250792}{A250792} as

\begin{quote}\itshape Number of (n+1) X (3+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) - 10*a(n-2) + 11*a(n-4) - 6*a(n-5).\end{quote}

\begin{quote}\ttfamily G.f.: 2*x*(27 - 81*x + 25*x\textasciicircum{}2 + 79*x\textasciicircum{}3 - 48*x\textasciicircum{}4) / ((1 - x)\textasciicircum{}2*(1 + x)*(1 - 2*x)*(1 - 3*x)).\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{54x - 162x^{2} + 50x^{3} + 158x^{4} - 96x^{5}}{1 - 6x + 10x^{2} - 11x^{4} + 6x^{5}}.\]
...
\begin{theorem} For A250792, the recurrence $a(n) = 6\,a(n-1) - 10\,a(n-2) + 11\,a(n-4) - 6\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250792, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{54x - 162x^{2} + 50x^{3} + 158x^{4} - 96x^{5}}{1 - 6x + 10x^{2} - 11x^{4} + 6x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 54, 162, 482, 1430, 4258, 12706, 37986, 113694,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250792}{A250792}, revision 7, last modified Nov 20 2018.
