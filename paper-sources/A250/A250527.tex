...
\title{Proofs of the conjectured column and row recurrences for OEIS A250527}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250527}{A250527} as

\begin{quote}\itshape T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction\end{quote}
...
\begin{quote}\ttfamily Empirical for column k (k=2 recurrence also works for k=1):\\
k=1: a(n) = 9*a(n-1) -31*a(n-2) +51*a(n-3) -40*a(n-4) +12*a(n-5)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Nov 24 2014). As of revision 6, last modified Jul 23 2025, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A250527, the recurrence $a(n) = 9\,a(n-1) - 31\,a(n-2) + 51\,a(n-3) - 40\,a(n-4) + 12\,a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250527}{A250527}, revision 6, last modified Jul 23 2025.
