...
\title{Proofs of the conjectured column and row recurrences for OEIS A250544}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250544}{A250544} as

\begin{quote}\itshape T(n,k) = number of (n+1)X(k+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction\end{quote}
...
\begin{quote}\ttfamily Empirical for column k (k=2-7 recurrence also works for k=1):\\
k=1: a(n) = 16*a(n-1) -106*a(n-2) +376*a(n-3) -769*a(n-4) +904*a(n-5) -564*a(n-6) +144*a(n-7)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Nov 24 2014). As of revision 16, last modified Mar 12 2015, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A250544, the recurrence $a(n) = 16\,a(n-1) - 106\,a(n-2) + 376\,a(n-3) - 769\,a(n-4) + 904\,a(n-5) - 564\,a(n-6) + 144\,a(n-7)$ holds for every $n \ge 8$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250544}{A250544}, revision 16, last modified Mar 12 2015.
