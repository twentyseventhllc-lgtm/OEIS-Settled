...
\title{A proof of the conjectured linear recurrence for OEIS A250944}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250944}{A250944} as
...
\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -29*a(n-2) -6*a(n-3) +136*a(n-4) -90*a(n-5) -217*a(n-6) +186*a(n-7) +143*a(n-8) -124*a(n-9) -32*a(n-10) +24*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 29\,a(n-2) - 6\,a(n-3) + 136\,a(n-4) - 90\,a(n-5) - 217\,a(n-6) + \\ 186\,a(n-7) + 143\,a(n-8) - 124\,a(n-9) - 32\,a(n-10) + 24\,a(n-11). \end{multline*}
...
\begin{theorem} For A250944, the recurrence $a(n) = 10\,a(n-1) - 29\,a(n-2) - 6\,a(n-3) + 136\,a(n-4) - 90\,a(n-5) - 217\,a(n-6) + 186\,a(n-7) + 143\,a(n-8) - 124\,a(n-9) - 32\,a(n-10) + 24\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 125, 699, 3355, 15431, 67595, 287045, 1188599, 4827913,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250944}{A250944}, revision 6, last modified Jul 23 2025.
