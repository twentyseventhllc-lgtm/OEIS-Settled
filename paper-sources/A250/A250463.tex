...
\title{A proof of the conjectured linear recurrence for OEIS A250463}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250463}{A250463} as

\begin{quote}\itshape Number of (n+1) X (3+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +14*a(n-2) -35*a(n-3) -37*a(n-4) +68*a(n-5) +30*a(n-6) -44*a(n-7) -8*a(n-8) +8*a(n-9).\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 14\,a(n-2) - 35\,a(n-3) - 37\,a(n-4) + 68\,a(n-5) + 30\,a(n-6) - \\ 44\,a(n-7) - 8\,a(n-8) + 8\,a(n-9). \end{multline*}
...
\begin{theorem} For A250463, the recurrence $a(n) = 5\,a(n-1) + 14\,a(n-2) - 35\,a(n-3) - 37\,a(n-4) + 68\,a(n-5) + 30\,a(n-6) - 44\,a(n-7) - 8\,a(n-8) + 8\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 85, 557, 3476, 21753, 135753, 847278, 5286723, 32988493,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250463}{A250463}, revision 6, last modified Sep 04 2022.
