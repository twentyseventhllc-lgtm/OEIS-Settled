...
\title{A proof of the conjectured generating function for OEIS A250773}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250773}{A250773} as
...
\begin{quote}\ttfamily Empirical g.f.: 2*x*(72 - 231*x + 212*x\textasciicircum{}2 - 64*x\textasciicircum{}3) / ((1 - x)\textasciicircum{}3*(1 - 2*x)). - Colin Barker, Nov 19 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{144x - 462x^{2} + 424x^{3} - 128x^{4}}{1 - 5x + 9x^{2} - 7x^{3} + 2x^{4}}.\]
...
\begin{theorem} For A250773, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{144x - 462x^{2} + 424x^{3} - 128x^{4}}{1 - 5x + 9x^{2} - 7x^{3} + 2x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 144, 258, 418, 648, 996, 1558, 2526, 4284,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250773}{A250773}, revision 8, last modified Nov 19 2018.
