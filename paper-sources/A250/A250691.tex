...
\title{Proofs of the conjectured column and row recurrences for OEIS A250691}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250691}{A250691} as
...
k=1: [linear recurrence of order 7] for n>11\\k=2: [order 13] for n>17\end{quote}
...
\begin{theorem} For column $k = 1$ of A250691, the recurrence $a(n) = 0$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A250691, the recurrence $a(n) = 0$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The width is $3$; the digraph has $64$ states, $64$ after trimming, and $S = 38$ blocks after refinement. The model reproduces every published value of column $k = 2$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 17$; after that point more than $S = 38$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250691}{A250691}, revision 8, last modified Jul 23 2025.
