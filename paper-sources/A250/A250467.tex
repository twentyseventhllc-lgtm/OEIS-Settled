...
\title{A proof of the conjectured order of the recurrence for OEIS A250467}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250467}{A250467} as

\begin{quote}\itshape Number of (n+1)X(7+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction\end{quote}
...
For scale: at $n = 8$ there are $2^{64}$ arrays, about $10^{19}$, against $68$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\item {\bfseries The published terms.} The walk count reproduces all 14 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4757, 166765, 5286723, 169000988, 5383012776, 171499189113, 5462124226322, 173973296060000,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250467}{A250467}, revision 6, last modified Jul 23 2025.
