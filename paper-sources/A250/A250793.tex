...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250793}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250793}{A250793} as

\begin{quote}\itshape Number of (n+1) X (4+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) - 20*a(n-2) + 8*a(n-3) + 33*a(n-4) - 36*a(n-5) + 8*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(59 - 284*x + 271*x\textasciicircum{}2 + 416*x\textasciicircum{}3 - 624*x\textasciicircum{}4 + 10*x\textasciicircum{}5 + 128*x\textasciicircum{}6) / ((1 - x)\textasciicircum{}2*(1 - 2*x)*(1 - 2*x - x\textasciicircum{}2)*(1 - 2*x - 4*x\textasciicircum{}2)). - Colin Barker, Nov 20 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{118x - 568x^{2} + 542x^{3} + 832x^{4} - 1248x^{5} + 20x^{6} + 256x^{7}}{1 - 8x + 20x^{2} - 8x^{3} - 33x^{4} + 36x^{5} - 8x^{7}}.\]
...
\begin{theorem} For A250793, the recurrence $a(n) = 8\,a(n-1) - 20\,a(n-2) + 8\,a(n-3) + 33\,a(n-4) - 36\,a(n-5) + 8\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250793, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{118x - 568x^{2} + 542x^{3} + 832x^{4} - 1248x^{5} + 20x^{6} + 256x^{7}}{1 - 8x + 20x^{2} - 8x^{3} - 33x^{4} + 36x^{5} - 8x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 118, 376, 1190, 3776, 12062, 38676, 124366, 400616,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250793}{A250793}, revision 8, last modified Nov 20 2018.
