...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250677}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250677}{A250677} as
...
\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) - 21*a(n-2) - 54*a(n-3) + 155*a(n-4) + 118*a(n-5) - 228*a(n-6) - 144*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(104 - 371*x - 579*x\textasciicircum{}2 + 2514*x\textasciicircum{}3 + 1516*x\textasciicircum{}4 - 3792*x\textasciicircum{}5 - 2304*x\textasciicircum{}6) / ((1 - 4*x)*(1 - x - x\textasciicircum{}2)*(1 - 2*x - 4*x\textasciicircum{}2)*(1 - 3*x - 9*x\textasciicircum{}2)). - Colin Barker, Mar 19 2018\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 21\,a(n-2) - 54\,a(n-3) + 155\,a(n-4) + 118\,a(n-5) - 228\,a(n-6) - \\ 144\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{104x - 371x^{2} - 579x^{3} + 2514x^{4} + 1516x^{5} - 3792x^{6} - 2304x^{7}}{1 - 10x + 21x^{2} + 54x^{3} - 155x^{4} - 118x^{5} + 228x^{6} + 144x^{7}}.\]
...
\begin{theorem} For A250677, the recurrence $a(n) = 10\,a(n-1) - 21\,a(n-2) - 54\,a(n-3) + 155\,a(n-4) + 118\,a(n-5) - 228\,a(n-6) - 144\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250677, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{104x - 371x^{2} - 579x^{3} + 2514x^{4} + 1516x^{5} - 3792x^{6} - 2304x^{7}}{1 - 10x + 21x^{2} + 54x^{3} - 155x^{4} - 118x^{5} + 228x^{6} + 144x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 104, 669, 3927, 22119, 120233, 637948, 3321772, 17052553,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250677}{A250677}, revision 11, last modified Mar 19 2018.
