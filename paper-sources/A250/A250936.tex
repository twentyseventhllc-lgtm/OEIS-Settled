...
\title{A proof of the conjectured linear recurrence for OEIS A250936}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250936}{A250936} as
...
\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) -71*a(n-2) +211*a(n-3) -368*a(n-4) +376*a(n-5) -208*a(n-6) +48*a(n-7) for n>11\end{quote}
...
\begin{multline*} a(n) = 13\,a(n-1) - 71\,a(n-2) + 211\,a(n-3) - 368\,a(n-4) + 376\,a(n-5) - 208\,a(n-6) + \\ 48\,a(n-7). \end{multline*}
...
\begin{theorem} For A250936, the recurrence $a(n) = 13\,a(n-1) - 71\,a(n-2) + 211\,a(n-3) - 368\,a(n-4) + 376\,a(n-5) - 208\,a(n-6) + 48\,a(n-7)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. The last nonvanishing one is at $m = 4$, that is at $n = 11$. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 155, 699, 2812, 10528, 37477, 128507, 428095, 1394237,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250936}{A250936}, revision 7, last modified Jul 23 2025.
