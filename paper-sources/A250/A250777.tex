...
\title{A proof of the conjectured generating function for OEIS A250777}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250777}{A250777} as

\begin{quote}\itshape Number of (n+1) X (2+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical g.f.: x*(21 - 17*x) / ((1 - x)*(1 - 2*x)). - Colin Barker, Nov 19 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{21x - 17x^{2}}{1 - 3x + 2x^{2}}.\]
...
\begin{theorem} For A250777, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{21x - 17x^{2}}{1 - 3x + 2x^{2}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 21, 46, 96, 196, 396, 796, 1596, 3196,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250777}{A250777}, revision 8, last modified Nov 19 2018.
