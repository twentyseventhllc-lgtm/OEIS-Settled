...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250692}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250692}{A250692} as

\begin{quote}\itshape Number of (1+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) - 106*a(n-2) + 376*a(n-3) - 769*a(n-4) + 904*a(n-5) - 564*a(n-6) + 144*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(104 - 1121*x + 4877*x\textasciicircum{}2 - 11052*x\textasciicircum{}3 + 13756*x\textasciicircum{}4 - 8880*x\textasciicircum{}5 + 2304*x\textasciicircum{}6) / ((1 - x)\textasciicircum{}2*(1 - 2*x)\textasciicircum{}2*(1 - 3*x)\textasciicircum{}2*(1 - 4*x)). - Colin Barker, Feb 21 2018\end{quote}
...
\begin{multline*} a(n) = 16\,a(n-1) - 106\,a(n-2) + 376\,a(n-3) - 769\,a(n-4) + 904\,a(n-5) - 564\,a(n-6) + \\ 144\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{104x - 1121x^{2} + 4877x^{3} - 11052x^{4} + 13756x^{5} - 8880x^{6} + 2304x^{7}}{1 - 16x + 106x^{2} - 376x^{3} + 769x^{4} - 904x^{5} + 564x^{6} - 144x^{7}}.\]
...
\begin{theorem} For A250692, the recurrence $a(n) = 16\,a(n-1) - 106\,a(n-2) + 376\,a(n-3) - 769\,a(n-4) + 904\,a(n-5) - 564\,a(n-6) + 144\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250692, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{104x - 1121x^{2} + 4877x^{3} - 11052x^{4} + 13756x^{5} - 8880x^{6} + 2304x^{7}}{1 - 16x + 106x^{2} - 376x^{3} + 769x^{4} - 904x^{5} + 564x^{6} - 144x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 104, 543, 2541, 11150, 47002, 193117, 780551, 3122604,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250692}{A250692}, revision 7, last modified Feb 21 2018.
