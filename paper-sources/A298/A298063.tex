...
\title{Proofs of the conjectured column and row recurrences for OEIS A298063}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298063}{A298063} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 1, 3, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = a(n-2)\\k=2: a(n) = a(n-1) +a(n-2) +8*a(n-3) -16*a(n-5)\\k=3: [order 17] for n>18\\k=4: [order 71]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 11 2018). As of revision 4, last modified Jan 11 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A298063, the recurrence $a(n) = a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A298063, the recurrence $a(n) = a(n-1) + a(n-2) + 8\,a(n-3) - 16\,a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A298063, the recurrence $a(n) = 0$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A298063, the recurrence $a(n) = 0$ holds for every $n \ge 72$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298063}{A298063}, revision 4, last modified Jan 11 2018.
