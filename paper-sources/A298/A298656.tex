...
\title{A proof of the conjectured linear recurrence for OEIS A298656}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298656}{A298656} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +a(n-3) -14*a(n-4) -a(n-5) +33*a(n-6) -58*a(n-7) +8*a(n-8) +31*a(n-9) +257*a(n-10) -83*a(n-11) -415*a(n-12) +258*a(n-13) +257*a(n-14) -701*a(n-15) -1280*a(n-16) +817*a(n-17) +2138*a(n-18) -1277*a(n-19) -1528*a(n-20) +3841*a(n-21) +4395*a(n-22) -4674*a(n-23) -3840*a(n-24) +6126*a(n-25) +1522*a(n-26) -10670*a(n-27) -7803*a(n-28) +11150*a(n-29) +1242*a(n-30) -18501*a(n-31) +5389*a(n-32) +19940*a(n-33) -6561*a(n-34) -14251*a(n-35) +20541*a(n-36) +18531*a(n-37) -24833*a(n-38) -10425*a(n-39) +29434*a(n-40) +13173*a(n-41) -23604*a(n-42) -9671*a(n-43) +14824*a(n-44) -2310*a(n-45) -14701*a(n-46) -6124*a(n-47) +4664*a(n-48) +2279*a(n-49) -4344*a(n-50) +3221*a(n-51) +5148*a(n-52) -1564*a(n-53) -1655*a(n-54) +410*a(n-55) -29*a(n-56) +385*a(n-57) +1679*a(n-58) +770*a(n-59) -1293*a(n-60) -895*a(n-61) +499*a(n-62) +423*a(n-63) -72*a(n-64) -174*a(n-65) -69*a(n-66) +20*a(n-67) +16*a(n-68) +10*a(n-69) +5*a(n-70) -2*a(n-71) -a(n-72) for n>73\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jan 24 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 4, last modified Jan 24 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 3\,a(n-1) + a(n-3) - 14\,a(n-4) - a(n-5) + 33\,a(n-6) - 58\,a(n-7) + \\ 8\,a(n-8) + 31\,a(n-9) + 257\,a(n-10) - 83\,a(n-11) - 415\,a(n-12) + 258\,a(n-13) + \\ 257\,a(n-14) - 701\,a(n-15) - 1280\,a(n-16) + 817\,a(n-17) + 2138\,a(n-18) - 1277\,a(n-19) - \\ 1528\,a(n-20) + 3841\,a(n-21) + 4395\,a(n-22) - 4674\,a(n-23) - 3840\,a(n-24) + 6126\,a(n-25) + \\ 1522\,a(n-26) - 10670\,a(n-27) - 7803\,a(n-28) + 11150\,a(n-29) + 1242\,a(n-30) - 18501\,a(n-31) + \\ 5389\,a(n-32) + 19940\,a(n-33) - 6561\,a(n-34) - 14251\,a(n-35) + 20541\,a(n-36) + 18531\,a(n-37) - \\ 24833\,a(n-38) - 10425\,a(n-39) + 29434\,a(n-40) + 13173\,a(n-41) - 23604\,a(n-42) - 9671\,a(n-43) + \\ 14824\,a(n-44) - 2310\,a(n-45) - 14701\,a(n-46) - 6124\,a(n-47) + 4664\,a(n-48) + 2279\,a(n-49) - \\ 4344\,a(n-50) + 3221\,a(n-51) + 5148\,a(n-52) - 1564\,a(n-53) - 1655\,a(n-54) + 410\,a(n-55) - \\ 29\,a(n-56) + 385\,a(n-57) + 1679\,a(n-58) + 770\,a(n-59) - 1293\,a(n-60) - 895\,a(n-61) + \\ 499\,a(n-62) + 423\,a(n-63) - 72\,a(n-64) - 174\,a(n-65) - 69\,a(n-66) + 20\,a(n-67) + \\ 16\,a(n-68) + 10\,a(n-69) + 5\,a(n-70) - 2\,a(n-71) - a(n-72). \end{multline*}
...
\begin{theorem} For A298656, the recurrence of order $72$ displayed in Section 1 holds for every $n > 73$, and fails at $n = 73$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,182$. The last nonvanishing one is at $m = 1$, that is at $n = 73$. After it, more than $S = 74$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 13, 19, 40, 85, 173, 322, 635,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298656}{A298656}, revision 4, last modified Jan 24 2018.
