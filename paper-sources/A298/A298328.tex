...
\title{Proofs of the conjectured column and row recurrences for OEIS A298328}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298328}{A298328} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 0, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = a(n-1)\\k=2: a(n) = 5*a(n-2) +8*a(n-3) +4*a(n-4)\\k=3: [order 19] for n>20\\k=4: [order 67] for n>68\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 17 2018). As of revision 4, last modified Jan 17 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A298328, the recurrence $a(n) = a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A298328, the recurrence $a(n) = 5\,a(n-2) + 8\,a(n-3) + 4\,a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A298328, the recurrence $a(n) = 0$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A298328, the recurrence $a(n) = 0$ holds for every $n > 68$, and fails at $n = 68$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298328}{A298328}, revision 4, last modified Jan 17 2018.
