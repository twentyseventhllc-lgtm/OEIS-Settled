...
\title{A proof of the conjectured linear recurrence for OEIS A298570}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298570}{A298570} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 0, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-3) +2*a(n-4) +a(n-5) -10*a(n-6) -2*a(n-7) -2*a(n-8) +2*a(n-9).\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-3) + 2\,a(n-4) + a(n-5) - 10\,a(n-6) - 2\,a(n-7) - 2\,a(n-8) + \\ 2\,a(n-9). \end{multline*}
...
\begin{theorem} For A298570, the recurrence $a(n) = 7\,a(n-3) + 2\,a(n-4) + a(n-5) - 10\,a(n-6) - 2\,a(n-7) - 2\,a(n-8) + 2\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 35 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 4, 1, 2, 14, 10, 12, 72,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298570}{A298570}, revision 6, last modified Jan 01 2024.
