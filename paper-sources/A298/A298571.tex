...
\title{A proof of the conjectured linear recurrence for OEIS A298571}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298571}{A298571} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +26*a(n-3) -16*a(n-4) -20*a(n-5) -278*a(n-6) +92*a(n-7) +146*a(n-8) +1603*a(n-9) -188*a(n-10) -487*a(n-11) -5508*a(n-12) -255*a(n-13) +587*a(n-14) +11843*a(n-15) +2118*a(n-16) +867*a(n-17) -16392*a(n-18) -4788*a(n-19) -3812*a(n-20) +14685*a(n-21) +5603*a(n-22) +5402*a(n-23) -8344*a(n-24) -3708*a(n-25) -4188*a(n-26) +2776*a(n-27) +1216*a(n-28) +1696*a(n-29) -384*a(n-30) -128*a(n-31) -256*a(n-32) for n>33\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 26\,a(n-3) - 16\,a(n-4) - 20\,a(n-5) - 278\,a(n-6) + \\ 92\,a(n-7) + 146\,a(n-8) + 1603\,a(n-9) - 188\,a(n-10) - 487\,a(n-11) - 5508\,a(n-12) - \\ 255\,a(n-13) + 587\,a(n-14) + 11843\,a(n-15) + 2118\,a(n-16) + 867\,a(n-17) - 16392\,a(n-18) - \\ 4788\,a(n-19) - 3812\,a(n-20) + 14685\,a(n-21) + 5603\,a(n-22) + 5402\,a(n-23) - 8344\,a(n-24) - \\ 3708\,a(n-25) - 4188\,a(n-26) + 2776\,a(n-27) + 1216\,a(n-28) + 1696\,a(n-29) - 384\,a(n-30) - \\ 128\,a(n-31) - 256\,a(n-32). \end{multline*}
...
The condition is $c(i,j) \in \{0, 2, 4, 5, 7\}$ for every cell of the array, together with $A[0][0]=0$.
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $140$; neither removal changes any count.
...
That refinement leaves $39$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 38$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A298571, the recurrence of order $32$ displayed in Section 1 holds for every $n > 33$, and fails at $n = 33$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,106$. The last nonvanishing one is at $m = 1$, that is at $n = 33$. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 8, 2, 3, 41, 38, 70, 374,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298571}{A298571}, revision 4, last modified Jan 22 2018.
