...
\title{Proofs of the conjectured column and row recurrences for OEIS A298167}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298167}{A298167} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
k=2: a(n) = a(n-1) +a(n-2)\\k=3: a(n) = a(n-1) +a(n-2)\\k=4: a(n) = 2*a(n-1) +a(n-2) -a(n-3) -2*a(n-4) -2*a(n-5) +a(n-6) +a(n-7)\\k=5: [order 67]\end{quote}
...
\begin{theorem} For column $k = 2$ of A298167, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A298167, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A298167, the recurrence $a(n) = 2\,a(n-1) + a(n-2) - a(n-3) - 2\,a(n-4) - 2\,a(n-5) + a(n-6) + a(n-7)$ holds for every $n \ge 8$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 5$ of A298167, the recurrence $a(n) = 0$ holds for every $n \ge 68$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298167}{A298167}, revision 4, last modified Jan 14 2018.
