...
\title{A proof of the conjectured linear recurrence for OEIS A298182}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298182}{A298182} as

\begin{quote}\itshape Number of nX7 0..1 arrays with every element equal to 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -8*a(n-2) +14*a(n-3) -30*a(n-4) -3*a(n-5) +31*a(n-6) -19*a(n-7) +239*a(n-8) -221*a(n-9) +70*a(n-10) -600*a(n-11) -13*a(n-12) +699*a(n-13) -60*a(n-14) +1998*a(n-15) -2941*a(n-16) +246*a(n-17) -919*a(n-18) +748*a(n-19) +5642*a(n-20) -4627*a(n-21) +789*a(n-22) -7280*a(n-23) +1283*a(n-24) +9180*a(n-25) -727*a(n-26) +3094*a(n-27) -10634*a(n-28) -1764*a(n-29) +4744*a(n-30) +1451*a(n-31) +6057*a(n-32) -6690*a(n-33) -2277*a(n-34) +512*a(n-35) +1285*a(n-36) +2306*a(n-37) -1107*a(n-38) -1080*a(n-39) +455*a(n-40) -349*a(n-41) +542*a(n-42) +118*a(n-43) -396*a(n-44) +152*a(n-45) +32*a(n-46) -50*a(n-47) +8*a(n-48)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 8\,a(n-2) + 14\,a(n-3) - 30\,a(n-4) - 3\,a(n-5) + 31\,a(n-6) - \\ 19\,a(n-7) + 239\,a(n-8) - 221\,a(n-9) + 70\,a(n-10) - 600\,a(n-11) - 13\,a(n-12) + \\ 699\,a(n-13) - 60\,a(n-14) + 1998\,a(n-15) - 2941\,a(n-16) + 246\,a(n-17) - 919\,a(n-18) + \\ 748\,a(n-19) + 5642\,a(n-20) - 4627\,a(n-21) + 789\,a(n-22) - 7280\,a(n-23) + 1283\,a(n-24) + \\ 9180\,a(n-25) - 727\,a(n-26) + 3094\,a(n-27) - 10634\,a(n-28) - 1764\,a(n-29) + 4744\,a(n-30) + \\ 1451\,a(n-31) + 6057\,a(n-32) - 6690\,a(n-33) - 2277\,a(n-34) + 512\,a(n-35) + 1285\,a(n-36) + \\ 2306\,a(n-37) - 1107\,a(n-38) - 1080\,a(n-39) + 455\,a(n-40) - 349\,a(n-41) + 542\,a(n-42) + \\ 118\,a(n-43) - 396\,a(n-44) + 152\,a(n-45) + 32\,a(n-46) - 50\,a(n-47) + 8\,a(n-48). \end{multline*}
...
The construction gives $16512$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $264$; neither removal changes any count.
...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $55$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A298182, the recurrence of order $48$ displayed in Section 1 holds for every $n \ge 49$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,139$. Every one of them vanished. After it, more than $S = 55$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 8, 8, 15, 54, 114, 231, 596,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298182}{A298182}, revision 4, last modified Jan 14 2018.
