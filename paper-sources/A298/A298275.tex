...
\title{A proof of the conjectured linear recurrence for OEIS A298275}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298275}{A298275} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +8*a(n-2) -12*a(n-3) -8*a(n-4) +2*a(n-5) +3*a(n-6) -2*a(n-7) -7*a(n-9) +2*a(n-10) for n>11\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 8\,a(n-2) - 12\,a(n-3) - 8\,a(n-4) + 2\,a(n-5) + 3\,a(n-6) - \\ 2\,a(n-7) - 7\,a(n-9) + 2\,a(n-10). \end{multline*}
...
\begin{theorem} For A298275, the recurrence $a(n) = 6\,a(n-1) + 8\,a(n-2) - 12\,a(n-3) - 8\,a(n-4) + 2\,a(n-5) + 3\,a(n-6) - 2\,a(n-7) - 7\,a(n-9) + 2\,a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 129, 873, 6013, 41437, 285280, 1964290,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298275}{A298275}, revision 4, last modified Jan 16 2018.
