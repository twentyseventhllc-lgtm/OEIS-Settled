...
k=1: a(n) = 55*a(n-2) -725*a(n-4) +3663*a(n-6) -7525*a(n-8) +6335*a(n-10) -1805*a(n-12).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 01 2014). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
