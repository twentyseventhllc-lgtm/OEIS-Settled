...
k=1: a(n) = a(n-1) +3*a(n-3) +a(n-4) +a(n-8) for n>10\\k=2: a(n) = a(n-1) +7*a(n-3) +a(n-4) +a(n-5) -7*a(n-6) -4*a(n-7) +3*a(n-9) for n>12\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 22 2015). As of revision 6, last modified Jun 02 2025, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
