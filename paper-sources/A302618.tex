...
\title{A proof of the conjectured linear recurrence for OEIS A302618}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302618}{A302618} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) +4*a(n-3) -4*a(n-4) -4*a(n-5) +a(n-6) -4*a(n-7) -4*a(n-9) for n>11\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) + 4\,a(n-3) - 4\,a(n-4) - 4\,a(n-5) + a(n-6) - \\ 4\,a(n-7) - 4\,a(n-9). \end{multline*}
...
\begin{theorem} For A302618, the recurrence $a(n) = 2\,a(n-1) + a(n-2) + 4\,a(n-3) - 4\,a(n-4) - 4\,a(n-5) + a(n-6) - 4\,a(n-7) - 4\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 17, 25, 71, 191, 498, 1321, 3505,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302618}{A302618}, revision 4, last modified Apr 10 2018.
