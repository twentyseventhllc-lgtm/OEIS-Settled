...
\title{A proof of the conjectured linear recurrence for OEIS A306161}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A306161}{A306161} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +5*a(n-3) +2*a(n-4) -2*a(n-5) -8*a(n-6) -8*a(n-7) for n>10\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 5\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) - 8\,a(n-6) - \\ 8\,a(n-7). \end{multline*}
...
\begin{theorem} For A306161, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 5\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) - 8\,a(n-6) - 8\,a(n-7)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 5, 17, 32, 77, 207, 523, 1304,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A306161}{A306161}, revision 4, last modified Jun 23 2018.
