...
\title{A proof of the conjectured linear recurrence for OEIS A298497}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298497}{A298497} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +38*a(n-3) -74*a(n-4) -94*a(n-5) -548*a(n-6) +1068*a(n-7) +1218*a(n-8) +4225*a(n-9) -8296*a(n-10) -8891*a(n-11) -20219*a(n-12) +40048*a(n-13) +41055*a(n-14) +65345*a(n-15) -129516*a(n-16) -127567*a(n-17) -150411*a(n-18) +291882*a(n-19) +277454*a(n-20) +255085*a(n-21) -466458*a(n-22) -433314*a(n-23) -325005*a(n-24) +528945*a(n-25) +492165*a(n-26) +313348*a(n-27) -417649*a(n-28) -405446*a(n-29) -226960*a(n-30) +216825*a(n-31) +235781*a(n-32) +118928*a(n-33) -61334*a(n-34) -89164*a(n-35) -39557*a(n-36) +263*a(n-37) +16190*a(n-38) +3967*a(n-39) +5305*a(n-40) +1954*a(n-41) +2833*a(n-42) -770*a(n-43) -1558*a(n-44) -1215*a(n-45) -319*a(n-46) +210*a(n-47) +145*a(n-48) +78*a(n-49) +4*a(n-50) +2*a(n-51) for n>54\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 38\,a(n-3) - 74\,a(n-4) - 94\,a(n-5) - 548\,a(n-6) + \\ 1068\,a(n-7) + 1218\,a(n-8) + 4225\,a(n-9) - 8296\,a(n-10) - 8891\,a(n-11) - 20219\,a(n-12) + \\ 40048\,a(n-13) + 41055\,a(n-14) + 65345\,a(n-15) - 129516\,a(n-16) - 127567\,a(n-17) - 150411\,a(n-18) + \\ 291882\,a(n-19) + 277454\,a(n-20) + 255085\,a(n-21) - 466458\,a(n-22) - 433314\,a(n-23) - 325005\,a(n-24) + \\ 528945\,a(n-25) + 492165\,a(n-26) + 313348\,a(n-27) - 417649\,a(n-28) - 405446\,a(n-29) - 226960\,a(n-30) + \\ 216825\,a(n-31) + 235781\,a(n-32) + 118928\,a(n-33) - 61334\,a(n-34) - 89164\,a(n-35) - 39557\,a(n-36) + \\ 263\,a(n-37) + 16190\,a(n-38) + 3967\,a(n-39) + 5305\,a(n-40) + 1954\,a(n-41) + 2833\,a(n-42) - \\ 770\,a(n-43) - 1558\,a(n-44) - 1215\,a(n-45) - 319\,a(n-46) + 210\,a(n-47) + 145\,a(n-48) + \\ 78\,a(n-49) + 4\,a(n-50) + 2\,a(n-51). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $202$; neither removal changes any count.
...
\begin{theorem} For A298497, the recurrence of order $51$ displayed in Section 1 holds for every $n > 54$, and fails at $n = 54$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,143$. The last nonvanishing one is at $m = 3$, that is at $n = 54$. After it, more than $S = 59$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 13, 4, 38, 54, 97, 467, 1105,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298497}{A298497}, revision 4, last modified Jan 20 2018.
