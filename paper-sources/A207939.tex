...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207939}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207939}{A207939} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) - a(n-2) - 20*a(n-3) + 10*a(n-4) + 28*a(n-5) - 9*a(n-6) - 15*a(n-7) + a(n-8) + 2*a(n-9) for n>10.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(6 + 6*x - 76*x\textasciicircum{}2 - 63*x\textasciicircum{}3 + 247*x\textasciicircum{}4 + 189*x\textasciicircum{}5 - 223*x\textasciicircum{}6 - 171*x\textasciicircum{}7 + 29*x\textasciicircum{}8 + 26*x\textasciicircum{}9) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 - x - x\textasciicircum{}2)*(1 - 2*x - 5*x\textasciicircum{}2 + x\textasciicircum{}4)). - Colin Barker, Mar 06 2018\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - a(n-2) - 20\,a(n-3) + 10\,a(n-4) + 28\,a(n-5) - 9\,a(n-6) - \\ 15\,a(n-7) + a(n-8) + 2\,a(n-9). \end{multline*}

stated for $n > 10$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 6x^{2} - 76x^{3} - 63x^{4} + 247x^{5} + 189x^{6} - 223x^{7} - 171x^{8} + 29x^{9} + 26x^{10}}{1 - 5x + x^{2} + 20x^{3} - 10x^{4} - 28x^{5} + 9x^{6} + 15x^{7} - x^{8} - 2x^{9}}.\]
...
\begin{theorem} For A207939, the recurrence $a(n) = 5\,a(n-1) - a(n-2) - 20\,a(n-3) + 10\,a(n-4) + 28\,a(n-5) - 9\,a(n-6) - 15\,a(n-7) + a(n-8) + 2\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,50$. The last nonvanishing one is at $m = 1$, that is at $n = 10$. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 10$. The theorem is at least as strong.

\begin{theorem} For A207939, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 6x^{2} - 76x^{3} - 63x^{4} + 247x^{5} + 189x^{6} - 223x^{7} - 171x^{8} + 29x^{9} + 26x^{10}}{1 - 5x + x^{2} + 20x^{3} - 10x^{4} - 28x^{5} + 9x^{6} + 15x^{7} - x^{8} - 2x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 98, 271, 844, 2706, 8977, 30168,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207939}{A207939}, revision 8, last modified Mar 06 2018.
