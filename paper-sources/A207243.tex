...
\title{A proof of the conjectured linear recurrence for OEIS A207243}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207243}{A207243} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -3*a(n-2) -3*a(n-3) -4*a(n-4) +16*a(n-5) -8*a(n-6) +2*a(n-7) -8*a(n-8) +10*a(n-9) -14*a(n-10) +12*a(n-11) -4*a(n-12) +4*a(n-13) -5*a(n-14) +4*a(n-15) -3*a(n-16) +a(n-17)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 3\,a(n-2) - 3\,a(n-3) - 4\,a(n-4) + 16\,a(n-5) - 8\,a(n-6) + \\ 2\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) - 14\,a(n-10) + 12\,a(n-11) - 4\,a(n-12) + \\ 4\,a(n-13) - 5\,a(n-14) + 4\,a(n-15) - 3\,a(n-16) + a(n-17). \end{multline*}
...
\begin{theorem} For A207243, the recurrence $a(n) = 4\,a(n-1) - 3\,a(n-2) - 3\,a(n-3) - 4\,a(n-4) + 16\,a(n-5) - 8\,a(n-6) + 2\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) - 14\,a(n-10) + 12\,a(n-11) - 4\,a(n-12) + 4\,a(n-13) - 5\,a(n-14) + 4\,a(n-15) - 3\,a(n-16) + a(n-17)$ holds for every $n \ge 18$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 102, 283, 699, 1526, 3355, 6888,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207243}{A207243}, revision 9, last modified Oct 03 2025.
