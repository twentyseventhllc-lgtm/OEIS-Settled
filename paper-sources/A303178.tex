...
\title{A proof of the conjectured linear recurrence for OEIS A303178}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303178}{A303178} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 6\,a(n-2) - a(n-3) - 15\,a(n-4) - 47\,a(n-5) - 18\,a(n-6) + \\ 91\,a(n-7) + 121\,a(n-8) + 35\,a(n-9) - 33\,a(n-10) - 205\,a(n-11) - 172\,a(n-12) - \\ 49\,a(n-13) + 107\,a(n-14) + 182\,a(n-15) - 26\,a(n-16) + 178\,a(n-17) + 171\,a(n-18) - \\ 156\,a(n-19) - 88\,a(n-20) - 98\,a(n-21) - 154\,a(n-22) + 74\,a(n-23) + 127\,a(n-24) + \\ 19\,a(n-25) - 63\,a(n-26) - 13\,a(n-27) + 26\,a(n-28) - a(n-29) + 4\,a(n-30) - \\ 4\,a(n-31). \end{multline*}
...
\begin{theorem} For A303178, the recurrence of order $31$ displayed in Section 1 holds for every $n > 33$, and fails at $n = 33$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,96$. The last nonvanishing one is at $m = 2$, that is at $n = 33$. After it, more than $S = 36$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 37, 72, 297, 1302, 5050, 20188, 81926,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303178}{A303178}, revision 4, last modified Apr 19 2018.
