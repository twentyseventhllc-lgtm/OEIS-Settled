...
\title{A proof of the conjectured linear recurrence for OEIS A301611}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301611}{A301611} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 1, 2 or 3 horizontally or vertically adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +41*a(n-2) -12*a(n-3) -318*a(n-4) -262*a(n-5) +724*a(n-6) +1034*a(n-7) -1340*a(n-8) -3422*a(n-9) +4016*a(n-10) +12158*a(n-11) +6925*a(n-12) -17989*a(n-13) -30269*a(n-14) +7574*a(n-15) +1694*a(n-16) +8004*a(n-17) -672*a(n-18) +432*a(n-19) -864*a(n-20) for n>21\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 41\,a(n-2) - 12\,a(n-3) - 318\,a(n-4) - 262\,a(n-5) + 724\,a(n-6) + \\ 1034\,a(n-7) - 1340\,a(n-8) - 3422\,a(n-9) + 4016\,a(n-10) + 12158\,a(n-11) + 6925\,a(n-12) - \\ 17989\,a(n-13) - 30269\,a(n-14) + 7574\,a(n-15) + 1694\,a(n-16) + 8004\,a(n-17) - 672\,a(n-18) + \\ 432\,a(n-19) - 864\,a(n-20). \end{multline*}
...
\begin{theorem} For A301611, the recurrence of order $20$ displayed in Section 1 holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,68$. The last nonvanishing one is at $m = 1$, that is at $n = 21$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 34, 367, 3816, 40085, 421025, 4422826, 46459647,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301611}{A301611}, revision 4, last modified Mar 24 2018.
