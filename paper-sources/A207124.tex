...
\title{A proof of the conjectured linear recurrence for OEIS A207124}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207124}{A207124} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -12*a(n-2) +30*a(n-3) -105*a(n-4) +140*a(n-5) -191*a(n-6) +637*a(n-7) -525*a(n-8) +374*a(n-9) -2132*a(n-10) +851*a(n-11) -82*a(n-12) +4997*a(n-13) -364*a(n-14) -761*a(n-15) -7828*a(n-16) -1358*a(n-17) +1552*a(n-18) +7812*a(n-19) +2336*a(n-20) -1168*a(n-21) -4944*a(n-22) -1472*a(n-23) +512*a(n-24) +1632*a(n-25) +448*a(n-26) -128*a(n-27) -256*a(n-28)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 12\,a(n-2) + 30\,a(n-3) - 105\,a(n-4) + 140\,a(n-5) - 191\,a(n-6) + \\ 637\,a(n-7) - 525\,a(n-8) + 374\,a(n-9) - 2132\,a(n-10) + 851\,a(n-11) - 82\,a(n-12) + \\ 4997\,a(n-13) - 364\,a(n-14) - 761\,a(n-15) - 7828\,a(n-16) - 1358\,a(n-17) + 1552\,a(n-18) + \\ 7812\,a(n-19) + 2336\,a(n-20) - 1168\,a(n-21) - 4944\,a(n-22) - 1472\,a(n-23) + 512\,a(n-24) + \\ 1632\,a(n-25) + 448\,a(n-26) - 128\,a(n-27) - 256\,a(n-28). \end{multline*}
...
\begin{theorem} For A207124, the recurrence of order $28$ displayed in Section 1 holds for every $n \ge 29$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 289, 1024, 4096, 14161, 45796, 150544,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207124}{A207124}, revision 9, last modified Oct 03 2025.
