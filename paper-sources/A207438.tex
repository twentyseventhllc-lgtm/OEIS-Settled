...
\title{A proof of the conjectured linear recurrence for OEIS A207438}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207438}{A207438} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) +a(n-2) -120*a(n-3) +106*a(n-4) +730*a(n-5) -804*a(n-6) -2308*a(n-7) +2565*a(n-8) +4000*a(n-9) -4254*a(n-10) -3640*a(n-11) +3811*a(n-12) +1460*a(n-13) -1708*a(n-14) -82*a(n-15) +284*a(n-16) -48*a(n-17) for n>18\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) + a(n-2) - 120\,a(n-3) + 106\,a(n-4) + 730\,a(n-5) - 804\,a(n-6) - \\ 2308\,a(n-7) + 2565\,a(n-8) + 4000\,a(n-9) - 4254\,a(n-10) - 3640\,a(n-11) + 3811\,a(n-12) + \\ 1460\,a(n-13) - 1708\,a(n-14) - 82\,a(n-15) + 284\,a(n-16) - 48\,a(n-17). \end{multline*}
...
\begin{theorem} For A207438, the recurrence $a(n) = 8\,a(n-1) + a(n-2) - 120\,a(n-3) + 106\,a(n-4) + 730\,a(n-5) - 804\,a(n-6) - 2308\,a(n-7) + 2565\,a(n-8) + 4000\,a(n-9) - 4254\,a(n-10) - 3640\,a(n-11) + 3811\,a(n-12) + 1460\,a(n-13) - 1708\,a(n-14) - 82\,a(n-15) + 284\,a(n-16) - 48\,a(n-17)$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,65$. The last nonvanishing one is at $m = 1$, that is at $n = 18$. After it, more than $S = 21$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 323, 1360, 6525, 32393, 165626, 855471,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207438}{A207438}, revision 9, last modified Oct 03 2025.
