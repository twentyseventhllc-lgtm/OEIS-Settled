...
\title{A proof of the conjectured linear recurrence for OEIS A197674}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197674}{A197674} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,1,0,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +a(n-2) -6*a(n-3) -14*a(n-4) +29*a(n-6) -18*a(n-7) -29*a(n-8) -46*a(n-9) +79*a(n-10) +199*a(n-11) +62*a(n-12) -91*a(n-13) -228*a(n-14) -70*a(n-15) +92*a(n-16) +71*a(n-17) +30*a(n-18) -35*a(n-19) -3*a(n-20) -3*a(n-21) -18*a(n-22) +4*a(n-23) +a(n-24) -a(n-25) +a(n-26)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + a(n-2) - 6\,a(n-3) - 14\,a(n-4) + 29\,a(n-6) - 18\,a(n-7) - \\ 29\,a(n-8) - 46\,a(n-9) + 79\,a(n-10) + 199\,a(n-11) + 62\,a(n-12) - 91\,a(n-13) - \\ 228\,a(n-14) - 70\,a(n-15) + 92\,a(n-16) + 71\,a(n-17) + 30\,a(n-18) - 35\,a(n-19) - \\ 3\,a(n-20) - 3\,a(n-21) - 18\,a(n-22) + 4\,a(n-23) + a(n-24) - a(n-25) + \\ a(n-26). \end{multline*}
...
The entry lists, for each value $x$, a target value $\tau(x)$: \tau(0) = 2, \tau(1) = 0, \tau(2) = 1, \tau(3) = 0, \tau(4) = 1. The condition is that for every cell,
...
\begin{theorem} For A197674, the recurrence of order $26$ displayed in Section 1 holds for every $n \ge 27$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,83$. Every one of them vanished. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 16, 57, 202, 721, 2557, 8930, 31326,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197674}{A197674}, revision 9, last modified Oct 03 2025.
