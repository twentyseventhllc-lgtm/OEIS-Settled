...
\title{A proof of the conjectured order of the recurrence for OEIS A300535}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300535}{A300535} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A300535, the least order of a linear recurrence that $a$ eventually satisfies is exactly $75$, and that recurrence holds for every $n > 78$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 16, 36, 300, 1436, 8974, 52012, 311037,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300535}{A300535}, revision 4, last modified Mar 08 2018.
