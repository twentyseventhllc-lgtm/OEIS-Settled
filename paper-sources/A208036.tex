...
\title{A proof of the conjectured linear recurrence for OEIS A208036}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208036}{A208036} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-2) +33*a(n-3) +62*a(n-4) +114*a(n-5) -28*a(n-6) -241*a(n-7) -432*a(n-8) +51*a(n-9) +421*a(n-10) +289*a(n-11) -471*a(n-12) -277*a(n-13) -13*a(n-14) +275*a(n-15) +54*a(n-16) +40*a(n-17) -101*a(n-18) +18*a(n-19) -19*a(n-20) +15*a(n-21) -3*a(n-22) +2*a(n-23) -a(n-24) for n>25\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 4\,a(n-2) + 33\,a(n-3) + 62\,a(n-4) + 114\,a(n-5) - 28\,a(n-6) - \\ 241\,a(n-7) - 432\,a(n-8) + 51\,a(n-9) + 421\,a(n-10) + 289\,a(n-11) - 471\,a(n-12) - \\ 277\,a(n-13) - 13\,a(n-14) + 275\,a(n-15) + 54\,a(n-16) + 40\,a(n-17) - 101\,a(n-18) + \\ 18\,a(n-19) - 19\,a(n-20) + 15\,a(n-21) - 3\,a(n-22) + 2\,a(n-23) - a(n-24). \end{multline*}
...
\begin{theorem} For A208036, the recurrence of order $24$ displayed in Section 1 holds for every $n > 25$, and fails at $n = 25$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,78$. The last nonvanishing one is at $m = 1$, that is at $n = 25$. After it, more than $S = 27$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 15, 225, 1071, 4743, 21147, 94605, 422477, 1889665,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208036}{A208036}, revision 9, last modified Oct 03 2025.
