...
\title{A proof of the conjectured linear recurrence for OEIS A229632}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A229632}{A229632} as

\begin{quote}\itshape Number of defective 3-colorings of an nX3 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order\end{quote}
...
The reachable part of the digraph has $100$ states, $72$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 10$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $10\times10$ matrix.
...
\begin{theorem} For A229632, the recurrence $a(n) = 15\,a(n-1) - 81\,a(n-2) + 185\,a(n-3) - 162\,a(n-4) + 60\,a(n-5) - 8\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 40, 244, 1496, 8800, 50084, 277996, 1513104,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A229632}{A229632}, revision 8, last modified Jul 23 2025.
