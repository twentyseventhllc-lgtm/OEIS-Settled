...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A254971}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A254971}{A254971} as

\begin{quote}\itshape Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 and no column sum 0\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 3*a(n-3) + 5*a(n-4) - a(n-5) - 6*a(n-6) - 7*a(n-7) + 2*a(n-9) - a(n-10) for n>11.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(121 + 68*x + 146*x\textasciicircum{}2 + 242*x\textasciicircum{}3 - 72*x\textasciicircum{}4 - 328*x\textasciicircum{}5 - 356*x\textasciicircum{}6 - 3*x\textasciicircum{}7 + 96*x\textasciicircum{}8 - 45*x\textasciicircum{}9 - 2*x\textasciicircum{}10) / ((1 + x)*(1 - 3*x + x\textasciicircum{}2 - 4*x\textasciicircum{}3 - x\textasciicircum{}4 + 2*x\textasciicircum{}5 + 4*x\textasciicircum{}6 + 3*x\textasciicircum{}7 - 3*x\textasciicircum{}8 + x\textasciicircum{}9)). - Colin Barker, Dec 18 2018\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 5\,a(n-4) - a(n-5) - 6\,a(n-6) - \\ 7\,a(n-7) + 2\,a(n-9) - a(n-10). \end{multline*}

stated for $n > 11$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{121x + 68x^{2} + 146x^{3} + 242x^{4} - 72x^{5} - 328x^{6} - 356x^{7} - 3x^{8} + 96x^{9} - 45x^{10} - 2x^{11}}{1 - 2x - 2x^{2} - 3x^{3} - 5x^{4} + x^{5} + 6x^{6} + 7x^{7} - 2x^{9} + x^{10}}.\]
...
\begin{theorem} For A254971, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 5\,a(n-4) - a(n-5) - 6\,a(n-6) - 7\,a(n-7) + 2\,a(n-9) - a(n-10)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,53$. The last nonvanishing one is at $m = 1$, that is at $n = 11$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 11$. The theorem is at least as strong.

\begin{theorem} For A254971, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{121x + 68x^{2} + 146x^{3} + 242x^{4} - 72x^{5} - 328x^{6} - 356x^{7} - 3x^{8} + 96x^{9} - 45x^{10} - 2x^{11}}{1 - 2x - 2x^{2} - 3x^{3} - 5x^{4} + x^{5} + 6x^{6} + 7x^{7} - 2x^{9} + x^{10}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 121, 310, 1008, 3241, 9961, 30529, 94351, 292130,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A254971}{A254971}, revision 8, last modified Dec 18 2018.
