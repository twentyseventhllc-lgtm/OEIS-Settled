...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A188701}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A188701}{A188701} as

\begin{quote}\itshape Number of n X 4 binary arrays without the pattern 0 0 diagonally or vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 20*a(n-2) + 27*a(n-3) - 14*a(n-4) - 25*a(n-5) + 4*a(n-6) + 5*a(n-7) - a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(16 + 39*x + 12*x\textasciicircum{}2 - 43*x\textasciicircum{}3 - 20*x\textasciicircum{}4 + 9*x\textasciicircum{}5 + 4*x\textasciicircum{}6 - x\textasciicircum{}7) / ((1 + x)*(1 + 2*x - x\textasciicircum{}2)*(1 - 4*x - 9*x\textasciicircum{}2 + 5*x\textasciicircum{}3 + 4*x\textasciicircum{}4 - x\textasciicircum{}5)). - Colin Barker, Apr 28 2018\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 20\,a(n-2) + 27\,a(n-3) - 14\,a(n-4) - 25\,a(n-5) + 4\,a(n-6) + \\ 5\,a(n-7) - a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{16x + 39x^{2} + 12x^{3} - 43x^{4} - 20x^{5} + 9x^{6} + 4x^{7} - x^{8}}{1 - x - 20x^{2} - 27x^{3} + 14x^{4} + 25x^{5} - 4x^{6} - 5x^{7} + x^{8}}.\]
...
\begin{theorem} For A188701, the recurrence $a(n) = a(n-1) + 20\,a(n-2) + 27\,a(n-3) - 14\,a(n-4) - 25\,a(n-5) + 4\,a(n-6) + 5\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A188701, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{16x + 39x^{2} + 12x^{3} - 43x^{4} - 20x^{5} + 9x^{6} + 4x^{7} - x^{8}}{1 - x - 20x^{2} - 27x^{3} + 14x^{4} + 25x^{5} - 4x^{6} - 5x^{7} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 55, 387, 1876, 10857, 57665, 318732, 1729531,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188701}{A188701}, revision 9, last modified Apr 28 2018.
