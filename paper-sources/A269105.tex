...
\title{A proof of the conjectured linear recurrence for OEIS A269105}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269105}{A269105} as

\begin{quote}\itshape Number of nX4 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three no more than once\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 90*a(n-1) -2559*a(n-2) +24556*a(n-3) -94959*a(n-4) +140442*a(n-5) -69169*a(n-6) for n>7\end{quote}
...
\begin{theorem} For A269105, the recurrence $a(n) = 90\,a(n-1) - 2559\,a(n-2) + 24556\,a(n-3) - 94959\,a(n-4) + 140442\,a(n-5) - 69169\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,38$. The last nonvanishing one is at $m = 1$, that is at $n = 7$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 13 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 216, 15540, 872460, 43964700, 2085484068, 95166487524, 4227147007836, 184069947098892,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269105}{A269105}, revision 4, last modified Feb 19 2016.
