...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207730}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207730}{A207730} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 5*a(n-3) + 22*a(n-4) - 24*a(n-5) - 15*a(n-6) - 36*a(n-8) + 27*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(6 + 24*x + 6*x\textasciicircum{}2 - 17*x\textasciicircum{}3 - 39*x\textasciicircum{}4 - 51*x\textasciicircum{}5 - 9*x\textasciicircum{}6 - 9*x\textasciicircum{}7 + 27*x\textasciicircum{}8) / ((1 - 3*x)*(1 + x - x\textasciicircum{}2)*(1 + x\textasciicircum{}2)*(1 + 3*x\textasciicircum{}2 - 9*x\textasciicircum{}4)). - Colin Barker, Mar 05 2018\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 5\,a(n-3) + 22\,a(n-4) - 24\,a(n-5) - 15\,a(n-6) - 36\,a(n-8) + \\ 27\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{6x + 24x^{2} + 6x^{3} - 17x^{4} - 39x^{5} - 51x^{6} - 9x^{7} - 9x^{8} + 27x^{9}}{1 - 2x - 5x^{3} - 22x^{4} + 24x^{5} + 15x^{6} + 36x^{8} - 27x^{9}}.\]
...
\begin{theorem} For A207730, the recurrence $a(n) = 2\,a(n-1) + 5\,a(n-3) + 22\,a(n-4) - 24\,a(n-5) - 15\,a(n-6) - 36\,a(n-8) + 27\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A207730, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{6x + 24x^{2} + 6x^{3} - 17x^{4} - 39x^{5} - 51x^{6} - 9x^{7} - 9x^{8} + 27x^{9}}{1 - 2x - 5x^{3} - 22x^{4} + 24x^{5} + 15x^{6} + 36x^{8} - 27x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 6, 36, 78, 169, 611, 2209, 6016, 16384,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207730}{A207730}, revision 8, last modified Mar 05 2018.
