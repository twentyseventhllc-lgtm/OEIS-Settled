...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250787}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250787}{A250787} as

\begin{quote}\itshape Number of (5+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) - 12*a(n-2) + 5*a(n-3) + 13*a(n-4) - 16*a(n-5) + 2*a(n-6) + 5*a(n-7) - 2*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(72 - 234*x + 171*x\textasciicircum{}2 + 259*x\textasciicircum{}3 - 420*x\textasciicircum{}4 + 70*x\textasciicircum{}5 + 148*x\textasciicircum{}6 - 64*x\textasciicircum{}7) / ((1 - x)\textasciicircum{}4*(1 + x)*(1 - 2*x)*(1 - x - x\textasciicircum{}2)). - Colin Barker, Nov 20 2018\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 12\,a(n-2) + 5\,a(n-3) + 13\,a(n-4) - 16\,a(n-5) + 2\,a(n-6) + \\ 5\,a(n-7) - 2\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{144x - 468x^{2} + 342x^{3} + 518x^{4} - 840x^{5} + 140x^{6} + 296x^{7} - 128x^{8}}{1 - 6x + 12x^{2} - 5x^{3} - 13x^{4} + 16x^{5} - 2x^{6} - 5x^{7} + 2x^{8}}.\]
...
\begin{theorem} For A250787, the recurrence $a(n) = 6\,a(n-1) - 12\,a(n-2) + 5\,a(n-3) + 13\,a(n-4) - 16\,a(n-5) + 2\,a(n-6) + 5\,a(n-7) - 2\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250787, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{144x - 468x^{2} + 342x^{3} + 518x^{4} - 840x^{5} + 140x^{6} + 296x^{7} - 128x^{8}}{1 - 6x + 12x^{2} - 5x^{3} - 13x^{4} + 16x^{5} - 2x^{6} - 5x^{7} + 2x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 144, 396, 990, 2426, 5688, 12950, 28692, 62274,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250787}{A250787}, revision 7, last modified Nov 20 2018.
