...
k=1: a(n) = a(n-2) +2*a(n-3) +6*a(n-4) +2*a(n-5) -a(n-6) +2*a(n-7) -a(n-8) for n>9\\k=4: a(n) = 3*a(n-7) +5*a(n-10) +a(n-13) -a(n-14) -a(n-17) -2*a(n-21) for n>24\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 04 2015). As of revision 6, last modified Jun 02 2025, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
