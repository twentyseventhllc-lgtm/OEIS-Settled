...
\title{A proof of the conjectured linear recurrence for OEIS A297453}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297453}{A297453} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0 or 2 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -2*a(n-2) +14*a(n-3) -69*a(n-4) +45*a(n-5) -13*a(n-6) +23*a(n-7) +3*a(n-8) +3*a(n-9) +2*a(n-10) -4*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 2\,a(n-2) + 14\,a(n-3) - 69\,a(n-4) + 45\,a(n-5) - 13\,a(n-6) + \\ 23\,a(n-7) + 3\,a(n-8) + 3\,a(n-9) + 2\,a(n-10) - 4\,a(n-11). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $100$; neither removal changes any count.
...
\begin{theorem} For A297453, the recurrence $a(n) = 6\,a(n-1) - 2\,a(n-2) + 14\,a(n-3) - 69\,a(n-4) + 45\,a(n-5) - 13\,a(n-6) + 23\,a(n-7) + 3\,a(n-8) + 3\,a(n-9) + 2\,a(n-10) - 4\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 57, 285, 1677, 9774, 55713, 321030, 1848151,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297453}{A297453}, revision 4, last modified Dec 30 2017.
