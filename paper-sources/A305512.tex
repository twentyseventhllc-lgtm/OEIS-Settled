...
\title{A proof of the conjectured linear recurrence for OEIS A305512}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305512}{A305512} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +5*a(n-3) -8*a(n-6) -8*a(n-7) -10*a(n-9) -a(n-10) +a(n-11) -2*a(n-12) -2*a(n-14) for n>17\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 5\,a(n-3) - 8\,a(n-6) - 8\,a(n-7) - 10\,a(n-9) - \\ a(n-10) + a(n-11) - 2\,a(n-12) - 2\,a(n-14). \end{multline*}
...
\begin{theorem} For A305512, the recurrence $a(n) = a(n-1) + a(n-2) + 5\,a(n-3) - 8\,a(n-6) - 8\,a(n-7) - 10\,a(n-9) - a(n-10) + a(n-11) - 2\,a(n-12) - 2\,a(n-14)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,74$. The last nonvanishing one is at $m = 3$, that is at $n = 17$. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 1, 6, 10, 13, 38, 73, 164,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305512}{A305512}, revision 4, last modified Jun 03 2018.
