...
\title{A proof of the conjectured generating function for OEIS A250774}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250774}{A250774} as
...
\begin{quote}\ttfamily Empirical g.f.: 2*x*(144 - 463*x + 421*x\textasciicircum{}2 - 128*x\textasciicircum{}3) / ((1 - x)\textasciicircum{}3*(1 - 2*x)). - Colin Barker, Nov 19 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{288x - 926x^{2} + 842x^{3} - 256x^{4}}{1 - 5x + 9x^{2} - 7x^{3} + 2x^{4}}.\]
...
\begin{theorem} For A250774, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{288x - 926x^{2} + 842x^{3} - 256x^{4}}{1 - 5x + 9x^{2} - 7x^{3} + 2x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 288, 514, 820, 1234, 1812, 2666, 4020, 6322,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250774}{A250774}, revision 8, last modified Nov 19 2018.
