...
\title{A proof of the conjectured generating function for OEIS A250810}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250810}{A250810} as
...
\begin{quote}\ttfamily Empirical g.f.: 3*x*(432 - 879*x + 653*x\textasciicircum{}2) / ((1 - x)*(1 - 2*x)*(1 - 3*x)). - Colin Barker, Nov 20 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{1296x - 2637x^{2} + 1959x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}.\]
...
For scale: at $n = 8$ there are $3^{56}$ arrays, about $10^{27}$, against $15$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A250810, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{1296x - 2637x^{2} + 1959x^{3}}{1 - 6x + 11x^{2} - 6x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1296, 5139, 18537, 62469, 201741, 634509, 1962717, 6007149,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250810}{A250810}, revision 8, last modified Nov 20 2018.
