...
\title{A proof of the conjectured linear recurrence for OEIS A197245}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A197245}{A197245} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,0,1,1,1 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) +9*a(n-3) +26*a(n-4) +58*a(n-5) -25*a(n-6) -148*a(n-7) -104*a(n-8) -114*a(n-9) +55*a(n-10) -149*a(n-11) +186*a(n-12) -9*a(n-13) +39*a(n-14) -55*a(n-15) +21*a(n-16) +a(n-17) +2*a(n-18) -a(n-19) for n>20\end{quote}
...
\begin{multline*} a(n) = a(n-2) + 9\,a(n-3) + 26\,a(n-4) + 58\,a(n-5) - 25\,a(n-6) - 148\,a(n-7) - \\ 104\,a(n-8) - 114\,a(n-9) + 55\,a(n-10) - 149\,a(n-11) + 186\,a(n-12) - 9\,a(n-13) + \\ 39\,a(n-14) - 55\,a(n-15) + 21\,a(n-16) + a(n-17) + 2\,a(n-18) - a(n-19). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $151$; neither removal changes any count.
...
\begin{theorem} For A197245, the recurrence $a(n) = a(n-2) + 9\,a(n-3) + 26\,a(n-4) + 58\,a(n-5) - 25\,a(n-6) - 148\,a(n-7) - 104\,a(n-8) - 114\,a(n-9) + 55\,a(n-10) - 149\,a(n-11) + 186\,a(n-12) - 9\,a(n-13) + 39\,a(n-14) - 55\,a(n-15) + 21\,a(n-16) + a(n-17) + 2\,a(n-18) - a(n-19)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,73$. The last nonvanishing one is at $m = 1$, that is at $n = 20$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 8, 3, 53, 110, 227, 1035, 2004,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A197245}{A197245}, revision 9, last modified Oct 03 2025.
