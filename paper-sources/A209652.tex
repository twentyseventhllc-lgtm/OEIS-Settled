...
\title{A proof of the conjectured linear recurrence for OEIS A209652}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A209652}{A209652} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-1) -13*a(n-2) -243*a(n-3) +709*a(n-4) +2169*a(n-5) -9198*a(n-6) -9930*a(n-7) +61958*a(n-8) +23330*a(n-9) -254062*a(n-10) -16614*a(n-11) +669763*a(n-12) -53961*a(n-13) -1146177*a(n-14) +176529*a(n-15) +1247849*a(n-16) -252499*a(n-17) -820948*a(n-18) +202824*a(n-19) +291592*a(n-20) -85440*a(n-21) -41472*a(n-22) +13824*a(n-23) for n>24\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-1) - 13\,a(n-2) - 243\,a(n-3) + 709\,a(n-4) + 2169\,a(n-5) - 9198\,a(n-6) - \\ 9930\,a(n-7) + 61958\,a(n-8) + 23330\,a(n-9) - 254062\,a(n-10) - 16614\,a(n-11) + 669763\,a(n-12) - \\ 53961\,a(n-13) - 1146177\,a(n-14) + 176529\,a(n-15) + 1247849\,a(n-16) - 252499\,a(n-17) - 820948\,a(n-18) + \\ 202824\,a(n-19) + 291592\,a(n-20) - 85440\,a(n-21) - 41472\,a(n-22) + 13824\,a(n-23). \end{multline*}
...
\begin{theorem} For A209652, the recurrence of order $23$ displayed in Section 1 holds for every $n > 24$, and fails at $n = 24$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 1$, that is at $n = 24$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 390, 1215, 4690, 16830, 65765, 251160,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A209652}{A209652}, revision 9, last modified Oct 03 2025.
