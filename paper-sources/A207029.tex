...
\title{A proof of the conjectured linear recurrence for OEIS A207029}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207029}{A207029} as

\begin{quote}\itshape Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -5*a(n-2) -25*a(n-3) +5*a(n-4) +146*a(n-5) -21*a(n-6) -400*a(n-7) -230*a(n-8) +955*a(n-9) +807*a(n-10) -997*a(n-11) -2055*a(n-12) +345*a(n-13) +2000*a(n-14) +1561*a(n-15) -601*a(n-16) -1120*a(n-17) -2255*a(n-18) -690*a(n-19) +1257*a(n-20) +3043*a(n-21) +570*a(n-22) -650*a(n-23) -1885*a(n-24) -921*a(n-25) -654*a(n-26) +1200*a(n-27) +910*a(n-28) +655*a(n-29) -421*a(n-30) -229*a(n-31) -520*a(n-32) -45*a(n-33) +25*a(n-34) +240*a(n-35) +25*a(n-36) +50*a(n-37) -45*a(n-38) -15*a(n-39) -30*a(n-40) +10*a(n-41) +5*a(n-43) +a(n-45) -a(n-46)\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) - 5\,a(n-2) - 25\,a(n-3) + 5\,a(n-4) + 146\,a(n-5) - 21\,a(n-6) - \\ 400\,a(n-7) - 230\,a(n-8) + 955\,a(n-9) + 807\,a(n-10) - 997\,a(n-11) - 2055\,a(n-12) + \\ 345\,a(n-13) + 2000\,a(n-14) + 1561\,a(n-15) - 601\,a(n-16) - 1120\,a(n-17) - 2255\,a(n-18) - \\ 690\,a(n-19) + 1257\,a(n-20) + 3043\,a(n-21) + 570\,a(n-22) - 650\,a(n-23) - 1885\,a(n-24) - \\ 921\,a(n-25) - 654\,a(n-26) + 1200\,a(n-27) + 910\,a(n-28) + 655\,a(n-29) - 421\,a(n-30) - \\ 229\,a(n-31) - 520\,a(n-32) - 45\,a(n-33) + 25\,a(n-34) + 240\,a(n-35) + 25\,a(n-36) + \\ 50\,a(n-37) - 45\,a(n-38) - 15\,a(n-39) - 30\,a(n-40) + 10\,a(n-41) + 5\,a(n-43) + \\ a(n-45) - a(n-46). \end{multline*}
...
\begin{theorem} For A207029, the recurrence of order $46$ displayed in Section 1 holds for every $n \ge 47$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 396, 1719, 6123, 16038, 49925, 129302,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207029}{A207029}, revision 9, last modified Oct 03 2025.
