...
\title{A proof of the conjectured closed form for OEIS A209646}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A209646}{A209646} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 9*n\textasciicircum{}3 + (9/2)*n\textasciicircum{}2 - (9/2)*n.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Mar 11 2012).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 25, last modified Aug 06 2026, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = -\frac{9}{2}n + \frac{9}{2}n^{2} + 9n^{3}.\]
...
\begin{theorem} For A209646, $a(n)$ is the polynomial $-\frac{9}{2}n + \frac{9}{2}n^{2} + 9n^{3}$ for every $n \ge 1$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 38 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 270, 630, 1215, 2079, 3276, 4860,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A209646}{A209646}, revision 25, last modified Aug 06 2026.
