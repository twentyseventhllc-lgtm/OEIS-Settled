...
\title{A proof of the conjectured linear recurrence for OEIS A255621}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255621}{A255621} as

\begin{quote}\itshape Number of length n+7 0..2 arrays with at most two downsteps in every 7 consecutive neighbor pairs\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +a(n-3) +12*a(n-4) -18*a(n-5) +7*a(n-6) +153*a(n-7) -237*a(n-8) +95*a(n-9) -885*a(n-11) +1087*a(n-12) -123*a(n-13) -6870*a(n-14) +8984*a(n-15) -1401*a(n-16) -1260*a(n-17) +11772*a(n-18) -16266*a(n-19) +6696*a(n-20) +69471*a(n-21) -114183*a(n-22) +47448*a(n-23) -100*a(n-24) -17955*a(n-25) +5628*a(n-26) -700*a(n-27) -2565*a(n-28) +804*a(n-29) -100*a(n-30)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + a(n-3) + 12\,a(n-4) - 18\,a(n-5) + 7\,a(n-6) + \\ 153\,a(n-7) - 237\,a(n-8) + 95\,a(n-9) - 885\,a(n-11) + 1087\,a(n-12) - 123\,a(n-13) - \\ 6870\,a(n-14) + 8984\,a(n-15) - 1401\,a(n-16) - 1260\,a(n-17) + 11772\,a(n-18) - 16266\,a(n-19) + \\ 6696\,a(n-20) + 69471\,a(n-21) - 114183\,a(n-22) + 47448\,a(n-23) - 100\,a(n-24) - 17955\,a(n-25) + \\ 5628\,a(n-26) - 700\,a(n-27) - 2565\,a(n-28) + 804\,a(n-29) - 100\,a(n-30). \end{multline*}
...
The objects are the words $w_1 w_2 \cdots w_L$ over $\{0,1,\dots,2\}$ of length $L = n + 7$ satisfying the entry's conditions, which are, clause by clause:
...
The reachable part of that digraph has $3280$ states, $3280$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 96$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $96\times96$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A255621, the recurrence of order $30$ displayed in Section 1 holds for every $n \ge 31$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,153$. Every one of them vanished. After it, more than $S = 96$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3834, 9186, 23298, 60390, 156563, 405687, 1047141, 2656032,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255621}{A255621}, revision 6, last modified Jul 23 2025.
