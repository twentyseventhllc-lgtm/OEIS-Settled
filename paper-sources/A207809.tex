...
\title{A proof of the conjectured linear recurrence for OEIS A207809}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207809}{A207809} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +13*a(n-2) +4*a(n-3) -12*a(n-4) +a(n-5) +a(n-6)\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 20 2012).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 18, last modified Jul 04 2016, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = 2\,a(n-1) + 13\,a(n-2) + 4\,a(n-3) - 12\,a(n-4) + a(n-5) + a(n-6).\]
...
\begin{theorem} For A207809, the recurrence $a(n) = 2\,a(n-1) + 13\,a(n-2) + 4\,a(n-3) - 12\,a(n-4) + a(n-5) + a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 370, 1970, 9040, 43990, 209050, 1002960,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207809}{A207809}, revision 18, last modified Jul 04 2016.
