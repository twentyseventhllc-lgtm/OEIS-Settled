...
k=1: a(n) = 61*a(n-2) -813*a(n-4) +4271*a(n-6) -9694*a(n-8) +8264*a(n-10) -1536*a(n-12).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 03 2014). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
