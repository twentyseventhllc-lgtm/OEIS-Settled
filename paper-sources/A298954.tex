...
\title{A proof of the conjectured linear recurrence for OEIS A298954}
...
\begin{theorem} For A298954, the recurrence of order $69$ displayed in Section 1 holds for every $n \ge 70$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,177$. Every one of them vanished. After it, more than $S = 74$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 3, 3, 6, 10, 22, 47, 143,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298954}{A298954}, revision 4, last modified Jan 30 2018.
