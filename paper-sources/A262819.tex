...
\title{Proofs of the conjectured column and row recurrences for OEIS A262819}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A262819}{A262819} as

\begin{quote}\itshape T(n,k)=Number of (n+3)X(k+3) 0..1 arrays with each row divisible by 9 and column not divisible by 9, read as a binary number with top and left being the most significant bits\end{quote}
...
k=3: [linear recurrence of order 17]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Oct 03 2015). As of revision 4, last modified Oct 03 2015, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 3$ of A262819, the recurrence $a(n) = 0$ holds for every $n \ge 18$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A262819}{A262819}, revision 4, last modified Oct 03 2015.
