...
\title{Proofs of the conjectured column and row recurrences for OEIS A269152}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269152}{A269152} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..3 arrays with some element plus some horizontally, antidiagonally or vertically adjacent neighbor totalling three exactly once\end{quote}
...
The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 20 2016). As of revision 6, last modified Jan 20 2024, the entry records no proof of any of them and links to none. This note proves the 3 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A269152, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269152, the recurrence $a(n) = 12\,a(n-1) - 38\,a(n-2) + 12\,a(n-3) - a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269152, the recurrence $a(n) = 0$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269152}{A269152}, revision 6, last modified Jan 20 2024.
