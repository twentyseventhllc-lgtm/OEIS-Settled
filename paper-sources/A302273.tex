...
\title{A proof of the conjectured linear recurrence for OEIS A302273}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302273}{A302273} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +5*a(n-2) +26*a(n-3) -66*a(n-4) -86*a(n-5) +79*a(n-6) +14*a(n-7) +13*a(n-8) -168*a(n-9) +250*a(n-10) +428*a(n-11) -232*a(n-12) -24*a(n-13) -160*a(n-14) +160*a(n-15) -256*a(n-16) -384*a(n-17) +256*a(n-18).\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 5\,a(n-2) + 26\,a(n-3) - 66\,a(n-4) - 86\,a(n-5) + 79\,a(n-6) + \\ 14\,a(n-7) + 13\,a(n-8) - 168\,a(n-9) + 250\,a(n-10) + 428\,a(n-11) - 232\,a(n-12) - \\ 24\,a(n-13) - 160\,a(n-14) + 160\,a(n-15) - 256\,a(n-16) - 384\,a(n-17) + 256\,a(n-18). \end{multline*}
...
\begin{theorem} For A302273, the recurrence $a(n) = 2\,a(n-1) + 5\,a(n-2) + 26\,a(n-3) - 66\,a(n-4) - 86\,a(n-5) + 79\,a(n-6) + 14\,a(n-7) + 13\,a(n-8) - 168\,a(n-9) + 250\,a(n-10) + 428\,a(n-11) - 232\,a(n-12) - 24\,a(n-13) - 160\,a(n-14) + 160\,a(n-15) - 256\,a(n-16) - 384\,a(n-17) + 256\,a(n-18)$ holds for every $n \ge 19$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. Every one of them vanished. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 7, 22, 79, 269, 942, 3401, 12283,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302273}{A302273}, revision 7, last modified Apr 05 2018.
