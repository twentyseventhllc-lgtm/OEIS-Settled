...
\title{A proof of the conjectured linear recurrence for OEIS A261261}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A261261}{A261261} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +5*a(n-3) +4*a(n-4) +8*a(n-5) +7*a(n-6) +7*a(n-7) +5*a(n-8) -5*a(n-9) -8*a(n-10) -7*a(n-11) -5*a(n-12) -a(n-13) +a(n-14) +a(n-15) +a(n-16) for n>17\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 5\,a(n-3) + 4\,a(n-4) + 8\,a(n-5) + 7\,a(n-6) + 7\,a(n-7) + \\ 5\,a(n-8) - 5\,a(n-9) - 8\,a(n-10) - 7\,a(n-11) - 5\,a(n-12) - a(n-13) + \\ a(n-14) + a(n-15) + a(n-16). \end{multline*}
...
That refinement leaves $34$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 25$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A261261, the recurrence $a(n) = a(n-1) + 5\,a(n-3) + 4\,a(n-4) + 8\,a(n-5) + 7\,a(n-6) + 7\,a(n-7) + 5\,a(n-8) - 5\,a(n-9) - 8\,a(n-10) - 7\,a(n-11) - 5\,a(n-12) - a(n-13) + a(n-14) + a(n-15) + a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,72$. The last nonvanishing one is at $m = 1$, that is at $n = 17$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 166, 232, 690, 1918, 4350, 10382, 26072, 63964,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A261261}{A261261}, revision 4, last modified Aug 13 2015.
