...
\title{A proof of the conjectured linear recurrence for OEIS A261375}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A261375}{A261375} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00001011 00010101 or 01010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) +11*a(n-4) +13*a(n-6) -2*a(n-8) -2*a(n-10) +4*a(n-12) for n>17\end{quote}
...
\begin{theorem} For A261375, the recurrence $a(n) = a(n-2) + 11\,a(n-4) + 13\,a(n-6) - 2\,a(n-8) - 2\,a(n-10) + 4\,a(n-12)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 5$, that is at $n = 17$. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 60, 82, 202, 424, 869, 1714, 3778, 7462,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A261375}{A261375}, revision 4, last modified Aug 17 2015.
