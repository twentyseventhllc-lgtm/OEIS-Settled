...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A261107}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A261107}{A261107} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-3) +2*a(n-4) +2*a(n-5) +a(n-6) for n>7.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(33 + 19*x + 54*x\textasciicircum{}2 + 34*x\textasciicircum{}3 + 26*x\textasciicircum{}4 + 6*x\textasciicircum{}5 - 5*x\textasciicircum{}6) / (1 - x - 2*x\textasciicircum{}3 - 2*x\textasciicircum{}4 - 2*x\textasciicircum{}5 - x\textasciicircum{}6). - Colin Barker, Dec 30 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{33x + 19x^{2} + 54x^{3} + 34x^{4} + 26x^{5} + 6x^{6} - 5x^{7}}{1 - x - 2x^{3} - 2x^{4} - 2x^{5} - x^{6}}.\]
...
\begin{theorem} For A261107, the recurrence $a(n) = a(n-1) + 2\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) + a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,53$. The last nonvanishing one is at $m = 1$, that is at $n = 7$. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 7$. The theorem is at least as strong.

\begin{theorem} For A261107, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{33x + 19x^{2} + 54x^{3} + 34x^{4} + 26x^{5} + 6x^{6} - 5x^{7}}{1 - x - 2x^{3} - 2x^{4} - 2x^{5} - x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 33, 52, 106, 206, 402, 790, 1546, 3026,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A261107}{A261107}, revision 8, last modified Dec 30 2018.
