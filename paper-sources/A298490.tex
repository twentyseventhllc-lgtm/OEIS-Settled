...
\title{A proof of the conjectured linear recurrence for OEIS A298490}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298490}{A298490} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) +6*a(n-3) -14*a(n-4) -8*a(n-5) -12*a(n-6) +16*a(n-7) +24*a(n-8) +27*a(n-9) +102*a(n-10) +13*a(n-11) -99*a(n-12) -390*a(n-13) -297*a(n-14) +126*a(n-15) +559*a(n-16) +781*a(n-17) +129*a(n-18) -240*a(n-19) -723*a(n-20) -356*a(n-21) -201*a(n-22) -117*a(n-23) +59*a(n-24) -69*a(n-25) +401*a(n-26) +250*a(n-27) +595*a(n-28) +310*a(n-29) +46*a(n-30) -311*a(n-31) -636*a(n-32) -423*a(n-33) -181*a(n-34) +315*a(n-35) +344*a(n-36) +144*a(n-37) -84*a(n-38) -96*a(n-39) -12*a(n-40) +20*a(n-41) for n>43.\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) + 6\,a(n-3) - 14\,a(n-4) - 8\,a(n-5) - 12\,a(n-6) + \\ 16\,a(n-7) + 24\,a(n-8) + 27\,a(n-9) + 102\,a(n-10) + 13\,a(n-11) - 99\,a(n-12) - \\ 390\,a(n-13) - 297\,a(n-14) + 126\,a(n-15) + 559\,a(n-16) + 781\,a(n-17) + 129\,a(n-18) - \\ 240\,a(n-19) - 723\,a(n-20) - 356\,a(n-21) - 201\,a(n-22) - 117\,a(n-23) + 59\,a(n-24) - \\ 69\,a(n-25) + 401\,a(n-26) + 250\,a(n-27) + 595\,a(n-28) + 310\,a(n-29) + 46\,a(n-30) - \\ 311\,a(n-31) - 636\,a(n-32) - 423\,a(n-33) - 181\,a(n-34) + 315\,a(n-35) + 344\,a(n-36) + \\ 144\,a(n-37) - 84\,a(n-38) - 96\,a(n-39) - 12\,a(n-40) + 20\,a(n-41). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $184$; neither removal changes any count.
...
\begin{theorem} For A298490, the recurrence of order $41$ displayed in Section 1 holds for every $n > 43$, and fails at $n = 43$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,126$. The last nonvanishing one is at $m = 2$, that is at $n = 43$. After it, more than $S = 47$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 29, 27, 41, 101, 158, 263, 481,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298490}{A298490}, revision 6, last modified Dec 26 2023.
