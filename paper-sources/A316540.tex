...
\title{A proof of the conjectured linear recurrence for OEIS A316540}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316540}{A316540} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +8*a(n-3) -a(n-4) -12*a(n-5) -26*a(n-6) -2*a(n-7) +10*a(n-8) +15*a(n-9) -a(n-10) +6*a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 8\,a(n-3) - a(n-4) - 12\,a(n-5) - 26\,a(n-6) - \\ 2\,a(n-7) + 10\,a(n-8) + 15\,a(n-9) - a(n-10) + 6\,a(n-11). \end{multline*}
...
\begin{theorem} For A316540, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 8\,a(n-3) - a(n-4) - 12\,a(n-5) - 26\,a(n-6) - 2\,a(n-7) + 10\,a(n-8) + 15\,a(n-9) - a(n-10) + 6\,a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. The last nonvanishing one is at $m = 1$, that is at $n = 12$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 26, 53, 187, 484, 1262, 3570,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316540}{A316540}, revision 4, last modified Jul 06 2018.
