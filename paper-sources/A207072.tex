...
\title{A proof of the conjectured linear recurrence for OEIS A207072}
...
\begin{multline*} a(n) = 9\,a(n-1) - 35\,a(n-2) + 128\,a(n-3) - 504\,a(n-4) + 1405\,a(n-5) - 3527\,a(n-6) + \\ 10004\,a(n-7) - 21957\,a(n-8) + 43116\,a(n-9) - 100600\,a(n-10) + 180542\,a(n-11) - 288683\,a(n-12) + \\ 601553\,a(n-13) - 890790\,a(n-14) + 1178751\,a(n-15) - 2389520\,a(n-16) + 2860308\,a(n-17) - 3168352\,a(n-18) + \\ 6925971\,a(n-19) - 6272993\,a(n-20) + 5964756\,a(n-21) - 15635179\,a(n-22) + 9301968\,a(n-23) - 8207968\,a(n-24) + \\ 28084470\,a(n-25) - 8016257\,a(n-26) + 8613235\,a(n-27) - 39935561\,a(n-28) + 554384\,a(n-29) - 7574657\,a(n-30) + \\ 44233732\,a(n-31) + 8559244\,a(n-32) + 5944596\,a(n-33) - 36966852\,a(n-34) - 12244472\,a(n-35) - 3806760\,a(n-36) + \\ 22506064\,a(n-37) + 8779376\,a(n-38) + 1734912\,a(n-39) - 9491712\,a(n-40) - 3511296\,a(n-41) - 343296\,a(n-42) + \\ 2433024\,a(n-43) + 691200\,a(n-44) - 331776\,a(n-46). \end{multline*}
...
That refinement leaves $70$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 46$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207072, the recurrence of order $46$ displayed in Section 1 holds for every $n \ge 47$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,120$. Every one of them vanished. After it, more than $S = 46$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 390, 1485, 6398, 23856, 82739, 291364,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207072}{A207072}, revision 9, last modified Oct 03 2025.
