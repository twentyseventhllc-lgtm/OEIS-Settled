...
\title{A proof of the conjectured linear recurrence for OEIS A303249}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303249}{A303249} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +6*a(n-2) +7*a(n-3) -61*a(n-4) -78*a(n-5) +115*a(n-6) +26*a(n-7) -126*a(n-8) -300*a(n-9) +380*a(n-10) -80*a(n-11) +144*a(n-12) -32*a(n-13) +128*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 6\,a(n-2) + 7\,a(n-3) - 61\,a(n-4) - 78\,a(n-5) + 115\,a(n-6) + \\ 26\,a(n-7) - 126\,a(n-8) - 300\,a(n-9) + 380\,a(n-10) - 80\,a(n-11) + 144\,a(n-12) - \\ 32\,a(n-13) + 128\,a(n-14). \end{multline*}
...
\begin{theorem} For A303249, the recurrence $a(n) = 4\,a(n-1) + 6\,a(n-2) + 7\,a(n-3) - 61\,a(n-4) - 78\,a(n-5) + 115\,a(n-6) + 26\,a(n-7) - 126\,a(n-8) - 300\,a(n-9) + 380\,a(n-10) - 80\,a(n-11) + 144\,a(n-12) - 32\,a(n-13) + 128\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 14, 49, 250, 1183, 5918, 28680, 141255,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303249}{A303249}, revision 4, last modified Apr 20 2018.
