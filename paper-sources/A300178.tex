...
\title{A proof of the conjectured linear recurrence for OEIS A300178}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300178}{A300178} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) +27*a(n-2) +51*a(n-3) -10*a(n-4) -a(n-5) -10*a(n-6)\end{quote}
...
\[a(n) = 14\,a(n-1) + 27\,a(n-2) + 51\,a(n-3) - 10\,a(n-4) - a(n-5) - 10\,a(n-6).\]
...
\begin{theorem} For A300178, the recurrence $a(n) = 14\,a(n-1) + 27\,a(n-2) + 51\,a(n-3) - 10\,a(n-4) - a(n-5) - 10\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 2033, 32321, 513832, 8168705, 129863167, 2064518282,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300178}{A300178}, revision 4, last modified Feb 27 2018.
