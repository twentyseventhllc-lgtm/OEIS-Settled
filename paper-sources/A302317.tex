...
\title{A proof of the conjectured linear recurrence for OEIS A302317}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302317}{A302317} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +3*a(n-2) +30*a(n-3) -88*a(n-4) -36*a(n-5) -60*a(n-6) -116*a(n-7) +4*a(n-8) -16*a(n-9) +20*a(n-10) +40*a(n-11) +64*a(n-12) +16*a(n-13) -32*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 3\,a(n-2) + 30\,a(n-3) - 88\,a(n-4) - 36\,a(n-5) - 60\,a(n-6) - \\ 116\,a(n-7) + 4\,a(n-8) - 16\,a(n-9) + 20\,a(n-10) + 40\,a(n-11) + 64\,a(n-12) + \\ 16\,a(n-13) - 32\,a(n-14). \end{multline*}
...
\begin{theorem} For A302317, the recurrence $a(n) = 3\,a(n-1) + 3\,a(n-2) + 30\,a(n-3) - 88\,a(n-4) - 36\,a(n-5) - 60\,a(n-6) - 116\,a(n-7) + 4\,a(n-8) - 16\,a(n-9) + 20\,a(n-10) + 40\,a(n-11) + 64\,a(n-12) + 16\,a(n-13) - 32\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 65, 281, 1144, 4321, 18093, 72746,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302317}{A302317}, revision 4, last modified Apr 05 2018.
