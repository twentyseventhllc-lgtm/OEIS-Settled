...
\title{A proof of the conjectured linear recurrence for OEIS A305247}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305247}{A305247} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 4 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) +a(n-4) -4*a(n-5) -a(n-6) -10*a(n-7) -10*a(n-8) -3*a(n-9) +6*a(n-11) +2*a(n-12).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (May 28 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 7, last modified Sep 30 2023, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) + a(n-4) - 4\,a(n-5) - a(n-6) - 10\,a(n-7) - \\ 10\,a(n-8) - 3\,a(n-9) + 6\,a(n-11) + 2\,a(n-12). \end{multline*}
...
\begin{theorem} For A305247, the recurrence $a(n) = 2\,a(n-1) + a(n-2) + a(n-4) - 4\,a(n-5) - a(n-6) - 10\,a(n-7) - 10\,a(n-8) - 3\,a(n-9) + 6\,a(n-11) + 2\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 7, 10, 17, 34, 65, 121, 244,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305247}{A305247}, revision 7, last modified Sep 30 2023.
