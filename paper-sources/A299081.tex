...
\title{Proofs of the conjectured column and row recurrences for OEIS A299081}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299081}{A299081} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 02 2018). As of revision 6, last modified Mar 01 2023, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A299081, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A299081, the recurrence $a(n) = 3\,a(n-1) + 3\,a(n-2) + 2\,a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A299081, the recurrence $a(n) = 0$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A299081, the recurrence $a(n) = 0$ holds for every $n > 31$, and fails at $n = 31$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299081}{A299081}, revision 6, last modified Mar 01 2023.
