...
\title{A proof of the conjectured linear recurrence for OEIS A317728}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317728}{A317728} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +11*a(n-2) +11*a(n-3) -2*a(n-4) -a(n-5) -2*a(n-6)\end{quote}
...
\[a(n) = 6\,a(n-1) + 11\,a(n-2) + 11\,a(n-3) - 2\,a(n-4) - a(n-5) - 2\,a(n-6).\]
...
\begin{theorem} For A317728, the recurrence $a(n) = 6\,a(n-1) + 11\,a(n-2) + 11\,a(n-3) - 2\,a(n-4) - a(n-5) - 2\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 25, 161, 1250, 9541, 72715, 554642, 4229957,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317728}{A317728}, revision 4, last modified Aug 05 2018.
