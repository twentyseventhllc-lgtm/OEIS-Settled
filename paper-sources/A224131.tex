...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224131}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224131}{A224131} as

\begin{quote}\itshape Number of n X 6 0..1 arrays with rows nondecreasing and antidiagonals unimodal\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) - 14*a(n-2) + 9*a(n-3) + 4*a(n-5) + 16*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(7 + 24*x\textasciicircum{}2 + 19*x\textasciicircum{}3 + 20*x\textasciicircum{}4 + 16*x\textasciicircum{}5) / (1 - 7*x + 14*x\textasciicircum{}2 - 9*x\textasciicircum{}3 - 4*x\textasciicircum{}5 - 16*x\textasciicircum{}6). - Colin Barker, Aug 27 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x + 24x^{3} + 19x^{4} + 20x^{5} + 16x^{6}}{1 - 7x + 14x^{2} - 9x^{3} - 4x^{5} - 16x^{6}}.\]
...
\begin{theorem} For A224131, the recurrence $a(n) = 7\,a(n-1) - 14\,a(n-2) + 9\,a(n-3) + 4\,a(n-5) + 16\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,48$. Every one of them vanished. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A224131, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x + 24x^{3} + 19x^{4} + 20x^{5} + 16x^{6}}{1 - 7x + 14x^{2} - 9x^{3} - 4x^{5} - 16x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 269, 1279, 5648, 24095, 101412, 425246,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224131}{A224131}, revision 9, last modified Aug 27 2018.
