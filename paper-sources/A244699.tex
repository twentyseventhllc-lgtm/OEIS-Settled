...
\title{A proof of the conjectured linear recurrence for OEIS A244699}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A244699}{A244699} as

\begin{quote}\itshape Number of length n+4 0..7 arrays with no five consecutive elements with pattern ababa or abbba (with a!=b) and new values 0..7 introduced in 0..7 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 23*a(n-1) -190*a(n-2) +624*a(n-3) -299*a(n-4) -1735*a(n-5) -321*a(n-6) +3257*a(n-7) +7830*a(n-8) +2362*a(n-9) -6411*a(n-10) -12773*a(n-11) -15698*a(n-12) -15096*a(n-13) -18309*a(n-14) -14657*a(n-15) -7203*a(n-16) +1319*a(n-17) +7754*a(n-18) +9212*a(n-19) +11865*a(n-20) +11915*a(n-21) +10867*a(n-22) +8583*a(n-23) +5912*a(n-24) +4520*a(n-25) +2834*a(n-26) +1796*a(n-27) +975*a(n-28) +505*a(n-29) +321*a(n-30) +117*a(n-31) +65*a(n-32) +21*a(n-33) +10*a(n-34) +6*a(n-35) -a(n-36) +a(n-37)\end{quote}
...
\begin{multline*} a(n) = 23\,a(n-1) - 190\,a(n-2) + 624\,a(n-3) - 299\,a(n-4) - 1735\,a(n-5) - 321\,a(n-6) + \\ 3257\,a(n-7) + 7830\,a(n-8) + 2362\,a(n-9) - 6411\,a(n-10) - 12773\,a(n-11) - 15698\,a(n-12) - \\ 15096\,a(n-13) - 18309\,a(n-14) - 14657\,a(n-15) - 7203\,a(n-16) + 1319\,a(n-17) + 7754\,a(n-18) + \\ 9212\,a(n-19) + 11865\,a(n-20) + 11915\,a(n-21) + 10867\,a(n-22) + 8583\,a(n-23) + 5912\,a(n-24) + \\ 4520\,a(n-25) + 2834\,a(n-26) + 1796\,a(n-27) + 975\,a(n-28) + 505\,a(n-29) + 321\,a(n-30) + \\ 117\,a(n-31) + 65\,a(n-32) + 21\,a(n-33) + 10\,a(n-34) + 6\,a(n-35) - a(n-36) + \\ a(n-37). \end{multline*}
...
The reachable part of that digraph has $8781$ states, $8781$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 38$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $38\times38$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A244699, the recurrence of order $37$ displayed in Section 1 holds for every $n \ge 38$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 50, 192, 823, 3877, 19807, 108745, 636642, 3946032,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A244699}{A244699}, revision 6, last modified Jul 23 2025.
