...
\title{A proof of the conjectured linear recurrence for OEIS A252551}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252551}{A252551} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 4 6 or 7\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 26*a(n-3) -280*a(n-6) +1644*a(n-9) -5901*a(n-12) +13891*a(n-15) +9*a(n-16) -22285*a(n-18) -87*a(n-19) +24609*a(n-21) +235*a(n-22) -18285*a(n-24) -174*a(n-25) +8465*a(n-27) -229*a(n-28) -2074*a(n-30) +496*a(n-31) +616*a(n-33) -313*a(n-34) -1069*a(n-36) +38*a(n-37) +983*a(n-39) +40*a(n-40) -355*a(n-42) -17*a(n-43) -37*a(n-45) +2*a(n-46) +72*a(n-48) -21*a(n-51) +2*a(n-54) for n>60\end{quote}
...
\begin{multline*} a(n) = 26\,a(n-3) - 280\,a(n-6) + 1644\,a(n-9) - 5901\,a(n-12) + 13891\,a(n-15) + 9\,a(n-16) - \\ 22285\,a(n-18) - 87\,a(n-19) + 24609\,a(n-21) + 235\,a(n-22) - 18285\,a(n-24) - 174\,a(n-25) + \\ 8465\,a(n-27) - 229\,a(n-28) - 2074\,a(n-30) + 496\,a(n-31) + 616\,a(n-33) - 313\,a(n-34) - \\ 1069\,a(n-36) + 38\,a(n-37) + 983\,a(n-39) + 40\,a(n-40) - 355\,a(n-42) - 17\,a(n-43) - \\ 37\,a(n-45) + 2\,a(n-46) + 72\,a(n-48) - 21\,a(n-51) + 2\,a(n-54). \end{multline*}
...
That refinement leaves $228$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 110$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $4^{24}$ arrays, about $10^{14}$, against $110$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A252551, the recurrence of order $54$ displayed in Section 1 holds for every $n > 60$, and fails at $n = 60$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,198$. The last nonvanishing one is at $m = 6$, that is at $n = 60$. After it, more than $S = 110$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 771, 747, 832, 1265, 2162, 3761, 6855, 12549,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252551}{A252551}, revision 6, last modified Jun 02 2025.
