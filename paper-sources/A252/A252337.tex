...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A252337}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252337}{A252337} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..2 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 or 4\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: 2*x*(54 + 80*x + 163*x\textasciicircum{}2 + 124*x\textasciicircum{}3 + 10*x\textasciicircum{}4 - 73*x\textasciicircum{}5 - 68*x\textasciicircum{}6 - 31*x\textasciicircum{}7 - 2*x\textasciicircum{}8) / (1 - x - 2*x\textasciicircum{}2 - 6*x\textasciicircum{}3 - 5*x\textasciicircum{}4 - x\textasciicircum{}5 + 2*x\textasciicircum{}6 + 2*x\textasciicircum{}7 + x\textasciicircum{}8). - Colin Barker, Dec 03 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{108x + 160x^{2} + 326x^{3} + 248x^{4} + 20x^{5} - 146x^{6} - 136x^{7} - 62x^{8} - 4x^{9}}{1 - x - 2x^{2} - 6x^{3} - 5x^{4} - x^{5} + 2x^{6} + 2x^{7} + x^{8}}.\]
...
For scale: at $n = 8$ there are $3^{32}$ arrays, about $10^{15}$, against $13$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A252337, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 6\,a(n-3) + 5\,a(n-4) + a(n-5) - 2\,a(n-6) - 2\,a(n-7) - a(n-8)$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}
...
\begin{theorem} For A252337, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{108x + 160x^{2} + 326x^{3} + 248x^{4} + 20x^{5} - 146x^{6} - 136x^{7} - 62x^{8} - 4x^{9}}{1 - x - 2x^{2} - 6x^{3} - 5x^{4} - x^{5} + 2x^{6} + 2x^{7} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 108, 268, 810, 2242, 6030, 16676, 46154, 126892,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252337}{A252337}, revision 8, last modified Dec 03 2018.
