...
\title{A proof of the conjectured linear recurrence for OEIS A252598}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252598}{A252598} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 2 or 5\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -6*a(n-2) +31*a(n-3) -92*a(n-4) +124*a(n-5) -375*a(n-6) +811*a(n-7) -979*a(n-8) +2278*a(n-9) -3380*a(n-10) +3698*a(n-11) -7324*a(n-12) +6163*a(n-13) -6909*a(n-14) +11385*a(n-15) -602*a(n-16) +6670*a(n-17) -3170*a(n-18) -12304*a(n-19) -6355*a(n-20) -14914*a(n-21) +8655*a(n-22) +7225*a(n-23) +20083*a(n-24) +9981*a(n-25) -963*a(n-26) -7637*a(n-27) -9987*a(n-28) -1830*a(n-29) +1511*a(n-30) +3257*a(n-31) +530*a(n-32) -1400*a(n-33) -2384*a(n-34) -1532*a(n-35) -732*a(n-36) +60*a(n-37) +226*a(n-38) +120*a(n-39) +80*a(n-40) -20*a(n-41) +12*a(n-42) -8*a(n-43) for n>47\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 6\,a(n-2) + 31\,a(n-3) - 92\,a(n-4) + 124\,a(n-5) - 375\,a(n-6) + \\ 811\,a(n-7) - 979\,a(n-8) + 2278\,a(n-9) - 3380\,a(n-10) + 3698\,a(n-11) - 7324\,a(n-12) + \\ 6163\,a(n-13) - 6909\,a(n-14) + 11385\,a(n-15) - 602\,a(n-16) + 6670\,a(n-17) - 3170\,a(n-18) - \\ 12304\,a(n-19) - 6355\,a(n-20) - 14914\,a(n-21) + 8655\,a(n-22) + 7225\,a(n-23) + 20083\,a(n-24) + \\ 9981\,a(n-25) - 963\,a(n-26) - 7637\,a(n-27) - 9987\,a(n-28) - 1830\,a(n-29) + 1511\,a(n-30) + \\ 3257\,a(n-31) + 530\,a(n-32) - 1400\,a(n-33) - 2384\,a(n-34) - 1532\,a(n-35) - 732\,a(n-36) + \\ 60\,a(n-37) + 226\,a(n-38) + 120\,a(n-39) + 80\,a(n-40) - 20\,a(n-41) + 12\,a(n-42) - \\ 8\,a(n-43). \end{multline*}
...
\begin{theorem} For A252598, the recurrence of order $43$ displayed in Section 1 holds for every $n > 47$, and fails at $n = 47$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,131$. The last nonvanishing one is at $m = 4$, that is at $n = 47$. After it, more than $S = 58$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 303, 567, 1218, 2792, 6709, 16123, 39372, 97138,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252598}{A252598}, revision 6, last modified Jun 02 2025.
