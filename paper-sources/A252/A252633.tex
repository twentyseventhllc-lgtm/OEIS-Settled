...
\title{A proof of the conjectured linear recurrence for OEIS A252633}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252633}{A252633} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 25*a(n-3) -222*a(n-6) +815*a(n-9) -1085*a(n-12) +696*a(n-15) -756*a(n-18) for n>24\end{quote}
...
\[a(n) = 25\,a(n-3) - 222\,a(n-6) + 815\,a(n-9) - 1085\,a(n-12) + 696\,a(n-15) - 756\,a(n-18).\]
...
For scale: at $n = 8$ there are $4^{24}$ arrays, about $10^{14}$, against $85$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A252633, the recurrence $a(n) = 25\,a(n-3) - 222\,a(n-6) + 815\,a(n-9) - 1085\,a(n-12) + 696\,a(n-15) - 756\,a(n-18)$ holds for every $n > 24$, and fails at $n = 24$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,135$. The last nonvanishing one is at $m = 6$, that is at $n = 24$. After it, more than $S = 85$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 572, 687, 1189, 2230, 4382, 8697, 17046, 34424,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252633}{A252633}, revision 6, last modified Jun 02 2025.
