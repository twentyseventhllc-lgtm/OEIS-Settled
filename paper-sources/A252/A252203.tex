...
\title{A proof of the conjectured linear recurrence for OEIS A252203}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252203}{A252203} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 1 3 4 6 or 7\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +33*a(n-3) -31*a(n-4) -35*a(n-5) -288*a(n-6) +218*a(n-7) +385*a(n-8) +255*a(n-9) +417*a(n-10) -1371*a(n-11) -54*a(n-12) -992*a(n-13) +1178*a(n-14) +1150*a(n-15) -740*a(n-16) +320*a(n-17) -476*a(n-18) -448*a(n-19) +512*a(n-20) -64*a(n-21) for n>26\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 33\,a(n-3) - 31\,a(n-4) - 35\,a(n-5) - 288\,a(n-6) + \\ 218\,a(n-7) + 385\,a(n-8) + 255\,a(n-9) + 417\,a(n-10) - 1371\,a(n-11) - 54\,a(n-12) - \\ 992\,a(n-13) + 1178\,a(n-14) + 1150\,a(n-15) - 740\,a(n-16) + 320\,a(n-17) - 476\,a(n-18) - \\ 448\,a(n-19) + 512\,a(n-20) - 64\,a(n-21). \end{multline*}
...
Every row and column sum of every $3\times3$ subblock must lie in $\{1, 3, 4, 6, 7\}$.

Every diagonal and antidiagonal sum of every $3\times3$ subblock must avoid $\{1, 3, 4, 6, 7\}$.
...
That refinement leaves $115$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 66$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $4^{24}$ arrays, about $10^{14}$, against $66$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A252203, the recurrence of order $21$ displayed in Section 1 holds for every $n > 26$, and fails at $n = 26$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,115$. The last nonvanishing one is at $m = 5$, that is at $n = 26$. After it, more than $S = 66$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2680, 4743, 9312, 19794, 51024, 125554, 278710, 763726,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252203}{A252203}, revision 6, last modified Jun 02 2025.
