...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A269007}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269007}{A269007} as

\begin{quote}\itshape Number of n X 4 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(5 - 24*x + 73*x\textasciicircum{}2 - 124*x\textasciicircum{}3 + 60*x\textasciicircum{}4 + 16*x\textasciicircum{}5 + 4*x\textasciicircum{}6) / (1 - 6*x + 2*x\textasciicircum{}2 + 8*x\textasciicircum{}3)\textasciicircum{}2. - Colin Barker, Jan 18 2019\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{5x - 24x^{2} + 73x^{3} - 124x^{4} + 60x^{5} + 16x^{6} + 4x^{7}}{1 - 12x + 40x^{2} - 8x^{3} - 92x^{4} + 32x^{5} + 64x^{6}}.\]
...
\begin{theorem} For A269007, the recurrence $a(n) = 12\,a(n-1) - 40\,a(n-2) + 8\,a(n-3) + 92\,a(n-4) - 32\,a(n-5) - 64\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\begin{theorem} For A269007, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{5x - 24x^{2} + 73x^{3} - 124x^{4} + 60x^{5} + 16x^{6} + 4x^{7}}{1 - 12x + 40x^{2} - 8x^{3} - 92x^{4} + 32x^{5} + 64x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 36, 305, 2136, 14240, 91048, 566656, 3456320,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269007}{A269007}, revision 7, last modified Jan 18 2019.
