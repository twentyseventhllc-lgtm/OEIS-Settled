...
\title{Proofs of the conjectured column and row recurrences for OEIS A269186}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269186}{A269186} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..3 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling three exactly once\end{quote}
...
\begin{theorem} For column $k = 1$ of A269186, the recurrence $a(n) = 6\,a(n-1) - 9\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269186, the recurrence $a(n) = 10\,a(n-1) - 21\,a(n-2) - 20\,a(n-3) - 4\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269186, the recurrence $a(n) = 0$ holds for every $n > 9$, and fails at $n = 9$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269186}{A269186}, revision 4, last modified Feb 20 2016.
