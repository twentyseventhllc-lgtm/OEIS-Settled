...
\title{A proof of the conjectured linear recurrence for OEIS A269040}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269040}{A269040} as

\begin{quote}\itshape Number of 6 X n 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Feb 22 2025, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\begin{theorem} For A269040, the recurrence of order $46$ displayed in Section 1 holds for every $n > 48$, and fails at $n = 48$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 7128, 67104, 1114848, 14710368, 208867428, 2783857776, 37310632920,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269040}{A269040}, revision 6, last modified Feb 22 2025.
