...
\title{Proofs of the conjectured column and row recurrences for OEIS A269214}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269214}{A269214} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three exactly once\end{quote}
...
k=1: a(n) = a(n-1)\\k=2: a(n) = 14*a(n-1) -49*a(n-2) for n>3\\k=3: a(n) = 30*a(n-1) -237*a(n-2) +180*a(n-3) -36*a(n-4) for n>5\end{quote}
...
\begin{theorem} In A269214, column $k = 1$ is identically zero, and the claimed recurrence therefore holds at every index.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269214, the recurrence $a(n) = 14\,a(n-1) - 49\,a(n-2)$ holds for every $n > 3$, and fails at $n = 3$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269214, the recurrence $a(n) = 30\,a(n-1) - 237\,a(n-2) + 180\,a(n-3) - 36\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269214}{A269214}, revision 4, last modified Feb 20 2016.
