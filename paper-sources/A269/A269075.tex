...
\title{Proofs of the conjectured column and row recurrences for OEIS A269075}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269075}{A269075} as

\begin{quote}\itshape T(n,k)=Number of nXk binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once\end{quote}
...
k=1: a(n) = 2*a(n-1)\\k=2: a(n) = 4*a(n-1) -2*a(n-2) -4*a(n-3) -a(n-4)\\k=3: a(n) = 10*a(n-1) -31*a(n-2) +24*a(n-3) +21*a(n-4) -18*a(n-5) -9*a(n-6)\\k=4: a(n) = 12*a(n-1) -40*a(n-2) +8*a(n-3) +92*a(n-4) -32*a(n-5) -64*a(n-6) for n>7\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 19 2016). As of revision 4, last modified Feb 19 2016, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A269075, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269075, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) - 4\,a(n-3) - a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269075, the recurrence $a(n) = 10\,a(n-1) - 31\,a(n-2) + 24\,a(n-3) + 21\,a(n-4) - 18\,a(n-5) - 9\,a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A269075, the recurrence $a(n) = 12\,a(n-1) - 40\,a(n-2) + 8\,a(n-3) + 92\,a(n-4) - 32\,a(n-5) - 64\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269075}{A269075}, revision 4, last modified Feb 19 2016.
