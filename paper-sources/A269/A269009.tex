...
\title{A proof of the conjectured linear recurrence for OEIS A269009}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269009}{A269009} as

\begin{quote}\itshape Number of nX6 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} For A269009, the recurrence $a(n) = 28\,a(n-1) - 230\,a(n-2) + 192\,a(n-3) + 3805\,a(n-4) - 5776\,a(n-5) - 27808\,a(n-6) + 25744\,a(n-7) + 101333\,a(n-8) - 13916\,a(n-9) - 149690\,a(n-10) - 66848\,a(n-11) + 23183\,a(n-12) + 9888\,a(n-13) - 2304\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 272, 4948, 73568, 1049588, 14382480, 192100836, 2516546784,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269009}{A269009}, revision 4, last modified Feb 17 2016.
