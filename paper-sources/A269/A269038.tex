...
\title{A proof of the conjectured linear recurrence for OEIS A269038}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269038}{A269038} as

\begin{quote}\itshape Number of 4Xn 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once\end{quote}
...
\begin{theorem} For A269038, the recurrence $a(n) = 6\,a(n-1) + 23\,a(n-2) - 102\,a(n-3) - 288\,a(n-4) + 250\,a(n-5) + 787\,a(n-6) - 238\,a(n-7) - 741\,a(n-8) + 124\,a(n-9) + 196\,a(n-10) - 16\,a(n-11) - 16\,a(n-12)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 504, 2136, 18384, 115656, 785124, 4998648, 31834476,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269038}{A269038}, revision 4, last modified Feb 18 2016.
