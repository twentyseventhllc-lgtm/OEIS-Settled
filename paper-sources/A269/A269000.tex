...
\title{A proof of the conjectured linear recurrence for OEIS A269000}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269000}{A269000} as

\begin{quote}\itshape Number of 6Xn binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once\end{quote}
...
\begin{theorem} For A269000, the recurrence of order $42$ displayed in Section 1 holds for every $n \ge 43$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,119$. Every one of them vanished. After it, more than $S = 56$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 64, 1121, 19416, 308112, 4583103, 66954420, 946498448, 13228660133,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269000}{A269000}, revision 4, last modified Feb 17 2016.
