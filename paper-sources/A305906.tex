...
\title{A proof of the conjectured linear recurrence for OEIS A305906}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305906}{A305906} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +4*a(n-2) +11*a(n-3) -19*a(n-4) -49*a(n-5) -54*a(n-6) +80*a(n-7) +161*a(n-8) +107*a(n-9) -128*a(n-10) -154*a(n-11) -22*a(n-12) +37*a(n-13) -26*a(n-14) -33*a(n-15) for n>16\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 4\,a(n-2) + 11\,a(n-3) - 19\,a(n-4) - 49\,a(n-5) - 54\,a(n-6) + \\ 80\,a(n-7) + 161\,a(n-8) + 107\,a(n-9) - 128\,a(n-10) - 154\,a(n-11) - 22\,a(n-12) + \\ 37\,a(n-13) - 26\,a(n-14) - 33\,a(n-15). \end{multline*}
...
\begin{theorem} For A305906, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) + 11\,a(n-3) - 19\,a(n-4) - 49\,a(n-5) - 54\,a(n-6) + 80\,a(n-7) + 161\,a(n-8) + 107\,a(n-9) - 128\,a(n-10) - 154\,a(n-11) - 22\,a(n-12) + 37\,a(n-13) - 26\,a(n-14) - 33\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. The last nonvanishing one is at $m = 1$, that is at $n = 16$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 14, 35, 98, 358, 1124, 3534, 11667,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305906}{A305906}, revision 4, last modified Jun 14 2018.
