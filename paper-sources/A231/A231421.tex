...
\title{A proof of the conjectured linear recurrence for OEIS A231421}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231421}{A231421} as

\begin{quote}\itshape Number of (2+1)X(n+1) 0..2 arrays with no element equal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 20*a(n-1) +56*a(n-2) -821*a(n-3) -2559*a(n-4) +2274*a(n-5) +11333*a(n-6) +75045*a(n-7) +58970*a(n-8) -744820*a(n-9) -338743*a(n-10) +3350990*a(n-11) -566226*a(n-12) -8533262*a(n-13) +6626396*a(n-14) +10836980*a(n-15) -13238580*a(n-16) -6337152*a(n-17) +13746128*a(n-18) -1255112*a(n-19) -8079152*a(n-20) +2081168*a(n-21) +460736*a(n-22) -1034208*a(n-23) +221216*a(n-24) -114304*a(n-25) -122880*a(n-26) -16384*a(n-27) -512*a(n-28)\end{quote}
...
\begin{multline*} a(n) = 20\,a(n-1) + 56\,a(n-2) - 821\,a(n-3) - 2559\,a(n-4) + 2274\,a(n-5) + 11333\,a(n-6) + \\ 75045\,a(n-7) + 58970\,a(n-8) - 744820\,a(n-9) - 338743\,a(n-10) + 3350990\,a(n-11) - 566226\,a(n-12) - \\ 8533262\,a(n-13) + 6626396\,a(n-14) + 10836980\,a(n-15) - 13238580\,a(n-16) - 6337152\,a(n-17) + 13746128\,a(n-18) - \\ 1255112\,a(n-19) - 8079152\,a(n-20) + 2081168\,a(n-21) + 460736\,a(n-22) - 1034208\,a(n-23) + 221216\,a(n-24) - \\ 114304\,a(n-25) - 122880\,a(n-26) - 16384\,a(n-27) - 512\,a(n-28). \end{multline*}
...
The reachable part of the digraph has $1592$ states, $799$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 43$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $43\times43$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A231421, the recurrence of order $28$ displayed in Section 1 holds for every $n \ge 29$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,92$. Every one of them vanished. After it, more than $S = 43$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 50, 1032, 20896, 424404, 8704406, 178277756, 3654045516, 74894704740,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231421}{A231421}, revision 6, last modified Jul 23 2025.
