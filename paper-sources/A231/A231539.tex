...
\title{A proof of the conjectured linear recurrence for OEIS A231539}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231539}{A231539} as

\begin{quote}\itshape Number of nX3 0..1 arrays with no element less than a strict majority of its horizontal, vertical and antidiagonal neighbors\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) -14*a(n-2) +34*a(n-3) -67*a(n-4) +86*a(n-5) -79*a(n-6) +14*a(n-7) +47*a(n-8) -66*a(n-9) +15*a(n-10) -105*a(n-11) +121*a(n-12) +24*a(n-13) -40*a(n-14) -56*a(n-15) +2*a(n-16) +43*a(n-17) -11*a(n-18) -15*a(n-19) -6*a(n-20) +2*a(n-21) +a(n-22)\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) - 14\,a(n-2) + 34\,a(n-3) - 67\,a(n-4) + 86\,a(n-5) - 79\,a(n-6) + \\ 14\,a(n-7) + 47\,a(n-8) - 66\,a(n-9) + 15\,a(n-10) - 105\,a(n-11) + 121\,a(n-12) + \\ 24\,a(n-13) - 40\,a(n-14) - 56\,a(n-15) + 2\,a(n-16) + 43\,a(n-17) - 11\,a(n-18) - \\ 15\,a(n-19) - 6\,a(n-20) + 2\,a(n-21) + a(n-22). \end{multline*}
...
The reachable part of the digraph has $131$ states, $62$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 23$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $23\times23$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A231539, the recurrence of order $22$ displayed in Section 1 holds for every $n \ge 23$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 116, 589, 3001, 15644, 81179, 420243,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231539}{A231539}, revision 6, last modified Jul 23 2025.
