...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A231538}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231538}{A231538} as

\begin{quote}\itshape Number of n X 2 0..1 arrays with no element less than a strict majority of its horizontal, vertical and antidiagonal neighbors\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 5*a(n-3) - 8*a(n-4) + 3*a(n-5) - 2*a(n-6) + a(n-7) - a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(2 - 2*x + 4*x\textasciicircum{}2 - 9*x\textasciicircum{}3 + 2*x\textasciicircum{}4 - x\textasciicircum{}5 + x\textasciicircum{}6 - x\textasciicircum{}7) / (1 - 4*x + 4*x\textasciicircum{}2 - 5*x\textasciicircum{}3 + 8*x\textasciicircum{}4 - 3*x\textasciicircum{}5 + 2*x\textasciicircum{}6 - x\textasciicircum{}7 + x\textasciicircum{}8). - Colin Barker, Sep 29 2018\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) - 8\,a(n-4) + 3\,a(n-5) - 2\,a(n-6) + \\ a(n-7) - a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{2x - 2x^{2} + 4x^{3} - 9x^{4} + 2x^{5} - x^{6} + x^{7} - x^{8}}{1 - 4x + 4x^{2} - 5x^{3} + 8x^{4} - 3x^{5} + 2x^{6} - x^{7} + x^{8}}.\]
...
\begin{theorem} For A231538, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) - 8\,a(n-4) + 3\,a(n-5) - 2\,a(n-6) + a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A231538, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{2x - 2x^{2} + 4x^{3} - 9x^{4} + 2x^{5} - x^{6} + x^{7} - x^{8}}{1 - 4x + 4x^{2} - 5x^{3} + 8x^{4} - 3x^{5} + 2x^{6} - x^{7} + x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 6, 20, 57, 164, 485, 1424, 4169,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231538}{A231538}, revision 11, last modified Sep 30 2018.
