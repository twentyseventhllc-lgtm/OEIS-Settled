...
\title{A proof of the conjectured linear recurrence for OEIS A231518}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231518}{A231518} as

\begin{quote}\itshape Number of nX3 0..1 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -2*a(n-2) +43*a(n-3) -50*a(n-4) +33*a(n-5) -307*a(n-6) +115*a(n-7) -66*a(n-8) +490*a(n-9) +60*a(n-10) -144*a(n-11) +32*a(n-12) -192*a(n-13) for n>14\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 2\,a(n-2) + 43\,a(n-3) - 50\,a(n-4) + 33\,a(n-5) - 307\,a(n-6) + \\ 115\,a(n-7) - 66\,a(n-8) + 490\,a(n-9) + 60\,a(n-10) - 144\,a(n-11) + 32\,a(n-12) - \\ 192\,a(n-13). \end{multline*}
...
The reachable part of the digraph has $119$ states, $55$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 18$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $18\times18$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A231518, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) + 43\,a(n-3) - 50\,a(n-4) + 33\,a(n-5) - 307\,a(n-6) + 115\,a(n-7) - 66\,a(n-8) + 490\,a(n-9) + 60\,a(n-10) - 144\,a(n-11) + 32\,a(n-12) - 192\,a(n-13)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,58$. The last nonvanishing one is at $m = 1$, that is at $n = 14$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 34, 153, 776, 3861, 18721, 91993, 453274,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231518}{A231518}, revision 6, last modified Jul 23 2025.
