...
\title{A proof of the conjectured linear recurrence for OEIS A231193}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231193}{A231193} as

\begin{quote}\itshape Number of (n+1)X(2+1) 0..2 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 22*a(n-1) +7*a(n-2) -24*a(n-3) +218*a(n-4) -1474*a(n-5) -4420*a(n-6) +892*a(n-7) +1572*a(n-8) +5428*a(n-9) +124572*a(n-10) +179816*a(n-11) -55176*a(n-12) -492608*a(n-13) -667584*a(n-14) -56192*a(n-15) +368640*a(n-16) +246784*a(n-17) -61440*a(n-18)\end{quote}
...
\begin{multline*} a(n) = 22\,a(n-1) + 7\,a(n-2) - 24\,a(n-3) + 218\,a(n-4) - 1474\,a(n-5) - 4420\,a(n-6) + \\ 892\,a(n-7) + 1572\,a(n-8) + 5428\,a(n-9) + 124572\,a(n-10) + 179816\,a(n-11) - 55176\,a(n-12) - \\ 492608\,a(n-13) - 667584\,a(n-14) - 56192\,a(n-15) + 368640\,a(n-16) + 246784\,a(n-17) - 61440\,a(n-18). \end{multline*}
...
The reachable part of the digraph has $1544$ states, $734$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 24$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $24\times24$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A231193, the recurrence of order $18$ displayed in Section 1 holds for every $n \ge 19$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 67, 1413, 31665, 704428, 15698874, 349736292, 7791727354, 173590087438,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231193}{A231193}, revision 6, last modified Jul 23 2025.
