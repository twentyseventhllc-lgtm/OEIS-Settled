...
\title{A proof of the conjectured order of the recurrence for OEIS A231194}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231194}{A231194} as

\begin{quote}\itshape Number of (n+1)X(3+1) 0..2 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order\end{quote}
...
The reachable part of the digraph has $13185$ states, $6201$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 103$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $103\times103$ matrix. The bound is computed, not assumed.
...
\item {\bfseries The published terms.} The walk count reproduces all 13 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 538, 31665, 2001156, 125862699, 7925306181, 498915418541, 31409217221246, 1977358522670046,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231194}{A231194}, revision 7, last modified Jul 23 2025.
