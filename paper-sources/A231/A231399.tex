...
\title{A proof of the conjectured order of the recurrence for OEIS A231399}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A231399}{A231399} as

\begin{quote}\itshape Number of (3+1)X(n+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order\end{quote}
...
The reachable part of the digraph has $8538$ states, $1511$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 87$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $87\times87$ matrix. The bound is computed, not assumed.
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 15, 100, 311, 1706, 7844, 35696, 184692,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A231399}{A231399}, revision 7, last modified Jul 23 2025.
