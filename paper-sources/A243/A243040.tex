...
\title{A proof of the conjectured linear recurrence for OEIS A243040}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A243040}{A243040} as

\begin{quote}\itshape Number of length n+3 0..4 arrays with no four elements in a row with pattern abab (with a!=b) and new values 0..4 introduced in 0..4 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -14*a(n-2) -10*a(n-3) +13*a(n-4) +28*a(n-5) +9*a(n-6) -12*a(n-7) -14*a(n-8) -6*a(n-9) -a(n-10)\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 14\,a(n-2) - 10\,a(n-3) + 13\,a(n-4) + 28\,a(n-5) + 9\,a(n-6) - \\ 12\,a(n-7) - 14\,a(n-8) - 6\,a(n-9) - a(n-10). \end{multline*}
...
\begin{theorem} For A243040, the recurrence $a(n) = 8\,a(n-1) - 14\,a(n-2) - 10\,a(n-3) + 13\,a(n-4) + 28\,a(n-5) + 9\,a(n-6) - 12\,a(n-7) - 14\,a(n-8) - 6\,a(n-9) - a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 47, 178, 738, 3255, 14932, 70167, 334488,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A243040}{A243040}, revision 6, last modified Jul 23 2025.
