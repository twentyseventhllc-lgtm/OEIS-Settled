...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A189105}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A189105}{A189105} as

\begin{quote}\itshape Number of n X 3 binary arrays without the pattern 1 1 0 diagonally or antidiagonally\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) -40*a(n-3) +22*a(n-4) +86*a(n-5) -80*a(n-6) +24*a(n-8) -8*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(2 + 2*x - 12*x\textasciicircum{}2 + 5*x\textasciicircum{}3 + 21*x\textasciicircum{}4 - 20*x\textasciicircum{}5 + 6*x\textasciicircum{}7 - 2*x\textasciicircum{}8) / ((1 - 7*x + 6*x\textasciicircum{}2 - 2*x\textasciicircum{}3)*(1 - 6*x\textasciicircum{}2 + 14*x\textasciicircum{}4 - 4*x\textasciicircum{}6)). - Colin Barker, May 01 2018\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) - 40\,a(n-3) + 22\,a(n-4) + 86\,a(n-5) - 80\,a(n-6) + 24\,a(n-8) - \\ 8\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{8x + 8x^{2} - 48x^{3} + 20x^{4} + 84x^{5} - 80x^{6} + 24x^{8} - 8x^{9}}{1 - 7x + 40x^{3} - 22x^{4} - 86x^{5} + 80x^{6} - 24x^{8} + 8x^{9}}.\]
...
The reachable part of the digraph has $73$ states, $73$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 9$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $9\times9$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A189105, the recurrence $a(n) = 7\,a(n-1) - 40\,a(n-3) + 22\,a(n-4) + 86\,a(n-5) - 80\,a(n-6) + 24\,a(n-8) - 8\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A189105, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{8x + 8x^{2} - 48x^{3} + 20x^{4} + 84x^{5} - 80x^{6} + 24x^{8} - 8x^{9}}{1 - 7x + 40x^{3} - 22x^{4} - 86x^{5} + 80x^{6} - 24x^{8} + 8x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 64, 400, 2500, 15200, 92416, 560576, 3400336,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A189105}{A189105}, revision 8, last modified May 01 2018.
