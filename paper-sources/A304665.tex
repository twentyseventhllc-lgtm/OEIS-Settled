...
\title{A proof of the conjectured linear recurrence for OEIS A304665}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304665}{A304665} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +14*a(n-3) -22*a(n-4) -3*a(n-5) -75*a(n-6) +93*a(n-7) +26*a(n-8) +215*a(n-9) -225*a(n-10) -93*a(n-11) -431*a(n-12) +399*a(n-13) +190*a(n-14) +679*a(n-15) -477*a(n-16) -271*a(n-17) -784*a(n-18) +455*a(n-19) +378*a(n-20) +790*a(n-21) -394*a(n-22) -421*a(n-23) -734*a(n-24) +146*a(n-25) +319*a(n-26) +472*a(n-27) -66*a(n-28) -251*a(n-29) -323*a(n-30) -245*a(n-31) -18*a(n-32) -128*a(n-33) +134*a(n-34) +128*a(n-35) +176*a(n-36) +40*a(n-37) -55*a(n-38) -63*a(n-39) -10*a(n-40) +6*a(n-41) +6*a(n-42) for n>43\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 14\,a(n-3) - 22\,a(n-4) - 3\,a(n-5) - 75\,a(n-6) + 93\,a(n-7) + \\ 26\,a(n-8) + 215\,a(n-9) - 225\,a(n-10) - 93\,a(n-11) - 431\,a(n-12) + 399\,a(n-13) + \\ 190\,a(n-14) + 679\,a(n-15) - 477\,a(n-16) - 271\,a(n-17) - 784\,a(n-18) + 455\,a(n-19) + \\ 378\,a(n-20) + 790\,a(n-21) - 394\,a(n-22) - 421\,a(n-23) - 734\,a(n-24) + 146\,a(n-25) + \\ 319\,a(n-26) + 472\,a(n-27) - 66\,a(n-28) - 251\,a(n-29) - 323\,a(n-30) - 245\,a(n-31) - \\ 18\,a(n-32) - 128\,a(n-33) + 134\,a(n-34) + 128\,a(n-35) + 176\,a(n-36) + 40\,a(n-37) - \\ 55\,a(n-38) - 63\,a(n-39) - 10\,a(n-40) + 6\,a(n-41) + 6\,a(n-42). \end{multline*}
...
\begin{theorem} For A304665, the recurrence of order $42$ displayed in Section 1 holds for every $n > 43$, and fails at $n = 43$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 21, 30, 93, 249, 544, 1366, 3399,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304665}{A304665}, revision 4, last modified May 16 2018.
