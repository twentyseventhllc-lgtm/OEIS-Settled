...
k=1: a(n) = 7*a(n-1) -9*a(n-2) -12*a(n-3).\\k=2: a(n) = 10*a(n-1) -28*a(n-2) +a(n-3) +54*a(n-4) +24*a(n-5).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 26 2013). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
