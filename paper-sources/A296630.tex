...
\title{A proof of the conjectured linear recurrence for OEIS A296630}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296630}{A296630} as

\begin{quote}\itshape Number of nX3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0, 2 or 4 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +4*a(n-2) +6*a(n-3) +8*a(n-4) +6*a(n-5) +3*a(n-6) -2*a(n-7) -6*a(n-8) -8*a(n-9) -7*a(n-10) -4*a(n-11) -a(n-12)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 4\,a(n-2) + 6\,a(n-3) + 8\,a(n-4) + 6\,a(n-5) + 3\,a(n-6) - \\ 2\,a(n-7) - 6\,a(n-8) - 8\,a(n-9) - 7\,a(n-10) - 4\,a(n-11) - a(n-12). \end{multline*}
...
\begin{theorem} For A296630, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) + 6\,a(n-3) + 8\,a(n-4) + 6\,a(n-5) + 3\,a(n-6) - 2\,a(n-7) - 6\,a(n-8) - 8\,a(n-9) - 7\,a(n-10) - 4\,a(n-11) - a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 19, 71, 260, 966, 3581, 13275, 49209,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296630}{A296630}, revision 4, last modified Dec 17 2017.
