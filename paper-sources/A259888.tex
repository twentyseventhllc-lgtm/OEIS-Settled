...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A259888}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259888}{A259888} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 11*a(n-3) - 8*a(n-4) - 5*a(n-5) - 5*a(n-6) - 2*a(n-7) + 3*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(67 - 27*x + 332*x\textasciicircum{}2 - 321*x\textasciicircum{}3 - 316*x\textasciicircum{}4 - 179*x\textasciicircum{}5 - 125*x\textasciicircum{}6 + 156*x\textasciicircum{}7) / (1 - 3*x + 3*x\textasciicircum{}2 - 11*x\textasciicircum{}3 + 8*x\textasciicircum{}4 + 5*x\textasciicircum{}5 + 5*x\textasciicircum{}6 + 2*x\textasciicircum{}7 - 3*x\textasciicircum{}8). - Colin Barker, Dec 27 2018\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + 11\,a(n-3) - 8\,a(n-4) - 5\,a(n-5) - 5\,a(n-6) - \\ 2\,a(n-7) + 3\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{67x - 27x^{2} + 332x^{3} - 321x^{4} - 316x^{5} - 179x^{6} - 125x^{7} + 156x^{8}}{1 - 3x + 3x^{2} - 11x^{3} + 8x^{4} + 5x^{5} + 5x^{6} + 2x^{7} - 3x^{8}}.\]
...
\begin{theorem} For A259888, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + 11\,a(n-3) - 8\,a(n-4) - 5\,a(n-5) - 5\,a(n-6) - 2\,a(n-7) + 3\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A259888, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{67x - 27x^{2} + 332x^{3} - 321x^{4} - 316x^{5} - 179x^{6} - 125x^{7} + 156x^{8}}{1 - 3x + 3x^{2} - 11x^{3} + 8x^{4} + 5x^{5} + 5x^{6} + 2x^{7} - 3x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 67, 174, 653, 1853, 4662, 13704, 40955, 114098,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259888}{A259888}, revision 8, last modified Dec 27 2018.
