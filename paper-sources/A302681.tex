...
\title{A proof of the conjectured linear recurrence for OEIS A302681}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302681}{A302681} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-3) +3*a(n-4) for n>7\end{quote}
...
\begin{theorem} For A302681, the recurrence $a(n) = a(n-1) + 3\,a(n-3) + 3\,a(n-4)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 4, 8, 12, 18, 40, 94, 184,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302681}{A302681}, revision 4, last modified Apr 11 2018.
