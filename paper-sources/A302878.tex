...
\title{A proof of the conjectured linear recurrence for OEIS A302878}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302878}{A302878} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +2*a(n-3) +36*a(n-4) -22*a(n-5) -100*a(n-6) -5*a(n-7) -280*a(n-8) +97*a(n-9) +725*a(n-10) -111*a(n-11) +481*a(n-12) -72*a(n-13) -1160*a(n-14) +511*a(n-15) +19*a(n-16) +9*a(n-17) +24*a(n-18) -10*a(n-19) -a(n-20) for n>21\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 2\,a(n-3) + 36\,a(n-4) - 22\,a(n-5) - 100\,a(n-6) - \\ 5\,a(n-7) - 280\,a(n-8) + 97\,a(n-9) + 725\,a(n-10) - 111\,a(n-11) + 481\,a(n-12) - \\ 72\,a(n-13) - 1160\,a(n-14) + 511\,a(n-15) + 19\,a(n-16) + 9\,a(n-17) + 24\,a(n-18) - \\ 10\,a(n-19) - a(n-20). \end{multline*}
...
\begin{theorem} For A302878, the recurrence of order $20$ displayed in Section 1 holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,75$. The last nonvanishing one is at $m = 1$, that is at $n = 21$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 6, 17, 35, 72, 241, 722, 1821,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302878}{A302878}, revision 4, last modified Apr 15 2018.
