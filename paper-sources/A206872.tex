...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A206872}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A206872}{A206872} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays avoiding 0 0 0 horizontally and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) + 7*a(n-2) + 27*a(n-3) - 13*a(n-4) + a(n-5) - 31*a(n-6) + 5*a(n-7) - 2*a(n-8) + 4*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(7 + 28*x + 15*x\textasciicircum{}2 - 12*x\textasciicircum{}3 - 29*x\textasciicircum{}4 - 26*x\textasciicircum{}5 + 3*x\textasciicircum{}6 + 2*x\textasciicircum{}7 + 4*x\textasciicircum{}8) / ((1 - x)*(1 - 2*x - 9*x\textasciicircum{}2 - 36*x\textasciicircum{}3 - 23*x\textasciicircum{}4 - 24*x\textasciicircum{}5 + 7*x\textasciicircum{}6 + 2*x\textasciicircum{}7 + 4*x\textasciicircum{}8)). - Colin Barker, Mar 04 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 13 2012).

The line quoted ending in that signature is contributed by Colin Barker on Mar 04 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 8, last modified Mar 04 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 3\,a(n-1) + 7\,a(n-2) + 27\,a(n-3) - 13\,a(n-4) + a(n-5) - 31\,a(n-6) + \\ 5\,a(n-7) - 2\,a(n-8) + 4\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x + 28x^{2} + 15x^{3} - 12x^{4} - 29x^{5} - 26x^{6} + 3x^{7} + 2x^{8} + 4x^{9}}{1 - 3x - 7x^{2} - 27x^{3} + 13x^{4} - x^{5} + 31x^{6} - 5x^{7} + 2x^{8} - 4x^{9}}.\]
...
\begin{theorem} For A206872, the recurrence $a(n) = 3\,a(n-1) + 7\,a(n-2) + 27\,a(n-3) - 13\,a(n-4) + a(n-5) - 31\,a(n-6) + 5\,a(n-7) - 2\,a(n-8) + 4\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,48$. Every one of them vanished. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A206872, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x + 28x^{2} + 15x^{3} - 12x^{4} - 29x^{5} - 26x^{6} + 3x^{7} + 2x^{8} + 4x^{9}}{1 - 3x - 7x^{2} - 27x^{3} + 13x^{4} - x^{5} + 31x^{6} - 5x^{7} + 2x^{8} - 4x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 211, 1153, 6139, 31529, 165783, 867545,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A206872}{A206872}, revision 8, last modified Mar 04 2018.
