...
\title{A proof of the conjectured linear recurrence for OEIS A302318}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302318}{A302318} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +2*a(n-2) +87*a(n-3) -302*a(n-4) -259*a(n-5) -2588*a(n-6) +7234*a(n-7) +9019*a(n-8) +32215*a(n-9) -59476*a(n-10) -94910*a(n-11) -149849*a(n-12) +16795*a(n-13) +197662*a(n-14) +186025*a(n-15) +288434*a(n-16) +53946*a(n-17) +33493*a(n-18) -321081*a(n-19) -435016*a(n-20) -421284*a(n-21) +61987*a(n-22) +535595*a(n-23) +627461*a(n-24) +128263*a(n-25) -415105*a(n-26) -560627*a(n-27) -191402*a(n-28) +237533*a(n-29) +341727*a(n-30) +141774*a(n-31) -87789*a(n-32) -144155*a(n-33) -59413*a(n-34) +20431*a(n-35) +42378*a(n-36) +15442*a(n-37) -4727*a(n-38) -7374*a(n-39) -3473*a(n-40) +1426*a(n-41) +410*a(n-42) +704*a(n-43) -322*a(n-44) +40*a(n-45) -66*a(n-46) +32*a(n-47) -4*a(n-48) for n>49.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 05 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Aug 21 2025, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 4\,a(n-1) + 2\,a(n-2) + 87\,a(n-3) - 302\,a(n-4) - 259\,a(n-5) - 2588\,a(n-6) + \\ 7234\,a(n-7) + 9019\,a(n-8) + 32215\,a(n-9) - 59476\,a(n-10) - 94910\,a(n-11) - 149849\,a(n-12) + \\ 16795\,a(n-13) + 197662\,a(n-14) + 186025\,a(n-15) + 288434\,a(n-16) + 53946\,a(n-17) + 33493\,a(n-18) - \\ 321081\,a(n-19) - 435016\,a(n-20) - 421284\,a(n-21) + 61987\,a(n-22) + 535595\,a(n-23) + 627461\,a(n-24) + \\ 128263\,a(n-25) - 415105\,a(n-26) - 560627\,a(n-27) - 191402\,a(n-28) + 237533\,a(n-29) + 341727\,a(n-30) + \\ 141774\,a(n-31) - 87789\,a(n-32) - 144155\,a(n-33) - 59413\,a(n-34) + 20431\,a(n-35) + 42378\,a(n-36) + \\ 15442\,a(n-37) - 4727\,a(n-38) - 7374\,a(n-39) - 3473\,a(n-40) + 1426\,a(n-41) + 410\,a(n-42) + \\ 704\,a(n-43) - 322\,a(n-44) + 40\,a(n-45) - 66\,a(n-46) + 32\,a(n-47) - 4\,a(n-48). \end{multline*}
...
\begin{theorem} For A302318, the recurrence of order $48$ displayed in Section 1 holds for every $n > 49$, and fails at $n = 49$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,132$. The last nonvanishing one is at $m = 1$, that is at $n = 49$. After it, more than $S = 54$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 52, 177, 953, 4525, 19734, 96956, 458537,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302318}{A302318}, revision 9, last modified Aug 21 2025.
