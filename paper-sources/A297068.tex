...
\title{A proof of the conjectured linear recurrence for OEIS A297068}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297068}{A297068} as

\begin{quote}\itshape Number of nX3 0..1 arrays with no 1 adjacent to 1 king-move neighboring 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +4*a(n-3) -30*a(n-4) -145*a(n-5) -69*a(n-6) +50*a(n-7) +33*a(n-8) -26*a(n-9) -7*a(n-10) -4*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 4\,a(n-3) - 30\,a(n-4) - 145\,a(n-5) - 69\,a(n-6) + 50\,a(n-7) + \\ 33\,a(n-8) - 26\,a(n-9) - 7\,a(n-10) - 4\,a(n-11). \end{multline*}
...
\begin{theorem} For A297068, the recurrence $a(n) = 7\,a(n-1) + 4\,a(n-3) - 30\,a(n-4) - 145\,a(n-5) - 69\,a(n-6) + 50\,a(n-7) + 33\,a(n-8) - 26\,a(n-9) - 7\,a(n-10) - 4\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 32, 205, 1292, 8810, 60779, 419569, 2901787,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297068}{A297068}, revision 4, last modified Dec 24 2017.
