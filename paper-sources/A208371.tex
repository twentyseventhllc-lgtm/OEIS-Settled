...
\title{A proof of the conjectured linear recurrence for OEIS A208371}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208371}{A208371} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +41*a(n-2) +78*a(n-3) -153*a(n-4) -363*a(n-5) +253*a(n-6) +566*a(n-7) -276*a(n-8) -324*a(n-9) +165*a(n-10) +29*a(n-11) -15*a(n-12)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 41\,a(n-2) + 78\,a(n-3) - 153\,a(n-4) - 363\,a(n-5) + 253\,a(n-6) + \\ 566\,a(n-7) - 276\,a(n-8) - 324\,a(n-9) + 165\,a(n-10) + 29\,a(n-11) - 15\,a(n-12). \end{multline*}
...
\begin{theorem} For A208371, the recurrence $a(n) = a(n-1) + 41\,a(n-2) + 78\,a(n-3) - 153\,a(n-4) - 363\,a(n-5) + 253\,a(n-6) + 566\,a(n-7) - 276\,a(n-8) - 324\,a(n-9) + 165\,a(n-10) + 29\,a(n-11) - 15\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 1162, 9338, 67396, 507682, 3759574, 28035840,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208371}{A208371}, revision 9, last modified Oct 03 2025.
