...
\title{A proof of the conjectured linear recurrence for OEIS A295547}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295547}{A295547} as

\begin{quote}\itshape Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 3 or 4 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) -8*a(n-2) -7*a(n-3) +10*a(n-4) -84*a(n-5) -232*a(n-6) +680*a(n-7) +1299*a(n-8) -1669*a(n-9) -475*a(n-10) +3475*a(n-11) -5871*a(n-12) -8620*a(n-13) +4957*a(n-14) -3601*a(n-15) -7232*a(n-16) +1897*a(n-17) +10512*a(n-18) +544*a(n-19) +795*a(n-20) +21086*a(n-21) +6396*a(n-22) +19576*a(n-23) +6829*a(n-24) +16929*a(n-25) -15374*a(n-26) +664*a(n-27) -12805*a(n-28) -19325*a(n-29) -17150*a(n-30) -12843*a(n-31) -15082*a(n-32) -5335*a(n-33) -8181*a(n-34) -58*a(n-35) -3152*a(n-36) +1066*a(n-37) -493*a(n-38) +294*a(n-39) +37*a(n-40) +15*a(n-41) +24*a(n-42) +12*a(n-43) -a(n-44) -a(n-45).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Nov 23 2017).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 7, last modified Nov 23 2017, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 7\,a(n-1) - 8\,a(n-2) - 7\,a(n-3) + 10\,a(n-4) - 84\,a(n-5) - 232\,a(n-6) + \\ 680\,a(n-7) + 1299\,a(n-8) - 1669\,a(n-9) - 475\,a(n-10) + 3475\,a(n-11) - 5871\,a(n-12) - \\ 8620\,a(n-13) + 4957\,a(n-14) - 3601\,a(n-15) - 7232\,a(n-16) + 1897\,a(n-17) + 10512\,a(n-18) + \\ 544\,a(n-19) + 795\,a(n-20) + 21086\,a(n-21) + 6396\,a(n-22) + 19576\,a(n-23) + 6829\,a(n-24) + \\ 16929\,a(n-25) - 15374\,a(n-26) + 664\,a(n-27) - 12805\,a(n-28) - 19325\,a(n-29) - 17150\,a(n-30) - \\ 12843\,a(n-31) - 15082\,a(n-32) - 5335\,a(n-33) - 8181\,a(n-34) - 58\,a(n-35) - 3152\,a(n-36) + \\ 1066\,a(n-37) - 493\,a(n-38) + 294\,a(n-39) + 37\,a(n-40) + 15\,a(n-41) + 24\,a(n-42) + \\ 12\,a(n-43) - a(n-44) - a(n-45). \end{multline*}
...
\begin{theorem} For A295547, the recurrence of order $45$ displayed in Section 1 holds for every $n \ge 46$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 24, 116, 598, 3035, 15352, 78434, 399324,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295547}{A295547}, revision 7, last modified Nov 23 2017.
