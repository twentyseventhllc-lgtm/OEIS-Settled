...
\title{Proofs of the conjectured column and row recurrences for OEIS A295275}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295275}{A295275} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1 or 4 1s\end{quote}
...
k=1: a(n) = a(n-1) +a(n-2) +a(n-3)\\k=2: a(n) = 2*a(n-1) +3*a(n-2) -a(n-4)\\k=3: [order 10]\\k=4: [order 16]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Nov 19 2017). As of revision 8, last modified Oct 20 2023, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A295275, the recurrence $a(n) = a(n-1) + a(n-2) + a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A295275, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A295275, the recurrence $a(n) = 0$ holds for every $n \ge 11$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A295275, the recurrence $a(n) = 0$ holds for every $n \ge 17$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295275}{A295275}, revision 8, last modified Oct 20 2023.
