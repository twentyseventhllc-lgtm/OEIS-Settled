...
\title{A proof of the conjectured linear recurrence for OEIS A295270}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295270}{A295270} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1 or 4 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 10*a(n-2) + 20*a(n-3) + 17*a(n-4) - a(n-5) - 9*a(n-6) - 12*a(n-7) - a(n-8) - a(n-9) + a(n-10).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Nov 19 2017).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 13, last modified May 31 2026, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 10\,a(n-2) + 20\,a(n-3) + 17\,a(n-4) - a(n-5) - 9\,a(n-6) - \\ 12\,a(n-7) - a(n-8) - a(n-9) + a(n-10). \end{multline*}
...
\begin{theorem} For A295270, the recurrence $a(n) = 2\,a(n-1) + 10\,a(n-2) + 20\,a(n-3) + 17\,a(n-4) - a(n-5) - 9\,a(n-6) - 12\,a(n-7) - a(n-8) - a(n-9) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 33, 164, 811, 4035, 19997, 99245, 492401,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295270}{A295270}, revision 13, last modified May 31 2026.
