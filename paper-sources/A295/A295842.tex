...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A295842}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295842}{A295842} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 adjacent to 1 or 2 king-move neighboring 1s\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) + a(n-2) + 12*a(n-3) - 30*a(n-4) + 3*a(n-5) - 6*a(n-6) + 6*a(n-7) + 5*a(n-8) + 2*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(4 + 13*x - 16*x\textasciicircum{}2 - 26*x\textasciicircum{}3 - 3*x\textasciicircum{}4 + 11*x\textasciicircum{}6 + 7*x\textasciicircum{}7 + 2*x\textasciicircum{}8) / (1 - 4*x - x\textasciicircum{}2 - 12*x\textasciicircum{}3 + 30*x\textasciicircum{}4 - 3*x\textasciicircum{}5 + 6*x\textasciicircum{}6 - 6*x\textasciicircum{}7 - 5*x\textasciicircum{}8 - 2*x\textasciicircum{}9). - Colin Barker, Feb 22 2019\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + a(n-2) + 12\,a(n-3) - 30\,a(n-4) + 3\,a(n-5) - 6\,a(n-6) + \\ 6\,a(n-7) + 5\,a(n-8) + 2\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{4x + 13x^{2} - 16x^{3} - 26x^{4} - 3x^{5} + 11x^{7} + 7x^{8} + 2x^{9}}{1 - 4x - x^{2} - 12x^{3} + 30x^{4} - 3x^{5} + 6x^{6} - 6x^{7} - 5x^{8} - 2x^{9}}.\]
...
\begin{theorem} For A295842, the recurrence $a(n) = 4\,a(n-1) + a(n-2) + 12\,a(n-3) - 30\,a(n-4) + 3\,a(n-5) - 6\,a(n-6) + 6\,a(n-7) + 5\,a(n-8) + 2\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A295842, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{4x + 13x^{2} - 16x^{3} - 26x^{4} - 3x^{5} + 11x^{7} + 7x^{8} + 2x^{9}}{1 - 4x - x^{2} - 12x^{3} + 30x^{4} - 3x^{5} + 6x^{6} - 6x^{7} - 5x^{8} - 2x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 29, 104, 467, 2197, 9645, 43335, 195508,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295842}{A295842}, revision 8, last modified Feb 22 2019.
