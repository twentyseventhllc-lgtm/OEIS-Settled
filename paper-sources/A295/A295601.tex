...
\title{A proof of the conjectured linear recurrence for OEIS A295601}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295601}{A295601} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 2, 3 or 4 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) - 9*a(n-2) - 11*a(n-3) + 14*a(n-4) - 53*a(n-5) + 19*a(n-6) + 42*a(n-7) - 23*a(n-8) + 72*a(n-9) + 36*a(n-10) - 25*a(n-11) - 12*a(n-12).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Nov 24 2017).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 13, last modified Nov 26 2017, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 7\,a(n-1) - 9\,a(n-2) - 11\,a(n-3) + 14\,a(n-4) - 53\,a(n-5) + 19\,a(n-6) + \\ 42\,a(n-7) - 23\,a(n-8) + 72\,a(n-9) + 36\,a(n-10) - 25\,a(n-11) - 12\,a(n-12). \end{multline*}
...
\begin{theorem} For A295601, the recurrence $a(n) = 7\,a(n-1) - 9\,a(n-2) - 11\,a(n-3) + 14\,a(n-4) - 53\,a(n-5) + 19\,a(n-6) + 42\,a(n-7) - 23\,a(n-8) + 72\,a(n-9) + 36\,a(n-10) - 25\,a(n-11) - 12\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 20, 83, 338, 1425, 6080, 26249, 114298,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295601}{A295601}, revision 13, last modified Nov 26 2017.
