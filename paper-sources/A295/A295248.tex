...
\title{A proof of the conjectured linear recurrence for OEIS A295248}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295248}{A295248} as

\begin{quote}\itshape Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1 or 3 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +6*a(n-2) +a(n-3) +2*a(n-4) -6*a(n-5) -6*a(n-6) -18*a(n-7) -5*a(n-8) +3*a(n-9) +4*a(n-11) +a(n-12) +9*a(n-13) -a(n-14) +3*a(n-15) -3*a(n-16) -a(n-18)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 6\,a(n-2) + a(n-3) + 2\,a(n-4) - 6\,a(n-5) - 6\,a(n-6) - \\ 18\,a(n-7) - 5\,a(n-8) + 3\,a(n-9) + 4\,a(n-11) + a(n-12) + 9\,a(n-13) - \\ a(n-14) + 3\,a(n-15) - 3\,a(n-16) - a(n-18). \end{multline*}
...
\begin{theorem} For A295248, the recurrence $a(n) = 4\,a(n-1) + 6\,a(n-2) + a(n-3) + 2\,a(n-4) - 6\,a(n-5) - 6\,a(n-6) - 18\,a(n-7) - 5\,a(n-8) + 3\,a(n-9) + 4\,a(n-11) + a(n-12) + 9\,a(n-13) - a(n-14) + 3\,a(n-15) - 3\,a(n-16) - a(n-18)$ holds for every $n \ge 19$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 35, 183, 948, 4928, 25596, 132993, 690938,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295248}{A295248}, revision 4, last modified Nov 18 2017.
