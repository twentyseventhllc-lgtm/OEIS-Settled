...
\title{A proof of the conjectured linear recurrence for OEIS A295208}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295208}{A295208} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 2 or 3 1's\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -7*a(n-2) +10*a(n-3) -18*a(n-4) +18*a(n-5) -5*a(n-6) -15*a(n-7) +7*a(n-8) -9*a(n-9) +10*a(n-10) -2*a(n-11) +a(n-12).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Nov 17 2017).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Apr 20 2021, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 5\,a(n-1) - 7\,a(n-2) + 10\,a(n-3) - 18\,a(n-4) + 18\,a(n-5) - 5\,a(n-6) - \\ 15\,a(n-7) + 7\,a(n-8) - 9\,a(n-9) + 10\,a(n-10) - 2\,a(n-11) + a(n-12). \end{multline*}
...
\begin{theorem} For A295208, the recurrence $a(n) = 5\,a(n-1) - 7\,a(n-2) + 10\,a(n-3) - 18\,a(n-4) + 18\,a(n-5) - 5\,a(n-6) - 15\,a(n-7) + 7\,a(n-8) - 9\,a(n-9) + 10\,a(n-10) - 2\,a(n-11) + a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 4, 10, 27, 102, 345, 1162, 4072,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295208}{A295208}, revision 9, last modified Apr 20 2021.
