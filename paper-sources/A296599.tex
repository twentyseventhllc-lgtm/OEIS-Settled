...
k=1: a(n) = 2*a(n-1) -a(n-2) +a(n-3)\\k=2: a(n) = 3*a(n-1) +a(n-2) +4*a(n-3) +a(n-4) +a(n-6) -a(n-7) -a(n-8)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 16 2017). As of revision 10, last modified Dec 29 2023, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
