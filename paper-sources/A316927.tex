...
\title{A proof of the conjectured linear recurrence for OEIS A316927}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316927}{A316927} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element unequal to 0, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) -3*a(n-2) -3*a(n-3) -64*a(n-4) -24*a(n-5) +77*a(n-6) +105*a(n-7) +88*a(n-8) -14*a(n-9) -40*a(n-10) +10*a(n-11) +18*a(n-12) +4*a(n-13) for n > 15.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jul 16 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified May 24 2021, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 7\,a(n-1) - 3\,a(n-2) - 3\,a(n-3) - 64\,a(n-4) - 24\,a(n-5) + 77\,a(n-6) + \\ 105\,a(n-7) + 88\,a(n-8) - 14\,a(n-9) - 40\,a(n-10) + 10\,a(n-11) + 18\,a(n-12) + \\ 4\,a(n-13). \end{multline*}
...
\begin{theorem} For A316927, the recurrence $a(n) = 7\,a(n-1) - 3\,a(n-2) - 3\,a(n-3) - 64\,a(n-4) - 24\,a(n-5) + 77\,a(n-6) + 105\,a(n-7) + 88\,a(n-8) - 14\,a(n-9) - 40\,a(n-10) + 10\,a(n-11) + 18\,a(n-12) + 4\,a(n-13)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,55$. The last nonvanishing one is at $m = 2$, that is at $n = 15$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 8, 25, 143, 851, 5114, 31197, 191330,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316927}{A316927}, revision 6, last modified May 24 2021.
