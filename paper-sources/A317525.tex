...
\title{Proofs of the conjectured column and row recurrences for OEIS A317525}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317525}{A317525} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = 2*a(n-1)\\k=2: a(n) = 4*a(n-1)\\k=3: a(n) = 8*a(n-1) -2*a(n-2) +a(n-3) -3*a(n-4)\\k=4: a(n) = 15*a(n-1) +a(n-2) -8*a(n-3) -84*a(n-4) -63*a(n-5) +24*a(n-6) +20*a(n-7)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 30 2018). As of revision 4, last modified Jul 30 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A317525, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A317525, the recurrence $a(n) = 4\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A317525, the recurrence $a(n) = 8\,a(n-1) - 2\,a(n-2) + a(n-3) - 3\,a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A317525, the recurrence $a(n) = 15\,a(n-1) + a(n-2) - 8\,a(n-3) - 84\,a(n-4) - 63\,a(n-5) + 24\,a(n-6) + 20\,a(n-7)$ holds for every $n \ge 8$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317525}{A317525}, revision 4, last modified Jul 30 2018.
