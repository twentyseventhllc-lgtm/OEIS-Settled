...
\title{A proof of the conjectured linear recurrence for OEIS A255656}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255656}{A255656} as

\begin{quote}\itshape Number of length n+4 0..3 arrays with at most two downsteps in every 4 consecutive neighbor pairs\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -4*a(n-3) +15*a(n-4) -24*a(n-5) -68*a(n-6) +136*a(n-7) -81*a(n-8) +40*a(n-9) -10*a(n-10) +4*a(n-11) -a(n-12)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 4\,a(n-3) + 15\,a(n-4) - 24\,a(n-5) - 68\,a(n-6) + 136\,a(n-7) - \\ 81\,a(n-8) + 40\,a(n-9) - 10\,a(n-10) + 4\,a(n-11) - a(n-12). \end{multline*}
...
The reachable part of that digraph has $341$ states, $341$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 18$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $18\times18$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A255656, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-3) + 15\,a(n-4) - 24\,a(n-5) - 68\,a(n-6) + 136\,a(n-7) - 81\,a(n-8) + 40\,a(n-9) - 10\,a(n-10) + 4\,a(n-11) - a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. Every one of them vanished. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 968, 3692, 14192, 54560, 209412, 803246, 3083292, 11835664,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255656}{A255656}, revision 7, last modified Jul 23 2025.
