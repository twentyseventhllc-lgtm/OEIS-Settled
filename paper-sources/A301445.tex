...
\title{A proof of the conjectured linear recurrence for OEIS A301445}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301445}{A301445} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +7*a(n-2) -10*a(n-3) -a(n-4) +7*a(n-5) -17*a(n-6) +5*a(n-8) -11*a(n-9) +5*a(n-10) -2*a(n-12) +2*a(n-13)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 7\,a(n-2) - 10\,a(n-3) - a(n-4) + 7\,a(n-5) - 17\,a(n-6) + \\ 5\,a(n-8) - 11\,a(n-9) + 5\,a(n-10) - 2\,a(n-12) + 2\,a(n-13). \end{multline*}
...
\begin{theorem} For A301445, the recurrence $a(n) = 5\,a(n-1) + 7\,a(n-2) - 10\,a(n-3) - a(n-4) + 7\,a(n-5) - 17\,a(n-6) + 5\,a(n-8) - 11\,a(n-9) + 5\,a(n-10) - 2\,a(n-12) + 2\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 29, 171, 1008, 5930, 34976, 206266, 1216562,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301445}{A301445}, revision 4, last modified Mar 21 2018.
