...
\title{A proof of the conjectured linear recurrence for OEIS A299834}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299834}{A299834} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +2*a(n-2) +7*a(n-3) -6*a(n-4) -15*a(n-5) +a(n-6) +2*a(n-7) -5*a(n-8) -2*a(n-9) for n>10.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 20 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Mar 17 2023, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 7\,a(n-1) + 2\,a(n-2) + 7\,a(n-3) - 6\,a(n-4) - 15\,a(n-5) + a(n-6) + \\ 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9). \end{multline*}
...
\begin{theorem} For A299834, the recurrence $a(n) = 7\,a(n-1) + 2\,a(n-2) + 7\,a(n-3) - 6\,a(n-4) - 15\,a(n-5) + a(n-6) + 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 142, 1000, 7388, 54611, 402928, 2973312,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299834}{A299834}, revision 6, last modified Mar 17 2023.
