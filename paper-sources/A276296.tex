...
\title{A proof of the conjectured linear recurrence for OEIS A276296}
...
\begin{multline*} a(n) = 15\,a(n-1) - 59\,a(n-2) + 88\,a(n-3) - 753\,a(n-4) + 3144\,a(n-5) - 3566\,a(n-6) + \\ 15470\,a(n-7) - 60036\,a(n-8) + 63424\,a(n-9) - 166302\,a(n-10) + 522272\,a(n-11) - 496170\,a(n-12) + \\ 872844\,a(n-13) - 2184470\,a(n-14) + 1728684\,a(n-15) - 2023510\,a(n-16) + 4274276\,a(n-17) - 2552010\,a(n-18) + \\ 1711922\,a(n-19) - 3752238\,a(n-20) + 1631282\,a(n-21) - 390844\,a(n-22) + 1591096\,a(n-23) - 522438\,a(n-24) - \\ 63580\,a(n-25) - 336430\,a(n-26) + 92712\,a(n-27) + 24271\,a(n-28) + 31601\,a(n-29) - 8451\,a(n-30) - \\ 1540\,a(n-31) - 993\,a(n-32) + 290\,a(n-33). \end{multline*}
...
The reachable part of the digraph has $600$ states, $600$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 41$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of the resulting $41\times41$ matrix. That bound is computed, not assumed.
...
\begin{theorem} For A276296, the recurrence of order $33$ displayed in Section 1 holds for every $n > 37$, and fails at $n = 37$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,99$. The last nonvanishing one is at $m = 4$, that is at $n = 37$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 108, 693, 5909, 50949, 442001, 3861469, 33851605,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A276296}{A276296}, revision 4, last modified Aug 28 2016.
