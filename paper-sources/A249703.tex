...
\title{A proof of the conjectured linear recurrence for OEIS A249703}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A249703}{A249703} as

\begin{quote}\itshape Number of length n+3 0..4 arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) -3*a(n-3) +25*a(n-4) -39*a(n-5) -30*a(n-6) +40*a(n-7) -176*a(n-8) +78*a(n-9) +365*a(n-10) +57*a(n-11) +515*a(n-12) +361*a(n-13) -923*a(n-14) -1037*a(n-15) -1152*a(n-16) -1164*a(n-17) +750*a(n-18) +1980*a(n-19) +1872*a(n-20) +1440*a(n-21) -432*a(n-22) -1728*a(n-23) -864*a(n-24)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) - 3\,a(n-3) + 25\,a(n-4) - 39\,a(n-5) - 30\,a(n-6) + \\ 40\,a(n-7) - 176\,a(n-8) + 78\,a(n-9) + 365\,a(n-10) + 57\,a(n-11) + 515\,a(n-12) + \\ 361\,a(n-13) - 923\,a(n-14) - 1037\,a(n-15) - 1152\,a(n-16) - 1164\,a(n-17) + 750\,a(n-18) + \\ 1980\,a(n-19) + 1872\,a(n-20) + 1440\,a(n-21) - 432\,a(n-22) - 1728\,a(n-23) - 864\,a(n-24). \end{multline*}
...
The reachable part of that digraph has $156$ states, $156$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 29$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $29\times29$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A249703, the recurrence of order $24$ displayed in Section 1 holds for every $n \ge 25$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 205, 485, 1153, 2601, 5425, 11925, 27113, 61725,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A249703}{A249703}, revision 6, last modified Jul 23 2025.
