...
k=1: a(n) = a(n-1) +a(n-2)\\k=2: a(n) = a(n-1) +4*a(n-3) +a(n-5) -a(n-6)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jun 09 2019). As of revision 6, last modified Apr 19 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
