...
\title{A proof of the conjectured linear recurrence for OEIS A305240}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305240}{A305240} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +2*a(n-3) -a(n-4) -2*a(n-5) -3*a(n-6) -a(n-7) +a(n-8) for n>11\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 2\,a(n-3) - a(n-4) - 2\,a(n-5) - 3\,a(n-6) - \\ a(n-7) + a(n-8). \end{multline*}
...
\begin{theorem} For A305240, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 2\,a(n-3) - a(n-4) - 2\,a(n-5) - 3\,a(n-6) - a(n-7) + a(n-8)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,55$. The last nonvanishing one is at $m = 3$, that is at $n = 11$. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 18, 32, 86, 158, 343, 721,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305240}{A305240}, revision 4, last modified May 28 2018.
