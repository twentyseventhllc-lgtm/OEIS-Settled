...
\title{A proof of the conjectured linear recurrence for OEIS A305765}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305765}{A305765} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +16*a(n-2) -52*a(n-3) -89*a(n-4) +228*a(n-5) -65*a(n-6) -256*a(n-7) +754*a(n-8) -428*a(n-9) -25*a(n-10) -255*a(n-11) -768*a(n-12) +2580*a(n-13) -3804*a(n-14) +1874*a(n-15) +1205*a(n-16) -1287*a(n-17) +2505*a(n-18) -4282*a(n-19) +2886*a(n-20) -5280*a(n-21) +4994*a(n-22) -3929*a(n-23) +4905*a(n-24) -2280*a(n-25) +513*a(n-26) -1013*a(n-27) +598*a(n-28) -103*a(n-29) -43*a(n-30) +119*a(n-31) -31*a(n-32) +4*a(n-33) -14*a(n-34) +8*a(n-35) for n>37\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Jun 10 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 4, last modified Jun 10 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 6\,a(n-1) + 16\,a(n-2) - 52\,a(n-3) - 89\,a(n-4) + 228\,a(n-5) - 65\,a(n-6) - \\ 256\,a(n-7) + 754\,a(n-8) - 428\,a(n-9) - 25\,a(n-10) - 255\,a(n-11) - 768\,a(n-12) + \\ 2580\,a(n-13) - 3804\,a(n-14) + 1874\,a(n-15) + 1205\,a(n-16) - 1287\,a(n-17) + 2505\,a(n-18) - \\ 4282\,a(n-19) + 2886\,a(n-20) - 5280\,a(n-21) + 4994\,a(n-22) - 3929\,a(n-23) + 4905\,a(n-24) - \\ 2280\,a(n-25) + 513\,a(n-26) - 1013\,a(n-27) + 598\,a(n-28) - 103\,a(n-29) - 43\,a(n-30) + \\ 119\,a(n-31) - 31\,a(n-32) + 4\,a(n-33) - 14\,a(n-34) + 8\,a(n-35). \end{multline*}
...
\begin{theorem} For A305765, the recurrence of order $35$ displayed in Section 1 holds for every $n > 37$, and fails at $n = 37$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,101$. The last nonvanishing one is at $m = 2$, that is at $n = 37$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 112, 684, 4893, 34001, 240701, 1696681, 11974403,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305765}{A305765}, revision 4, last modified Jun 10 2018.
