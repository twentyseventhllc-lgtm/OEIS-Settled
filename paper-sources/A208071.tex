...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208071}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208071}{A208071} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 17*a(n-3) - 2*a(n-4) - 4*a(n-5) - 16*a(n-6) for n>8.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(4 + 56*x - 63*x\textasciicircum{}2 - 45*x\textasciicircum{}3 - 522*x\textasciicircum{}4 + 36*x\textasciicircum{}5 + 32*x\textasciicircum{}6 + 448*x\textasciicircum{}7) / ((1 - x)*(1 - 4*x)*(1 + x + x\textasciicircum{}2)*(1 + 2*x + 4*x\textasciicircum{}2)). - Colin Barker, Jun 27 2018\end{quote}
...
\[a(n) = 2\,a(n-1) + 4\,a(n-2) + 17\,a(n-3) - 2\,a(n-4) - 4\,a(n-5) - 16\,a(n-6).\]

stated for $n > 8$.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{16x + 224x^{2} - 252x^{3} - 180x^{4} - 2088x^{5} + 144x^{6} + 128x^{7} + 1792x^{8}}{1 - 2x - 4x^{2} - 17x^{3} + 2x^{4} + 4x^{5} + 16x^{6}}.\]
...
\begin{theorem} For A208071, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) + 17\,a(n-3) - 2\,a(n-4) - 4\,a(n-5) - 16\,a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}
...
\begin{theorem} For A208071, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{16x + 224x^{2} - 252x^{3} - 180x^{4} - 2088x^{5} + 144x^{6} + 128x^{7} + 1792x^{8}}{1 - 2x - 4x^{2} - 17x^{3} + 2x^{4} + 4x^{5} + 16x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 324, 1764, 7056, 26244, 108900, 435600,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208071}{A208071}, revision 8, last modified Jun 27 2018.
