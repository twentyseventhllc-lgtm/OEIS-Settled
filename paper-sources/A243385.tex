...
\title{A proof of the conjectured linear recurrence for OEIS A243385}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A243385}{A243385} as

\begin{quote}\itshape Number of length n+3 0..4 arrays with no four elements in a row with pattern abba (with a!=b) and new values 0..4 introduced in 0..4 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-1) -44*a(n-2) +87*a(n-3) -107*a(n-4) +101*a(n-5) -71*a(n-6) +37*a(n-7) -16*a(n-8) +4*a(n-9) -a(n-10)\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-1) - 44\,a(n-2) + 87\,a(n-3) - 107\,a(n-4) + 101\,a(n-5) - 71\,a(n-6) + \\ 37\,a(n-7) - 16\,a(n-8) + 4\,a(n-9) - a(n-10). \end{multline*}
...
The reachable part of that digraph has $229$ states, $229$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 11$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $11\times11$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A243385, the recurrence $a(n) = 11\,a(n-1) - 44\,a(n-2) + 87\,a(n-3) - 107\,a(n-4) + 101\,a(n-5) - 71\,a(n-6) + 37\,a(n-7) - 16\,a(n-8) + 4\,a(n-9) - a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 46, 173, 715, 3145, 14384, 67346, 319672,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A243385}{A243385}, revision 6, last modified Jul 23 2025.
