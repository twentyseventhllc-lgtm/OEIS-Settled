...
\title{A proof of the conjectured linear recurrence for OEIS A318064}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A318064}{A318064} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) +19*a(n-2) -102*a(n-3) -178*a(n-4) +302*a(n-5) +901*a(n-6) +47*a(n-7) -3090*a(n-8) -1538*a(n-9) +5753*a(n-10) +4891*a(n-11) -5102*a(n-12) -3212*a(n-13) +1843*a(n-14) -6490*a(n-15) -5285*a(n-16) +19179*a(n-17) +30843*a(n-18) +13600*a(n-19) -14605*a(n-20) -29759*a(n-21) -27375*a(n-22) -19262*a(n-23) -7115*a(n-24) +21577*a(n-25) +35903*a(n-26) +13899*a(n-27) -8765*a(n-28) -10010*a(n-29) -6393*a(n-30) -2087*a(n-31) +1134*a(n-32) +1680*a(n-33) +796*a(n-34) -31*a(n-35) -149*a(n-36) -100*a(n-37) -16*a(n-38) +16*a(n-39)\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) + 19\,a(n-2) - 102\,a(n-3) - 178\,a(n-4) + 302\,a(n-5) + 901\,a(n-6) + \\ 47\,a(n-7) - 3090\,a(n-8) - 1538\,a(n-9) + 5753\,a(n-10) + 4891\,a(n-11) - 5102\,a(n-12) - \\ 3212\,a(n-13) + 1843\,a(n-14) - 6490\,a(n-15) - 5285\,a(n-16) + 19179\,a(n-17) + 30843\,a(n-18) + \\ 13600\,a(n-19) - 14605\,a(n-20) - 29759\,a(n-21) - 27375\,a(n-22) - 19262\,a(n-23) - 7115\,a(n-24) + \\ 21577\,a(n-25) + 35903\,a(n-26) + 13899\,a(n-27) - 8765\,a(n-28) - 10010\,a(n-29) - 6393\,a(n-30) - \\ 2087\,a(n-31) + 1134\,a(n-32) + 1680\,a(n-33) + 796\,a(n-34) - 31\,a(n-35) - 149\,a(n-36) - \\ 100\,a(n-37) - 16\,a(n-38) + 16\,a(n-39). \end{multline*}
...
That refinement leaves $52$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 45$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A318064, the recurrence of order $39$ displayed in Section 1 holds for every $n \ge 40$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 67, 649, 7170, 76927, 829137, 8929364, 96178466,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A318064}{A318064}, revision 4, last modified Aug 15 2018.
