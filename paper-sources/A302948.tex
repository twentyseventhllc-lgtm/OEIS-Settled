...
\title{A proof of the conjectured linear recurrence for OEIS A302948}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302948}{A302948} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +15*a(n-2) +13*a(n-3) -2*a(n-4) -19*a(n-5) -3*a(n-6) +4*a(n-8)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 15\,a(n-2) + 13\,a(n-3) - 2\,a(n-4) - 19\,a(n-5) - 3\,a(n-6) + \\ 4\,a(n-8). \end{multline*}
...
\begin{theorem} For A302948, the recurrence $a(n) = 4\,a(n-1) + 15\,a(n-2) + 13\,a(n-3) - 2\,a(n-4) - 19\,a(n-5) - 3\,a(n-6) + 4\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 15, 86, 587, 3815, 25131, 164916, 1083375,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302948}{A302948}, revision 4, last modified Apr 16 2018.
