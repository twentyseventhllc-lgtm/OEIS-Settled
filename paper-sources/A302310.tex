...
\title{A proof of the conjectured linear recurrence for OEIS A302310}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302310}{A302310} as

\begin{quote}\itshape Number of 2Xn 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-3) +12*a(n-4) -16*a(n-5) for n>6\end{quote}
...
\begin{theorem} For A302310, the recurrence $a(n) = 2\,a(n-1) - a(n-2) + 4\,a(n-3) + 12\,a(n-4) - 16\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 3, 11, 21, 31, 113, 363, 813,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302310}{A302310}, revision 4, last modified Apr 05 2018.
