...
\title{A proof of the conjectured linear recurrence for OEIS A305511}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305511}{A305511} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) +4*a(n-3) +3*a(n-4) -4*a(n-6) -5*a(n-7) -a(n-8) -3*a(n-9) -2*a(n-10) for n>13\end{quote}
...
\begin{multline*} a(n) = a(n-2) + 4\,a(n-3) + 3\,a(n-4) - 4\,a(n-6) - 5\,a(n-7) - a(n-8) - \\ 3\,a(n-9) - 2\,a(n-10). \end{multline*}
...
\begin{theorem} For A305511, the recurrence $a(n) = a(n-2) + 4\,a(n-3) + 3\,a(n-4) - 4\,a(n-6) - 5\,a(n-7) - a(n-8) - 3\,a(n-9) - 2\,a(n-10)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. The last nonvanishing one is at $m = 3$, that is at $n = 13$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 34 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 2, 5, 6, 8, 19, 33, 60,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305511}{A305511}, revision 4, last modified Jun 03 2018.
