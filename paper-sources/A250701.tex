...
\title{A proof of the conjectured linear recurrence for OEIS A250701}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250701}{A250701} as
...
\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) -64*a(n-2) +112*a(n-3) +193*a(n-4) -1145*a(n-5) +1171*a(n-6) +2815*a(n-7) -7600*a(n-8) +620*a(n-9) +17570*a(n-10) -16376*a(n-11) -18514*a(n-12) +37522*a(n-13) +1693*a(n-14) -44011*a(n-15) +19988*a(n-16) +29252*a(n-17) -26851*a(n-18) -9189*a(n-19) +18134*a(n-20) -1082*a(n-21) -7142*a(n-22) +2176*a(n-23) +1569*a(n-24) -849*a(n-25) -139*a(n-26) +153*a(n-27) -9*a(n-28) -11*a(n-29) +2*a(n-30)\end{quote}
...
\begin{multline*} a(n) = 13\,a(n-1) - 64\,a(n-2) + 112\,a(n-3) + 193\,a(n-4) - 1145\,a(n-5) + 1171\,a(n-6) + \\ 2815\,a(n-7) - 7600\,a(n-8) + 620\,a(n-9) + 17570\,a(n-10) - 16376\,a(n-11) - 18514\,a(n-12) + \\ 37522\,a(n-13) + 1693\,a(n-14) - 44011\,a(n-15) + 19988\,a(n-16) + 29252\,a(n-17) - 26851\,a(n-18) - \\ 9189\,a(n-19) + 18134\,a(n-20) - 1082\,a(n-21) - 7142\,a(n-22) + 2176\,a(n-23) + 1569\,a(n-24) - \\ 849\,a(n-25) - 139\,a(n-26) + 153\,a(n-27) - 9\,a(n-28) - 11\,a(n-29) + 2\,a(n-30). \end{multline*}
...
\begin{theorem} For A250701, the recurrence of order $30$ displayed in Section 1 holds for every $n \ge 31$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 654, 4958, 30719, 160486, 735523, 3020711, 11354082, 39603227,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250701}{A250701}, revision 6, last modified Jul 23 2025.
