...
\title{A proof of the conjectured linear recurrence for OEIS A297602}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297602}{A297602} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -a(n-2) +19*a(n-3) -36*a(n-4) -62*a(n-6) +62*a(n-7) +24*a(n-8) +4*a(n-9) -40*a(n-10) -32*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - a(n-2) + 19\,a(n-3) - 36\,a(n-4) - 62\,a(n-6) + 62\,a(n-7) + \\ 24\,a(n-8) + 4\,a(n-9) - 40\,a(n-10) - 32\,a(n-11). \end{multline*}
...
\begin{theorem} For A297602, the recurrence $a(n) = 5\,a(n-1) - a(n-2) + 19\,a(n-3) - 36\,a(n-4) - 62\,a(n-6) + 62\,a(n-7) + 24\,a(n-8) + 4\,a(n-9) - 40\,a(n-10) - 32\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 35, 181, 953, 4997, 26155, 137033, 717905,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297602}{A297602}, revision 4, last modified Jan 01 2018.
