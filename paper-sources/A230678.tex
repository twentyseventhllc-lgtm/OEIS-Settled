...
\title{A proof of the conjectured order of the recurrence for OEIS A230678}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A230678}{A230678} as

\begin{quote}\itshape Number of 4Xn 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value 2-x(i,j)\end{quote}
...
\begin{theorem} For A230678, the least order of a linear recurrence that $a$ eventually satisfies is exactly $64$, and that recurrence holds for every $n > 65$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 14 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 423, 17271, 730503, 37034355, 1844154933, 91258562955, 4522036938501,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A230678}{A230678}, revision 7, last modified Jun 02 2025.
