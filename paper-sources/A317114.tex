...
\title{A proof of the conjectured linear recurrence for OEIS A317114}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317114}{A317114} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) +18*a(n-2) -52*a(n-3) -87*a(n-4) +179*a(n-5) -32*a(n-6) -71*a(n-7) +331*a(n-8) -255*a(n-9) +742*a(n-10) -1606*a(n-11) -181*a(n-12) +3533*a(n-13) -4199*a(n-14) +1635*a(n-15) -190*a(n-16) -239*a(n-17) +1405*a(n-18) -4311*a(n-19) +3687*a(n-20) -4321*a(n-21) +3412*a(n-22) -3747*a(n-23) +4780*a(n-24) -2739*a(n-25) +465*a(n-26) -471*a(n-27) +287*a(n-28) +41*a(n-29) +26*a(n-30) +101*a(n-31) -33*a(n-32) +12*a(n-33) -14*a(n-34) +8*a(n-35) for n>37\end{quote}
...
\begin{multline*} a(n) = 6\,a(n-1) + 18\,a(n-2) - 52\,a(n-3) - 87\,a(n-4) + 179\,a(n-5) - 32\,a(n-6) - \\ 71\,a(n-7) + 331\,a(n-8) - 255\,a(n-9) + 742\,a(n-10) - 1606\,a(n-11) - 181\,a(n-12) + \\ 3533\,a(n-13) - 4199\,a(n-14) + 1635\,a(n-15) - 190\,a(n-16) - 239\,a(n-17) + 1405\,a(n-18) - \\ 4311\,a(n-19) + 3687\,a(n-20) - 4321\,a(n-21) + 3412\,a(n-22) - 3747\,a(n-23) + 4780\,a(n-24) - \\ 2739\,a(n-25) + 465\,a(n-26) - 471\,a(n-27) + 287\,a(n-28) + 41\,a(n-29) + 26\,a(n-30) + \\ 101\,a(n-31) - 33\,a(n-32) + 12\,a(n-33) - 14\,a(n-34) + 8\,a(n-35). \end{multline*}
...
\begin{theorem} For A317114, the recurrence of order $35$ displayed in Section 1 holds for every $n > 37$, and fails at $n = 37$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 112, 698, 5157, 37221, 273221, 2000595, 14657917,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317114}{A317114}, revision 4, last modified Jul 21 2018.
