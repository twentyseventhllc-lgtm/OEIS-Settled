...
\title{Proofs of the conjectured column and row recurrences for OEIS A304901}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304901}{A304901} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element unequal to 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=4: [order 46] for n>48.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (May 20 2018). As of revision 6, last modified Jun 21 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 4$ of A304901, the recurrence $a(n) = 0$ holds for every $n > 48$, and fails at $n = 48$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304901}{A304901}, revision 6, last modified Jun 21 2022.
