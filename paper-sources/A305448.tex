...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,169$. The last nonvanishing one is at $m = 2$, that is at $n = 65$. After it, more than $S = 75$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
