...
\title{A proof of the conjectured linear recurrence for OEIS A234486}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234486}{A234486} as

\begin{quote}\itshape Number of (n+1) X (4+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 16*a(n-1) -69*a(n-2) -186*a(n-3) +2233*a(n-4) -3610*a(n-5) -15789*a(n-6) +56088*a(n-7) +1729*a(n-8) -189898*a(n-9) +95019*a(n-10) +304674*a(n-11) -145486*a(n-12) -269396*a(n-13) +58980*a(n-14) +118584*a(n-15) +6480*a(n-16) -16992*a(n-17) -3456*a(n-18).\end{quote}
...
\begin{multline*} a(n) = 16\,a(n-1) - 69\,a(n-2) - 186\,a(n-3) + 2233\,a(n-4) - 3610\,a(n-5) - 15789\,a(n-6) + \\ 56088\,a(n-7) + 1729\,a(n-8) - 189898\,a(n-9) + 95019\,a(n-10) + 304674\,a(n-11) - 145486\,a(n-12) - \\ 269396\,a(n-13) + 58980\,a(n-14) + 118584\,a(n-15) + 6480\,a(n-16) - 16992\,a(n-17) - 3456\,a(n-18). \end{multline*}
...
For scale: at $n = 8$ there are $4^{40}$ arrays, about $10^{24}$, against $18$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A234486, the recurrence of order $18$ displayed in Section 1 holds for every $n \ge 19$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3686, 13554, 49784, 183422, 677138, 2505400, 9288710, 34509914,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234486}{A234486}, revision 6, last modified Jun 20 2022.
