...
\title{A proof of the conjectured linear recurrence for OEIS A260975}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260975}{A260975} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-4) +6*a(n-5) +10*a(n-7) +5*a(n-8) -24*a(n-9) -4*a(n-10) -26*a(n-11) +39*a(n-12) -a(n-14) for n>18\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-4) + 6\,a(n-5) + 10\,a(n-7) + 5\,a(n-8) - 24\,a(n-9) - 4\,a(n-10) - \\ 26\,a(n-11) + 39\,a(n-12) - a(n-14). \end{multline*}
...
\begin{theorem} For A260975, the recurrence $a(n) = 8\,a(n-4) + 6\,a(n-5) + 10\,a(n-7) + 5\,a(n-8) - 24\,a(n-9) - 4\,a(n-10) - 26\,a(n-11) + 39\,a(n-12) - a(n-14)$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,83$. The last nonvanishing one is at $m = 4$, that is at $n = 18$. After it, more than $S = 35$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 204, 239, 372, 732, 1288, 2576, 4688, 8760,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260975}{A260975}, revision 6, last modified Jun 02 2025.
