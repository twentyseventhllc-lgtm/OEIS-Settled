...
\title{Proofs of the conjectured column and row recurrences for OEIS A305223}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305223}{A305223} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element unequal to 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} In A305223, column $k = 1$ is identically zero, and the claimed recurrence therefore holds at every index.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A305223, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - 4\,a(n-3) - 6\,a(n-4) + 4\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A305223, the recurrence $a(n) = 0$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A305223, the recurrence $a(n) = 0$ holds for every $n > 66$, and fails at $n = 66$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305223}{A305223}, revision 4, last modified May 27 2018.
