...
\title{A proof of the conjectured linear recurrence for OEIS A207930}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207930}{A207930} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) -a(n-2) +8*a(n-3) +34*a(n-4) +14*a(n-5) +42*a(n-6) -42*a(n-8) -14*a(n-9) -34*a(n-10) -8*a(n-11) +a(n-12) -a(n-13) +a(n-14) for n>15\end{quote}
...
\begin{multline*} a(n) = a(n-1) - a(n-2) + 8\,a(n-3) + 34\,a(n-4) + 14\,a(n-5) + 42\,a(n-6) - \\ 42\,a(n-8) - 14\,a(n-9) - 34\,a(n-10) - 8\,a(n-11) + a(n-12) - a(n-13) + \\ a(n-14). \end{multline*}
...
\begin{theorem} For A207930, the recurrence $a(n) = a(n-1) - a(n-2) + 8\,a(n-3) + 34\,a(n-4) + 14\,a(n-5) + 42\,a(n-6) - 42\,a(n-8) - 14\,a(n-9) - 34\,a(n-10) - 8\,a(n-11) + a(n-12) - a(n-13) + a(n-14)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,72$. The last nonvanishing one is at $m = 1$, that is at $n = 15$. After it, more than $S = 28$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 240, 576, 1872, 6084, 18096, 53824,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207930}{A207930}, revision 9, last modified Oct 03 2025.
