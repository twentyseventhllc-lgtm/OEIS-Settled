...
\title{Proofs of the conjectured column and row recurrences for OEIS A269089}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269089}{A269089} as

\begin{quote}\itshape T(n,k)=Number of nXk binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once\end{quote}
...
k=1: a(n) = 2*a(n-1) +a(n-2) -2*a(n-3) -a(n-4)\\k=2: a(n) = 2*a(n-1) +3*a(n-2) -2*a(n-3) -6*a(n-4) -4*a(n-5) -a(n-6)\\k=3: [order 10]\\k=4: [order 16]\end{quote}
...
\begin{theorem} For column $k = 1$ of A269089, the recurrence $a(n) = 2\,a(n-1) + a(n-2) - 2\,a(n-3) - a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269089, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - 2\,a(n-3) - 6\,a(n-4) - 4\,a(n-5) - a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A269089, the recurrence $a(n) = 0$ holds for every $n \ge 11$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A269089, the recurrence $a(n) = 0$ holds for every $n \ge 17$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269089}{A269089}, revision 4, last modified Feb 19 2016.
