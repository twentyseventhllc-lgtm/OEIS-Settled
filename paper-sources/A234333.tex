...
k=1: a(n) = 32*a(n-2) -48*a(n-4).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 23 2013). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
