...
\title{A proof of the conjectured linear recurrence for OEIS A207732}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207732}{A207732} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +21*a(n-3) +285*a(n-4) +40*a(n-5) +116*a(n-6) -1248*a(n-7) -17520*a(n-8) -5440*a(n-9) +3712*a(n-10) +13824*a(n-11) +291840*a(n-12) +102400*a(n-13) +131072*a(n-15) -1048576*a(n-16)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 21\,a(n-3) + 285\,a(n-4) + 40\,a(n-5) + 116\,a(n-6) - 1248\,a(n-7) - \\ 17520\,a(n-8) - 5440\,a(n-9) + 3712\,a(n-10) + 13824\,a(n-11) + 291840\,a(n-12) + 102400\,a(n-13) + \\ 131072\,a(n-15) - 1048576\,a(n-16). \end{multline*}
...
\begin{theorem} For A207732, the recurrence $a(n) = a(n-1) + 21\,a(n-3) + 285\,a(n-4) + 40\,a(n-5) + 116\,a(n-6) - 1248\,a(n-7) - 17520\,a(n-8) - 5440\,a(n-9) + 3712\,a(n-10) + 13824\,a(n-11) + 291840\,a(n-12) + 102400\,a(n-13) + 131072\,a(n-15) - 1048576\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 490, 1225, 8575, 60025, 211680, 746496,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207732}{A207732}, revision 9, last modified Oct 03 2025.
