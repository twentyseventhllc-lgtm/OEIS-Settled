...
k=4: a(n) = 3*a(n-7) +5*a(n-10) +a(n-13) -a(n-14) -a(n-17) -2*a(n-21) for n>27\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Aug 28 2015). As of revision 4, last modified Aug 28 2015, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
