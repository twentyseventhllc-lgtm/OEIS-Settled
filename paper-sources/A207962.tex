...
\title{A proof of the conjectured linear recurrence for OEIS A207962}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207962}{A207962} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +11*a(n-3) +11*a(n-4) -a(n-5) -20*a(n-6) -27*a(n-7) -5*a(n-8) +20*a(n-9) +13*a(n-10) -3*a(n-11) -4*a(n-12) for n>15\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 11\,a(n-3) + 11\,a(n-4) - a(n-5) - 20\,a(n-6) - \\ 27\,a(n-7) - 5\,a(n-8) + 20\,a(n-9) + 13\,a(n-10) - 3\,a(n-11) - 4\,a(n-12). \end{multline*}
...
\begin{theorem} For A207962, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 11\,a(n-3) + 11\,a(n-4) - a(n-5) - 20\,a(n-6) - 27\,a(n-7) - 5\,a(n-8) + 20\,a(n-9) + 13\,a(n-10) - 3\,a(n-11) - 4\,a(n-12)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,59$. The last nonvanishing one is at $m = 3$, that is at $n = 15$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 297, 989, 3080, 9994, 32358, 104176,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207962}{A207962}, revision 9, last modified Oct 03 2025.
