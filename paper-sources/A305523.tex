...
\title{Proofs of the conjectured column and row recurrences for OEIS A305523}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305523}{A305523} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}
...
k=3: a(n) = 6*a(n-1) +8*a(n-2) -10*a(n-3) -44*a(n-4) -30*a(n-5) for n>6;\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jun 04 2018). As of revision 6, last modified Sep 05 2025, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 3$ of A305523, the recurrence $a(n) = 6\,a(n-1) + 8\,a(n-2) - 10\,a(n-3) - 44\,a(n-4) - 30\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305523}{A305523}, revision 6, last modified Sep 05 2025.
