...
\title{A proof of the conjectured linear recurrence for OEIS A208004}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208004}{A208004} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 9*a(n-1) -10*a(n-2) -106*a(n-3) +272*a(n-4) +170*a(n-5) -936*a(n-6) +306*a(n-7) +898*a(n-8) -558*a(n-9) -224*a(n-10) +190*a(n-11) +a(n-12) -11*a(n-13) for n>14\end{quote}
...
\begin{multline*} a(n) = 9\,a(n-1) - 10\,a(n-2) - 106\,a(n-3) + 272\,a(n-4) + 170\,a(n-5) - 936\,a(n-6) + \\ 306\,a(n-7) + 898\,a(n-8) - 558\,a(n-9) - 224\,a(n-10) + 190\,a(n-11) + a(n-12) - \\ 11\,a(n-13). \end{multline*}
...
\begin{theorem} For A208004, the recurrence $a(n) = 9\,a(n-1) - 10\,a(n-2) - 106\,a(n-3) + 272\,a(n-4) + 170\,a(n-5) - 936\,a(n-6) + 306\,a(n-7) + 898\,a(n-8) - 558\,a(n-9) - 224\,a(n-10) + 190\,a(n-11) + a(n-12) - 11\,a(n-13)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,55$. The last nonvanishing one is at $m = 1$, that is at $n = 14$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 618, 1711, 7016, 24512, 106503, 411848,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208004}{A208004}, revision 9, last modified Oct 03 2025.
