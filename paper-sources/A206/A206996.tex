...
\title{A proof of the conjectured linear recurrence for OEIS A206996}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A206996}{A206996} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 1 0 horizontally and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -18*a(n-2) -96*a(n-3) +314*a(n-4) +205*a(n-5) -1435*a(n-6) +363*a(n-7) +2647*a(n-8) -1601*a(n-9) -2021*a(n-10) +1517*a(n-11) +728*a(n-12) -593*a(n-13) -121*a(n-14) +101*a(n-15) +7*a(n-16) -6*a(n-17)\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 18\,a(n-2) - 96\,a(n-3) + 314\,a(n-4) + 205\,a(n-5) - 1435\,a(n-6) + \\ 363\,a(n-7) + 2647\,a(n-8) - 1601\,a(n-9) - 2021\,a(n-10) + 1517\,a(n-11) + 728\,a(n-12) - \\ 593\,a(n-13) - 121\,a(n-14) + 101\,a(n-15) + 7\,a(n-16) - 6\,a(n-17). \end{multline*}
...
\begin{theorem} For A206996, the recurrence $a(n) = 10\,a(n-1) - 18\,a(n-2) - 96\,a(n-3) + 314\,a(n-4) + 205\,a(n-5) - 1435\,a(n-6) + 363\,a(n-7) + 2647\,a(n-8) - 1601\,a(n-9) - 2021\,a(n-10) + 1517\,a(n-11) + 728\,a(n-12) - 593\,a(n-13) - 121\,a(n-14) + 101\,a(n-15) + 7\,a(n-16) - 6\,a(n-17)$ holds for every $n \ge 18$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 1011, 6612, 38144, 211471, 1124120, 5856490,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A206996}{A206996}, revision 9, last modified Oct 03 2025.
