...
\title{A proof of the conjectured linear recurrence for OEIS A301837}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301837}{A301837} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) -46*a(n-2) +72*a(n-3) -57*a(n-4) +16*a(n-5) for n>6\end{quote}
...
\[a(n) = 13\,a(n-1) - 46\,a(n-2) + 72\,a(n-3) - 57\,a(n-4) + 16\,a(n-5).\]
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $170$; neither removal changes any count.
...
\begin{theorem} For A301837, the recurrence $a(n) = 13\,a(n-1) - 46\,a(n-2) + 72\,a(n-3) - 57\,a(n-4) + 16\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 81, 678, 5748, 48802, 414385, 3518619, 29877293,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301837}{A301837}, revision 4, last modified Mar 27 2018.
