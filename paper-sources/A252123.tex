...
\title{A proof of the conjectured linear recurrence for OEIS A252123}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252123}{A252123} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 3 4 6 or 7\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 25*a(n-3) -221*a(n-6) +784*a(n-9) -755*a(n-12) -683*a(n-15) +977*a(n-18) -126*a(n-21) for n>26\end{quote}
...
\begin{multline*} a(n) = 25\,a(n-3) - 221\,a(n-6) + 784\,a(n-9) - 755\,a(n-12) - 683\,a(n-15) + 977\,a(n-18) - \\ 126\,a(n-21). \end{multline*}
...
Every row and column sum of every $3\times3$ subblock must avoid $\{0, 3, 4, 6, 7\}$.

Every diagonal and antidiagonal sum of every $3\times3$ subblock must lie in $\{0, 3, 4, 6, 7\}$.
...
That refinement leaves $76$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 47$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A252123, the recurrence $a(n) = 25\,a(n-3) - 221\,a(n-6) + 784\,a(n-9) - 755\,a(n-12) - 683\,a(n-15) + 977\,a(n-18) - 126\,a(n-21)$ holds for every $n > 26$, and fails at $n = 26$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,100$. The last nonvanishing one is at $m = 5$, that is at $n = 26$. After it, more than $S = 47$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 380, 634, 1214, 2149, 4671, 9640, 17053, 37562,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252123}{A252123}, revision 6, last modified Jun 02 2025.
