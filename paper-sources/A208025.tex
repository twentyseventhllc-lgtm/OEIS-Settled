...
\title{A proof of the conjectured linear recurrence for OEIS A208025}
...
\begin{theorem} For A208025, the recurrence of order $36$ displayed in Section 1 holds for every $n > 37$, and fails at $n = 37$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,100$. The last nonvanishing one is at $m = 1$, that is at $n = 37$. After it, more than $S = 38$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 256, 1260, 5895, 26845, 123709, 574560, 2652823,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208025}{A208025}, revision 9, last modified Oct 03 2025.
