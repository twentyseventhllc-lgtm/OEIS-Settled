...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207689}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207689}{A207689} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + a(n-2) + 3*a(n-3) + a(n-4) - a(n-5) - a(n-6) for n>8.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(9 + 72*x + 10*x\textasciicircum{}2 + 48*x\textasciicircum{}3 - 32*x\textasciicircum{}4 - 48*x\textasciicircum{}5 - 10*x\textasciicircum{}6 + 17*x\textasciicircum{}7) / ((1 + x\textasciicircum{}2 - x\textasciicircum{}3)*(1 - x - 2*x\textasciicircum{}2 - x\textasciicircum{}3)). - Colin Barker, Jun 25 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 72x^{2} + 10x^{3} + 48x^{4} - 32x^{5} - 48x^{6} - 10x^{7} + 17x^{8}}{1 - x - x^{2} - 3x^{3} - x^{4} + x^{5} + x^{6}}.\]
...
\begin{theorem} For A207689, the recurrence $a(n) = a(n-1) + a(n-2) + 3\,a(n-3) + a(n-4) - a(n-5) - a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}
...
\begin{theorem} For A207689, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 72x^{2} + 10x^{3} + 48x^{4} - 32x^{5} - 48x^{6} - 10x^{7} + 17x^{8}}{1 - x - x^{2} - 3x^{3} - x^{4} + x^{5} + x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 100, 256, 576, 1156, 2500, 5476,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207689}{A207689}, revision 9, last modified Jun 25 2018.
