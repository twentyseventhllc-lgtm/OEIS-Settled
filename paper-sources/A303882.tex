...
\title{A proof of the conjectured linear recurrence for OEIS A303882}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303882}{A303882} as

\begin{quote}\itshape Number of n X 2 0..1 arrays with every element unequal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A303882, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) - 6\,a(n-4) - 4\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 4, 8, 24, 82, 272, 908, 3076,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303882}{A303882}, revision 6, last modified Dec 29 2023.
