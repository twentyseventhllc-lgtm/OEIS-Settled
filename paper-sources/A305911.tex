...
\title{Proofs of the conjectured column and row recurrences for OEIS A305911}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305911}{A305911} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=2: a(n) = 2*a(n-1) +2*a(n-2) +6*a(n-3) -10*a(n-4) -8*a(n-5) for n > 6;\\k=4: [order 69] for n > 70.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jun 14 2018). As of revision 6, last modified Apr 26 2021, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 2$ of A305911, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-2) + 6\,a(n-3) - 10\,a(n-4) - 8\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A305911, the recurrence $a(n) = 0$ holds for every $n > 70$, and fails at $n = 70$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305911}{A305911}, revision 6, last modified Apr 26 2021.
