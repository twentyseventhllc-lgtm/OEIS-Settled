...
\title{A proof of the conjectured linear recurrence for OEIS A207909}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207909}{A207909} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +15*a(n-3) +67*a(n-4) -103*a(n-5) -69*a(n-6) -157*a(n-7) -735*a(n-8) +867*a(n-9) +665*a(n-10) +273*a(n-11) +2309*a(n-12) -2157*a(n-13) -1104*a(n-14) -82*a(n-15) -2401*a(n-16) +1858*a(n-17) +342*a(n-18) +28*a(n-19) +644*a(n-20) -456*a(n-21) -32*a(n-22) -48*a(n-24) +32*a(n-25)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 15\,a(n-3) + 67\,a(n-4) - 103\,a(n-5) - 69\,a(n-6) - 157\,a(n-7) - \\ 735\,a(n-8) + 867\,a(n-9) + 665\,a(n-10) + 273\,a(n-11) + 2309\,a(n-12) - 2157\,a(n-13) - \\ 1104\,a(n-14) - 82\,a(n-15) - 2401\,a(n-16) + 1858\,a(n-17) + 342\,a(n-18) + 28\,a(n-19) + \\ 644\,a(n-20) - 456\,a(n-21) - 32\,a(n-22) - 48\,a(n-24) + 32\,a(n-25). \end{multline*}
...
\begin{theorem} For A207909, the recurrence of order $25$ displayed in Section 1 holds for every $n \ge 26$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 261, 841, 4089, 19881, 80511, 326041,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207909}{A207909}, revision 9, last modified Oct 03 2025.
