...
\title{A proof of the conjectured linear recurrence for OEIS A317729}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317729}{A317729} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) +42*a(n-2) +107*a(n-3) -30*a(n-4) +12*a(n-5) -16*a(n-6).\end{quote}
...
\begin{theorem} For A317729, the recurrence $a(n) = 12\,a(n-1) + 42\,a(n-2) + 107\,a(n-3) - 30\,a(n-4) + 12\,a(n-5) - 16\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 98, 1250, 19208, 293378, 4458098, 67837952, 1032124178,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317729}{A317729}, revision 6, last modified May 16 2023.
