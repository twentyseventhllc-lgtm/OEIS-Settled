...
\title{A proof of the conjectured linear recurrence for OEIS A275562}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A275562}{A275562} as

\begin{quote}\itshape Number of n X 5 0..2 arrays with no element equal to any value at offset (-2,0) (-1,2) or (0,-2) and new values introduced in order 0..2\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +22*a(n-2) +8*a(n-3) -191*a(n-4) -156*a(n-5) +917*a(n-6) +837*a(n-7) -2936*a(n-8) -2248*a(n-9) +6832*a(n-10) +3015*a(n-11) -11514*a(n-12) -1236*a(n-13) +14699*a(n-14) -2370*a(n-15) -15138*a(n-16) +4822*a(n-17) +12804*a(n-18) -4364*a(n-19) -8775*a(n-20) +2339*a(n-21) +4703*a(n-22) -715*a(n-23) -1892*a(n-24) +91*a(n-25) +563*a(n-26) +8*a(n-27) -120*a(n-28) -3*a(n-29) +16*a(n-30) -a(n-32) for n>34.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Aug 01 2016).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Sep 09 2025, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = a(n-1) + 22\,a(n-2) + 8\,a(n-3) - 191\,a(n-4) - 156\,a(n-5) + 917\,a(n-6) + \\ 837\,a(n-7) - 2936\,a(n-8) - 2248\,a(n-9) + 6832\,a(n-10) + 3015\,a(n-11) - 11514\,a(n-12) - \\ 1236\,a(n-13) + 14699\,a(n-14) - 2370\,a(n-15) - 15138\,a(n-16) + 4822\,a(n-17) + 12804\,a(n-18) - \\ 4364\,a(n-19) - 8775\,a(n-20) + 2339\,a(n-21) + 4703\,a(n-22) - 715\,a(n-23) - 1892\,a(n-24) + \\ 91\,a(n-25) + 563\,a(n-26) + 8\,a(n-27) - 120\,a(n-28) - 3\,a(n-29) + 16\,a(n-30) - \\ a(n-32). \end{multline*}
...
The reachable part of the digraph has $1261$ states, $1261$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 35$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of the resulting $35\times35$ matrix. That bound is computed, not assumed.
...
\begin{theorem} For A275562, the recurrence of order $32$ displayed in Section 1 holds for every $n > 34$, and fails at $n = 34$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 288, 672, 3192, 13104, 57600, 248520, 1075140,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A275562}{A275562}, revision 9, last modified Sep 09 2025.
