...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A207089}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207089}{A207089} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays avoiding 0 0 0 horizontally and 0 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 11*a(n-2) + 48*a(n-3) + 29*a(n-4) + 6*a(n-5) - 111*a(n-6) - 8*a(n-7) - 32*a(n-8) + 64*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(7 + 35*x + 66*x\textasciicircum{}2 + 36*x\textasciicircum{}3 - 77*x\textasciicircum{}4 - 119*x\textasciicircum{}5 - 40*x\textasciicircum{}6 + 32*x\textasciicircum{}7 + 64*x\textasciicircum{}8) / (1 - 2*x - 11*x\textasciicircum{}2 - 48*x\textasciicircum{}3 - 29*x\textasciicircum{}4 - 6*x\textasciicircum{}5 + 111*x\textasciicircum{}6 + 8*x\textasciicircum{}7 + 32*x\textasciicircum{}8 - 64*x\textasciicircum{}9). - Colin Barker, Mar 04 2018\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 11\,a(n-2) + 48\,a(n-3) + 29\,a(n-4) + 6\,a(n-5) - 111\,a(n-6) - \\ 8\,a(n-7) - 32\,a(n-8) + 64\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{7x + 35x^{2} + 66x^{3} + 36x^{4} - 77x^{5} - 119x^{6} - 40x^{7} + 32x^{8} + 64x^{9}}{1 - 2x - 11x^{2} - 48x^{3} - 29x^{4} - 6x^{5} + 111x^{6} + 8x^{7} + 32x^{8} - 64x^{9}}.\]
...
\begin{theorem} For A207089, the recurrence $a(n) = 2\,a(n-1) + 11\,a(n-2) + 48\,a(n-3) + 29\,a(n-4) + 6\,a(n-5) - 111\,a(n-6) - 8\,a(n-7) - 32\,a(n-8) + 64\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,48$. Every one of them vanished. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A207089, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{7x + 35x^{2} + 66x^{3} + 36x^{4} - 77x^{5} - 119x^{6} - 40x^{7} + 32x^{8} + 64x^{9}}{1 - 2x - 11x^{2} - 48x^{3} - 29x^{4} - 6x^{5} + 111x^{6} + 8x^{7} + 32x^{8} - 64x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 241, 1393, 7915, 44065, 248525, 1398065,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207089}{A207089}, revision 8, last modified Mar 04 2018.
