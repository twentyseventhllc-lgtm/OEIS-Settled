...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A235303}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A235303}{A235303} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) + 13*a(n-2) - 39*a(n-3) - 40*a(n-4) + 120*a(n-5).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(35 - 511*x\textasciicircum{}2 + 1800*x\textasciicircum{}4) / ((1 - 3*x)*(1 - 5*x\textasciicircum{}2)*(1 - 8*x\textasciicircum{}2)). - Colin Barker, Oct 18 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{70x - 1022x^{3} + 3600x^{5}}{1 - 3x - 13x^{2} + 39x^{3} + 40x^{4} - 120x^{5}}.\]
...
\begin{theorem} For A235303, the recurrence $a(n) = 3\,a(n-1) + 13\,a(n-2) - 39\,a(n-3) - 40\,a(n-4) + 120\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A235303, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{70x - 1022x^{3} + 3600x^{5}}{1 - 3x - 13x^{2} + 39x^{3} + 40x^{4} - 120x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 70, 210, 518, 1554, 4006, 12018, 32006, 96018,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A235303}{A235303}, revision 10, last modified Jun 18 2022.
