...
\title{A proof of the conjectured linear recurrence for OEIS A250730}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250730}{A250730} as

\begin{quote}\itshape Number of (1+1)X(n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction\end{quote}
...
\begin{theorem} For A250730, the recurrence $a(n) = 3\,a(n-1) - a(n-2) - 2\,a(n-3) + a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 22, 50, 114, 257, 579, 1302, 2927,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250730}{A250730}, revision 8, last modified Jul 23 2025.
