...
\title{A proof of the conjectured linear recurrence for OEIS A302279}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302279}{A302279} as

\begin{quote}\itshape Number of 2 X n 0..1 arrays with every element equal to 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A302279, the recurrence $a(n) = a(n-1) + 3\,a(n-2) - 4\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 3, 7, 10, 27, 45, 98, 193,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302279}{A302279}, revision 7, last modified Apr 05 2018.
