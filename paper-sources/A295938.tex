...
\title{A proof of the conjectured linear recurrence for OEIS A295938}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295938}{A295938} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 adjacent to 1 or 3 king-move neighboring 1's\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 3*a(n-2) + 18*a(n-3) + a(n-4) - 19*a(n-5) - 36*a(n-6) - 13*a(n-7) + 5*a(n-8) + 10*a(n-9).\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 3\,a(n-2) + 18\,a(n-3) + a(n-4) - 19\,a(n-5) - 36\,a(n-6) - \\ 13\,a(n-7) + 5\,a(n-8) + 10\,a(n-9). \end{multline*}
...
\begin{theorem} For A295938, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 18\,a(n-3) + a(n-4) - 19\,a(n-5) - 36\,a(n-6) - 13\,a(n-7) + 5\,a(n-8) + 10\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 15, 41, 120, 465, 1472, 4667, 16230,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295938}{A295938}, revision 11, last modified Dec 01 2017.
