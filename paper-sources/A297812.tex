...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,146$. The last nonvanishing one is at $m = 9$, that is at $n = 49$. After it, more than $S = 70$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
