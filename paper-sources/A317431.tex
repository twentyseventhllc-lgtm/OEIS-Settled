...
\title{A proof of the conjectured linear recurrence for OEIS A317431}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317431}{A317431} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +5*a(n-2) +10*a(n-3) -29*a(n-4) -69*a(n-5) -36*a(n-6) +68*a(n-7) +201*a(n-8) +115*a(n-9) +35*a(n-10) -218*a(n-11) -192*a(n-12) -83*a(n-13) +2*a(n-14) +113*a(n-15) +61*a(n-16) +18*a(n-17) +4*a(n-18) -10*a(n-19) -4*a(n-20) for n>21\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 5\,a(n-2) + 10\,a(n-3) - 29\,a(n-4) - 69\,a(n-5) - 36\,a(n-6) + \\ 68\,a(n-7) + 201\,a(n-8) + 115\,a(n-9) + 35\,a(n-10) - 218\,a(n-11) - 192\,a(n-12) - \\ 83\,a(n-13) + 2\,a(n-14) + 113\,a(n-15) + 61\,a(n-16) + 18\,a(n-17) + 4\,a(n-18) - \\ 10\,a(n-19) - 4\,a(n-20). \end{multline*}
...
\begin{theorem} For A317431, the recurrence of order $20$ displayed in Section 1 holds for every $n > 21$, and fails at $n = 21$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 16, 61, 201, 863, 3666, 14831, 61638,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317431}{A317431}, revision 4, last modified Jul 27 2018.
