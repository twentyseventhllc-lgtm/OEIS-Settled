...
\title{A proof of the conjectured linear recurrence for OEIS A304137}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304137}{A304137} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +2*a(n-3) -6*a(n-4) +3*a(n-6) for n>10\end{quote}
...
\begin{theorem} For A304137, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-3) - 6\,a(n-4) + 3\,a(n-6)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 37 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 13, 9, 11, 20, 17, 25, 62,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304137}{A304137}, revision 4, last modified May 07 2018.
