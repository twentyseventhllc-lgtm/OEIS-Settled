...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,130$. The last nonvanishing one is at $m = 8$, that is at $n = 41$. After it, more than $S = 55$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
