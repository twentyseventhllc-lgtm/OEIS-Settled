...
\title{A proof of the conjectured linear recurrence for OEIS A304004}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304004}{A304004} as

\begin{quote}\itshape Number of n X 2 0..1 arrays with every element unequal to 0, 2, 3 or 5 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A304004, the recurrence $a(n) = a(n-1) + 3\,a(n-2) - 4\,a(n-4)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 4, 7, 13, 26, 49, 99, 194,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304004}{A304004}, revision 6, last modified Apr 26 2021.
