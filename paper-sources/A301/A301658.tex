...
\title{A proof of the conjectured linear recurrence for OEIS A301658}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301658}{A301658} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1 or 4 horizontally or vertically adjacent elements, with upper left element zero\end{quote}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $25$; neither removal changes any count.
...
\begin{theorem} For A301658, the recurrence $a(n) = 2\,a(n-1) + a(n-2) - a(n-3) - 2\,a(n-4) + a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 6, 9, 13, 24, 45, 89, 182,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301658}{A301658}, revision 4, last modified Mar 25 2018.
