...
\title{A proof of the conjectured linear recurrence for OEIS A301885}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301885}{A301885} as

\begin{quote}\itshape Number of 2Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-3) -a(n-4) -2*a(n-6) +a(n-7)\end{quote}
...
\begin{theorem} For A301885, the recurrence $a(n) = 2\,a(n-1) + a(n-3) - a(n-4) - 2\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 5, 10, 18, 35, 74, 154, 317,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301885}{A301885}, revision 4, last modified Mar 28 2018.
