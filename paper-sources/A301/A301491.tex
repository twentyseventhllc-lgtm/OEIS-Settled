...
\title{Proofs of the conjectured column and row recurrences for OEIS A301491}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301491}{A301491} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
k=4: [order 89] for n>91.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Mar 22 2018). As of revision 6, last modified Apr 17 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 4$ of A301491, the recurrence $a(n) = 0$ holds for every $n > 91$, and fails at $n = 91$.\end{theorem}

{\itshape Proof.} The width is $4$; the digraph has $272$ states, $262$ after trimming, and $S = 96$ blocks after refinement. The model reproduces every published value of column $k = 4$ --- and of the rest of the triangle. The residuals were computed exactly and the last nonvanishing one is at $n = 91$; after that point more than $S = 96$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301491}{A301491}, revision 6, last modified Apr 17 2022.
