...
\title{A proof of the conjectured linear recurrence for OEIS A301659}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301659}{A301659} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 1 or 4 horizontally or vertically adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) +a(n-3) -4*a(n-4) -4*a(n-6) +3*a(n-7) +3*a(n-8) +a(n-9) +a(n-10) -2*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) + a(n-3) - 4\,a(n-4) - 4\,a(n-6) + 3\,a(n-7) + \\ 3\,a(n-8) + a(n-9) + a(n-10) - 2\,a(n-11). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $50$; neither removal changes any count.
...
\begin{theorem} For A301659, the recurrence $a(n) = 3\,a(n-1) - a(n-2) + a(n-3) - 4\,a(n-4) - 4\,a(n-6) + 3\,a(n-7) + 3\,a(n-8) + a(n-9) + a(n-10) - 2\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 9, 15, 24, 46, 99, 223, 528,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301659}{A301659}, revision 4, last modified Mar 25 2018.
