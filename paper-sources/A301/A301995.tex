...
\title{A proof of the conjectured linear recurrence for OEIS A301995}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301995}{A301995} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -4*a(n-2) +a(n-3)\end{quote}
...
\begin{theorem} For A301995, the recurrence $a(n) = 4\,a(n-1) - 4\,a(n-2) + a(n-3)$ holds for every $n \ge 4$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 8, 26, 74, 200, 530, 1394, 3656,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301995}{A301995}, revision 4, last modified Mar 30 2018.
