...
\title{A proof of the conjectured linear recurrence for OEIS A301657}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301657}{A301657} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1 or 4 horizontally or vertically adjacent elements, with upper left element zero\end{quote}
...
The construction gives $72$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $15$; neither removal changes any count.
...
\begin{theorem} For A301657, the recurrence $a(n) = 2\,a(n-1) - a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 34 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 4, 6, 9, 15, 26, 46, 83,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301657}{A301657}, revision 4, last modified Mar 25 2018.
