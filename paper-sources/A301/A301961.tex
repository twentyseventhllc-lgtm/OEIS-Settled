...
\title{A proof of the conjectured linear recurrence for OEIS A301961}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301961}{A301961} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) -a(n-3) -2*a(n-4) -3*a(n-5) +2*a(n-6) for n>8\end{quote}
...
\begin{theorem} For A301961, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - a(n-3) - 2\,a(n-4) - 3\,a(n-5) + 2\,a(n-6)$ holds for every $n > 8$, and fails at $n = 8$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,48$. The last nonvanishing one is at $m = 2$, that is at $n = 8$. After it, more than $S = 10$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 14, 41, 111, 311, 874, 2454, 6906,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301961}{A301961}, revision 4, last modified Mar 29 2018.
