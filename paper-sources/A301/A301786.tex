...
\title{A proof of the conjectured linear recurrence for OEIS A301786}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301786}{A301786} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) -a(n-4)\end{quote}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $23$; neither removal changes any count.
...
\begin{theorem} For A301786, the recurrence $a(n) = a(n-1) + 2\,a(n-2) - a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 9, 17, 32, 61, 116, 221, 421,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301786}{A301786}, revision 4, last modified Mar 26 2018.
