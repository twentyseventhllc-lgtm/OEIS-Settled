...
\title{Proofs of the conjectured column and row recurrences for OEIS A262795}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A262795}{A262795} as

\begin{quote}\itshape T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each row divisible by 5 and column not divisible by 5, read as a binary number with top and left being the most significant bits\end{quote}
...
k=1: a(n) = a(n-1)\\k=2: [order 8]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Oct 02 2015). As of revision 4, last modified Oct 02 2015, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} In A262795, column $k = 1$ is identically zero, and the claimed recurrence therefore holds at every index.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A262795, the recurrence $a(n) = 0$ holds for every $n \ge 9$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A262795}{A262795}, revision 4, last modified Oct 02 2015.
