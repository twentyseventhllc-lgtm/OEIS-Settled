...
\title{A proof of the conjectured linear recurrence for OEIS A262335}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A262335}{A262335} as

\begin{quote}\itshape Number of (n+3)X(3+3) 0..1 arrays with each row and column divisible by 9, read as a binary number with top and left being the most significant bits\end{quote}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 64, 512, 3375, 24389, 185193, 1481544, 11852352,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A262335}{A262335}, revision 4, last modified Sep 18 2015.
