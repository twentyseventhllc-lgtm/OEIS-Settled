...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A262268}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A262268}{A262268} as

\begin{quote}\itshape Number of (n+2) X (2+2) 0..1 arrays with each row and column divisible by 5, read as a binary number with top and left being the most significant bits\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(4 - 8*x + x\textasciicircum{}2 - 29*x\textasciicircum{}3 - 10*x\textasciicircum{}4 + 20*x\textasciicircum{}5 + 8*x\textasciicircum{}6 + 32*x\textasciicircum{}7) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 - 4*x)*(1 + x\textasciicircum{}2)*(1 + 4*x\textasciicircum{}2)). - Colin Barker, Dec 31 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{4x - 8x^{2} + x^{3} - 29x^{4} - 10x^{5} + 20x^{6} + 8x^{7} + 32x^{8}}{1 - 6x + 12x^{2} - 24x^{3} + 31x^{4} + 6x^{5} - 12x^{6} + 24x^{7} - 32x^{8}}.\]
...
\begin{theorem} For A262268, the recurrence $a(n) = 6\,a(n-1) - 12\,a(n-2) + 24\,a(n-3) - 31\,a(n-4) - 6\,a(n-5) + 12\,a(n-6) - 24\,a(n-7) + 32\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A262268, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{4x - 8x^{2} + x^{3} - 29x^{4} - 10x^{5} + 20x^{6} + 8x^{7} + 32x^{8}}{1 - 6x + 12x^{2} - 24x^{3} + 31x^{4} + 6x^{5} - 12x^{6} + 24x^{7} - 32x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 16, 49, 169, 676, 2704, 10609, 42025,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A262268}{A262268}, revision 7, last modified Dec 31 2018.
