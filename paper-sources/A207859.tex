...
\title{A proof of the conjectured linear recurrence for OEIS A207859}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207859}{A207859} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +30*a(n-3) +161*a(n-4) +45*a(n-5) +166*a(n-6) -749*a(n-7) -4860*a(n-8) -1352*a(n-9) +3048*a(n-10) +4635*a(n-11) +28540*a(n-12) +11318*a(n-13) -11422*a(n-14) -4202*a(n-15) -69991*a(n-16) -28677*a(n-17) +609*a(n-18) -20891*a(n-19) +65400*a(n-20) +5094*a(n-21) +7969*a(n-22) +10090*a(n-23) -24802*a(n-24) +1479*a(n-25) -2070*a(n-26) -1380*a(n-27) +3917*a(n-28) -350*a(n-29) -75*a(n-30) +41*a(n-31) -140*a(n-32) +16*a(n-33) +a(n-35) +a(n-36)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 30\,a(n-3) + 161\,a(n-4) + 45\,a(n-5) + 166\,a(n-6) - 749\,a(n-7) - \\ 4860\,a(n-8) - 1352\,a(n-9) + 3048\,a(n-10) + 4635\,a(n-11) + 28540\,a(n-12) + 11318\,a(n-13) - \\ 11422\,a(n-14) - 4202\,a(n-15) - 69991\,a(n-16) - 28677\,a(n-17) + 609\,a(n-18) - 20891\,a(n-19) + \\ 65400\,a(n-20) + 5094\,a(n-21) + 7969\,a(n-22) + 10090\,a(n-23) - 24802\,a(n-24) + 1479\,a(n-25) - \\ 2070\,a(n-26) - 1380\,a(n-27) + 3917\,a(n-28) - 350\,a(n-29) - 75\,a(n-30) + 41\,a(n-31) - \\ 140\,a(n-32) + 16\,a(n-33) + a(n-35) + a(n-36). \end{multline*}
...
\begin{theorem} For A207859, the recurrence of order $36$ displayed in Section 1 holds for every $n \ge 37$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,112$. Every one of them vanished. After it, more than $S = 49$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 370, 1369, 7289, 38809, 178088, 817216,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207859}{A207859}, revision 9, last modified Oct 03 2025.
