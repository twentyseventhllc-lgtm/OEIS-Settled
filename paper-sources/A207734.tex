...
\title{A proof of the conjectured linear recurrence for OEIS A207734}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207734}{A207734} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +48*a(n-3) +1512*a(n-4) +180*a(n-5) +612*a(n-6) -15840*a(n-7) -496179*a(n-8) -159489*a(n-9) +110160*a(n-10) +986580*a(n-11) +48988800*a(n-12) +17204400*a(n-13) +52488000*a(n-15) -1049760000*a(n-16)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 48\,a(n-3) + 1512\,a(n-4) + 180\,a(n-5) + 612\,a(n-6) - 15840\,a(n-7) - \\ 496179\,a(n-8) - 159489\,a(n-9) + 110160\,a(n-10) + 986580\,a(n-11) + 48988800\,a(n-12) + 17204400\,a(n-13) + \\ 52488000\,a(n-15) - 1049760000\,a(n-16). \end{multline*}
...
\begin{theorem} For A207734, the recurrence $a(n) = a(n-1) + 48\,a(n-3) + 1512\,a(n-4) + 180\,a(n-5) + 612\,a(n-6) - 15840\,a(n-7) - 496179\,a(n-8) - 159489\,a(n-9) + 110160\,a(n-10) + 986580\,a(n-11) + 48988800\,a(n-12) + 17204400\,a(n-13) + 52488000\,a(n-15) - 1049760000\,a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 31, 961, 2449, 6241, 88243, 1247689, 4799749, 18464209,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207734}{A207734}, revision 9, last modified Oct 03 2025.
