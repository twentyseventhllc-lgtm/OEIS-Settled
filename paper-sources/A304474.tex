...
\title{A proof of the conjectured linear recurrence for OEIS A304474}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304474}{A304474} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) +6*a(n-3) +8*a(n-4) +5*a(n-5) -6*a(n-6) -22*a(n-7) -25*a(n-8) -14*a(n-9) +2*a(n-10) +7*a(n-11) +3*a(n-12) for n>13\end{quote}
...
\begin{multline*} a(n) = a(n-2) + 6\,a(n-3) + 8\,a(n-4) + 5\,a(n-5) - 6\,a(n-6) - 22\,a(n-7) - \\ 25\,a(n-8) - 14\,a(n-9) + 2\,a(n-10) + 7\,a(n-11) + 3\,a(n-12). \end{multline*}
...
\begin{theorem} For A304474, the recurrence $a(n) = a(n-2) + 6\,a(n-3) + 8\,a(n-4) + 5\,a(n-5) - 6\,a(n-6) - 22\,a(n-7) - 25\,a(n-8) - 14\,a(n-9) + 2\,a(n-10) + 7\,a(n-11) + 3\,a(n-12)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 19, 37, 94, 202, 428, 965,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304474}{A304474}, revision 4, last modified May 13 2018.
