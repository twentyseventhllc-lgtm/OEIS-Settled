...
\title{Proofs of the conjectured column and row recurrences for OEIS A301669}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301669}{A301669} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 1, 2 or 4 horizontally or vertically adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = a(n-1) +a(n-2)\\k=2: a(n) = 2*a(n-1) +a(n-2) +2*a(n-3) -a(n-4)\\k=3: [order 20]\\k=4: [order 70]\end{quote}
...
\begin{theorem} For column $k = 1$ of A301669, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A301669, the recurrence $a(n) = 2\,a(n-1) + a(n-2) + 2\,a(n-3) - a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A301669, the recurrence $a(n) = 0$ holds for every $n \ge 21$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A301669, the recurrence $a(n) = 0$ holds for every $n \ge 71$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301669}{A301669}, revision 4, last modified Mar 25 2018.
