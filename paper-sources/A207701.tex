...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207701}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207701}{A207701} as

\begin{quote}\itshape Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}
...
\begin{quote}\ttfamily G.f.: x*(25 + 450*x + 119*x\textasciicircum{}2 - 404*x\textasciicircum{}3 + 127*x\textasciicircum{}4 + 2*x\textasciicircum{}5 + x\textasciicircum{}6) / (1 - x)\textasciicircum{}7.\end{quote}

\begin{quote}\ttfamily a(n) = (-3 + n + 15*n\textasciicircum{}2 + 2*n\textasciicircum{}3)\textasciicircum{}2 / 9.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 19 2012).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Jun 25 2018, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{25x + 450x^{2} + 119x^{3} - 404x^{4} + 127x^{5} + 2x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]

Written out, the claim is

\[a(n) = 1 - \frac{2}{3}n - \frac{89}{9}n^{2} + 2n^{3} + \frac{229}{9}n^{4} + \frac{20}{3}n^{5} + \frac{4}{9}n^{6}.\]
...
\begin{theorem} For A207701, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A207701, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{25x + 450x^{2} + 119x^{3} - 404x^{4} + 127x^{5} + 2x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A207701, $a(n)$ is the polynomial $1 - \frac{2}{3}n - \frac{89}{9}n^{2} + 2n^{3} + \frac{229}{9}n^{4} + \frac{20}{3}n^{5} + \frac{4}{9}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 25, 625, 3969, 15129, 43681, 105625, 225625, 439569,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207701}{A207701}, revision 9, last modified Jun 25 2018.
