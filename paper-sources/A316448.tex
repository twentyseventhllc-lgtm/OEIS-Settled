...
\title{Proofs of the conjectured column and row recurrences for OEIS A316448}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316448}{A316448} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element unequal to 1, 2, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 03 2018). As of revision 4, last modified Jul 03 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A316448, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A316448, the recurrence $a(n) = 2\,a(n-1) + 5\,a(n-2) - 2\,a(n-3) - 12\,a(n-4) - 8\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A316448, the recurrence $a(n) = 0$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A316448, the recurrence $a(n) = 0$ holds for every $n > 71$, and fails at $n = 71$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316448}{A316448}, revision 4, last modified Jul 03 2018.
