...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A250900}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250900}{A250900} as

\begin{quote}\itshape Number of (2+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) - 40*a(n-2) + 82*a(n-3) - 91*a(n-4) + 52*a(n-5) - 12*a(n-6).\end{quote}

\begin{quote}\ttfamily G.f.: x*(125 - 819*x + 2015*x\textasciicircum{}2 - 2393*x\textasciicircum{}3 + 1392*x\textasciicircum{}4 - 324*x\textasciicircum{}5) / ((1 - x)\textasciicircum{}3*(1 - 2*x)\textasciicircum{}2*(1 - 3*x)).\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{125x - 819x^{2} + 2015x^{3} - 2393x^{4} + 1392x^{5} - 324x^{6}}{1 - 10x + 40x^{2} - 82x^{3} + 91x^{4} - 52x^{5} + 12x^{6}}.\]
...
\begin{theorem} For A250900, the recurrence $a(n) = 10\,a(n-1) - 40\,a(n-2) + 82\,a(n-3) - 91\,a(n-4) + 52\,a(n-5) - 12\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A250900, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{125x - 819x^{2} + 2015x^{3} - 2393x^{4} + 1392x^{5} - 324x^{6}}{1 - 10x + 40x^{2} - 82x^{3} + 91x^{4} - 52x^{5} + 12x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 125, 431, 1325, 3867, 11029, 31215, 88421, 251819,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250900}{A250900}, revision 8, last modified Nov 23 2018.
