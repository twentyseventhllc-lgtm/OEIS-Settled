...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208503}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208503}{A208503} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 6*a(n-2) - 3*a(n-3) for n>5.\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 13*x*(1 + 12*x - x\textasciicircum{}2 - 43*x\textasciicircum{}3 + 19*x\textasciicircum{}4) / (1 - x - 6*x\textasciicircum{}2 + 3*x\textasciicircum{}3). - Colin Barker, Jul 03 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{13x + 156x^{2} - 13x^{3} - 559x^{4} + 247x^{5}}{1 - x - 6x^{2} + 3x^{3}}.\]
...
\begin{theorem} For A208503, the recurrence $a(n) = a(n-1) + 6\,a(n-2) - 3\,a(n-3)$ holds for every $n > 5$, and fails at $n = 5$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,39$. The last nonvanishing one is at $m = 2$, that is at $n = 5$. After it, more than $S = 6$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 5$. The theorem is at least as strong.

\begin{theorem} For A208503, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{13x + 156x^{2} - 13x^{3} - 559x^{4} + 247x^{5}}{1 - x - 6x^{2} + 3x^{3}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 234, 650, 1794, 4992, 13806, 38376,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208503}{A208503}, revision 8, last modified Jul 03 2018.
