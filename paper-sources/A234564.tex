...
\title{Proofs of the conjectured column and row recurrences for OEIS A234564}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234564}{A234564} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings)\end{quote}
...
\begin{quote}\ttfamily Empirical for column k: (column 2..7 recurrence works also for k=1; apparently all rows and columns satisfy the same order 14 recurrence):\\
k=1: a(n) = 3*a(n-1) +18*a(n-2) -54*a(n-3) -80*a(n-4) +240*a(n-5).\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Dec 28 2013). As of revision 6, last modified Jun 20 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A234564, the recurrence $a(n) = 3\,a(n-1) + 18\,a(n-2) - 54\,a(n-3) - 80\,a(n-4) + 240\,a(n-5)$ holds for every $n \ge 6$, at every index at which it can be stated.\end{theorem}
...
\item 6 lines: the line is not in a form this reader accepts
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234564}{A234564}, revision 6, last modified Jun 20 2022.
