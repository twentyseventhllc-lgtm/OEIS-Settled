...
\title{A proof of the conjectured linear recurrence for OEIS A303194}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303194}{A303194} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 1, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-2) +42*a(n-3) -52*a(n-4) -36*a(n-5) -601*a(n-6) +494*a(n-7) +501*a(n-8) +3674*a(n-9) -2252*a(n-10) -3728*a(n-11) -9746*a(n-12) +7102*a(n-13) +11972*a(n-14) +9668*a(n-15) -12696*a(n-16) -18552*a(n-17) -2516*a(n-18) +14464*a(n-19) +17480*a(n-20) +2144*a(n-21) -23696*a(n-22) -4528*a(n-23) +3152*a(n-24) +13280*a(n-25) -7136*a(n-26) -768*a(n-27) +7936*a(n-28) +768*a(n-29) +384*a(n-30) -5120*a(n-31) -256*a(n-32) +2048*a(n-33) for n>37\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + a(n-2) + 42\,a(n-3) - 52\,a(n-4) - 36\,a(n-5) - 601\,a(n-6) + \\ 494\,a(n-7) + 501\,a(n-8) + 3674\,a(n-9) - 2252\,a(n-10) - 3728\,a(n-11) - 9746\,a(n-12) + \\ 7102\,a(n-13) + 11972\,a(n-14) + 9668\,a(n-15) - 12696\,a(n-16) - 18552\,a(n-17) - 2516\,a(n-18) + \\ 14464\,a(n-19) + 17480\,a(n-20) + 2144\,a(n-21) - 23696\,a(n-22) - 4528\,a(n-23) + 3152\,a(n-24) + \\ 13280\,a(n-25) - 7136\,a(n-26) - 768\,a(n-27) + 7936\,a(n-28) + 768\,a(n-29) + 384\,a(n-30) - \\ 5120\,a(n-31) - 256\,a(n-32) + 2048\,a(n-33). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $245$; neither removal changes any count.
...
That refinement leaves $51$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 41$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A303194, the recurrence of order $33$ displayed in Section 1 holds for every $n > 37$, and fails at $n = 37$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,104$. The last nonvanishing one is at $m = 4$, that is at $n = 37$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 25, 43, 97, 523, 1751, 5573, 21575,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303194}{A303194}, revision 4, last modified Apr 19 2018.
