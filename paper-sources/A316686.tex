...
\title{Proofs of the conjectured column and row recurrences for OEIS A316686}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316686}{A316686} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element unequal to 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
k=2: a(n) = 3*a(n-1) +a(n-2) +2*a(n-3) -2*a(n-4) -4*a(n-5) for n>6;\\k=4: [order 42] for n>44.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 10 2018). As of revision 6, last modified Nov 12 2022, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 2$ of A316686, the recurrence $a(n) = 3\,a(n-1) + a(n-2) + 2\,a(n-3) - 2\,a(n-4) - 4\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A316686, the recurrence $a(n) = 0$ holds for every $n > 44$, and fails at $n = 44$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316686}{A316686}, revision 6, last modified Nov 12 2022.
