...
k=2: a(n) = 3*a(n-1) +a(n-2) +2*a(n-3) -2*a(n-4) -4*a(n-5) for n>6;\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 10 2018). As of revision 6, last modified Nov 12 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
