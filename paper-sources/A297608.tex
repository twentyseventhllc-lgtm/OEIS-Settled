...
\title{A proof of the conjectured linear recurrence for OEIS A297608}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A297608}{A297608} as

\begin{quote}\itshape Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +3*a(n-2) +4*a(n-3) +12*a(n-4) -12*a(n-6)\end{quote}
...
\begin{theorem} For A297608, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 12\,a(n-4) - 12\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 11, 35, 96, 281, 829, 2428, 7059,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A297608}{A297608}, revision 4, last modified Jan 01 2018.
