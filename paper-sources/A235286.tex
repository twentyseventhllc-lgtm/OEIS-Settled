...
\title{A proof of the conjectured linear recurrence for OEIS A235286}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A235286}{A235286} as

\begin{quote}\itshape Number of (n+1) X (5+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings)\end{quote}
...
For scale: at $n = 8$ there are $4^{48}$ arrays, about $10^{29}$, against $7$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A235286, the recurrence $a(n) = 3\,a(n-1) + 3\,a(n-2) - 15\,a(n-3) + 4\,a(n-4) + 18\,a(n-5) - 12\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 236, 304, 380, 544, 740, 1168, 1724, 2944,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A235286}{A235286}, revision 7, last modified Jun 18 2022.
