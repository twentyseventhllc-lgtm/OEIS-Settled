...
\title{A proof of the conjectured linear recurrence for OEIS A303508}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303508}{A303508} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +6*a(n-2) +36*a(n-3) -58*a(n-4) -116*a(n-5) -196*a(n-6) -160*a(n-7) -36*a(n-8) -240*a(n-9) -64*a(n-10) +232*a(n-11) +184*a(n-12) -64*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 6\,a(n-2) + 36\,a(n-3) - 58\,a(n-4) - 116\,a(n-5) - 196\,a(n-6) - \\ 160\,a(n-7) - 36\,a(n-8) - 240\,a(n-9) - 64\,a(n-10) + 232\,a(n-11) + 184\,a(n-12) - \\ 64\,a(n-14). \end{multline*}
...
\begin{theorem} For A303508, the recurrence $a(n) = 3\,a(n-1) + 6\,a(n-2) + 36\,a(n-3) - 58\,a(n-4) - 116\,a(n-5) - 196\,a(n-6) - 160\,a(n-7) - 36\,a(n-8) - 240\,a(n-9) - 64\,a(n-10) + 232\,a(n-11) + 184\,a(n-12) - 64\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 78, 420, 2088, 9916, 49740, 245904,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303508}{A303508}, revision 4, last modified Apr 25 2018.
