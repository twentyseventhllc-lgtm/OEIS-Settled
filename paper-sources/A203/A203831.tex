...
\title{A proof of the conjectured linear recurrence for OEIS A203831}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A203831}{A203831} as

\begin{quote}\itshape Number of (n+1)X5 0..2 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 31*a(n-1) -24*a(n-2) -1612*a(n-3) +3816*a(n-4) +1152*a(n-5) -2784*a(n-6) +256*a(n-7)\end{quote}
...
\begin{multline*} a(n) = 31\,a(n-1) - 24\,a(n-2) - 1612\,a(n-3) + 3816\,a(n-4) + 1152\,a(n-5) - 2784\,a(n-6) + \\ 256\,a(n-7). \end{multline*}
...
The reachable part of the digraph has $5869$ states, $5869$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 8$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $8\times8$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A203831, the recurrence $a(n) = 31\,a(n-1) - 24\,a(n-2) - 1612\,a(n-3) + 3816\,a(n-4) + 1152\,a(n-5) - 2784\,a(n-6) + 256\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 14 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5625, 151659, 4238721, 119606211, 3383285769, 95763046491, 2710984443345, 76749227497395,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A203831}{A203831}, revision 9, last modified Oct 03 2025.
