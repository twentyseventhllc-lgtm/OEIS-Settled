...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A207598}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207598}{A207598} as

\begin{quote}\itshape Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 120*n\textasciicircum{}4 + 40*n\textasciicircum{}3 - 200*n\textasciicircum{}2 + 80*n.\end{quote}

\begin{quote}\ttfamily G.f.: 40*x*(1 + 35*x + 41*x\textasciicircum{}2 - 5*x\textasciicircum{}3) / (1 - x)\textasciicircum{}5.\end{quote}
...
\[a(n) = 80n - 200n^{2} + 40n^{3} + 120n^{4}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{40x + 1400x^{2} + 1640x^{3} - 200x^{4}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}.\]
...
\begin{theorem} For A207598, $a(n)$ is the polynomial $80n - 200n^{2} + 40n^{3} + 120n^{4}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A207598, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{40x + 1400x^{2} + 1640x^{3} - 200x^{4}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}$.\end{theorem}
...
\begin{theorem} For A207598, the recurrence $a(n) = 5\,a(n-1) - 10\,a(n-2) + 10\,a(n-3) - 5\,a(n-4) + a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,46$. Every one of them vanished. After it, more than $S = 8$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 40, 1600, 9240, 30400, 75400, 157440, 292600, 499840,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207598}{A207598}, revision 8, last modified Jun 25 2018.
