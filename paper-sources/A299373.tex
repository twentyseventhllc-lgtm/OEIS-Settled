...
\title{Proofs of the conjectured column and row recurrences for OEIS A299373}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299373}{A299373} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = a(n-1) +a(n-2)\\k=2: a(n) = 4*a(n-1) -2*a(n-2) +4*a(n-3) for n>4\\k=3: [order 10] for n>11\\k=4: [order 31] for n>32\end{quote}
...
\begin{theorem} For column $k = 1$ of A299373, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A299373, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) + 4\,a(n-3)$ holds for every $n > 4$, and fails at $n = 4$.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A299373, the recurrence $a(n) = 0$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A299373, the recurrence $a(n) = 0$ holds for every $n > 32$, and fails at $n = 32$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299373}{A299373}, revision 4, last modified Feb 08 2018.
