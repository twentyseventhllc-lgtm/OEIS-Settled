...
\title{A proof of the conjectured linear recurrence for OEIS A301537}
...
\begin{multline*} a(n) = 3\,a(n-1) + 2\,a(n-2) - a(n-3) + 4\,a(n-4) - 34\,a(n-5) - 75\,a(n-6) - \\ 14\,a(n-7) + 46\,a(n-8) + 323\,a(n-9) + 751\,a(n-10) + 478\,a(n-11) - 191\,a(n-12) - \\ 1729\,a(n-13) - 4244\,a(n-14) - 4352\,a(n-15) - 1713\,a(n-16) + 4203\,a(n-17) + 13644\,a(n-18) + \\ 18309\,a(n-19) + 13580\,a(n-20) - 167\,a(n-21) - 21556\,a(n-22) - 37473\,a(n-23) - 38916\,a(n-24) - \\ 23118\,a(n-25) + 7056\,a(n-26) + 36004\,a(n-27) + 52920\,a(n-28) + 52093\,a(n-29) + 29895\,a(n-30) - \\ 29895\,a(n-32) - 52093\,a(n-33) - 52920\,a(n-34) - 36004\,a(n-35) - 7056\,a(n-36) + 23118\,a(n-37) + \\ 38916\,a(n-38) + 37473\,a(n-39) + 21556\,a(n-40) + 167\,a(n-41) - 13580\,a(n-42) - 18309\,a(n-43) - \\ 13644\,a(n-44) - 4203\,a(n-45) + 1713\,a(n-46) + 4352\,a(n-47) + 4244\,a(n-48) + 1729\,a(n-49) + \\ 191\,a(n-50) - 478\,a(n-51) - 751\,a(n-52) - 323\,a(n-53) - 46\,a(n-54) + 14\,a(n-55) + \\ 75\,a(n-56) + 34\,a(n-57) - 4\,a(n-58) + a(n-59) - 2\,a(n-60) - 3\,a(n-61) + \\ a(n-62). \end{multline*}

stated without a range; it first has meaning at $n = 63$, the least index at which all of $a(n-1),\dots,a(n-62)$ are terms of the sequence.
...
\begin{theorem} For A301537, the recurrence of order $62$ displayed in Section 1 holds for every $n \ge 63$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,161$. Every one of them vanished. After it, more than $S = 67$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 10, 26, 79, 212, 603, 1841, 5663,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301537}{A301537}, revision 4, last modified Mar 23 2018.
