...
\title{A proof of the conjectured linear recurrence for OEIS A207561}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207561}{A207561} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 12*a(n-1) -18*a(n-2) -286*a(n-3) +990*a(n-4) +2420*a(n-5) -13219*a(n-6) -7318*a(n-7) +87016*a(n-8) -13474*a(n-9) -326656*a(n-10) +164320*a(n-11) +729389*a(n-12) -512204*a(n-13) -962042*a(n-14) +804466*a(n-15) +713562*a(n-16) -680852*a(n-17) -265049*a(n-18) +296838*a(n-19) +35044*a(n-20) -56802*a(n-21) +984*a(n-22) +2880*a(n-23) for n>24\end{quote}
...
\begin{multline*} a(n) = 12\,a(n-1) - 18\,a(n-2) - 286\,a(n-3) + 990\,a(n-4) + 2420\,a(n-5) - 13219\,a(n-6) - \\ 7318\,a(n-7) + 87016\,a(n-8) - 13474\,a(n-9) - 326656\,a(n-10) + 164320\,a(n-11) + 729389\,a(n-12) - \\ 512204\,a(n-13) - 962042\,a(n-14) + 804466\,a(n-15) + 713562\,a(n-16) - 680852\,a(n-17) - 265049\,a(n-18) + \\ 296838\,a(n-19) + 35044\,a(n-20) - 56802\,a(n-21) + 984\,a(n-22) + 2880\,a(n-23). \end{multline*}
...
That refinement leaves $38$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 26$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A207561, the recurrence of order $23$ displayed in Section 1 holds for every $n > 24$, and fails at $n = 24$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 720, 2234, 9568, 36426, 160652, 666212,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207561}{A207561}, revision 9, last modified Oct 03 2025.
