...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A295980}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A295980}{A295980} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 adjacent to 2 or 3 king-move neighboring 1s\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 21*a(n-3) - 44*a(n-4) - 12*a(n-5) - 34*a(n-6) + 33*a(n-7) + 4*a(n-8) + 14*a(n-9) + a(n-10).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(1 + 11*x - 14*x\textasciicircum{}2 - 57*x\textasciicircum{}3 - 42*x\textasciicircum{}4 - 2*x\textasciicircum{}5 + 38*x\textasciicircum{}6 + 18*x\textasciicircum{}7 + 15*x\textasciicircum{}8 + x\textasciicircum{}9) / (1 - 4*x + 2*x\textasciicircum{}2 - 21*x\textasciicircum{}3 + 44*x\textasciicircum{}4 + 12*x\textasciicircum{}5 + 34*x\textasciicircum{}6 - 33*x\textasciicircum{}7 - 4*x\textasciicircum{}8 - 14*x\textasciicircum{}9 - x\textasciicircum{}10). - Colin Barker, Feb 22 2019\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 2\,a(n-2) + 21\,a(n-3) - 44\,a(n-4) - 12\,a(n-5) - 34\,a(n-6) + \\ 33\,a(n-7) + 4\,a(n-8) + 14\,a(n-9) + a(n-10). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{x + 11x^{2} - 14x^{3} - 57x^{4} - 42x^{5} - 2x^{6} + 38x^{7} + 18x^{8} + 15x^{9} + x^{10}}{1 - 4x + 2x^{2} - 21x^{3} + 44x^{4} + 12x^{5} + 34x^{6} - 33x^{7} - 4x^{8} - 14x^{9} - x^{10}}.\]
...
\begin{theorem} For A295980, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) + 21\,a(n-3) - 44\,a(n-4) - 12\,a(n-5) - 34\,a(n-6) + 33\,a(n-7) + 4\,a(n-8) + 14\,a(n-9) + a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A295980, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{x + 11x^{2} - 14x^{3} - 57x^{4} - 42x^{5} - 2x^{6} + 38x^{7} + 18x^{8} + 15x^{9} + x^{10}}{1 - 4x + 2x^{2} - 21x^{3} + 44x^{4} + 12x^{5} + 34x^{6} - 33x^{7} - 4x^{8} - 14x^{9} - x^{10}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 15, 44, 110, 581, 2354, 8452, 35474,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A295980}{A295980}, revision 7, last modified Feb 22 2019.
