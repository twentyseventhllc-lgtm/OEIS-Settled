...
\title{A proof of the conjectured linear recurrence for OEIS A260470}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260470}{A260470} as

\begin{quote}\itshape Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +10*a(n-3) +4*a(n-4) -2*a(n-5) -12*a(n-6) -5*a(n-7) -2*a(n-8) +4*a(n-9) +4*a(n-10) -8*a(n-11) -10*a(n-12) -8*a(n-13) +8*a(n-14) -a(n-16) +3*a(n-17) +2*a(n-18) +2*a(n-19) for n>22\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 2\,a(n-5) - 12\,a(n-6) - \\ 5\,a(n-7) - 2\,a(n-8) + 4\,a(n-9) + 4\,a(n-10) - 8\,a(n-11) - 10\,a(n-12) - \\ 8\,a(n-13) + 8\,a(n-14) - a(n-16) + 3\,a(n-17) + 2\,a(n-18) + 2\,a(n-19). \end{multline*}
...
That refinement leaves $39$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 31$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A260470, the recurrence $a(n) = a(n-1) + a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 2\,a(n-5) - 12\,a(n-6) - 5\,a(n-7) - 2\,a(n-8) + 4\,a(n-9) + 4\,a(n-10) - 8\,a(n-11) - 10\,a(n-12) - 8\,a(n-13) + 8\,a(n-14) - a(n-16) + 3\,a(n-17) + 2\,a(n-18) + 2\,a(n-19)$ holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,80$. The last nonvanishing one is at $m = 3$, that is at $n = 22$. After it, more than $S = 31$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 103, 213, 658, 1723, 4607, 13198, 36254, 98246,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260470}{A260470}, revision 6, last modified Jun 02 2025.
