...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A209649}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A209649}{A209649} as

\begin{quote}\itshape Number of n X 7 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 7*n\textasciicircum{}5 + 70*n\textasciicircum{}4 + (35/3)*n\textasciicircum{}3 - (105/2)*n\textasciicircum{}2 - (7/6)*n.\end{quote}

\begin{quote}\ttfamily G.f.: 35*x*(1 + x)*(1 + 28*x - 17*x\textasciicircum{}2) / (1 - x)\textasciicircum{}6.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 12, last modified Mar 09 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = -\frac{7}{6}n - \frac{105}{2}n^{2} + \frac{35}{3}n^{3} + 70n^{4} + 7n^{5}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{35x + 1015x^{2} + 385x^{3} - 595x^{4}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}.\]
...
\begin{theorem} For A209649, $a(n)$ is the polynomial $-\frac{7}{6}n - \frac{105}{2}n^{2} + \frac{35}{3}n^{3} + 70n^{4} + 7n^{5}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A209649, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{35x + 1015x^{2} + 385x^{3} - 595x^{4}}{1 - 6x + 15x^{2} - 20x^{3} + 15x^{4} - 6x^{5} + x^{6}}$.\end{theorem}
...
\begin{theorem} For A209649, the recurrence $a(n) = 6\,a(n-1) - 15\,a(n-2) + 20\,a(n-3) - 15\,a(n-4) + 6\,a(n-5) - a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 35, 1225, 7210, 24990, 65765, 145775, 287140, 518700,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A209649}{A209649}, revision 12, last modified Mar 09 2018.
