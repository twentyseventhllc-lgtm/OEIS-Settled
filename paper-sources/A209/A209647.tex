...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A209647}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A209647}{A209647} as

\begin{quote}\itshape Number of n X 5 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (7/2)*n\textasciicircum{}4 + 21*n\textasciicircum{}3 - (7/2)*n\textasciicircum{}2 - 7*n.\end{quote}

\begin{quote}\ttfamily G.f.: 14*x*(1 + 9*x - 3*x\textasciicircum{}2 - x\textasciicircum{}3) / (1 - x)\textasciicircum{}5.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 13, last modified Mar 08 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = -7n - \frac{7}{2}n^{2} + 21n^{3} + \frac{7}{2}n^{4}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{14x + 126x^{2} - 42x^{3} - 14x^{4}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}.\]
...
\begin{theorem} For A209647, $a(n)$ is the polynomial $-7n - \frac{7}{2}n^{2} + 21n^{3} + \frac{7}{2}n^{4}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A209647, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{14x + 126x^{2} - 42x^{3} - 14x^{4}}{1 - 5x + 10x^{2} - 10x^{3} + 5x^{4} - x^{5}}$.\end{theorem}
...
\begin{theorem} For A209647, the recurrence $a(n) = 5\,a(n-1) - 10\,a(n-2) + 10\,a(n-3) - 5\,a(n-4) + a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,49$. Every one of them vanished. After it, more than $S = 6$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 14, 196, 798, 2156, 4690, 8904, 15386, 24808,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A209647}{A209647}, revision 13, last modified Mar 08 2018.
