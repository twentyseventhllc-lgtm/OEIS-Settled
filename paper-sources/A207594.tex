...
\title{A proof of the conjectured linear recurrence for OEIS A207594}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207594}{A207594} as

\begin{quote}\itshape Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 25*a(n-2) +2*a(n-3) -199*a(n-4) +632*a(n-6) -30*a(n-7) -879*a(n-8) +28*a(n-9) +548*a(n-10) -139*a(n-12) -4*a(n-13) +10*a(n-14) for n>16\end{quote}
...
\begin{multline*} a(n) = 25\,a(n-2) + 2\,a(n-3) - 199\,a(n-4) + 632\,a(n-6) - 30\,a(n-7) - 879\,a(n-8) + \\ 28\,a(n-9) + 548\,a(n-10) - 139\,a(n-12) - 4\,a(n-13) + 10\,a(n-14). \end{multline*}
...
\begin{theorem} For A207594, the recurrence $a(n) = 25\,a(n-2) + 2\,a(n-3) - 199\,a(n-4) + 632\,a(n-6) - 30\,a(n-7) - 879\,a(n-8) + 28\,a(n-9) + 548\,a(n-10) - 139\,a(n-12) - 4\,a(n-13) + 10\,a(n-14)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 25, 625, 1250, 5000, 18150, 70800, 263550, 1018700,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207594}{A207594}, revision 9, last modified Oct 03 2025.
