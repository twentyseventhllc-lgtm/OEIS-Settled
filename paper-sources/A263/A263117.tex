...
\title{Proofs of the conjectured column and row recurrences for OEIS A263117}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A263117}{A263117} as

\begin{quote}\itshape T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each row and column not divisible by 7, read as a binary number with top and left being the most significant bits\end{quote}
...
k=1: [linear recurrence of order 16]\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Oct 09 2015). As of revision 4, last modified Oct 09 2015, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A263117, the recurrence $a(n) = 0$ holds for every $n \ge 17$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The width is $3$; the digraph has $343$ states, $343$ after trimming, and $S = 84$ blocks after refinement. The model reproduces every published value of column $k = 1$ --- and of the rest of the triangle. The residuals were computed exactly and all of them vanish; after that point more than $S = 84$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A263117}{A263117}, revision 4, last modified Oct 09 2015.
