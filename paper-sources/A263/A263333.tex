...
\title{Proofs of the conjectured column and row recurrences for OEIS A263333}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A263333}{A263333} as

\begin{quote}\itshape T(n,k)=Number of (n+2)X(k+2) 0..2 arrays with each row and column divisible by 11, read as a base-3 number with top and left being the most significant digits\end{quote}
...
k=1: [linear recurrence of order 26]\end{quote}
...
\begin{theorem} For column $k = 1$ of A263333, the recurrence $a(n) = 0$ holds for every $n \ge 27$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The width is $3$; the digraph has $121$ states, $121$ after trimming, and $S = 66$ blocks after refinement. The model reproduces every published value of column $k = 1$ --- and of the rest of the triangle. The residuals were computed exactly and all of them vanish; after that point more than $S = 66$ consecutive residuals vanish, so by Section 3 every later one vanishes too. $\square$
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A263333}{A263333}, revision 3, last modified Oct 15 2015.
