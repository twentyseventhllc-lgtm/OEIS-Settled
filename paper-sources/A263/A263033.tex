...
\title{A proof of the conjectured linear recurrence for OEIS A263033}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A263033}{A263033} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..1 arrays with each row and column not divisible by 5, read as a binary number with top and left being the most significant bits\end{quote}
...
\begin{theorem} For A263033, the recurrence of order $30$ displayed in Section 1 holds for every $n \ge 31$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,130$. Every one of them vanished. After it, more than $S = 75$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 98, 512, 3711, 24013, 142344, 839216, 5128489, 31001921,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A263033}{A263033}, revision 4, last modified Oct 08 2015.
