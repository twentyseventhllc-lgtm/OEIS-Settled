...
\title{Proofs of the conjectured column and row recurrences for OEIS A263464}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A263464}{A263464} as

\begin{quote}\itshape T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with each row and column divisible by 11, read as a base-5 number with top and left being the most significant digits\end{quote}
...
k=1: a(n) = 3*a(n-1) +a(n-5) -3*a(n-6)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Oct 19 2015). As of revision 4, last modified Oct 19 2015, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A263464, the recurrence $a(n) = 3\,a(n-1) + a(n-5) - 3\,a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A263464}{A263464}, revision 4, last modified Oct 19 2015.
