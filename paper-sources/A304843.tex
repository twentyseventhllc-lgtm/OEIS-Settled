...
\title{A proof of the conjectured linear recurrence for OEIS A304843}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304843}{A304843} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +8*a(n-3) +a(n-4) -9*a(n-5) -26*a(n-6) -6*a(n-7) +6*a(n-8) +16*a(n-9) +2*a(n-10) +6*a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 8\,a(n-3) + a(n-4) - 9\,a(n-5) - 26\,a(n-6) - \\ 6\,a(n-7) + 6\,a(n-8) + 16\,a(n-9) + 2\,a(n-10) + 6\,a(n-11). \end{multline*}
...
\begin{theorem} For A304843, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 8\,a(n-3) + a(n-4) - 9\,a(n-5) - 26\,a(n-6) - 6\,a(n-7) + 6\,a(n-8) + 16\,a(n-9) + 2\,a(n-10) + 6\,a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. The last nonvanishing one is at $m = 1$, that is at $n = 12$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 25, 51, 165, 419, 1009, 2697,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304843}{A304843}, revision 4, last modified May 19 2018.
