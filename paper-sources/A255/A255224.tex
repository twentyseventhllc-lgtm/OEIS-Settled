...
\title{A proof of the conjectured linear recurrence for OEIS A255224}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255224}{A255224} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 2 and no column sum 2\end{quote}
...
\begin{theorem} For A255224, the recurrence $a(n) = 2\,a(n-1) - a(n-2) + a(n-3) - a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 37 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 43, 49, 58, 70, 88, 115, 154, 211,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255224}{A255224}, revision 6, last modified Jun 02 2025.
