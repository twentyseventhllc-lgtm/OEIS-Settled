...
\title{A proof of the conjectured linear recurrence for OEIS A255794}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255794}{A255794} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 3\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-2) +2*a(n-3) +3*a(n-4) +3*a(n-5) +2*a(n-6) +3*a(n-7) -13*a(n-8) -11*a(n-9) -10*a(n-10) -a(n-11) +4*a(n-12) -a(n-13) +a(n-14) for n>21\end{quote}
...
\begin{multline*} a(n) = a(n-2) + 2\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 2\,a(n-6) + 3\,a(n-7) - \\ 13\,a(n-8) - 11\,a(n-9) - 10\,a(n-10) - a(n-11) + 4\,a(n-12) - a(n-13) + \\ a(n-14). \end{multline*}
...
\begin{theorem} For A255794, the recurrence $a(n) = a(n-2) + 2\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 2\,a(n-6) + 3\,a(n-7) - 13\,a(n-8) - 11\,a(n-9) - 10\,a(n-10) - a(n-11) + 4\,a(n-12) - a(n-13) + a(n-14)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,75$. The last nonvanishing one is at $m = 7$, that is at $n = 21$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 70, 134, 210, 409, 733, 1318, 2380, 4187,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255794}{A255794}, revision 6, last modified Jun 02 2025.
