...
\title{A proof of the conjectured linear recurrence for OEIS A255155}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255155}{A255155} as

\begin{quote}\itshape Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 0 or 1 and no column sum 0 or 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +6*a(n-2) +21*a(n-3) +53*a(n-4) +33*a(n-5) -49*a(n-6) -255*a(n-7) -298*a(n-8) +550*a(n-9) +1137*a(n-10) -8*a(n-11) -2536*a(n-12) -2445*a(n-13) +3641*a(n-14) +3226*a(n-15) -5655*a(n-16) -2727*a(n-17) +4934*a(n-18) +670*a(n-19) -3942*a(n-20) -1351*a(n-21) +794*a(n-22) -44*a(n-23) +94*a(n-24) +519*a(n-25) -35*a(n-26) +72*a(n-27) +117*a(n-28) -36*a(n-29) for n>31\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 6\,a(n-2) + 21\,a(n-3) + 53\,a(n-4) + 33\,a(n-5) - 49\,a(n-6) - \\ 255\,a(n-7) - 298\,a(n-8) + 550\,a(n-9) + 1137\,a(n-10) - 8\,a(n-11) - 2536\,a(n-12) - \\ 2445\,a(n-13) + 3641\,a(n-14) + 3226\,a(n-15) - 5655\,a(n-16) - 2727\,a(n-17) + 4934\,a(n-18) + \\ 670\,a(n-19) - 3942\,a(n-20) - 1351\,a(n-21) + 794\,a(n-22) - 44\,a(n-23) + 94\,a(n-24) + \\ 519\,a(n-25) - 35\,a(n-26) + 72\,a(n-27) + 117\,a(n-28) - 36\,a(n-29). \end{multline*}
...
That refinement leaves $54$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 43$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A255155, the recurrence of order $29$ displayed in Section 1 holds for every $n > 31$, and fails at $n = 31$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 331, 1285, 5615, 24076, 102481, 437238, 1863728, 7949259,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255155}{A255155}, revision 6, last modified Jun 02 2025.
