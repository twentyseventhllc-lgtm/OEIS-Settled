...
\title{A proof of the conjectured linear recurrence for OEIS A255088}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255088}{A255088} as

\begin{quote}\itshape Number of (n+2)X(5+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 0\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +17*a(n-3) -37*a(n-4) +19*a(n-5) +415*a(n-6) -469*a(n-7) -323*a(n-8) -7131*a(n-9) +8173*a(n-10) +5833*a(n-11) -19533*a(n-12) +13435*a(n-13) +5312*a(n-14) +236241*a(n-15) -243777*a(n-16) -104880*a(n-17) +140460*a(n-18) -32856*a(n-19) +22328*a(n-20) -687820*a(n-21) +670596*a(n-22) -453340*a(n-23) +335929*a(n-24) +108738*a(n-25) -42419*a(n-26) +2206909*a(n-27) -2155874*a(n-28) +844778*a(n-29) -969478*a(n-30) +124513*a(n-31) +110628*a(n-32) +2023531*a(n-33) -2132395*a(n-34) -2226420*a(n-35) +2064996*a(n-36) +164844*a(n-37) +196992*a(n-38) +2508228*a(n-39) -2716164*a(n-40) -3950784*a(n-41) +3950784*a(n-42) for n>51\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 17\,a(n-3) - 37\,a(n-4) + 19\,a(n-5) + 415\,a(n-6) - 469\,a(n-7) - \\ 323\,a(n-8) - 7131\,a(n-9) + 8173\,a(n-10) + 5833\,a(n-11) - 19533\,a(n-12) + 13435\,a(n-13) + \\ 5312\,a(n-14) + 236241\,a(n-15) - 243777\,a(n-16) - 104880\,a(n-17) + 140460\,a(n-18) - 32856\,a(n-19) + \\ 22328\,a(n-20) - 687820\,a(n-21) + 670596\,a(n-22) - 453340\,a(n-23) + 335929\,a(n-24) + 108738\,a(n-25) - \\ 42419\,a(n-26) + 2206909\,a(n-27) - 2155874\,a(n-28) + 844778\,a(n-29) - 969478\,a(n-30) + 124513\,a(n-31) + \\ 110628\,a(n-32) + 2023531\,a(n-33) - 2132395\,a(n-34) - 2226420\,a(n-35) + 2064996\,a(n-36) + 164844\,a(n-37) + \\ 196992\,a(n-38) + 2508228\,a(n-39) - 2716164\,a(n-40) - 3950784\,a(n-41) + 3950784\,a(n-42). \end{multline*}
...
That refinement leaves $290$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 117$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,

\[a(n) \;=\; \tilde w^{\mathsf T} L^{\,n-1} \tilde f \qquad (n \ge 1),\]

and $a$ satisfies the linear recurrence given by the characteristic polynomial of $L$, of degree $117$. This is the only bound used below, and it is computed, not assumed.

For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $117$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A255088, the recurrence of order $42$ displayed in Section 1 holds for every $n > 51$, and fails at $n = 51$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,186$. The last nonvanishing one is at $m = 9$, that is at $n = 51$. After it, more than $S = 117$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3658, 4405, 8631, 24034, 70938, 211945, 644545, 1975790,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255088}{A255088}, revision 6, last modified Jun 02 2025.
