...
\title{A proof of the conjectured linear recurrence for OEIS A255619}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A255619}{A255619} as

\begin{quote}\itshape Number of length n+5 0..2 arrays with at most two downsteps in every 5 consecutive neighbor pairs\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -3*a(n-2) +8*a(n-3) -9*a(n-4) +30*a(n-5) -35*a(n-6) +12*a(n-7) -45*a(n-8) +56*a(n-9) -147*a(n-10) +177*a(n-11) -63*a(n-12) +18*a(n-13) +3*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 3\,a(n-2) + 8\,a(n-3) - 9\,a(n-4) + 30\,a(n-5) - 35\,a(n-6) + \\ 12\,a(n-7) - 45\,a(n-8) + 56\,a(n-9) - 147\,a(n-10) + 177\,a(n-11) - 63\,a(n-12) + \\ 18\,a(n-13) + 3\,a(n-14). \end{multline*}
...
The reachable part of that digraph has $364$ states, $364$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 27$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $27\times27$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A255619, the recurrence $a(n) = 3\,a(n-1) - 3\,a(n-2) + 8\,a(n-3) - 9\,a(n-4) + 30\,a(n-5) - 35\,a(n-6) + 12\,a(n-7) - 45\,a(n-8) + 56\,a(n-9) - 147\,a(n-10) + 177\,a(n-11) - 63\,a(n-12) + 18\,a(n-13) + 3\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 651, 1803, 5088, 14381, 40659, 114546, 322078, 907110,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A255619}{A255619}, revision 6, last modified Jul 23 2025.
