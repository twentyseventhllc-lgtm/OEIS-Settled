...
\title{Proofs of the conjectured column and row recurrences for OEIS A270118}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A270118}{A270118} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..7 arrays with some element plus some horizontally or vertically adjacent neighbor totalling seven exactly once\end{quote}
...
k=1: a(n) = 14*a(n-1) -49*a(n-2)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Mar 11 2016). As of revision 4, last modified Mar 11 2016, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A270118, the recurrence $a(n) = 14\,a(n-1) - 49\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A270118}{A270118}, revision 4, last modified Mar 11 2016.
