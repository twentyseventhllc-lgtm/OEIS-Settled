...
\title{A proof of the conjectured linear recurrence for OEIS A303237}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303237}{A303237} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -5*a(n-2) +16*a(n-3) -36*a(n-4) +32*a(n-5) -63*a(n-6) +64*a(n-7) -51*a(n-8) +4*a(n-9) +60*a(n-10) +16*a(n-11) +112*a(n-12) +64*a(n-13)\end{quote}
...
\begin{theorem} For A303237, the recurrence $a(n) = 4\,a(n-1) - 5\,a(n-2) + 16\,a(n-3) - 36\,a(n-4) + 32\,a(n-5) - 63\,a(n-6) + 64\,a(n-7) - 51\,a(n-8) + 4\,a(n-9) + 60\,a(n-10) + 16\,a(n-11) + 112\,a(n-12) + 64\,a(n-13)$ holds for every $n \ge 14$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 11, 18, 55, 181, 494, 1465, 4415,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303237}{A303237}, revision 4, last modified Apr 20 2018.
