...
\title{A proof of the conjectured linear recurrence for OEIS A303422}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303422}{A303422} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +4*a(n-2) +21*a(n-3) +18*a(n-4)\end{quote}
...
\begin{theorem} For A303422, the recurrence $a(n) = 7\,a(n-1) + 4\,a(n-2) + 21\,a(n-3) + 18\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 252, 1985, 15647, 123337, 972168, 7662841,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303422}{A303422}, revision 4, last modified Apr 23 2018.
