...
\title{A proof of the conjectured linear recurrence for OEIS A303011}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303011}{A303011} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +4*a(n-2) +30*a(n-3) -88*a(n-4) -52*a(n-5) -84*a(n-6) -200*a(n-7) -80*a(n-8) -112*a(n-9) -96*a(n-10)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 4\,a(n-2) + 30\,a(n-3) - 88\,a(n-4) - 52\,a(n-5) - 84\,a(n-6) - \\ 200\,a(n-7) - 80\,a(n-8) - 112\,a(n-9) - 96\,a(n-10). \end{multline*}
...
\begin{theorem} For A303011, the recurrence $a(n) = 3\,a(n-1) + 4\,a(n-2) + 30\,a(n-3) - 88\,a(n-4) - 52\,a(n-5) - 84\,a(n-6) - 200\,a(n-7) - 80\,a(n-8) - 112\,a(n-9) - 96\,a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 68, 308, 1320, 5220, 22652, 95220,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303011}{A303011}, revision 4, last modified Apr 17 2018.
