...
\title{A proof of the conjectured linear recurrence for OEIS A303892}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303892}{A303892} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 3 or 4 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +22*a(n-2) -8*a(n-3) -131*a(n-4) +a(n-5) +153*a(n-6) -84*a(n-7) +542*a(n-8) +278*a(n-9) -1349*a(n-10) +447*a(n-11) +711*a(n-12) -308*a(n-13) +422*a(n-14) -2403*a(n-15) +1609*a(n-16) -250*a(n-17) -407*a(n-18) +3132*a(n-19) -3586*a(n-20) +3814*a(n-21) -3697*a(n-22) +375*a(n-23) +1563*a(n-24) -1317*a(n-25) +1526*a(n-26) -1386*a(n-27) +563*a(n-28) -422*a(n-29) +246*a(n-30) -59*a(n-31) +112*a(n-32) -21*a(n-33) -2*a(n-34) -7*a(n-35) for n>40\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 22\,a(n-2) - 8\,a(n-3) - 131\,a(n-4) + a(n-5) + 153\,a(n-6) - \\ 84\,a(n-7) + 542\,a(n-8) + 278\,a(n-9) - 1349\,a(n-10) + 447\,a(n-11) + 711\,a(n-12) - \\ 308\,a(n-13) + 422\,a(n-14) - 2403\,a(n-15) + 1609\,a(n-16) - 250\,a(n-17) - 407\,a(n-18) + \\ 3132\,a(n-19) - 3586\,a(n-20) + 3814\,a(n-21) - 3697\,a(n-22) + 375\,a(n-23) + 1563\,a(n-24) - \\ 1317\,a(n-25) + 1526\,a(n-26) - 1386\,a(n-27) + 563\,a(n-28) - 422\,a(n-29) + 246\,a(n-30) - \\ 59\,a(n-31) + 112\,a(n-32) - 21\,a(n-33) - 2\,a(n-34) - 7\,a(n-35). \end{multline*}
...
\begin{theorem} For A303892, the recurrence of order $35$ displayed in Section 1 holds for every $n > 40$, and fails at $n = 40$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,109$. The last nonvanishing one is at $m = 5$, that is at $n = 40$. After it, more than $S = 47$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 86, 271, 1659, 7421, 39711, 195279, 1003855,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303892}{A303892}, revision 4, last modified May 02 2018.
