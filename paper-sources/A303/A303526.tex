...
\title{A proof of the conjectured linear recurrence for OEIS A303526}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303526}{A303526} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +a(n-3) +30*a(n-4) -53*a(n-5) -102*a(n-6) +11*a(n-7) -227*a(n-8) +351*a(n-9) +784*a(n-10) -242*a(n-11) +351*a(n-12) -361*a(n-13) -1069*a(n-14) +577*a(n-15) +8*a(n-16) +28*a(n-17) +22*a(n-18) -11*a(n-19) -a(n-20) for n>21\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + a(n-3) + 30\,a(n-4) - 53\,a(n-5) - 102\,a(n-6) + \\ 11\,a(n-7) - 227\,a(n-8) + 351\,a(n-9) + 784\,a(n-10) - 242\,a(n-11) + 351\,a(n-12) - \\ 361\,a(n-13) - 1069\,a(n-14) + 577\,a(n-15) + 8\,a(n-16) + 28\,a(n-17) + 22\,a(n-18) - \\ 11\,a(n-19) - a(n-20). \end{multline*}
...
\begin{theorem} For A303526, the recurrence of order $20$ displayed in Section 1 holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,74$. The last nonvanishing one is at $m = 1$, that is at $n = 21$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 6, 18, 37, 80, 286, 916, 2532,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303526}{A303526}, revision 4, last modified Apr 25 2018.
