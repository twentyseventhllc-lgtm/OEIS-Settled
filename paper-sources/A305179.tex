...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,146$. The last nonvanishing one is at $m = 7$, that is at $n = 50$. After it, more than $S = 67$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
