...
\title{A proof of the conjectured linear recurrence for OEIS A207308}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207308}{A207308} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +11*a(n-3) +13*a(n-4) +3*a(n-5) -12*a(n-6) -27*a(n-7) -13*a(n-8) -3*a(n-9) +15*a(n-10) +8*a(n-11) +4*a(n-12) -5*a(n-13) -a(n-14) -a(n-15) +2*a(n-16) -a(n-17) for n>18\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 11\,a(n-3) + 13\,a(n-4) + 3\,a(n-5) - 12\,a(n-6) - \\ 27\,a(n-7) - 13\,a(n-8) - 3\,a(n-9) + 15\,a(n-10) + 8\,a(n-11) + 4\,a(n-12) - \\ 5\,a(n-13) - a(n-14) - a(n-15) + 2\,a(n-16) - a(n-17). \end{multline*}
...
\begin{theorem} For A207308, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 11\,a(n-3) + 13\,a(n-4) + 3\,a(n-5) - 12\,a(n-6) - 27\,a(n-7) - 13\,a(n-8) - 3\,a(n-9) + 15\,a(n-10) + 8\,a(n-11) + 4\,a(n-12) - 5\,a(n-13) - a(n-14) - a(n-15) + 2\,a(n-16) - a(n-17)$ holds for every $n > 18$, and fails at $n = 18$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 350, 1271, 3773, 11497, 36868, 116117,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207308}{A207308}, revision 9, last modified Oct 03 2025.
