...
\title{A proof of the conjectured linear recurrence for OEIS A298439}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298439}{A298439} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) -4*a(n-3) -4*a(n-4) -2*a(n-5) +2*a(n-6) +5*a(n-7) -2*a(n-8) +6*a(n-9) -a(n-10) -a(n-11) -a(n-12) for n>13\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) - 4\,a(n-3) - 4\,a(n-4) - 2\,a(n-5) + 2\,a(n-6) + \\ 5\,a(n-7) - 2\,a(n-8) + 6\,a(n-9) - a(n-10) - a(n-11) - a(n-12). \end{multline*}
...
\begin{theorem} For A298439, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) - 4\,a(n-3) - 4\,a(n-4) - 2\,a(n-5) + 2\,a(n-6) + 5\,a(n-7) - 2\,a(n-8) + 6\,a(n-9) - a(n-10) - a(n-11) - a(n-12)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. The last nonvanishing one is at $m = 1$, that is at $n = 13$. After it, more than $S = 14$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 1, 11, 2, 27, 36, 86, 162,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298439}{A298439}, revision 4, last modified Jan 19 2018.
