...
\title{A proof of the conjectured linear recurrence for OEIS A296683}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A296683}{A296683} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with each 1 adjacent to 1, 2 or 3 king-move neighboring 1s\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) + 4*a(n-2) + 37*a(n-3) - 15*a(n-4) + 21*a(n-5) - 79*a(n-6) - 7*a(n-7) - 92*a(n-8) - 49*a(n-9) - 19*a(n-10) - 20*a(n-11) + 2*a(n-12).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Dec 18 2017).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Dec 18 2017, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 4\,a(n-1) + 4\,a(n-2) + 37\,a(n-3) - 15\,a(n-4) + 21\,a(n-5) - 79\,a(n-6) - \\ 7\,a(n-7) - 92\,a(n-8) - 49\,a(n-9) - 19\,a(n-10) - 20\,a(n-11) + 2\,a(n-12). \end{multline*}
...
\begin{theorem} For A296683, the recurrence $a(n) = 4\,a(n-1) + 4\,a(n-2) + 37\,a(n-3) - 15\,a(n-4) + 21\,a(n-5) - 79\,a(n-6) - 7\,a(n-7) - 92\,a(n-8) - 49\,a(n-9) - 19\,a(n-10) - 20\,a(n-11) + 2\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 43, 210, 1162, 6959, 39608, 226599, 1305725,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A296683}{A296683}, revision 9, last modified Dec 18 2017.
