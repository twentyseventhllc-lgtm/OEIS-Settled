...
\title{A proof of the conjectured order of the recurrence for OEIS A299671}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299671}{A299671} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A299671, the least order of a linear recurrence that $a$ eventually satisfies is exactly $65$, and that recurrence holds for every $n > 66$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 88, 372, 2009, 12076, 69614, 398314, 2305246,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299671}{A299671}, revision 4, last modified Feb 16 2018.
