...
\title{A proof of the conjectured order of the recurrence for OEIS A299093}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299093}{A299093} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Sep 10 2023, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 29, 41, 125, 574, 1847, 6007, 22330,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299093}{A299093}, revision 6, last modified Sep 10 2023.
