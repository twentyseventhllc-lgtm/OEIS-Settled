...
\title{A proof of the conjectured order of the recurrence for OEIS A299658}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299658}{A299658} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Feb 15 2018, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\begin{theorem} For A299658, the least order of a linear recurrence that $a$ eventually satisfies is exactly $89$, and that recurrence holds for every $n > 89$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 512, 11888, 297071, 7411398, 185302633, 4634931975, 115940148451,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299658}{A299658}, revision 6, last modified Feb 15 2018.
