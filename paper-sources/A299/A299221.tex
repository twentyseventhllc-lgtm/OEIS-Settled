...
\title{Proofs of the conjectured column and row recurrences for OEIS A299221}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299221}{A299221} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element equal to 0, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=4: [order 66] for n>68.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 05 2018). As of revision 6, last modified Apr 17 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 4$ of A299221, the recurrence $a(n) = 0$ holds for every $n > 68$, and fails at $n = 68$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299221}{A299221}, revision 6, last modified Apr 17 2022.
