...
\title{Proofs of the conjectured column and row recurrences for OEIS A299135}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299135}{A299135} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 0, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = a(n-1)\\k=2: a(n) = a(n-1) +5*a(n-2) +4*a(n-3)\\k=3: [order 12] for n>14\\k=4: [order 49] for n>51\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 03 2018). As of revision 4, last modified Feb 03 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A299135, the recurrence $a(n) = a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A299135, the recurrence $a(n) = a(n-1) + 5\,a(n-2) + 4\,a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A299135, the recurrence $a(n) = 0$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A299135, the recurrence $a(n) = 0$ holds for every $n > 51$, and fails at $n = 51$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299135}{A299135}, revision 4, last modified Feb 03 2018.
