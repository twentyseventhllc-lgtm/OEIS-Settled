...
\title{A proof of the conjectured linear recurrence for OEIS A256023}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A256023}{A256023} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 1 and no column sum 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -a(n-2) +5*a(n-3) -9*a(n-4) -5*a(n-5) -3*a(n-6) +7*a(n-7) +7*a(n-8) +4*a(n-9) -3*a(n-10) -2*a(n-11) -2*a(n-12)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - a(n-2) + 5\,a(n-3) - 9\,a(n-4) - 5\,a(n-5) - 3\,a(n-6) + \\ 7\,a(n-7) + 7\,a(n-8) + 4\,a(n-9) - 3\,a(n-10) - 2\,a(n-11) - 2\,a(n-12). \end{multline*}
...
\begin{theorem} For A256023, the recurrence $a(n) = 3\,a(n-1) - a(n-2) + 5\,a(n-3) - 9\,a(n-4) - 5\,a(n-5) - 3\,a(n-6) + 7\,a(n-7) + 7\,a(n-8) + 4\,a(n-9) - 3\,a(n-10) - 2\,a(n-11) - 2\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 68, 164, 484, 1302, 3500, 9820, 27424, 76068,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A256023}{A256023}, revision 6, last modified Jun 02 2025.
