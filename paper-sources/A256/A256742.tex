...
\title{A proof of the conjectured linear recurrence for OEIS A256742}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A256742}{A256742} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +6*a(n-2) +5*a(n-3) -19*a(n-4) -34*a(n-5) +8*a(n-6) +52*a(n-7) +24*a(n-8) for n>13\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 6\,a(n-2) + 5\,a(n-3) - 19\,a(n-4) - 34\,a(n-5) + 8\,a(n-6) + \\ 52\,a(n-7) + 24\,a(n-8). \end{multline*}
...
\begin{theorem} For A256742, the recurrence $a(n) = a(n-1) + 6\,a(n-2) + 5\,a(n-3) - 19\,a(n-4) - 34\,a(n-5) + 8\,a(n-6) + 52\,a(n-7) + 24\,a(n-8)$ holds for every $n > 13$, and fails at $n = 13$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,64$. The last nonvanishing one is at $m = 5$, that is at $n = 13$. After it, more than $S = 25$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 393, 570, 1564, 2512, 6352, 12280, 28816, 60728,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A256742}{A256742}, revision 6, last modified Jun 02 2025.
