...
\title{A proof of the conjectured linear recurrence for OEIS A234884}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234884}{A234884} as

\begin{quote}\itshape Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings)\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +46*a(n-2) -91*a(n-3) -852*a(n-4) +1670*a(n-5) +8364*a(n-6) -16318*a(n-7) -48531*a(n-8) +94856*a(n-9) +177211*a(n-10) -349287*a(n-11) -422181*a(n-12) +844527*a(n-13) +666796*a(n-14) -1362305*a(n-15) -697540*a(n-16) +1464198*a(n-17) +475379*a(n-18) -1029412*a(n-19) -204338*a(n-20) +455683*a(n-21) +52461*a(n-22) -118912*a(n-23) -7142*a(n-24) +16187*a(n-25) +376*a(n-26) -846*a(n-27).\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 46\,a(n-2) - 91\,a(n-3) - 852\,a(n-4) + 1670\,a(n-5) + 8364\,a(n-6) - \\ 16318\,a(n-7) - 48531\,a(n-8) + 94856\,a(n-9) + 177211\,a(n-10) - 349287\,a(n-11) - 422181\,a(n-12) + \\ 844527\,a(n-13) + 666796\,a(n-14) - 1362305\,a(n-15) - 697540\,a(n-16) + 1464198\,a(n-17) + 475379\,a(n-18) - \\ 1029412\,a(n-19) - 204338\,a(n-20) + 455683\,a(n-21) + 52461\,a(n-22) - 118912\,a(n-23) - 7142\,a(n-24) + \\ 16187\,a(n-25) + 376\,a(n-26) - 846\,a(n-27). \end{multline*}
...
For scale: at $n = 8$ there are $6^{24}$ arrays, about $10^{19}$, against $31$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A234884, the recurrence of order $27$ displayed in Section 1 holds for every $n \ge 28$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 272, 980, 3164, 11984, 40856, 159004, 551048, 2185372,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234884}{A234884}, revision 6, last modified Jun 20 2022.
