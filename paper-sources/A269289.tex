...
\title{Proofs of the conjectured column and row recurrences for OEIS A269289}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A269289}{A269289} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once\end{quote}
...
k=1: a(n) = 4*a(n-1)\\k=2: a(n) = 18*a(n-1) -81*a(n-2)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 21 2016). As of revision 4, last modified Feb 21 2016, the entry records no proof of any of them and links to none. This note proves the 2 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A269289, the recurrence $a(n) = 4\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A269289, the recurrence $a(n) = 18\,a(n-1) - 81\,a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\item 8 lines: fewer than six published terms in that line
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A269289}{A269289}, revision 4, last modified Feb 21 2016.
