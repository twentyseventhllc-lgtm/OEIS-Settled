...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A184540}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A184540}{A184540} as

\begin{quote}\itshape Number of (n+2) X 3 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily G.f.: x*(45 - 91*x + 61*x\textasciicircum{}2 - 14*x\textasciicircum{}3) / (1 - x)\textasciicircum{}4.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 11, last modified Mar 25 2026, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{45x - 91x^{2} + 61x^{3} - 14x^{4}}{1 - 4x + 6x^{2} - 4x^{3} + x^{4}}.\]
...
\begin{theorem} For A184540, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{45x - 91x^{2} + 61x^{3} - 14x^{4}}{1 - 4x + 6x^{2} - 4x^{3} + x^{4}}$.\end{theorem}
...
\begin{theorem} For A184540, the recurrence $a(n) = 4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) - a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,61$. Every one of them vanished. After it, more than $S = 9$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 42 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 45, 89, 147, 220, 309, 415, 539, 682,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A184540}{A184540}, revision 11, last modified Mar 25 2026.
