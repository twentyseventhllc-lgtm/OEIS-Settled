...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,160$. The last nonvanishing one is at $m = 1$, that is at $n = 63$. After it, more than $S = 71$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
