...
\title{A proof of the conjectured linear recurrence for OEIS A317425}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317425}{A317425} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +18*a(n-3) -28*a(n-4) -4*a(n-5) -129*a(n-6) +159*a(n-7) +41*a(n-8) +501*a(n-9) -497*a(n-10) -175*a(n-11) -1270*a(n-12) +972*a(n-13) +389*a(n-14) +2411*a(n-15) -1192*a(n-16) -426*a(n-17) -3509*a(n-18) +828*a(n-19) +91*a(n-20) +3754*a(n-21) -24*a(n-22) +367*a(n-23) -2841*a(n-24) -779*a(n-25) -650*a(n-26) +1159*a(n-27) +780*a(n-28) +393*a(n-29) -90*a(n-30) -257*a(n-31) -82*a(n-32) -35*a(n-33) +11*a(n-34) +11*a(n-35) +15*a(n-36) +18*a(n-37) -a(n-38) -3*a(n-39) -3*a(n-40) for n>41\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 18\,a(n-3) - 28\,a(n-4) - 4\,a(n-5) - 129\,a(n-6) + 159\,a(n-7) + \\ 41\,a(n-8) + 501\,a(n-9) - 497\,a(n-10) - 175\,a(n-11) - 1270\,a(n-12) + 972\,a(n-13) + \\ 389\,a(n-14) + 2411\,a(n-15) - 1192\,a(n-16) - 426\,a(n-17) - 3509\,a(n-18) + 828\,a(n-19) + \\ 91\,a(n-20) + 3754\,a(n-21) - 24\,a(n-22) + 367\,a(n-23) - 2841\,a(n-24) - 779\,a(n-25) - \\ 650\,a(n-26) + 1159\,a(n-27) + 780\,a(n-28) + 393\,a(n-29) - 90\,a(n-30) - 257\,a(n-31) - \\ 82\,a(n-32) - 35\,a(n-33) + 11\,a(n-34) + 11\,a(n-35) + 15\,a(n-36) + 18\,a(n-37) - \\ a(n-38) - 3\,a(n-39) - 3\,a(n-40). \end{multline*}
...
The condition is $c(i,j) \in \{0, 1, 3, 5, 6, 7, 8\}$ for every cell of the array, together with $A[0][0]=0$.
...
\begin{theorem} For A317425, the recurrence of order $40$ displayed in Section 1 holds for every $n > 41$, and fails at $n = 41$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,117$. The last nonvanishing one is at $m = 1$, that is at $n = 41$. After it, more than $S = 44$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 21, 32, 97, 279, 640, 1666, 4365,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317425}{A317425}, revision 4, last modified Jul 27 2018.
