...
\title{A proof of the conjectured linear recurrence for OEIS A207875}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207875}{A207875} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-2) +7*a(n-3) +4*a(n-4) -3*a(n-5) -17*a(n-6) -5*a(n-7) +7*a(n-8) +2*a(n-9) -13*a(n-10) -a(n-11) -2*a(n-12) for n>14\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-2) + 7\,a(n-3) + 4\,a(n-4) - 3\,a(n-5) - 17\,a(n-6) - 5\,a(n-7) + \\ 7\,a(n-8) + 2\,a(n-9) - 13\,a(n-10) - a(n-11) - 2\,a(n-12). \end{multline*}
...
\begin{theorem} For A207875, the recurrence $a(n) = 2\,a(n-2) + 7\,a(n-3) + 4\,a(n-4) - 3\,a(n-5) - 17\,a(n-6) - 5\,a(n-7) + 7\,a(n-8) + 2\,a(n-9) - 13\,a(n-10) - a(n-11) - 2\,a(n-12)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,62$. The last nonvanishing one is at $m = 2$, that is at $n = 14$. After it, more than $S = 17$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 164, 400, 824, 1940, 4200, 9276,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207875}{A207875}, revision 9, last modified Oct 03 2025.
