...
\title{A proof of the conjectured linear recurrence for OEIS A302473}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302473}{A302473} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +17*a(n-2) +15*a(n-3) -33*a(n-4) -62*a(n-5) -148*a(n-6) -116*a(n-7) +343*a(n-8) +429*a(n-9) +269*a(n-10) +191*a(n-11) -415*a(n-12) -534*a(n-13) -468*a(n-14) -436*a(n-15) -132*a(n-16) -72*a(n-17) -8*a(n-18) +8*a(n-19) for n>21\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 17\,a(n-2) + 15\,a(n-3) - 33\,a(n-4) - 62\,a(n-5) - 148\,a(n-6) - \\ 116\,a(n-7) + 343\,a(n-8) + 429\,a(n-9) + 269\,a(n-10) + 191\,a(n-11) - 415\,a(n-12) - \\ 534\,a(n-13) - 468\,a(n-14) - 436\,a(n-15) - 132\,a(n-16) - 72\,a(n-17) - 8\,a(n-18) + \\ 8\,a(n-19). \end{multline*}
...
\begin{theorem} For A302473, the recurrence $a(n) = a(n-1) + 17\,a(n-2) + 15\,a(n-3) - 33\,a(n-4) - 62\,a(n-5) - 148\,a(n-6) - 116\,a(n-7) + 343\,a(n-8) + 429\,a(n-9) + 269\,a(n-10) + 191\,a(n-11) - 415\,a(n-12) - 534\,a(n-13) - 468\,a(n-14) - 436\,a(n-15) - 132\,a(n-16) - 72\,a(n-17) - 8\,a(n-18) + 8\,a(n-19)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 2$, that is at $n = 21$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 11, 49, 203, 955, 4556, 21843, 103319,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302473}{A302473}, revision 4, last modified Apr 08 2018.
