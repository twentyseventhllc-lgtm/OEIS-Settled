...
\title{A proof of the conjectured linear recurrence for OEIS A318063}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A318063}{A318063} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +9*a(n-2) -7*a(n-3) -3*a(n-4) +8*a(n-5) -2*a(n-6) -9*a(n-7) -2*a(n-8) -a(n-9) +2*a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 9\,a(n-2) - 7\,a(n-3) - 3\,a(n-4) + 8\,a(n-5) - 2\,a(n-6) - \\ 9\,a(n-7) - 2\,a(n-8) - a(n-9) + 2\,a(n-11). \end{multline*}
...
\begin{theorem} For A318063, the recurrence $a(n) = 5\,a(n-1) + 9\,a(n-2) - 7\,a(n-3) - 3\,a(n-4) + 8\,a(n-5) - 2\,a(n-6) - 9\,a(n-7) - 2\,a(n-8) - a(n-9) + 2\,a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,50$. The last nonvanishing one is at $m = 1$, that is at $n = 12$. After it, more than $S = 13$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 98, 649, 4003, 25106, 156846, 980960,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A318063}{A318063}, revision 4, last modified Aug 15 2018.
