...
\title{A proof of the conjectured linear recurrence for OEIS A316277}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316277}{A316277} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +16*a(n-2) +5*a(n-3) -50*a(n-4) -91*a(n-5) -64*a(n-6) -37*a(n-7) -23*a(n-8) -5*a(n-9) for n>10\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 16\,a(n-2) + 5\,a(n-3) - 50\,a(n-4) - 91\,a(n-5) - 64\,a(n-6) - \\ 37\,a(n-7) - 23\,a(n-8) - 5\,a(n-9). \end{multline*}
...
\begin{theorem} For A316277, the recurrence $a(n) = 4\,a(n-1) + 16\,a(n-2) + 5\,a(n-3) - 50\,a(n-4) - 91\,a(n-5) - 64\,a(n-6) - 37\,a(n-7) - 23\,a(n-8) - 5\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 25, 125, 846, 5321, 34017, 216805, 1382759,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316277}{A316277}, revision 4, last modified Jun 28 2018.
