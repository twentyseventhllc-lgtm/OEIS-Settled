...
\title{A proof of the conjectured linear recurrence for OEIS A316752}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316752}{A316752} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-2) +12*a(n-3) +5*a(n-4) -23*a(n-5) -50*a(n-6) -25*a(n-7) +40*a(n-8) +70*a(n-9) +32*a(n-10) -25*a(n-11) -25*a(n-12) -5*a(n-13) +4*a(n-14) -a(n-15) -2*a(n-16) for n>17\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-2) + 12\,a(n-3) + 5\,a(n-4) - 23\,a(n-5) - 50\,a(n-6) - 25\,a(n-7) + \\ 40\,a(n-8) + 70\,a(n-9) + 32\,a(n-10) - 25\,a(n-11) - 25\,a(n-12) - 5\,a(n-13) + \\ 4\,a(n-14) - a(n-15) - 2\,a(n-16). \end{multline*}
...
\begin{theorem} For A316752, the recurrence $a(n) = 3\,a(n-2) + 12\,a(n-3) + 5\,a(n-4) - 23\,a(n-5) - 50\,a(n-6) - 25\,a(n-7) + 40\,a(n-8) + 70\,a(n-9) + 32\,a(n-10) - 25\,a(n-11) - 25\,a(n-12) - 5\,a(n-13) + 4\,a(n-14) - a(n-15) - 2\,a(n-16)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,69$. The last nonvanishing one is at $m = 1$, that is at $n = 17$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 9, 15, 17, 79, 185, 315, 970,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316752}{A316752}, revision 4, last modified Jul 12 2018.
