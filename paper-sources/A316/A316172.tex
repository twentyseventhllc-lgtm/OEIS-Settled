...
\title{A proof of the conjectured order of the recurrence for OEIS A316172}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316172}{A316172} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 1, 2, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 10, 34, 72, 331, 1425, 5297, 18573,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316172}{A316172}, revision 4, last modified Jun 25 2018.
