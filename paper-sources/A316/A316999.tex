...
\title{A proof of the conjectured linear recurrence for OEIS A316999}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316999}{A316999} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +3*a(n-2) +7*a(n-3) -48*a(n-4) +5*a(n-5) +10*a(n-6) +2*a(n-7) -19*a(n-8) -15*a(n-9) -6*a(n-10) -a(n-11) for n>12\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 3\,a(n-2) + 7\,a(n-3) - 48\,a(n-4) + 5\,a(n-5) + 10\,a(n-6) + \\ 2\,a(n-7) - 19\,a(n-8) - 15\,a(n-9) - 6\,a(n-10) - a(n-11). \end{multline*}
...
\begin{theorem} For A316999, the recurrence $a(n) = 5\,a(n-1) + 3\,a(n-2) + 7\,a(n-3) - 48\,a(n-4) + 5\,a(n-5) + 10\,a(n-6) + 2\,a(n-7) - 19\,a(n-8) - 15\,a(n-9) - 6\,a(n-10) - a(n-11)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 30, 162, 894, 4905, 26952, 148138, 814090,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316999}{A316999}, revision 4, last modified Jul 18 2018.
