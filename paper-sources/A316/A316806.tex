...
\title{A proof of the conjectured order of the recurrence for OEIS A316806}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316806}{A316806} as

\begin{quote}\itshape Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A316806, the least order of a linear recurrence that $a$ eventually satisfies is exactly $59$, and that recurrence holds for every $n > 59$, the entry's own figure.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 14 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 2048, 113606, 6256258, 347046960, 19261290694, 1068884675914, 59316329979368,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316806}{A316806}, revision 4, last modified Jul 14 2018.
