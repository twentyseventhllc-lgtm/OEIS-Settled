...
\title{Proofs of the conjectured column and row recurrences for OEIS A316822}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316822}{A316822} as

\begin{quote}\itshape T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=4: [order 38] for n>39.\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jul 14 2018). As of revision 6, last modified Jun 26 2022, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 4$ of A316822, the recurrence $a(n) = 0$ holds for every $n > 39$, and fails at $n = 39$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316822}{A316822}, revision 6, last modified Jun 26 2022.
