...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,157$. The last nonvanishing one is at $m = 3$, that is at $n = 60$. After it, more than $S = 71$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
