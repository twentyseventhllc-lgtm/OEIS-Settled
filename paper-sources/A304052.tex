...
\title{A proof of the conjectured linear recurrence for OEIS A304052}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304052}{A304052} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}
...
\begin{theorem} For A304052, the recurrence $a(n) = a(n-1) + 3\,a(n-2) + 8\,a(n-3) - 4\,a(n-4) - 16\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 28 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 11, 10, 51, 165, 306, 993,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304052}{A304052}, revision 4, last modified May 05 2018.
