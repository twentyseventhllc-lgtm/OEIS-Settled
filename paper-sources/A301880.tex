...
\title{A proof of the conjectured linear recurrence for OEIS A301880}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A301880}{A301880} as

\begin{quote}\itshape Number of n X 4 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +12*a(n-2) -2*a(n-3) -38*a(n-4) +a(n-5) +12*a(n-6) -a(n-8).\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 12\,a(n-2) - 2\,a(n-3) - 38\,a(n-4) + a(n-5) + 12\,a(n-6) - \\ a(n-8). \end{multline*}
...
\begin{theorem} For A301880, the recurrence $a(n) = a(n-1) + 12\,a(n-2) - 2\,a(n-3) - 38\,a(n-4) + a(n-5) + 12\,a(n-6) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 18, 58, 203, 673, 2340, 7883, 27175,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A301880}{A301880}, revision 6, last modified Jun 23 2026.
