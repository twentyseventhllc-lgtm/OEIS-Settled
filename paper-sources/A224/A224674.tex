...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224674}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224674}{A224674} as

\begin{quote}\itshape Number of (n+1) X 7 0..2 matrices with each 2 X 2 subblock idempotent\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(189 - 456*x + 143*x\textasciicircum{}2 + 292*x\textasciicircum{}3 - 187*x\textasciicircum{}4 + 10*x\textasciicircum{}5) / ((1 - x)\textasciicircum{}3*(1 - x - x\textasciicircum{}2)). - Colin Barker, Feb 17 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{189x - 456x^{2} + 143x^{3} + 292x^{4} - 187x^{5} + 10x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}.\]

\section{The object}

The name is read as follows. The reading is not a guess: it is pinned against the entry's own published terms, and against an independent enumeration, before anything is proved (Section 7).

Let $q = 3$ and let $A$ be an $n' \times 7$ matrix over $\{0,\dots,2\}$ with $n' = n + 1$ rows.
...
For scale: at $n = 8$ there are $3^{56}$ arrays, about $10^{27}$, against $10$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A224674, the recurrence $a(n) = 4\,a(n-1) - 5\,a(n-2) + a(n-3) + 2\,a(n-4) - a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,53$. The last nonvanishing one is at $m = 1$, that is at $n = 6$. After it, more than $S = 10$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

The entry claims the recurrence for $n > 6$. The theorem is at least as strong.

\begin{theorem} For A224674, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{189x - 456x^{2} + 143x^{3} + 292x^{4} - 187x^{5} + 10x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 189, 300, 398, 573, 793, 1126, 1608, 2343,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224674}{A224674}, revision 10, last modified Feb 17 2018.
