...
\title{A proof of the conjectured linear recurrence for OEIS A224199}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224199}{A224199} as

\begin{quote}\itshape Number of nX3 0..3 arrays with rows unimodal and antidiagonals nondecreasing\end{quote}
...
\begin{theorem} For A224199, the recurrence $a(n) = 20\,a(n-1) - 70\,a(n-2) + 228\,a(n-3) - 276\,a(n-4) + 392\,a(n-5) - 196\,a(n-6) + 144\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 50, 984, 16060, 263516, 4357084, 72105068, 1193130640, 19742052632,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224199}{A224199}, revision 8, last modified Oct 03 2025.
