...
\title{A proof of the conjectured closed form for OEIS A224413}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224413}{A224413} as

\begin{quote}\itshape Number of 6Xn 0..1 arrays with rows unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (1/479001600)*n\textasciicircum{}12 + (1/7257600)*n\textasciicircum{}11 + (199/43545600)*n\textasciicircum{}10 + (1/10752)*n\textasciicircum{}9 + (19951/14515200)*n\textasciicircum{}8 + (5143/345600)*n\textasciicircum{}7 + (6148357/43545600)*n\textasciicircum{}6 + (3015961/1451520)*n\textasciicircum{}5 + (128983289/10886400)*n\textasciicircum{}4 + (40193333/604800)*n\textasciicircum{}3 + (444089893/1663200)*n\textasciicircum{}2 - (4351/20)*n - 222 for n>4\end{quote}
...
\[a(n) = -222 - \frac{4351}{20}n + \frac{444089893}{1663200}n^{2} + \frac{40193333}{604800}n^{3} + \frac{128983289}{10886400}n^{4} + \frac{3015961}{1451520}n^{5} + \frac{6148357}{43545600}n^{6} + \frac{5143}{345600}n^{7} + \frac{19951}{14515200}n^{8} + \frac{1}{10752}n^{9} + \frac{199}{43545600}n^{10} + \frac{1}{7257600}n^{11} + \frac{1}{479001600}n^{12}.\]
...
\begin{theorem} For A224413, $a(n)$ is the polynomial $-222 - \frac{4351}{20}n + \frac{444089893}{1663200}n^{2} + \frac{40193333}{604800}n^{3} + \frac{128983289}{10886400}n^{4} + \frac{3015961}{1451520}n^{5} + \frac{6148357}{43545600}n^{6} + \frac{5143}{345600}n^{7} + \frac{19951}{14515200}n^{8} + \frac{1}{10752}n^{9} + \frac{199}{43545600}n^{10} + \frac{1}{7257600}n^{11} + \frac{1}{479001600}n^{12}$ for every $n > 4$, and not at $n = 4$.\end{theorem}

{\itshape Proof.} A polynomial of degree $12$ is annihilated by the difference operator $(E-1)^{13}$, whose characteristic polynomial is $(t-1)^{13}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 13 = 75$. Its values were computed exactly; the last nonvanishing one is at $n = 4$, and more than $75$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 64, 972, 4636, 13440, 31710, 68282, 139638, 275766,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224413}{A224413}, revision 8, last modified Oct 03 2025.
