...
\title{A proof of the conjectured linear recurrence for OEIS A224386}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224386}{A224386} as

\begin{quote}\itshape Number of nX3 0..3 arrays with diagonals and antidiagonals unimodal and rows nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 20*a(n-1) -70*a(n-2) -211*a(n-3) +2453*a(n-4) -12192*a(n-5) +5907*a(n-6) +119292*a(n-7) -294992*a(n-8) +742820*a(n-9) +144828*a(n-10) -5072952*a(n-11) +6034728*a(n-12) -15994872*a(n-13) -858096*a(n-14) -10368*a(n-15)\end{quote}
...
\begin{multline*} a(n) = 20\,a(n-1) - 70\,a(n-2) - 211\,a(n-3) + 2453\,a(n-4) - 12192\,a(n-5) + 5907\,a(n-6) + \\ 119292\,a(n-7) - 294992\,a(n-8) + 742820\,a(n-9) + 144828\,a(n-10) - 5072952\,a(n-11) + 6034728\,a(n-12) - \\ 15994872\,a(n-13) - 858096\,a(n-14) - 10368\,a(n-15). \end{multline*}
...
\begin{theorem} For A224386, the recurrence $a(n) = 20\,a(n-1) - 70\,a(n-2) - 211\,a(n-3) + 2453\,a(n-4) - 12192\,a(n-5) + 5907\,a(n-6) + 119292\,a(n-7) - 294992\,a(n-8) + 742820\,a(n-9) + 144828\,a(n-10) - 5072952\,a(n-11) + 6034728\,a(n-12) - 15994872\,a(n-13) - 858096\,a(n-14) - 10368\,a(n-15)$ holds for every $n \ge 16$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 6094, 86701, 1268572, 18794636, 279128617, 4142692993,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224386}{A224386}, revision 8, last modified Oct 03 2025.
