...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A224147}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224147}{A224147} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/720)*n\textasciicircum{}6 + (1/80)*n\textasciicircum{}5 + (23/144)*n\textasciicircum{}4 + (29/48)*n\textasciicircum{}3 + (241/180)*n\textasciicircum{}2 + (53/60)*n + 1.\end{quote}

\begin{quote}\ttfamily G.f.: x*(4 - 12*x + 21*x\textasciicircum{}2 - 23*x\textasciicircum{}3 + 16*x\textasciicircum{}4 - 6*x\textasciicircum{}5 + x\textasciicircum{}6) / (1 - x)\textasciicircum{}7.\end{quote}
...
\[a(n) = 1 + \frac{53}{60}n + \frac{241}{180}n^{2} + \frac{29}{48}n^{3} + \frac{23}{144}n^{4} + \frac{1}{80}n^{5} + \frac{1}{720}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{4x - 12x^{2} + 21x^{3} - 23x^{4} + 16x^{5} - 6x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A224147, $a(n)$ is the polynomial $1 + \frac{53}{60}n + \frac{241}{180}n^{2} + \frac{29}{48}n^{3} + \frac{23}{144}n^{4} + \frac{1}{80}n^{5} + \frac{1}{720}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A224147, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{4x - 12x^{2} + 21x^{3} - 23x^{4} + 16x^{5} - 6x^{6} + x^{7}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A224147, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 34 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 16, 49, 124, 275, 554, 1037, 1831,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224147}{A224147}, revision 8, last modified Aug 28 2018.
