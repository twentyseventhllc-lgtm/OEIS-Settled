...
\title{A proof of the conjectured closed form for OEIS A224052}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224052}{A224052} as

\begin{quote}\itshape Number of nX3 0..2 arrays with rows and columns unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (1/19160064)*n\textasciicircum{}12 + (5/3193344)*n\textasciicircum{}11 + (1627/43545600)*n\textasciicircum{}10 + (751/1451520)*n\textasciicircum{}9 + (3247/580608)*n\textasciicircum{}8 + (18607/483840)*n\textasciicircum{}7 + (11286841/43545600)*n\textasciicircum{}6 + (1893037/1451520)*n\textasciicircum{}5 + (2032151/435456)*n\textasciicircum{}4 + (1618571/362880)*n\textasciicircum{}3 + (7125527/831600)*n\textasciicircum{}2 + (241067/27720)*n - 9 for n>1\end{quote}
...
\[a(n) = -9 + \frac{241067}{27720}n + \frac{7125527}{831600}n^{2} + \frac{1618571}{362880}n^{3} + \frac{2032151}{435456}n^{4} + \frac{1893037}{1451520}n^{5} + \frac{11286841}{43545600}n^{6} + \frac{18607}{483840}n^{7} + \frac{3247}{580608}n^{8} + \frac{751}{1451520}n^{9} + \frac{1627}{43545600}n^{10} + \frac{5}{3193344}n^{11} + \frac{1}{19160064}n^{12}.\]
...
\begin{theorem} For A224052, $a(n)$ is the polynomial $-9 + \frac{241067}{27720}n + \frac{7125527}{831600}n^{2} + \frac{1618571}{362880}n^{3} + \frac{2032151}{435456}n^{4} + \frac{1893037}{1451520}n^{5} + \frac{11286841}{43545600}n^{6} + \frac{18607}{483840}n^{7} + \frac{3247}{580608}n^{8} + \frac{751}{1451520}n^{9} + \frac{1627}{43545600}n^{10} + \frac{5}{3193344}n^{11} + \frac{1}{19160064}n^{12}$ for every $n > 1$, and not at $n = 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $12$ is annihilated by the difference operator $(E-1)^{13}$, whose characteristic polynomial is $(t-1)^{13}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 13 = 51$. Its values were computed exactly; the last nonvanishing one is at $n = 1$, and more than $51$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 22, 218, 1232, 5219, 18502, 57911, 164781, 433762,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224052}{A224052}, revision 8, last modified Oct 03 2025.
