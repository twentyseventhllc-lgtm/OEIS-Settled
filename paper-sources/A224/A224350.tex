...
\title{A proof of the conjectured order of the recurrence for OEIS A224350}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224350}{A224350} as

\begin{quote}\itshape Number of nX5 0..2 arrays with diagonals and antidiagonals unimodal and rows nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical recurrence of order 56 (see link above)\end{quote}
...
The entry states only that the sequence satisfies a linear recurrence of order $56$ and refers to a linked file for its coefficients, which this note does not use. What is proved below is the corresponding exact statement: the least order of a linear recurrence the sequence eventually satisfies, and the exact index beyond which it holds.
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 21, 441, 5840, 57387, 495985, 4231138, 37433596, 342170839,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224350}{A224350}, revision 10, last modified Oct 03 2025.
