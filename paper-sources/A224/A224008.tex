...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224008}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224008}{A224008} as

\begin{quote}\itshape Number of n X 4 0..2 arrays with rows nondecreasing and antidiagonals unimodal\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 15*a(n-1) - 58*a(n-2) + 105*a(n-3) + 20*a(n-4) - 183*a(n-5) + 220*a(n-6) + 240*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(15 + 156*x\textasciicircum{}2 + 101*x\textasciicircum{}3 + 157*x\textasciicircum{}4 + 460*x\textasciicircum{}5 + 240*x\textasciicircum{}6) / (1 - 15*x + 58*x\textasciicircum{}2 - 105*x\textasciicircum{}3 - 20*x\textasciicircum{}4 + 183*x\textasciicircum{}5 - 220*x\textasciicircum{}6 - 240*x\textasciicircum{}7). - Colin Barker, Aug 26 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{15x + 156x^{3} + 101x^{4} + 157x^{5} + 460x^{6} + 240x^{7}}{1 - 15x + 58x^{2} - 105x^{3} - 20x^{4} + 183x^{5} - 220x^{6} - 240x^{7}}.\]
...
\begin{theorem} For A224008, the recurrence $a(n) = 15\,a(n-1) - 58\,a(n-2) + 105\,a(n-3) + 20\,a(n-4) - 183\,a(n-5) + 220\,a(n-6) + 240\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,42$. Every one of them vanished. After it, more than $S = 12$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A224008, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{15x + 156x^{3} + 101x^{4} + 157x^{5} + 460x^{6} + 240x^{7}}{1 - 15x + 58x^{2} - 105x^{3} - 20x^{4} + 183x^{5} - 220x^{6} - 240x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 17 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 15, 225, 2661, 28541, 297859, 3094127, 32148473, 334179881,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224008}{A224008}, revision 8, last modified Aug 26 2018.
