...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A224148}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224148}{A224148} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/40320)*n\textasciicircum{}8 + (1/3360)*n\textasciicircum{}7 + (1/192)*n\textasciicircum{}6 + (1/16)*n\textasciicircum{}5 + (223/640)*n\textasciicircum{}4 + (149/160)*n\textasciicircum{}3 + (3319/2016)*n\textasciicircum{}2 + (169/168)*n + 1.\end{quote}

\begin{quote}\ttfamily G.f.: x*(5 - 20*x + 47*x\textasciicircum{}2 - 76*x\textasciicircum{}3 + 85*x\textasciicircum{}4 - 62*x\textasciicircum{}5 + 29*x\textasciicircum{}6 - 8*x\textasciicircum{}7 + x\textasciicircum{}8) / (1 - x)\textasciicircum{}9.\end{quote}
...
\[a(n) = 1 + \frac{169}{168}n + \frac{3319}{2016}n^{2} + \frac{149}{160}n^{3} + \frac{223}{640}n^{4} + \frac{1}{16}n^{5} + \frac{1}{192}n^{6} + \frac{1}{3360}n^{7} + \frac{1}{40320}n^{8}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{5x - 20x^{2} + 47x^{3} - 76x^{4} + 85x^{5} - 62x^{6} + 29x^{7} - 8x^{8} + x^{9}}{1 - 9x + 36x^{2} - 84x^{3} + 126x^{4} - 126x^{5} + 84x^{6} - 36x^{7} + 9x^{8} - x^{9}}.\]
...
\begin{theorem} For A224148, $a(n)$ is the polynomial $1 + \frac{169}{168}n + \frac{3319}{2016}n^{2} + \frac{149}{160}n^{3} + \frac{223}{640}n^{4} + \frac{1}{16}n^{5} + \frac{1}{192}n^{6} + \frac{1}{3360}n^{7} + \frac{1}{40320}n^{8}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A224148, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{5x - 20x^{2} + 47x^{3} - 76x^{4} + 85x^{5} - 62x^{6} + 29x^{7} - 8x^{8} + x^{9}}{1 - 9x + 36x^{2} - 84x^{3} + 126x^{4} - 126x^{5} + 84x^{6} - 36x^{7} + 9x^{8} - x^{9}}$.\end{theorem}
...
\begin{theorem} For A224148, the recurrence $a(n) = 9\,a(n-1) - 36\,a(n-2) + 84\,a(n-3) - 126\,a(n-4) + 126\,a(n-5) - 84\,a(n-6) + 36\,a(n-7) - 9\,a(n-8) + a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. Every one of them vanished. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 31 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 25, 92, 272, 691, 1573, 3296, 6472,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224148}{A224148}, revision 8, last modified Aug 28 2018.
