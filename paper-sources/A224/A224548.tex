...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224548}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224548}{A224548} as

\begin{quote}\itshape Number of (n+1) X 7 0..1 matrices with each 2 X 2 subblock idempotent\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(132 - 310*x + 90*x\textasciicircum{}2 + 198*x\textasciicircum{}3 - 129*x\textasciicircum{}4 + 10*x\textasciicircum{}5) / ((1 - x)\textasciicircum{}3*(1 - x - x\textasciicircum{}2)). - Colin Barker, Aug 31 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{132x - 310x^{2} + 90x^{3} + 198x^{4} - 129x^{5} + 10x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}.\]

\section{The object}

The name is read as follows. The reading is not a guess: it is pinned against the entry's own published terms, and against an independent enumeration, before anything is proved (Section 7).

Let $q = 2$ and let $A$ be an $n' \times 7$ matrix over $\{0,\dots,1\}$ with $n' = n + 1$ rows.
...
\begin{theorem} For A224548, the recurrence $a(n) = 4\,a(n-1) - 5\,a(n-2) + a(n-3) + 2\,a(n-4) - a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For A224548, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{132x - 310x^{2} + 90x^{3} + 198x^{4} - 129x^{5} + 10x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 132, 218, 302, 448, 635, 916, 1323, 1941,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224548}{A224548}, revision 7, last modified Aug 31 2018.
