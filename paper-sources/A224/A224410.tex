...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A224410}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224410}{A224410} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays with rows unimodal and antidiagonals nondecreasing\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/720)*n\textasciicircum{}6 + (1/48)*n\textasciicircum{}5 + (29/144)*n\textasciicircum{}4 + (13/16)*n\textasciicircum{}3 + (2087/360)*n\textasciicircum{}2 + (7/6)*n.\end{quote}

\begin{quote}\ttfamily G.f.: x*(8 - 20*x + 16*x\textasciicircum{}2 + 4*x\textasciicircum{}3 - 11*x\textasciicircum{}4 + 4*x\textasciicircum{}5) / (1 - x)\textasciicircum{}7.\end{quote}
...
\[a(n) = \frac{7}{6}n + \frac{2087}{360}n^{2} + \frac{13}{16}n^{3} + \frac{29}{144}n^{4} + \frac{1}{48}n^{5} + \frac{1}{720}n^{6}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{8x - 20x^{2} + 16x^{3} + 4x^{4} - 11x^{5} + 4x^{6}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}.\]
...
\begin{theorem} For A224410, $a(n)$ is the polynomial $\frac{7}{6}n + \frac{2087}{360}n^{2} + \frac{13}{16}n^{3} + \frac{29}{144}n^{4} + \frac{1}{48}n^{5} + \frac{1}{720}n^{6}$ for every $n \ge 1$.\end{theorem}
...
\begin{theorem} For A224410, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{8x - 20x^{2} + 16x^{3} + 4x^{4} - 11x^{5} + 4x^{6}}{1 - 7x + 21x^{2} - 35x^{3} + 35x^{4} - 21x^{5} + 7x^{6} - x^{7}}$.\end{theorem}
...
\begin{theorem} For A224410, the recurrence $a(n) = 7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,58$. Every one of them vanished. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 34 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 36, 100, 228, 465, 879, 1568, 2668,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224410}{A224410}, revision 8, last modified Aug 30 2018.
