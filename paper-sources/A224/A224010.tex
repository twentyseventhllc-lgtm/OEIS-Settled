...
\title{A proof of the conjectured linear recurrence for OEIS A224010}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224010}{A224010} as

\begin{quote}\itshape Number of n X 6 0..2 arrays with rows nondecreasing and antidiagonals unimodal\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 28*a(n-1) -283*a(n-2) +1386*a(n-3) -3562*a(n-4) +4940*a(n-5) -3840*a(n-6) -14256*a(n-7) +50007*a(n-8) -26386*a(n-9) +141154*a(n-10) +250789*a(n-11) +41356*a(n-12) +274344*a(n-13) +134400*a(n-14)\end{quote}
...
\begin{theorem} For A224010, the recurrence $a(n) = 28\,a(n-1) - 283\,a(n-2) + 1386\,a(n-3) - 3562\,a(n-4) + 4940\,a(n-5) - 3840\,a(n-6) - 14256\,a(n-7) + 50007\,a(n-8) - 26386\,a(n-9) + 141154\,a(n-10) + 250789\,a(n-11) + 41356\,a(n-12) + 274344\,a(n-13) + 134400\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,93$. Every one of them vanished. After it, more than $S = 57$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 28, 784, 15340, 245055, 3516324, 47735665, 630339756, 8213689391,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224010}{A224010}, revision 10, last modified Sep 18 2025.
