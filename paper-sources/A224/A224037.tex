...
\title{A proof of the conjectured linear recurrence for OEIS A224037}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224037}{A224037} as

\begin{quote}\itshape Number of nX7 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 8*a(n-1) -21*a(n-2) +15*a(n-3) +15*a(n-4) -16*a(n-5) -9*a(n-6) +12*a(n-7) -8*a(n-8) +10*a(n-9) -12*a(n-10) +16*a(n-11) -16*a(n-12) +32*a(n-13) for n>16\end{quote}
...
\begin{multline*} a(n) = 8\,a(n-1) - 21\,a(n-2) + 15\,a(n-3) + 15\,a(n-4) - 16\,a(n-5) - 9\,a(n-6) + \\ 12\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) - 12\,a(n-10) + 16\,a(n-11) - 16\,a(n-12) + \\ 32\,a(n-13). \end{multline*}
...
\begin{theorem} For A224037, the recurrence $a(n) = 8\,a(n-1) - 21\,a(n-2) + 15\,a(n-3) + 15\,a(n-4) - 16\,a(n-5) - 9\,a(n-6) + 12\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) - 12\,a(n-10) + 16\,a(n-11) - 16\,a(n-12) + 32\,a(n-13)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,68$. The last nonvanishing one is at $m = 3$, that is at $n = 16$. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 43, 161, 508, 1505, 4395, 12856, 37808,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224037}{A224037}, revision 8, last modified Oct 03 2025.
