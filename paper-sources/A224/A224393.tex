...
\title{A proof of the conjectured closed form for OEIS A224393}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224393}{A224393} as

\begin{quote}\itshape Number of 4Xn 0..3 arrays with diagonals and antidiagonals unimodal and rows nondecreasing\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (3551/47900160)*n\textasciicircum{}12 + (17561/13305600)*n\textasciicircum{}11 + (410317/21772800)*n\textasciicircum{}10 + (127787/725760)*n\textasciicircum{}9 + (394837/290304)*n\textasciicircum{}8 + (4724393/1209600)*n\textasciicircum{}7 + (880093831/21772800)*n\textasciicircum{}6 - (673403/80640)*n\textasciicircum{}5 + (476636641/1088640)*n\textasciicircum{}4 + (58121267/907200)*n\textasciicircum{}3 - (1924453/415800)*n\textasciicircum{}2 - (1998055/2772)*n + 1906 for n>4\end{quote}
...
\[a(n) = 1906 - \frac{1998055}{2772}n - \frac{1924453}{415800}n^{2} + \frac{58121267}{907200}n^{3} + \frac{476636641}{1088640}n^{4} - \frac{673403}{80640}n^{5} + \frac{880093831}{21772800}n^{6} + \frac{4724393}{1209600}n^{7} + \frac{394837}{290304}n^{8} + \frac{127787}{725760}n^{9} + \frac{410317}{21772800}n^{10} + \frac{17561}{13305600}n^{11} + \frac{3551}{47900160}n^{12}.\]
...
\begin{theorem} For A224393, $a(n)$ is the polynomial $1906 - \frac{1998055}{2772}n - \frac{1924453}{415800}n^{2} + \frac{58121267}{907200}n^{3} + \frac{476636641}{1088640}n^{4} - \frac{673403}{80640}n^{5} + \frac{880093831}{21772800}n^{6} + \frac{4724393}{1209600}n^{7} + \frac{394837}{290304}n^{8} + \frac{127787}{725760}n^{9} + \frac{410317}{21772800}n^{10} + \frac{17561}{13305600}n^{11} + \frac{3551}{47900160}n^{12}$ for every $n > 4$, and not at $n = 4$.\end{theorem}

{\itshape Proof.} A polynomial of degree $12$ is annihilated by the difference operator $(E-1)^{13}$, whose characteristic polynomial is $(t-1)^{13}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 13 = 123$. Its values were computed exactly; the last nonvanishing one is at $n = 4$, and more than $123$ consecutive vanishing values follow, so every later one vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 256, 10000, 86701, 497958, 2332222, 9331553, 32806574, 103452812,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224393}{A224393}, revision 8, last modified Oct 03 2025.
