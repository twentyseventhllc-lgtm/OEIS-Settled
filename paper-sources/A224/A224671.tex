...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224671}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224671}{A224671} as

\begin{quote}\itshape Number of (n+1) X 4 0..2 matrices with each 2 X 2 subblock idempotent\end{quote}
...
\begin{quote}\ttfamily G.f.: x*(41 - 88*x + 9*x\textasciicircum{}2 + 77*x\textasciicircum{}3 - 41*x\textasciicircum{}4 + x\textasciicircum{}5) / ((1 - x)\textasciicircum{}3*(1 - x - x\textasciicircum{}2)).\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{41x - 88x^{2} + 9x^{3} + 77x^{4} - 41x^{5} + x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}.\]

\section{The object}

The name is read as follows. The reading is not a guess: it is pinned against the entry's own published terms, and against an independent enumeration, before anything is proved (Section 7).

Let $q = 3$ and let $A$ be an $n' \times 4$ matrix over $\{0,\dots,2\}$ with $n' = n + 1$ rows.
...
\begin{theorem} For A224671, the recurrence $a(n) = 4\,a(n-1) - 5\,a(n-2) + a(n-3) + 2\,a(n-4) - a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For A224671, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{41x - 88x^{2} + 9x^{3} + 77x^{4} - 41x^{5} + x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 33 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 41, 76, 108, 170, 257, 398, 617, 967,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224671}{A224671}, revision 7, last modified Feb 17 2018.
