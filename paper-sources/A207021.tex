...
\title{A proof of the conjectured closed form for OEIS A207021}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207021}{A207021} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = (13/6)*n\textasciicircum{}4 + 13*n\textasciicircum{}3 + (52/3)*n\textasciicircum{}2 - (39/2)*n.\end{quote}
...
\[a(n) = -\frac{39}{2}n + \frac{52}{3}n^{2} + 13n^{3} + \frac{13}{6}n^{4}.\]
...
\begin{theorem} For A207021, $a(n)$ is the polynomial $-\frac{39}{2}n + \frac{52}{3}n^{2} + 13n^{3} + \frac{13}{6}n^{4}$ for every $n \ge 1$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 32 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 624, 1586, 3315, 6123, 10374, 16484,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207021}{A207021}, revision 12, last modified Oct 03 2025.
