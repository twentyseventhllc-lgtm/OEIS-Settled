...
\title{A proof of the conjectured linear recurrence for OEIS A304266}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304266}{A304266} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $20$; neither removal changes any count.
...
\begin{theorem} For A304266, the recurrence $a(n) = a(n-1) + a(n-2) + 5\,a(n-3) + a(n-4) - 3\,a(n-5) - 3\,a(n-6)$ holds for every $n > 7$, and fails at $n = 7$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 5, 10, 21, 50, 116, 259, 601,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304266}{A304266}, revision 4, last modified May 09 2018.
