...
k=2: a(n) = 3*a(n-2) +4*a(n-3) +2*a(n-4)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Jan 07 2018). As of revision 4, last modified Jan 07 2018, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
