...
\title{A proof of the conjectured linear recurrence for OEIS A316284}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316284}{A316284} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 3, 6 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +a(n-2) +6*a(n-3) -23*a(n-4) -22*a(n-5) +7*a(n-6) +27*a(n-7) +24*a(n-8) -18*a(n-9) -10*a(n-10) for n>12.\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + a(n-2) + 6\,a(n-3) - 23\,a(n-4) - 22\,a(n-5) + 7\,a(n-6) + \\ 27\,a(n-7) + 24\,a(n-8) - 18\,a(n-9) - 10\,a(n-10). \end{multline*}
...
\begin{theorem} For A316284, the recurrence $a(n) = 3\,a(n-1) + a(n-2) + 6\,a(n-3) - 23\,a(n-4) - 22\,a(n-5) + 7\,a(n-6) + 27\,a(n-7) + 24\,a(n-8) - 18\,a(n-9) - 10\,a(n-10)$ holds for every $n > 12$, and fails at $n = 12$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. The last nonvanishing one is at $m = 2$, that is at $n = 12$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 21, 42, 125, 361, 987, 2840, 8177,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316284}{A316284}, revision 6, last modified Sep 03 2022.
