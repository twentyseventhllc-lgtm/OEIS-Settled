...
\title{A proof of the conjectured linear recurrence for OEIS A303097}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303097}{A303097} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +9*a(n-2) -14*a(n-3) -28*a(n-4) -6*a(n-5) +32*a(n-6) +10*a(n-7) -2*a(n-8) +32*a(n-9) -32*a(n-11).\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 18 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Jun 21 2022, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 5\,a(n-1) + 9\,a(n-2) - 14\,a(n-3) - 28\,a(n-4) - 6\,a(n-5) + 32\,a(n-6) + \\ 10\,a(n-7) - 2\,a(n-8) + 32\,a(n-9) - 32\,a(n-11). \end{multline*}
...
\begin{theorem} For A303097, the recurrence $a(n) = 5\,a(n-1) + 9\,a(n-2) - 14\,a(n-3) - 28\,a(n-4) - 6\,a(n-5) + 32\,a(n-6) + 10\,a(n-7) - 2\,a(n-8) + 32\,a(n-9) - 32\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 15, 77, 486, 2869, 17229, 102952, 616065,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303097}{A303097}, revision 6, last modified Jun 21 2022.
