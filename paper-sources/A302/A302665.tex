...
\title{A proof of the conjectured linear recurrence for OEIS A302665}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302665}{A302665} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +4*a(n-2) -11*a(n-3) -27*a(n-4) -12*a(n-5) +85*a(n-6) +22*a(n-7) -22*a(n-8) -108*a(n-9) +72*a(n-10) -80*a(n-11) +120*a(n-12) +64*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 4\,a(n-2) - 11\,a(n-3) - 27\,a(n-4) - 12\,a(n-5) + 85\,a(n-6) + \\ 22\,a(n-7) - 22\,a(n-8) - 108\,a(n-9) + 72\,a(n-10) - 80\,a(n-11) + 120\,a(n-12) + \\ 64\,a(n-14). \end{multline*}
...
\begin{theorem} For A302665, the recurrence $a(n) = 4\,a(n-1) + 4\,a(n-2) - 11\,a(n-3) - 27\,a(n-4) - 12\,a(n-5) + 85\,a(n-6) + 22\,a(n-7) - 22\,a(n-8) - 108\,a(n-9) + 72\,a(n-10) - 80\,a(n-11) + 120\,a(n-12) + 64\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 14, 43, 194, 691, 2802, 10660, 41839,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302665}{A302665}, revision 4, last modified Apr 11 2018.
