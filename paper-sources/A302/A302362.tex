...
\title{A proof of the conjectured linear recurrence for OEIS A302362}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302362}{A302362} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -3*a(n-2) +9*a(n-3) -9*a(n-4) -11*a(n-5) +a(n-6) -18*a(n-7) +16*a(n-8) -12*a(n-9) -4*a(n-10) +4*a(n-11) +8*a(n-12)\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 3\,a(n-2) + 9\,a(n-3) - 9\,a(n-4) - 11\,a(n-5) + a(n-6) - \\ 18\,a(n-7) + 16\,a(n-8) - 12\,a(n-9) - 4\,a(n-10) + 4\,a(n-11) + 8\,a(n-12). \end{multline*}
...
\begin{theorem} For A302362, the recurrence $a(n) = 4\,a(n-1) - 3\,a(n-2) + 9\,a(n-3) - 9\,a(n-4) - 11\,a(n-5) + a(n-6) - 18\,a(n-7) + 16\,a(n-8) - 12\,a(n-9) - 4\,a(n-10) + 4\,a(n-11) + 8\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 12, 31, 109, 397, 1430, 5110, 18395,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302362}{A302362}, revision 4, last modified Apr 06 2018.
