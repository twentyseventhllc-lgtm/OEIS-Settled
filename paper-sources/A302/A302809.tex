...
\title{A proof of the conjectured linear recurrence for OEIS A302809}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302809}{A302809} as

\begin{quote}\itshape Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +14*a(n-2) +2*a(n-3) -22*a(n-4) +3*a(n-5) +37*a(n-6) -19*a(n-7) -4*a(n-8) +24*a(n-9) -4*a(n-10) +11*a(n-11) +8*a(n-12) +2*a(n-13) for n>15\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 14\,a(n-2) + 2\,a(n-3) - 22\,a(n-4) + 3\,a(n-5) + 37\,a(n-6) - \\ 19\,a(n-7) - 4\,a(n-8) + 24\,a(n-9) - 4\,a(n-10) + 11\,a(n-11) + 8\,a(n-12) + \\ 2\,a(n-13). \end{multline*}
...
\begin{theorem} For A302809, the recurrence $a(n) = 3\,a(n-1) + 14\,a(n-2) + 2\,a(n-3) - 22\,a(n-4) + 3\,a(n-5) + 37\,a(n-6) - 19\,a(n-7) - 4\,a(n-8) + 24\,a(n-9) - 4\,a(n-10) + 11\,a(n-11) + 8\,a(n-12) + 2\,a(n-13)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,57$. The last nonvanishing one is at $m = 2$, that is at $n = 15$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 32, 169, 934, 5117, 28128, 154494, 848519,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302809}{A302809}, revision 4, last modified Apr 13 2018.
