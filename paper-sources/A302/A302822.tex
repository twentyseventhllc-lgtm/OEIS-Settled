...
\title{A proof of the conjectured order of the recurrence for OEIS A302822}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302822}{A302822} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 6, last modified Apr 13 2018, the entry records no proof and links to none, so the statement is open. This note settles it.
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 81, 389, 1494, 6905, 34957, 170262, 800847,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302822}{A302822}, revision 6, last modified Apr 13 2018.
