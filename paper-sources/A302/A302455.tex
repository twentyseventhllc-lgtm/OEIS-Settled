...
\title{A proof of the conjectured linear recurrence for OEIS A302455}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302455}{A302455} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) -2*a(n-2) +13*a(n-3) -23*a(n-4) +12*a(n-5) -42*a(n-6) +32*a(n-7) -24*a(n-8) -18*a(n-9) +24*a(n-10) +40*a(n-11) +32*a(n-12)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) - 2\,a(n-2) + 13\,a(n-3) - 23\,a(n-4) + 12\,a(n-5) - 42\,a(n-6) + \\ 32\,a(n-7) - 24\,a(n-8) - 18\,a(n-9) + 24\,a(n-10) + 40\,a(n-11) + 32\,a(n-12). \end{multline*}
...
\begin{theorem} For A302455, the recurrence $a(n) = 3\,a(n-1) - 2\,a(n-2) + 13\,a(n-3) - 23\,a(n-4) + 12\,a(n-5) - 42\,a(n-6) + 32\,a(n-7) - 24\,a(n-8) - 18\,a(n-9) + 24\,a(n-10) + 40\,a(n-11) + 32\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 11, 18, 55, 177, 474, 1397, 4135,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302455}{A302455}, revision 4, last modified Apr 08 2018.
