...
\title{A proof of the conjectured linear recurrence for OEIS A302626}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302626}{A302626} as

\begin{quote}\itshape Number of 5 X n 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) -2*a(n-2) -2*a(n-3) -8*a(n-4) +23*a(n-6) -a(n-7) -11*a(n-8) -16*a(n-9) +17*a(n-10) +2*a(n-11) -5*a(n-12) -5*a(n-13) +3*a(n-14) +3*a(n-15) -a(n-16) for n>21.\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) - 2\,a(n-2) - 2\,a(n-3) - 8\,a(n-4) + 23\,a(n-6) - a(n-7) - \\ 11\,a(n-8) - 16\,a(n-9) + 17\,a(n-10) + 2\,a(n-11) - 5\,a(n-12) - 5\,a(n-13) + \\ 3\,a(n-14) + 3\,a(n-15) - a(n-16). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $434$; neither removal changes any count.
...
That refinement leaves $41$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 31$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $2^{40}$ arrays, about $10^{12}$, against $31$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A302626, the recurrence $a(n) = 4\,a(n-1) - 2\,a(n-2) - 2\,a(n-3) - 8\,a(n-4) + 23\,a(n-6) - a(n-7) - 11\,a(n-8) - 16\,a(n-9) + 17\,a(n-10) + 2\,a(n-11) - 5\,a(n-12) - 5\,a(n-13) + 3\,a(n-14) + 3\,a(n-15) - a(n-16)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,78$. The last nonvanishing one is at $m = 5$, that is at $n = 21$. After it, more than $S = 31$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 264, 191, 367, 896, 2229, 5771, 15303,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302626}{A302626}, revision 6, last modified Mar 27 2023.
