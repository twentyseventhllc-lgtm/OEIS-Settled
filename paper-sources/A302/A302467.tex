...
\title{A proof of the conjectured linear recurrence for OEIS A302467}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302467}{A302467} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +9*a(n-2) +15*a(n-3) -68*a(n-4) -132*a(n-5) +96*a(n-6) +136*a(n-7) -34*a(n-8) -276*a(n-9) +188*a(n-10) -8*a(n-11) +32*a(n-12) -16*a(n-13) +64*a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 9\,a(n-2) + 15\,a(n-3) - 68\,a(n-4) - 132\,a(n-5) + 96\,a(n-6) + \\ 136\,a(n-7) - 34\,a(n-8) - 276\,a(n-9) + 188\,a(n-10) - 8\,a(n-11) + 32\,a(n-12) - \\ 16\,a(n-13) + 64\,a(n-14). \end{multline*}
...
\begin{theorem} For A302467, the recurrence $a(n) = 3\,a(n-1) + 9\,a(n-2) + 15\,a(n-3) - 68\,a(n-4) - 132\,a(n-5) + 96\,a(n-6) + 136\,a(n-7) - 34\,a(n-8) - 276\,a(n-9) + 188\,a(n-10) - 8\,a(n-11) + 32\,a(n-12) - 16\,a(n-13) + 64\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 14, 49, 250, 1147, 5486, 25599, 121626,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302467}{A302467}, revision 4, last modified Apr 08 2018.
