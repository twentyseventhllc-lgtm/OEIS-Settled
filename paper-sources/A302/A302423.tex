...
\title{A proof of the conjectured linear recurrence for OEIS A302423}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302423}{A302423} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +11*a(n-3) -2*a(n-4) -3*a(n-5) -19*a(n-6) -5*a(n-7) -20*a(n-8) -60*a(n-9) -2*a(n-10) +10*a(n-11) +78*a(n-12) +30*a(n-13) +118*a(n-14) +191*a(n-15) +14*a(n-16) -14*a(n-17) -50*a(n-18) -165*a(n-20) -332*a(n-21) -84*a(n-22) -37*a(n-23) -86*a(n-24) -81*a(n-25) +40*a(n-26) +237*a(n-27) +110*a(n-28) +27*a(n-29) +62*a(n-30) +53*a(n-31) +27*a(n-32) -44*a(n-33) -26*a(n-34) -19*a(n-35) -21*a(n-36) -a(n-37) +2*a(n-38) +10*a(n-39) +a(n-40) -a(n-42) for n>43\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 11\,a(n-3) - 2\,a(n-4) - 3\,a(n-5) - 19\,a(n-6) - \\ 5\,a(n-7) - 20\,a(n-8) - 60\,a(n-9) - 2\,a(n-10) + 10\,a(n-11) + 78\,a(n-12) + \\ 30\,a(n-13) + 118\,a(n-14) + 191\,a(n-15) + 14\,a(n-16) - 14\,a(n-17) - 50\,a(n-18) - \\ 165\,a(n-20) - 332\,a(n-21) - 84\,a(n-22) - 37\,a(n-23) - 86\,a(n-24) - 81\,a(n-25) + \\ 40\,a(n-26) + 237\,a(n-27) + 110\,a(n-28) + 27\,a(n-29) + 62\,a(n-30) + 53\,a(n-31) + \\ 27\,a(n-32) - 44\,a(n-33) - 26\,a(n-34) - 19\,a(n-35) - 21\,a(n-36) - a(n-37) + \\ 2\,a(n-38) + 10\,a(n-39) + a(n-40) - a(n-42). \end{multline*}
...
\begin{theorem} For A302423, the recurrence of order $42$ displayed in Section 1 holds for every $n > 43$, and fails at $n = 43$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,118$. The last nonvanishing one is at $m = 1$, that is at $n = 43$. After it, more than $S = 43$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 5, 17, 21, 42, 148, 362, 879, 2447,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302423}{A302423}, revision 4, last modified Apr 07 2018.
