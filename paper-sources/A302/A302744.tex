...
\title{A proof of the conjectured order of the recurrence for OEIS A302744}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302744}{A302744} as

\begin{quote}\itshape Number of 5Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical recurrence of order 64 (see link above)\end{quote}
...
\item {\bfseries The published terms.} The walk count reproduces all 15 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 16, 512, 11980, 286631, 6947036, 168799572, 4104115772, 99818649293,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302744}{A302744}, revision 4, last modified Apr 12 2018.
