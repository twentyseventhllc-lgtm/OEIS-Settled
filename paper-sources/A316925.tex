...
\title{Proofs of the conjectured column and row recurrences for OEIS A316925}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316925}{A316925} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element unequal to 0, 1, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = a(n-1) +a(n-2)\\k=2: a(n) = 2*a(n-1) -a(n-2) +8*a(n-3) -8*a(n-4)\\k=3: [order 17] for n>19\\k=4: [order 51] for n>55\end{quote}
...
\begin{theorem} For column $k = 1$ of A316925, the recurrence $a(n) = a(n-1) + a(n-2)$ holds for every $n \ge 3$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A316925, the recurrence $a(n) = 2\,a(n-1) - a(n-2) + 8\,a(n-3) - 8\,a(n-4)$ holds for every $n \ge 5$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A316925, the recurrence $a(n) = 0$ holds for every $n > 19$, and fails at $n = 19$.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A316925, the recurrence $a(n) = 0$ holds for every $n > 55$, and fails at $n = 55$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316925}{A316925}, revision 4, last modified Jul 16 2018.
