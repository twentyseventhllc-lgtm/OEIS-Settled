...
\title{A proof of the conjectured linear recurrence for OEIS A299583}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299583}{A299583} as

\begin{quote}\itshape Number of n X 3 0..1 arrays with every element equal to 1, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +5*a(n-3) -19*a(n-4) -16*a(n-5) +10*a(n-6) +32*a(n-7) -30*a(n-9) +75*a(n-10) +16*a(n-11) -99*a(n-12) -51*a(n-13) +52*a(n-14) +25*a(n-15) -4*a(n-16) +a(n-17) -2*a(n-18) -a(n-19) for n>20.\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 3\,a(n-2) + 5\,a(n-3) - 19\,a(n-4) - 16\,a(n-5) + 10\,a(n-6) + \\ 32\,a(n-7) - 30\,a(n-9) + 75\,a(n-10) + 16\,a(n-11) - 99\,a(n-12) - 51\,a(n-13) + \\ 52\,a(n-14) + 25\,a(n-15) - 4\,a(n-16) + a(n-17) - 2\,a(n-18) - a(n-19). \end{multline*}
...
The condition is $c(i,j) \in \{1, 3, 4, 5, 7, 8\}$ for every cell of the array, together with $A[0][0]=0$.
...
\begin{theorem} For A299583, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) + 5\,a(n-3) - 19\,a(n-4) - 16\,a(n-5) + 10\,a(n-6) + 32\,a(n-7) - 30\,a(n-9) + 75\,a(n-10) + 16\,a(n-11) - 99\,a(n-12) - 51\,a(n-13) + 52\,a(n-14) + 25\,a(n-15) - 4\,a(n-16) + a(n-17) - 2\,a(n-18) - a(n-19)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 4, 1, 8, 12, 31, 117, 263,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299583}{A299583}, revision 6, last modified Jan 01 2024.
