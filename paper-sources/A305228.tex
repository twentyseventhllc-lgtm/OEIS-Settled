...
\title{A proof of the conjectured linear recurrence for OEIS A305228}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305228}{A305228} as

\begin{quote}\itshape Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 3 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +a(n-2) -26*a(n-3) +5*a(n-4) +45*a(n-5) +11*a(n-6) -33*a(n-7) -49*a(n-8) +14*a(n-9) +29*a(n-10) +2*a(n-11) +21*a(n-12) -20*a(n-13) -21*a(n-14) +17*a(n-15) +4*a(n-16) -4*a(n-17) for n>22\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + a(n-2) - 26\,a(n-3) + 5\,a(n-4) + 45\,a(n-5) + 11\,a(n-6) - \\ 33\,a(n-7) - 49\,a(n-8) + 14\,a(n-9) + 29\,a(n-10) + 2\,a(n-11) + 21\,a(n-12) - \\ 20\,a(n-13) - 21\,a(n-14) + 17\,a(n-15) + 4\,a(n-16) - 4\,a(n-17). \end{multline*}
...
The construction gives $4160$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $525$; neither removal changes any count.
...
That refinement leaves $53$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 35$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A305228, the recurrence $a(n) = 5\,a(n-1) + a(n-2) - 26\,a(n-3) + 5\,a(n-4) + 45\,a(n-5) + 11\,a(n-6) - 33\,a(n-7) - 49\,a(n-8) + 14\,a(n-9) + 29\,a(n-10) + 2\,a(n-11) + 21\,a(n-12) - 20\,a(n-13) - 21\,a(n-14) + 17\,a(n-15) + 4\,a(n-16) - 4\,a(n-17)$ holds for every $n > 22$, and fails at $n = 22$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,81$. The last nonvanishing one is at $m = 5$, that is at $n = 22$. After it, more than $S = 35$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 32, 293, 236, 541, 2050, 7062, 26528, 96528,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305228}{A305228}, revision 4, last modified May 27 2018.
