...
\title{A proof of the conjectured linear recurrence for OEIS A252426}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A252426}{A252426} as

\begin{quote}\itshape Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 11*a(n-3) -39*a(n-6) +57*a(n-9) -72*a(n-12) +60*a(n-15) -31*a(n-18) +17*a(n-21) -a(n-24) -a(n-27) for n>34\end{quote}
...
\begin{multline*} a(n) = 11\,a(n-3) - 39\,a(n-6) + 57\,a(n-9) - 72\,a(n-12) + 60\,a(n-15) - 31\,a(n-18) + \\ 17\,a(n-21) - a(n-24) - a(n-27). \end{multline*}
...
That refinement leaves $181$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 96$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
For scale: at $n = 8$ there are $4^{24}$ arrays, about $10^{14}$, against $96$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A252426, the recurrence $a(n) = 11\,a(n-3) - 39\,a(n-6) + 57\,a(n-9) - 72\,a(n-12) + 60\,a(n-15) - 31\,a(n-18) + 17\,a(n-21) - a(n-24) - a(n-27)$ holds for every $n > 34$, and fails at $n = 34$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,159$. The last nonvanishing one is at $m = 7$, that is at $n = 34$. After it, more than $S = 96$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 641, 602, 608, 878, 1152, 1603, 2617, 4131,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A252426}{A252426}, revision 6, last modified Jun 02 2025.
