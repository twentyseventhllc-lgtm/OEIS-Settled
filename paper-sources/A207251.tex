...
\title{A proof of the conjectured linear recurrence for OEIS A207251}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207251}{A207251} as

\begin{quote}\itshape Number of nX5 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 3*a(n-1) +6*a(n-2) +a(n-3) +36*a(n-4) +49*a(n-5) +31*a(n-6) +66*a(n-7) +45*a(n-8) +15*a(n-9) -5*a(n-10) -16*a(n-11) -a(n-12) -a(n-13) +a(n-14)\end{quote}
...
\begin{multline*} a(n) = 3\,a(n-1) + 6\,a(n-2) + a(n-3) + 36\,a(n-4) + 49\,a(n-5) + 31\,a(n-6) + \\ 66\,a(n-7) + 45\,a(n-8) + 15\,a(n-9) - 5\,a(n-10) - 16\,a(n-11) - a(n-12) - \\ a(n-13) + a(n-14). \end{multline*}
...
\begin{theorem} For A207251, the recurrence $a(n) = 3\,a(n-1) + 6\,a(n-2) + a(n-3) + 36\,a(n-4) + 49\,a(n-5) + 31\,a(n-6) + 66\,a(n-7) + 45\,a(n-8) + 15\,a(n-9) - 5\,a(n-10) - 16\,a(n-11) - a(n-12) - a(n-13) + a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 10, 100, 390, 1950, 9072, 43498, 206514, 982940,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207251}{A207251}, revision 9, last modified Oct 03 2025.
