...
\title{A proof of the conjectured linear recurrence for OEIS A207886}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207886}{A207886} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +11*a(n-3) -2*a(n-4) -7*a(n-5) -31*a(n-6) +a(n-7) +6*a(n-8) +39*a(n-9) -4*a(n-10) +7*a(n-11) -24*a(n-12) -a(n-13) -6*a(n-14) +6*a(n-15) for n>17\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 11\,a(n-3) - 2\,a(n-4) - 7\,a(n-5) - 31\,a(n-6) + \\ a(n-7) + 6\,a(n-8) + 39\,a(n-9) - 4\,a(n-10) + 7\,a(n-11) - 24\,a(n-12) - \\ a(n-13) - 6\,a(n-14) + 6\,a(n-15). \end{multline*}
...
\begin{theorem} For A207886, the recurrence $a(n) = a(n-1) + a(n-2) + 11\,a(n-3) - 2\,a(n-4) - 7\,a(n-5) - 31\,a(n-6) + a(n-7) + 6\,a(n-8) + 39\,a(n-9) - 4\,a(n-10) + 7\,a(n-11) - 24\,a(n-12) - a(n-13) - 6\,a(n-14) + 6\,a(n-15)$ holds for every $n > 17$, and fails at $n = 17$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,65$. The last nonvanishing one is at $m = 2$, that is at $n = 17$. After it, more than $S = 19$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 177, 575, 1360, 3106, 8652, 22114,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207886}{A207886}, revision 9, last modified Oct 03 2025.
