...
\title{A proof of the conjectured linear recurrence for OEIS A302009}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302009}{A302009} as

\begin{quote}\itshape Number of nX7 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 85*a(n-1) +1213*a(n-2) +405*a(n-3) -48433*a(n-4) -99541*a(n-5) +739091*a(n-6) +1518593*a(n-7) -5898671*a(n-8) -5217125*a(n-9) +25830080*a(n-10) -16620026*a(n-11) -10284072*a(n-12) +13380888*a(n-13) -2391872*a(n-14) -1786496*a(n-15) +844032*a(n-16) -105472*a(n-17) for n>19\end{quote}
...
\begin{multline*} a(n) = 85\,a(n-1) + 1213\,a(n-2) + 405\,a(n-3) - 48433\,a(n-4) - 99541\,a(n-5) + 739091\,a(n-6) + \\ 1518593\,a(n-7) - 5898671\,a(n-8) - 5217125\,a(n-9) + 25830080\,a(n-10) - 16620026\,a(n-11) - 10284072\,a(n-12) + \\ 13380888\,a(n-13) - 2391872\,a(n-14) - 1786496\,a(n-15) + 844032\,a(n-16) - 105472\,a(n-17). \end{multline*}
...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $57$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A302009, the recurrence of order $17$ displayed in Section 1 holds for every $n > 19$, and fails at $n = 19$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,92$. The last nonvanishing one is at $m = 2$, that is at $n = 19$. After it, more than $S = 57$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 12 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 64, 8192, 772272, 75450768, 7350348800, 716213306576, 69786476414080, 6799869079320928,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302009}{A302009}, revision 4, last modified Mar 30 2018.
