...
\title{A proof of the conjectured linear recurrence for OEIS A306055}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A306055}{A306055} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +11*a(n-3) +3*a(n-4) -13*a(n-5) -46*a(n-6) -37*a(n-7) +8*a(n-8) +45*a(n-9) +39*a(n-10) +9*a(n-11) -a(n-12) -3*a(n-13) for n>14\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 11\,a(n-3) + 3\,a(n-4) - 13\,a(n-5) - 46\,a(n-6) - \\ 37\,a(n-7) + 8\,a(n-8) + 45\,a(n-9) + 39\,a(n-10) + 9\,a(n-11) - a(n-12) - \\ 3\,a(n-13). \end{multline*}
...
\begin{theorem} For A306055, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 11\,a(n-3) + 3\,a(n-4) - 13\,a(n-5) - 46\,a(n-6) - 37\,a(n-7) + 8\,a(n-8) + 45\,a(n-9) + 39\,a(n-10) + 9\,a(n-11) - a(n-12) - 3\,a(n-13)$ holds for every $n > 14$, and fails at $n = 14$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 12, 27, 58, 189, 526, 1344, 3772,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A306055}{A306055}, revision 4, last modified Jun 18 2018.
