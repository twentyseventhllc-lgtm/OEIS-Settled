...
\title{A proof of the conjectured linear recurrence for OEIS A243032}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A243032}{A243032} as

\begin{quote}\itshape Number of length n+3 0..7 arrays with no four elements in a row with pattern abba (possibly a=b) and new values 0..7 introduced in 0..7 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 22*a(n-1) -174*a(n-2) +572*a(n-3) -624*a(n-4) +452*a(n-5) -3128*a(n-6) +1972*a(n-7) +2055*a(n-8) +11822*a(n-9) +5790*a(n-10) +1804*a(n-11) -15511*a(n-12) -20914*a(n-13) -24188*a(n-14) -15968*a(n-15) -9299*a(n-16) -3002*a(n-17) -840*a(n-18)\end{quote}
...
\begin{multline*} a(n) = 22\,a(n-1) - 174\,a(n-2) + 572\,a(n-3) - 624\,a(n-4) + 452\,a(n-5) - 3128\,a(n-6) + \\ 1972\,a(n-7) + 2055\,a(n-8) + 11822\,a(n-9) + 5790\,a(n-10) + 1804\,a(n-11) - 15511\,a(n-12) - \\ 20914\,a(n-13) - 24188\,a(n-14) - 15968\,a(n-15) - 9299\,a(n-16) - 3002\,a(n-17) - 840\,a(n-18). \end{multline*}
...
The reachable part of that digraph has $1300$ states, $1300$ after trimming. Identifying states with the same number of completions of every length, and then the mirror identification on the edges coming in, leaves $S = 22$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of the $22\times22$ quotient matrix; that degree bound is computed here, not assumed.
...
\begin{theorem} For A243032, the recurrence of order $18$ displayed in Section 1 holds for every $n \ge 19$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. Every one of them vanished. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 43, 163, 694, 3252, 16552, 90634, 529587,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A243032}{A243032}, revision 6, last modified Jul 23 2025.
