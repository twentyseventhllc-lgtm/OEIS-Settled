...
\title{A proof of the conjectured linear recurrence for OEIS A260242}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A260242}{A260242} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001001\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +4*a(n-3) +9*a(n-4) -13*a(n-5) +14*a(n-6) +6*a(n-7) -35*a(n-8) +11*a(n-9) +11*a(n-10) -4*a(n-11) -14*a(n-12) +10*a(n-13) -4*a(n-14) for n>15\end{quote}
...
\begin{multline*} a(n) = a(n-1) + a(n-2) + 4\,a(n-3) + 9\,a(n-4) - 13\,a(n-5) + 14\,a(n-6) + \\ 6\,a(n-7) - 35\,a(n-8) + 11\,a(n-9) + 11\,a(n-10) - 4\,a(n-11) - 14\,a(n-12) + \\ 10\,a(n-13) - 4\,a(n-14). \end{multline*}
...
\begin{theorem} For A260242, the recurrence $a(n) = a(n-1) + a(n-2) + 4\,a(n-3) + 9\,a(n-4) - 13\,a(n-5) + 14\,a(n-6) + 6\,a(n-7) - 35\,a(n-8) + 11\,a(n-9) + 11\,a(n-10) - 4\,a(n-11) - 14\,a(n-12) + 10\,a(n-13) - 4\,a(n-14)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,68$. The last nonvanishing one is at $m = 1$, that is at $n = 15$. After it, more than $S = 23$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 99, 213, 551, 1235, 3026, 7822, 18837, 45114,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A260242}{A260242}, revision 6, last modified Jun 02 2025.
