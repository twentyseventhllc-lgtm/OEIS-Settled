...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208370}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208370}{A208370} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) + 19*a(n-2) + 23*a(n-3) - 26*a(n-4) - 38*a(n-5) + 13*a(n-6) + 15*a(n-7) - 4*a(n-8).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 9*x*(1 + 8*x + 11*x\textasciicircum{}2 - 16*x\textasciicircum{}3 - 28*x\textasciicircum{}4 + 10*x\textasciicircum{}5 + 15*x\textasciicircum{}6 - 4*x\textasciicircum{}7) / ((1 + x)*(1 - 2*x - 17*x\textasciicircum{}2 - 6*x\textasciicircum{}3 + 32*x\textasciicircum{}4 + 6*x\textasciicircum{}5 - 19*x\textasciicircum{}6 + 4*x\textasciicircum{}7)). - Colin Barker, Jul 02 2018\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 19\,a(n-2) + 23\,a(n-3) - 26\,a(n-4) - 38\,a(n-5) + 13\,a(n-6) + \\ 15\,a(n-7) - 4\,a(n-8). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 72x^{2} + 99x^{3} - 144x^{4} - 252x^{5} + 90x^{6} + 135x^{7} - 36x^{8}}{1 - x - 19x^{2} - 23x^{3} + 26x^{4} + 38x^{5} - 13x^{6} - 15x^{7} + 4x^{8}}.\]
...
\begin{theorem} For A208370, the recurrence $a(n) = a(n-1) + 19\,a(n-2) + 23\,a(n-3) - 26\,a(n-4) - 38\,a(n-5) + 13\,a(n-6) + 15\,a(n-7) - 4\,a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208370, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 72x^{2} + 99x^{3} - 144x^{4} - 252x^{5} + 90x^{6} + 135x^{7} - 36x^{8}}{1 - x - 19x^{2} - 23x^{3} + 26x^{4} + 38x^{5} - 13x^{6} - 15x^{7} + 4x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 351, 1953, 9999, 52821, 275769, 1446381,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208370}{A208370}, revision 8, last modified Jul 02 2018.
