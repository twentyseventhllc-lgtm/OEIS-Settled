...
\title{A proof of the conjectured linear recurrence for OEIS A229690}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A229690}{A229690} as

\begin{quote}\itshape Number of defective 3-colorings of an nX4 0..2 array connected horizontally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 27*a(n-1) -243*a(n-2) +729*a(n-3) for n>4.\end{quote}
...
The reachable part of the digraph has $271$ states, $177$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 7$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $7\times7$ matrix.
...
\begin{theorem} For A229690, the recurrence $a(n) = 27\,a(n-1) - 243\,a(n-2) + 729\,a(n-3)$ holds for every $n > 4$, and fails at $n = 4$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,32$. The last nonvanishing one is at $m = 1$, that is at $n = 4$. After it, more than $S = 7$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 245, 5077, 80757, 1125333, 14461173, 175867605, 2054728053,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A229690}{A229690}, revision 8, last modified Jul 23 2025.
