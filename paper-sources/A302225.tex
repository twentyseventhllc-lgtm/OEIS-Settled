...
\title{A proof of the conjectured linear recurrence for OEIS A302225}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302225}{A302225} as

\begin{quote}\itshape Number of 2Xn 0..1 arrays with every element equal to 1, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +3*a(n-2) +6*a(n-3) +10*a(n-4) +4*a(n-5) for n>6\end{quote}
...
\begin{theorem} For A302225, the recurrence $a(n) = 2\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) + 10\,a(n-4) + 4\,a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 0, 3, 14, 45, 146, 537, 1934, 6861,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302225}{A302225}, revision 4, last modified Apr 03 2018.
