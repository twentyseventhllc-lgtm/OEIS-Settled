...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234444}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234444}{A234444} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 60*a(n-2) - 344*a(n-4).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 32*x*(5 + 35*x - 48*x\textasciicircum{}2 - 265*x\textasciicircum{}3) / (1 - 60*x\textasciicircum{}2 + 344*x\textasciicircum{}4). - Colin Barker, Oct 15 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{160x + 1120x^{2} - 1536x^{3} - 8480x^{4}}{1 - 60x^{2} + 344x^{4}}.\]
...
\begin{theorem} For A234444, the recurrence $a(n) = 60\,a(n-2) - 344\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234444, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{160x + 1120x^{2} - 1536x^{3} - 8480x^{4}}{1 - 60x^{2} + 344x^{4}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 160, 1120, 8064, 58720, 428800, 3137920, 22953984, 168075520,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234444}{A234444}, revision 13, last modified Jun 20 2022.
