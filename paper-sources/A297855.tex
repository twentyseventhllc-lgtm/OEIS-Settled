...
For scale: at $n = 8$ there are $2^{40}$ arrays, about $10^{12}$, against $103$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,222$. The last nonvanishing one is at $m = 5$, that is at $n = 81$. After it, more than $S = 103$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
