...
\title{A proof of the conjectured linear recurrence for OEIS A302514}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302514}{A302514} as

\begin{quote}\itshape Number of nX7 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +12*a(n-3) +11*a(n-5) -38*a(n-6) -5*a(n-7) -17*a(n-8) +27*a(n-9) -32*a(n-10) +12*a(n-11) +16*a(n-12) +24*a(n-13) +16*a(n-15) for n>21\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 12\,a(n-3) + 11\,a(n-5) - 38\,a(n-6) - 5\,a(n-7) - 17\,a(n-8) + \\ 27\,a(n-9) - 32\,a(n-10) + 12\,a(n-11) + 16\,a(n-12) + 24\,a(n-13) + 16\,a(n-15). \end{multline*}
...
The construction gives $16512$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $196$; neither removal changes any count.
...
For scale: at $n = 8$ there are $2^{56}$ arrays, about $10^{17}$, against $29$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A302514, the recurrence $a(n) = a(n-1) + 12\,a(n-3) + 11\,a(n-5) - 38\,a(n-6) - 5\,a(n-7) - 17\,a(n-8) + 27\,a(n-9) - 32\,a(n-10) + 12\,a(n-11) + 16\,a(n-12) + 24\,a(n-13) + 16\,a(n-15)$ holds for every $n > 21$, and fails at $n = 21$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,76$. The last nonvanishing one is at $m = 6$, that is at $n = 21$. After it, more than $S = 29$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 21, 23, 118, 235, 689, 1784, 4558, 12324,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302514}{A302514}, revision 4, last modified Apr 09 2018.
