...
\title{A proof of the conjectured linear recurrence for OEIS A304349}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304349}{A304349} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 0, 1, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) -a(n-2) +8*a(n-3) -8*a(n-4)\end{quote}
...
\begin{theorem} For A304349, the recurrence $a(n) = 2\,a(n-1) - a(n-2) + 8\,a(n-3) - 8\,a(n-4)$ holds for every $n \ge 5$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 5, 9, 21, 57, 125, 289, 741,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304349}{A304349}, revision 4, last modified May 11 2018.
