...
\title{A proof of the conjectured linear recurrence for OEIS A305344}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A305344}{A305344} as

\begin{quote}\itshape Number of nX5 0..1 arrays with every element unequal to 0, 1, 3, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +10*a(n-3) -6*a(n-4) -6*a(n-5) -9*a(n-6) -18*a(n-7) -9*a(n-8) -27*a(n-9) +40*a(n-10) +43*a(n-11) +45*a(n-12) +38*a(n-13) +39*a(n-14) +5*a(n-15) -64*a(n-16) -77*a(n-17) -70*a(n-18) -32*a(n-19) -78*a(n-20) +20*a(n-21) +32*a(n-22) +48*a(n-23) +75*a(n-24) +18*a(n-25) +64*a(n-26) -12*a(n-27) -28*a(n-28) -6*a(n-29) -54*a(n-30) +4*a(n-31) -14*a(n-32) -2*a(n-33) +26*a(n-34) -4*a(n-35) +12*a(n-36) -4*a(n-37) for n>48\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 10\,a(n-3) - 6\,a(n-4) - 6\,a(n-5) - 9\,a(n-6) - 18\,a(n-7) - \\ 9\,a(n-8) - 27\,a(n-9) + 40\,a(n-10) + 43\,a(n-11) + 45\,a(n-12) + 38\,a(n-13) + \\ 39\,a(n-14) + 5\,a(n-15) - 64\,a(n-16) - 77\,a(n-17) - 70\,a(n-18) - 32\,a(n-19) - \\ 78\,a(n-20) + 20\,a(n-21) + 32\,a(n-22) + 48\,a(n-23) + 75\,a(n-24) + 18\,a(n-25) + \\ 64\,a(n-26) - 12\,a(n-27) - 28\,a(n-28) - 6\,a(n-29) - 54\,a(n-30) + 4\,a(n-31) - \\ 14\,a(n-32) - 2\,a(n-33) + 26\,a(n-34) - 4\,a(n-35) + 12\,a(n-36) - 4\,a(n-37). \end{multline*}
...
The construction gives $1056$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $223$; neither removal changes any count.
...
\begin{theorem} For A305344, the recurrence of order $37$ displayed in Section 1 holds for every $n > 48$, and fails at $n = 48$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,120$. The last nonvanishing one is at $m = 11$, that is at $n = 48$. After it, more than $S = 52$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 53, 63, 199, 649, 1729, 4685, 13671,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A305344}{A305344}, revision 4, last modified May 30 2018.
