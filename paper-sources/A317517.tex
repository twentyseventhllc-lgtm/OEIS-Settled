...
\title{Proofs of the conjectured column and row recurrences for OEIS A317517}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317517}{A317517} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = 2*a(n-1)\\k=2: a(n) = 4*a(n-1)\\k=3: a(n) = 8*a(n-1) -a(n-2) +6*a(n-3)\\k=4: a(n) = 16*a(n-1) -6*a(n-2) +64*a(n-3)\end{quote}
...
\begin{theorem} For column $k = 1$ of A317517, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A317517, the recurrence $a(n) = 4\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A317517, the recurrence $a(n) = 8\,a(n-1) - a(n-2) + 6\,a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A317517, the recurrence $a(n) = 16\,a(n-1) - 6\,a(n-2) + 64\,a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317517}{A317517}, revision 4, last modified Jul 30 2018.
