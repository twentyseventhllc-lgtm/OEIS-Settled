...
\title{A proof of the conjectured linear recurrence for OEIS A316689}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A316689}{A316689} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 6, 7 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +5*a(n-3) +a(n-4) -2*a(n-5) -6*a(n-6) -4*a(n-7) for n>11\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 5\,a(n-3) + a(n-4) - 2\,a(n-5) - 6\,a(n-6) - \\ 4\,a(n-7). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $45$; neither removal changes any count.
...
\begin{theorem} For A316689, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 5\,a(n-3) + a(n-4) - 2\,a(n-5) - 6\,a(n-6) - 4\,a(n-7)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 5, 9, 23, 44, 125, 313, 773,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A316689}{A316689}, revision 4, last modified Jul 10 2018.
