...
\title{Proofs of the conjectured column and row recurrences for OEIS A234672}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234672}{A234672} as

\begin{quote}\itshape T(n,k) is the number of (n+1) X (k+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings)\end{quote}
...
\begin{theorem} For column $k = 1$ of A234672, the recurrence $a(n) = 0$ holds for every $n \ge 8$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234672}{A234672}, revision 6, last modified Jun 20 2022.
