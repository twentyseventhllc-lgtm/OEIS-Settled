...
\title{A proof of the conjectured linear recurrence for OEIS A196977}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196977}{A196977} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,2,1,0,4 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +4*a(n-2) +22*a(n-3) +45*a(n-4) +166*a(n-5) +204*a(n-6) +94*a(n-7) -372*a(n-8) -674*a(n-9) -692*a(n-10) -170*a(n-11) +495*a(n-12) +655*a(n-13) +521*a(n-14) +107*a(n-15) -138*a(n-16) -139*a(n-17) -84*a(n-18) -15*a(n-19) +9*a(n-20) +3*a(n-21)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 4\,a(n-2) + 22\,a(n-3) + 45\,a(n-4) + 166\,a(n-5) + 204\,a(n-6) + \\ 94\,a(n-7) - 372\,a(n-8) - 674\,a(n-9) - 692\,a(n-10) - 170\,a(n-11) + 495\,a(n-12) + \\ 655\,a(n-13) + 521\,a(n-14) + 107\,a(n-15) - 138\,a(n-16) - 139\,a(n-17) - 84\,a(n-18) - \\ 15\,a(n-19) + 9\,a(n-20) + 3\,a(n-21). \end{multline*}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $288$; neither removal changes any count.
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $24$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A196977, the recurrence of order $21$ displayed in Section 1 holds for every $n \ge 22$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 2, 14, 65, 298, 1422, 6679, 31386, 147574,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196977}{A196977}, revision 9, last modified Oct 03 2025.
