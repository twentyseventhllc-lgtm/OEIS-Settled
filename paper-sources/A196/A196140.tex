...
\title{A proof of the conjectured linear recurrence for OEIS A196140}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196140}{A196140} as

\begin{quote}\itshape Number of nX2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,4,1,2 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +a(n-3) -2*a(n-4) -a(n-5) +a(n-6)\end{quote}
...
\begin{theorem} For A196140, the recurrence $a(n) = 2\,a(n-1) + a(n-3) - 2\,a(n-4) - a(n-5) + a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 33 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3, 5, 8, 17, 34, 62, 123, 243,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196140}{A196140}, revision 9, last modified Oct 03 2025.
