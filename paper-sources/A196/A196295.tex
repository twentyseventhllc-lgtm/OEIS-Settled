...
\title{A proof of the conjectured linear recurrence for OEIS A196295}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A196295}{A196295} as

\begin{quote}\itshape Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,1,4,2 for x=0,1,2,3,4\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +3*a(n-2) -2*a(n-3) -3*a(n-4) -28*a(n-5) -108*a(n-6) -553*a(n-7) -1487*a(n-8) -406*a(n-9) +1679*a(n-10) +7367*a(n-11) +29776*a(n-12) +40461*a(n-13) +40921*a(n-14) +25939*a(n-15) +4942*a(n-16) -5887*a(n-17) -21877*a(n-18) -27360*a(n-19) -19016*a(n-20) +284*a(n-21) +3863*a(n-22) -2168*a(n-23) -3302*a(n-24) +3474*a(n-25) +1158*a(n-26) -171*a(n-27) -1312*a(n-28) +650*a(n-29) -96*a(n-30) +70*a(n-31) -18*a(n-32)\end{quote}
...
The construction gives $15750$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $282$; neither removal changes any count.
...
For scale: at $n = 8$ there are $5^{24}$ arrays, about $10^{17}$, against $35$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A196295, the recurrence of order $32$ displayed in Section 1 holds for every $n \ge 33$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 20, 58, 290, 1201, 4988, 21344, 90150,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A196295}{A196295}, revision 9, last modified Oct 03 2025.
