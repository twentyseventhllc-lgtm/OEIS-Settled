...
\title{A proof of the conjectured linear recurrence for OEIS A304422}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304422}{A304422} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 4*a(n-1) +15*a(n-2) +7*a(n-3) -36*a(n-4) -72*a(n-5) -51*a(n-6) -29*a(n-7) -19*a(n-8) -4*a(n-9) for n>10\end{quote}
...
\begin{multline*} a(n) = 4\,a(n-1) + 15\,a(n-2) + 7\,a(n-3) - 36\,a(n-4) - 72\,a(n-5) - 51\,a(n-6) - \\ 29\,a(n-7) - 19\,a(n-8) - 4\,a(n-9). \end{multline*}
...
\begin{theorem} For A304422, the recurrence $a(n) = 4\,a(n-1) + 15\,a(n-2) + 7\,a(n-3) - 36\,a(n-4) - 72\,a(n-5) - 51\,a(n-6) - 29\,a(n-7) - 19\,a(n-8) - 4\,a(n-9)$ holds for every $n > 10$, and fails at $n = 10$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 25, 124, 836, 5227, 33263, 210954, 1338995,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304422}{A304422}, revision 4, last modified May 12 2018.
