...
\title{A proof of the conjectured linear recurrence and generating function and closed form for OEIS A184544}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A184544}{A184544} as

\begin{quote}\itshape Number of (n+2) X 7 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = (1/5040)*n\textasciicircum{}7 + (1/120)*n\textasciicircum{}6 + (53/360)*n\textasciicircum{}5 + (17/12)*n\textasciicircum{}4 + (5767/720)*n\textasciicircum{}3 + (3063/40)*n\textasciicircum{}2 + (11959/70)*n + 52.\end{quote}

\begin{quote}\ttfamily G.f.: x*(309 - 1680*x + 3943*x\textasciicircum{}2 - 5120*x\textasciicircum{}3 + 3955*x\textasciicircum{}4 - 1819*x\textasciicircum{}5 + 465*x\textasciicircum{}6 - 52*x\textasciicircum{}7) / (1 - x)\textasciicircum{}8.\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 11, last modified Apr 13 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\[a(n) = 52 + \frac{11959}{70}n + \frac{3063}{40}n^{2} + \frac{5767}{720}n^{3} + \frac{17}{12}n^{4} + \frac{53}{360}n^{5} + \frac{1}{120}n^{6} + \frac{1}{5040}n^{7}.\]

Written out, the claim is

\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{309x - 1680x^{2} + 3943x^{3} - 5120x^{4} + 3955x^{5} - 1819x^{6} + 465x^{7} - 52x^{8}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}.\]
...
Let $A$ be an $n' \times 7$ array over $\{0,\dots,1\}$ with $n' = n + 2$ rows.
...
That refinement leaves $29$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 14$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A184544, $a(n)$ is the polynomial $52 + \frac{11959}{70}n + \frac{3063}{40}n^{2} + \frac{5767}{720}n^{3} + \frac{17}{12}n^{4} + \frac{53}{360}n^{5} + \frac{1}{120}n^{6} + \frac{1}{5040}n^{7}$ for every $n \ge 1$.\end{theorem}

{\itshape Proof.} A polynomial of degree $7$ is annihilated by the difference operator $(E-1)^{8}$, whose characteristic polynomial is $(t-1)^{8}$. So $a(n) - P(n)$, with $P$ the claimed polynomial, satisfies the linear recurrence whose characteristic polynomial is the product of that with the characteristic polynomial of $L$, of degree $S + 8 = 22$. Its values were computed exactly; all of them vanish, and more than $22$ consecutive vanishing values follow, so every later one vanishes as well. $\square$

\begin{theorem} For A184544, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{309x - 1680x^{2} + 3943x^{3} - 5120x^{4} + 3955x^{5} - 1819x^{6} + 465x^{7} - 52x^{8}}{1 - 8x + 28x^{2} - 56x^{3} + 70x^{4} - 56x^{5} + 28x^{6} - 8x^{7} + x^{8}}$.\end{theorem}
...
\begin{theorem} For A184544, the recurrence $a(n) = 8\,a(n-1) - 28\,a(n-2) + 56\,a(n-3) - 70\,a(n-4) + 56\,a(n-5) - 28\,a(n-6) + 8\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 309, 792, 1627, 3024, 5313, 8989, 14767, 23648,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A184544}{A184544}, revision 11, last modified Apr 13 2018.
