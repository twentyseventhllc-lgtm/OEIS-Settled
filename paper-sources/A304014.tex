...
\title{A proof of the conjectured linear recurrence for OEIS A304014}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A304014}{A304014} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 5 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) +4*a(n-2) +3*a(n-3) -13*a(n-4) -20*a(n-5) +6*a(n-6) -21*a(n-7) +23*a(n-8) +63*a(n-9) +36*a(n-10) +14*a(n-11) -55*a(n-12) -43*a(n-13) -7*a(n-14) +26*a(n-15) +25*a(n-16) -6*a(n-17) +4*a(n-18) -4*a(n-20)\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-1) + 4\,a(n-2) + 3\,a(n-3) - 13\,a(n-4) - 20\,a(n-5) + 6\,a(n-6) - \\ 21\,a(n-7) + 23\,a(n-8) + 63\,a(n-9) + 36\,a(n-10) + 14\,a(n-11) - 55\,a(n-12) - \\ 43\,a(n-13) - 7\,a(n-14) + 26\,a(n-15) + 25\,a(n-16) - 6\,a(n-17) + 4\,a(n-18) - \\ 4\,a(n-20). \end{multline*}
...
\begin{theorem} For A304014, the recurrence $a(n) = 2\,a(n-1) + 4\,a(n-2) + 3\,a(n-3) - 13\,a(n-4) - 20\,a(n-5) + 6\,a(n-6) - 21\,a(n-7) + 23\,a(n-8) + 63\,a(n-9) + 36\,a(n-10) + 14\,a(n-11) - 55\,a(n-12) - 43\,a(n-13) - 7\,a(n-14) + 26\,a(n-15) + 25\,a(n-16) - 6\,a(n-17) + 4\,a(n-18) - 4\,a(n-20)$ holds for every $n \ge 21$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,74$. Every one of them vanished. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 26 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 16, 38, 103, 281, 826, 2421, 7104,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A304014}{A304014}, revision 4, last modified May 04 2018.
