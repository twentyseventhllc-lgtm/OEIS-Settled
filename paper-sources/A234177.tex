...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234177}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234177}{A234177} as

\begin{quote}\itshape Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) - 27*a(n-2) + 3*a(n-3) + 36*a(n-4) + 12*a(n-5).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 2*x*(38 - 186*x + 75*x\textasciicircum{}2 + 294*x\textasciicircum{}3 + 96*x\textasciicircum{}4) / (1 - 10*x + 27*x\textasciicircum{}2 - 3*x\textasciicircum{}3 - 36*x\textasciicircum{}4 - 12*x\textasciicircum{}5). - Colin Barker, Oct 13 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{76x - 372x^{2} + 150x^{3} + 588x^{4} + 192x^{5}}{1 - 10x + 27x^{2} - 3x^{3} - 36x^{4} - 12x^{5}}.\]
...
\begin{theorem} For A234177, the recurrence $a(n) = 10\,a(n-1) - 27\,a(n-2) + 3\,a(n-3) + 36\,a(n-4) + 12\,a(n-5)$ holds for every $n \ge 6$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234177, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{76x - 372x^{2} + 150x^{3} + 588x^{4} + 192x^{5}}{1 - 10x + 27x^{2} - 3x^{3} - 36x^{4} - 12x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 76, 388, 1978, 10120, 51886, 266434, 1369642, 7046416,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234177}{A234177}, revision 11, last modified Oct 13 2018.
