...
\title{Proofs of the conjectured column and row recurrences for OEIS A250898}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A250898}{A250898} as
...
\begin{quote}\ttfamily Empirical for column k (k=2 recurrence works also for k=1):\\
k=1: a(n) = 8*a(n-1) -23*a(n-2) +28*a(n-3) -12*a(n-4) for n>6\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Nov 28 2014). As of revision 6, last modified Jul 23 2025, the entry records no proof of any of them and links to none. This note proves the 1 column recurrence listed above.
...
\begin{theorem} For column $k = 1$ of A250898, the recurrence $a(n) = 8\,a(n-1) - 23\,a(n-2) + 28\,a(n-3) - 12\,a(n-4)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A250898}{A250898}, revision 6, last modified Jul 23 2025.
