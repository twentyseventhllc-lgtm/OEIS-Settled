...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208109}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208109}{A208109} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-1) + 8*a(n-3) + 61*a(n-4) - 66*a(n-5) - 48*a(n-6) - 252*a(n-8) + 216*a(n-9).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: x*(9 + 63*x + 9*x\textasciicircum{}2 - 53*x\textasciicircum{}3 - 114*x\textasciicircum{}4 - 300*x\textasciicircum{}5 - 36*x\textasciicircum{}6 - 36*x\textasciicircum{}7 + 216*x\textasciicircum{}8) / ((1 - 2*x - 7*x\textasciicircum{}2 + 6*x\textasciicircum{}3)*(1 + 7*x\textasciicircum{}2 - 12*x\textasciicircum{}4 - 36*x\textasciicircum{}6)). - Colin Barker, Jun 28 2018\end{quote}
...
The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Jun 28 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-1) + 8\,a(n-3) + 61\,a(n-4) - 66\,a(n-5) - 48\,a(n-6) - 252\,a(n-8) + \\ 216\,a(n-9). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 63x^{2} + 9x^{3} - 53x^{4} - 114x^{5} - 300x^{6} - 36x^{7} - 36x^{8} + 216x^{9}}{1 - 2x - 8x^{3} - 61x^{4} + 66x^{5} + 48x^{6} + 252x^{8} - 216x^{9}}.\]
...
\begin{theorem} For A208109, the recurrence $a(n) = 2\,a(n-1) + 8\,a(n-3) + 61\,a(n-4) - 66\,a(n-5) - 48\,a(n-6) - 252\,a(n-8) + 216\,a(n-9)$ holds for every $n \ge 10$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A208109, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 63x^{2} + 9x^{3} - 53x^{4} - 114x^{5} - 300x^{6} - 36x^{7} - 36x^{8} + 216x^{9}}{1 - 2x - 8x^{3} - 61x^{4} + 66x^{5} + 48x^{6} + 252x^{8} - 216x^{9}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 23 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 171, 361, 1805, 9025, 25555, 72361,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208109}{A208109}, revision 9, last modified Jun 28 2018.
