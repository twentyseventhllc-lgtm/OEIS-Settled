...
\title{A proof of the conjectured linear recurrence for OEIS A299657}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A299657}{A299657} as

\begin{quote}\itshape Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 13*a(n-1) +12*a(n-2) -39*a(n-3) -468*a(n-4) -404*a(n-5) +675*a(n-6) +2723*a(n-7) +3026*a(n-8) +5750*a(n-9) +19747*a(n-10) +17630*a(n-11) -28280*a(n-12) -73625*a(n-13) -44638*a(n-14) +24870*a(n-15) +47548*a(n-16) +29679*a(n-17) +4247*a(n-18) -10854*a(n-19) -4557*a(n-20) -2325*a(n-21) -2645*a(n-22) -403*a(n-23) +60*a(n-24)\end{quote}
...
\begin{multline*} a(n) = 13\,a(n-1) + 12\,a(n-2) - 39\,a(n-3) - 468\,a(n-4) - 404\,a(n-5) + 675\,a(n-6) + \\ 2723\,a(n-7) + 3026\,a(n-8) + 5750\,a(n-9) + 19747\,a(n-10) + 17630\,a(n-11) - 28280\,a(n-12) - \\ 73625\,a(n-13) - 44638\,a(n-14) + 24870\,a(n-15) + 47548\,a(n-16) + 29679\,a(n-17) + 4247\,a(n-18) - \\ 10854\,a(n-19) - 4557\,a(n-20) - 2325\,a(n-21) - 2645\,a(n-22) - 403\,a(n-23) + 60\,a(n-24). \end{multline*}
...
\begin{theorem} For A299657, the recurrence of order $24$ displayed in Section 1 holds for every $n \ge 25$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1642, 22087, 297071, 4001253, 53909088, 726363190,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A299657}{A299657}, revision 4, last modified Feb 15 2018.
