...
\title{A proof of the conjectured linear recurrence for OEIS A298765}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298765}{A298765} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 5 or 8 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -4*a(n-2) -a(n-3) -3*a(n-4) -12*a(n-5) +33*a(n-6) -17*a(n-7) +3*a(n-8) -81*a(n-9) -4*a(n-10) +86*a(n-11) +127*a(n-12) +13*a(n-13) -95*a(n-14) -56*a(n-15) +8*a(n-16) +8*a(n-17) -16*a(n-18) -8*a(n-19) for n>20\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 4\,a(n-2) - a(n-3) - 3\,a(n-4) - 12\,a(n-5) + 33\,a(n-6) - \\ 17\,a(n-7) + 3\,a(n-8) - 81\,a(n-9) - 4\,a(n-10) + 86\,a(n-11) + 127\,a(n-12) + \\ 13\,a(n-13) - 95\,a(n-14) - 56\,a(n-15) + 8\,a(n-16) + 8\,a(n-17) - 16\,a(n-18) - \\ 8\,a(n-19). \end{multline*}
...
\begin{theorem} For A298765, the recurrence $a(n) = 5\,a(n-1) - 4\,a(n-2) - a(n-3) - 3\,a(n-4) - 12\,a(n-5) + 33\,a(n-6) - 17\,a(n-7) + 3\,a(n-8) - 81\,a(n-9) - 4\,a(n-10) + 86\,a(n-11) + 127\,a(n-12) + 13\,a(n-13) - 95\,a(n-14) - 56\,a(n-15) + 8\,a(n-16) + 8\,a(n-17) - 16\,a(n-18) - 8\,a(n-19)$ holds for every $n > 20$, and fails at $n = 20$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,71$. The last nonvanishing one is at $m = 1$, that is at $n = 20$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 18, 57, 222, 808, 3124, 11807, 44846,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298765}{A298765}, revision 4, last modified Jan 26 2018.
