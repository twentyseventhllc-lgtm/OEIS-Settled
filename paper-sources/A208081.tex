...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208081}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208081}{A208081} as

\begin{quote}\itshape Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 0 vertically\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) +59*a(n-2) -216*a(n-3) -146*a(n-4) +568*a(n-5) -58*a(n-6) -208*a(n-7) +35*a(n-8) +6*a(n-9) -a(n-10).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 25*x*(1 + 15*x - 20*x\textasciicircum{}2 - 180*x\textasciicircum{}3 + 334*x\textasciicircum{}4 - 26*x\textasciicircum{}5 - 144*x\textasciicircum{}6 + 32*x\textasciicircum{}7 + 5*x\textasciicircum{}8 - x\textasciicircum{}9) / ((1 - 16*x + 38*x\textasciicircum{}2 - 12*x\textasciicircum{}3 + x\textasciicircum{}4)*(1 + 6*x - x\textasciicircum{}2 - 16*x\textasciicircum{}3 - x\textasciicircum{}4 + 6*x\textasciicircum{}5 + x\textasciicircum{}6)). - Colin Barker, Jan 20 2018\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 23 2012).

The line quoted ending in that signature is contributed by Colin Barker on Jan 20 2018.

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 12, last modified Jan 20 2018, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 10\,a(n-1) + 59\,a(n-2) - 216\,a(n-3) - 146\,a(n-4) + 568\,a(n-5) - 58\,a(n-6) - \\ 208\,a(n-7) + 35\,a(n-8) + 6\,a(n-9) - a(n-10). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{25x + 375x^{2} - 500x^{3} - 4500x^{4} + 8350x^{5} - 650x^{6} - 3600x^{7} + 800x^{8} + 125x^{9} - 25x^{10}}{1 - 10x - 59x^{2} + 216x^{3} + 146x^{4} - 568x^{5} + 58x^{6} + 208x^{7} - 35x^{8} - 6x^{9} + x^{10}}.\]
...
For scale: at $n = 8$ there are $2^{48}$ arrays, about $10^{14}$, against $11$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A208081, the recurrence $a(n) = 10\,a(n-1) + 59\,a(n-2) - 216\,a(n-3) - 146\,a(n-4) + 568\,a(n-5) - 58\,a(n-6) - 208\,a(n-7) + 35\,a(n-8) + 6\,a(n-9) - a(n-10)$ holds for every $n \ge 11$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,43$. Every one of them vanished. After it, more than $S = 11$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A208081, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{25x + 375x^{2} - 500x^{3} - 4500x^{4} + 8350x^{5} - 650x^{6} - 3600x^{7} + 800x^{8} + 125x^{9} - 25x^{10}}{1 - 10x - 59x^{2} + 216x^{3} + 146x^{4} - 568x^{5} + 58x^{6} + 208x^{7} - 35x^{8} - 6x^{9} + x^{10}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 25, 625, 7225, 99225, 1288225, 17098225, 224850025, 2968615225,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208081}{A208081}, revision 12, last modified Jan 20 2018.
