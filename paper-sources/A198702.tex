...
\title{A proof of the conjectured linear recurrence for OEIS A198702}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A198702}{A198702} as

\begin{quote}\itshape Number of nX2 0..4 arrays with values 0..4 introduced in row major order and each element equal to at least one horizontal or vertical neighbor\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 17*a(n-1) -80*a(n-2) +37*a(n-3) +349*a(n-4) -60*a(n-5) -729*a(n-6) -553*a(n-7) +572*a(n-8) +783*a(n-9) +139*a(n-10) -304*a(n-11) -170*a(n-12)\end{quote}
...
\begin{multline*} a(n) = 17\,a(n-1) - 80\,a(n-2) + 37\,a(n-3) + 349\,a(n-4) - 60\,a(n-5) - 729\,a(n-6) - \\ 553\,a(n-7) + 572\,a(n-8) + 783\,a(n-9) + 139\,a(n-10) - 304\,a(n-11) - 170\,a(n-12). \end{multline*}
...
The reachable part of the digraph has $1960$ states, $982$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 14$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of that $14\times14$ matrix; the bound is computed, not assumed.
...
\begin{theorem} For A198702, the recurrence $a(n) = 17\,a(n-1) - 80\,a(n-2) + 37\,a(n-3) + 349\,a(n-4) - 60\,a(n-5) - 729\,a(n-6) - 553\,a(n-7) + 572\,a(n-8) + 783\,a(n-9) + 139\,a(n-10) - 304\,a(n-11) - 170\,a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 14, 76, 488, 3508, 27422, 227045,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A198702}{A198702}, revision 9, last modified Oct 03 2025.
