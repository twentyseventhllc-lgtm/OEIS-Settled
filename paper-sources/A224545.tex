...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224545}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224545}{A224545} as

\begin{quote}\itshape Number of (n+1) X 4 0..1 matrices with each 2 X 2 subblock idempotent\end{quote}
...
\begin{quote}\ttfamily Empirical g.f.: x*(28 - 60*x + 10*x\textasciicircum{}2 + 45*x\textasciicircum{}3 - 25*x\textasciicircum{}4 + x\textasciicircum{}5) / ((1 - x)\textasciicircum{}3*(1 - x - x\textasciicircum{}2)). - Colin Barker, Aug 30 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{28x - 60x^{2} + 10x^{3} + 45x^{4} - 25x^{5} + x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}.\]

\section{The object}

The name is read as follows. The reading is not a guess: it is pinned against the entry's own published terms, and against an independent enumeration, before anything is proved (Section 7).

Let $q = 2$ and let $A$ be an $n' \times 4$ matrix over $\{0,\dots,1\}$ with $n' = n + 1$ rows.
...
\begin{theorem} For A224545, the recurrence $a(n) = 4\,a(n-1) - 5\,a(n-2) + a(n-3) + 2\,a(n-4) - a(n-5)$ holds for every $n > 6$, and fails at $n = 6$.\end{theorem}
...
\begin{theorem} For A224545, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{28x - 60x^{2} + 10x^{3} + 45x^{4} - 25x^{5} + x^{6}}{1 - 4x + 5x^{2} - x^{3} - 2x^{4} + x^{5}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 33 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 28, 52, 78, 125, 193, 302, 472, 743,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224545}{A224545}, revision 7, last modified Aug 30 2018.
