...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A224019}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A224019}{A224019} as

\begin{quote}\itshape Number of n X 3 0..3 arrays with rows nondecreasing and antidiagonals unimodal\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 20*a(n-1) - 70*a(n-2) + 228*a(n-3) - 276*a(n-4) + 392*a(n-5) - 196*a(n-6) + 144*a(n-7).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(5 + 49*x\textasciicircum{}2 - 11*x\textasciicircum{}3 + 85*x\textasciicircum{}4 - 13*x\textasciicircum{}5 + 36*x\textasciicircum{}6) / (1 - 20*x + 70*x\textasciicircum{}2 - 228*x\textasciicircum{}3 + 276*x\textasciicircum{}4 - 392*x\textasciicircum{}5 + 196*x\textasciicircum{}6 - 144*x\textasciicircum{}7). - Colin Barker, Aug 26 2018\end{quote}
...
\begin{multline*} a(n) = 20\,a(n-1) - 70\,a(n-2) + 228\,a(n-3) - 276\,a(n-4) + 392\,a(n-5) - 196\,a(n-6) + \\ 144\,a(n-7). \end{multline*}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{20x + 196x^{3} - 44x^{4} + 340x^{5} - 52x^{6} + 144x^{7}}{1 - 20x + 70x^{2} - 228x^{3} + 276x^{4} - 392x^{5} + 196x^{6} - 144x^{7}}.\]
...
\begin{theorem} For A224019, the recurrence $a(n) = 20\,a(n-1) - 70\,a(n-2) + 228\,a(n-3) - 276\,a(n-4) + 392\,a(n-5) - 196\,a(n-6) + 144\,a(n-7)$ holds for every $n \ge 8$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A224019, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{20x + 196x^{3} - 44x^{4} + 340x^{5} - 52x^{6} + 144x^{7}}{1 - 20x + 70x^{2} - 228x^{3} + 276x^{4} - 392x^{5} + 196x^{6} - 144x^{7}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 6796, 112436, 1859020, 30756756, 508916456, 8420768936,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A224019}{A224019}, revision 8, last modified Aug 26 2018.
