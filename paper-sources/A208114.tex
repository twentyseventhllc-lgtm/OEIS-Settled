...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A208114}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208114}{A208114} as

\begin{quote}\itshape Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically\end{quote}
...
\begin{quote}\ttfamily G.f.: x*(9 + 63*x + 45*x\textasciicircum{}2 + 67*x\textasciicircum{}3 + 11*x\textasciicircum{}4 - 3*x\textasciicircum{}5 - x\textasciicircum{}6 + x\textasciicircum{}7) / ((1 - x)\textasciicircum{}5*(1 + x)\textasciicircum{}3).\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{9x + 63x^{2} + 45x^{3} + 67x^{4} + 11x^{5} - 3x^{6} - x^{7} + x^{8}}{1 - 2x - 2x^{2} + 6x^{3} - 6x^{5} + 2x^{6} + 2x^{7} - x^{8}}.\]
...
\begin{theorem} For A208114, the recurrence $a(n) = 2\,a(n-1) + 2\,a(n-2) - 6\,a(n-3) + 6\,a(n-5) - 2\,a(n-6) - 2\,a(n-7) + a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,56$. Every one of them vanished. After it, more than $S = 9$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$

\begin{theorem} For A208114, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{9x + 63x^{2} + 45x^{3} + 67x^{4} + 11x^{5} - 3x^{6} - x^{7} + x^{8}}{1 - 2x - 2x^{2} + 6x^{3} - 6x^{5} + 2x^{6} + 2x^{7} - x^{8}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 33 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 225, 625, 1225, 2401, 3969, 6561,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208114}{A208114}, revision 8, last modified Jun 28 2018.
