...
\title{A proof of the conjectured linear recurrence for OEIS A234118}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234118}{A234118} as

\begin{quote}\itshape Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 50*a(n-1) -427*a(n-2) -2748*a(n-3) +22158*a(n-4) +50476*a(n-5) -220478*a(n-6) -236864*a(n-7) +237555*a(n-8) +152850*a(n-9) -74775*a(n-10) -7956*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 50\,a(n-1) - 427\,a(n-2) - 2748\,a(n-3) + 22158\,a(n-4) + 50476\,a(n-5) - 220478\,a(n-6) - \\ 236864\,a(n-7) + 237555\,a(n-8) + 152850\,a(n-9) - 74775\,a(n-10) - 7956\,a(n-11). \end{multline*}
...
\begin{theorem} For A234118, the recurrence $a(n) = 50\,a(n-1) - 427\,a(n-2) - 2748\,a(n-3) + 22158\,a(n-4) + 50476\,a(n-5) - 220478\,a(n-6) - 236864\,a(n-7) + 237555\,a(n-8) + 152850\,a(n-9) - 74775\,a(n-10) - 7956\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 13 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 3127, 116801, 4279065, 157630963, 5807422543, 214027901025, 7888454356625, 290756314787875,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234118}{A234118}, revision 6, last modified Jun 02 2025.
