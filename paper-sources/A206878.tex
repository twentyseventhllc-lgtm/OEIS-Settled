...
\title{A proof of the conjectured linear recurrence for OEIS A206878}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A206878}{A206878} as

\begin{quote}\itshape Number of nX3 0..1 arrays avoiding 0 1 0 horizontally and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) -7*a(n-2) +24*a(n-3) +8*a(n-4) +11*a(n-5) +32*a(n-6) -22*a(n-7) -44*a(n-8) +11*a(n-9) +13*a(n-10) -a(n-11) -a(n-12)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) - 7\,a(n-2) + 24\,a(n-3) + 8\,a(n-4) + 11\,a(n-5) + 32\,a(n-6) - \\ 22\,a(n-7) - 44\,a(n-8) + 11\,a(n-9) + 13\,a(n-10) - a(n-11) - a(n-12). \end{multline*}
...
\begin{theorem} For A206878, the recurrence $a(n) = 5\,a(n-1) - 7\,a(n-2) + 24\,a(n-3) + 8\,a(n-4) + 11\,a(n-5) + 32\,a(n-6) - 22\,a(n-7) - 44\,a(n-8) + 11\,a(n-9) + 13\,a(n-10) - a(n-11) - a(n-12)$ holds for every $n \ge 13$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 49, 230, 1011, 4705, 22412, 105936, 497727,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A206878}{A206878}, revision 9, last modified Oct 03 2025.
