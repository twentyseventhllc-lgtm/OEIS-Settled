...
\title{A proof of the conjectured linear recurrence and generating function for OEIS A234221}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A234221}{A234221} as

\begin{quote}\itshape Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings)\end{quote}

and carries in its Formula section the lines:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) + 20*a(n-2) - 224*a(n-3) + 144*a(n-4) + 1680*a(n-5) - 2880*a(n-6).\end{quote}

\begin{quote}\ttfamily Empirical g.f.: 4*x*(109 - 373*x - 3507*x\textasciicircum{}2 + 11976*x\textasciicircum{}3 + 26580*x\textasciicircum{}4 - 90000*x\textasciicircum{}5) / ((1 - 3*x)*(1 - 4*x)*(1 - 12*x\textasciicircum{}2)*(1 - 20*x\textasciicircum{}2)). - Colin Barker, Oct 14 2018\end{quote}
...
\[\sum_{n \ge 1} a(n)\,x^n \;=\; \frac{436x - 1492x^{2} - 14028x^{3} + 47904x^{4} + 106320x^{5} - 360000x^{6}}{1 - 7x - 20x^{2} + 224x^{3} - 144x^{4} - 1680x^{5} + 2880x^{6}}.\]
...
\begin{theorem} For A234221, the recurrence $a(n) = 7\,a(n-1) + 20\,a(n-2) - 224\,a(n-3) + 144\,a(n-4) + 1680\,a(n-5) - 2880\,a(n-6)$ holds for every $n \ge 7$ --- at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For A234221, the generating function is exactly $\sum_{n\ge 1} a(n)x^n = \frac{436x - 1492x^{2} - 14028x^{3} + 47904x^{4} + 106320x^{5} - 360000x^{6}}{1 - 7x - 20x^{2} + 224x^{3} - 144x^{4} - 1680x^{5} + 2880x^{6}}$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 436, 1560, 5612, 20724, 76972, 293316, 1123724, 4410276,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A234221}{A234221}, revision 12, last modified Jun 20 2022.
