...
\title{A proof of the conjectured linear recurrence for OEIS A303017}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303017}{A303017} as

\begin{quote}\itshape Number of 3 X n 0..1 arrays with every element equal to 0, 1, 2, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 6*a(n-1) -7*a(n-2) -11*a(n-3) +11*a(n-4) +a(n-5) +49*a(n-6) -12*a(n-7) -59*a(n-8) -61*a(n-9) +23*a(n-10) +89*a(n-11) +28*a(n-12) -24*a(n-13) -44*a(n-14) +12*a(n-15) for n>16.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 17 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 9, last modified Jan 27 2024, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 6\,a(n-1) - 7\,a(n-2) - 11\,a(n-3) + 11\,a(n-4) + a(n-5) + 49\,a(n-6) - \\ 12\,a(n-7) - 59\,a(n-8) - 61\,a(n-9) + 23\,a(n-10) + 89\,a(n-11) + 28\,a(n-12) - \\ 24\,a(n-13) - 44\,a(n-14) + 12\,a(n-15). \end{multline*}
...
\begin{theorem} For A303017, the recurrence $a(n) = 6\,a(n-1) - 7\,a(n-2) - 11\,a(n-3) + 11\,a(n-4) + a(n-5) + 49\,a(n-6) - 12\,a(n-7) - 59\,a(n-8) - 61\,a(n-9) + 23\,a(n-10) + 89\,a(n-11) + 28\,a(n-12) - 24\,a(n-13) - 44\,a(n-14) + 12\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. The last nonvanishing one is at $m = 1$, that is at $n = 16$. After it, more than $S = 18$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 27 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 4, 25, 68, 187, 579, 1797, 5571, 17382,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303017}{A303017}, revision 9, last modified Jan 27 2024.
