...
\title{Proofs of the conjectured column and row recurrences for OEIS A300182}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A300182}{A300182} as

\begin{quote}\itshape T(n,k)=Number of nXk 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero\end{quote}
...
k=1: a(n) = 2*a(n-1)\\k=2: a(n) = 4*a(n-1)\\k=3: a(n) = 7*a(n-1) +7*a(n-2) +6*a(n-3)\\k=4: a(n) = 14*a(n-1) +27*a(n-2) +51*a(n-3) -10*a(n-4) -a(n-5) -10*a(n-6)\end{quote}

The lines carry no separate signature; the entry itself is by R. H. Hardin (Feb 27 2018). As of revision 4, last modified Feb 27 2018, the entry records no proof of any of them and links to none. This note proves the 4 column recurrences listed above.
...
\begin{theorem} For column $k = 1$ of A300182, the recurrence $a(n) = 2\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 2$ of A300182, the recurrence $a(n) = 4\,a(n-1)$ holds for every $n \ge 2$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 3$ of A300182, the recurrence $a(n) = 7\,a(n-1) + 7\,a(n-2) + 6\,a(n-3)$ holds for every $n \ge 4$, at every index at which it can be stated.\end{theorem}
...
\begin{theorem} For column $k = 4$ of A300182, the recurrence $a(n) = 14\,a(n-1) + 27\,a(n-2) + 51\,a(n-3) - 10\,a(n-4) - a(n-5) - 10\,a(n-6)$ holds for every $n \ge 7$, at every index at which it can be stated.\end{theorem}
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A300182}{A300182}, revision 4, last modified Feb 27 2018.
