...
\title{A proof of the conjectured linear recurrence for OEIS A207877}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207877}{A207877} as

\begin{quote}\itshape Number of n X 6 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-2) +16*a(n-3) +8*a(n-4) -24*a(n-5) -115*a(n-6) -22*a(n-7) +125*a(n-8) +346*a(n-9) -15*a(n-10) -362*a(n-11) -654*a(n-12) +63*a(n-13) +326*a(n-14) +940*a(n-15) -35*a(n-16) -527*a(n-17) -658*a(n-18) -497*a(n-19) +552*a(n-20) +390*a(n-21) +320*a(n-22) +60*a(n-23) -352*a(n-24) -8*a(n-25) -192*a(n-26) +96*a(n-27) for n>33.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Feb 21 2012).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 11, last modified Jun 05 2026, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = 2\,a(n-2) + 16\,a(n-3) + 8\,a(n-4) - 24\,a(n-5) - 115\,a(n-6) - 22\,a(n-7) + \\ 125\,a(n-8) + 346\,a(n-9) - 15\,a(n-10) - 362\,a(n-11) - 654\,a(n-12) + 63\,a(n-13) + \\ 326\,a(n-14) + 940\,a(n-15) - 35\,a(n-16) - 527\,a(n-17) - 658\,a(n-18) - 497\,a(n-19) + \\ 552\,a(n-20) + 390\,a(n-21) + 320\,a(n-22) + 60\,a(n-23) - 352\,a(n-24) - 8\,a(n-25) - \\ 192\,a(n-26) + 96\,a(n-27). \end{multline*}
...
\begin{theorem} For A207877, the recurrence of order $27$ displayed in Section 1 holds for every $n > 33$, and fails at $n = 33$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,99$. The last nonvanishing one is at $m = 6$, that is at $n = 33$. After it, more than $S = 41$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 19, 361, 702, 1940, 4160, 10742, 24952, 61530,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207877}{A207877}, revision 11, last modified Jun 05 2026.
