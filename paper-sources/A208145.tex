...
\title{A proof of the conjectured linear recurrence for OEIS A208145}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208145}{A208145} as

\begin{quote}\itshape Number of 6Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically\end{quote}
...
\begin{theorem} For A208145, the recurrence of order $24$ displayed in Section 1 holds for every $n \ge 25$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,154$. Every one of them vanished. After it, more than $S = 100$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 12, 144, 756, 3969, 14112, 50176, 141120, 396900,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208145}{A208145}, revision 12, last modified Oct 03 2025.
