...
\title{A proof of the conjectured linear recurrence for OEIS A207695}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A207695}{A207695} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 2*a(n-3) +64*a(n-4) +16*a(n-5) +4*a(n-6) -20*a(n-7) -1112*a(n-8) -324*a(n-9) +40*a(n-10) -136*a(n-11) +7516*a(n-12) +2032*a(n-13) -192*a(n-14) +1936*a(n-15) -23584*a(n-16) -4720*a(n-17) -5888*a(n-19) +37360*a(n-20) +3968*a(n-21) +480*a(n-22) +6464*a(n-23) -29872*a(n-24) -704*a(n-25) -256*a(n-26) -2592*a(n-27) +11072*a(n-28) -256*a(n-29) -64*a(n-30) +320*a(n-31) -1600*a(n-32) +64*a(n-33) +64*a(n-36) for n>39\end{quote}
...
\begin{multline*} a(n) = 2\,a(n-3) + 64\,a(n-4) + 16\,a(n-5) + 4\,a(n-6) - 20\,a(n-7) - 1112\,a(n-8) - \\ 324\,a(n-9) + 40\,a(n-10) - 136\,a(n-11) + 7516\,a(n-12) + 2032\,a(n-13) - 192\,a(n-14) + \\ 1936\,a(n-15) - 23584\,a(n-16) - 4720\,a(n-17) - 5888\,a(n-19) + 37360\,a(n-20) + 3968\,a(n-21) + \\ 480\,a(n-22) + 6464\,a(n-23) - 29872\,a(n-24) - 704\,a(n-25) - 256\,a(n-26) - 2592\,a(n-27) + \\ 11072\,a(n-28) - 256\,a(n-29) - 64\,a(n-30) + 320\,a(n-31) - 1600\,a(n-32) + 64\,a(n-33) + \\ 64\,a(n-36). \end{multline*}
...
\begin{theorem} For A207695, the recurrence of order $36$ displayed in Section 1 holds for every $n > 39$, and fails at $n = 39$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,109$. The last nonvanishing one is at $m = 3$, that is at $n = 39$. After it, more than $S = 42$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 25 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 9, 81, 144, 256, 768, 2304, 5856, 14884,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A207695}{A207695}, revision 9, last modified Oct 03 2025.
