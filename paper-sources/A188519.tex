...
\title{A proof of the conjectured linear recurrence for OEIS A188519}
...
The reachable part of the digraph has $421$ states, $421$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 103$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $103\times103$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A188519, the recurrence of order $71$ displayed in Section 1 holds for every $n \ge 72$, at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,198$. Every one of them vanished. After it, more than $S = 103$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 18 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 20, 400, 4143, 40230, 342240, 2800798, 22015314, 169875850,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A188519}{A188519}, revision 9, last modified Oct 03 2025.
