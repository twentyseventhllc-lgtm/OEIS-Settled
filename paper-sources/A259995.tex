...
\title{A proof of the conjectured linear recurrence for OEIS A259995}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A259995}{A259995} as

\begin{quote}\itshape Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +2*a(n-2) +10*a(n-3) +5*a(n-4) -19*a(n-5) -33*a(n-6) -45*a(n-7) -a(n-8) +25*a(n-9) +13*a(n-10) +5*a(n-11) +3*a(n-12) +9*a(n-13) +8*a(n-14)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 19\,a(n-5) - 33\,a(n-6) - \\ 45\,a(n-7) - a(n-8) + 25\,a(n-9) + 13\,a(n-10) + 5\,a(n-11) + 3\,a(n-12) + \\ 9\,a(n-13) + 8\,a(n-14). \end{multline*}
...
\begin{theorem} For A259995, the recurrence $a(n) = a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 19\,a(n-5) - 33\,a(n-6) - 45\,a(n-7) - a(n-8) + 25\,a(n-9) + 13\,a(n-10) + 5\,a(n-11) + 3\,a(n-12) + 9\,a(n-13) + 8\,a(n-14)$ holds for every $n \ge 15$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 24 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 99, 269, 805, 1819, 4383, 12412, 32525, 82616,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A259995}{A259995}, revision 6, last modified Jun 02 2025.
