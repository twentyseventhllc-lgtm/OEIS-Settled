...
\title{A proof of the conjectured linear recurrence for OEIS A298332}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A298332}{A298332} as

\begin{quote}\itshape Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +3*a(n-2) +14*a(n-3) -9*a(n-4) -29*a(n-5) -33*a(n-6) -48*a(n-7) +34*a(n-8) -2*a(n-9) -10*a(n-10) -32*a(n-11) +12*a(n-12) +8*a(n-13) for n>15\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 3\,a(n-2) + 14\,a(n-3) - 9\,a(n-4) - 29\,a(n-5) - 33\,a(n-6) - \\ 48\,a(n-7) + 34\,a(n-8) - 2\,a(n-9) - 10\,a(n-10) - 32\,a(n-11) + 12\,a(n-12) + \\ 8\,a(n-13). \end{multline*}
...
\begin{theorem} For A298332, the recurrence $a(n) = 5\,a(n-1) + 3\,a(n-2) + 14\,a(n-3) - 9\,a(n-4) - 29\,a(n-5) - 33\,a(n-6) - 48\,a(n-7) + 34\,a(n-8) - 2\,a(n-9) - 10\,a(n-10) - 32\,a(n-11) + 12\,a(n-12) + 8\,a(n-13)$ holds for every $n > 15$, and fails at $n = 15$.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 17, 113, 628, 3641, 21375, 124972, 730509,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A298332}{A298332}, revision 4, last modified Jan 17 2018.
