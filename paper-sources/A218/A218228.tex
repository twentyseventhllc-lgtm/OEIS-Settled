...
\title{A proof of the conjectured linear recurrence for OEIS A218228}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A218228}{A218228} as

\begin{quote}\itshape Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, vertical or antidiagonal neighbor in a random 0..2 nX3 array\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +7*a(n-2) +7*a(n-3) +5*a(n-4) +9*a(n-5) +9*a(n-6) +9*a(n-7) +8*a(n-8) +4*a(n-9) +a(n-10) +a(n-11) +a(n-12) +a(n-13) -a(n-14) -a(n-15) -a(n-16) -a(n-17)\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 5\,a(n-4) + 9\,a(n-5) + 9\,a(n-6) + \\ 9\,a(n-7) + 8\,a(n-8) + 4\,a(n-9) + a(n-10) + a(n-11) + a(n-12) + \\ a(n-13) - a(n-14) - a(n-15) - a(n-16) - a(n-17). \end{multline*}
...
The reachable part of the subset automaton has $87$ states, $87$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 18$ blocks, and the count satisfies the linear recurrence given by the characteristic polynomial of that $18\times18$ matrix. The bound is computed, not assumed.
...
\begin{theorem} For A218228, the recurrence $a(n) = 7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 5\,a(n-4) + 9\,a(n-5) + 9\,a(n-6) + 9\,a(n-7) + 8\,a(n-8) + 4\,a(n-9) + a(n-10) + a(n-11) + a(n-12) + a(n-13) - a(n-14) - a(n-15) - a(n-16) - a(n-17)$ holds for every $n \ge 18$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 7, 61, 497, 3969, 31739, 253825, 2029849, 16232833,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A218228}{A218228}, revision 8, last modified Oct 03 2025.
