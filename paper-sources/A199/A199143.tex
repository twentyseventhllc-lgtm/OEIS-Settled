...
\title{A proof of the conjectured linear recurrence for OEIS A199143}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A199143}{A199143} as

\begin{quote}\itshape Number of nX2 0..3 arrays with values 0..3 introduced in row major order and each element equal to one or two horizontal and vertical neighbors\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +2*a(n-2) -16*a(n-3) -49*a(n-4) -35*a(n-5) +56*a(n-6) +54*a(n-7) +45*a(n-8) -27*a(n-9) for n>11\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 2\,a(n-2) - 16\,a(n-3) - 49\,a(n-4) - 35\,a(n-5) + 56\,a(n-6) + \\ 54\,a(n-7) + 45\,a(n-8) - 27\,a(n-9). \end{multline*}
...
The reachable part of the digraph has $710$ states, $357$ after trimming; the forward identification of states with equal numbers of completions of every length, then the mirror identification on the edges coming in, leaves $S = 15$ blocks. The count satisfies the linear recurrence given by the characteristic polynomial of that $15\times15$ matrix; the bound is computed, not assumed.
...
\begin{theorem} For A199143, the recurrence $a(n) = 7\,a(n-1) + 2\,a(n-2) - 16\,a(n-3) - 49\,a(n-4) - 35\,a(n-5) + 56\,a(n-6) + 54\,a(n-7) + 45\,a(n-8) - 27\,a(n-9)$ holds for every $n > 11$, and fails at $n = 11$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,51$. The last nonvanishing one is at $m = 2$, that is at $n = 11$. After it, more than $S = 15$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 21 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 13, 65, 393, 2539, 16866, 113432,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A199143}{A199143}, revision 9, last modified Oct 03 2025.
