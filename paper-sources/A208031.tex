...
\title{A proof of the conjectured linear recurrence for OEIS A208031}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A208031}{A208031} as

\begin{quote}\itshape Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 5*a(n-1) +30*a(n-2) -64*a(n-3) -157*a(n-4) +303*a(n-5) +101*a(n-6) -262*a(n-7) -23*a(n-8) +64*a(n-9) -4*a(n-11)\end{quote}
...
\begin{multline*} a(n) = 5\,a(n-1) + 30\,a(n-2) - 64\,a(n-3) - 157\,a(n-4) + 303\,a(n-5) + 101\,a(n-6) - \\ 262\,a(n-7) - 23\,a(n-8) + 64\,a(n-9) - 4\,a(n-11). \end{multline*}
...
\begin{theorem} For A208031, the recurrence $a(n) = 5\,a(n-1) + 30\,a(n-2) - 64\,a(n-3) - 157\,a(n-4) + 303\,a(n-5) + 101\,a(n-6) - 262\,a(n-7) - 23\,a(n-8) + 64\,a(n-9) - 4\,a(n-11)$ holds for every $n \ge 12$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 19 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 19, 361, 1995, 17119, 123709, 955073, 7184755, 54606513,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A208031}{A208031}, revision 9, last modified Oct 03 2025.
