...
\title{A proof of the conjectured linear recurrence for OEIS A303458}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A303458}{A303458} as

\begin{quote}\itshape Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 14*a(n-1) +18*a(n-2) -338*a(n-3) -62*a(n-4) +1192*a(n-5) -648*a(n-6) +1818*a(n-7) +1407*a(n-8) -3144*a(n-9) +3656*a(n-10) -8832*a(n-11) -7324*a(n-12) +8010*a(n-13) +2202*a(n-14) +3312*a(n-15) for n>16\end{quote}
...
\begin{multline*} a(n) = 14\,a(n-1) + 18\,a(n-2) - 338\,a(n-3) - 62\,a(n-4) + 1192\,a(n-5) - 648\,a(n-6) + \\ 1818\,a(n-7) + 1407\,a(n-8) - 3144\,a(n-9) + 3656\,a(n-10) - 8832\,a(n-11) - 7324\,a(n-12) + \\ 8010\,a(n-13) + 2202\,a(n-14) + 3312\,a(n-15). \end{multline*}
...
That refinement leaves $23$ blocks. The mirror reduction is then applied: two blocks receiving the same weight from the start, for every walk length, also contribute identically, and the refinement that finds them looks at edges coming in rather than going out. Writing $L$ for the resulting $S \times S$ matrix with $S = 22$, $\tilde w$ for the start weights and $\tilde f$ for the acceptance weights,
...
\begin{theorem} For A303458, the recurrence $a(n) = 14\,a(n-1) + 18\,a(n-2) - 338\,a(n-3) - 62\,a(n-4) + 1192\,a(n-5) - 648\,a(n-6) + 1818\,a(n-7) + 1407\,a(n-8) - 3144\,a(n-9) + 3656\,a(n-10) - 8832\,a(n-11) - 7324\,a(n-12) + 8010\,a(n-13) + 2202\,a(n-14) + 3312\,a(n-15)$ holds for every $n > 16$, and fails at $n = 16$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,59$. The last nonvanishing one is at $m = 1$, that is at $n = 16$. After it, more than $S = 22$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 16 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 128, 1696, 22756, 306448, 4129588, 55681352, 750838628,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A303458}{A303458}, revision 4, last modified Apr 24 2018.
