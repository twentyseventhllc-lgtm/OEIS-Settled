...
\title{A proof of the conjectured linear recurrence for OEIS A317857}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A317857}{A317857} as

\begin{quote}\itshape Number of nX2 0..1 arrays with every element unequal to 1, 2 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +4*a(n-2) -2*a(n-3) -2*a(n-4) +a(n-5) -4*a(n-6) +4*a(n-7) -a(n-8)\end{quote}
...
\begin{multline*} a(n) = a(n-1) + 4\,a(n-2) - 2\,a(n-3) - 2\,a(n-4) + a(n-5) - 4\,a(n-6) + \\ 4\,a(n-7) - a(n-8). \end{multline*}
...
\begin{theorem} For A317857, the recurrence $a(n) = a(n-1) + 4\,a(n-2) - 2\,a(n-3) - 2\,a(n-4) + a(n-5) - 4\,a(n-6) + 4\,a(n-7) - a(n-8)$ holds for every $n \ge 9$ --- at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 30 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 1, 3, 6, 10, 21, 46, 102, 220,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A317857}{A317857}, revision 4, last modified Aug 09 2018.
