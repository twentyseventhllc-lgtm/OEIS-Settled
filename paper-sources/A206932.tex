...
\title{A proof of the conjectured linear recurrence for OEIS A206932}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A206932}{A206932} as

\begin{quote}\itshape Number of nX4 0..1 arrays avoiding 0 0 0 horizontally and 0 1 1 vertically\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 10*a(n-1) -24*a(n-2) -50*a(n-3) +241*a(n-4) -8*a(n-5) -750*a(n-6) +328*a(n-7) +1008*a(n-8) -448*a(n-9) -642*a(n-10) +200*a(n-11) +191*a(n-12) -34*a(n-13) -24*a(n-14) +2*a(n-15) +a(n-16)\end{quote}
...
\begin{multline*} a(n) = 10\,a(n-1) - 24\,a(n-2) - 50\,a(n-3) + 241\,a(n-4) - 8\,a(n-5) - 750\,a(n-6) + \\ 328\,a(n-7) + 1008\,a(n-8) - 448\,a(n-9) - 642\,a(n-10) + 200\,a(n-11) + 191\,a(n-12) - \\ 34\,a(n-13) - 24\,a(n-14) + 2\,a(n-15) + a(n-16). \end{multline*}
...
\begin{theorem} For A206932, the recurrence $a(n) = 10\,a(n-1) - 24\,a(n-2) - 50\,a(n-3) + 241\,a(n-4) - 8\,a(n-5) - 750\,a(n-6) + 328\,a(n-7) + 1008\,a(n-8) - 448\,a(n-9) - 642\,a(n-10) + 200\,a(n-11) + 191\,a(n-12) - 34\,a(n-13) - 24\,a(n-14) + 2\,a(n-15) + a(n-16)$ holds for every $n \ge 17$ --- at every index at which it can be stated.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,66$. Every one of them vanished. After it, more than $S = 24$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 20 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 13, 169, 1153, 6837, 35277, 170409, 783557, 3498981,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A206932}{A206932}, revision 9, last modified Oct 03 2025.
