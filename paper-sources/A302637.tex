...
\title{A proof of the conjectured linear recurrence for OEIS A302637}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A302637}{A302637} as

\begin{quote}\itshape Number of 4 X n 0..1 arrays with every element equal to 0, 1, 3 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = a(n-1) +a(n-2) +2*a(n-3) +8*a(n-4) -6*a(n-5) -6*a(n-6) -13*a(n-7) -22*a(n-8) +7*a(n-9) +11*a(n-10) +28*a(n-11) +28*a(n-12) +2*a(n-13) -9*a(n-14) -27*a(n-15) -17*a(n-16) -2*a(n-17) +4*a(n-18) +10*a(n-19) +4*a(n-20) -2*a(n-21) -a(n-22) for n > 23.\end{quote}

That line carries no separate signature; the entry itself is by R. H. Hardin (Apr 10 2018).

The word {\itshape Empirical} --- equivalently {\itshape Conjecture} --- is the entry's own: the statement is recorded as fitted to the published terms, and no proof is given there. As of revision 7, last modified Jun 07 2021, the entry records no proof and links to none, so the statement is open. This note settles it.

Written out, the claim is

\begin{multline*} a(n) = a(n-1) + a(n-2) + 2\,a(n-3) + 8\,a(n-4) - 6\,a(n-5) - 6\,a(n-6) - \\ 13\,a(n-7) - 22\,a(n-8) + 7\,a(n-9) + 11\,a(n-10) + 28\,a(n-11) + 28\,a(n-12) + \\ 2\,a(n-13) - 9\,a(n-14) - 27\,a(n-15) - 17\,a(n-16) - 2\,a(n-17) + 4\,a(n-18) + \\ 10\,a(n-19) + 4\,a(n-20) - 2\,a(n-21) - a(n-22). \end{multline*}
...
The construction gives $272$ states. Removing states unreachable from a start state, and states from which no accepting state can be reached, leaves $104$; neither removal changes any count.
...
\begin{theorem} For A302637, the recurrence of order $22$ displayed in Section 1 holds for every $n > 23$, and fails at $n = 23$.\end{theorem}

{\itshape Proof.} The residuals $u_m$ were computed exactly for $m = 1,\dots,85$. The last nonvanishing one is at $m = 1$, that is at $n = 23$. After it, more than $S = 28$ consecutive residuals vanish, so by Section 5 every later residual vanishes as well. $\square$
...
\item {\bfseries The published terms.} The walk count reproduces all 29 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 8, 10, 19, 33, 65, 149, 304, 643,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A302637}{A302637}, revision 7, last modified Jun 07 2021.
