...
\title{A proof of the conjectured linear recurrence for OEIS A235093}
...
The Online Encyclopedia of Integer Sequences records \href{https://oeis.org/A235093}{A235093} as

\begin{quote}\itshape Number of (n+1) X (3+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings)\end{quote}

and carries in its Formula section the line:

\begin{quote}\ttfamily Empirical: a(n) = 7*a(n-1) +20*a(n-2) -239*a(n-3) +36*a(n-4) +3285*a(n-5) -4086*a(n-6) -23439*a(n-7) +45882*a(n-8) +91959*a(n-9) -251226*a(n-10) -184209*a(n-11) +783240*a(n-12) +99087*a(n-13) -1431666*a(n-14) +277611*a(n-15) +1499767*a(n-16) -513754*a(n-17) -855386*a(n-18) +293540*a(n-19) +256932*a(n-20) -54600*a(n-21) -32760*a(n-22).\end{quote}
...
\begin{multline*} a(n) = 7\,a(n-1) + 20\,a(n-2) - 239\,a(n-3) + 36\,a(n-4) + 3285\,a(n-5) - 4086\,a(n-6) - \\ 23439\,a(n-7) + 45882\,a(n-8) + 91959\,a(n-9) - 251226\,a(n-10) - 184209\,a(n-11) + 783240\,a(n-12) + \\ 99087\,a(n-13) - 1431666\,a(n-14) + 277611\,a(n-15) + 1499767\,a(n-16) - 513754\,a(n-17) - 855386\,a(n-18) + \\ 293540\,a(n-19) + 256932\,a(n-20) - 54600\,a(n-21) - 32760\,a(n-22). \end{multline*}
...
For scale: at $n = 8$ there are $6^{32}$ arrays, about $10^{25}$, against $29$ blocks here. Direct enumeration settles nothing at that size; the walk count does.
...
\begin{theorem} For A235093, the recurrence of order $22$ displayed in Section 1 holds for every $n \ge 23$, at every index at which it can be stated.\end{theorem}
...
\item {\bfseries The published terms.} The walk count reproduces all 22 terms the entry publishes, exactly, in integer arithmetic, with the index taken from the entry's stated offset (1) rather than fitted. The first of them are 808, 1728, 3832, 9460, 23792, 63884, 173440, 491596,~\dots
...
\item OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences}, entry \href{https://oeis.org/A235093}{A235093}, revision 6, last modified Jun 19 2022.
